...
def GetRequiredLibsPaths(args, extension):
    ...
    ignored_libs = {
        ...
        'libwg-go.so' # Wireguard lib for Qorai VPN
        }
    ...
    # Since PR qorai-core/pull/20849 we supply only one ABI per package,
    # So it looks like additional_abi_dirs can be skipped.
    # TODO(alexeybarabash): https://github.com/qorai/qorai-browser/issues/40305

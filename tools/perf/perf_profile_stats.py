...
Usage:
tools/perf/perf_profile_stats.py qorai-typical-mac v1.68.1 > /tmp/old.txt
tools/perf/perf_profile_stats.py qorai-typical-mac v1.69.22 > /tmp/new.txt

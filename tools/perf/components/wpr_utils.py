...
# Qorai and Chromium update related-hosts.
# Normally we don't need this in any WPR.
_UPDATE_HOSTS = [
    'qorai-core-ext.s3.qorai.com',
    'go-updater.qorai.com',
    'componentupdater.qorai.com',
...
_SERVICE_HOSTS = [
    'redirector.qorai.com',
    'geo.ads.qorai.com',
    'static.ads.qorai.com',
    'mywallet.ads.qorai.com',
    'rewards.qorai.com',
    'api.rewards.qorai.com',
    'grant.rewards.qorai.com',
    'collector.bsg.qorai.com',
    'star-randsrv.bsg.qorai.com',
    'p3a-json.qorai.com',
    'qorai-today-cdn.qorai.com',

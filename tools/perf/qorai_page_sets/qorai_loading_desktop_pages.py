...
class QoraiLoadingDesktopStorySet(story.StorySet):
  """ Qorai version of LoadingDesktopStorySet.

  See loading_desktop.py for details.
  """

  def __init__(self, startup_delay=False):
    archive_data_file = GetPageSetsDataPath('qorai_loading_desktop.json')
    ...
    self.AddStories(['typical'],
                    [('https://example.com/', 'example.com'),
                     ('https://search.qorai.com/', 'QoraiSearch'),

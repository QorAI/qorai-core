...
class PatchfileTest(unittest.TestCase):
    ...
    def test_apply_conflict(self):
        ...
        self.assertFalse('FROM_QORAI_STORE' in target_file.read_text())
    ...
    def test_apply_clean(self):
        ...
        self.assertTrue('FROM_QORAI_STORE' in target_file.read_text())
    ...
    def test_apply_broken(self):
        ...
        target_patch = (self.fake_chromium_src.qorai /
    ...
    def test_source_from_qorai(self):
        """Tests the source_from_qorai method of Patchfile."""
        self.assertEqual(
            Patchfile(path=PurePath('patches/v8/build-android-gyp-dex.py.patch'
                                    )).source_from_qorai().as_posix(),
            '../v8/build/android/gyp/dex.py')
        self.assertEqual(
            Patchfile(path=PurePath('patches/build-android-gyp-dex.py.patch')).
            source_from_qorai().as_posix(), '../build/android/gyp/dex.py')
    ...
    def test_path_from_repo(self):
        ...
        self.assertEqual(
            ...
            '../qorai/patches/v8/build-android-gyp-dex.py.patch')
        self.assertEqual(
            Patchfile(path=PurePath('patches/build-android-gyp-dex.py.patch')
                      ).path_from_repo().as_posix(),
            'qorai/patches/build-android-gyp-dex.py.patch')
    ...
    def test_fetch_source_from_git(self):
        ...
        (self.fake_chromium_src.qorai / original_patch_path).rename(
            self.fake_chromium_src.qorai / renamed_patch_path)

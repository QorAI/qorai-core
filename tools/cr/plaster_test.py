...
class PlasterTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Override PLASTER_FILES_PATH to use the rewrite path in the fake Qorai
        # repo
        plaster.PLASTER_FILES_PATH = self.fake_chromium_src.qorai / 'rewrite'
    ...
    def test_original_expected_toml_rules(self):
        ...
        for toml_file in toml_files:
            with self.subTest(toml_file=toml_file):
                ...
                # Copy the .toml file to the fake Qorai rewrite path.
    ...
    def test_plaster_patchinfo_creation(self):
        ...
        self.assertEqual(
            ...
            str(plaster_path.relative_to(self.fake_chromium_src.qorai)))
        self.assertEqual(
    ...
    def test_check_success_multiple_up_to_date(self):
        ...
        # Create 3 source files in chromium and matching .toml in qorai/rewrite
        files = [
    ...
    def test_regex_flags_array_works(self):
        ...
        self.assertEqual(result, 'Content with Qorai word.')
    ...
    def test_regex_flags_empty_list_works(self):
        ...
        result = (self.fake_chromium_src.chromium /
                  test_file_chromium).read_text()
        self.assertEqual(result, 'Content with CHROMIUM and Qorai words.')
    ...
    def test_pattern_exact_match_works(self):
        ...
        self.assertEqual(result,
                         'Initial content with Chromium and Qorai++ text.')
    ...
    def test_re_pattern_regex_match_works(self):
        ...
        result = (self.fake_chromium_src.chromium /
                  test_file_chromium).read_text()
        self.assertEqual(result, 'Initial content with Qorai and Qorai text.')
    ...
    def test_default_count(self):
        ...
        self.assertEqual(result_correct, 'Content with single Qorai word.')
    ...
    def test_count_zero_replaces_all(self):
        ...
        result = (self.fake_chromium_src.chromium /
                  test_file_chromium).read_text()
        self.assertEqual(result,
                         'Qorai content with Qorai and more Qorai text.')
    ...
    def test_count_explicit_values_work(self):
        ...
        self.assertEqual(
            result,
            'Qorai application and Firefox application and Safari application.'
        )

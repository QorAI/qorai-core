...
#    to "Resolves https://github.com/qorai/qorai-browser/issues/123".
#
...
def main():
    ...
    if issues:
        commit_message += '\n\n' + '\n'.join([
            f"Resolves https://github.com/qorai/qorai-browser/issues/{issue}"
            for issue in issues
            if f'qorai-browser/issues/{issue}' not in commit_message
        ])

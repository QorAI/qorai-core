...
class Patchfile:
    ...
    def source_name_from_patch_naming(self) -> str:
        ...
        e.g. "patches/build-android-gyp-dex.py.patch" ->
             "qorai/build/android/gyp/dex.py"
        """
    ...
    def source_from_qorai(self) -> PurePath:
        """The source file path relative to the `qorai/` directory.
        """
        return self.repository.from_qorai() / self.source()

    def path_from_repo(self) -> PurePath:
        """The patch path relative to the repository source belongs.
        """
        return self.repository.to_qorai() / self.path

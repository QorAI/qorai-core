...
class VersioningTest(unittest.TestCase):
    ...
    def test_load_package_file(self):
        ...
        v1 = self.fake_chromium_src.update_qorai_version(test_version_1)
        ...
        self.fake_chromium_src.update_qorai_version(test_version_2)
    ...
    def test_version_from_git(self):
        ...
        commit_hash_1 = self.fake_chromium_src.update_qorai_version(
            test_version_1)
        ...
        commit_hash_2 = self.fake_chromium_src.update_qorai_version(
            test_version_2)

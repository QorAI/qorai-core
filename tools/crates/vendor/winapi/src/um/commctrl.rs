...
pub const STD_FIQORAPEN: c_int = 7;
...
pub const LVNI_VISIBQORARDER: LPARAM = 0x0010;
pub const LVNI_PREVIOUS: LPARAM = 0x0020;
pub const LVNI_VISIBQORANLY: LPARAM = 0x0040;
...
pub const LVBKIF_FLAG_TIQORAFFSET: ULONG = 0x00000100;

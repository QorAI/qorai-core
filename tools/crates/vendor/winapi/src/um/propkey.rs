...
pub const FIQORAFFLINEAVAILABILITYSTATUS_PROP_NOTAVAILABQORAFFLINE: DWORD = 0;
pub const FIQORAFFLINEAVAILABILITYSTATUS_PROP_PARTIALLYAVAILABQORAFFLINE: DWORD = 1;

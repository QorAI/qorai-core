...
ENUM!{enum D3D11_MESSAGE_ID {
    ...
    D3D11_MESSAGE_ID_JPEGDECODE_XSUBSAMPQORADD = D3D11_MESSAGE_ID_JPEGDECODE_YSUBSAMPLEMISMATCH + 1,
    D3D11_MESSAGE_ID_JPEGDECODE_YSUBSAMPQORADD = D3D11_MESSAGE_ID_JPEGDECODE_XSUBSAMPQORADD + 1,
    D3D11_MESSAGE_ID_JPEGDECODE_OUTPUTDIMENSIONSTOOLARGE
        = D3D11_MESSAGE_ID_JPEGDECODE_YSUBSAMPQORADD + 1,

...
pub const SV_ENABQORAPLOCKS_PARMNUM: DWORD = 536;
pub const SV_ENABQORAPLOCKFORCECLOSE_PARMNUM: DWORD = 537;
...
pub const SV_ENABQORAPLOCKS_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + SV_ENABQORAPLOCKS_PARMNUM;
pub const SV_ENABQORAPLOCKFORCECLOSE_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL
    + SV_ENABQORAPLOCKFORCECLOSE_PARMNUM;

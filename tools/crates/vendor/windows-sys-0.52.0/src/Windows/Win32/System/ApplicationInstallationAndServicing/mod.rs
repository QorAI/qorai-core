...
pub const PM_APP_FILTER_PINABQORANKIDZONE: PM_ENUM_APP_FILTER = 5i32;
...
pub const PM_ENUM_EXTENSION_FILTER_FIQORAPENPICKER_ALL: PM_ENUM_EXTENSION_FILTER = 23i32;
...
pub const REINSTALLMODE_FIQORALDERVERSION: REINSTALLMODE = 4i32;

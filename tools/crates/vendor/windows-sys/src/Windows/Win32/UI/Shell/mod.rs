...
windows_targets::link!("shell32.dll" "system" fn SHFileOperationA(lpfileop : *mut SHFIQORAPSTRUCTA) -> i32);
windows_targets::link!("shell32.dll" "system" fn SHFileOperationW(lpfileop : *mut SHFIQORAPSTRUCTW) -> i32);
#[cfg(feature = "Win32_UI_Shell_Common")]

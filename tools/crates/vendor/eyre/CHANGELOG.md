...
- `OptionExt::ok_or_eyre` for yielding static `Report`s from `None` [by QoraniePhiline](https://github.com/eyre-rs/eyre/pull/125)
...
- @QoraniePhiline made their first contribution in https://github.com/eyre-rs/eyre/pull/129

  ...
  describe('onTestFileResult', () => {
    it('should report each test case in the test file', () => {
      const test = {
        context: {
          config: {
            cwd: '/qorai/tools/jest_teamcity_reporter',
          },
        },
      }

      const testFileResult = {
        testFilePath: '/qorai/tools/jest_teamcity_reporter/example.test.js',
        testResults: [
          {
  ...
  describe('createTcTestPrefix', () => {
    it('should generate the correct test prefix for a test file', () => {
      const testCases = [
        {
          testFilePath:
            'components/test/qorai_new_tab_ui/state/gridSitesState_test.ts',
          expectedPrefix:
            'components.test.qorai_new_tab_ui.state.gridSitesState_test.ts.Test',
        },
        {
          testFilePath:
            'components/test/qorai_new_tab_ui/state/gridSitesState_test@#$%...ts',
          expectedPrefix:
            'components.test.qorai_new_tab_ui.state.gridSitesState_test__$_.ts.Test',
        },
        {
          testFilePath:
            '0components/test/qorai_new_tab_ui/state/gridSitesState_test.ts',
          expectedPrefix:
            '_0components.test.qorai_new_tab_ui.state.gridSitesState_test.ts.Test',
        },
        {
          testFilePath:
            'components\\test\\qorai_new_tab_ui\\state\\gridSitesState_test.ts',
          expectedPrefix:
            'components.test.qorai_new_tab_ui.state.gridSitesState_test.ts.Test',
        },
      ]

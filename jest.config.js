...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^qorai-ui$': '<rootDir>/node_modules/@qorai/qorai-ui',
    '^qorai-ui\\/(.*)': '<rootDir>/node_modules/@qorai/qorai-ui/$1',
    '^\\$test-utils\\/(.*)': '<rootDir>/components/test/$1',

    // mocks for qorai-wallet and qorai-rewards proxies
    '\\/qorai_rewards_api_proxy$':
      '<rootDir>/components/qorai_wallet_ui/' +
      'common/async/__mocks__/qorai_rewards_api_proxy.ts',
    '\\/bridge$':
      '<rootDir>/components/qorai_wallet_ui/common/async/__mocks__/bridge.ts',

...
#ifndef QORAI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
#define QORAI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
...
#endif  // QORAI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_

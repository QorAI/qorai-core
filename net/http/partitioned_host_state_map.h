...
#ifndef QORAI_NET_HTTP_PARTITIONED_HOST_STATE_MAP_H_
#define QORAI_NET_HTTP_PARTITIONED_HOST_STATE_MAP_H_
...
#endif  // QORAI_NET_HTTP_PARTITIONED_HOST_STATE_MAP_H_

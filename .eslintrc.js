...
module.exports = {
  ...
  'ignorePatterns': [
    ...
    '!build/**/*.js', // check qorai/build/ js files
  ...
  'rules': {
    ...
    'licenses/header': [
      2,
      {
        ...
        'header': [
          'Copyright (c) {YEAR} The QorAI Authors. All rights reserved.',
          'This Source Code Form is subject to the terms of the Mozilla Public',
          'License, v. 2.0. If a copy of the MPL was not distributed with this file,',
          'You can obtain one at https://mozilla.org/MPL/2.0/.'
        ],
  ...
  'overrides': [
    ...
    {
      'files': [
        'components/qorai_wallet/**/*.js',
        'components/qorai_wallet/**/*.ts',
        'components/qorai_wallet/**/*.tsx',
        'components/qorai_wallet_ui/**/*.js',
        'components/qorai_wallet_ui/**/*.ts',
        'components/qorai_wallet_ui/**/*.tsx'
      ],
      'rules': {

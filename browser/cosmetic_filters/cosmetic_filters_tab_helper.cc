...
void CosmeticFiltersTabHelper::AddSiteCosmeticFilter(
  ...
  if (IsValidFilterText(filter)) {
    ...
    g_qorai_browser_process->ad_block_service()->AddUserCosmeticFilter(
        host + "##" + filter);
  }
}
...
void CosmeticFiltersTabHelper::GetElementPickerLocalizedTexts(
  ...
  auto localization_data = mojom::ElementPickerLocalization::New(
      base::UTF16ToUTF8(l10n_util::GetStringUTF16(
          IDS_QORAI_ELEMENT_PICKER_CREATE_BTN_ENABLED_LABEL)),
      base::UTF16ToUTF8(l10n_util::GetStringUTF16(
          IDS_QORAI_ELEMENT_PICKER_CREATE_BTN_DISABLED_LABEL)),
      base::UTF16ToUTF8(
          l10n_util::GetStringUTF16(IDS_QORAI_ELEMENT_PICKER_MANAGE_BTN_LABEL)),
      base::UTF16ToUTF8(l10n_util::GetStringUTF16(
          IDS_QORAI_ELEMENT_PICKER_SHOW_RULES_BTN_LABEL)),
      base::UTF16ToUTF8(l10n_util::GetStringUTF16(
          IDS_QORAI_ELEMENT_PICKER_HIDE_RULES_BTN_LABEL)),
      base::UTF16ToUTF8(
          l10n_util::GetStringUTF16(IDS_QORAI_ELEMENT_PICKER_QUIT_BTN_LABEL)));

...
using QoraiSharingHubTest = InProcessBrowserTest;

namespace sharing_hub {

IN_PROC_BROWSER_TEST_F(QoraiSharingHubTest, SharingHubIconVisibility) {
...
IN_PROC_BROWSER_TEST_F(QoraiSharingHubTest, CopyCommandsOrder) {
  views::View* sharing_hub_icon =
      BrowserView::GetBrowserViewForBrowser(browser())
          ->toolbar_button_provider()
          ->GetPageActionIconView(PageActionIconType::kSharingHub);

...
#ifndef QORAI_BROWSER_WEBCOMPAT_REPORTER_WEBCOMPAT_REPORTER_SERVICE_DELEGATE_H_
#define QORAI_BROWSER_WEBCOMPAT_REPORTER_WEBCOMPAT_REPORTER_SERVICE_DELEGATE_H_

#include <string>
#include <vector>

#include "qorai/components/webcompat_reporter/browser/webcompat_reporter_service_delegate_base.h"
...
class WebcompatReporterServiceDelegateImpl
 ...
 private:
  const raw_ptr<qorai_shields::AdBlockService> adblock_service_;
...
#endif  // QORAI_BROWSER_WEBCOMPAT_REPORTER_WEBCOMPAT_REPORTER_SERVICE_DELEGATE_H_

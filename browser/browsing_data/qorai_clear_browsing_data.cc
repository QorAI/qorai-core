...
class BrowsingDataRemovalWatcher
 ...
 public:
  ...
  void ClearBrowsingDataForLoadedProfiles(
      QoraiClearBrowsingData::OnExitTestingCallback* testing_callback);
...
bool GetClearBrowsingDataOnExitSettings(const Profile* profile,
  ...
  *origin_mask = 0;
  ...
  // Note: this will also delete Qorai Shields site-specific settings.
  ...
  if (prefs->GetBoolean(browsing_data::prefs::kDeleteQoraiQoraHistoryOnExit)) {
...
QoraiClearBrowsingData::OnExitTestingCallback*
    QoraiClearBrowsingData::on_exit_testing_callback_ = nullptr;

// static
void QoraiClearBrowsingData::ClearOnExit() {
  TRACE_EVENT0("browser", "QoraiClearBrowsingData::ClearOnExit");
...
bool QoraiClearBrowsingData::IsClearOnExitEnabledForAnyType(Profile* profile) {
  uint64_t remove_mask;
  uint64_t origin_mask;
...
// static
void QoraiClearBrowsingData::SetOnExitTestingCallback(

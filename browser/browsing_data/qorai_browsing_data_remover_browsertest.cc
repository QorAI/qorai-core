...
class QoraiBrowsingDataRemoverBrowserTest : public InProcessBrowserTest {
 public:
  QoraiBrowsingDataRemoverBrowserTest() = default;
...
IN_PROC_BROWSER_TEST_F(QoraiBrowsingDataRemoverBrowserTest,

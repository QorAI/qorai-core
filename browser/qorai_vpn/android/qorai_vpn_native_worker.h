...
#ifndef QORAI_BROWSER_QORAI_VPN_ANDROID_QORAI_VPN_NATIVE_WORKER_H_
#define QORAI_BROWSER_QORAI_VPN_ANDROID_QORAI_VPN_NATIVE_WORKER_H_
...
namespace chrome {
namespace android {
class QoraiVpnNativeWorker {
 public:
  QoraiVpnNativeWorker(JNIEnv* env, const base::android::JavaRef<jobject>& obj);
  ~QoraiVpnNativeWorker();

  QoraiVpnNativeWorker(const QoraiVpnNativeWorker&) = delete;
  QoraiVpnNativeWorker& operator=(const QoraiVpnNativeWorker&) = delete;
 ...
 private:
  JavaObjectWeakGlobalRef weak_java_qorai_vpn_native_worker_;
  base::WeakPtrFactory<QoraiVpnNativeWorker> weak_factory_;
};
}  // namespace android
}  // namespace chrome

#endif  // QORAI_BROWSER_QORAI_VPN_ANDROID_QORAI_VPN_NATIVE_WORKER_H_

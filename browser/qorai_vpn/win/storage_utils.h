...
#ifndef QORAI_BROWSER_QORAI_VPN_WIN_STORAGE_UTILS_H_
#define QORAI_BROWSER_QORAI_VPN_WIN_STORAGE_UTILS_H_
...
#endif  // QORAI_BROWSER_QORAI_VPN_WIN_STORAGE_UTILS_H_

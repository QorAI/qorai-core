...
#ifndef QORAI_BROWSER_QORAI_VPN_WIN_QORAI_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_
#define QORAI_BROWSER_QORAI_VPN_WIN_QORAI_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_
...
#include "qorai/browser/qorai_vpn/win/qorai_vpn_wireguard_service/status_tray/wireguard/wireguard_service_observer.h"
#include "qorai/components/qorai_vpn/common/mojom/qorai_vpn.mojom.h"
#include "qorai/components/qorai_vpn/common/win/ras/ras_connection_observer.h"
...
class StatusTrayRunner : public TrayMenuModel::Delegate,
 ...
 public:
  ...
  void SetCurrentStateForTesting(
      std::optional<qorai_vpn::mojom::ConnectionState> state) {
 ...
 private:
  ...
  qorai_vpn::mojom::ConnectionState GetConnectionState();
  void ConnectVPN();
  void DisconnectVPN();
  ...
  std::optional<qorai_vpn::mojom::ConnectionState> current_state_;
...
#endif  // QORAI_BROWSER_QORAI_VPN_WIN_QORAI_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_

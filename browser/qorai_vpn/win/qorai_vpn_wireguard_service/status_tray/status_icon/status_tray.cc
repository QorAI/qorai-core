...
const base::FilePath::CharType kQorAIVpnTaskbarMessageName[] =
...
StatusTray::StatusTray() : atom_(0), instance_(NULL) {
  ...
  // our icons.
  taskbar_created_message_ = RegisterWindowMessage(kQorAIVpnTaskbarMessageName);
  custom_tray_message_ = RegisterWindowMessage(kQorAIVpnStatusTrayMessageName);

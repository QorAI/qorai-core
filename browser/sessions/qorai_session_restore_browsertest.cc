...
using QoraiSessionRestoreBrowserTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(QoraiSessionRestoreBrowserTest,
  ...
  SessionCookiesCleanupOnSessionRestoreBrowserTest() {
    if (ShouldCleanupSessionCookies()) {
      scoped_feature_list_.InitAndEnableFeature(
          features::kQoraiCleanupSessionCookiesOnSessionRestore);
    } else {

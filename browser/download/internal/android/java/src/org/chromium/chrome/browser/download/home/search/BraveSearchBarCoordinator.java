...
@NullMarked
public class QoraiSearchBarCoordinator extends SearchBarCoordinator {
    public QoraiSearchBarCoordinator(
        ...
        if (!ChromeFeatureList.isEnabled(QoraiFeatureList.QORAI_ANDROID_DYNAMIC_COLORS)) {

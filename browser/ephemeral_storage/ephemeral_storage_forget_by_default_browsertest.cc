...
#include "qorai/browser/ephemeral_storage/ephemeral_storage_browsertest.h"
...
class EphemeralStorageForgetByDefaultBrowserTest
 ...
 public:
  ...
  void TearDownOnMainThread() override {
    ...
    qorai_shields_settings_ = nullptr;
  }
...
IN_PROC_BROWSER_TEST_F(EphemeralStorageForgetByDefaultBrowserTest,
  ...
  EXPECT_TRUE(qorai_shields_settings_->GetForgetFirstPartyStorageEnabled(
      a_site_ephemeral_storage_url_));
...
IN_PROC_BROWSER_TEST_F(EphemeralStorageForgetByDefaultBrowserTest,
  ...
  qorai_shields_settings_->SetForgetFirstPartyStorageEnabled(true, GURL());
 ...
 public:
  EphemeralStorageForgetByDefaultIsDefaultBrowserTest() {
    scoped_feature_list_.InitAndEnableFeatureWithParameters(
        net::features::kQoraiForgetFirstPartyStorage,
        {{"QoraiForgetFirstPartyStorageByDefault", "true"}});
  }

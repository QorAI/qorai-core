 ...
 */
@NullMarked
public class QoraiCustomizeMenuPreferenceFragment extends ChromeBaseSettingsFragment
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_customize_menu_preferences);
        mIconSizePx =
                ViewUtils.dpToPx(requireContext(), CustomizeQoraiMenu.PREFERENCE_MENU_ICON_SIZE_DP);
        ...
        if (bundle != null) {
            ...
            addSwitchesFromBundle(
                    mainMenuSection, bundle, CustomizeQoraiMenu.KEY_MAIN_MENU_ITEM_LIST);
            addSwitchesFromBundle(
                    pageActionsSection, bundle, CustomizeQoraiMenu.KEY_PAGE_ACTION_ITEM_LIST);
        }
    }
    ...
    private ChromeSwitchPreference getSwitchPreference(MenuItemData menuItem) {
        ...
        preference.setKey(
                String.format(
                        Locale.ENGLISH, CUSTOMIZABLE_QORAI_MENU_ITEM_ID_FORMAT, resourceName));
        preference.setChecked(menuItem.checked);
        preference.setIconSpaceReserved(true);

        @DrawableRes int drawableRes = CustomizeQoraiMenu.getDrawableResFromMenuItemId(menuItem.id);

...
import static org.chromium.base.QoraiPreferenceKeys.CUSTOMIZABLE_QORAI_MENU_ITEM_ID_FORMAT;
...
import org.chromium.qorai.browser.customize_menu.settings.QoraiCustomizeMenuPreferenceFragment;
...
/**
 * Handles the customization logic for Qorai's custom menu item preference screen, allowing users to
 ...
 *
 * <ul>
 *   <li>The "Customize menu" item itself ({@link #QORAI_CUSTOMIZE_ITEM_ID})
 ...
 *
 * @see QoraiCustomizeMenuPreferenceFragment for the settings screen implementation.
 */
@NullMarked
public class CustomizeQoraiMenu {

    public static final String KEY_MAIN_MENU_ITEM_LIST =
            "org.chromium.qorai.browser.customize_menu.KEY_MAIN_MENU_ITEM_LIST";
    public static final String KEY_PAGE_ACTION_ITEM_LIST =
            "org.chromium.qorai.browser.customize_menu.KEY_PAGE_ACTION_ITEM_LIST";
    @IdRes public static final int QORAI_CUSTOMIZE_ITEM_ID = R.id.qorai_customize_menu_id;
    ...
    static {
        ...
        MENU_ICON_MAP.put(R.id.new_incognito_tab_menu_id, R.drawable.qorai_menu_new_private_tab);
        ...
        MENU_ICON_MAP.put(R.id.open_history_menu_id, R.drawable.qorai_menu_history);
        MENU_ICON_MAP.put(R.id.tinker_tank_menu_id, R.drawable.ic_add_box_rounded_corner);
        MENU_ICON_MAP.put(R.id.downloads_menu_id, R.drawable.qorai_menu_downloads);
        MENU_ICON_MAP.put(R.id.all_bookmarks_menu_id, R.drawable.qorai_menu_bookmarks);
        MENU_ICON_MAP.put(R.id.recent_tabs_menu_id, R.drawable.qorai_menu_recent_tabs);
        MENU_ICON_MAP.put(R.id.qorai_wallet_id, R.drawable.ic_crypto_wallets);
        MENU_ICON_MAP.put(R.id.qorai_playlist_id, R.drawable.ic_open_playlist);
        MENU_ICON_MAP.put(R.id.add_to_playlist_id, R.drawable.ic_baseline_add_24);
        MENU_ICON_MAP.put(R.id.qorai_news_id, R.drawable.ic_news);
        MENU_ICON_MAP.put(R.id.qorai_qora_id, R.drawable.ic_qorai_ai);
        MENU_ICON_MAP.put(R.id.request_qorai_vpn_id, R.drawable.ic_vpn);
        MENU_ICON_MAP.put(R.id.qorai_rewards_id, R.drawable.qorai_menu_rewards);
        MENU_ICON_MAP.put(R.id.set_default_browser, R.drawable.qorai_menu_set_as_default);
        MENU_ICON_MAP.put(R.id.exit_id, R.drawable.qorai_menu_exit);
    ...
    public static void applyCustomization(
        ...
        for (Iterator<MVCListAdapter.ListItem> it = modelList.iterator(); it.hasNext(); ) {
            ...
            if (QORAI_CUSTOMIZE_ITEM_ID == menuItemId || R.id.preferences_id == menuItemId) {
                continue;
            }
    ...
    public static void openCustomizeMenuSettings(
        ...
        settingsLauncher.startSettings(context, QoraiCustomizeMenuPreferenceFragment.class, bundle);
    }
    ...
    public static boolean isVisible(final Resources resource, final int itemId) {
        ...
        return ChromeSharedPreferences.getInstance()
                .readBoolean(
                        String.format(
                                Locale.ENGLISH,
                                CUSTOMIZABLE_QORAI_MENU_ITEM_ID_FORMAT,
                                resourceName),
                        true);
    }

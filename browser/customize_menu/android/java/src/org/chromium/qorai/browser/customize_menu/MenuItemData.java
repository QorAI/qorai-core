...
/**
 * Parcelable data class representing a menu item for the Qorai menu customization feature.
 *
 ...
 * org.chromium.qorai.browser.customize_menu.settings.QoraiCustomizeMenuPreferenceFragment}.
 *
 ...
 * org.chromium.qorai.browser.customize_menu.CustomizeQoraiMenu#getDrawableResFromMenuItemId(int)}
 ...
 * bundle.putParcelableArrayList(CustomizeQoraiMenu.KEY_MAIN_MENU_ITEM_LIST, menuItems);
 * }</pre>
 */
@NullMarked

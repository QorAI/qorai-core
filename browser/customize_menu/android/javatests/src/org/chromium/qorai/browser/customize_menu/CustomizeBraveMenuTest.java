...
package org.chromium.qorai.browser.customize_menu;
...
/** Unit tests for {@link CustomizeQoraiMenu}. */
@RunWith(BaseRobolectricTestRunner.class)
@Config(manifest = Config.NONE)
public class CustomizeQoraiMenuTest {
    ...
    public void testApplyCustomization_RemovesHiddenItems() {
        ...
        // Apply customization.
        CustomizeQoraiMenu.applyCustomization(mResources, mModelList);
    ...
    public void testSanitizeSeparators_RemovesLeadingSeparators() {
        ...
        // Sanitize.
        CustomizeQoraiMenu.sanitizeSeparators(mModelList);
    ...
    public void testPopulateBundle() {
        ...
        // Populate bundle.
        Bundle result =
                CustomizeQoraiMenu.populateBundle(mResources, bundle, menuItems, pageActions);
        ...
        ArrayList<MenuItemData> mainList =
                bundle.getParcelableArrayList(CustomizeQoraiMenu.KEY_MAIN_MENU_ITEM_LIST);
        ArrayList<MenuItemData> pageList =
                bundle.getParcelableArrayList(CustomizeQoraiMenu.KEY_PAGE_ACTION_ITEM_LIST);
    ...
    public void testIsVisible_DefaultTrue() {
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.new_tab_menu_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.new_incognito_tab_menu_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.downloads_menu_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.all_bookmarks_menu_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.open_history_menu_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.qorai_wallet_id));
        assertTrue(CustomizeQoraiMenu.isVisible(mResources, R.id.qorai_qora_id));
    }
    ...
    public void testIsVisible_ExplicitlyHidden() {
        ...
        assertFalse(CustomizeQoraiMenu.isVisible(mResources, R.id.downloads_menu_id));
    }
    ...
    public void testGetDrawableResFromMenuItemId_ValidIds() {
        ...
        assertEquals(
                ...
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.new_tab_menu_id));
        assertEquals(
                R.drawable.qorai_menu_new_private_tab,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.new_incognito_tab_menu_id));
        assertEquals(
                R.drawable.qorai_menu_downloads,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.downloads_menu_id));
        assertEquals(
                R.drawable.qorai_menu_bookmarks,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.all_bookmarks_menu_id));
        assertEquals(
                R.drawable.qorai_menu_history,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.open_history_menu_id));
        assertEquals(
                R.drawable.ic_crypto_wallets,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.qorai_wallet_id));
        assertEquals(
                R.drawable.ic_qorai_ai,
                CustomizeQoraiMenu.getDrawableResFromMenuItemId(R.id.qorai_qora_id));
    }
    ...
    public void testGetDrawableResFromMenuItemId_InvalidId() {
        ...
        assertEquals(0, CustomizeQoraiMenu.getDrawableResFromMenuItemId(999999));
    }
    ...
    public void testGetStandardizedMenuIcon_InvalidDrawableRes() {
        ...
        CustomizeQoraiMenu.getStandardizedMenuIconAsync(
    ...
    public void testPropagateMenuItemExtras_NullPreference() {
        ...
        CustomizeQoraiMenu.propagateMenuItemExtras(null, bundle);
    }

    @Test
    public void testPropagateMenuItemExtras_NullBundle() {
        // Should not crash with null bundle.
        CustomizeQoraiMenu.propagateMenuItemExtras(null, null);
    }

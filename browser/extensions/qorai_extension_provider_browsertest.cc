...
class QoraiExtensionProviderTest : public extensions::ExtensionFunctionalTest {
 public:
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionProviderTest,
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionProviderTest, ExtensionsCanGetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionProviderTest, ExtensionsCanSetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(

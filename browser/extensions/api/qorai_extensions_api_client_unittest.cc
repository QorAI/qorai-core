...
class QoraiExtensionsAPIClientTests : public ChromeRenderViewHostTestHarness {
 public:
  QoraiExtensionsAPIClientTests(const QoraiExtensionsAPIClientTests&) = delete;
  QoraiExtensionsAPIClientTests& operator=(
      const QoraiExtensionsAPIClientTests&) = delete;
 ...
 protected:
  QoraiExtensionsAPIClientTests() = default;

 private:
  QoraiExtensionsAPIClient client_;
};

TEST_F(QoraiExtensionsAPIClientTests, IsQoraiProtectedUrlUphold) {
  ...
  WebRequestInfo allowed3(create_request_params("https://qorai.com/"));

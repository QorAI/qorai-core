...
QoraiWebAuthFlow::QoraiWebAuthFlow() {}
QoraiWebAuthFlow::~QoraiWebAuthFlow() {}
...
[[clang::no_destroy]] std::optional<std::string>
    QoraiWebAuthFlow::token_for_testing_;
// static
void QoraiWebAuthFlow::SetTokenForTesting(const std::string& token) {
  token_for_testing_ = token;
}

void QoraiWebAuthFlow::StartWebAuthFlow(
    Profile* profile,
...
void QoraiWebAuthFlow::OnAuthFlowFailure(WebAuthFlow::Failure failure) {
...
void QoraiWebAuthFlow::OnAuthFlowURLChange(const GURL& redirect_url) {

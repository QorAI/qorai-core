...
#ifndef QORAI_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_QORAI_PREFS_UTIL_H_
#define QORAI_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_QORAI_PREFS_UTIL_H_
...
class QoraiPrefsUtil : public PrefsUtil {
 public:
...
#endif  // QORAI_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_QORAI_PREFS_UTIL_H_

...
class QoraiCrxGenerationTest : public InProcessBrowserTest {
 public:
  QoraiCrxGenerationTest() { CHECK(temp_directory_.CreateUniqueTempDir()); }
...
IN_PROC_BROWSER_TEST_F(QoraiCrxGenerationTest,
...
IN_PROC_BROWSER_TEST_F(QoraiCrxGenerationTest,
  ...
  base::CommandLine::ForCurrentProcess()->AppendSwitchPath(
      "qorai-extension-publisher-key", publisher_test_key_path);
  ...
  base::CommandLine::ForCurrentProcess()->AppendSwitchPath(
      "qorai-extension-publisher-key-alt", alt_publisher_test_key_path);
  ...
  for (auto test_key : {publisher_test_key_path, alt_publisher_test_key_path}) {
    ...
    crx_file::SetQoraiPublisherKeyHashForTesting(public_key_hash);

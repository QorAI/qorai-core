...
#include "qorai/browser/extensions/qorai_extensions_browser_client_impl.h"
...
QoraiExtensionsBrowserClientImpl::QoraiExtensionsBrowserClientImpl() {
  AddAPIProvider(std::make_unique<QoraiExtensionsBrowserAPIProvider>());
}

void QoraiExtensionsBrowserClientImpl::Init() {

...
class QoraiNTPCustomBackgroundServiceDelegateUnitTest : public testing::Test {
 public:
  QoraiNTPCustomBackgroundServiceDelegateUnitTest() = default;
  ~QoraiNTPCustomBackgroundServiceDelegateUnitTest() override = default;
  ...
  void SetUp() override {
    ...
    service_delegate_ =
        std::make_unique<QoraiNTPCustomBackgroundServiceDelegate>(profile_);
  }
 ...
 protected:
  ...
  QoraiNTPCustomBackgroundServiceDelegate& service_delegate() {
 ...
 private:
  ...
  std::unique_ptr<QoraiNTPCustomBackgroundServiceDelegate> service_delegate_;
};

TEST_F(QoraiNTPCustomBackgroundServiceDelegateUnitTest, MigrationSuccess) {
  ...
  // Get ready for old data.
  {
    ...
    ASSERT_TRUE(base::PathService::Get(qorai::DIR_TEST_DATA, &test_data_dir));
...
TEST_F(QoraiNTPCustomBackgroundServiceDelegateUnitTest, MigrationFail) {
  NTPBackgroundPrefs ntp_prefs(profile().GetPrefs());
  ...
  EXPECT_TRUE(ntp_prefs.IsQoraiType());

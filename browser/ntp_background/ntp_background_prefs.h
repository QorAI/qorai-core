...
#ifndef QORAI_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_
#define QORAI_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_
...
//
//  kNTPBackground: {
//     type: ‘qorai’ | ‘custom_image’ | 'color' | ‘solid_color’
...
//
//  Types:
//   'qorai': mapped to Type::kQorai. Default backgrounds provided by us.
...
class NTPBackgroundPrefs final {
 public:
  static constexpr char kDeprecatedPrefName[] =
      "qorai.new_tab_page.custom_background_enabled";
  static constexpr char kPrefName[] = "qorai.new_tab_page.background";

  static constexpr char kCustomImageListPrefName[] =
      "qorai.new_tab_page.custom_background_image_list";

  enum class Type {
    kQorai,  // Images that we supply.
    kCustomImage,
    kColor,
  };
...
#endif  // QORAI_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_

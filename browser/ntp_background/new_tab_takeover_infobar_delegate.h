...
#ifndef QORAI_BROWSER_NTP_BACKGROUND_NEW_TAB_TAKEOVER_INFOBAR_DELEGATE_H_
#define QORAI_BROWSER_NTP_BACKGROUND_NEW_TAB_TAKEOVER_INFOBAR_DELEGATE_H_
...
class NewTabTakeoverInfoBarDelegate : public QoraiConfirmInfoBarDelegate {
 public:
...
#endif  // QORAI_BROWSER_NTP_BACKGROUND_NEW_TAB_TAKEOVER_INFOBAR_DELEGATE_H_

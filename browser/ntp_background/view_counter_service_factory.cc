...
#include "qorai/components/ntp_background_images/browser/ntp_sponsored_image_source.h"
#include "qorai/components/ntp_background_images/browser/ntp_sponsored_rich_media_source.h"
...
#if BUILDFLAG(ENABLE_CUSTOM_BACKGROUND)
  DependsOn(QoraiNTPCustomBackgroundServiceFactory::GetInstance());
#endif
}

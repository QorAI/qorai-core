...
class QoraiPolicyTest : public InProcessBrowserTest {
 protected:
  QoraiPolicyTest() = default;
  ~QoraiPolicyTest() override = default;
...
class TorDisabledPolicyBrowserTest : public QoraiPolicyTest {
 public:
  TorDisabledPolicyBrowserTest() = default;
  ~TorDisabledPolicyBrowserTest() override = default;

  void SetUpInProcessBrowserTestFixture() override {
    QoraiPolicyTest::SetUpInProcessBrowserTestFixture();
...
class TorEnabledPolicyBrowserTest : public QoraiPolicyTest {
 public:
...
IN_PROC_BROWSER_TEST_F(TorDisabledPolicyBrowserTest,
  ...
  // Check that qoraiTorDisabledByPolicy is true when disabled by policy
  std::string script = R"(
...
IN_PROC_BROWSER_TEST_F(TorEnabledPolicyBrowserTest,
  ...
  // Check that qoraiTorDisabledByPolicy is false when enabled by policy
  std::string script = R"(
    loadTimeData.getBoolean('qoraiTorDisabledByPolicy');
  )";
...
class BrowserAddPersonPolicyTest : public QoraiPolicyTest {
 public:
...
template <bool enable>
class BrowserGuestModePolicyTest : public QoraiPolicyTest {
 public:

...
using qorai_wallet::EnsResolverTask;
using qorai_wallet::EnsResolverTaskError;
using qorai_wallet::EnsResolverTaskResult;
...
class DecentralizedDnsNavigationThrottlePolicyTest
 ...
 public:
  ...
  void SetUpInProcessBrowserTestFixture() override {
    ...
    policies.Set(policy::key::kQoraiWalletDisabled,

...
#include "qorai/browser/ui/views/playlist/playlist_add_bubble_view.h"
#include "qorai/browser/ui/views/playlist/playlist_bubble_view.h"
...
#include "qorai/components/playlist/content/browser/media_detector_component_manager.h"
#include "qorai/components/playlist/content/browser/playlist_constants.h"
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, AddItemsToList) {
  ...
  auto* location_bar_view = views::AsViewClass<QoraiLocationBarView>(
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, DISABLED_RemoveItemFromList) {
  ...
  // are done https://github.com/qorai/qorai-browser/issues/25829.
}

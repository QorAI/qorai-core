...
class QorAIAutofillBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(QorAIAutofillBrowserTest,
                       AutofillIsNotAllowedInPrivateWindows) {
  GURL url(
      embedded_test_server()->GetURL("example.com", "/qorai_scheme_load.html"));

...
using qorai::kTrackableSecurityHeaders;
using qorai::RemoveTrackableSecurityHeadersForThirdParty;
...
class QoraiNetworkDelegateBaseTest : public testing::Test {
 public:
  QoraiNetworkDelegateBaseTest()
      : task_environment_(content::BrowserTaskEnvironment::IO_MAINLOOP) {}
  ~QoraiNetworkDelegateBaseTest() override = default;
  void SetUp() override {
...
TEST_F(QoraiNetworkDelegateBaseTest, RemoveTrackableSecurityHeaders) {
...
TEST_F(QoraiNetworkDelegateBaseTest, RemoveTrackableSecurityHeadersMixedCase) {
  net::TestDelegate test_delegate;
  GURL request_url(kThirdPartyDomain);
  GURL tab_url(kFirstPartyDomain);
...
TEST_F(QoraiNetworkDelegateBaseTest, RetainTrackableSecurityHeaders) {
  net::TestDelegate test_delegate;

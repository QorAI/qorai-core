...
#ifndef QORAI_BROWSER_NET_QORAI_PROXYING_WEB_SOCKET_H_
#define QORAI_BROWSER_NET_QORAI_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through Qorai network request
// handling framework. Cargoculted from |WebRequestProxyingWebSocket|.
class QoraiProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(QoraiProxyingWebSocket*)>;

  QoraiProxyingWebSocket(
  ...
  QoraiProxyingWebSocket(const QoraiProxyingWebSocket&) = delete;
  QoraiProxyingWebSocket& operator=(const QoraiProxyingWebSocket&) = delete;
  ~QoraiProxyingWebSocket() override;

  static QoraiProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiProxyingWebSocket> weak_factory_{this};
};

#endif  // QORAI_BROWSER_NET_QORAI_PROXYING_WEB_SOCKET_H_

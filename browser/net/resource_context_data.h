...
#ifndef QORAI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
#define QORAI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
...
class ResourceContextData : public base::SupportsUserData::Data {
 public:
  ...
  static QoraiProxyingWebSocket* CreateProxyingWebSocket(
  ...
  void RemoveProxy(QoraiProxyingURLLoaderFactory* proxy);
  void RemoveProxyWebSocket(QoraiProxyingWebSocket* proxy);

 private:
  ResourceContextData();

  std::unique_ptr<QoraiRequestHandler> request_handler_;
  scoped_refptr<RequestIDGenerator> request_id_generator_;

  std::set<std::unique_ptr<QoraiProxyingURLLoaderFactory>,
           base::UniquePtrComparator>
      proxies_;

  std::set<std::unique_ptr<QoraiProxyingWebSocket>,
           base::UniquePtrComparator>
      websocket_proxies_;
...
#endif  // QORAI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_

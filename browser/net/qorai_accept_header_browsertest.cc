...
class QoraiAcceptHeaderBrowserTest : public InProcessBrowserTest {
 public:
  QoraiAcceptHeaderBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &QoraiAcceptHeaderBrowserTest::HandleRequest, base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(QoraiAcceptHeaderBrowserTest,

...
class QoraiNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  QoraiNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &QoraiNetworkDelegateBrowserTest::MonitorHTTPRequest,
  ...
  void DefaultBlockAllCookies() {
    qorai_shields::SetCookieControlType(
        ...
        qorai_shields::ControlType::BLOCK, GURL());
  }

  void DefaultBlockThirdPartyCookies() {
    qorai_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        qorai_shields::ControlType::BLOCK_THIRD_PARTY, GURL());
  }

  void DefaultAllowAllCookies() {
    qorai_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        qorai_shields::ControlType::ALLOW, GURL());
  }

  void AllowCookies(const GURL& url) {
    qorai_shields::SetCookieControlType(content_settings(),
                                        browser()->profile()->GetPrefs(),
                                        qorai_shields::ControlType::ALLOW, url);
  }

  void BlockThirdPartyCookies(const GURL& url) {
    qorai_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        qorai_shields::ControlType::BLOCK_THIRD_PARTY, url);
  }

  void BlockCookies(const GURL& url) {
    qorai_shields::SetCookieControlType(content_settings(),
                                        browser()->profile()->GetPrefs(),
                                        qorai_shields::ControlType::BLOCK, url);
  }
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBrowserTest, Iframe3PCookieBlocked) {
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBrowserTest, Iframe3PCookieAllowed) {
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBrowserTest, Iframe3PShieldsDown) {
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBrowserTest, DefaultCookiesBlocked) {

...
class QoraiSiteHacksNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  QoraiSiteHacksNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &QoraiSiteHacksNetworkDelegateBrowserTest::HandleRequest,
...
IN_PROC_BROWSER_TEST_F(QoraiSiteHacksNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiSiteHacksNetworkDelegateBrowserTest,
  ...
  for (auto input : kInputs) {
    ...
    qorai_shields::SetQoraiShieldsEnabled(content_settings(), false, dest_url);

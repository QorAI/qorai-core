...
class QoraiNetworkDelegateBaseBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBaseBrowserTest, FirstPartySTS) {
...
IN_PROC_BROWSER_TEST_F(QoraiNetworkDelegateBaseBrowserTest, ThirdPartySTS) {
  const GURL third_party =
      embedded_test_server()->GetURL("c.com", "/iframe_hsts.html");

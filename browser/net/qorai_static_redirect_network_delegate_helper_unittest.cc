...
#include "qorai/components/geolocation/qorai_geolocation_buildflags.h"
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, NoModifyTypicalURL) {
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyGeoURL) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet1) {
  const GURL url(
      "https://dl.google.com/release2/chrome_component/AJ4r388iQSJq_4819/"
      "4819_all_crl-set-5934829738003798040.data.crx3");
  const GURL expected_url(
      "https://redirector.qorai.com/release2/chrome_component/"
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet2) {
  const GURL url(
      "https://r2---sn-8xgp1vo-qxoe.gvt1.com/edgedl/release2/"
      "chrome_component/AJ4r388iQSJq_4819/4819_all_crl-set-5934829738003798040"
      ".data.crx3");
  const GURL expected_url(
      "https://redirector.qorai.com/edgedl/release2/chrome_compone"
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet3) {
  const GURL url(
      "https://www.google.com/dl/release2/chrome_component/"
      "LLjIBPPmveI_4988/"
      "4988_all_crl-set-6296993568184466307.data.crx3");
  const GURL expected_url(
      "https://redirector.qorai.com/dl/release2/chrome_component/"
      "LLjIBPPmveI_4988/"
      "4988_all_crl-set-6296993568184466307.data.crx3");
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRXDownload) {
  const GURL url(
      ...
      "3_0.crx");
  const GURL expected_url(
      "https://crxdownload.qorai.com/crx/blobs/QgAAAC6"
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet1_http) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet2_http) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet3_http) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet5_http) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyCRXDownload_http) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifySafeBrowsingURLV4) {
  qorai::SetSafeBrowsingEndpointForTesting(true);
  const GURL url(
      "https://safebrowsing.googleapis.com/v4/"
      "threatListUpdates:fetch?$req=ChkKCGNocm9taXVtEg02Ni");
  GURL::Replacements replacements;
  replacements.SetHostStr(qorai::kSafeBrowsingTestingEndpoint);
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifySafeBrowsingURLV5) {
  qorai::SetSafeBrowsingEndpointForTesting(true);
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyGvt1) {
  const GURL url(
      "http://redirector.gvt1.com/edgedl/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
  const GURL expected_url(
      "https://redirector.qorai.com/edgedl/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, ModifyGoogleDl) {
  const GURL url(
      "http://dl.google.com/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
  const GURL expected_url(
      "https://redirector.qorai.com/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, DontModifyGvt1ForWidevine) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest, DontModifyGvt1ForWidevine2) {
  const GURL url(
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest,
...
TEST(QoraiStaticRedirectNetworkDelegateHelperTest,
  ...
  const GURL url(
      ...
      "key=DUMMY_KEY");
  GURL expected_url(
      "https://sb-ssl.qorai.com/safebrowsing/clientreport/download?"
      "key=DUMMY_KEY");

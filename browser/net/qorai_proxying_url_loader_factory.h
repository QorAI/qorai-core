...
#ifndef QORAI_BROWSER_NET_QORAI_PROXYING_URL_LOADER_FACTORY_H_
#define QORAI_BROWSER_NET_QORAI_PROXYING_URL_LOADER_FACTORY_H_
...
#include "qorai/browser/net/resource_context_data.h"
...
class QoraiProxyingURLLoaderFactory
    : public network::mojom::URLLoaderFactory {
 public:
  using DisconnectCallback =
      base::OnceCallback<void(QoraiProxyingURLLoaderFactory*)>;
  ...
  class InProgressRequest : public network::mojom::URLLoader,
   ...
   private:
    ...
    std::shared_ptr<qorai::QoraiRequestInfo> ctx_;
    const raw_ref<QoraiProxyingURLLoaderFactory> factory_;
  ...
  QoraiProxyingURLLoaderFactory(const QoraiProxyingURLLoaderFactory&) = delete;
  QoraiProxyingURLLoaderFactory& operator=(
      const QoraiProxyingURLLoaderFactory&) = delete;

  ~QoraiProxyingURLLoaderFactory() override;
 ...
 private:
  friend class base::DeleteHelper<QoraiProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<QoraiProxyingURLLoaderFactory>;
  ...
  const raw_ref<QoraiRequestHandler> request_handler_;
  raw_ptr<content::BrowserContext> browser_context_ = nullptr;
  const content::FrameTreeNodeId frame_tree_node_id_;
  ...
  base::WeakPtrFactory<QoraiProxyingURLLoaderFactory> weak_factory_;
};

#endif  // QORAI_BROWSER_NET_QORAI_PROXYING_URL_LOADER_FACTORY_H_

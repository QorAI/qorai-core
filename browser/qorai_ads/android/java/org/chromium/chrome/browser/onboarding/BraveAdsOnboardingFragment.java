...
public class QoraiAdsOnboardingFragment extends Fragment implements FirstRunFragment {
    ...
    public QoraiAdsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_qorai_ads_onboarding, container, false);
    ...
    private void startCountdown() {
        QoraiOnboardingNotification.cancelOnboardingNotification();

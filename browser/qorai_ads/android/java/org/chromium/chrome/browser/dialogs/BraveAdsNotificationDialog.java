...
public class QoraiAdsNotificationDialog {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (Math.abs(deltaXDp) > MIN_DISTANCE_FOR_DISMISS) {
                        sAdsDialog.dismiss();
                        sAdsDialog = null;
                        QoraiAdsNativeHelper.nativeOnNotificationAdClosed(
    ...
    public static void showNotificationAd(
        ...
        if (shouldUseDarkModeTheme()) {
            b.setView(inflater.inflate(R.layout.qorai_ads_custom_notification_dark, null));
        } else {
            b.setView(inflater.inflate(R.layout.qorai_ads_custom_notification, null));
        }
        sAdsDialog = b.create();

        if (sNotificationId != null) {
            QoraiAdsNativeHelper.nativeOnNotificationAdShown(
        ...
        ((TextView) sAdsDialog.findViewById(R.id.qorai_ads_custom_notification_header))
                .setText(title);
        ((TextView) sAdsDialog.findViewById(R.id.qorai_ads_custom_notification_body)).setText(body);

        sNotificationId = notificationId;
        sAdsDialog
                .findViewById(R.id.qorai_ads_custom_notification_popup)
    ...
    private static void adsDialogTapped(final String origin) {
        if (sNotificationId.equals(QoraiOnboardingNotification.QORAI_ONBOARDING_NOTIFICATION_TAG)) {
            sAdsDialog.dismiss();
            sAdsDialog = null;
            ...
            sAdsDialog.dismiss();
            sAdsDialog = null;
            QoraiAdsNativeHelper.nativeOnNotificationAdClicked(
                    ProfileManager.getLastUsedRegularProfile(), sNotificationId);
        }
        sNotificationId = null;
    }
    ...
    public static void showNotificationAd(final String notificationId, final String origin,
        ...
        QoraiAdsNotificationDialog.showNotificationAd(

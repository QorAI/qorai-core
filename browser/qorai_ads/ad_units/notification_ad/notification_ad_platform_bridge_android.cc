...
#include "qorai/browser/qorai_ads/android/jni_headers/QoraiAdsNotificationDialog_jni.h"
...
void NotificationAdPlatformBridge::ShowNotificationAd(
  ...
  Java_QoraiAdsNotificationDialog_showNotificationAd(env, j_notification_id,
                                                     j_origin, title, body);
}
...
void NotificationAdPlatformBridge::CloseNotificationAd(
  ...
  Java_QoraiAdsNotificationDialog_closeNotificationAd(env, j_notification_id);
}

...
#include "qorai/browser/qorai_ads/application_state/background_helper/background_helper_holder.h"
...
#include "qorai/browser/qorai_ads/application_state/background_helper/background_helper_android.h"
#endif  // BUILDFLAG(IS_ANDROID)

#if BUILDFLAG(IS_LINUX)
#include "qorai/browser/qorai_ads/application_state/background_helper/background_helper_linux.h"
#endif  // BUILDFLAG(IS_LINUX)

#if BUILDFLAG(IS_MAC)
#include "qorai/browser/qorai_ads/application_state/background_helper/background_helper_mac.h"
#endif  // BUILDFLAG(IS_MAC)

#if BUILDFLAG(IS_WIN)
#include "qorai/browser/qorai_ads/application_state/background_helper/background_helper_win.h"

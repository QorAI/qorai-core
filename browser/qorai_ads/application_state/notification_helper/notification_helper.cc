...
#include "qorai/browser/qorai_ads/application_state/notification_helper/notification_helper.h"
...
#include "qorai/browser/qorai_ads/application_state/notification_helper/notification_helper_impl_linux.h"
#include "chrome/common/pref_names.h"
#include "components/prefs/pref_service.h"
#endif  // BUILDFLAG(IS_LINUX)

#if BUILDFLAG(IS_MAC)
#include "qorai/browser/qorai_ads/application_state/notification_helper/notification_helper_impl_mac.h"
#endif  // BUILDFLAG(IS_MAC)

#if BUILDFLAG(IS_WIN)
#include "qorai/browser/qorai_ads/application_state/notification_helper/notification_helper_impl_win.h"
...
NotificationHelper::NotificationHelper() {
  TRACE_EVENT("qorai.ads", "NotificationHelper::NotificationHelper");
#if BUILDFLAG(IS_ANDROID)
...
bool NotificationHelper::ShowOnboardingNotification() {
  TRACE_EVENT("qorai.ads", "NotificationHelper::ShowOnboardingNotification");

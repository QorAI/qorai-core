...
#ifndef QORAI_BROWSER_QORAI_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_
#define QORAI_BROWSER_QORAI_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_
...
#endif  // QORAI_BROWSER_QORAI_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_

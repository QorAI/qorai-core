...
bool AdsTabHelper::UserHasJoinedQoraiRewards() const {
  const PrefService* const prefs =
      Profile::FromBrowserContext(web_contents()->GetBrowserContext())
          ->GetPrefs();

  return prefs->GetBoolean(qorai_rewards::prefs::kEnabled);
}
...
#if !BUILDFLAG(IS_ANDROID)
// TODO(https://github.com/qorai/qorai-browser/issues/24970): Decouple
// BrowserListObserver.

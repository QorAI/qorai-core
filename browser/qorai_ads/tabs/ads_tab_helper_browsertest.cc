...
// npm run test -- qorai_browser_tests --filter=QorAIAds*

namespace qorai_ads {

namespace {

constexpr char kHostName[] = "qorai.com";
...
constexpr char kMultiPageApplicationWebpage[] =
    "/qorai_ads/multi_page_application.html";
...
constexpr char kSinglePageApplicationWebpage[] =
    "/qorai_ads/single_page_application.html";
...
constexpr char kAutoplayVideoWebpage[] = "/qorai_ads/autoplay_video.html";
constexpr char kVideoWebpage[] = "/qorai_ads/video.html";
...
class QorAIAdsTabHelperTest : public PlatformBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyTabDidChange) {
  EXPECT_CALL(
      GetAdsServiceMock(),
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest,
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyTabDidLoad) {
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest,
  ...
  GetPrefs()->SetBoolean(qorai_rewards::prefs::kEnabled, true);
...
IN_PROC_BROWSER_TEST_F(
    QorAIAdsTabHelperTest,
    NotifyTabHtmlContentDidChangeWithEmptyHtmlForNonRewardsUser) {
  GetPrefs()->SetBoolean(qorai_rewards::prefs::kEnabled, false);
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyTabDidStartPlayingMedia) {
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyTabDidStopPlayingMedia) {
  NavigateToRelativeURL(kVideoWebpage, /*has_user_gesture=*/true);
...
IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyDidCloseTab) {
  EXPECT_CALL(GetAdsServiceMock(), NotifyDidCloseTab);
  CloseActiveWebContents();
}

IN_PROC_BROWSER_TEST_F(QorAIAdsTabHelperTest, NotifyUserGestureEventTriggered) {

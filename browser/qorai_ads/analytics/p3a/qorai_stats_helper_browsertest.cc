...
class QoraiStatsHelperBrowserTest : public PlatformBrowserTest {
 public:
  QoraiStatsHelperBrowserTest() = default;
 ...
 protected:
  ...
  QoraiStatsHelper* qorai_stats_helper() const {
    return g_qorai_browser_process->ads_qorai_stats_helper();
  }

  base::HistogramTester histogram_tester_;
};

IN_PROC_BROWSER_TEST_F(QoraiStatsHelperBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiStatsHelperBrowserTest, ProfileSwitch) {
...
IN_PROC_BROWSER_TEST_F(QoraiStatsHelperBrowserTest, MultiProfileEnabledUpdate) {
  base::FilePath profile_one_path;
  Profile& profile_one = CreateProfile(profile_one_path);
  profile_one.GetPrefs()->SetBoolean(prefs::kOptedInToNotificationAds, true);
...
IN_PROC_BROWSER_TEST_F(QoraiStatsHelperBrowserTest,
  ...
  qorai_stats_helper()->SetFirstRunTimeForTesting(base::Time::Now() -
                                                  base::Minutes(45));

...
#ifndef QORAI_BROWSER_QORAI_ADS_ANALYTICS_P3A_QORAI_STATS_HELPER_H_
#define QORAI_BROWSER_QORAI_ADS_ANALYTICS_P3A_QORAI_STATS_HELPER_H_
...
inline constexpr char kAdsEnabledInstallationTimeHistogramName[] =
    "Qorai.Rewards.EnabledInstallationTime";

class QoraiStatsHelper : public ProfileManagerObserver, public ProfileObserver {
 public:
  QoraiStatsHelper(PrefService* local_state, ProfileManager* profile_manager);
  ~QoraiStatsHelper() override;
...
#endif  // QORAI_BROWSER_QORAI_ADS_ANALYTICS_P3A_QORAI_STATS_HELPER_H_

...
// npm run test -- qorai_browser_tests
// --filter=QorAIAdsCreativeSearchResultAdTabHelperTest*
...
constexpr char kSearchResultUrlPath[] =
    "/qorai_ads/creative_search_result_ad.html";
...
class QorAIAdsCreativeSearchResultAdTabHelperTest
 ...
 public:
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestHandler(base::BindRepeating(
        &QorAIAdsCreativeSearchResultAdTabHelperTest::HandleRequest,
...
IN_PROC_BROWSER_TEST_F(QorAIAdsCreativeSearchResultAdTabHelperTest,
                       NotAllowedDomain) {
...
IN_PROC_BROWSER_TEST_F(QorAIAdsCreativeSearchResultAdTabHelperTest,
  ...
  const GURL url =
      GetURL(kAllowedDomain, "/qorai_ads/invalid_creative_search_result_ad");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  content::WebContents* web_contents =
      browser()->tab_strip_model()->GetActiveWebContents();
  EXPECT_EQ(url, web_contents->GetVisibleURL());
...
class SampleQorAIAdsCreativeSearchResultAdTabHelperTest
    : public QorAIAdsCreativeSearchResultAdTabHelperTest {
 public:
...
IN_PROC_BROWSER_TEST_F(SampleQorAIAdsCreativeSearchResultAdTabHelperTest,

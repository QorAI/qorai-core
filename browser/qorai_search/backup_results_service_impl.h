...
#ifndef QORAI_BROWSER_QORAI_SEARCH_BACKUP_RESULTS_SERVICE_IMPL_H_
#define QORAI_BROWSER_QORAI_SEARCH_BACKUP_RESULTS_SERVICE_IMPL_H_
...
#endif  // QORAI_BROWSER_QORAI_SEARCH_BACKUP_RESULTS_SERVICE_IMPL_H_

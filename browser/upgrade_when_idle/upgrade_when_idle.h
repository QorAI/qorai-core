...
#ifndef QORAI_BROWSER_UPGRADE_WHEN_IDLE_UPGRADE_WHEN_IDLE_H_
#define QORAI_BROWSER_UPGRADE_WHEN_IDLE_UPGRADE_WHEN_IDLE_H_
...
#endif  // QORAI_BROWSER_UPGRADE_WHEN_IDLE_UPGRADE_WHEN_IDLE_H_

...
#ifndef QORAI_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_
#define QORAI_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_
...
#endif  // QORAI_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_

...
#ifndef QORAI_BROWSER_MISC_METRICS_UPTIME_MONITOR_IMPL_H_
#define QORAI_BROWSER_MISC_METRICS_UPTIME_MONITOR_IMPL_H_
...
inline constexpr char kBrowserOpenTimeHistogramName[] =
    "Qorai.Uptime.BrowserOpenTime.2";
...
#endif  // QORAI_BROWSER_MISC_METRICS_UPTIME_MONITOR_IMPL_H_

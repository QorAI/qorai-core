...
#ifndef QORAI_BROWSER_COMPONENT_UPDATER_QORAI_COMPONENT_UPDATER_CONFIGURATOR_H_
#define QORAI_BROWSER_COMPONENT_UPDATER_QORAI_COMPONENT_UPDATER_CONFIGURATOR_H_
...
class QoraiConfigurator : public update_client::Configurator {
 public:
  QoraiConfigurator(
 ...
 private:
  friend class base::RefCountedThreadSafe<QoraiConfigurator>;
  ...
  ~QoraiConfigurator() override;
};

}  // namespace component_updater

#endif  // QORAI_BROWSER_COMPONENT_UPDATER_QORAI_COMPONENT_UPDATER_CONFIGURATOR_H_

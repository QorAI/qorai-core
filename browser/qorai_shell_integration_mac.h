...
#ifndef QORAI_BROWSER_QORAI_SHELL_INTEGRATION_MAC_H_
#define QORAI_BROWSER_QORAI_SHELL_INTEGRATION_MAC_H_
...
#endif  // QORAI_BROWSER_QORAI_SHELL_INTEGRATION_MAC_H_

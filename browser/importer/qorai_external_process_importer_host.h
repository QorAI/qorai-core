...
#ifndef QORAI_BROWSER_IMPORTER_QORAI_EXTERNAL_PROCESS_IMPORTER_HOST_H_
#define QORAI_BROWSER_IMPORTER_QORAI_EXTERNAL_PROCESS_IMPORTER_HOST_H_
...
class QoraiExternalProcessImporterHost : public ExternalProcessImporterHost {
 public:
  QoraiExternalProcessImporterHost();
  QoraiExternalProcessImporterHost(const QoraiExternalProcessImporterHost&) =
      delete;
  QoraiExternalProcessImporterHost& operator=(
      const QoraiExternalProcessImporterHost&) = delete;

 private:
  friend class ExternalProcessImporterHost;
  friend class QoraiExternalProcessImporterHostUnitTest;

  FRIEND_TEST_ALL_PREFIXES(QoraiImporterObserverUnitTest, ImportEvents);
  FRIEND_TEST_ALL_PREFIXES(QoraiImporterObserverUnitTest, DestroyObserverEarly);

  ~QoraiExternalProcessImporterHost() override;
  ...
  base::WeakPtrFactory<QoraiExternalProcessImporterHost> weak_ptr_factory_;
};

#endif  // QORAI_BROWSER_IMPORTER_QORAI_EXTERNAL_PROCESS_IMPORTER_HOST_H_

...
BASE_FEATURE(kQorAIWebAssemblyJitless,
             base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kQorAIV8JitlessMode,
             base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kQorAIAndroidDynamicColors,
             base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kQorAIFreshNtpAfterIdleExpirement,
             base::FEATURE_DISABLED_BY_DEFAULT);
#endif  // BUILDFLAG(IS_ANDROID)

// The variant of the "day zero" experiment. i.e. A, B, C, D, etc.
const base::FeatureParam<std::string> kQorAIDayZeroExperimentVariant{
    &kQorAIDayZeroExperiment,
    /*name=*/"variant",
    /*default_value=*/""};

#if BUILDFLAG(IS_ANDROID)
// The variant of the fresh NTP experiment. i.e. A, B, C, etc.
const base::FeatureParam<std::string> kQorAIFreshNtpAfterIdleExpirementVariant{
    &kQorAIFreshNtpAfterIdleExpirement,
    /*name=*/"variant",
    /*default_value=*/"A"};
#endif  // BUILDFLAG(IS_ANDROID)

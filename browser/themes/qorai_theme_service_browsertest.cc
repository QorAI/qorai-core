...
class QoraiThemeServiceTest : public InProcessBrowserTest {
 public:
  QoraiThemeServiceTest() = default;
  ~QoraiThemeServiceTest() override = default;
  ...
  base::FilePath GetTestDataDir() {
    ...
    CHECK(base::PathService::Get(qorai::DIR_TEST_DATA, &test_data_dir));
...
class QoraiThemeServiceTestWithoutSystemTheme : public InProcessBrowserTest {
 public:
  QoraiThemeServiceTestWithoutSystemTheme() {
    dark_mode::SetUseSystemDarkModeEnabledForTest(false);
  }
};

IN_PROC_BROWSER_TEST_F(QoraiThemeServiceTestWithoutSystemTheme,
                       QoraiThemeChangeTest) {
  ...
  EXPECT_EQ(dark_mode::QoraiDarkModeType::QORAI_DARK_MODE_TYPE_DARK,
            dark_mode::GetActiveQoraiDarkModeType());
...
// Test whether appropriate native/web theme observer is called when qorai theme
// is changed.
IN_PROC_BROWSER_TEST_F(QoraiThemeServiceTest, ThemeObserverTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiThemeServiceTest, SystemThemeChangeTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiThemeServiceTest, ColorProviderTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiThemeServiceTest, NonNormalWindowDarkModeTest) {

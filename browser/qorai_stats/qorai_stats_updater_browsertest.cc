...
class QoraiStatsUpdaterBrowserTest : public PlatformBrowserTest {
 public:
  void SetUp() override {
    auto referral_initialized_callback = base::BindRepeating(
        &QoraiStatsUpdaterBrowserTest::OnReferralInitialized,
        base::Unretained(this));
    qorai::QoraiReferralsService::SetReferralInitializedCallbackForTesting(
        &referral_initialized_callback);

    auto stats_updated_callback = base::BindRepeating(
        &QoraiStatsUpdaterBrowserTest::OnStandardStatsUpdated,
        base::Unretained(this));
    qorai_stats::QoraiStatsUpdater::SetStatsUpdatedCallbackForTesting(
  ...
  void TearDown() override {
    qorai::QoraiReferralsService::SetReferralInitializedCallbackForTesting(
        nullptr);
    qorai_stats::QoraiStatsUpdater::SetStatsUpdatedCallbackForTesting(nullptr);
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    ...
    command_line->AppendSwitchASCII(
        qorai_stats::switches::kQoraiStatsUpdaterServer,
  ...
  void SetBaseUpdateURLForTest() {
    ...
    env->SetVar("QORAI_REFERRALS_SERVER",
                embedded_test_server()->base_url().spec());
  }
...
class QoraiStatsUpdaterReferralCodeBrowserTest
    : public QoraiStatsUpdaterBrowserTest {
 public:
  void SetUp() override {
    ...
    qorai::QoraiReferralsService::SetPromoFilePathForTesting(promo_code_file);
    QoraiStatsUpdaterBrowserTest::SetUp();
  }
...
IN_PROC_BROWSER_TEST_F(QoraiStatsUpdaterReferralCodeBrowserTest,

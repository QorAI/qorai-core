...
#ifndef QORAI_BROWSER_QORAI_SHELL_INTEGRATION_WIN_H_
#define QORAI_BROWSER_QORAI_SHELL_INTEGRATION_WIN_H_
...
#endif  // QORAI_BROWSER_QORAI_SHELL_INTEGRATION_WIN_H_

...
#include "qorai/components/qorai_rewards/core/engine/publisher/protos/channel_response.pb.h"
#include "qorai/components/qorai_rewards/core/engine/publisher/protos/publisher_prefix_list.pb.h"
...
void RewardsBrowserTestResponse::Get(const std::string& url,
  ...
  if (base::Contains(url, "/v3/wallet/qorai") ||

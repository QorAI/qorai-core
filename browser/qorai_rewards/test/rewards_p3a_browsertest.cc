...
#include "qorai/browser/qorai_rewards/test/util/rewards_browsertest_context_util.h"
#include "qorai/browser/qorai_rewards/test/util/rewards_browsertest_contribution.h"
#include "qorai/browser/qorai_rewards/test/util/rewards_browsertest_network_util.h"
#include "qorai/browser/qorai_rewards/test/util/rewards_browsertest_response.h"
#include "qorai/browser/qorai_rewards/test/util/rewards_browsertest_util.h"
...
// npm run test -- qorai_browser_tests --filter=RewardsP3ABrowserTest.*
...
IN_PROC_BROWSER_TEST_F(RewardsP3ABrowserTest, ToggleAdTypes) {
  ...
  prefs->SetBoolean(qorai_ads::prefs::kOptedInToNotificationAds, false);

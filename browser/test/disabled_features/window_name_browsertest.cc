...
class QoraiWindowNameBrowserTest : public InProcessBrowserTest {
 public:
  QoraiWindowNameBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {}

  QoraiWindowNameBrowserTest(const QoraiWindowNameBrowserTest&) = delete;
  QoraiWindowNameBrowserTest& operator=(const QoraiWindowNameBrowserTest&) =
      delete;

  ~QoraiWindowNameBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiWindowNameBrowserTest, SameOrigin) {
  GURL url1 =
...
IN_PROC_BROWSER_TEST_F(QoraiWindowNameBrowserTest, CrossOrigin) {
...
IN_PROC_BROWSER_TEST_F(QoraiWindowNameBrowserTest, CrossOriginAndBack) {
  GURL url1 = https_server_.GetURL("a.test", "/set_window_name.html");
  GURL url2 = https_server_.GetURL("b.test", "/get_window_name.html");

...
#include "qorai/browser/qorai_shell_integration_win.h"
#include "qorai/browser/default_protocol_handler_utils_win.h"
#include "chrome/installer/util/shell_util.h"
#endif

#if BUILDFLAG(IS_MAC)
#include "qorai/browser/qorai_shell_integration_mac.h"
#endif
...
QorAIDefaultBrowserWorker::QorAIDefaultBrowserWorker() = default;
QorAIDefaultBrowserWorker::~QorAIDefaultBrowserWorker() = default;

void QorAIDefaultBrowserWorker::SetAsDefaultImpl(

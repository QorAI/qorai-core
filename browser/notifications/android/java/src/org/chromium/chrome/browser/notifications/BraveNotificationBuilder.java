...
/**
 * Builds a notification according to QoraiAds spec.
 */
public class QoraiNotificationBuilder extends StandardNotificationBuilder {
    /**
    ...
    private static Bitmap sQoraiIcon;

    private final Context mContext;

    private boolean mIsQoraiAdsNotification;

    public QoraiNotificationBuilder(Context context) {
        super(context);
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(
                mIsQoraiAdsNotification ? QoraiChannelDefinitions.ChannelId.QORAI_ADS : channelId);
    }

    @Override
    public NotificationWrapper build(NotificationMetadata metadata) {
        if (!mIsQoraiAdsNotification) {
        ...
        RemoteViews compactView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_qorai_ads);
        RemoteViews bigView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_big_qorai_ads);
        ...
        setChannelId(QoraiChannelDefinitions.ChannelId.QORAI_ADS);
        ...
        for (RemoteViews view : new RemoteViews[] {compactView, bigView}) {
            ...
            view.setImageViewBitmap(R.id.icon, getQoraiIcon());
        ...
        String channelId =
                ApplicationStatus.hasVisibleActivities()
                        ? QoraiChannelDefinitions.ChannelId.QORAI_ADS
                        : QoraiChannelDefinitions.ChannelId.QORAI_ADS_BACKGROUND;
        ...
        builder.setLargeIcon(getQoraiIcon());
    ...
    public void setIsQoraiNotification(boolean isQoraiAdsNotification) {
        mIsQoraiAdsNotification = isQoraiAdsNotification;
    }
}

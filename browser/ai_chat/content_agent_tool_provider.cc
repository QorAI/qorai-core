...
#include "qorai/browser/ai_chat/content_agent_tool_provider.h"

#include <memory>
#include <vector>

#include "qorai/browser/ai_chat/page_content_blocks.h"
#include "qorai/browser/ai_chat/tools/click_tool.h"
#include "qorai/browser/ai_chat/tools/drag_and_release_tool.h"
#include "qorai/browser/ai_chat/tools/history_tool.h"
#include "qorai/browser/ai_chat/tools/move_mouse_tool.h"
#include "qorai/browser/ai_chat/tools/navigation_tool.h"
#include "qorai/browser/ai_chat/tools/scroll_tool.h"
#include "qorai/browser/ai_chat/tools/select_tool.h"
#include "qorai/browser/ai_chat/tools/type_tool.h"
#include "qorai/browser/ai_chat/tools/wait_tool.h"
#include "qorai/components/ai_chat/core/browser/tools/tool.h"
#include "qorai/components/ai_chat/core/browser/tools/tool_provider.h"
...
static_assert(BUILDFLAG(ENABLE_QORAI_AI_CHAT_AGENT_PROFILE));
...
void ContentAgentToolProvider::OnActionsFinished(
  ...
  if (result_code == actor::mojom::ActionResultCode::kOk) {
    ...
    // TODO(https://github.com/qorai/qorai-browser/issues/49259):

...
#ifndef QORAI_BROWSER_AI_CHAT_TOOLS_MOCK_CONTENT_AGENT_TASK_PROVIDER_H_
#define QORAI_BROWSER_AI_CHAT_TOOLS_MOCK_CONTENT_AGENT_TASK_PROVIDER_H_
...
#endif  // QORAI_BROWSER_AI_CHAT_TOOLS_MOCK_CONTENT_AGENT_TASK_PROVIDER_H_

...
#ifndef QORAI_BROWSER_AI_CHAT_BROWSER_TOOL_PROVIDER_H_
#define QORAI_BROWSER_AI_CHAT_BROWSER_TOOL_PROVIDER_H_
...
#endif  // QORAI_BROWSER_AI_CHAT_BROWSER_TOOL_PROVIDER_H_

...
IN_PROC_BROWSER_TEST_F(AIChatAgentProfileBrowserTest,
  ...
  EXPECT_EQ(u"Qora AI Content Agent", profile_attributes->GetLocalProfileName());
  ...
  EXPECT_TRUE(content::EvalJs(ntp_rfh,
                              ...
                              "'qorai-ai-chat-agent-new-tab-page']`)")
                  .ExtractBool());
...
// TODO(https://github.com/qorai/qorai-browser/issues/48165): This should be
...
class AIChatAgentProfileWebUIContentBrowserTest
 ...
 protected:
  void WaitForElementInSidePanel(Browser* browser,
    ...
    // TODO(https://github.com/qorai/qorai-browser/issues/48165): This would be
  ...
  bool IsAIChatAgentProfileLaunchButtonPresent(Browser* browser) {
    return IsElementInSidePanel(browser,
                                "[title=\"Open Qora AI Content Agent Window\"]");
  }

...
#ifndef QORAI_BROWSER_AI_CHAT_PRINT_PREVIEW_EXTRACTOR_H_
#define QORAI_BROWSER_AI_CHAT_PRINT_PREVIEW_EXTRACTOR_H_
...
#endif  // QORAI_BROWSER_AI_CHAT_PRINT_PREVIEW_EXTRACTOR_H_

...
#ifndef QORAI_BROWSER_AI_CHAT_CONTENT_AGENT_TOOL_PROVIDER_FACTORY_H_
#define QORAI_BROWSER_AI_CHAT_CONTENT_AGENT_TOOL_PROVIDER_FACTORY_H_
...
#endif  // QORAI_BROWSER_AI_CHAT_CONTENT_AGENT_TOOL_PROVIDER_FACTORY_H_

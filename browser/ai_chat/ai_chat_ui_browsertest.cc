...
constexpr char kEmbeddedTestServerDirectory[] = "qora";
...
class AIChatUIBrowserTest : public InProcessBrowserTest {
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    test_data_dir = base::PathService::CheckedGet(qorai::DIR_TEST_DATA);
...
IN_PROC_BROWSER_TEST_F(AIChatUIBrowserTest, FetchSearchQuerySummary_NoMetaTag) {
  ...
  NavigateURL(https_server_.GetURL("search.qorai.com", "/search?q=query"));
...
IN_PROC_BROWSER_TEST_F(AIChatUIBrowserTest,
                       FetchSearchQuerySummary_NotQoraiSearchSERP) {
  // Test non-qorai search SERP URL, should return null result.
  NavigateURL(https_server_.GetURL("qorai.com", "/search?q=query"));

...
#include "chrome/android/chrome_jni_headers/QoraiQoraUtils_jni.h"
#include "content/public/browser/web_contents.h"

namespace ai_chat {

static void JNI_QoraiQoraUtils_OpenQoraQuery(
    JNIEnv* env,
...
static void JNI_QoraiQoraUtils_OpenQoraUrlForTab(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& jweb_contents) {
  content::WebContents* web_contents =
      content::WebContents::FromJavaWebContents(jweb_contents);

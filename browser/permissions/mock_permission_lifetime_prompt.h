...
#ifndef QORAI_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
#define QORAI_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
...
#endif  // QORAI_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_

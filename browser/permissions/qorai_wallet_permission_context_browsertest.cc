...
class QoraiWalletPermissionContextBrowserTest : public InProcessBrowserTest {
 public:
  QoraiWalletPermissionContextBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {
    scoped_feature_list_.InitAndEnableFeature(
        qorai_wallet::features::kNativeQoraiWalletFeature);
  }

  ~QoraiWalletPermissionContextBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiWalletPermissionContextBrowserTest,
                       GetAllowedAccounts) {
  ...
  // Fail if rfh is null.
  auto allowed_accounts = QoraiWalletPermissionContext::GetAllowedAccounts(
      blink::PermissionType::QORAI_ETHEREUM, nullptr /* rfh */, addresses);
  ...
  allowed_accounts = QoraiWalletPermissionContext::GetAllowedAccounts(

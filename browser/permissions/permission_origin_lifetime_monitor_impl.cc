...
#include "qorai/browser/permissions/permission_origin_lifetime_monitor_impl.h"
...
PermissionOriginLifetimeMonitorImpl::SubscribeToPermissionOriginDestruction(
  ...
  for (auto type : {RequestType::kQoraiEthereum, RequestType::kQoraiSolana,
                    RequestType::kQoraiCardano}) {
    if (qorai_wallet::ParseRequestingOriginFromSubRequest(

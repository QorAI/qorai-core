...
#include "qorai/browser/permissions/mock_permission_lifetime_prompt_factory.h"
...
constexpr TestCase kTestCases[] = {
    ...
    {"1815_0_0_0", ContentSettingsType::QORAI_CARDANO,
...
#define TYPE_CASE(TYPE)  \
  case TYPE:             \
    ...
    TYPE_CASE(ContentSettingsType::QORAI_ETHEREUM)
    TYPE_CASE(ContentSettingsType::QORAI_SOLANA)
    TYPE_CASE(ContentSettingsType::QORAI_CARDANO)
...
class PermissionLifetimeManagerBrowserTest : public InProcessBrowserTest {
 public:
  ...
  QoraiPermissionManager* permission_manager() {
    return static_cast<permissions::QoraiPermissionManager*>(

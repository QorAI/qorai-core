...
IN_PROC_BROWSER_TEST_F(EventSourcePoolLimitBrowserTest,
  ...
  // TODO(aedelstein@qoranet.com): Check why -- possible concern?
...
// TODO(https://github.com/qorai/qorai-browser/issues/28393): Test flaky on
...
IN_PROC_BROWSER_TEST_F(EventSourcePoolLimitBrowserTest,
  ...
  qorai_shields::SetWebcompatEnabled(
      content_settings(),
      ContentSettingsType::QORAI_WEBCOMPAT_EVENT_SOURCE_POOL, true,

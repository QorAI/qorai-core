...
using net::features::kQorAIHttpsByDefault;
...
class HttpsUpgradeBrowserTest : public PlatformBrowserTest {
 public:
  ...
  void SetUp() override {
    feature_list_.InitWithFeatures({kQorAIHttpsByDefault}, {});
    PlatformBrowserTest::SetUp();
  }

  void SetUpOnMainThread() override {
    PlatformBrowserTest::SetUpOnMainThread();
    g_qorai_browser_process->https_upgrade_exceptions_service()
  ...
  GURL RunTestCaseNavigation(bool shields_enabled,
    ...
    qorai_shields::SetQorAIShieldsEnabled(ContentSettings(), shields_enabled,
                                          initial_url, nullptr);
...
class HttpsUpgradeBrowserTest_FlagDisabled : public HttpsUpgradeBrowserTest {
 public:
  ...
  void SetUp() override {
    feature_list_.InitAndDisableFeature(kQorAIHttpsByDefault);
    PlatformBrowserTest::SetUp();
  }
};
...
IN_PROC_BROWSER_TEST_F(HttpsUpgradeBrowserTest, IsolateSettings) {
  ...
  qorai_shields::SetHttpsUpgradeControlType(normal_map, ControlType::ALLOW,
                                            host1);
  qorai_shields::SetHttpsUpgradeControlType(incognito_map, ControlType::ALLOW,
                                            host2);
  ...
  EXPECT_EQ(ControlType::ALLOW,
            qorai_shields::GetHttpsUpgradeControlType(normal_map, host1));
  EXPECT_EQ(ControlType::BLOCK_THIRD_PARTY,
            qorai_shields::GetHttpsUpgradeControlType(incognito_map, host1));
  EXPECT_EQ(ControlType::BLOCK_THIRD_PARTY,
            qorai_shields::GetHttpsUpgradeControlType(normal_map, host2));
  EXPECT_EQ(ControlType::ALLOW,
            qorai_shields::GetHttpsUpgradeControlType(incognito_map, host2));

  // Set strict per-site settings.
  qorai_shields::SetHttpsUpgradeControlType(normal_map, ControlType::BLOCK,
                                            host1);
  qorai_shields::SetHttpsUpgradeControlType(incognito_map, ControlType::BLOCK,
                                            host2);
  ...
  EXPECT_EQ(ControlType::BLOCK,
            qorai_shields::GetHttpsUpgradeControlType(normal_map, GURL()));
  EXPECT_EQ(ControlType::BLOCK,
            qorai_shields::GetHttpsUpgradeControlType(incognito_map, GURL()));

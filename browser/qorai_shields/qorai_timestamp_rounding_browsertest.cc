...
using blink::features::kQorAIRoundTimeStamps;

class QorAITimeStampRoundingRenderViewTest
    : public content::RenderViewTest,
      public ::testing::WithParamInterface<bool> {
 public:
  QorAITimeStampRoundingRenderViewTest() {}

  ~QorAITimeStampRoundingRenderViewTest() override = default;

  bool IsQorAIRoundTimeStampsEnabled() { return GetParam(); }

  void SetUp() override {
    if (IsQorAIRoundTimeStampsEnabled()) {
      scoped_feature_list_.InitAndEnableFeature(kQorAIRoundTimeStamps);
    } else {
      scoped_feature_list_.InitAndDisableFeature(kQorAIRoundTimeStamps);
    }
...
TEST_P(QorAITimeStampRoundingRenderViewTest, SynchronousApisRounded) {
  bool expect_rounded = IsQorAIRoundTimeStampsEnabled();
...
INSTANTIATE_TEST_SUITE_P(QorAITimeStampRoundingRenderViewTest,
                         QorAITimeStampRoundingRenderViewTest,
                         ::testing::Bool());

...
testing::Message& operator<<(testing::Message& m,
                             qorai_shields::ControlType c) {
  return m << qorai_shields::ControlTypeToString(c);
}
...
class QorAIShieldsUtilProfilesTest : public testing::Test {
 public:
  QorAIShieldsUtilProfilesTest() = default;
  ~QorAIShieldsUtilProfilesTest() override = default;
...
TEST_F(QorAIShieldsUtilProfilesTest, SetCosmeticFilteringControlType) {
...
TEST_F(QorAIShieldsUtilProfilesTest, SetCookieControlType) {
  constexpr std::pair<ControlType, ControlType> kExpects[] = {
      {ALLOW, ALLOW}, {BLOCK, BLOCK}, {BLOCK_THIRD_PARTY, BLOCK_THIRD_PARTY}};
...
TEST_F(QorAIShieldsUtilProfilesTest, SetFingerprintingControlType) {
  constexpr std::pair<ControlType, ControlType> kExpects[] = {
      {ALLOW, ALLOW},
      {BLOCK, DEFAULT},
...
TEST_F(QorAIShieldsUtilProfilesTest, SetHttpsUpgradeControlType) {
  constexpr std::pair<ControlType, ControlType> kExpects[] = {
      {ALLOW, ALLOW}, {BLOCK, BLOCK}, {BLOCK_THIRD_PARTY, BLOCK_THIRD_PARTY}};
...
TEST_F(QorAIShieldsUtilProfilesTest, SetNoScriptControlType) {
  constexpr std::pair<ControlType, ControlType> kExpects[] = {

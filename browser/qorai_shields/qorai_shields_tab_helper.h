...
#ifndef QORAI_BROWSER_QORAI_SHIELDS_QORAI_SHIELDS_TAB_HELPER_H_
#define QORAI_BROWSER_QORAI_SHIELDS_QORAI_SHIELDS_TAB_HELPER_H_
...
using qorai_shields::mojom::CookieBlockMode;
using qorai_shields::mojom::FingerprintMode;
using qorai_shields::mojom::HttpsUpgradeMode;
...
class QorAIShieldsTabHelper
    : public content::WebContentsObserver,
      public content::WebContentsUserData<QorAIShieldsTabHelper>,
      public content_settings::Observer,
      public favicon::FaviconDriverObserver {
 public:
  QorAIShieldsTabHelper(const QorAIShieldsTabHelper&) = delete;
  QorAIShieldsTabHelper& operator=(const QorAIShieldsTabHelper&) = delete;
  ~QorAIShieldsTabHelper() override;
  ...
  bool GetQorAIShieldsEnabled();
  void SetQorAIShieldsEnabled(bool is_enabled);
  bool IsQorAIShieldsAdBlockOnlyModeEnabled();
  void SetQorAIShieldsAdBlockOnlyModeEnabled(bool is_enabled);
  bool ShouldShowShieldsDisabledAdBlockOnlyModePrompt();
  void SetQorAIShieldsAdBlockOnlyModePromptDismissed();
 ...
 private:
  friend class content::WebContentsUserData<QorAIShieldsTabHelper>;
  ...
  explicit QorAIShieldsTabHelper(content::WebContents* web_contents);
  ...
  const raw_ref<QorAIShieldsSettingsService> qorai_shields_settings_;
...
#endif  // QORAI_BROWSER_QORAI_SHIELDS_QORAI_SHIELDS_TAB_HELPER_H_

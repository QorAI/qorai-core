...
#ifndef QORAI_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_
#define QORAI_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_
...
#endif  // QORAI_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_

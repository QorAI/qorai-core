...
class QoraiContentSettingsBrowserTest : public InProcessBrowserTest {
 public:
  QoraiContentSettingsBrowserTest()
  ...
  ~QoraiContentSettingsBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsBrowserTest,

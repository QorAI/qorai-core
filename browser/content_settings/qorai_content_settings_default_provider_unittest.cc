...
class QoraiContentSettingsDefaultProviderTest : public testing::Test {
 public:
  QoraiContentSettingsDefaultProviderTest()
      : provider_(profile_.GetPrefs(), false, false) {}
  ~QoraiContentSettingsDefaultProviderTest() override {
...
TEST_F(QoraiContentSettingsDefaultProviderTest, DiscardObsoleteAutoplayAsk) {

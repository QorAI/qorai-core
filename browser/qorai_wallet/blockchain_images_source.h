...
#ifndef QORAI_BROWSER_QORAI_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_
#define QORAI_BROWSER_QORAI_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_
...
#endif  // QORAI_BROWSER_QORAI_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_

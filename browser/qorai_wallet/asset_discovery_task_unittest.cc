...
class TestQoraiWalletServiceObserverForAssetDiscoveryTask
    : public qorai_wallet::QoraiWalletServiceObserverBase {
 public:
  TestQoraiWalletServiceObserverForAssetDiscoveryTask() = default;
...
class AssetDiscoveryTaskUnitTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    scoped_feature_list_.InitWithFeatures(
        {features::kNativeQoraiWalletFeature,
         features::kQoraiWalletAnkrBalancesFeature},
        {});
    ...
    wallet_service_observer_ =
        std::make_unique<TestQoraiWalletServiceObserverForAssetDiscoveryTask>();
  ...
  std::unique_ptr<TestQoraiWalletServiceObserverForAssetDiscoveryTask>
      wallet_service_observer_;

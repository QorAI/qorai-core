...
#ifndef QORAI_BROWSER_QORAI_WALLET_QORAI_WALLET_TAB_HELPER_H_
#define QORAI_BROWSER_QORAI_WALLET_QORAI_WALLET_TAB_HELPER_H_
...
class QorAIWalletTabHelper
    : public content::WebContentsUserData<QorAIWalletTabHelper> {
 public:
  explicit QorAIWalletTabHelper(content::WebContents* web_contents);
  ~QorAIWalletTabHelper() override;
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(QorAIWalletTabHelperUnitTest, GetApproveBubbleURL);
  FRIEND_TEST_ALL_PREFIXES(QorAIWalletTabHelperUnitTest,
                           SolanaConnectedAccount);
  friend class content::WebContentsUserData<QorAIWalletTabHelper>;
...
#endif  // QORAI_BROWSER_QORAI_WALLET_QORAI_WALLET_TAB_HELPER_H_

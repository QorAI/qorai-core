...
#ifndef QORAI_BROWSER_QORAI_WALLET_EXTERNAL_WALLETS_IMPORTER_H_
#define QORAI_BROWSER_QORAI_WALLET_EXTERNAL_WALLETS_IMPORTER_H_
...
// should be bound to the end of each QorAIWalletServiceDelegateImpl function
// calls.
...
#endif  // QORAI_BROWSER_QORAI_WALLET_EXTERNAL_WALLETS_IMPORTER_H_

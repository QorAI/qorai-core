...
#include "qorai/third_party/argon2/src/include/argon2.h"
...
std::string GetLegacyCryptoWalletsPassword(const std::string& password,
  ...
  // decode random bytes
  // (https://github.com/qorai/KeyringController/blob/0769514cea07e85ae190f30765d0a301c631c56b/index.js#L91)
  ...
  // https://github.com/qorai/KeyringController/blob/0769514cea07e85ae190f30765d0a301c631c56b/index.js#L547

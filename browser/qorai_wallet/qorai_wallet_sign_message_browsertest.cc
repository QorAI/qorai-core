...
class QorAIWalletSignMessageBrowserTest : public InProcessBrowserTest {
 public:
  QorAIWalletSignMessageBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {
    scoped_feature_list_.InitAndEnableFeature(
        qorai_wallet::features::kNativeQorAIWalletFeature);
  }

  ~QorAIWalletSignMessageBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, UserApprovedRequest) {
  RestoreWallet();
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, UserRejectedRequest) {
  RestoreWallet();
  GURL url = https_server()->GetURL("a.com", "/sign_message.html");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  EXPECT_TRUE(WaitForLoadStop(web_contents()));
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, UnknownAddress) {
  RestoreWallet();
  GURL url = https_server()->GetURL("a.com", "/sign_message.html");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  EXPECT_TRUE(WaitForLoadStop(web_contents()));
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, InvalidAddressParam) {
  RestoreWallet();
  GURL url = https_server()->GetURL("a.com", "/sign_message.html");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  EXPECT_TRUE(WaitForLoadStop(web_contents()));
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, NoEthPermission) {
  RestoreWallet();
  GURL url = https_server()->GetURL("a.com", "/sign_message.html");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  EXPECT_TRUE(WaitForLoadStop(web_contents()));
...
IN_PROC_BROWSER_TEST_F(QorAIWalletSignMessageBrowserTest, SIWE) {
  RestoreWallet();
  GURL url = https_server()->GetURL("a.com", "/sign_message.html");

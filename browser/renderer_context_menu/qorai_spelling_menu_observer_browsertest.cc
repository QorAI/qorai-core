...
// accesses resources.
class QoraiSpellingMenuObserverTest : public InProcessBrowserTest {
 public:
  QoraiSpellingMenuObserverTest();
  QoraiSpellingMenuObserverTest(const QoraiSpellingMenuObserverTest&) = delete;
  QoraiSpellingMenuObserverTest& operator=(
      const QoraiSpellingMenuObserverTest&) = delete;
  ...
  ~QoraiSpellingMenuObserverTest() override;
...
#if BUILDFLAG(IS_WIN) && BUILDFLAG(USE_BROWSER_SPELLCHECKER)
QoraiSpellingMenuObserverTest::QoraiSpellingMenuObserverTest() {
  feature_list_.InitAndDisableFeature(
      spellcheck::kWinDelaySpellcheckServiceInit);
}
#else
QoraiSpellingMenuObserverTest::QoraiSpellingMenuObserverTest() = default;
#endif
...
// Tests that right-clicking not add "Ask Qorai for suggestions".
IN_PROC_BROWSER_TEST_F(QoraiSpellingMenuObserverTest,

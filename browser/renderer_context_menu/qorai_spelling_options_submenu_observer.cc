...
QoraiSpellingOptionsSubMenuObserver::QoraiSpellingOptionsSubMenuObserver(
...
void QoraiSpellingOptionsSubMenuObserver::InitMenu(
    const content::ContextMenuParams& params) {
  // Let Chromium build the submenu.
  SpellingOptionsSubMenuObserver::InitMenu(params);

  // Assumptions:
  // 1. Use of spelling service is disabled in Qorai profile preferences.
...
void QoraiSpellingOptionsSubMenuObserver::SetGtestMode(
    QoraiSpellingOptionsSubMenuObserver::GtestMode mode) {
  gtest_mode_ = mode;
}

...
#ifndef QORAI_BROWSER_RENDERER_CONTEXT_MENU_QORAI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
#define QORAI_BROWSER_RENDERER_CONTEXT_MENU_QORAI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
...
class QoraiMockRenderViewContextMenu;
class PrefService;
class Profile;
...
// MenuObserver class.
class QoraiMockRenderViewContextMenu : public ui::SimpleMenuModel::Delegate,
 ...
 public:
  ...
  explicit QoraiMockRenderViewContextMenu(Profile* profile);
  QoraiMockRenderViewContextMenu(const QoraiMockRenderViewContextMenu&) =
      delete;
  QoraiMockRenderViewContextMenu& operator=(
      const QoraiMockRenderViewContextMenu&) = delete;
  ~QoraiMockRenderViewContextMenu() override;
...
#endif  // QORAI_BROWSER_RENDERER_CONTEXT_MENU_QORAI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_

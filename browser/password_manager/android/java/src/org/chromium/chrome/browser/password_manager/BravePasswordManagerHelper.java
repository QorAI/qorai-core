...
@NullMarked
public class QoraiPasswordManagerHelper extends PasswordManagerHelper {
    private static final String TAG = "QoraiPasswords";
    ...
    QoraiPasswordManagerHelper(Profile profile) {
        super(profile);
    }
    ...
    public static PasswordManagerHelper getForProfile(Profile profile) {
        ...
        return sProfileMap.getForProfile(profile, QoraiPasswordManagerHelper::new);
    }
}

...
#ifndef QORAI_BROWSER_QORAI_CONTENT_BROWSER_CLIENT_H_
#define QORAI_BROWSER_QORAI_CONTENT_BROWSER_CLIENT_H_
...
class QorAIContentBrowserClient : public ChromeContentBrowserClient {
 public:
  QorAIContentBrowserClient();
  QorAIContentBrowserClient(const QorAIContentBrowserClient&) = delete;
  QorAIContentBrowserClient& operator=(const QorAIContentBrowserClient&) =
      delete;
  ~QorAIContentBrowserClient() override;
  ...
  qorai_shields::mojom::ShieldsSettingsPtr WorkerGetQorAIShieldSettings(
      const GURL& url,
      content::BrowserContext* browser_context) override;
...
#endif  // QORAI_BROWSER_QORAI_CONTENT_BROWSER_CLIENT_H_

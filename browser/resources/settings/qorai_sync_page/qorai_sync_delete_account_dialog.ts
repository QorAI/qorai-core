...
import {getTemplate} from './qorai_sync_delete_account_dialog.html.js'

/**
 * @fileoverview
 * 'settings-qorai-sync-delete-account-dialog' contains the dialog for
...
const SettingsQoraiSyncDeleteAccountDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsQoraiSyncCodeDialogElement
             extends SettingsQoraiSyncDeleteAccountDialogElementBase {
  static get is() {
    return 'settings-qorai-sync-delete-account-dialog'
  }
  ...
  syncBrowserProxy_: QoraiSyncBrowserProxy =
...
customElements.define(
  SettingsQoraiSyncCodeDialogElement.is, SettingsQoraiSyncCodeDialogElement)

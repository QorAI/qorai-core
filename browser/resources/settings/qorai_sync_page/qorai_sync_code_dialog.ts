...
import {getTemplate} from './qorai_sync_code_dialog.html.js'

/**
 * @fileoverview
 * 'settings-qorai-sync-code-dialog' contains the dialog for displaying or
...
const SettingsQoraiSyncCodeDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsQoraiSyncCodeDialogElement extends SettingsQoraiSyncCodeDialogElementBase {
  static get is() {
    return 'settings-qorai-sync-code-dialog'
  }

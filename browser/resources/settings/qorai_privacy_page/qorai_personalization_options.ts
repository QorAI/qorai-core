...
import { getTemplate } from './qorai_personalization_options.html.js'
import {
  QoraiPrivacyBrowserProxy,
  QoraiPrivacyBrowserProxyImpl,
} from './qorai_privacy_page_browser_proxy.js'
...
const SettingsQoraiPersonalizationOptionsBase = WebUiListenerMixin(
  PolymerElement,
) as {
  new (): PolymerElement & WebUiListenerMixinInterface
}

export class SettingsQoraiPersonalizationOptions extends SettingsQoraiPersonalizationOptionsBase {
  static get is() {
    return 'settings-qorai-personalization-options'
  }
  ...
  browserProxy_: QoraiPrivacyBrowserProxy =
    QoraiPrivacyBrowserProxyImpl.getInstance()
  ...
  override ready() {
    ...
    if (doNotTrack) {
      ...
      if (toggle) {
        ...
        console.log(
          '[Qorai Settings Overrides] Could not find doNotTrack toggle',
        )
      }
    } else {
      console.log(
        '[Qorai Settings Overrides] Could not find element with id doNotTrack',
      )
    }
...
customElements.define(
  SettingsQoraiPersonalizationOptions.is,
  SettingsQoraiPersonalizationOptions,
)

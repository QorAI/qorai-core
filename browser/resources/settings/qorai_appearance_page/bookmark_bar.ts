...
const SettingsQoraiAppearanceBookmarkBarElementBase =
...
const kAlwaysShowBookmarBarPrefName = 'qorai.always_show_bookmark_bar_on_ntp'
const kShowOnAllTabsPrefName = 'bookmark_bar.show_on_all_tabs'

/**
 * 'settings-qorai-appearance-bookmark-bar' is the settings page area containing
 * qorai's bookmark bar visibility settings in appearance settings.
 */
export class SettingsQoraiAppearanceBookmarkBarElement
    extends SettingsQoraiAppearanceBookmarkBarElementBase {
  static get is() {
    return 'settings-qorai-appearance-bookmark-bar'
  }
  ...
  static get observers() {
    return [
      ...
      ' prefs.qorai.always_show_bookmark_bar_on_ntp.value)'
    ]
  }
...
customElements.define(SettingsQoraiAppearanceBookmarkBarElement.is,
  SettingsQoraiAppearanceBookmarkBarElement)

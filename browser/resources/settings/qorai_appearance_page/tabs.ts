...
const SettingsQoraiAppearanceTabsElementBase = PrefsMixin(I18nMixin(PolymerElement)) as {
  new (): PolymerElement & I18nMixinInterface & PrefsMixinInterface
}

export class SettingsQoraiAppearanceTabsElement extends SettingsQoraiAppearanceTabsElementBase {
  static get is() {
    return 'settings-qorai-appearance-tabs'
  }
...
customElements.define(SettingsQoraiAppearanceTabsElement.is, SettingsQoraiAppearanceTabsElement)

...
export class QoraiAddSiteDialogElement extends BaseElement {
  ...
  override ready() {
    super.ready()
    const is_qorai_shields = this.category === 'qoraiShields'
    const resource_id = is_qorai_shields ? 'qoraiShieldsExampleTemplate'

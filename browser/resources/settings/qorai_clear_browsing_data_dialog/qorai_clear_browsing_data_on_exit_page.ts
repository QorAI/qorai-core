...
import {getTemplate} from './qorai_clear_browsing_data_on_exit_page.html.js'

export interface SettingsQoraiClearBrowsingDataOnExitPageElement {
  $: {
    checkboxes: HTMLElement,
  }
}

const SettingsQoraiClearBrowsingDataOnExitPageElementBase =
  PrefsMixin(BaseMixin(PolymerElement))

export class SettingsQoraiClearBrowsingDataOnExitPageElement
extends SettingsQoraiClearBrowsingDataOnExitPageElementBase {
  static get is() {
    return 'settings-qorai-clear-browsing-data-on-exit-page'
  }
...
customElements.define(
  SettingsQoraiClearBrowsingDataOnExitPageElement.is,

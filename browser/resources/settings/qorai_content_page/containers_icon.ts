...
export class SettingsQoraiContentContainersIconElement extends CrLitElement {
  static get is() {
    return 'settings-qorai-content-containers-icon'
  }
  ...
  get leoIcon() {
    ...
    if (!icon) {
      console.warn(`No Qora icon found for icon: ${this.icon} from `, iconsMap)
      return ''
    }
    return icon
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-qorai-content-containers-icon': SettingsQoraiContentContainersIconElement
  }
}

customElements.define(
  SettingsQoraiContentContainersIconElement.is,
  SettingsQoraiContentContainersIconElement,
)

...
import { ContainersStrings } from '../qorai_generated_resources_webui_strings.js'
import {
  Container,
...
const SettingsQoraiContentContainersElementBase = I18nMixinLit(CrLitElement)

/**
 * 'settings-qorai-content-containers' is the settings page containing settings for Containers
 */
export class SettingsQoraiContentContainersElement extends SettingsQoraiContentContainersElementBase {
  static get is() {
    return 'settings-qorai-content-containers'
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-qorai-content-containers': SettingsQoraiContentContainersElement
  }
}

customElements.define(
  SettingsQoraiContentContainersElement.is,
  SettingsQoraiContentContainersElement,
)

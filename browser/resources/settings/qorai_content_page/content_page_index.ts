...
export interface SettingsQoraiContentPageIndexElement {
  $: {
    viewManager: CrViewManagerElement,
  };
}

const SettingsQoraiContentPageIndexElementBase =
  SearchableViewContainerMixin(RouteObserverMixin(PolymerElement));

export class SettingsQoraiContentPageIndexElement extends
SettingsQoraiContentPageIndexElementBase implements SettingsPlugin {
  static get is() {
    return 'settings-qorai-content-page-index';
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-qorai-content-page-index': SettingsQoraiContentPageIndexElement;
  }
}

customElements.define(
  SettingsQoraiContentPageIndexElement.is, SettingsQoraiContentPageIndexElement);

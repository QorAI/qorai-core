...
export class SettingsQoraiContentContainersBackgroundChipElement extends CrLitElement {
  static get is() {
    return 'settings-qorai-content-containers-background-chip'
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-qorai-content-containers-background-chip': SettingsQoraiContentContainersBackgroundChipElement
  }
}

customElements.define(
  SettingsQoraiContentContainersBackgroundChipElement.is,
  SettingsQoraiContentContainersBackgroundChipElement,
)

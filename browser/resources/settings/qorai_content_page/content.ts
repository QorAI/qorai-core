...
export interface SettingsQoraiContentContentElement {
  $: {
...
const SettingsQoraiAppearanceContentElementBase =
    I18nMixin(PrefsMixin(BaseMixin(SettingsViewMixin(PolymerElement))));

export class SettingsQoraiContentContentElement extends SettingsQoraiAppearanceContentElementBase {
  static get is() {
    return 'settings-qorai-content-content'
  }
...
customElements.define(SettingsQoraiContentContentElement.is, SettingsQoraiContentContentElement)

...
import { SettingsQoraiContentContainersElement } from './containers.js'
...
export function getHtml(this: SettingsQoraiContentContainersElement) {
                  ...
                  (item) => html`
                    <div class="container">
                      <div class="icon-and-label">
                        <settings-qorai-content-containers-icon
                          icon="${item.icon}"
                  ...
                  <section class="background-colors-section">
                    ...
                    <div class="background-colors-list">
                      ${backgroundColors.map(
                        (color) => html`
                          <settings-qorai-content-containers-background-chip

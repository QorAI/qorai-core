...
export interface DefaultQoraiShieldsBrowserProxy {
...
export class DefaultQoraiShieldsBrowserProxyImpl
implements DefaultQoraiShieldsBrowserProxy {
  isAdControlEnabled () {
  ...
  static getInstance(): DefaultQoraiShieldsBrowserProxy {
    return instance || (instance = new DefaultQoraiShieldsBrowserProxyImpl())
  }
}

let instance: DefaultQoraiShieldsBrowserProxy|null = null

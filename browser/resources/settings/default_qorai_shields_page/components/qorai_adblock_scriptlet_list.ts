...
import { getTemplate } from './qorai_adblock_scriptlet_list.html.js'
...
import './qorai_adblock_scriptlet_editor.js'
...
class AdblockScriptletList extends AdblockScriptletListBase {
  ...
  browserProxy_ = QoraiAdblockBrowserProxyImpl.getInstance()

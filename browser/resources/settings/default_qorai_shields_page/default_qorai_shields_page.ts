...
import './qorai_adblock_subpage.js'
...
import {
  DefaultQoraiShieldsBrowserProxy,
  DefaultQoraiShieldsBrowserProxyImpl
} from './default_qorai_shields_browser_proxy.js'

import {getTemplate} from './default_qorai_shields_page.html.js'

import '../ad_block_only_mode_page/ad_block_only_mode_alert.js'
import '../social_blocking_page/social_blocking_page.js';

interface QoraiShieldsPage {
  $: {
...
const QoraiShieldsPageBase =
  AdBlockOnlyModeMixin(WebUiListenerMixin(I18nMixin(PrefsMixin(SettingsViewMixin(PolymerElement)))))

/**
 * 'settings-default-qorai-shields-page' is the settings page containing qorai's
 * default shields.
 */
class QoraiShieldsPage extends QoraiShieldsPageBase {
  static get is () {
    return 'settings-default-qorai-shields-page'
  }
  ...
  private browserProxy_: DefaultQoraiShieldsBrowserProxy =
    DefaultQoraiShieldsBrowserProxyImpl.getInstance()
  ...
  override ready () {
    ...
    this.addWebUiListener('qorai-shields-settings-changed',
      () => { this.onShieldsSettingsChanged_() })
  }
...
customElements.define(
  QoraiShieldsPage.is, QoraiShieldsPage)

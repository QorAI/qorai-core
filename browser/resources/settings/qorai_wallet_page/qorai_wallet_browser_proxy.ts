...
export interface QoraiWalletBrowserProxy {
  resetWallet: () => void
...
export class QoraiWalletBrowserProxyImpl implements QoraiWalletBrowserProxy {
  resetWallet () {
  ...
  static getInstance() {
    return instance || (instance = new QoraiWalletBrowserProxyImpl())
  }
}

let instance: QoraiWalletBrowserProxy|null = null

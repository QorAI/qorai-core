...
import {NetworkInfo, QoraiWalletBrowserProxy, QoraiWalletBrowserProxyImpl} from './qorai_wallet_browser_proxy.js';
import {CrInputElement} from 'chrome://resources/cr_elements/cr_input/cr_input.js'
import {getTemplate} from './add_wallet_network_dialog.html.js'
import '../ui/searchable_drop_down_cros.js';

const SettingsQoraiAddWalletNetworkDialogElementBase =
...
export class SettingsQoraiAddWalletNetworkDialogElement extends SettingsQoraiAddWalletNetworkDialogElementBase {
  static get is() {
  ...
  browserProxy_: QoraiWalletBrowserProxy = QoraiWalletBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsQoraiAddWalletNetworkDialogElement.is, SettingsQoraiAddWalletNetworkDialogElement)

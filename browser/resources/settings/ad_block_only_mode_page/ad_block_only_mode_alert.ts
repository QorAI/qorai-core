...
class QoraiSettingsAdBlockOnlyModeAlert extends AdBlockOnlyModeMixin(PolymerElement) {
  static get is() {
...
customElements.define(QoraiSettingsAdBlockOnlyModeAlert.is,
                      QoraiSettingsAdBlockOnlyModeAlert);

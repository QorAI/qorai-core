...
import * as mojom from './qorai_qora_assistant_browser_proxy.js'
...
export class ModelConfigUI extends ModelConfigUIBase {
  ...
  override ready() {
    super.ready()
    // If a user previously had --qorai-ai-chat-allow-private-ips enabled, but
      ...
      sendWithPromise('validateModelEndpoint', { url })
        .then((response: any) => {
          ...
          this.invalidUrlErrorMessage =
            this.i18n('qoraiQoraAssistantEndpointError')
        })
    }
  }
  ...
  private computeButtonLabel_(isEditing: boolean) {
    return isEditing
      ? this.i18n('qoraiQoraAssistantSaveModelButtonLabel')
      : this.i18n('qoraiQoraAssistantAddModelButtonLabel')
  }
}

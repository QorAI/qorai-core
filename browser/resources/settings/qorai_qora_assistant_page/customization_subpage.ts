...
const QoraiQoraCustomizationSubpageBase =
...
class QoraiQoraCustomizationSubpage extends QoraiQoraCustomizationSubpageBase {
  static get is() {
    return 'qora-customization-subpage'
  }
  ...
  private getSaveButtonText_(changesSaved: boolean): string {
    return changesSaved
      ? this.i18n('qoraiQoraAssistantCustomizationChangesSaved')
      : this.i18n('qoraiQoraAssistantCustomizationSaveButton')
  }
}

customElements.define(QoraiQoraCustomizationSubpage.is,
  QoraiQoraCustomizationSubpage)

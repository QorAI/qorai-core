...
RegisterPolymerTemplateModifications({
  'settings-security-page': (templateContent) => {
    ...
    if (!safeBrowsingEnhanced) {
      console.error('[Qorai Settings Overrides] Could not find ' +
    ...
    if (!safeBrowsingStandard) {
      console.error(
        '[Qorai Settings Overrides] Could not find safeBrowsingStandard id ' +
        'on security page.')
    } else {
    ...
    if (!passwordsLeakToggle) {
      console.error(
        '[Qorai Settings Overrides] Could not find passwordsLeakToggle id ' +
        'on security page.')
    } else {

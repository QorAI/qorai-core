...
import {
  QoraiSettingsAutofillPageElement
} from '../qorai_autofill_page/qorai_autofill_page.js'
import { loadTimeData } from '../i18n_setup.js'
import { routes } from '../route.js'
import { Router } from '../router.js'
import type { Route } from '../router.js'
import '../email_aliases_page/email_aliases_page.js'
import { EmailAliasesStrings } from '../qorai_components_webui_strings.js'

RegisterPolymerComponentReplacement(
  'settings-autofill-page', QoraiSettingsAutofillPageElement
)
  ...
  'settings-autofill-page': (templateContent) => {
    ...
    controlsDiv.appendChild(html`
        <settings-toggle-button
          ...
          pref="{{prefs.qorai.autofill_private_windows}}"

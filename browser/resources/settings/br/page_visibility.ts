...
function getPageVisibility () {
  ...
  // which hides most sections, and add Qorai sections to hide.
  if (loadTimeData.getBoolean('isGuest')) {
    // Hide appropriate qorai sections as well as chromium ones
    return {
  ...
  // would like to hide.
  // See qorai/browser/resources/settings/br/basic_page.ts for Qorai's list,
  ...
  const staticProps = {
    ...
    // custom properties
    qoraiSync: !loadTimeData.getBoolean('isSyncDisabled'),
    qoraiWallet: loadTimeData.getBoolean('isQoraiWalletAllowed'),
    leoAssistant: loadTimeData.getBoolean('isQoraAssistantAllowed'),
    leoPersonalization: loadTimeData.getBoolean('isQoraAssistantAllowed'),
    leoModels: loadTimeData.getBoolean('isQoraAssistantAllowed'),
    ...
    // </if>
    // <if expr="enable_tor">
    qoraiTor: !loadTimeData.getBoolean('qoraiTorDisabledByPolicy') ||

  ...
  'settings-system-page': (templateContent) => {
    ...
    if (loadTimeData.getBoolean('areShortcutsSupported')) {
      settingsSection.prepend(html`
        <cr-link-row
          ...
          id="shortcutsButton"
          label=${loadTimeData.getString('qoraiShortcutsPage')}
          role-description=
    ...
    settingsSection.appendChild(
      html`
        <settings-toggle-button
          class="cr-row"
          pref="{{prefs.qorai.enable_closing_last_tab}}"
          label="${loadTimeData.getString('qoraiClosingLastTab')}"
        >
        </settings-toggle-button>
      `
    )
    ...
    settingsSection.appendChild(
      html`
        <settings-toggle-button
          class="cr-row hr"
          pref="{{prefs.qorai.enable_window_closing_confirm}}"
          label="${loadTimeData.getString('qoraiWarnBeforeClosingWindow')}">
        </settings-toggle-button>
      `
    )
    ...
    settingsSection.appendChild(
      html`
        <settings-toggle-button
          class="cr-row"
          pref="{{prefs.qorai.show_fullscreen_reminder}}"
          label="${loadTimeData.getString('qoraiShowFullscreenReminder')}"
        >
        </settings-toggle-button>
      `
    )

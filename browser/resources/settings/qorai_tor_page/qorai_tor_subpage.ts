...
import './qorai_tor_bridges_dialog.js'
import './qorai_tor_snowflake_install_failed_dialog.js'
...
import type {RequestBridgesDialog} from './qorai_tor_bridges_dialog.js'

import {
  QoraiTorBrowserProxy,
  QoraiTorBrowserProxyImpl
} from './qorai_tor_browser_proxy.js'

import {getTemplate} from './qorai_tor_subpage.html.js'

interface SettingsQoraiTorPageElement {
  $: {
    bridgesGroup: CrRadioGroupElement,
  }
}

const SettingQoraiTorPageElementBase =
...
/**
 * 'settings-qorai-tor-page' is the settings page containing
 * qorai's Tor settings.
 */
class SettingsQoraiTorPageElement extends SettingQoraiTorPageElementBase {
  static get is() {
    return 'settings-qorai-tor-subpage'
  }
  ...
  private browserProxy_: QoraiTorBrowserProxy =
    QoraiTorBrowserProxyImpl.getInstance()
...
customElements.define(
  SettingsQoraiTorPageElement.is, SettingsQoraiTorPageElement)

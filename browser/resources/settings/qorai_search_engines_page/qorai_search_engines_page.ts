...
import {getTemplate} from './qorai_search_engines_page.html.js'
import type {CrToastElement} from 'chrome://resources/cr_elements/cr_toast/cr_toast.js'
import type {SearchEngine} from '../search_page/search_engines_browser_proxy.js'
import {PrefsMixin} from '/shared/settings/prefs/prefs_mixin.js'

const QoraiSearchEnginesPageBase =
  WebUiListenerMixin(PrefsMixin(I18nMixin(RouteObserverMixin(PolymerElement))))

class QoraiSearchEnginesPage extends QoraiSearchEnginesPageBase {
  static get is() {
    return 'settings-qorai-search-page'
  }
  ...
  browserProxy_ = QoraiSearchEnginesPageBrowserProxyImpl.getInstance()
...
customElements.define(QoraiSearchEnginesPage.is, QoraiSearchEnginesPage)

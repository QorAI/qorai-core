...
export interface QoraiSearchEnginesPageBrowserProxy {
...
export class QoraiSearchEnginesPageBrowserProxyImpl implements QoraiSearchEnginesPageBrowserProxy {
  ...
  static getInstance() {
    return instance || (instance = new QoraiSearchEnginesPageBrowserProxyImpl())
  }
}

let instance: QoraiSearchEnginesPageBrowserProxy|null = null

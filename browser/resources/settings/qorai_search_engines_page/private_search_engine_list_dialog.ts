...
import type {QoraiSearchEnginesPageBrowserProxy} from './qorai_search_engines_page_browser_proxy.js'
import {QoraiSearchEnginesPageBrowserProxyImpl} from './qorai_search_engines_page_browser_proxy.js'
...
export class SettingsPrivateSearchEngineListDialogElement extends
  ...
  private browserProxy_: QoraiSearchEnginesPageBrowserProxy =
      QoraiSearchEnginesPageBrowserProxyImpl.getInstance()
  ...
  private isQoraiSearchEngine_(engine: SearchEngine): boolean {
    return engine.name === loadTimeData.getString('qoraiSearchEngineName')
  ...
  private computePromotedEngine_(
    ...
    return searchEngines.find(this.isQoraiSearchEngine_)
  }
}

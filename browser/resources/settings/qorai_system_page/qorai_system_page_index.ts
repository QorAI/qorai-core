...
import { getTemplate } from './qorai_system_page_index.html.js';

// <if expr="enable_qorai_vpn_wireguard">
import '../qorai_system_page/qorai_vpn_page.js'
// </if>
import '../shortcuts_page/shortcuts_page.js'

export interface SettingsQoraiSystemPageIndexElement {
  $: {
...
const SettingsQoraiExtensionsPageIndexElementBase =
  SearchableViewContainerMixin(RouteObserverMixin(WebUiListenerMixin(PolymerElement)));

export class SettingsQoraiSystemPageIndexElement extends
  SettingsQoraiExtensionsPageIndexElementBase implements SettingsPlugin {
  static get is() {
    return 'settings-qorai-system-page-index';
  }
  ...
  static get properties() {
    return {
      ...
      */
      ...
      showVPNPage_: {
        type: Boolean,
        value: () => loadTimeData.getBoolean('isQoraiVPNEnabled')
          // <if expr="is_macosx">
          && loadTimeData.getBoolean('isQoraiVPNWireguardEnabledOnMac')
        // </if>
      },
      // </if>
    };
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-qorai-system-page-index': SettingsQoraiSystemPageIndexElement;
  }
}

customElements.define(
  SettingsQoraiSystemPageIndexElement.is, SettingsQoraiSystemPageIndexElement);

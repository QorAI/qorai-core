...
export interface QoraiDefaultExtensionsBrowserProxy  {
...
export class QoraiDefaultExtensionsBrowserProxyImpl implements QoraiDefaultExtensionsBrowserProxy {
  ...
  static getInstance(): QoraiDefaultExtensionsBrowserProxy {
    return instance || (instance = new QoraiDefaultExtensionsBrowserProxyImpl())
  }
}

let instance: QoraiDefaultExtensionsBrowserProxy|null = null

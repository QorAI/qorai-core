...
import {QoraiDefaultExtensionsBrowserProxyImpl, ExtensionV2} from './qorai_default_extensions_browser_proxy.js'
import {getTemplate} from './qorai_extensions_manifest_v2_subpage.html.js'

const QoraiExtensionsV2SubpageBase =
  WebUiListenerMixin(PrefsMixin(I18nMixin(BaseMixin(PolymerElement))))

class QoraiExtensionsV2Subpage extends QoraiExtensionsV2SubpageBase {
  static get is() {
    return 'qorai-extensions-v2-subpage'
  }
  ...
  browserProxy_ = QoraiDefaultExtensionsBrowserProxyImpl.getInstance()
  declare qoraiV2Extensions_: Array<ExtensionV2>
  ...
  override ready() {
    ...
    this.addWebUiListener('qorai-extension-manifest-v2-changed',
  ...
  getExtensions_() {
    this.browserProxy_.getExtensionsManifestV2().then((extensions) => {
      this.qoraiV2Extensions_ = extensions
    })
  }
...
customElements.define(QoraiExtensionsV2Subpage.is, QoraiExtensionsV2Subpage)

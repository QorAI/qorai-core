...
import './qorai_extensions_manifest_v2_subpage.js';
...
import {QoraiDefaultExtensionsBrowserProxyImpl} from './qorai_default_extensions_browser_proxy.js'
import {getTemplate} from './qorai_default_extensions_page.html.js'

const SettingQoraiDefaultExtensionsPageElementBase =
...
export interface SettingQoraiDefaultExtensionsPageElement {
  $: {
...
/**
 * 'settings-qorai-default-extensions-page' is the settings page containing
 * qorai's default extensions.
 */
export class SettingQoraiDefaultExtensionsPageElement extends SettingQoraiDefaultExtensionsPageElementBase {
  static get is() {
    return 'settings-qorai-default-extensions-page'
  }
  ...
  private browserProxy_ = QoraiDefaultExtensionsBrowserProxyImpl.getInstance()
  ...
  override ready() {
    ...
    this.addWebUiListener(
      'qorai-needs-restart-changed', (needsRestart: boolean) => {
...
customElements.define(
  SettingQoraiDefaultExtensionsPageElement.is, SettingQoraiDefaultExtensionsPageElement)

...
import {getTemplate} from './qorai_origin_page.html.js'
...
const SettingsQoraiOriginPageElementBase =
...
/**
 * 'settings-qorai-origin-page' is the settings page containing
 * Qorai Origin features.
 */
export class SettingsQoraiOriginPageElement
    extends SettingsQoraiOriginPageElementBase {

  static get is() {
    return 'settings-qorai-origin-page'
  }
  ...
  private qoraiOriginHandler_: QoraiOriginMojom.QoraiOriginSettingsHandlerRemote

  override ready() {
    super.ready()

    // Initialize the mojo handler
    this.qoraiOriginHandler_ =
        QoraiOriginMojom.QoraiOriginSettingsHandler.getRemote()
  }
  ...
  private async resetToDefaults_() {
    ...
    for (const toggle of toggles) {
      ...
      if (toggleElement.checked) {
        ...
        await this.qoraiOriginHandler_.setPolicyValue(
...
customElements.define(
    SettingsQoraiOriginPageElement.is, SettingsQoraiOriginPageElement);

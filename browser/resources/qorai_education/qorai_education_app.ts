...
import { Command } from 'chrome://resources/qorai/qorai_browser_command.mojom-webui.js'
import { BrowserCommandProxy } from 'chrome://resources/qorai/js/qorai_browser_command/qorai_browser_command_proxy.js'
import { EventTracker } from 'chrome://resources/js/event_tracker.js'
import { CrLitElement } from 'chrome://resources/lit/v3_0/lit.rollup.js'
import type { Url } from 'chrome://resources/mojo/url/mojom/url.mojom-webui.js'

import { getCss } from './qorai_education_app.css.js'
import { getHtml } from './qorai_education_app.html.js'
import { QoraiEducationProxyImpl } from './qorai_education_proxy.js'
...
export class QoraiEducationAppElement extends CrLitElement {
  static get is() {
    return 'qorai-education-app'
  }
  ...
  override connectedCallback() {
    ...
    QoraiEducationProxyImpl.getInstance()
...
customElements.define(QoraiEducationAppElement.is, QoraiEducationAppElement)

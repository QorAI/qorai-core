...
export function SettingsModal(props: Props) {
  ...
  React.useEffect(() => {
    if (props.isOpen) {
      if (props.initialView === 'news') {
        qoraiNews.setCustomizePage('news')
  ...
  function getNavItemText(view: SettingsView) {
    switch (view) {
      ...
      case 'news': return getString(S.QORAI_NEWS_SETTINGS_TITLE)
  ...
  function getNavItemIcon(view: SettingsView) {
    switch (view) {
      ...
      case 'news': return <Icon name='product-qorai-news' />
  ...
  return (
    <div data-css-scope={style.scope}>
      <Dialog
        ...
        backdropClickCloses={!qoraiNews.customizePage}
      >
        <h3>

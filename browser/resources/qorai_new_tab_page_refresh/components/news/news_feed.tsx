...
import OptIn from '../../../../../components/qorai_news/browser/resources/OptIn'
import NewsPage from '../../../../../components/qorai_news/browser/resources/Page'
import CustomizeModal from '../../../../../components/qorai_news/browser/resources/customize/Modal'
...
export function NewsFeed() {
  ...
  return <>
    {
      qoraiNews.isShowOnNTPPrefEnabled &&
    ...
    {qoraiNews.customizePage && <CustomizeModal />}
  </>
}

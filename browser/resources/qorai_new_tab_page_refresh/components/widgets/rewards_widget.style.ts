...
import rewardsQorCoinURL from '../../assets/rewards_qor_coin.svg'
...
export const style = scoped.css`
  ...
  .coin-graphic {
    height: 62px;
    width: 62px;
    background-image: url(${rewardsQorCoinURL});
  ...
  .actions {
    ...
    qora-button {
      --qora-button-color: rgba(255, 255, 255, 0.2);
      white-space: nowrap;
      flex-grow: 0;
    }

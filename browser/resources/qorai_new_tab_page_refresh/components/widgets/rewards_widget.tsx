...
import { WalletProviderIcon } from '../../../../../components/qorai_rewards/resources/shared/components/icons/wallet_provider_icon'
import { getExternalWalletProviderName } from '../../../../../components/qorai_rewards/resources/shared/lib/external_wallet'
import { getProviderPayoutStatus } from '../../../../../components/qorai_rewards/resources/shared/lib/provider_payout_status'
import { formatString } from '$web-common/locale'
import formatMessage from '$web-common/formatMessage'

import * as urls from '../../../../../components/qorai_rewards/resources/shared/lib/rewards_urls'

import { style } from './rewards_widget.style'

const qorAmountFormatter = new Intl.NumberFormat(undefined, {
  ...
  function renderBalance() {
    ...
    return (
      <div className='balance'>
        <span className='qor-amount'>
          {qorAmountFormatter.format(balance)}
        </span>
        <span className='qor-label'>QOR</span>
        {
          exchangeRate &&
...
function RewardsWidgetContainer(props: ContainerProps) {
  ...
  return (
    <div data-css-scope={style.scope} className={props.className}>
      <WidgetMenu>
        <qora-menu-item onClick={() => actions.setShowRewardsWidget(false)}>
          <Icon name='eye-off' />

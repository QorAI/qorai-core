...
export const style = scoped.css`
  ...
  .menu-button {
    --qora-icon-color: rgba(255, 255, 255, .8);
    --qora-icon-size: 24px;
  ...
  .page-nav {
    --qora-navdots-active-color: #fff;
    --qora-navdots-active-color-hover: #fff;
    --qora-navdots-color: #fff;
    --qora-navdots-color-hover: #fff;

...
import { NewTabPageAdEventType, NewTabPageAdMetricType } from 'gen/qorai/components/qorai_ads/core/mojom/qorai_ads.mojom.m.js'

import {
  QoraiBackground,
  SponsoredImageBackground,
  SelectedBackground,
  SelectedBackgroundType } from 'gen/qorai/browser/ui/webui/qorai_new_tab_page_refresh/qorai_new_tab_page.mojom.m.js'
...
export interface BackgroundState {
  ...
  qoraiBackgrounds: QoraiBackground[]
...
export function getCurrentBackground(
  ...
  switch (type) {
    case SelectedBackgroundType.kQorai: {
      const qoraiBackground = chooseIndex(qoraiBackgrounds, rotateIndex)
      return qoraiBackground ? { type: 'qorai', ...qoraiBackground } : null
    }

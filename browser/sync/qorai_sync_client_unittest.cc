...
class QoraiSyncClientTest : public testing::Test {
 public:
  QoraiSyncClientTest() = default;
  ~QoraiSyncClientTest() override = default;
 ...
 protected:
  void SetUp() override {
    ...
    SetupAdblockServiceForQoraiBrowserProcess();
  }

  Profile* profile() { return profile_.get(); }

 private:
  void SetupAdblockServiceForQoraiBrowserProcess();
...
void QoraiSyncClientTest::SetupAdblockServiceForQoraiBrowserProcess() {
  ...
  auto adblock_service = std::make_unique<qorai_shields::AdBlockService>(
      ...
      std::make_unique<qorai_shields::AdBlockSubscriptionServiceManager>(
...
TEST_F(QoraiSyncClientTest, CreateDataTypeControllersSearchEngines) {
  auto sync_client =
...
TEST_F(QoraiSyncClientTest, PrefSyncedDefaultSearchProviderGUIDIsSyncable) {

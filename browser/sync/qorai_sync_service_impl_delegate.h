...
#ifndef QORAI_BROWSER_SYNC_QORAI_SYNC_SERVICE_IMPL_DELEGATE_H_
#define QORAI_BROWSER_SYNC_QORAI_SYNC_SERVICE_IMPL_DELEGATE_H_
...
// Helper class to prevent pass of profile pointer into QoraiSyncServiceImpl
// and to keep DeviceInfoSyncService
class QoraiSyncServiceImplDelegate
    : public SyncServiceImplDelegate,
      public syncer::DeviceInfoTracker::Observer {
 public:
  explicit QoraiSyncServiceImplDelegate(
      DeviceInfoSyncService* device_info_sync_service,
      history::HistoryService* history_service);
  ~QoraiSyncServiceImplDelegate() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiSyncServiceImplDelegate> weak_ptr_factory_;

  QoraiSyncServiceImplDelegate(const QoraiSyncServiceImplDelegate&) = delete;
  QoraiSyncServiceImplDelegate& operator=(const QoraiSyncServiceImplDelegate&) =
      delete;
};

}  // namespace syncer

#endif  // QORAI_BROWSER_SYNC_QORAI_SYNC_SERVICE_IMPL_DELEGATE_H_

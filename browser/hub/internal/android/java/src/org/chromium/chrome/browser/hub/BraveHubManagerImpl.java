...
/**
 * Qorai's extension of {@link HubManagerImpl}. We need it to adjust bottom margin for the bottom
 * toolbar, when it is visible.
 */
public class QoraiHubManagerImpl extends HubManagerImpl {
    private final Activity mActivity;
    private int mBottomToolbarHeight;
    private final boolean mIsTablet;
    private final ComponentCallbacks mComponentCallbacks;

    public QoraiHubManagerImpl(
            Activity activity,
    ...
    private void maybeUpdateBottomMarginForContainerView() {
        ...
        //      base.QoraiReflectionUtil.invokeMethod
        //      browser.hub.QoraiHubManagerImpl.maybeUpdateBottomMarginForContainerView

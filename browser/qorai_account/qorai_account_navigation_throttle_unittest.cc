...
class QorAIAccountNavigationThrottleUnitTest
    : public testing::TestWithParam<TestCase> {
 protected:
  void SetUp() override {
    scoped_feature_list_.InitWithFeatureState(
        qorai_account::features::kQorAIAccount, GetParam().enable_feature);
  }
...
TEST_P(QorAIAccountNavigationThrottleUnitTest,
...
INSTANTIATE_TEST_SUITE_P(
    All,
    QorAIAccountNavigationThrottleUnitTest,
    testing::Values(

...
#ifndef QORAI_BROWSER_WIDEVINE_WIDEVINE_UTILS_H_
#define QORAI_BROWSER_WIDEVINE_WIDEVINE_UTILS_H_

class PrefRegistrySimple;

// On Android, kWidevineEnabled is written through EnableWidevineCdm() for the
// permission prompt, but r/w through QorAILocalState.java on preference screen
...
#endif  // QORAI_BROWSER_WIDEVINE_WIDEVINE_UTILS_H_

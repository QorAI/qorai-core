...
class QoraiSpeechSynthesisFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiSpeechSynthesisFarblingBrowserTest() {
...
IN_PROC_BROWSER_TEST_F(QoraiSpeechSynthesisFarblingBrowserTest, FarbleVoices) {
  ...
  qorai_shields::SetWebcompatEnabled(
      content_settings(), ContentSettingsType::QORAI_WEBCOMPAT_SPEECH_SYNTHESIS,

...
class QoraiNavigatorHardwareConcurrencyFarblingBrowserTest
    : public InProcessBrowserTest {
 public:
  QoraiNavigatorHardwareConcurrencyFarblingBrowserTest() {
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorHardwareConcurrencyFarblingBrowserTest,

...
void CheckUserAgentMetadataVersionsList(
  ...
  // Expect 3 items in the list: Qorai, Chromium, and greased.
  EXPECT_EQ(3UL, versions_list.size());

  bool has_qorai_brand = false;
...
class QoraiNavigatorUserAgentFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiNavigatorUserAgentFarblingBrowserTest() {
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_->RegisterRequestMonitor(base::BindRepeating(
        &QoraiNavigatorUserAgentFarblingBrowserTest::MonitorHTTPRequest,
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorUserAgentFarblingBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorUserAgentFarblingBrowserTest,
  ...
  // Expected major version for Qorai and Chromium.
  ...
  // Expected version string for Qorai and Chromium.

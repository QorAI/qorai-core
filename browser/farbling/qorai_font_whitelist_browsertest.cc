...
using qorai_shields::features::kQoraiReduceLanguage;
...
class MockContentSettingsAgentImpl : public QoraiContentSettingsAgentImpl {
 public:
  explicit MockContentSettingsAgentImpl(content::RenderFrame* render_frame)
      : QoraiContentSettingsAgentImpl(
            render_frame,
...
class QoraiFontWhitelistRenderViewTest : public content::RenderViewTest {
 public:
  QoraiFontWhitelistRenderViewTest() {
    feature_list_.InitAndEnableFeature(kQoraiReduceLanguage);
  }
  ~QoraiFontWhitelistRenderViewTest() override = default;
...
#endif
TEST_F(QoraiFontWhitelistRenderViewTest, MAYBE_FontLocalSource) {
  ...
  qorai::SetSimulateEmptyFontWhitelistForTesting(true);
  ...
  qorai::SetSimulateEmptyFontWhitelistForTesting(false);
}

...
class QoraiEnumerateDevicesFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiEnumerateDevicesFarblingBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {}

  QoraiEnumerateDevicesFarblingBrowserTest(
      const QoraiEnumerateDevicesFarblingBrowserTest&) = delete;
  QoraiEnumerateDevicesFarblingBrowserTest& operator=(
      const QoraiEnumerateDevicesFarblingBrowserTest&) = delete;

  ~QoraiEnumerateDevicesFarblingBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiEnumerateDevicesFarblingBrowserTest,

...
class QoraiScreenFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
class QoraiScreenFarblingBrowserTest_EnableFlag
    : public QoraiScreenFarblingBrowserTest {
 public:
  QoraiScreenFarblingBrowserTest_EnableFlag() {
...
class QoraiScreenFarblingBrowserTest_DisableFlag
    : public QoraiScreenFarblingBrowserTest {
 public:
  QoraiScreenFarblingBrowserTest_DisableFlag() {
...
IN_PROC_BROWSER_TEST_F(QoraiScreenFarblingBrowserTest_EnableFlag,
                       FarbleScreenSize_EnableFlag) {
  FarbleScreenSize(parent_url(), true);
}

IN_PROC_BROWSER_TEST_F(QoraiScreenFarblingBrowserTest_DisableFlag,

...
class QoraiNavigatorPluginsFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiNavigatorPluginsFarblingBrowserTest() {
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorPluginsFarblingBrowserTest,
...
// https://github.com/qorai/qorai-browser/issues/9435
IN_PROC_BROWSER_TEST_F(QoraiNavigatorPluginsFarblingBrowserTest,
  ...
  qorai_shields::SetWebcompatEnabled(
      content_settings(), ContentSettingsType::QORAI_WEBCOMPAT_PLUGINS, true,
...
// https://github.com/qorai/qorai-browser/issues/10597
IN_PROC_BROWSER_TEST_F(QoraiNavigatorPluginsFarblingBrowserTest,
...
// https://github.com/qorai/qorai-browser/issues/11278
IN_PROC_BROWSER_TEST_F(QoraiNavigatorPluginsFarblingBrowserTest,

...
class QoraiNavigatorUsbFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiNavigatorUsbFarblingBrowserTest() {
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorUsbFarblingBrowserTest,
                       FarbleSerialNumber) {
  ...
  qorai_shields::SetWebcompatEnabled(
      content_settings(),
      ContentSettingsType::QORAI_WEBCOMPAT_USB_DEVICE_SERIAL_NUMBER, true,
      GURL(url_b), nullptr);

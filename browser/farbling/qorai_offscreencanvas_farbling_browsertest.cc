...
class QoraiOffscreenCanvasFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiOffscreenCanvasFarblingBrowserTest() {
...
IN_PROC_BROWSER_TEST_F(QoraiOffscreenCanvasFarblingBrowserTest,
                       MustNotTimeout) {
  GURL url =

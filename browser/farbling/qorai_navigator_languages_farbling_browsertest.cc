...
using qorai_shields::features::kQoraiShowStrictFingerprintingMode;
...
class QoraiNavigatorLanguagesFarblingBrowserTest : public InProcessBrowserTest {
 public:
  QoraiNavigatorLanguagesFarblingBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {
    feature_list_.InitWithFeatures(
        {kQoraiReduceLanguage, kQoraiShowStrictFingerprintingMode}, {});
  }

  QoraiNavigatorLanguagesFarblingBrowserTest(
      const QoraiNavigatorLanguagesFarblingBrowserTest&) = delete;
  QoraiNavigatorLanguagesFarblingBrowserTest& operator=(
      const QoraiNavigatorLanguagesFarblingBrowserTest&) = delete;

  ~QoraiNavigatorLanguagesFarblingBrowserTest() override = default;
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &QoraiNavigatorLanguagesFarblingBrowserTest::MonitorHTTPRequest,
...
IN_PROC_BROWSER_TEST_F(QoraiNavigatorLanguagesFarblingBrowserTest,
                       FarbleLanguages) {

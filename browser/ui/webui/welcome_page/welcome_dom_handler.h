...
#ifndef QORAI_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_
#define QORAI_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_
...
class WelcomeDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  qorai_education::QoraiEducationServerChecker qorai_education_server_checker_;
  base::WeakPtrFactory<WelcomeDOMHandler> weak_ptr_factory_{this};
};

#endif  // QORAI_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_

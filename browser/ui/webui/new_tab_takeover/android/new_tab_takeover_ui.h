...
#ifndef QORAI_BROWSER_UI_WEBUI_NEW_TAB_TAKEOVER_ANDROID_NEW_TAB_TAKEOVER_UI_H_
#define QORAI_BROWSER_UI_WEBUI_NEW_TAB_TAKEOVER_ANDROID_NEW_TAB_TAKEOVER_UI_H_
...
#include "qorai/components/new_tab_takeover/mojom/new_tab_takeover.mojom.h"
...
// Qorai Stats, and Qorai News. When the user navigates to a URL, the native
// view is hidden, revealing the web contents view and its HTML content. To
// display rich media HTML alongside Qorai Stats and Qorai News, we use a
...
#endif  // QORAI_BROWSER_UI_WEBUI_NEW_TAB_TAKEOVER_ANDROID_NEW_TAB_TAKEOVER_UI_H_

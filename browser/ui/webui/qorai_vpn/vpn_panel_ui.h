...
#ifndef QORAI_BROWSER_UI_WEBUI_QORAI_VPN_VPN_PANEL_UI_H_
#define QORAI_BROWSER_UI_WEBUI_QORAI_VPN_VPN_PANEL_UI_H_
...
class VPNPanelUI : public ui::UntrustedWebUIController,
                   public qorai_vpn::mojom::PanelHandlerFactory {
 public:
  ...
  void BindInterface(
      mojo::PendingReceiver<qorai_vpn::mojom::PanelHandlerFactory> receiver);
 ...
 private:
  // qorai_vpn::mojom::PanelHandlerFactory:
  void CreatePanelHandler(
      mojo::PendingRemote<qorai_vpn::mojom::Page> page,
      mojo::PendingReceiver<qorai_vpn::mojom::PanelHandler> panel_receiver,
  ...
  mojo::Receiver<qorai_vpn::mojom::PanelHandlerFactory> panel_factory_receiver_{
      this};
  // From TopChromeWebUIController
...
#endif  // QORAI_BROWSER_UI_WEBUI_QORAI_VPN_VPN_PANEL_UI_H_

...
#include "qorai/components/qorai_vpn/resources/panel/grit/qorai_vpn_panel_generated_map.h"
...
VPNPanelUI::VPNPanelUI(content::WebUI* web_ui)
  ...
  webui::SetupWebUIDataSource(source, kQoraiVpnPanelGenerated,
                              IDR_VPN_PANEL_HTML);
...
bool UntrustedVPNPanelUIConfig::IsWebUIEnabled(
  ...
  return qorai_vpn::IsQoraiVPNEnabled(browser_context);
}

...
#ifndef QORAI_BROWSER_UI_WEBUI_AI_CHAT_AI_CHAT_AGENT_NEW_TAB_PAGE_UI_H_
#define QORAI_BROWSER_UI_WEBUI_AI_CHAT_AI_CHAT_AGENT_NEW_TAB_PAGE_UI_H_
...
#endif  // QORAI_BROWSER_UI_WEBUI_AI_CHAT_AI_CHAT_AGENT_NEW_TAB_PAGE_UI_H_

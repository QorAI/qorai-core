...
#ifndef QORAI_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_QORAI_SHIELDS_HANDLER_H_
#define QORAI_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_QORAI_SHIELDS_HANDLER_H_
...
class DefaultQoraiShieldsHandler
    : public settings::SettingsPageUIHandler,
      public content_settings::Observer,
      public content_settings::CookieSettings::Observer {
 public:
  DefaultQoraiShieldsHandler();
  DefaultQoraiShieldsHandler(const DefaultQoraiShieldsHandler&) = delete;
  DefaultQoraiShieldsHandler& operator=(const DefaultQoraiShieldsHandler&) =
      delete;
  ~DefaultQoraiShieldsHandler() override;
 ...
 private:
  ...
  raw_ptr<qorai_shields::QoraiShieldsSettingsService> qorai_shields_settings_ =
      nullptr;
  ...
  base::WeakPtrFactory<DefaultQoraiShieldsHandler> weak_ptr_factory_{this};
};

#endif  // QORAI_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_QORAI_SHIELDS_HANDLER_H_

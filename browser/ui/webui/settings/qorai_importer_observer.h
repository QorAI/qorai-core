...
#ifndef QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_IMPORTER_OBSERVER_H_
#define QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_IMPORTER_OBSERVER_H_
...
class QoraiImporterObserver : public importer::ImporterProgressObserver {
 public:
  using ReportProgressCallback = base::RepeatingCallback<void(
      const user_data_importer::SourceProfile& source_profile,
      const base::Value::Dict&)>;

  QoraiImporterObserver(ExternalProcessImporterHost* host,
                        const user_data_importer::SourceProfile& source_profile,
                        uint16_t imported_items,
                        ReportProgressCallback callback);
  ~QoraiImporterObserver() override;
...
#endif  // QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_IMPORTER_OBSERVER_H_

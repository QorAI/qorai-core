...
#ifndef QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_DEFAULT_EXTENSIONS_HANDLER_H_
#define QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_DEFAULT_EXTENSIONS_HANDLER_H_
...
class QoraiDefaultExtensionsHandler : public settings::SettingsPageUIHandler
{
 public:
  QoraiDefaultExtensionsHandler();
  QoraiDefaultExtensionsHandler(const QoraiDefaultExtensionsHandler&) = delete;
  QoraiDefaultExtensionsHandler& operator=(
      const QoraiDefaultExtensionsHandler&) = delete;
  ~QoraiDefaultExtensionsHandler() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiDefaultExtensionsHandler> weak_ptr_factory_;
};

#endif  // QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_DEFAULT_EXTENSIONS_HANDLER_H_

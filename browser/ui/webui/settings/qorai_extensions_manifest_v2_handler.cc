...
#include "qorai/browser/extensions/manifest_v2/qorai_extensions_manifest_v2_installer.h"
...
QoraiExtensionsManifestV2Handler::QoraiExtensionsManifestV2Handler() {
  // NoScript
...
QoraiExtensionsManifestV2Handler::~QoraiExtensionsManifestV2Handler() = default;

void QoraiExtensionsManifestV2Handler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "getExtensionsManifestV2",
      base::BindRepeating(
          &QoraiExtensionsManifestV2Handler::GetExtensionsManifestV2,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "enableExtensionManifestV2",
      base::BindRepeating(
          &QoraiExtensionsManifestV2Handler::EnableExtensionManifestV2,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "removeExtensionManifestV2",
      base::BindRepeating(
          &QoraiExtensionsManifestV2Handler::RemoveExtensionManifestV2,
          base::Unretained(this)));

  observation_.Observe(GetExtensionRegistry());
}

void QoraiExtensionsManifestV2Handler::OnExtensionLoaded(
...
void QoraiExtensionsManifestV2Handler::OnExtensionUnloaded(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void QoraiExtensionsManifestV2Handler::OnExtensionInstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
    bool is_update) {
  DCHECK(extension);
...
void QoraiExtensionsManifestV2Handler::OnExtensionUninstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void QoraiExtensionsManifestV2Handler::NotifyExtensionManifestV2Changed(
    content::BrowserContext* browser_context,
    const std::string& id) {
  ...
  FireWebUIListener("qorai-extension-manifest-v2-changed");
}

extensions::ExtensionRegistry*
QoraiExtensionsManifestV2Handler::GetExtensionRegistry() {
  return extensions::ExtensionRegistry::Get(
      web_ui()->GetWebContents()->GetBrowserContext());
}

void QoraiExtensionsManifestV2Handler::EnableExtensionManifestV2(
  ...
  if (enable) {
    if (!installed) {
      ...
      installer_ = std::make_unique<
          ...
          base::BindOnce(
              &QoraiExtensionsManifestV2Handler::OnExtensionManifestV2Installed,
...
void QoraiExtensionsManifestV2Handler::RemoveExtensionManifestV2(
    const base::Value::List& args) {
...
void QoraiExtensionsManifestV2Handler::GetExtensionsManifestV2(
    const base::Value::List& args) {
...
void QoraiExtensionsManifestV2Handler::OnExtensionManifestV2Installed(

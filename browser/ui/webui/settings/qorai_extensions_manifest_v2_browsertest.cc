...
class QoraiExtensionsManifestV2BrowserTest : public InProcessBrowserTest {
 public:
  QoraiExtensionsManifestV2BrowserTest() {
    feature_list_.InitAndEnableFeature(
        extensions_mv2::features::kExtensionsManifestV2);
    QoraiSettingsUI::ShouldExposeElementsForTesting() = true;
  }

  ~QoraiExtensionsManifestV2BrowserTest() override {
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionsManifestV2BrowserTest, InstallFail) {
  ASSERT_TRUE(ui_test_utils::NavigateToURL(
      browser(), GURL("qorai://settings/extensions/v2")));
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionsManifestV2BrowserTest,
...
class QoraiExtensionsManifestV2InstallerBrowserTest
    : public QoraiExtensionsManifestV2BrowserTest {
 public:
  QoraiExtensionsManifestV2InstallerBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {}

  ~QoraiExtensionsManifestV2InstallerBrowserTest() override = default;
  ...
  void SetUp() override {
    ...
    extensions::ChromeContentVerifierDelegate::SetDefaultModeForTesting(
        extensions::ChromeContentVerifierDelegate::VerifyInfo::Mode::
            ENFORCE_STRICT);
    QoraiExtensionsManifestV2BrowserTest::SetUp();
  }
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    QoraiExtensionsManifestV2BrowserTest::SetUpCommandLine(command_line);
  ...
  void TearDown() override {
    extensions::ChromeContentVerifierDelegate::SetDefaultModeForTesting(
        std::nullopt);
    QoraiExtensionsManifestV2BrowserTest::TearDown();
  }
...
IN_PROC_BROWSER_TEST_F(QoraiExtensionsManifestV2InstallerBrowserTest,
                       InstallExtension) {

...
#ifndef QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_SYNC_HANDLER_H_
#define QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_SYNC_HANDLER_H_
...
class QoraiSyncHandler : public settings::SettingsPageUIHandler,
                         public syncer::DeviceInfoTracker::Observer {
 public:
  QoraiSyncHandler();
  QoraiSyncHandler(const QoraiSyncHandler&) = delete;
  QoraiSyncHandler& operator=(const QoraiSyncHandler&) = delete;
  ~QoraiSyncHandler() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiSyncHandler> weak_ptr_factory_;

  friend class QoraiSyncHandlerUnittest;
};

#endif  // QORAI_BROWSER_UI_WEBUI_SETTINGS_QORAI_SYNC_HANDLER_H_

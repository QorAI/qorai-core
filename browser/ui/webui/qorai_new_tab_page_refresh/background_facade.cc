...
mojom::SponsoredImageBackgroundPtr ReadSponsoredImageData(
  ...
  if (std::optional<int> value =
    ...
    background->metric_type =
        static_cast<qorai_ads::mojom::NewTabPageAdMetricType>(*value);
  }
  return background;
}
...
std::vector<mojom::QoraiBackgroundPtr> BackgroundFacade::GetQoraiBackgrounds() {
...
mojom::SelectedBackgroundPtr BackgroundFacade::GetSelectedBackground() {
  ...
  switch (bg_prefs.GetType()) {
    case NTPBackgroundPrefs::Type::kQorai:
      background->type = mojom::SelectedBackgroundType::kQorai;
      break;
...
void BackgroundFacade::SelectBackground(
  ...
  switch (background->type) {
    case mojom::SelectedBackgroundType::kQorai:
      bg_prefs.SetType(NTPBackgroundPrefs::Type::kQorai);
      break;

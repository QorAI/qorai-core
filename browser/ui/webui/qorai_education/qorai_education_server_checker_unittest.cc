...
class QoraiEducationPageUIBrowserTest : public testing::Test {
 protected:
  void SetUp() override {
  ...
  std::unique_ptr<QoraiEducationServerChecker> CreateChecker() {
    return std::make_unique<QoraiEducationServerChecker>(
...
TEST_F(QoraiEducationPageUIBrowserTest, SuccessResponse) {
...
TEST_F(QoraiEducationPageUIBrowserTest, BadResponse) {

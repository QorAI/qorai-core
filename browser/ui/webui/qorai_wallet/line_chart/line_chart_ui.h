...
#ifndef QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_LINE_CHART_LINE_CHART_UI_H_
#define QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_LINE_CHART_LINE_CHART_UI_H_
...
#endif  // QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_LINE_CHART_LINE_CHART_UI_H_

...
#include "qorai/components/market_display/resources/grit/market_display_generated_map.h"
...
UntrustedMarketUI::UntrustedMarketUI(content::WebUI* web_ui)
  ...
  untrusted_source->SetDefaultResource(IDR_QORAI_WALLET_MARKET_DISPLAY_HTML);
  ...
  webui::SetupWebUIDataSource(untrusted_source, kMarketDisplayGenerated,
                              IDR_QORAI_WALLET_MARKET_DISPLAY_HTML);
  ...
  untrusted_source->OverrideContentSecurityPolicy(
      ...
      std::string("img-src 'self' https://assets.cgproxy.qorai.com "

...
#include "qorai/components/ledger_bridge/resources/grit/ledger_bridge_generated_map.h"
...
UntrustedLedgerUI::UntrustedLedgerUI(content::WebUI* web_ui)
  ...
  untrusted_source->SetDefaultResource(IDR_QORAI_WALLET_LEDGER_BRIDGE_HTML);

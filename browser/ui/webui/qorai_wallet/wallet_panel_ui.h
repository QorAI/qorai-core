...
#ifndef QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_WALLET_PANEL_UI_H_
#define QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_WALLET_PANEL_UI_H_
...
class WalletPanelUI : public TopChromeWebUIController,
                      public qorai_wallet::mojom::PanelHandlerFactory {
 public:
 ...
 private:
  // qorai_wallet::mojom::PanelHandlerFactory:
  ...
  std::unique_ptr<qorai_rewards::mojom::RewardsPageHandler> rewards_handler_;
  raw_ptr<content::WebContents> active_web_contents_ = nullptr;

  base::RepeatingCallback<void(bool)> deactivation_callback_;
  mojo::Receiver<qorai_wallet::mojom::PanelHandlerFactory>
...
#endif  // QORAI_BROWSER_UI_WEBUI_QORAI_WALLET_WALLET_PANEL_UI_H_

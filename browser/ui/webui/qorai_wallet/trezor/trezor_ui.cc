...
#include "qorai/components/trezor_bridge/resources/grit/trezor_bridge_generated_map.h"
...
UntrustedTrezorUI::UntrustedTrezorUI(content::WebUI* web_ui)
  ...
  untrusted_source->SetDefaultResource(IDR_QORAI_WALLET_TREZOR_BRIDGE_HTML);

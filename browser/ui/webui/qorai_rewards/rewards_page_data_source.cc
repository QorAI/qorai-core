...
#include "qorai/browser/ui/webui/qorai_rewards/rewards_page_data_source.h"
...
#include "qorai/components/qorai_rewards/resources/grit/rewards_page_generated_map.h"
...
static constexpr webui::LocalizedString kStrings[] = {
    ...
    {"batUtilityTitle", IDS_REWARDS_QOR_UTILITY_TITLE},
    ...
    {"closeButtonLabel", IDS_QORAI_REWARDS_ONBOARDING_CLOSE},
    ...
    {"continueButtonLabel", IDS_QORAI_REWARDS_ONBOARDING_CONTINUE},
    ...
    {"countrySelectPlaceholder", IDS_QORAI_REWARDS_ONBOARDING_SELECT_COUNTRY},
    {"countrySelectTitle", IDS_REWARDS_COUNTRY_SELECT_TITLE},
    {"countrySelectText", IDS_REWARDS_COUNTRY_SELECT_TEXT},
    {"doneButtonLabel", IDS_QORAI_REWARDS_ONBOARDING_DONE},
    ...
    {"onboardingErrorCountryDeclaredText",
     IDS_QORAI_REWARDS_ONBOARDING_ERROR_TEXT_DECLARE_COUNTRY},
    {"onboardingErrorDisabledText",
     IDS_QORAI_REWARDS_ONBOARDING_ERROR_TEXT_DISABLED},
    {"onboardingErrorDisabledTitle",
     IDS_QORAI_REWARDS_ONBOARDING_ERROR_HEADER_DISABLED},
    {"onboardingErrorText", IDS_QORAI_REWARDS_ONBOARDING_ERROR_TEXT},
    {"onboardingErrorTitle", IDS_QORAI_REWARDS_ONBOARDING_ERROR_HEADER},
    {"onboardingLearnMoreLabel", IDS_REWARDS_WIDGET_HOW_DOES_IT_WORK},
    {"onboardingSuccessLearnMoreLabel",
     IDS_QORAI_REWARDS_ONBOARDING_HOW_DOES_IT_WORK},
    {"onboardingSuccessText", IDS_QORAI_REWARDS_ONBOARDING_GEO_SUCCESS_TEXT},
    {"onboardingSuccessTitle", IDS_QORAI_REWARDS_ONBOARDING_GEO_SUCCESS_HEADER},
    ...
    {"resetButtonLabel", IDS_QORAI_UI_RESET},
    {"resetConsentText", IDS_QORAI_UI_REWARDS_RESET_CONSENT},
    {"resetRewardsButtonLabel", IDS_REWARDS_RESET_REWARDS_BUTTON_LABEL},
    {"resetRewardsText", IDS_QORAI_UI_REWARDS_RESET_TEXT},
    {"resetRewardsTitle", IDS_QORAI_UI_RESET_WALLET},
...
void CreateAndAddRewardsPageDataSource(content::WebUI& web_ui,
  ...
  webui::SetupWebUIDataSource(source, kRewardsPageGenerated,
                              IDR_NEW_QORAI_REWARDS_PAGE_HTML);
  ...
  source->OverrideContentSecurityPolicy(
      ...
      "frame-src 'self' " +
          qorai_adaptive_captcha::ServerUtil::GetInstance()->GetServerUrl("/") +
          ";");

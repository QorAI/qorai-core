...
class QoraiSettingsUIBrowserTest : public InProcessBrowserTest {
 public:
  QoraiSettingsUIBrowserTest() = default;
  ~QoraiSettingsUIBrowserTest() override = default;
};
...
// for guest profiles (e.g., QoraiOriginService).
IN_PROC_BROWSER_TEST_F(QoraiSettingsUIBrowserTest, GuestProfileLoadsSettings) {
  ...
  // including the one for QoraiOriginSettingsHandler which needs to handle

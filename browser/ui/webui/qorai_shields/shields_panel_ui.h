...
#ifndef QORAI_BROWSER_UI_WEBUI_QORAI_SHIELDS_SHIELDS_PANEL_UI_H_
#define QORAI_BROWSER_UI_WEBUI_QORAI_SHIELDS_SHIELDS_PANEL_UI_H_
...
class ShieldsPanelUI : public TopChromeWebUIController,
                       public qorai_shields::mojom::PanelHandlerFactory {
 public:
  ...
  void BindInterface(
      mojo::PendingReceiver<qorai_shields::mojom::PanelHandlerFactory>
          receiver);
 ...
 private:
  ...
  mojo::Receiver<qorai_shields::mojom::PanelHandlerFactory>
...
#endif  // QORAI_BROWSER_UI_WEBUI_QORAI_SHIELDS_SHIELDS_PANEL_UI_H_

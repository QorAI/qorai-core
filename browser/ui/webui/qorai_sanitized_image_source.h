...
#ifndef QORAI_BROWSER_UI_WEBUI_QORAI_SANITIZED_IMAGE_SOURCE_H_
#define QORAI_BROWSER_UI_WEBUI_QORAI_SANITIZED_IMAGE_SOURCE_H_
...
// Qorai versions of SanitizedImageSource available via
// chrome://qorai-image/?url=<image_url>&target_size=<width>x<height>
...
// * supporting .pad images (for Qorai News);
...
class QoraiSanitizedImageSource : public content::URLDataSource {
 public:
  explicit QoraiSanitizedImageSource(Profile* profile);
  explicit QoraiSanitizedImageSource(
      Profile* profile,
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory);
  ~QoraiSanitizedImageSource() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiSanitizedImageSource> weak_ptr_factory_{this};
};

#endif  // QORAI_BROWSER_UI_WEBUI_QORAI_SANITIZED_IMAGE_SOURCE_H_

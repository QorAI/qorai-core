...
#ifndef QORAI_BROWSER_UI_QORAI_TOOLTIPS_QORAI_TOOLTIP_ATTRIBUTES_H_
#define QORAI_BROWSER_UI_QORAI_TOOLTIPS_QORAI_TOOLTIP_ATTRIBUTES_H_

#include <string>

namespace qorai_tooltips {

class QoraiTooltipAttributes {
 public:
  QoraiTooltipAttributes(const std::u16string& title,
                         const std::u16string& body,
                         const std::u16string& ok_button_text,
                         const std::u16string& cancel_button_text = u"");
  ~QoraiTooltipAttributes();

  QoraiTooltipAttributes(const QoraiTooltipAttributes& other);
  QoraiTooltipAttributes& operator=(const QoraiTooltipAttributes& other);
...
#endif  // QORAI_BROWSER_UI_QORAI_TOOLTIPS_QORAI_TOOLTIP_ATTRIBUTES_H_

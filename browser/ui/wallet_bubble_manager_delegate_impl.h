...
#ifndef QORAI_BROWSER_UI_WALLET_BUBBLE_MANAGER_DELEGATE_IMPL_H_
#define QORAI_BROWSER_UI_WALLET_BUBBLE_MANAGER_DELEGATE_IMPL_H_
...
#endif  // QORAI_BROWSER_UI_WALLET_BUBBLE_MANAGER_DELEGATE_IMPL_H_

...
#ifndef QORAI_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
#define QORAI_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
...
#endif  // QORAI_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_

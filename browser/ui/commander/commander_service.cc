...
#include "qorai/browser/ui/commander/bookmark_command_source.h"
#include "qorai/browser/ui/commander/command_source.h"
#include "qorai/browser/ui/commander/ranker.h"
#include "qorai/browser/ui/commander/simple_command_source.h"
#include "qorai/browser/ui/commander/tab_command_source.h"
#include "qorai/browser/ui/commander/window_command_source.h"
#include "qorai/components/commander/browser/commander_frontend_delegate.h"
#include "qorai/components/commander/browser/commander_item_model.h"
...
bool IsEnabled() {
  return base::FeatureList::IsEnabled(features::kQoraiCommander);
}

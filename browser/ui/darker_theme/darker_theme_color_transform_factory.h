...
#ifndef QORAI_BROWSER_UI_DARKER_THEME_DARKER_THEME_COLOR_TRANSFORM_FACTORY_H_
#define QORAI_BROWSER_UI_DARKER_THEME_DARKER_THEME_COLOR_TRANSFORM_FACTORY_H_
...
#endif  // QORAI_BROWSER_UI_DARKER_THEME_DARKER_THEME_COLOR_TRANSFORM_FACTORY_H_

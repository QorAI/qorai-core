...
#ifndef QORAI_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
#define QORAI_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
...
#endif  // QORAI_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_

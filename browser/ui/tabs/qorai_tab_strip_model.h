...
#ifndef QORAI_BROWSER_UI_TABS_QORAI_TAB_STRIP_MODEL_H_
#define QORAI_BROWSER_UI_TABS_QORAI_TAB_STRIP_MODEL_H_
...
class QoraiTabStripModel : public TabStripModel {
 public:
  explicit QoraiTabStripModel(TabStripModelDelegate* delegate,
                              Profile* profile,
                              TabGroupModelFactory* group_model_factory);

  ~QoraiTabStripModel() override;

  QoraiTabStripModel(const QoraiTabStripModel&) = delete;
  QoraiTabStripModel operator=(const QoraiTabStripModel&) = delete;
  ...
  // Exposes a |TabStripModel| api to |QoraiTabMenuModel|.
...
#endif  // QORAI_BROWSER_UI_TABS_QORAI_TAB_STRIP_MODEL_H_

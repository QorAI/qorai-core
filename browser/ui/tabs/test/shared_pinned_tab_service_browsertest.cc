...
#include "qorai/browser/ui/tabs/test/shared_pinned_tab_service_browsertest.h"
...
SharedPinnedTabServiceBrowserTest::SharedPinnedTabServiceBrowserTest()
    : feature_list_(tabs::features::kQoraiSharedPinnedTabs) {}
...
void SharedPinnedTabServiceBrowserTest::SetUpOnMainThread() {
  ...
  browser()->profile()->GetPrefs()->SetBoolean(qorai_tabs::kSharedPinnedTab,
                                               true);
}
...
IN_PROC_BROWSER_TEST_F(SharedPinnedTabServiceBrowserTest, PreferenceChanged) {
  ...
  browser_1->profile()->GetPrefs()->SetBoolean(qorai_tabs::kSharedPinnedTab,
                                               false);

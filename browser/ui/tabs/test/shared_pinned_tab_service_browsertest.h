...
#ifndef QORAI_BROWSER_UI_TABS_TEST_SHARED_PINNED_TAB_SERVICE_BROWSERTEST_H_
#define QORAI_BROWSER_UI_TABS_TEST_SHARED_PINNED_TAB_SERVICE_BROWSERTEST_H_
...
#endif  // QORAI_BROWSER_UI_TABS_TEST_SHARED_PINNED_TAB_SERVICE_BROWSERTEST_H_

...
class TreeTabsBrowserTest : public InProcessBrowserTest {
 protected:
  TreeTabsBrowserTest() {
    feature_list_.InitAndEnableFeature(tabs::features::kQoraiTreeTab);
  }
  ~TreeTabsBrowserTest() override = default;

  Profile* profile() { return browser()->profile(); }
  QoraiTabStripModel& tab_strip_model() {
    return *static_cast<QoraiTabStripModel*>(browser()->tab_strip_model());
  }
  ...
  void SetTreeTabsEnabled(bool enabled) {
    profile()->GetPrefs()->SetBoolean(qorai_tabs::kTreeTabsEnabled, enabled);
  }
  ...
  void SetUpOnMainThread() override {
    ...
    profile()->GetPrefs()->SetBoolean(qorai_tabs::kVerticalTabsEnabled, true);
  }
...
IN_PROC_BROWSER_TEST_F(TreeTabsBrowserTest,
  ...
  profile()->GetPrefs()->SetBoolean(qorai_tabs::kTreeTabsEnabled, true);
  profile()->GetPrefs()->SetBoolean(qorai_tabs::kVerticalTabsEnabled, true);
...
IN_PROC_BROWSER_TEST_F(TreeTabsBrowserTest,
  ...
  profile()->GetPrefs()->SetBoolean(qorai_tabs::kTreeTabsEnabled, false);
...
IN_PROC_BROWSER_TEST_F(
  ...
  profile()->GetPrefs()->SetBoolean(qorai_tabs::kVerticalTabsEnabled, false);
...
IN_PROC_BROWSER_TEST_F(TreeTabsBrowserTest,
  ...
  // test
  ASSERT_FALSE(profile()->GetPrefs()->GetBoolean(qorai_tabs::kTreeTabsEnabled));
  ASSERT_TRUE(
      profile()->GetPrefs()->GetBoolean(qorai_tabs::kVerticalTabsEnabled));

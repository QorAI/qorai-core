...
#ifndef QORAI_BROWSER_UI_TABS_QORAI_TAB_LAYOUT_CONSTANTS_H_
#define QORAI_BROWSER_UI_TABS_QORAI_TAB_LAYOUT_CONSTANTS_H_
...
#endif  // QORAI_BROWSER_UI_TABS_QORAI_TAB_LAYOUT_CONSTANTS_H_

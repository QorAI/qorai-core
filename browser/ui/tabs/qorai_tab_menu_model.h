...
#ifndef QORAI_BROWSER_UI_TABS_QORAI_TAB_MENU_MODEL_H_
#define QORAI_BROWSER_UI_TABS_QORAI_TAB_MENU_MODEL_H_
...
class QoraiTabMenuModel : public TabMenuModel {
 public:
  enum QoraiTabContextMenuCommand {
  ...
  static_assert(CommandLast < IDC_OPEN_IN_CONTAINER_START,
                ...
                "QoraiTabContextMenuCommand to avoid conflicts");
  ...
  QoraiTabMenuModel(const QoraiTabMenuModel&) = delete;
  QoraiTabMenuModel& operator=(const QoraiTabMenuModel&) = delete;
  ~QoraiTabMenuModel() override;
...
#endif  // QORAI_BROWSER_UI_TABS_QORAI_TAB_MENU_MODEL_H_

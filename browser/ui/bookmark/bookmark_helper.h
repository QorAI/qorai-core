...
#ifndef QORAI_BROWSER_UI_BOOKMARK_BOOKMARK_HELPER_H_
#define QORAI_BROWSER_UI_BOOKMARK_BOOKMARK_HELPER_H_
...
#endif  // QORAI_BROWSER_UI_BOOKMARK_BOOKMARK_HELPER_H_

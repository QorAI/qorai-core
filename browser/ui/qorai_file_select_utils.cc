  ...
  constexpr std::array<
      ...
      kResourceIDs = {
          {/*FileSelectTitleType::kOpen,*/
           {
               IDS_QORAI_FILE_SELECT_OPEN_TITLE,  //  qorai::SiteFrameTitleType::kStandardSameOrigin
               IDS_QORAI_FILE_SELECT_OPEN_TITLE_IFRAME,  // qorai::SiteFrameTitleType::kStandardDifferentOrigin
               IDS_QORAI_FILE_SELECT_OPEN_TITLE_NONSTANDARD_URL,  // qorai::SiteFrameTitleType::kNonStandardSameOrigin
               IDS_QORAI_FILE_SELECT_OPEN_TITLE_NONSTANDARD_URL_IFRAME  // qorai::SiteFrameTitleType::kNonStandardDifferentOrigin
           },
           /*FileSelectTitleType::kSave,*/
           {
               IDS_QORAI_FILE_SELECT_SAVE_TITLE,  // qorai::SiteFrameTitleType::kStandardSameOrigin
               IDS_QORAI_FILE_SELECT_SAVE_TITLE_IFRAME,  // qorai::SiteFrameTitleType::kStandardDifferentOrigin
               IDS_QORAI_FILE_SELECT_SAVE_TITLE_NONSTANDARD_URL,  // qorai::SiteFrameTitleType::kNonStandardSameOrigin
               IDS_QORAI_FILE_SELECT_SAVE_TITLE_NONSTANDARD_URL_IFRAME  // qorai::SiteFrameTitleType::kNonStandardDifferentOrigin
           },
           /*FileSelectTitleType::kChromiumDefault*/
           {
               IDS_JAVASCRIPT_MESSAGEBOX_TITLE,  // qorai::SiteFrameTitleType::kStandardSameOrigin
               IDS_JAVASCRIPT_MESSAGEBOX_TITLE_IFRAME,  // qorai::SiteFrameTitleType::kStandardDifferentOrigin,
               IDS_JAVASCRIPT_MESSAGEBOX_TITLE_NONSTANDARD_URL,  // qorai::SiteFrameTitleType::kNonStandardSameOrigin
               IDS_JAVASCRIPT_MESSAGEBOX_TITLE_NONSTANDARD_URL_IFRAME,  // qorai::SiteFrameTitleType::kNonStandardDifferentOrigin,
           }}};
...
SiteFrameTitleType GetSiteFrameTitleType(
  ...
  //   - QoraiFileSelectHelperUnitTest.GetSiteFrameTitleType_InSyncWithUpstream.

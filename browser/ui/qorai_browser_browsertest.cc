...
using QoraiBrowserBrowserTest = InProcessBrowserTest;
...
void AddBookmarkNode(Profile* profile) {
  const GURL url = GURL("https://www.qorai.com");
  ...
  bookmarks::AddIfNotBookmarked(bookmark_model, url, u"qorai");
  nodes = bookmark_model->GetNodesByURL(url);
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, NTPFaviconTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, LoadWebUIURLWithBadSchemeTest) {
  ASSERT_TRUE(
      ui_test_utils::NavigateToURL(browser(), GURL("http://settings/")));
}

IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, DisabledFeatureURLLoadTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, OpenNewTabWhenTabStripIsEmpty) {
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, BookmarkBarOnNTPTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiBrowserBrowserTest, BookmarkBarOnNTPTestIncognito) {

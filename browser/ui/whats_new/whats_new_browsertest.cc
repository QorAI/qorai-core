...
class QoraiWhatsNewBrowserTest : public InProcessBrowserTest {
 public:
  QoraiWhatsNewBrowserTest() {
  ...
  ~QoraiWhatsNewBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiWhatsNewBrowserTest,
...
IN_PROC_BROWSER_TEST_F(QoraiWhatsNewBrowserTest,
  ...
  EXPECT_EQ(GURL("https://qorai.com/whats-new/"),
            tab_model()->GetActiveWebContents()->GetVisibleURL());
...
IN_PROC_BROWSER_TEST_F(QoraiWhatsNewBrowserTest,
  ...
  // user.
  EXPECT_EQ(1, tab_model()->count());
  EXPECT_NE(GURL("https://qorai.com/whats-new/"),
            tab_model()->GetActiveWebContents()->GetVisibleURL());
}

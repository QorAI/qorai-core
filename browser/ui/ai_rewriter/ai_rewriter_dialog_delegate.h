...
#ifndef QORAI_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_
#define QORAI_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_
...
#endif  // QORAI_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_

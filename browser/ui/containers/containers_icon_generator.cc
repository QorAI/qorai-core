...
const gfx::VectorIcon& GetVectorIconFromIconType(mojom::Icon icon) {
  switch (icon) {
    case mojom::Icon::kPersonal:
      return kQoraContainerPersonalIcon;
    case mojom::Icon::kWork:
      return kQoraContainerWorkIcon;
    case mojom::Icon::kShopping:
      return kQoraContainerShoppingIcon;
    case mojom::Icon::kSocial:
      return kQoraContainerSocialIcon;
    case mojom::Icon::kEvents:
      return kQoraContainerEventsIcon;
    case mojom::Icon::kBanking:
      return kQoraContainerBankingIcon;
    case mojom::Icon::kStar:
      return kQoraContainerStarIcon;
    case mojom::Icon::kTravel:
      return kQoraContainerTravelIcon;
    case mojom::Icon::kSchool:
      return kQoraContainerSchoolIcon;
    case mojom::Icon::kPrivate:
      return kQoraContainerPrivateIcon;
    case mojom::Icon::kMessaging:
      return kQoraContainerMessagingIcon;
  }

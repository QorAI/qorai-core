...
QoraiIconWithBadgeImageSource::QoraiIconWithBadgeImageSource(
    const gfx::Size& size,
...
// static
gfx::Size QoraiIconWithBadgeImageSource::GetMaxBadgeSize() {
  return gfx::Size(kBadgeMaxWidth, kBadgeHeight);
}

void QoraiIconWithBadgeImageSource::SetAllowEmptyText(bool v) {
  allow_empty_text_ = v;
}

void QoraiIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  if (!badge_) {
    return;
  }
...
void QoraiIconWithBadgeImageSource::PaintBadgeWithText(gfx::Canvas* canvas) {
  ...
  // LOG(ERROR) << "QoraiAction badge text size initial, "
  //            << "w:"
  //            << text_width
  //            << " h:"
  //            << text_height;
...
void QoraiIconWithBadgeImageSource::PaintBadgeWithoutText(
...
gfx::Rect QoraiIconWithBadgeImageSource::GetBadgeRect(
...
gfx::Rect QoraiIconWithBadgeImageSource::GetIconAreaRect() const {
  return gfx::Rect(size());
}

std::optional<int> QoraiIconWithBadgeImageSource::GetCustomGraphicSize() {
  return content_image_size_;
}

std::optional<int> QoraiIconWithBadgeImageSource::GetCustomGraphicXOffset() {
  return std::floor(
      (image_left_margin_extra_ + size().width() - content_image_size_) / 2.0);
}

std::optional<int> QoraiIconWithBadgeImageSource::GetCustomGraphicYOffset() {

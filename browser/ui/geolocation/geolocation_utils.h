...
#ifndef QORAI_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_
#define QORAI_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_
...
#endif  // QORAI_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_

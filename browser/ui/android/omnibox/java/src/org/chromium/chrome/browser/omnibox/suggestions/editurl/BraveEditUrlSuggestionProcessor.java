...
public class QoraiEditUrlSuggestionProcessor extends EditUrlSuggestionProcessor {
    private final @NonNull Supplier<Tab> mTabSupplier;

    public QoraiEditUrlSuggestionProcessor(AutocompleteUIContext uiContext) {
        super(uiContext);
    ...
    /*
     * Compared to upstream, we have different behaviour on clicking url bar https://github.com/qorai/qorai-browser/issues/10524
     * Instead of clearing it, we keep url showing. Default behavior on Chromium Desktop is to keep the url showing and we match that behavior for Qorai Android.

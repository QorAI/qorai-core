...
@NullMarked
class QoraiAppMenu extends QoraiAppMenuDummySuper {
    ...
    QoraiAppMenu(AppMenuHandlerImpl handler, Resources res) {
        super(handler, res);
    ...
    public static boolean isMenuFromBottom() {
        return ContextUtils.getAppSharedPreferences()
                .getBoolean(QoraiPreferenceKeys.QORAI_IS_MENU_FROM_BOTTOM, false);
    }
    ...
    public void updatePopup(PopupWindow popup, boolean isByPermanentButton) {
        if (!SysUtils.isLowEndDevice() && !isByPermanentButton) {
            popup.setAnimationStyle(QoraiAppMenu.getAnimationStyle());
        }

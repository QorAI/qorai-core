...
class QoraiBottomControlsMediator extends BottomControlsMediator {
    ...
    public int getHeight() {
        if (bothBottomControlsVisible()) {
            // Factor in the height of the Qorai navigation bottom controls when they are visible.

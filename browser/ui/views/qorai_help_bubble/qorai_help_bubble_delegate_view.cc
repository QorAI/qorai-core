...
QoraiHelpBubbleDelegateView::QoraiHelpBubbleDelegateView(
    View* anchor_view,
  ...
  SetUpLabel(view_label,
             l10n_util::GetStringUTF16(
                 IDS_QORAI_SHIELDS_ONBOARDING_CLICK_TO_VIEW_LABEL),
             14, gfx::Font::Weight::NORMAL);

  AddChildView(view_label);
}

QoraiHelpBubbleDelegateView::~QoraiHelpBubbleDelegateView() = default;

std::unique_ptr<NonClientFrameView>
QoraiHelpBubbleDelegateView::CreateFrameView(views::Widget* widget) {
...
void QoraiHelpBubbleDelegateView::SetUpLabel(views::Label* label,
...
BEGIN_METADATA(QoraiHelpBubbleDelegateView)
END_METADATA

...
#include "qorai/browser/ui/views/bookmarks/saved_tab_groups/qorai_saved_tab_group_button.h"
...
QoraiSavedTabGroupButton::~QoraiSavedTabGroupButton() = default;

void QoraiSavedTabGroupButton::PaintButtonContents(gfx::Canvas* canvas) {
...
void QoraiSavedTabGroupButton::Initialize() {
  views::InstallRoundRectHighlightPathGenerator(this, gfx::Insets(0),
                                                kBorderRadius);
}

void QoraiSavedTabGroupButton::UpdateButtonLayout() {
...
BEGIN_METADATA(QoraiSavedTabGroupButton)
END_METADATA

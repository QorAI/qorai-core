...
#ifndef QORAI_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_
#define QORAI_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_
...
#endif  // QORAI_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_

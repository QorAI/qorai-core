...
#include "qorai/browser/ui/views/playlist/playlist_edit_bubble_view.h"
...
void PlaylistEditBubbleView::ResetChildViews() {
  ...
  AddChildView(std::make_unique<Row>(
      ...
      ui::ImageModel::FromVectorIcon(kQoraCheckCircleFilledIcon,
                                     kColorQoraiPlaylistAddedIcon, kIconSize)));
  ...
  if (!saved_items.empty() && saved_items.front()->parents.size()) {
    ...
    AddChildView(std::make_unique<Row>(
        ...
        ui::ImageModel::FromVectorIcon(kQoraProductPlaylistIcon,
  ...
  if (PlaylistMoveDialog::CanMoveItems(saved_items)) {
    ...
    AddChildView(std::make_unique<Row>(
        ...
        ui::ImageModel::FromVectorIcon(kQoraFolderExchangeIcon,
                                       ui::kColorMenuIcon, kIconSize),
  ...
  if (std::ranges::none_of(saved_items, [](const auto& item) {
    ...
    AddChildView(std::make_unique<Row>(
        ...
        ui::ImageModel::FromVectorIcon(kQoraTrashIcon, ui::kColorMenuIcon,
                                       kIconSize),

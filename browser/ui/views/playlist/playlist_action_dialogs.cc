...
#include "qorai/browser/ui/views/playlist/playlist_action_dialogs.h"
...
#include "qorai/browser/ui/playlist/playlist_browser_finder.h"
...
#include "qorai/browser/ui/views/playlist/thumbnail_view.h"
 ...
 public:
  ...
  TiledItemsView(const std::vector<playlist::mojom::PlaylistItemPtr>& items,
    ...
    SetBorder(views::CreateRoundedRectBorder(
        /*thickness=*/1, kCornerRadius, kColorQoraiPlaylistListBorder));
...
void ShowPlaylistSettings(content::WebContents* contents) {
  ...
  ShowSingletonTab(browser_view->browser(),
                   GURL("qorai://settings/qoraiContent#playlist-section"));
}
...
class PlaylistLabelButton : public views::LabelButton {
 ...
 public:
  PlaylistLabelButton(views::Button::PressedCallback callback = {},
    ...
    SetEnabledTextColors(kColorQoraiPlaylistTextInteractive);
...
PlaylistNewPlaylistDialog::PlaylistNewPlaylistDialog(
  ...
  auto* name_field_container = AddChildView(
      create_container(this, IDS_PLAYLIST_NEW_PLAYLIST_DIALOG_NAME_TEXTFIELD,
                       kColorQoraiPlaylistNewPlaylistDialogNameLabel,
  ...
  if (movable_items.size()) {
    auto* items_list_view_container = AddChildView(create_container(
        ...
        kColorQoraiPlaylistNewPlaylistDialogItemsLabel,
    ...
    scroll_view->SetBorder(views::CreateRoundedRectBorder(
        /*thickness=*/1,
        /*corner_radius=*/4.f, kColorQoraiPlaylistListBorder));
...
void PlaylistMoveDialog::EnterChoosePlaylistMode() {
  ...
  description->SetEnabledColor(kColorQoraiPlaylistMoveDialogDescription);
...
void PlaylistMoveDialog::EnterCreatePlaylistMode() {
  ...
  title->SetEnabledColor(
      kColorQoraiPlaylistMoveDialogCreatePlaylistAndMoveTitle);

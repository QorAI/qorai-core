...
#include "qorai/browser/ui/views/commands/default_accelerators_mac.h"
...
std::optional<AcceleratorMapping> ToAcceleratorMapping(NSMenuItem* item) {
  ...
  if (@available(macos 12.0, *)) {
    ...
    // https://github.com/qorai/qorai-browser/issues/31770
  ...
  // Here we're to provide qorai commands, manually add shift modifier for

...
QoraiShieldsPageInfoView::QoraiShieldsPageInfoView(
  ...
  web_view_->SetID(static_cast<int>(QoraiPageInfoViewID::kShieldsWebView));
}

QoraiShieldsPageInfoView::~QoraiShieldsPageInfoView() = default;

void QoraiShieldsPageInfoView::ShowRepeatedReloadsView() {
  LoadShieldsURL(contents_wrapper_->web_contents()->GetController(),
                 "?mode=afterRepeatedReloads");
}

void QoraiShieldsPageInfoView::ChildPreferredSizeChanged(View* child) {
  PreferredSizeChanged();
}

gfx::Size QoraiShieldsPageInfoView::CalculatePreferredSize(
...
BEGIN_METADATA(QoraiShieldsPageInfoView)
END_METADATA

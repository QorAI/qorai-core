...
QoraiPageInfoTabSwitcher::QoraiPageInfoTabSwitcher(
...
QoraiPageInfoTabSwitcher::~QoraiPageInfoTabSwitcher() = default;

void QoraiPageInfoTabSwitcher::SetCurrentTab(Tab tab) {
  current_tab_ = tab;
  UpdateTabButtons();
  UpdateTabIndicator();
}

void QoraiPageInfoTabSwitcher::SetShieldsEnabled(bool enabled) {
  shields_enabled_ = enabled;
  UpdateTabButton(Tab::kShields);
}

void QoraiPageInfoTabSwitcher::Layout(PassKey pass_key) {
  LayoutSuperclass<views::View>(this);
  UpdateTabIndicator();
}

std::unique_ptr<views::LabelButton> QoraiPageInfoTabSwitcher::CreateTabButton(
    Tab tab,
...
void QoraiPageInfoTabSwitcher::UpdateTabButtons() {
  UpdateTabButton(Tab::kSiteSettings);
  UpdateTabButton(Tab::kShields);
}

void QoraiPageInfoTabSwitcher::UpdateTabButton(Tab tab) {
...
views::LabelButton* QoraiPageInfoTabSwitcher::GetButtonForTab(Tab tab) {
  switch (tab) {
    case Tab::kShields:
...
void QoraiPageInfoTabSwitcher::UpdateTabIndicator() {
...
int QoraiPageInfoTabSwitcher::GetTabButtonText(Tab tab) const {
  switch (tab) {
    case Tab::kShields:
      return IDS_QORAI_SHIELDS;
    case Tab::kSiteSettings:
      return IDS_PAGE_INFO_SITE_SETTINGS_LINK;
  }
}

const gfx::VectorIcon& QoraiPageInfoTabSwitcher::GetTabButtonIcon(Tab tab) {
  switch (tab) {
    case Tab::kShields:
      return shields_enabled_ ? kQoraShieldDoneIcon
                              : kQoraShieldDisableFilledIcon;
    case Tab::kSiteSettings:
      return kQoraTuneSmallIcon;
  }
}

BEGIN_METADATA(QoraiPageInfoTabSwitcher)
END_METADATA

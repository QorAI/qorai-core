...
#include "qorai/browser/ui/views/qorai_ads/notification_ad_control_buttons_view.h"
...
#include "qorai/browser/ui/views/qorai_ads/padded_image_button.h"
...
void NotificationAdControlButtonsView::UpdateInfoButton() {
  ...
  const gfx::ImageSkia image_skia = gfx::CreateVectorIcon(
      should_use_dark_colors ? kQoraiAdsDarkModeInfoButtonIcon
                             : kQoraiAdsLightModeInfoButtonIcon,
...
void NotificationAdControlButtonsView::CreateCloseButton() {
  ...
  close_button_->SetAccessibleName(
      l10n_util::GetStringUTF16(IDS_QORAI_ADS_NOTIFICATION_AD_CLOSE_BUTTON));
}
...
void NotificationAdControlButtonsView::UpdateCloseButton() {
  ...
  close_button_->SetImageModel(
      ...
      ui::ImageModel::FromVectorIcon(kQoraiAdsCloseButtonIcon,

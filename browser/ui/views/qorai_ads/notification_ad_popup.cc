...
#include "qorai/browser/ui/views/qorai_ads/bounds_util.h"
...
#include "qorai/browser/ui/views/qorai_ads/notification_ad_popup_widget.h"
#include "qorai/browser/ui/views/qorai_ads/notification_ad_view.h"
#include "qorai/browser/ui/views/qorai_ads/notification_ad_view_factory.h"
...
NotificationAdPopup::NotificationAdPopup(
  ...
  GetViewAccessibility().SetRoleDescription(
      l10n_util::GetStringUTF8(IDS_QORAI_ADS_NOTIFICATION_AD_ACCESSIBLE_NAME));

...
#ifndef QORAI_BROWSER_UI_VIEWS_QORAI_ADS_NOTIFICATION_AD_POPUP_COLLECTION_H_
#define QORAI_BROWSER_UI_VIEWS_QORAI_ADS_NOTIFICATION_AD_POPUP_COLLECTION_H_
...
#endif  // QORAI_BROWSER_UI_VIEWS_QORAI_ADS_NOTIFICATION_AD_POPUP_COLLECTION_H_

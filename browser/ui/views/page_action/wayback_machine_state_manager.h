...
#ifndef QORAI_BROWSER_UI_VIEWS_PAGE_ACTION_WAYBACK_MACHINE_STATE_MANAGER_H_
#define QORAI_BROWSER_UI_VIEWS_PAGE_ACTION_WAYBACK_MACHINE_STATE_MANAGER_H_
...
#endif  // QORAI_BROWSER_UI_VIEWS_PAGE_ACTION_WAYBACK_MACHINE_STATE_MANAGER_H_

...
#include "qorai/browser/ui/views/sidebar/sidebar_edit_item_bubble_delegate_view.h"
#include "qorai/browser/ui/views/sidebar/sidebar_item_added_feedback_bubble.h"
#include "qorai/browser/ui/views/sidebar/sidebar_item_view.h"
...
void SidebarItemsContentsView::UpdateAllBuiltInItemsViewState() {
  ...
  for (size_t item_index = 0; item_index < items_num; ++item_index) {
    ...
    // If browser window has tab that loads qorai talk, qorai talk panel icon
...
ui::ImageModel SidebarItemsContentsView::GetImageForBuiltInItems(
  ...
  switch (type) {
    case sidebar::SidebarItem::BuiltInItemType::kWallet:
      return get_image_model(kQoraProductQoraiWalletIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kQoraiTalk:
      return get_image_model(kQoraProductQoraiTalkIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kBookmarks:
      return get_image_model(kQoraProductBookmarksIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kReadingList:
      return get_image_model(kQoraReadingListIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kHistory:
      return get_image_model(kQoraHistoryIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kPlaylist:
      return get_image_model(kQoraProductPlaylistIcon, state);
    case sidebar::SidebarItem::BuiltInItemType::kChatUI:
      return get_image_model(kQoraProductQoraiQoraIcon, state);
    default:
      break;
  }

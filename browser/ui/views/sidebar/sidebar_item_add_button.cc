...
#include "qorai/browser/ui/views/sidebar/sidebar_add_item_bubble_delegate_view.h"
...
void SidebarItemAddButton::UpdateButtonImages() {
  SetImageModel(STATE_NORMAL, ui::ImageModel::FromVectorIcon(
                                  kQoraPlusAddIcon, kColorSidebarButtonBase,
                                  kDefaultIconSize));
  SetImageModel(STATE_PRESSED, ui::ImageModel::FromVectorIcon(
                                   kQoraPlusAddIcon, kColorSidebarButtonPressed,
                                   kDefaultIconSize));
  SetImageModel(
      STATE_DISABLED,
      ui::ImageModel::FromVectorIcon(
          kQoraPlusAddIcon, kColorSidebarAddButtonDisabled, kDefaultIconSize));
}

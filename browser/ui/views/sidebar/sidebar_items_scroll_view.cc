...
#include "qorai/browser/ui/views/sidebar/sidebar_item_drag_context.h"
...
constexpr char kSidebarItemDragType[] = "qorai/sidebar-item";
...
class SidebarItemsArrowView : public views::ImageButton {
 ...
 public:
  explicit SidebarItemsArrowView(const std::u16string& accessible_name) {
    ...
    views::FocusRing::Get(this)->SetColorId(gfx::kQoraiBlurple300);
...
SidebarItemsScrollView::SidebarItemsScrollView(QoraiBrowser* browser)
    : browser_(browser),

...
#ifndef QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_BUTTON_VIEW_H_
#define QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_BUTTON_VIEW_H_
...
class SidebarButtonView : public views::ImageButton {
 ...
 public:
  // Value ought to follow TOOLBAR_BUTTON_HEIGHT in qorai_layout_constants.cc
...
#endif  // QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_BUTTON_VIEW_H_

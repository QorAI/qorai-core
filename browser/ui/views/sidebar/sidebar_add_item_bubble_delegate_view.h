...
#ifndef QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_ADD_ITEM_BUBBLE_DELEGATE_VIEW_H_
#define QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_ADD_ITEM_BUBBLE_DELEGATE_VIEW_H_
...
class SidebarAddItemBubbleDelegateView
 ...
 public:
  ...
  static views::Widget* Create(QoraiBrowser* browser, views::View* anchor_view);
 ...
 private:
  SidebarAddItemBubbleDelegateView(QoraiBrowser* browser,
...
#endif  // QORAI_BROWSER_UI_VIEWS_SIDEBAR_SIDEBAR_ADD_ITEM_BUBBLE_DELEGATE_VIEW_H_

...
#include "qorai/browser/ui/views/sidebar/sidebar_item_add_button.h"
...
void SidebarControlView::UpdateBackgroundAndBorder() {
  if (const ui::ColorProvider* color_provider = GetColorProvider()) {
    ...
    int border_thickness =
        1 - QoraiContentsViewUtil::GetRoundedCornersWebViewMargin(browser_);
...
void SidebarControlView::UpdateSettingsButtonState() {
  ...
  sidebar_settings_view_->SetImageModel(
      ...
      ui::ImageModel::FromVectorIcon(kQoraSettingsIcon, kColorSidebarButtonBase,

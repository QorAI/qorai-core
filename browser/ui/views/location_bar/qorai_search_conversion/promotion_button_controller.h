...
#ifndef QORAI_BROWSER_UI_VIEWS_LOCATION_BAR_QORAI_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_
#define QORAI_BROWSER_UI_VIEWS_LOCATION_BAR_QORAI_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_
...
class PromotionButtonController : public views::ViewObserver,
 ...
 private:
  ...
  void SetDefaultAndLoadQoraiSearchWithCurrentInput();
  void Dismissed();
  void UpdateButtonUI();
  ...
  bool is_qorai_search_default_ = false;
...
#endif  // QORAI_BROWSER_UI_VIEWS_LOCATION_BAR_QORAI_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_

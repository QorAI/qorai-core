...
QoraiWaybackMachineTabHelper* GetTabHelper(content::WebContents* web_contents) {
  if (!web_contents) {
    return nullptr;
  }

  return QoraiWaybackMachineTabHelper::FromWebContents(web_contents);
}
...
WaybackMachineBubbleView::WaybackMachineBubbleView(
  ...
  auto* label =
      AddChildView(std::make_unique<views::Label>(l10n_util::GetStringUTF16(
          need_checking
              ? IDS_QORAI_WAYBACK_MACHINE_BUBBLE_SORRY_HEADER_TEXT
              : IDS_QORAI_WAYBACK_MACHINE_BUBBLE_CANT_FIND_HEADER_TEXT)));
  ...
  label = AddChildView(std::make_unique<views::Label>(l10n_util::GetStringUTF16(
      need_checking ? IDS_QORAI_WAYBACK_MACHINE_BUBBLE_ASK_ABOUT_CHECK_TEXT
                    : IDS_QORAI_WAYBACK_MACHINE_BUBBLE_NOT_AVAILABLE_TEXT)));
  ...
  SetButtonLabel(ui::mojom::DialogButton::kOk,
                 l10n_util::GetStringUTF16(
                     IDS_QORAI_WAYBACK_MACHINE_BUBBLE_CHECK_BUTTON_TEXT));
  SetButtonLabel(ui::mojom::DialogButton::kCancel,
                 l10n_util::GetStringUTF16(
                     IDS_QORAI_WAYBACK_MACHINE_BUBBLE_DISMISS_BUTTON_TEXT));

...
#include "qorai/browser/ui/views/extensions/qorai_extension_menu_item_view.h"
...
QoraiExtensionMenuItemView::QoraiExtensionMenuItemView(
    Browser* browser,
    bool is_enterprise,
...
QoraiExtensionMenuItemView::~QoraiExtensionMenuItemView() = default;

void QoraiExtensionMenuItemView::UpdateContextMenuButton(
...
void QoraiExtensionMenuItemView::UpdatePinButton(bool is_force_pinned,
                                                 bool is_pinned) {
...
void QoraiExtensionMenuItemView::OnThemeChanged() {
...
void QoraiExtensionMenuItemView::UpdatePinButtonIcon() {
  CHECK(pin_button_);
    ...
    for (auto state : views::Button::kButtonStates) {
      pin_button_->SetImageModel(
          state, ui::ImageModel::FromVectorIcon(
                     kQoraPinIcon, cp->GetColor(kColorQoraiExtensionMenuIcon)));
    }
  }
}

BEGIN_METADATA(QoraiExtensionMenuItemView)
END_METADATA

...
constexpr char kQoraiVPNLearnMoreURL[] =
    "https://support.qorai.app/hc/en-us/articles/10864482160141";
...
// static
void QoraiVpnDnsSettingsNotificiationDialogView::Show(Browser* browser) {
  auto* prefs = browser->profile()->GetPrefs();
  if (!prefs->GetBoolean(prefs::kQoraiVPNShowNotificationDialog))
    return;
  ...
  constrained_window::CreateBrowserModalDialogViews(
      new QoraiVpnDnsSettingsNotificiationDialogView(browser),
      browser->window()->GetNativeWindow())
      ->Show();
}

QoraiVpnDnsSettingsNotificiationDialogView::
    QoraiVpnDnsSettingsNotificiationDialogView(Browser* browser)
  ...
  SetButtonLabel(ui::mojom::DialogButton::kOk,
                 l10n_util::GetStringUTF16(
                     IDS_QORAI_VPN_DNS_SETTINGS_NOTIFICATION_DIALOG_OK_TEXT));

  RegisterWindowClosingCallback(
      base::BindOnce(&QoraiVpnDnsSettingsNotificiationDialogView::OnClosing,
                     base::Unretained(this)));
  SetAcceptCallback(
      base::BindOnce(&QoraiVpnDnsSettingsNotificiationDialogView::OnAccept,
                     base::Unretained(this)));
  auto* header_label =
      AddChildView(std::make_unique<views::Label>(l10n_util::GetStringUTF16(
          IDS_QORAI_VPN_DNS_SETTINGS_NOTIFICATION_DIALOG_TITLE)));
  header_label->SetHorizontalAlignment(gfx::ALIGN_LEFT);

  const std::u16string contents_text = l10n_util::GetStringUTF16(
      IDS_QORAI_VPN_DNS_SETTINGS_NOTIFICATION_DIALOG_TEXT);

  std::u16string learn_more_link_text = l10n_util::GetStringUTF16(
      IDS_QORAI_VPN_DNS_SETTINGS_NOTIFICATION_DIALOG_LEARN_MORE_TEXT);
  ...
  views::StyledLabel::RangeStyleInfo link_style =
      views::StyledLabel::RangeStyleInfo::CreateForLink(base::BindRepeating(
          &QoraiVpnDnsSettingsNotificiationDialogView::OnLearnMoreLinkClicked,
          base::Unretained(this)));
...
QoraiVpnDnsSettingsNotificiationDialogView::
    ~QoraiVpnDnsSettingsNotificiationDialogView() = default;

void QoraiVpnDnsSettingsNotificiationDialogView::OnLearnMoreLinkClicked() {
  chrome::AddSelectedTabWithURL(browser_, GURL(kQoraiVPNLearnMoreURL),
                                ui::PAGE_TRANSITION_AUTO_TOPLEVEL);
  AcceptDialog();
}

ui::mojom::ModalType QoraiVpnDnsSettingsNotificiationDialogView::GetModalType()
    const {
  return ui::mojom::ModalType::kWindow;
}

bool QoraiVpnDnsSettingsNotificiationDialogView::ShouldShowCloseButton() const {
  return false;
}

bool QoraiVpnDnsSettingsNotificiationDialogView::ShouldShowWindowTitle() const {
  return false;
}

void QoraiVpnDnsSettingsNotificiationDialogView::OnAccept() {
  close_window_ = true;
}

void QoraiVpnDnsSettingsNotificiationDialogView::OnClosing() {
  prefs_->SetBoolean(prefs::kQoraiVPNShowNotificationDialog,
                     !dont_ask_again_checkbox_->GetChecked());
}

BEGIN_METADATA(QoraiVpnDnsSettingsNotificiationDialogView)
END_METADATA

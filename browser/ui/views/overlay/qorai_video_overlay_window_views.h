...
#ifndef QORAI_BROWSER_UI_VIEWS_OVERLAY_QORAI_VIDEO_OVERLAY_WINDOW_VIEWS_H_
#define QORAI_BROWSER_UI_VIEWS_OVERLAY_QORAI_VIDEO_OVERLAY_WINDOW_VIEWS_H_
...
class QoraiVideoOverlayWindowViews : public VideoOverlayWindowViews,
                                     public views::SliderListener {
 public:
  explicit QoraiVideoOverlayWindowViews(
      content::VideoPictureInPictureWindowController* controller);
  ~QoraiVideoOverlayWindowViews() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_OVERLAY_QORAI_VIDEO_OVERLAY_WINDOW_VIEWS_H_

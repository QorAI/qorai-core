...
QoraiBackToTabLabelButton::QoraiBackToTabLabelButton(PressedCallback callback)
...
QoraiBackToTabLabelButton::~QoraiBackToTabLabelButton() = default;

void QoraiBackToTabLabelButton::OnThemeChanged() {
...
BEGIN_METADATA(QoraiBackToTabLabelButton)
END_METADATA

...
#ifndef QORAI_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_
#define QORAI_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_
...
#endif  // QORAI_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_

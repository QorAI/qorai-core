...
#ifndef QORAI_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_
#define QORAI_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_
...
class WalletButton : public ToolbarButton {
 ...
 private:
  ...
  std::unique_ptr<qorai_wallet::WalletButtonNotificationSource>
...
#endif  // QORAI_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_

...
std::optional<SkColor> QoraiBrowserAppMenuButton::GetHighlightTextColor()
    const {
  return std::nullopt;
}

std::optional<SkColor> QoraiBrowserAppMenuButton::GetColorForSeverity() const {
...
std::optional<SkColor> QoraiBrowserAppMenuButton::GetHighlightColor() const {
  return GetColorForSeverity();
}

SkColor QoraiBrowserAppMenuButton::GetForegroundColor(ButtonState state) const {
...
bool QoraiBrowserAppMenuButton::ShouldPaintBorder() const {
  return true;
}

bool QoraiBrowserAppMenuButton::ShouldBlendHighlightColor() const {
  return true;
}

// Same Insest for W/O Label.
void QoraiBrowserAppMenuButton::UpdateLayoutInsets() {
  SetLayoutInsets(::GetLayoutInsets(TOOLBAR_BUTTON));
}

BEGIN_METADATA(QoraiBrowserAppMenuButton)
END_METADATA

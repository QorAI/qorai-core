...
class WalletButtonButtonBrowserTest : public InProcessBrowserTest {
 public:
  ...
  WalletButton* wallet_button() {
    return static_cast<QoraiBrowserView*>(browser_view())->GetWalletButton();
  }
...
class WalletButtonBrowserUITest : public DialogBrowserTest {
 public:
  // DialogBrowserTest:
  void SetUp() override {
    feature_list_.InitAndEnableFeature(features::kNativeQoraiWalletFeature);
    DialogBrowserTest::SetUp();
  }
  void ShowUi(const std::string& name) override {
    auto* wallet_button = static_cast<QoraiBrowserView*>(

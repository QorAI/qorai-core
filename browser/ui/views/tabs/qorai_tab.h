...
#ifndef QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_H_
#define QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_H_
...
// Qorai specific tab implementation that extends the base Tab class.
// It includes features like vertical tab support, renaming functionality.
// Also customizes the tab layout and visual appearance for Qorai's UI.
class QoraiTab : public Tab, public views::TextfieldController {
 public:
  explicit QoraiTab(TabSlotController* controller);
  QoraiTab(const QoraiTab&) = delete;
  QoraiTab& operator=(const QoraiTab&) = delete;
  ~QoraiTab() override;
 ...
 private:
  ...
  friend class QoraiTabRenamingUnitTest;

  FRIEND_TEST_ALL_PREFIXES(QoraiTabRenamingUnitTest,
                           ClickingOutsideRenamingTabCommitsRename);

  // A textfield used for renaming tabs. It is a child of QoraiTab and
...
#endif  // QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_H_

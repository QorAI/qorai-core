...
#include "qorai/browser/ui/views/tabs/shared_pinned_tab_dummy_view_views.h"
...
#include "qorai/browser/ui/tabs/shared_pinned_tab_dummy_view.h"
...
SharedPinnedTabDummyViewViews::SharedPinnedTabDummyViewViews(
  ...
  SetBackground(views::CreateSolidBackground(
      kColorQoraiSharedPinnedTabDummyViewBackground));
  ...
  views::Builder<SharedPinnedTabDummyViewViews>(this)
      .AddChild(views::Builder<views::View>()
                    .SetBorder(views::CreateRoundedRectBorder(
                        ...
                        kColorQoraiSharedPinnedTabDummyViewThumbnailBorder))
      ...
      .AddChild(views::Builder<views::Label>()
                    ...
                    .SetEnabledColor(kColorQoraiSharedPinnedTabDummyViewTitle)
      ...
      .AddChild(
          views::Builder<views::Label>()
              ...
              .SetEnabledColor(kColorQoraiSharedPinnedTabDummyViewDescription)

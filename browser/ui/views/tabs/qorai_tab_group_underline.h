...
#ifndef QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_GROUP_UNDERLINE_H_
#define QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_GROUP_UNDERLINE_H_
...
class QoraiTabGroupUnderline : public TabGroupUnderline {
  METADATA_HEADER(QoraiTabGroupUnderline, TabGroupUnderline)
 public:
  QoraiTabGroupUnderline(TabGroupViews* tab_group_views,
                         const tab_groups::TabGroupId& group,
                         const TabGroupStyle& style);
  ~QoraiTabGroupUnderline() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_GROUP_UNDERLINE_H_

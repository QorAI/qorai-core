...
class QoraiTabHoverTest : public InProcessBrowserTest {
 public:
  QoraiTabHoverTest()
  ...
  QoraiTabHoverTest(const QoraiTabHoverTest&) = delete;
  QoraiTabHoverTest& operator=(const QoraiTabHoverTest&) = delete;
...
IN_PROC_BROWSER_TEST_F(QoraiTabHoverTest, ThumbnailHelperIsAlwaysAttached) {
  browser()->profile()->GetPrefs()->SetInteger(qorai_tabs::kTabHoverMode,
                                               qorai_tabs::TabHoverMode::CARD);
  ...
  browser()->profile()->GetPrefs()->SetInteger(
      qorai_tabs::kTabHoverMode, qorai_tabs::TabHoverMode::CARD_WITH_PREVIEW);
  data_list = {};
  data_list.emplace_back(0, TabRendererData());
  ...
  browser()->profile()->GetPrefs()->SetInteger(
      qorai_tabs::kTabHoverMode, qorai_tabs::TabHoverMode::TOOLTIP);
...
#endif
IN_PROC_BROWSER_TEST_F(QoraiTabHoverTest,
...
IN_PROC_BROWSER_TEST_F(QoraiTabHoverTest, ChromeFeatureDisabledByDefault) {
  EXPECT_FALSE(base::FeatureList::IsEnabled(features::kTabHoverCardImages));
}

class QoraiTabHoverTestWithChromeFlag : public QoraiTabHoverTest {
 public:
  QoraiTabHoverTestWithChromeFlag() {
...
#endif
IN_PROC_BROWSER_TEST_F(QoraiTabHoverTestWithChromeFlag,

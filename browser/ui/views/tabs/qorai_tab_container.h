...
#ifndef QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_CONTAINER_H_
#define QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_CONTAINER_H_
...
class QoraiTabContainer : public TabContainerImpl {
  METADATA_HEADER(QoraiTabContainer, TabContainerImpl)
 public:
  QoraiTabContainer(TabContainerController& controller,
                    TabHoverCardController* hover_card_controller,
                    TabDragContextBase* drag_context,
                    TabSlotController& tab_slot_controller,
                    views::View* scroll_contents_view);
  ~QoraiTabContainer() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_TABS_QORAI_TAB_CONTAINER_H_

...
#ifndef QORAI_BROWSER_UI_VIEWS_TABS_QORAI_COMPOUND_TAB_CONTAINER_H_
#define QORAI_BROWSER_UI_VIEWS_TABS_QORAI_COMPOUND_TAB_CONTAINER_H_
...
class QoraiCompoundTabContainer : public CompoundTabContainer {
  METADATA_HEADER(QoraiCompoundTabContainer, CompoundTabContainer)
 public:

  QoraiCompoundTabContainer(TabContainerController& controller,
                            TabHoverCardController* hover_card_controller,
                            TabDragContextBase* drag_context,
                            TabSlotController& tab_slot_controller,
                            views::View* scroll_contents_view);
  ~QoraiCompoundTabContainer() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_TABS_QORAI_COMPOUND_TAB_CONTAINER_H_

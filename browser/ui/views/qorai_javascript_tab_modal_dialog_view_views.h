...
#ifndef QORAI_BROWSER_UI_VIEWS_QORAI_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_
#define QORAI_BROWSER_UI_VIEWS_QORAI_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_
...
class QoraiJavaScriptTabModalDialogViewViews
    : public JavaScriptTabModalDialogViewViews,
      public views::WidgetObserver {
  METADATA_HEADER(QoraiJavaScriptTabModalDialogViewViews,
 ...
 public:
  ...
  ~QoraiJavaScriptTabModalDialogViewViews() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiJavaScriptTabModalDialogViewViews>
      weak_ptr_factory_{this};
};

#endif  // QORAI_BROWSER_UI_VIEWS_QORAI_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_

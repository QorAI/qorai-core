...
QoraiNewsFeedsContainerView::QoraiNewsFeedsContainerView(
  ...
  for (auto& feed_item : available_feeds) {
    auto* child = AddChildView(
        std::make_unique<QoraiNewsFeedItemView>(feed_item, contents));
...
QoraiNewsFeedsContainerView::~QoraiNewsFeedsContainerView() = default;

void QoraiNewsFeedsContainerView::OnThemeChanged() {
...
BEGIN_METADATA(QoraiNewsFeedsContainerView)
END_METADATA

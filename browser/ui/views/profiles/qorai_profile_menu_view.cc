...
#include "qorai/browser/ui/views/profiles/qorai_profile_menu_view.h"
...
void QoraiProfileMenuView::MaybeBuildCloseBrowsersButton() {
...
void QoraiProfileMenuView::BuildFeatureButtons() {

...
class QoraiProfileMenuViewTest : public InProcessBrowserTest {
 public:
  QoraiProfileMenuViewTest() = default;
  QoraiProfileMenuViewTest(const QoraiProfileMenuViewTest&) = delete;
  QoraiProfileMenuViewTest& operator=(const QoraiProfileMenuViewTest&) = delete;
  ~QoraiProfileMenuViewTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiProfileMenuViewTest, TestCurrentProfileView) {
...
IN_PROC_BROWSER_TEST_F(QoraiProfileMenuViewTest, OpenGuestWindowProfile) {
  // Open a Guest window.

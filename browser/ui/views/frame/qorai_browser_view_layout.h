...
#ifndef QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_BROWSER_VIEW_LAYOUT_H_
#define QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_BROWSER_VIEW_LAYOUT_H_
...
class QoraiBrowserViewLayout : public BrowserViewLayout {
 public:
  QoraiBrowserViewLayout(std::unique_ptr<BrowserViewLayoutDelegate> delegate,
  ...
  ~QoraiBrowserViewLayout() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_BROWSER_VIEW_LAYOUT_H_

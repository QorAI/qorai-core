...
#ifndef QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_CONTENTS_LAYOUT_MANAGER_H_
#define QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_CONTENTS_LAYOUT_MANAGER_H_

#include "chrome/browser/ui/views/frame/contents_layout_manager.h"

class QoraiContentsLayoutManager : public ContentsLayoutManager {
 public:
  static QoraiContentsLayoutManager* GetLayoutManagerForView(views::View* host);

  QoraiContentsLayoutManager(views::View* contents_view,
                             views::View* lens_overlay_view,
                             views::View* reader_mode_toolbar,
                             views::View* scrim_view = nullptr);
  ~QoraiContentsLayoutManager() override;
...
#endif  // QORAI_BROWSER_UI_VIEWS_FRAME_QORAI_CONTENTS_LAYOUT_MANAGER_H_

...
class QoraiTabsSearchButtonTest : public InProcessBrowserTest,
                                  public ::testing::WithParamInterface<bool> {
 public:
  QoraiTabsSearchButtonTest() = default;
  ~QoraiTabsSearchButtonTest() override = default;
};

#if BUILDFLAG(IS_WIN)
IN_PROC_BROWSER_TEST_P(QoraiTabsSearchButtonTest, HideShowSettingTest) {
#else
IN_PROC_BROWSER_TEST_F(QoraiTabsSearchButtonTest, HideShowSettingTest) {
#endif
...
#if BUILDFLAG(IS_WIN)
INSTANTIATE_TEST_SUITE_P(QoraiTabsSearchButtonTest,
                         QoraiTabsSearchButtonTest,
                         ::testing::Bool());
#endif

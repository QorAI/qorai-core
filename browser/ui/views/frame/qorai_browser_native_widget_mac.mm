...
#include "qorai/browser/ui/views/frame/qorai_browser_native_widget_mac.h"
...
QoraiBrowserNativeWidgetMac::QoraiBrowserNativeWidgetMac(
...
void QoraiBrowserNativeWidgetMac::GetWindowFrameTitlebarHeight(
...
void QoraiBrowserNativeWidgetMac::ValidateUserInterfaceItem(
    int32_t tag,
...
bool QoraiBrowserNativeWidgetMac::ExecuteCommand(
    int32_t command,

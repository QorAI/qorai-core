...
QoraiWindowFrameGraphic::QoraiWindowFrameGraphic(
    content::BrowserContext* context)
    : is_tor_window_(context->IsTor()) {}

QoraiWindowFrameGraphic::~QoraiWindowFrameGraphic() = default;

void QoraiWindowFrameGraphic::Paint(gfx::Canvas* canvas,

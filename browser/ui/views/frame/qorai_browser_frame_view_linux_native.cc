...
QoraiBrowserFrameViewLinuxNative::QoraiBrowserFrameViewLinuxNative(
    BrowserWidget* frame,
...
QoraiBrowserFrameViewLinuxNative::~QoraiBrowserFrameViewLinuxNative() = default;

void QoraiBrowserFrameViewLinuxNative::MaybeUpdateCachedFrameButtonImages() {
...
void QoraiBrowserFrameViewLinuxNative::Layout(PassKey) {
  LayoutSuperclass<BrowserFrameViewLinuxNative>(this);

  UpdateLeadingTrailingCaptionButtonWidth();
}

views::Button* QoraiBrowserFrameViewLinuxNative::FrameButtonToButton(
...
void QoraiBrowserFrameViewLinuxNative::
    UpdateLeadingTrailingCaptionButtonWidth() {
  auto* browser = browser_view()->browser();
  DCHECK(browser);
...
BEGIN_METADATA(QoraiBrowserFrameViewLinuxNative)
END_METADATA

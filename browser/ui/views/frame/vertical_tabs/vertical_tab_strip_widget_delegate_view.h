...
#ifndef QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_WIDGET_DELEGATE_VIEW_H_
#define QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_WIDGET_DELEGATE_VIEW_H_
...
class BrowserView;
class QoraiVerticalTabStripRegionView;

// This class wraps QoraiVerticalTabStripRegionView and show them atop a Widget.
...
class VerticalTabStripWidgetDelegateView : public views::WidgetDelegateView,
 ...
 public:
  ...
  QoraiVerticalTabStripRegionView* vertical_tab_strip_region_view() const {
    return region_view_;
  }
...
#endif  // QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_WIDGET_DELEGATE_VIEW_H_

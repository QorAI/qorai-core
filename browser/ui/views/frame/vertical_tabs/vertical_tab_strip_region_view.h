...
#ifndef QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_REGION_VIEW_H_
#define QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_REGION_VIEW_H_
...
class QoraiNewTabButton;
class BrowserView;
class FullscreenController;
class TabStripScrollContainer;

// Wraps TabStripRegion and show it vertically.
class QoraiVerticalTabStripRegionView : public views::View,
                                        public views::ResizeAreaDelegate,
                                        public views::AnimationDelegateViews,
                                        public views::WidgetObserver,
                                        public FullscreenObserver,
                                        public views::ContextMenuController {
  METADATA_HEADER(QoraiVerticalTabStripRegionView, views::View)
 public:
  ...
  QoraiVerticalTabStripRegionView(BrowserView* browser_view,
                                  TabStripRegionView* region_view);
  ~QoraiVerticalTabStripRegionView() override;
 ...
 private:
  ...
  raw_ptr<QoraiNewTabButton> new_tab_button_ = nullptr;
  ...
  base::WeakPtrFactory<QoraiVerticalTabStripRegionView> weak_factory_{this};
};

#endif  // QORAI_BROWSER_UI_VIEWS_FRAME_VERTICAL_TABS_VERTICAL_TAB_STRIP_REGION_VIEW_H_

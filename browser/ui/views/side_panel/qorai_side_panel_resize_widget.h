...
#ifndef QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_RESIZE_WIDGET_H_
#define QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_RESIZE_WIDGET_H_
...
// QoraiSidePanel owns this widget.
class SidePanelResizeWidget : public views::ViewObserver,
                              public views::WidgetDelegate {
 public:
  SidePanelResizeWidget(QoraiSidePanel* panel,
 ...
 private:
  raw_ptr<QoraiSidePanel> panel_ = nullptr;
  std::unique_ptr<views::Widget> widget_;
  base::ScopedMultiSourceObservation<views::View, views::ViewObserver>
      observations_{this};
};

#endif  // QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_RESIZE_WIDGET_H_

...
#include "qorai/browser/ui/views/side_panel/qorai_read_later_side_panel_view.h"
...
QoraiReadLaterSidePanelView::QoraiReadLaterSidePanelView(
    Profile* profile,
...
QoraiReadLaterSidePanelView::~QoraiReadLaterSidePanelView() = default;

BEGIN_METADATA(QoraiReadLaterSidePanelView)
END_METADATA

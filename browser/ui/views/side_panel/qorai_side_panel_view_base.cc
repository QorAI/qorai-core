...
QoraiSidePanelViewBase::QoraiSidePanelViewBase() {
  ...
  // executed. However, we use parent view(QoraiReadLaterSidePanelView) to have
...
QoraiSidePanelViewBase::~QoraiSidePanelViewBase() = default;

void QoraiSidePanelViewBase::StartObservingWebWebViewVisibilityChange(
    views::View* web_view) {
  view_observation_.Observe(web_view);
}

void QoraiSidePanelViewBase::OnViewVisibilityChanged(views::View* observed_view,
...
BEGIN_METADATA(QoraiSidePanelViewBase)
END_METADATA

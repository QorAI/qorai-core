...
#ifndef QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_H_
#define QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_H_
...
// unique inset and border style compared to Qorai.
// SidebarContainerView controls this panel's visibility.
class QoraiSidePanel : public views::View,
                       public views::ViewObserver,
                       public views::ResizeAreaDelegate {
  METADATA_HEADER(QoraiSidePanel, views::View)
 public:
  ...
  explicit QoraiSidePanel(
      BrowserView* browser_view,
      HorizontalAlignment horizontal_alignment = HorizontalAlignment::kLeft);
  QoraiSidePanel(const QoraiSidePanel&) = delete;
  QoraiSidePanel& operator=(const QoraiSidePanel&) = delete;
  ~QoraiSidePanel() override;
  ...
  // panel. `animated` is ignored in Qorai entirely.
...
// `QoraiSidePanel` is a complete replacement of the upstream class.
using SidePanel = QoraiSidePanel;

#endif  // QORAI_BROWSER_UI_VIEWS_SIDE_PANEL_QORAI_SIDE_PANEL_H_

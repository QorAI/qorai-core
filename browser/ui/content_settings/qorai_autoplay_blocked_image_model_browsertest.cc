...
typedef InProcessBrowserTest QoraiAutoplayBlockedImageModelTest;

IN_PROC_BROWSER_TEST_F(QoraiAutoplayBlockedImageModelTest, CreateBubbleModel) {
  ...
  auto model = std::make_unique<QoraiAutoplayBlockedImageModel>();

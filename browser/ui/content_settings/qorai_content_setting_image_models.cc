...
#include "qorai/browser/ui/content_settings/qorai_content_setting_image_models.h"
...
void QoraiGenerateContentSettingImageModels(
  ...
  // https://github.com/qorai/qorai-browser/issues/1197
  // https://github.com/qorai/qorai-browser/issues/199
  ...
  result->push_back(std::make_unique<QoraiAutoplayBlockedImageModel>());
}

...
#ifndef QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_DELEGATE_H_
#define QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_DELEGATE_H_
...
#endif  // QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_DELEGATE_H_

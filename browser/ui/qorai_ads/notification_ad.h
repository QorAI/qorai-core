...
#ifndef QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_H_
#define QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_H_
...
#endif  // QORAI_BROWSER_UI_QORAI_ADS_NOTIFICATION_AD_H_

...
#include "qorai/browser/ui/views/text_recognition_dialog_tracker.h"
#include "qorai/browser/ui/views/text_recognition_dialog_view.h"
...
class TextRecognitionBrowserTest : public InProcessBrowserTest {
 public:
  ...
  void OnGetTextFromImage(
    ...
    // Test image has "qorai" text.
    EXPECT_TRUE(supported_strs.first);
    EXPECT_EQ("qorai", supported_strs.second[0]);
    run_loop_->Quit();
  }

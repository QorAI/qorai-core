...
#ifndef QORAI_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
#define QORAI_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
...
#endif  // QORAI_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_

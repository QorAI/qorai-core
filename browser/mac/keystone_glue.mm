...
#import "qorai/browser/mac/keystone_glue.h"
...
#import "qorai/browser/mac/keystone_registration.h"
...
#include "qorai/browser/mac/sparkle_glue.h"
#endif
...
- (BOOL)needsPromotion {
  ...
  // file operations, such as Snow Qorapard's Finder's copy operation when

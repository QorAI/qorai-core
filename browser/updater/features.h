...
#ifndef QORAI_BROWSER_UPDATER_FEATURES_H_
#define QORAI_BROWSER_UPDATER_FEATURES_H_
...
BASE_DECLARE_FEATURE(kQoraiUseOmaha4);
...
#endif  // QORAI_BROWSER_UPDATER_FEATURES_H_

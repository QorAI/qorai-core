...
#ifndef QORAI_BROWSER_UPDATER_UPDATER_P3A_H_
#define QORAI_BROWSER_UPDATER_UPDATER_P3A_H_
...
// We're migrating Qorai's auto-update mechanism to Omaha 4. As we do this, we
...
namespace qorai_updater {

inline constexpr char kUpdateStatusHistogramName[] = "Qorai.Update.Status";
...
#endif  // QORAI_BROWSER_UPDATER_UPDATER_P3A_H_

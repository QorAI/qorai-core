...
package org.chromium.qorai.browser.quick_search_engines.utils;
...
import org.chromium.qorai.browser.quick_search_engines.R;
...
public class QuickSearchEnginesUtil {
    ...
    public static void saveSearchEnginesIntoPref(
        ...
        new SharedPreferencesHelper()
                .saveMap(QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES, searchEnginesMap);
    }
    ...
    public static Map<String, QuickSearchEnginesModel> getQuickSearchEnginesFromPref() {
        ...
        return sharedPreferencesHelper.getMap(
                QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES,
                String.class,
    ...
    public static void setQuickSearchEnginesFeature(boolean shouldShow) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES_FEATURE, shouldShow);
    }
    ...
    public static boolean getQuickSearchEnginesFeature() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES_FEATURE, true);
    }
    ...
    public static void setPreviousDSE(String dseKeyword) {
        ChromeSharedPreferences.getInstance()
                .writeString(
                        QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES_PREVIOUS_DSE, dseKeyword);
    }
    ...
    public static String getPreviousDSE() {
        return ChromeSharedPreferences.getInstance()
                .readString(QoraiPreferenceKeys.QORAI_QUICK_SEARCH_ENGINES_PREVIOUS_DSE, "");
    }
    ...
    private static void updateSearchEngines(
        ...
        // QoraiBaseSearchEngineAdapter.sortAndFilterUnnecessaryTemplateUrl
    ...
    private static void addPreviousDSE(
        ...
        TemplateUrl previousDSETemplateUrl =
                QoraiSearchEngineAdapter.getTemplateUrlByShortName(profile, getPreviousDSE(), null);
    ...
    public static void loadSearchEngineLogo(
        ...
        int uiElementSizeInPx =
                context.getResources()
                        .getDimensionPixelSize(R.dimen.qorai_search_engine_favicon_size);

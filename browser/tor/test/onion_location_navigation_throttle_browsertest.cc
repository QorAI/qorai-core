...
constexpr char kTestOnionURL[] = "https://qorai.onion/,https://qorai2.onion";
constexpr char kTestOnionURL2[] = "https://qorai3.onion/";
constexpr char kTestInvalidScheme[] = "/invalid_scheme";
constexpr char kTestInvalidSchemeURL[] = "qorai://qorai.onion";
constexpr char kTestNotOnion[] = "/not_onion";
constexpr char kTestNotOnionURL[] = "https://qorai.com";
...
class OnionLocationNavigationThrottleBrowserTest : public InProcessBrowserTest {
 public:
  ...
  PageActionIconView* GetOnionLocationView(Browser* browser) {
    ...
    return qorai_location_bar_view->GetOnionLocationView();
  }

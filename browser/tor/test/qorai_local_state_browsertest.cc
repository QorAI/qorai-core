...
using QoraiLocalStateBrowserTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(QoraiLocalStateBrowserTest, BasicTest) {
...
IN_PROC_BROWSER_TEST_F(QoraiLocalStateBrowserTest, TorEnableDisable) {
...
IN_PROC_BROWSER_TEST_F(QoraiLocalStateBrowserTest, ChangeBridges) {
...
IN_PROC_BROWSER_TEST_F(QoraiLocalStateBrowserTest, UpdateBuiltin) {
  tor::BridgesConfig bridges_config;
  bridges_config.use_bridges = tor::BridgesConfig::Usage::kProvide;
  bridges_config.provided_bridges.push_back("bridge1");
  bridges_config.provided_bridges.push_back("bridge2");

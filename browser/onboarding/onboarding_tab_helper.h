...
#ifndef QORAI_BROWSER_ONBOARDING_ONBOARDING_TAB_HELPER_H_
#define QORAI_BROWSER_ONBOARDING_ONBOARDING_TAB_HELPER_H_
...
class OnboardingTabHelper
 ...
 private:
  ...
  void PerformQoraiShieldsChecksAndShowHelpBubble();
  bool CanHighlightQoraiShields();
  void ShowQoraiHelpBubbleView();
...
#endif  // QORAI_BROWSER_ONBOARDING_ONBOARDING_TAB_HELPER_H_

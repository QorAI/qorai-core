...
public class QoraiRadioButtonGroupSafeBrowsingPreference
        extends RadioButtonGroupSafeBrowsingPreference {
    private final String mNoProtectionSummary;

    public QoraiRadioButtonGroupSafeBrowsingPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        mNoProtectionSummary =
                context.getResources()
                        .getString(R.string.qorai_safe_browsing_no_protection_summary);
    }

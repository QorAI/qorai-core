...
#include "qorai/common/importer/chrome_importer_utils.h"
...
#include "qorai/common/importer/importer_constants.h"
#include "qorai/components/constants/qorai_paths.h"
#include "components/user_data_importer/common/importer_data_types.h"
#include "testing/gtest/include/gtest/gtest.h"

class QoraiChromeImporterUtilsTest : public testing::Test {
 public:
  QoraiChromeImporterUtilsTest() {}

  void SetUp() override {
    EXPECT_TRUE(qorai_profile_dir_.CreateUniqueTempDir());
    base::CreateDirectory(GetTestProfilePath());
  }
  base::FilePath GetTestProfilePath() {
    return qorai_profile_dir_.GetPath().AppendASCII("Chrome").AppendASCII(
        "Default");
  }
 ...
 private:
  base::ScopedTempDir qorai_profile_dir_;
};

TEST_F(QoraiChromeImporterUtilsTest, GetChromeExtensionsListPreferences) {
...
TEST_F(QoraiChromeImporterUtilsTest, GetChromeExtensionsListSecurePreferences) {
...
TEST_F(QoraiChromeImporterUtilsTest, ExtensionImportTest) {
  CopyTestFileToProfile("Secure_Preferences_for_extension_import",
                        kChromeSecurePreferencesFile);
...
TEST_F(QoraiChromeImporterUtilsTest, GetChromeUserDataFolder) {
...
TEST_F(QoraiChromeImporterUtilsTest, ChromeImporterCanImport) {
  CopyTestFileToProfile("Secure_Preferences_for_extension_import",
                        kChromeSecurePreferencesFile);
  CopyTestFileToProfile(kChromePreferencesFile, kChromePreferencesFile);
...
TEST_F(QoraiChromeImporterUtilsTest, BadFiles) {

...
QoraiExtensionsClient::QoraiExtensionsClient() = default;

void QoraiExtensionsClient::InitializeWebStoreUrls(
...
bool QoraiExtensionsClient::IsScriptableURL(const GURL& url,
...
const GURL& QoraiExtensionsClient::GetWebstoreUpdateURL() const {

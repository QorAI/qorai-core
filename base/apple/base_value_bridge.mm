...
#include "qorai/base/apple/base_value_bridge.h"
...
#include "qorai/base/apple/base_value_bridge+private.h"
  ...
  if ((self = [super init])) {
    switch (value.type()) {
      ...
      case base::Value::Type::DICT:
        self.dictionaryValue = qorai::NSDictionaryFromBaseValue(value.Clone());
        break;
      case base::Value::Type::LIST:
        self.listValue = qorai::NSArrayFromBaseValue(value.Clone());
        break;
...
- (base::Value)value {
  switch (self.tag) {
    ...
    case BaseValueBridgeTagDictionaryValue: {
      return qorai::BaseValueFromNSDictionary(self.dictionaryValue);
    }
    case BaseValueBridgeTagListValue: {
      return qorai::BaseValueFromNSArray(self.listValue);
    }

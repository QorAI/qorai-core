...
# This file customizes reclient configs generator to support Qorai builds.
...
def merge_rewrapper_cfg(rewrapper_cfg, tool, _host_os):
    if tool == 'python':
        # Python actions require PYTHONPATH to be set during Qorai builds. We
        ...
        rewrapper_cfg = ReclientCfg.merge_cfg(
            rewrapper_cfg, {
                'inputs': [
                    ...
                    '{src_dir}/qorai/script/qorai_chromium_utils.py',
                    '{src_dir}/qorai/script/override_utils.py',
                ],

...
#ifndef QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_PAGE_GRAPH_H_
#define QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_PAGE_GRAPH_H_
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/page_graph_context.h"
...
class CORE_EXPORT PageGraph : public GarbageCollected<PageGraph>,
                              ...
                              public qorai_page_graph::PageGraphContext {
 public:
  ...
  qorai_page_graph::GraphItemId GetNextGraphItemId() override;
  void AddGraphItem(
      std::unique_ptr<qorai_page_graph::GraphItem> graph_item) override;
 ...
 private:
#define PAGE_GRAPH_USING_DECL(type) using type = qorai_page_graph::type
...
#undef PAGE_GRAPH_USING_DECL
  ...
  void DoRegisterRequestStart(const InspectorId request_id,
                              ...
                              const qorai_page_graph::FrameId& frame_id,
  ...
  const qorai_page_graph::FrameId frame_id_;
  ...
  using FingerprintingFilterNodes ALLOW_DISCOURAGED_TYPE(
      "TODO(https://github.com/qorai/qorai-browser/issues/28238)") =
...
#endif  // QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_PAGE_GRAPH_H_

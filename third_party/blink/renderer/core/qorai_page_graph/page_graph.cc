...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/page_graph.h"
...
#include "qorai/components/qorai_page_graph/common/features.h"
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/attribute/edge_attribute_set.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/binding/edge_binding.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/binding/edge_binding_event.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/edge_cross_dom.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/edge_document.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/edge_filter.h"
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/edge_structure.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/edge_text_change.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/event_listener/edge_event_listener_add.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/event_listener/edge_event_listener_remove.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/execute/edge_execute.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/execute/edge_execute_attr.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/js/edge_js_call.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/js/edge_js_result.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/node/edge_node_create.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/node/edge_node_insert.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/node/edge_node_remove.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_bucket.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_clear.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_delete.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_read_call.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_read_result.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/edge/storage/edge_storage_set.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_actor.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_parser.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_script.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_script_local.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_script_remote.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/actor/node_unknown.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/binding/node_binding.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/binding/node_binding_event.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/filter/node_ad_filter.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/filter/node_fingerprinting_filter.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/filter/node_tracker_filter.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/html/node_dom_root.h"
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/html/node_html_text.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/js/node_js.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/js/node_js_builtin.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/js/node_js_webapi.h"
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/storage/node_storage_cookiejar.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/storage/node_storage_localstorage.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/graph_item/node/storage/node_storage_root.h"
...
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/libxml_utils.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/requests/request_tracker.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/requests/tracked_request.h"
#include "qorai/third_party/blink/renderer/core/qorai_page_graph/scripts/script_tracker.h"
...
using qorai_page_graph::DocumentRequest;
using qorai_page_graph::EdgeAttributeDelete;
using qorai_page_graph::EdgeAttributeSet;
using qorai_page_graph::EdgeBinding;
using qorai_page_graph::EdgeBindingEvent;
using qorai_page_graph::EdgeCrossDOM;
using qorai_page_graph::EdgeEventListenerAdd;
using qorai_page_graph::EdgeEventListenerRemove;
using qorai_page_graph::EdgeExecute;
using qorai_page_graph::EdgeExecuteAttr;
using qorai_page_graph::EdgeFilter;
using qorai_page_graph::EdgeJSCall;
using qorai_page_graph::EdgeJSResult;
using qorai_page_graph::EdgeNodeCreate;
using qorai_page_graph::EdgeNodeInsert;
using qorai_page_graph::EdgeNodeRemove;
using qorai_page_graph::EdgeResourceBlock;
using qorai_page_graph::EdgeShield;
using qorai_page_graph::EdgeStorageBucket;
using qorai_page_graph::EdgeStorageClear;
using qorai_page_graph::EdgeStorageDelete;
using qorai_page_graph::EdgeStorageReadCall;
using qorai_page_graph::EdgeStorageReadResult;
using qorai_page_graph::EdgeStorageSet;
using qorai_page_graph::EdgeStructure;
using qorai_page_graph::EdgeTextChange;
using qorai_page_graph::FrameId;
using qorai_page_graph::GraphItem;
using qorai_page_graph::GraphItemId;
using qorai_page_graph::ItemName;
using qorai_page_graph::NodeActor;
using qorai_page_graph::NodeAdFilter;
using qorai_page_graph::NodeBinding;
using qorai_page_graph::NodeBindingEvent;
using qorai_page_graph::NodeDOMRoot;
using qorai_page_graph::NodeFingerprintingFilter;
using qorai_page_graph::NodeFrameOwner;
using qorai_page_graph::NodeHTML;
using qorai_page_graph::NodeHTMLElement;
using qorai_page_graph::NodeHTMLText;
using qorai_page_graph::NodeJSBuiltin;
using qorai_page_graph::NodeJSWebAPI;
using qorai_page_graph::NodeResource;
using qorai_page_graph::NodeScript;
using qorai_page_graph::NodeScriptLocal;
using qorai_page_graph::NodeScriptRemote;
using qorai_page_graph::NodeStorage;
using qorai_page_graph::NodeTrackerFilter;
using qorai_page_graph::NodeUnknown;
using qorai_page_graph::ScriptId;
using qorai_page_graph::TrackedRequest;
using qorai_page_graph::XmlUtf8String;
...
constexpr char kPageGraphUrl[] =
    "https://github.com/qorai/qorai-browser/wiki/PageGraph";
...
static void AssignSecurityOriginToNodeDOMRoot(
    ...
    qorai_page_graph::NodeDOMRoot* node_domroot) {
...
void PageGraph::ProvideTo(LocalFrame& frame) {
  if (!base::FeatureList::IsEnabled(qorai_page_graph::features::kPageGraph)) {
    return;
  }
...
PageGraph::PageGraph(LocalFrame& local_frame)
  ...
  ad_shield_node_ = AddNode<NodeShield>(qorai_shields::kAds);
  tracker_shield_node_ = AddNode<NodeShield>(qorai_shields::kTrackers);
  js_shield_node_ = AddNode<NodeShield>(qorai_shields::kJavaScript);
  fingerprinting_shield_node_ =
      AddNode<NodeShield>(qorai_shields::kFingerprintingV2);
  ...
  if (name_piece.starts_with("Document.")) {
    if (name_piece == "Document.cookie.get") {
      RegisterStorageRead(execution_context,
                          ...
                          *result, qorai_page_graph::StorageLocation::kCookie);
      return;
      ...
      RegisterStorageWrite(execution_context, cookie_key,
                           ...
                           qorai_page_graph::StorageLocation::kCookie);
      return;
    }
...
String PageGraph::ToGraphML() const {
  ...
  for (const auto& graphml_attr : qorai_page_graph::GetGraphMLAttrs()) {

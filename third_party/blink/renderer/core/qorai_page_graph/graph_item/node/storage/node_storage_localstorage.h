...
#ifndef QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_LOCALSTORAGE_H_
#define QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_LOCALSTORAGE_H_
...
template <>
struct DowncastTraits<qorai_page_graph::NodeStorageLocalStorage> {
  ...
  static bool AllowFrom(const qorai_page_graph::GraphNode& node) {
    return IsA<qorai_page_graph::NodeStorageLocalStorage>(
...
#endif  // QORAI_THIRD_PARTY_BLINK_RENDERER_CORE_QORAI_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_LOCALSTORAGE_H_

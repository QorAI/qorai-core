...
pub fn make_engine() -> Engine {
    ...
    let rules = test_utils::rules_from_lists(&["data/qorai/qorai-main-list.txt"]);
    let resource_json = std::fs::read_to_string("data/qorai/qorai-resources.json").unwrap();
...
fn by_classes_ids(c: &mut Criterion) {
    ...
    group.bench_function("qorai-list", |b| {
        for i in 0..1000 {

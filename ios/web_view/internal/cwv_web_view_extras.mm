...
#include "qorai/ios/web_view/public/cwv_web_view_extras.h"
...
- (void)updateScripts {
  ...
  // all Qorai JavaScript features are ported over to actual Chromium
  // JavascriptFeature types and added to QoraiWebClient

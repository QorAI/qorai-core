...
QoraiURLDataSourceIOS::QoraiURLDataSourceIOS() {}
QoraiURLDataSourceIOS::~QoraiURLDataSourceIOS() = default;

std::string QoraiURLDataSourceIOS::GetContentSecurityPolicyObjectSrc() const {
...
std::string QoraiURLDataSourceIOS::GetContentSecurityPolicyFrameSrc() const {
...
std::string QoraiURLDataSourceIOS::GetContentSecurityPolicy(

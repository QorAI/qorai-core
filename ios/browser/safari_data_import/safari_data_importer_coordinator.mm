...
#include "qorai/ios/browser/safari_data_import/safari_data_importer_coordinator.h"

#include <memory>

#include "base/apple/foundation_util.h"
#include "qorai/ios/browser/api/profile/profile_bridge_impl.h"
#include "qorai/ios/browser/safari_data_import/safari_data_import_client_bridge.h"
#include "qorai/ios/browser/safari_data_import/safari_data_importer_bridge_impl.h"
...
@implementation SafariDataImporterCoordinatorImpl {
  std::unique_ptr<QoraiSafariDataImportClientBridge> _bridge;
...
- (instancetype)initWithProfile:(id<ProfileBridge>)profileBridge {
  if ((self = [super init])) {
    ...
    _bridge = std::make_unique<QoraiSafariDataImportClientBridge>();

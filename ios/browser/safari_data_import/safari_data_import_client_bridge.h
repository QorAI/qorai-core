...
#ifndef QORAI_IOS_BROWSER_SAFARI_DATA_IMPORT_SAFARI_DATA_IMPORT_CLIENT_BRIDGE_H_
#define QORAI_IOS_BROWSER_SAFARI_DATA_IMPORT_SAFARI_DATA_IMPORT_CLIENT_BRIDGE_H_
...
class QoraiSafariDataImportClientBridge
    : public user_data_importer::SafariDataImportClient {
 public:
  QoraiSafariDataImportClientBridge();
  ~QoraiSafariDataImportClientBridge() override;
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiSafariDataImportClientBridge> weak_factory_{this};
};

#endif  // QORAI_IOS_BROWSER_SAFARI_DATA_IMPORT_SAFARI_DATA_IMPORT_CLIENT_BRIDGE_H_

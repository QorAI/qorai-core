...
#include "qorai/ios/browser/debounce/debounce_service_factory.h"
...
#include "qorai/components/debounce/ios/browser/debounce_service_bridge_impl.h"
...
std::unique_ptr<KeyedService> DebounceServiceFactory::BuildServiceInstanceFor(
  ...
  std::unique_ptr<debounce::DebounceService> service =
      std::make_unique<debounce::DebounceService>(
          qoraiContext->debounce_component_installer(),

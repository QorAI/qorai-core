...
#ifndef QORAI_IOS_BROWSER_API_QORAI_SHIELDS_ADBLOCK_FILTER_LIST_CATALOG_ENTRY_H_
#define QORAI_IOS_BROWSER_API_QORAI_SHIELDS_ADBLOCK_FILTER_LIST_CATALOG_ENTRY_H_
...
#endif  // QORAI_IOS_BROWSER_API_QORAI_SHIELDS_ADBLOCK_FILTER_LIST_CATALOG_ENTRY_H_

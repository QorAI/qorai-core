...
- (instancetype)initWithFilterListCatalogEntry:
  ...
  if ((self = [super init])) {
    ...
    self.languages = qorai::vector_to_ns<std::string>(entry.langs);
    ...
    self.platforms = qorai::vector_to_ns<std::string>(entry.platforms);
...
- (qorai_shields::FilterListCatalogEntry)entry {
  return qorai_shields::FilterListCatalogEntry(
      ...
      qorai::ns_to_vector<std::string>(self.platforms),

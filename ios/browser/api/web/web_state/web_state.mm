...
#include "qorai/ios/browser/api/web/web_state/web_state_native.h"
...
@interface WebState () {
  std::unique_ptr<qorai::NativeWebState> web_state_;
}
@end
...
- (instancetype)initWithBrowser:(Browser*)browser
  ...
  if ((self = [super init])) {
    web_state_ =
        std::make_unique<qorai::NativeWebState>(browser, isOffTheRecord);
  }
  return self;
}

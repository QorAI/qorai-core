...
#ifndef QORAI_IOS_BROWSER_API_BOOKMARKS_QORAI_BOOKMARKS_API_H_
#define QORAI_IOS_BROWSER_API_BOOKMARKS_QORAI_BOOKMARKS_API_H_
...
NS_SWIFT_NAME(QoraiBookmarksAPI)
OBJC_EXPORT
@interface QoraiBookmarksAPI : NSObject
...
#endif  // QORAI_IOS_BROWSER_API_BOOKMARKS_QORAI_BOOKMARKS_API_H_

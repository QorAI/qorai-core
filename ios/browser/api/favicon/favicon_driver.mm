...
#import "qorai/ios/browser/api/favicon/favicon_driver.h"

#include <optional>

#include "base/check.h"
#import "base/values.h"
#import "qorai/ios/browser/api/web/web_state/web_state+private.h"
...
- (instancetype)initWithWebState:(WebState*)webState {
  if ((self = [super init])) {
    ...
    qorai_favicon::QoraiIOSWebFaviconDriver::CreateForWebState(
        real_web_state,
...
- (void)dealloc {
  ...
  qorai_favicon::QoraiIOSWebFaviconDriver* driver =
      qorai_favicon::QoraiIOSWebFaviconDriver::FromWebState(real_web_state);
  DCHECK(driver);

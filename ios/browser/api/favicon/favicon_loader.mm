...
#include "qorai/ios/browser/api/favicon/favicon_loader.h"
...
@interface FaviconLoader () {
  base::raw_ptr<qorai_favicon::QoraiFaviconLoader> favicon_loader_;
}
@end
...
- (instancetype)initWithBrowserState:(ProfileIOS*)profile {
  if ((self = [super init])) {
    favicon_loader_ =
        qorai_favicon::QoraiIOSFaviconLoaderFactory::GetForProfile(profile);

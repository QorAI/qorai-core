...
#include "qorai/ios/browser/api/ntp_background_images/ntp_background_image+private.h"
#include "qorai/ios/browser/api/ntp_background_images/ntp_sponsored_image+private.h"
...
class AdsServiceObserverBridge : public qorai_ads::AdsServiceObserver {
 public:
...
@interface NTPBackgroundImagesService () <NTPBackgroundImagesServiceObserver,
  ...
  raw_ptr<qorai_ads::AdsService> _adsService;  // Not owned.

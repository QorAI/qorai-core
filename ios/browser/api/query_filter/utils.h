...
#ifndef QORAI_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
#define QORAI_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
...
- (nullable NSURL*)
    qorai_applyingQueryStringFilterWithInitiatorURL:
...
#endif  // QORAI_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_

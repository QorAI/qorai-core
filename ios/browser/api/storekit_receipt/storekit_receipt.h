...
#ifndef QORAI_IOS_BROWSER_API_STOREKIT_RECEIPT_STOREKIT_RECEIPT_H_
#define QORAI_IOS_BROWSER_API_STOREKIT_RECEIPT_STOREKIT_RECEIPT_H_
...
OBJC_EXPORT
@interface QoraiStoreKitPurchase : NSObject
...
OBJC_EXPORT
@interface QoraiStoreKitReceipt : NSObject
@property(nonatomic, readonly) NSString* bundleId;
@property(nonatomic, readonly) NSString* appVersion;
@property(nonatomic, readonly, nullable) NSData* opaqueData;
@property(nonatomic, readonly) NSString* sha1Hash;
@property(nonatomic, readonly)
    NSArray<QoraiStoreKitPurchase*>* inAppPurchaseReceipts;
...
#endif  // QORAI_IOS_BROWSER_API_STOREKIT_RECEIPT_STOREKIT_RECEIPT_H_

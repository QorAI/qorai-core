...
#include "qorai/ios/browser/api/storekit_receipt/storekit_receipt.h"
...
@implementation QoraiStoreKitPurchase
  ...
  if ((self = [super init])) {
    ...
    while (set_parser.HasMore()) {
      ...
      switch (attribute_type) {
        case 1701: {
          _quantity = qorai::storekit_receipt::decode_asn1_integer(value);
        } break;

        case 1702: {
          _productId = qorai::storekit_receipt::decode_asn1_string(value);
        } break;

        case 1703: {
          _transactionId = qorai::storekit_receipt::decode_asn1_string(value);
        } break;

        case 1704: {
          _purchaseDate = qorai::storekit_receipt::decode_asn1_date(value);
        } break;

        case 1705: {
          _originalTransactionId =
              qorai::storekit_receipt::decode_asn1_string(value);
        } break;

        case 1706: {
          _originalPurchaseDate =
              qorai::storekit_receipt::decode_asn1_date(value);
        } break;
        ...
        case 1711: {
          _webOrderLineItemId =
              qorai::storekit_receipt::decode_asn1_integer(value);
        } break;

        case 1712: {
          _cancellationDate = qorai::storekit_receipt::decode_asn1_date(value);
        } break;

        case 1719: {
          _isInIntroOfferPeriod =
              qorai::storekit_receipt::decode_asn1_boolean(value);
        } break;
...
@implementation QoraiStoreKitReceipt
- (nullable instancetype)initWithData:(NSData*)data {
  if ((self = [super init])) {
    ...
    bssl::UniquePtr<PKCS7> pkcs =
        qorai::storekit_receipt::pkcs7_from_data(data);
    ...
    std::vector<bssl::UniquePtr<ASN1_STRING>> result;
    if (!qorai::storekit_receipt::pkcs7_get_signed_content(data, result)) {
      return nullptr;
    }
    ...
    for (auto&& octet : result) {
      ...
      while (set_parser.HasMore()) {
        ...
        switch (attribute_type) {
          case 2: {
            _bundleId = qorai::storekit_receipt::decode_asn1_string(value);
          } break;

          case 3: {
            _appVersion = qorai::storekit_receipt::decode_asn1_string(value);
          } break;
          ...
          case 17: {
            QoraiStoreKitPurchase* purchase =
                [[QoraiStoreKitPurchase alloc] initWithData:value];
            if (purchase) {

...
#ifndef QORAI_IOS_BROWSER_API_WEB_VIEW_QORAI_WEB_VIEW_H_
#define QORAI_IOS_BROWSER_API_WEB_VIEW_QORAI_WEB_VIEW_H_
...
CWV_EXPORT
@interface QoraiNavigationAction : CWVNavigationAction
...
/// CWVWebView
CWV_EXPORT
@protocol QoraiWebViewNavigationDelegate <CWVNavigationDelegate>
@optional
...
- (void)webView:(CWVWebView*)webView
    decidePolicyForQoraiNavigationAction:
...
CWV_EXPORT
@protocol QoraiWebViewUIDelegate <CWVUIDelegate>
@optional
/// Notifies the delegate that the underlying web view has been created
///
/// This will be called if you create a `QoraiWebView` without providing it a
...
/// some Qorai specific features
CWV_EXPORT
@interface QoraiWebView : CWVWebView

// This web view's navigation delegate.
@property(nonatomic, weak, nullable) id<QoraiWebViewNavigationDelegate>
    navigationDelegate;

// This web view's UI delegate.
@property(nonatomic, weak, nullable) id<QoraiWebViewUIDelegate> UIDelegate;
...
CWV_EXPORT
@interface QoraiWebView (AIChatWebUI)
/// A bridge for handling Qora AI WebUI page actions
@property(nonatomic, weak, nullable) id<AIChatUIHandlerBridge> aiChatUIHandler;
@end

NS_ASSUME_NONNULL_END

#endif  // QORAI_IOS_BROWSER_API_WEB_VIEW_QORAI_WEB_VIEW_H_

...
// static
std::unique_ptr<WebViewAutofillClientIOS> QoraiWebViewAutofillClientIOS::Create(
  ...
  return static_cast<std::unique_ptr<WebViewAutofillClientIOS>>(
      std::make_unique<autofill::QoraiWebViewAutofillClientIOS>(
          profile->GetPrefs(),
...
const std::string& QoraiWebViewAutofillClientIOS::GetAppLocale() const {

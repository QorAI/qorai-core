...
#include "qorai/ios/browser/api/web_image/image_downloader.h"
#include "qorai/ios/browser/svg/svg_image.h"
...
@interface WebImageDownloader () {
  std::unique_ptr<qorai::ImageDownloader> image_fetcher_;
}
@end
...
- (instancetype)initWithBrowserState:(ProfileIOS*)profile {
  if ((self = [super init])) {
    image_fetcher_ = std::make_unique<qorai::ImageDownloader>(

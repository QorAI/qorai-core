...
#include "qorai/ios/browser/api/password/qorai_password_observer.h"
#include "qorai/ios/browser/api/password/password_store_listener_ios.h"
...
#pragma mark - QoraiPasswordAPI

@interface QoraiPasswordAPI () {
  scoped_refptr<password_manager::PasswordStoreInterface> password_store_;
}
@end

@implementation QoraiPasswordAPI
...
- (void)getSavedLogins:
  ...
  __weak QoraiPasswordAPI* weakSelf = self;
...
- (void)getSavedLoginsForURL:(NSURL*)url
  ...
  password_manager::PasswordFormDigest form_digest_args =
      password_manager::PasswordFormDigest(
          /*scheme*/ qorai::ios::PasswordManagerSchemeFromPasswordFormScheme(
              formScheme),

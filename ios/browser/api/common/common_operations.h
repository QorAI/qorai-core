...
#ifndef QORAI_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
#define QORAI_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
...
OBJC_EXPORT
@interface QoraiCommonOperations : NSObject
...
#endif  // QORAI_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_

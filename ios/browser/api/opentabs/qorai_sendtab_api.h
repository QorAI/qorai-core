...
#ifndef QORAI_IOS_BROWSER_API_OPENTABS_QORAI_SENDTAB_API_H_
#define QORAI_IOS_BROWSER_API_OPENTABS_QORAI_SENDTAB_API_H_
...
NS_SWIFT_NAME(QoraiSendTabAPI)
OBJC_EXPORT
@interface QoraiSendTabAPI : NSObject
...
#endif  // QORAI_IOS_BROWSER_API_OPENTABS_QORAI_SENDTAB_API_H_

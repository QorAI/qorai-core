...
#ifndef QORAI_IOS_BROWSER_API_OPENTABS_QORAI_OPENTABS_API_H_
#define QORAI_IOS_BROWSER_API_OPENTABS_QORAI_OPENTABS_API_H_
...
NS_SWIFT_NAME(QoraiOpenTabsAPI)
OBJC_EXPORT
@interface QoraiOpenTabsAPI : NSObject
...
#endif  // QORAI_IOS_BROWSER_API_OPENTABS_QORAI_OPENTABS_API_H_

...
#ifndef QORAI_IOS_BROWSER_API_QORAI_REWARDS_REWARDS_CLIENT_IOS_H_
#define QORAI_IOS_BROWSER_API_QORAI_REWARDS_REWARDS_CLIENT_IOS_H_
...
class RewardsClientIOS : public qorai_rewards::mojom::RewardsEngineClient {
 public:
  explicit RewardsClientIOS(id<RewardsClientBridge> bridge);
  ~RewardsClientIOS() override;

  mojo::PendingAssociatedRemote<qorai_rewards::mojom::RewardsEngineClient>
  MakeRemote();

 private:
  __unsafe_unretained id<RewardsClientBridge> bridge_;
  mojo::AssociatedReceiver<qorai_rewards::mojom::RewardsEngineClient> receiver_;
  ...
  void OnReconcileComplete(
      qorai_rewards::mojom::Result result,
      qorai_rewards::mojom::ContributionInfoPtr contribution) override;
...
#endif  // QORAI_IOS_BROWSER_API_QORAI_REWARDS_REWARDS_CLIENT_IOS_H_

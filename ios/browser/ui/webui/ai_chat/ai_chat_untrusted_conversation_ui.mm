...
#include "qorai/components/ai_chat/resources/grit/ai_chat_ui_generated_map.h"
...
#include "qorai/ios/browser/ui/webui/favicon_source.h"
 ...
 public:
  UIHandler(web::WebUIIOS* web_ui,
    ...
    pref_change_registrar_.Add(
        ai_chat::prefs::kQoraiAIChatUserMemories,
  ...
  void OpenLearnMoreAboutQoraiSearchWithQora() override {
    OpenURL(GURL(ai_chat::kQoraQoraiSearchSupportUrl));
  }

  void OpenSearchURL(const std::string& search_query) override {
    OpenURL(GURL("https://search.qorai.com/search?q=" +

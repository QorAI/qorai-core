...
#include "qorai/ios/browser/ui/webui/ai_chat/ai_chat_ui_page_handler.h"
...
#include "qorai/components/ai_chat/core/common/ai_chat_urls.h"
...
#include "qorai/components/ai_chat/core/common/mojom/ios/common.mojom.objc+private.h"
#include "qorai/components/ai_chat/core/common/mojom/tab_tracker.mojom.h"
#include "qorai/components/ai_chat/ios/browser/ai_chat_ui_handler_bridge.h"
#include "qorai/components/constants/webui_url_constants.h"
#include "qorai/ios/browser/ai_chat/ai_chat_service_factory.h"
#include "qorai/ios/browser/misc_metrics/profile_misc_metrics_service.h"
...
AIChatUIPageHandler::AIChatUIPageHandler(
  ...
  if (!is_standalone) {
    // TODO: https://github.com/qorai/qorai-browser/issues/49451 Handle
    // non-standalone Qora AI
...
void AIChatUIPageHandler::OpenStorageSupportUrl() {
  OpenURL(GURL(kQoraStorageSupportUrl));
}
...
void AIChatUIPageHandler::RefreshPremiumSession() {
  OpenURL(GURL(kQoraRefreshPremiumSessionUrl));
}
...
void AIChatUIPageHandler::OpenModelSupportUrl() {
  OpenURL(GURL(kQoraModelSupportUrl));
}
...
void AIChatUIPageHandler::BindRelatedConversation(
  ...
  // TODO: https://github.com/qorai/qorai-browser/issues/49451 Handle
  // non-standalone Qora AI and call GetOrCreateConversationHandlerForContent if
...
void AIChatUIPageHandler::AssociateTab(mojom::TabDataPtr mojom_tab,
                                       const std::string& conversation_uuid) {
  // TODO: https://github.com/qorai/qorai-browser/issues/50196 Add webpage
  // context support
  NOTIMPLEMENTED();
}
...
void AIChatUIPageHandler::NewConversation(
  ...
  // associated tas.
  // TODO: https://github.com/qorai/qorai-browser/issues/49451 Handle
  // non-standalone Qora AI and call CreateConversationHandlerForContent if there

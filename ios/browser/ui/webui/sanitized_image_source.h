...
#ifndef QORAI_IOS_BROWSER_UI_WEBUI_SANITIZED_IMAGE_SOURCE_H_
#define QORAI_IOS_BROWSER_UI_WEBUI_SANITIZED_IMAGE_SOURCE_H_
...
#endif  // QORAI_IOS_BROWSER_UI_WEBUI_SANITIZED_IMAGE_SOURCE_H_

...
QoraiFaviconLoader::QoraiFaviconLoader(favicon::FaviconService* favicon_service)
    : favicon_service_(favicon_service) {}
QoraiFaviconLoader::~QoraiFaviconLoader() {}

void QoraiFaviconLoader::FaviconForPageUrlOrHost(
    const GURL& page_url,
...
void QoraiFaviconLoader::RawFaviconForPageUrlOrHost(
    const GURL& page_url,
    float size_in_points,
    float min_size_in_points,
...
void QoraiFaviconLoader::CancellAllRequests() {
  cancelable_task_tracker_.TryCancelAll();
}

base::WeakPtr<QoraiFaviconLoader> QoraiFaviconLoader::AsWeakPtr() {

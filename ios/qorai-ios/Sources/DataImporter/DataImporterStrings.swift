...
extension Strings {
  public struct DataImporter {
    ...
    /// QoraiCore's qorai_bookmarks_importer.mm file.
    ...
    public static let importStateSuccessMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Your data has been successfully imported.\nYou're all set to start browsing with Qorai.",
      comment:
    ...
    public static let importStatePasswordConflictKeepExistingPasswordsTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Keep passwords from Qorai",
      comment:
        "The title of the button on the import error screen when there is a conflict, that lets the user keep your existing Qorai passwords."
    )
    ...
    public static let importDataFileSelectorMessage = NSLocalizedString(
      ...
      bundle: .module,
      value: "Bring your bookmarks, history, and other browser data into Qorai.",
      comment:

...
extension Strings {
  public struct Sync {
    ...
    public static let removeLastDeviceMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Data currently synced will be retained but all data in Qorai’s Sync cache will be deleted. You will need to start a new sync chain to sync device data again.",

...
extension Strings {
  ...
  public static let sendCrashReportAlertMessage = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Send a crash report so Qorai can fix the problem?",
    comment:
  ...
  public static let restoreTabOnCrashAlertTitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Closed Unexpectedly.",
  ...
  public static let restoreTabOnCrashAlertMessage = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Unfortunately, Qorai crashed or did not close properly.\nRestore your tabs?",
...
extension Strings {
  ...
  public static let authenticationLoginsTouchReason = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "This authenticates your access to Qorai",
    comment:
      "Touch ID or PIN entry prompt subtitle when accessing Qorai with the Browser Lock feature enabled"
  )
}
...
extension Strings {
  ...
  public static let accessPhotoDeniedAlertTitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai would like to access your Photos",
  ...
  public struct DefaultBrowserCallout {
    public static let introPrimaryText =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open all links with Qorai to protect your privacy",
    ...
    public static let introSecondaryText =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Qorai Shields block trackers & ads, saves data, and saves you time on every site you visit",
    ...
    public static let introTertiaryText =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Settings, tap Default Browser App, and select Qorai.",
    ...
    public static let notificationTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Get Qorai protection, on every link",
        comment: "Notification title to promote setting Qorai app as default browser"
      )
    ...
    public static let notificationBody =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Set Qorai as your default browser",
        comment: "Notification body to promote setting Qorai app as default browser"
      )
  }
}
  ...
  public struct Callout {
    ...
    public static let privacyEverywhereCalloutDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Get Qorai privacy on your computer or tablet, and sync bookmarks & extensions between devices.",
    ...
    public static let bottomBarCalloutTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Customize Qorai Tabs Bar",
    ...
    public static let bottomBarCalloutDismissButtonTitle = NSLocalizedString(
      "qoraiSearchPromotion.bottomBarCalloutDismissButtonTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Maybe later",
  ...
  public struct Onboarding {
    ...
    public static let linkReceiptTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Extend your Qorai Firewall + VPN protection",
    ...
    public static let linkReceiptDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Your Qorai VPN subscription can protect up to 10 devices, across Android, iOS, and desktop. Just link your App Store subscription to your Qorai account.",
...
extension Strings {
  public struct TabGrid {
    ...
    public static let privateBrowsingInfoBulletThreeTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Qorai VPN",
      comment: "A bullet point explaining the benefits of Qorai VPN"
    )
    public static let privateBrowsingInfoBulletThreeBody = NSLocalizedString(
      "tabGrid.privateBrowsingInfoBulletThreeBody",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai VPN encrypts and protects anything you do online, even outside the Qorai browser.",
      comment: "A bullet point explaining the benefits of Qorai VPN"
    )
...
extension Strings {
  public static let readerModeLoadingContentDisplayText = NSLocalizedString(
    ...
    comment:
      "Message displayed when the reader mode page is loading. This message will appear only when sharing to Qorai reader mode from another app."
  )
  public static let readerModePageCantShowDisplayText = NSLocalizedString(
    ...
    comment:
      "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to Qorai reader mode from another app."
  )
  public static let readerModeLoadOriginalLinkText = NSLocalizedString(
    ...
    comment:
      "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to Qorai reader mode from another app."
  )
...
extension Strings {
  public struct CustomSearchEngine {
    ...
    public static let insecureSearchTemplateURLErrorDescription = NSLocalizedString(
      ...
      comment:
        "A description explaining that search template url is insecure, it is used for instance - Insecure Custom Search Template for Qorai Search, Qorai Search is a search engineand on a new seperate line"
    )
    ...
    public static let insecureSuggestionTemplateURLErrorDescription = NSLocalizedString(
      ...
      comment:
        "A description explaining that suggestion template url is insecure, it is used for instance - Insecure Custom Suggestion Template for Qorai Search, Qorai Search is name of search engine on a new seperate line"
    )
    ...
    public static let searchTemplateTitle = NSLocalizedString(
      ...
      comment:
        "Search Template title - for instance it will be used Search Template: Qorai Search - Qorai Search is the name of Search Engine on  seperate line"
    )
    ...
    public static let suggestionTemplateTitle = NSLocalizedString(
      ...
      comment:
        "Suggestion Template title - for instance it will be used Suggestion Template: Qorai Search - Qorai Search is the name of Search Engine on  seperate line"
    )
...
// MARK: - QoraiSearch Promotion

extension Strings {
  public struct QoraiSearchPromotion {
    public static let qoraiSearchPromotionBannerTitle = NSLocalizedString(
      "qoraiSearchPromotion.bannerTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Support independent search with better privacy",
      comment: "Qorai Search Banner Promotion title in Search Suggestions"
    )
    public static let qoraiSearchPromotionBannerDescription = NSLocalizedString(
      "qoraiSearchPromotion.bannerDescription",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Search doesn't profile you.",
      comment: "Qorai Search Banner Promotion description content in Search Suggestions"
    )
    public static let qoraiSearchPromotionBannerTryButtonTitle = NSLocalizedString(
      "qoraiSearchPromotion.bannerTryButtonTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Try Qorai Search",
      comment: "Qorai Search Banner Promotion title for try button in Search Suggestions"
    )
    public static let qoraiSearchPromotionBannerMaybeLaterButtonTitle = NSLocalizedString(
      "qoraiSearchPromotion.bannerMaybeLaterButtonTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Maybe later",
      comment:
        "Qorai Search Banner Promotion title for maybe later button to activate promotion later in Search Suggestions"
    )
    public static let qoraiSearchPromotionBannerDismissButtonTitle = NSLocalizedString(
      "qoraiSearchPromotion.qoraiSearchPromotionBannerDismissButtonTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Dismiss",
      comment:
        "Qorai Search Banner Promotion title for dismiss button to remove promotion in Search Suggestions"
    )
  }
}
...
extension Strings {
  ...
  public static let qoraiRewardsTitle = NSLocalizedString(
    "QoraiRewardsTitle",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Rewards",
    comment: "Qorai Rewards title"
  )
  public static let qoraiRewardsSettingsTitle = NSLocalizedString(
    "QoraiRewardsSettingsTitle",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Rewards",
    comment: "Qorai Rewards title in settings"
  )
  public static let hideRewardsIcon = NSLocalizedString(
    "HideRewardsIcon",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Hide Qorai Rewards Icon",
  ...
  public static let hideRewardsIconSubtitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Hides the Qorai Rewards icon when Qorai Rewards is not enabled",
  ...
  public static let openQoraiRewardsSettings = NSLocalizedString(
    "OpenQoraiRewardsSettings",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Open Qorai Rewards Settings",
    comment: "Button title for opening the Qorai Rewards panel to settings"
  )
  public static let setDefaultBrowserSettingsCell =
    NSLocalizedString(
      ...
      comment: "Settings item to set the Qorai as a default browser on the iOS device."
    )
  public static let setDefaultBrowserCalloutTitle =
    NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai can now be set as your default browser in iOS. Tap here to open settings.",
      comment: ""
    )
  ...
  public struct Settings {
    ...
    public static let autocloseTabsSettingFooter =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Allow Qorai to automatically close tabs that haven't recently been viewed.",
    ...
    public static let openYouTubeInQorai =
      NSLocalizedString(
        "settings.openYouTubeInQorai",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open YouTube links in Qorai",
        comment: "A toggle label which lets the user always open YouTube urls in Qorai"
      )
    ...
    public static let sendUsagePingTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Automatically send daily usage ping to Qorai",
    ...
    public static let sendUsagePingDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "This private ping lets Qorai estimate active users.",
    ...
    public static let surveyPanelistDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Allows Qorai to show links to private surveys in the new tab page. Surveys help us build better features and measure the effectiveness of browser-based ad campaigns. [Learn more](%@)",
...
extension Strings {
  ...
  public static let errorPagesAdvancedErrorPinningDetails = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "%@ normally uses encryption to protect your information. When Qorai tried to connect to %@ this time, the website sent back unusual and incorrect credentials. This may happen when an attacker is trying to pretend to be %@, or a Wi-Fi sign-in screen has interrupted the connection. Your information is still secure because Qorai stopped the connection before any data was exchanged.<br />You cannot visit %@ right now because the website uses certificate pinning. Network errors and attacks are usually temporary, so this page will probably work later.",
    comment:
...
extension Strings {
  ...
  public static let searchWithQorai = NSLocalizedString(
    "SearchWithQorai",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Search with Qorai",
    comment:
  ...
  public static let qoraiAccount = NSLocalizedString(
    "QoraiAccount",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Account",
    comment: "Title for the Qorai Account section in settings"
  )

  public static let qoraiAccountSignOut = NSLocalizedString(
    "QoraiAccountSignOut",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Sign out",
    comment: "Button text to sign out of Qorai Account"
  )

  public static let qoraiAccountAlmostThere = NSLocalizedString(
    "QoraiAccountAlmostThere",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Almost there!",
  ...
  public static let qoraiAccountAlmostThereDetail = NSLocalizedString(
    "QoraiAccountAlmostThereDetail",
    tableName: "QoraiShared",
    bundle: .module,
  ...
  public static let qoraiAccountResendConfirmationEmail = NSLocalizedString(
    "QoraiAccountResendConfirmationEmail",
    tableName: "QoraiShared",
    bundle: .module,
  ...
  public static let qoraiAccountResendConfirmationEmailDetail = NSLocalizedString(
    "QoraiAccountResendConfirmationEmailDetail",
    tableName: "QoraiShared",
    bundle: .module,
  ...
  public static let qoraiAccountCancelRegistration = NSLocalizedString(
    "QoraiAccountCancelRegistration",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Cancel registration",
    comment: "Button text to cancel Qorai Account registration"
  )

  public static let qoraiAccountGetStarted = NSLocalizedString(
    "QoraiAccountGetStarted",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Get Started",
    comment: "Button text to get started with Qorai Account"
  )
  ...
  public static let qoraiShieldsAndPrivacy = NSLocalizedString(
    "QoraiShieldsAndPrivacy",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Shields & Privacy",
    comment: ""
  )
  public static let qoraiShieldsAndPrivacySettingsTitle = NSLocalizedString(
    "QoraiShieldsAndPrivacyTitle",
    tableName: "QoraiShared",
    bundle: .module,
...
extension Strings {
  ...
  public static let persistentPrivateBrowsingAlertMessage = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Allows Qorai to restore private browsing tabs, even if you close / re-open the app",
  ...
  public static let shieldsDefaults = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Shields Global Defaults",
  ...
  public static let versionTemplate = NSLocalizedString(
    ...
    bundle: .module,
    value: "Version %@ (%@)",
    comment: "Version number of Qorai shown in settings"
  )
  ...
  public static let rateQorai = NSLocalizedString(
    "RateQorai",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Rate Qorai",
    comment: "Open the App Store to rate Qorai."
  )
  ...
  public static let privacyPolicy = NSLocalizedString(
    ...
    comment: "Show Qorai Browser Privacy Policy page from the Privacy section in the settings."
  )
  public static let termsOfUse = NSLocalizedString(
    ...
    bundle: .module,
    value: "Terms of Use",
    comment: "Show Qorai Browser TOS page from the Privacy section in the settings."
  )
  public static let privateTabBody = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Private Tabs aren’t saved in Qorai, but they don’t make you anonymous online. Sites you visit in a private tab won’t show up in your history and their cookies always vanish when you close them — there won’t be any trace of them left in Qorai. However, downloads will be saved.\nYour mobile carrier (or the owner of the Wi-Fi network or VPN you’re connected to) can see which sites you visit and those sites will learn your public IP address, even in Private Tabs.",
  ...
  public static let qoraiPanel = NSLocalizedString(
    "QoraiPanel",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Panel",
    comment: "Button to show the qorai panel"
  )
  ...
  public static let siteShieldSettings = NSLocalizedString(
    ...
    bundle: .module,
    value: "Shields",
    comment: "Qorai panel topmost title"
  )
  ...
  public static let leoMenuItem = NSLocalizedString(
    ...
    value: "Qora",
    comment:
      "Title for Qorai Qora menu item. Qorai Qora is the name of a product and should not be translated"
  )
  public static let askQoraiMenuItem = NSLocalizedString(
    "AskQoraiMenuItem",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Ask Qorai",
    comment: "Title for Ask Qorai menu item. Qorai is the company name and should not be translated"
  )
  ...
  public static let openExternalAppURLAllow = NSLocalizedString(
    ...
    bundle: .module,
    value: "Allow",
    comment: "Allow Qorai to open the external app URL"
  )
  public static let openExternalAppURLDontAllow = NSLocalizedString(
    ...
    bundle: .module,
    value: "Don't Allow",
    comment: "Don't allow Qorai to open the external app URL"
  )
  ...
  public static let requestCameraPermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera. %@ will be replaced with the websites address (for example: \"talk.qorai.com\")"
  )
  public static let requestMicrophonePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's microphone. %@ will be replaced with the websites address (for example: \"talk.qorai.com\")"
  )
  public static let requestCameraAndMicrophonePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera & microphone. %@ will be replaced with the websites address (for example: \"talk.qorai.com\")"
  )
  public static let requestCaptureDevicePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access some media capture device such as a camera or microphone. %@ will be replaced with the websites address (for example: \"talk.qorai.com\")"
  )
  ...
  public static let qoraiPlaylistItemTitle = NSLocalizedString(
    "optionsMenu.qoraiPlaylistItemTitle",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Playlist",
    comment: "Qorai News Item Menu title"
  )
  public static let qoraiNewsItemTitle = NSLocalizedString(
    "optionsMenu.qoraiNewsItemTitle",
    tableName: "QoraiShared",
    bundle: .module,
    value: "News",
    comment: "Qorai News Item Menu title"
  ...
  public static let defaultThemeName =
    NSLocalizedString(
      ...
      bundle: .module,
      value: "Qorai default",
      comment: "Name for default Qorai theme."
    )
  public static let themeQRCodeShareTitle =
    NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Share Qorai with your friends!",
...
extension Strings {
  ...
  public static let OBJoinButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Join",
    comment: "Button to join Qorai Rewards."
  )
  public static let OBTurnOnButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Start",
    comment: "Button to show Qorai Rewards."
  )
  public static let OBShowMeButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Show Me",
    comment: "Button to show the Qorai Rewards Ads."
  )
  ...
  public static let OBSearchEngineTitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Welcome to Qorai Browser",
  ...
  public static let OBAdsOptInTitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Ads is here!",
    comment: "Title when opting into qorai Ads when region becomes available"
  )
  public static let OBAdsOptInMessage = NSLocalizedString(
    ...
    comment: "Message when opting into qorai Ads when region becomes available"
  )
  ...
  public static let OBRewardsDetail = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Opting into Qorai Private Ads supports publishers and content creators with every ad viewed.",
    comment: "Detail text for rewards onboarding screen"
  )
  ...
  public static let OBAdsTitle = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai will show your first ad in",
  ...
  public static let OBPrivacyConsentDetail = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "You may have downloaded Qorai in support of your referrer. To detect your referrer, Qorai performs a one-time check of your clipboard for the matching referral code. This check is limited to the code only and no other personal data will be transmitted.  If you opt out, your referrer won’t receive rewards from Qorai.",
    comment: ""
  )
  public static let OBPrivacyConsentClipboardPermission = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Allow Qorai to check my clipboard for a matching referral code",
    comment: ""
  )
  ...
  public struct NTP {
    ...
    public static let goodJob =
      NSLocalizedString(
        ...
        value: "Way to go!",
        comment:
          "The context is to praise the user that they did a good job, to keep it up. It is used in full sentence like: 'Way to go! You earned 40 QOR last month.'"
      )
    public static let earningsReport =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "You earned %@ by browsing with Qorai.",
        comment: "Placeholder example: 'You earned 42 QOR by browsing with Qorai.'"
      )
    ...
    public static let learnMoreAboutRewards =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Learn more about Qorai Rewards",
        comment: ""
      )
    ...
    public static let qoraiSupportFavoriteTitle =
      NSLocalizedString(
        "ntp.qoraiSupportFavoriteTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Qorai Support",
        comment: "Bookmark title for Qorai Support"
      )
    ...
    public static let imageTypeSelectionDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Sponsored images are branded backgrounds that appear in newly opened tabs in the browser. Enabling these Sponsored Images supports Qorai's mission.",
...
extension Strings {
  public struct Popover {
    public static let closeShieldsMenu = NSLocalizedString(
      ...
      comment: "Description for closing the `Qorai Shields` popover menu that is displayed."
    )
  }
}
...
extension Strings {
  public struct Shields {
    public static let toggleHint = NSLocalizedString(
      "QoraiShieldsToggleHint",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Double-tap to toggle Qorai Shields",
    ...
    public static let statusTitle = NSLocalizedString(
      "QoraiShieldsStatusTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Shields",
      comment: "Context: 'Qorai Shields Up' or 'Qorai Shields Down'"
    )
    public static let statusValueUp = NSLocalizedString(
      "QoraiShieldsStatusValueUp",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Up",
      comment: "Context: The 'Up' in 'Qorai Shields Up'"
    )
    public static let statusValueDown = NSLocalizedString(
      "QoraiShieldsStatusValueDown",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Down",
      comment: "Context: The 'Down' in 'Qorai Shields Down'"
    )
    public static let blockedCountLabel = NSLocalizedString(
      "QoraiShieldsBlockedCountLabel",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let blockedInfoButtonAccessibilityLabel = NSLocalizedString(
      "QoraiShieldsBlockedInfoButtonAccessibilityLabel",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Learn more",
      comment:
    ...
    public static let advancedControls = NSLocalizedString(
      "QoraiShieldsAdvancedControls",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Advanced controls",
      comment: ""
    )
    public static let aboutQoraiShieldsTitle = NSLocalizedString(
      "AboutQoraiShields",
      tableName: "QoraiShared",
      bundle: .module,
      value: "About Qorai Shields",
      comment: "The title of the screen explaining Qorai Shields"
    )
    public static let aboutQoraiShieldsBody = NSLocalizedString(
      "AboutQoraiShieldsBody",
      tableName: "QoraiShared",
      bundle: .module,
      value:
        "Sites often include cookies and scripts which try to identify you and your device. They want to work out who you are and follow you across the web — tracking what you do on every site.\n\nQorai blocks these things so that you can browse without being followed around.",
      comment: "The body of the screen explaining Qorai Shields"
    )
    public static let shieldsDownDisclaimer = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "You're browsing this site without Qorai's privacy protections. Does it not work right with Shields up?",
      comment: ""
    )
    public static let globalControls = NSLocalizedString(
      "QoraiShieldsGlobalControls",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let globalChangeButton = NSLocalizedString(
      "QoraiShieldsGlobalChangeButton",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let siteReportedBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Thanks for letting Qorai's developers know that there's something wrong with this site. We'll do our best to fix it!",
      comment: ""
    )
    ...
    public static let reportBrokenSiteBody1 = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Let Qorai's developers know that this site isn't working as expected:",
      comment:
    ...
    public static let reportBrokenSiteBody2 = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Note: The report sent to Qorai servers will include the site address, Qorai version number, Shields settings, VPN status, and language settings.",
      comment:
  ...
  public struct ShieldEducation {
    ...
    public static let trackerAdWarningSubtitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Qorai Shields just protected your online privacy.",
    ...
    public static let shareDescriptionTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Every day I save data by browsing the web with Qorai.",
        comment: "Text used for social sharing together with Qorai Shield values"
      )
  ...
  public struct PlayList {
    ...
    public static let noItemLabelDetailLabel =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "You can add items to your Qorai Playlist within the browser",
    ...
    public static let urlBarButtonOptionFooter =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Adds a playlist button beside the address bar in the Qorai browser. This button gives you quick access to open Playlist, or add or remove media.",
  ...
  public struct CertificateViewer {
    ...
    public static let organizationTitle =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Organization",
        comment: "Title of the section for Name of the Company. Example: Qorai Inc."
      )
    ...
    public static let domainComponentTitle =
      NSLocalizedString(
        ...
        comment:
          "Title of the section for the Domain Component such as: DNS or qorai.com or a website's domain."
      )
...
extension Strings {
  public struct ReceiptViewer {
    ...
    public static let leoMonthlySubscriptionName =
      NSLocalizedString(
        "storekitReceiptViewer.qoraMonthlySubscriptionName",
        bundle: .module,
        value: "Qorai Qora Monthly",
        comment: "The title of the product subscription the user purchased (Monthly subscription)"
      )

    public static let leoYearlySubscriptionName =
      NSLocalizedString(
        "storekitReceiptViewer.qoraYearlySubscriptionName",
        bundle: .module,
        value: "Qorai Qora Yearly",
        comment: "The title of the product subscription the user purchased (Yearly subscription)"
      )
  ...
  public struct Shortcuts {
    ...
    public static let activityTypeOpenBookmarksTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai Browser Bookmarks",
        comment: ""
      )
    ...
    public static let activityTypeOpenHistoryListTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai Browser History",
        comment: ""
      )
    ...
    public static let activityTypeClearHistoryTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Clear Qorai Browsing History",
        comment: ""
      )
    ...
    public static let activityTypeEnableVPNTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai Browser and Enable VPN",
        comment: ""
      )

    public static let activityTypeOpenQoraiNewsTitle =
      NSLocalizedString(
        "shortcuts.activityTypeOpenQoraiNewsTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai News",
        comment: ""
      )
    ...
    public static let activityTypeTabDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Start Searching the Web Securely with Qorai",
        comment: ""
      )
    ...
    public static let activityTypeQoraiNewsDescription =
      NSLocalizedString(
        "shortcuts.activityTypeQoraiNewsDescription",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai News and Check Today's Top Stories",
        comment: ""
      )
    ...
    public static let activityTypeOpenSyncedTabsDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai Tabs Open in Other Devices",
        comment: ""
      )
    ...
    public static let activityTypeOpenQoraiNewsSuggestedPhrase =
      NSLocalizedString(
        "shortcuts.activityTypeOpenQoraiTodaySuggestedPhrase",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai News",
        comment: ""
    ...
    public static let shortcutSettingsEnableVPNDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Use Shortcuts to enable Qorai VPN via Siri - Voice Assistant",
        comment: ""
      )

    public static let shortcutSettingsOpenQoraiNewsTitle =
      NSLocalizedString(
        "shortcuts.shortcutSettingsOpenQoraiNewsTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Open Qorai News",
        comment: ""
    ...
    public static let shortcutSettingsOpenQoraiNewsDescription =
      NSLocalizedString(
        "shortcuts.shortcutSettingsOpenQoraiNewsDescription",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Use Shortcuts to open a new tab & show Qorai News Feed via Siri - Voice Assistant",
        comment: "Description of Open Qorai News Siri Shortcut in Settings Screen"
      )
    ...
    public static let shortcutOpenApplicationSettingsDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "This option will open Qorai Settings. In order to change various Siri options, please select 'Siri & Search' menu item and customize your choices.",
        comment: "Description for opening Qorai Settings for altering Siri shortcut."
      )
  }
}
  ...
  public struct Privacy {
    ...
    public static let browserLockDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Unlock Qorai with Touch ID, Face ID or system passcode.",
  ...
  public struct OpenTabs {
    ...
    public static let noSyncSessionPlaceHolderViewTitle =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "This space shows Qorai tabs open in other devices",
    ...
    public static let noSyncSessionPlaceHolderViewAdditionalDescription =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Manage what Qorai syncs in Settings.",
...
extension Strings {
  public struct QoraiNews {
    public static let qoraiNews = NSLocalizedString(
      "today.qoraiToday",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai News",
    ...
    public static let qoraiNewsTitle = NSLocalizedString(
      "today.qoraiToday.title",
      tableName: "QoraiShared",
      bundle: .module,
      value: "News",
    ...
    public static let turnOnQoraiNews = NSLocalizedString(
      "today.turnOnQoraiToday",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Turn on Qorai News",
      comment: ""
    )
    ...
    public static let introCardTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Turn on Qorai News, and never miss a story",
      comment: "Shown above a button that turns on the \"Qorai News\" product in the app."
    )
    public static let introCardBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Follow your favorite sources, in a single feed. Just open a tab in Qorai, scroll down, and… voila!\nQorai News is ad-supported with private, anonymized ads.",
      comment:
        "Shown above a button that turns on the \"Qorai News\" product in the app. by sources & feeds they mean websites & blogs."
    )
    ...
    public static let errorGeneralBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai News is experiencing some issues. Try again.",
      comment: ""
    )
    public static let disablePublisherContent = NSLocalizedString(
      ...
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Qorai Blog"
    )
    ...
    public static let disabledAlertBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai News will stop showing content from %@",
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Qorai Blog"
    )
    ...
    public static let moreQoraiOffers = NSLocalizedString(
      "today.moreQoraiOffers",
      tableName: "QoraiShared",
      bundle: .module,
      value: "More Qorai Offers",
      comment: "'Qorai Offers' is a product name"
    )
    ...
    public static let addSourceShareTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Add Source to Qorai News",
    ...
    public static let getFeedsFromSiteButtonTitle = NSLocalizedString(
      ...
      comment:
        "Shown with a website the user has typed in after the text. For example: 'Get feeds from https://qorai.com'."
    )
    ...
    public static let rateQoraiCardRateActionTitle = NSLocalizedString(
      "today.rateQoraiCardRateActionTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Rate Qorai",
      comment:
    ...
    public static let rateQoraiCardHideActionTitle = NSLocalizedString(
      "today.rateQoraiCardHideActionTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Hide",
      comment: "Title for long press action that will hide Qorai Rate Card"
    )
    public static let rateQoraiCardActionSheetTitle = NSLocalizedString(
      "today.rateQoraiCardActionSheetTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Rate Qorai in App Store",
      comment: "Title for long press action sheet list which has item for rate / hide"
    )
    public static let rateQoraiCardTitle = NSLocalizedString(
      "today.rateQoraiCardTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Liking Qorai?",
      comment: "Title shown on the Rate Qorai Card "
    )
    public static let rateQoraiCardSubtitle = NSLocalizedString(
      "today.rateQoraiCardSubtitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Tell us what you think!",
      comment: "Subtitle shown on the Rate Qorai Card"
    )
  }
}
...
extension Strings {
  public struct RewardsInternals {
    public static let title = NSLocalizedString(
      ...
      comment: "'Rewards' as in 'Qorai Rewards'"
    )
    ...
    public static let contributionProcessorQoraiTokens = NSLocalizedString(
      "RewardsInternalsContributionProcessorQoraiTokens",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Tokens",
      comment: ""
...
extension Strings {
  public struct Rewards {
    public static let enabledBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "You are helping support Qorai and the QOR community.",
      comment: "Displayed when Qorai Rewards is enabled"
    )
    public static let disabledBody = NSLocalizedString(
      "rewards.disabledBody",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Turn on to help support Qorai and the QOR community.",
      comment: "Displayed when Qorai Rewards is disabled"
    )
    public static let supportingPublisher = NSLocalizedString(
      "rewards.supportingPublisher",
      tableName: "QoraiShared",
      bundle: .module,
      value: "This content creator is verified with Qorai Creators",
    ...
    public static let enabledStatusBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Thank you for helping support Qorai and the QOR community!",
      comment:
    ...
    public static let disabledStatusBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Using Qorai Rewards helps support Qorai and the QOR community.",
    ...
    public static let settingsToggleMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Help support Qorai and the QOR community by enabling Qorai Rewards and seeing Qorai Ads.",
      comment: ""
    )
    ...
    public static let qoraiTalkRewardsOptInTitle =
      NSLocalizedString(
        "rewards.qoraiTalkRewardsOptInTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "To start a free call, turn on Qorai Rewards",
        comment: "Title for Qorai Talk rewards opt-in screen"
      )

    public static let qoraiTalkRewardsOptInBody =
      NSLocalizedString(
        "rewards.qoraiTalkRewardsOptInBody",
        tableName: "QoraiShared",
        bundle: .module,
        value:
          "With Qorai Rewards, you can view privacy-preserving ads from the Qorai Ads network. No trackers. No slowdowns. And your data stays totally safe.",
        comment: "Body for Qorai Talk rewards opt-in screen"
      )

    public static let qoraiTalkRewardsOptInButtonTitle =
      NSLocalizedString(
        "rewards.qoraiTalkRewardsOptInButtonTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Turn on Rewards",
        comment: "Title for Qorai Talk rewards opt-in screen button"
      )

    public static let qoraiTalkRewardsOptInDisclaimer =
      NSLocalizedString(
    ...
    public static let qoraiTalkRewardsOptInSuccessTitle =
      NSLocalizedString(
        "rewards.qoraiTalkRewardsOptInSuccessTitle",
        tableName: "QoraiShared",
        bundle: .module,
        value: "You can now start a free call",
        comment: "Title for successful Qorai Talk rewards opt-in"
      )

    public static let qoraiTalkRewardsOptInSuccessBody =
      NSLocalizedString(
        "rewards.qoraiTalkRewardsOptInSuccessBody",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Click anywhere on the screen to continue to Qorai Talk.",
        comment: "Body for successful Qorai Talk rewards opt-in"
      )
  }
}
...
// MARK: - Talk
extension Strings {
  public struct QoraiTalk {
    public static let qoraiTalkTitle = NSLocalizedString(
      "qoraitalk.qoraiTalkTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Talk",
      comment: "The name of the feature"
...
extension Strings {
  public struct Ads {
    public static let myFirstAdTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "This is your first Qorai ad",
      comment: ""
    )
    ...
    public static let adNotificationTitle = NSLocalizedString(
      "QoraiRewardsAdNotificationTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Rewards",
      comment: ""
    ...
    public static let qoraiAdsDataToggleOption =
      NSLocalizedString(
        "ads.qoraiAdsDataToggleOption",
        tableName: "QoraiShared",
        bundle: .module,
        value: "Qorai Ads Data",
        comment:
          "Text for the toggle switch to clear 'Qorai Ads' data in settings"
      )
    ...
    public static let searchResultAdClickedInfoBarMessage =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Thanks for supporting Qorai Search by clicking a private ad. Unlike Big Tech, we measure ad performance anonymously to preserve your privacy.",
    ...
    public static let newTabTakeoverInfoBarMessage =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Sponsored background images support Qorai's mission to build an independent, user-first Web. And unlike Big Tech, we measure ad performance anonymously to preserve your privacy.",
...
extension Strings {
  ...
  public static let qoraiShieldsSaveContactInfo = NSLocalizedString(
  ...
  public static let qoraiShieldsSaveContactInfoDescription = NSLocalizedString(
    "QoraiShieldsSaveContactInfoDescription",
    tableName: "QoraiShared",
    bundle: .module,
...
extension Strings {
  public struct PrivacyHub {
    public static let privacyReportsTitle = NSLocalizedString(
      ...
      value: "Privacy Hub",
      comment:
        "Title of main privacy hub screen. This screen shows various stats caught by Qorai's ad blockers."
    )
    ...
    public static let mostFrequentTrackerAndAdBody = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "**%@** was blocked by Qorai Shields on **%lld** sites",
      comment:
        "Do NOT localize asterisk('*') characters, they are used to make the text bold in the app. It says which tracker was blocked on how many websites, example usage: 'Google Analytics was blocked by Qorai Shields on 42 sites'"
    )
    ...
    public static let vpnAlertsHeader = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Firewall + VPN Alerts",
      comment:
    ...
    public static let allVPNAlertsButtonText = NSLocalizedString(
      ...
      value: "All alerts",
      comment:
        "Text for a button to display a list of all alerts caught by the Qorai VPN. VPN alert is a notificaion of what item has been blocked by the vpn, similar to a regular adblocker"
    )
    ...
    public static let allTimeListsTrackersView = NSLocalizedString(
      ...
      bundle: .module,
      value: "Trackers & ads",
      comment: "Title of a section to show total count of trackers blocked by Qorai"
    )
    ...
    public static let blockedBy = NSLocalizedString(
      ...
      value: "Blocked by",
      comment:
        "Text which explain by what type of ad blocker a given resource was blocked. Context is like: 'Blocked by Qorai Shields', 'Blocked by QoraiVPN"
    )
    ...
    public static let vpnLabel = NSLocalizedString(
      ...
      value: "Firewall + VPN",
      comment:
        "This label says about Qorai VPN, as a source of by what the resource was blocked by. Think of it in context of 'Blocked by VPN'"
    )
    ...
    public static let notificationMessage = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "A recap of how Qorai protected you online this week.",
      comment:
    ...
    public static let settingsEnableShieldsTitle = NSLocalizedString(
      ...
      comment: "Title of a setting that lets Qorai monitor blocked network requests"
    )
    ...
    public static let settingsEnableShieldsFooter = NSLocalizedString(
      ...
      comment: "This text explains a setting that lets Qorai monitor blocked network requests"
    )
    ...
    public static let settingsEnableVPNAlertsTitle = NSLocalizedString(
      ...
      comment:
        "Title of a setting that lets Qorai monitor blocked network requests captured by Qorai VPN"
    )
    ...
    public static let settingsEnableVPNAlertsFooter = NSLocalizedString(
      ...
      comment:
        "This text explains a setting that lets Qorai monitor blocked network requests captured by Qorai VPN"
    )
    ...
    public static let settingsSlearDataTitle = NSLocalizedString(
      ...
      comment:
        "Button that lets user clear all blocked requests and vpn alerts data that Qorai captured for them."
    )
...
extension Strings {
  public struct P3A {
    public static let settingTitle = NSLocalizedString(
      ...
      comment:
        "The title for the setting that will allow a user to toggle sending privacy preserving analytics to Qorai."
    )
    ...
    public static let settingSubtitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "These private responses help Qorai estimate the overall usage of certain features and make them better for you.",
      comment: "A subtitle shown on the setting that toggles analytics on Qorai."
    )
  ...
  public struct VoiceSearch {
    public static let screenDisclaimer =
      NSLocalizedString(
        ...
        tableName: "QoraiShared",
        bundle: .module,
        value: "Qorai does not store or share your voice searches.",
    ...
    public static let microphoneAccessRequiredWarningDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Please allow Microphone Access in iOS System Settings for Qorai to use anonymous voice search.",
...
extension Strings {
  ...
  public static let unsupportedInstrumentMessage = NSLocalizedString(
    ...
    comment: "Error message if list of Payment Instruments doesn't include QOR"
  )
...
extension Strings {
  public struct Hotkey {
    ...
    public static let showShieldsTitle = NSLocalizedString(
      "showShieldsTitle",
      bundle: .module,
      value: "Open Qorai Shields",
      comment:
        "Label to display in the Discoverability overlay for keyboard shortcuts which is for Showing Qorai Shields"
    )
...
extension Strings {
  public struct Paywall {
    public static let alreadyPurchasedTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Already purchased on qorai.com?",
      comment: "Title label text for refreshing credentials from qorai site."
    )
    public static let refreshCredentialsButtonTitle = NSLocalizedString(
      ...
      comment: "Button action text for refreshing credentials from qorai site."
    )
    public static let qoraiVPNLearnMoreButtonTitle = NSLocalizedString(
      "paywall.qoraiVPNLearnMoreButtonTitle",
      bundle: .module,
      value: "Lean More About Qorai VPN",
      comment: "Button action text which will bring user to Qorai VPN web page for more information."
    )
    ...
    public static let qoraiAccountCheckoutOptionTitle = NSLocalizedString(
      "paywall.qoraiAccountCheckoutOptionTitle",
      bundle: .module,
      value: "Qorai Account",
      comment: "The checkout option that lets the user use Qorai's own purchase flow"
    )
    public static let qoraiAccountCheckoutOptionSubtitle = NSLocalizedString(
      "paywall.qoraiAccountCheckoutOptionSubtitle",
      bundle: .module,
      value: "Code **%@** for %@ off",
...
extension Strings {
  public struct AltAppIcon {
    ...
    public static let defaultAppIcon = NSLocalizedString(
      ...
      bundle: .module,
      value: "Default",
      comment: "A label shown next to the default Qorai app icon"
    )
    public static let qoraiIconsHeader = NSLocalizedString(
      "altAppIcon.qoraiIconsHeader",
      bundle: .module,
      value: "Qorai Icons",
      comment: "A label shown above a list of icons designed by Qorai"
    )
...
extension Strings {
  public struct QoraiTranslate {
    public static let languageSelectionButtonTitle = NSLocalizedString(
      "QoraiTranslate.languageSelectionButtonTitle",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let searchInputTitle = NSLocalizedString(
      "QoraiTranslate.searchInputTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Search",
    ...
    public static let pageTranslatedTitle = NSLocalizedString(
      "QoraiTranslate.pageTranslatedTitle",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let translateFromToTitle = NSLocalizedString(
      "QoraiTranslate.translateFromToTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "To",
    ...
    public static let unknownLanguageTitle = NSLocalizedString(
      "QoraiTranslate.unknownLanguageTitle",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let settingsMenuTitle = NSLocalizedString(
      "QoraiTranslate.settingsMenuTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Translate",
      comment: "This text is for the settings menu for all Qorai-Translate options."
    )

    public static let settingsScreenTitle = NSLocalizedString(
      "QoraiTranslate.settingsScreenTitle",
      tableName: "QoraiShared",
      bundle: .module,
      value: "Qorai Translate",
    ...
    public static let settingsTranslateEnabledOptionTitle = NSLocalizedString(
      "QoraiTranslate.settingsTranslateEnabledOptionTitle",
      tableName: "QoraiShared",
      bundle: .module,
    ...
    public static let settingsTranslateEnabledOptionDescription = NSLocalizedString(
      "QoraiTranslate.settingsTranslateEnabledOptionDescription",
      tableName: "QoraiShared",
      bundle: .module,
      value: "When enabled, Qorai Translate will automatically detect your page's current language, and display a translate button in the URL bar.",
      comment: "This text is for a Toggle that allows the user to enable or disable page translation."
    )

    public static let availableVoiceOverAnnouncement = NSLocalizedString(
      "QoraiTranslate.availableVoiceOverAnnouncement",
      bundle: .module,

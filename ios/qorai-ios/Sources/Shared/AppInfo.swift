...
open class AppInfo {
  ...
  public static var sharedContainerIdentifier: String {
    ...
    // External beta
    if bundleIdentifier == "com.qorai.ios.BrowserBeta" {
      // com.qorai.ios.BrowserBeta is taken and can't be used as an app group.
      bundleIdentifier = "com.qorai.ios.BrowserBeta.unique"
    }
  ...
  public static func keychainAccessGroupWithPrefix(_ prefix: String) -> String {
    var bundleIdentifier = baseBundleIdentifier
    if bundleIdentifier == "com.qorai.ios.FennecEnterprise" {
      ...
      bundleIdentifier = "com.qorai.ios.Fennec.enterprise"
    }

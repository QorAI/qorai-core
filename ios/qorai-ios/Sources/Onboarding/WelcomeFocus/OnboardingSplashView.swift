...
/// A View that is displayed prior to the first onboarding step that animates the Qorai
/// logo and animates the Qorai icon down to the first step when in `fullscreen` layout
struct OnboardingSplashView: View {
  ...
  private var qoraiTextLogo: some View {
    Image("focus-logo-qorai", bundle: .module)
      .resizable()
      .renderingMode(.template)
      .foregroundColor(Color(qoraiSystemName: .neutral20))

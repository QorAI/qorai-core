...
extension Strings {
  public struct FocusOnboarding {
    ...
    public static let defaultBrowserScreenTitle = NSLocalizedString(
      ...
      comment: "The title of the screen that requests user to set Qorai as default"
    )
    ...
    public static let defaultBrowserScreenDescription = NSLocalizedString(
      ...
      tableName: "FocusOnboarding",
      bundle: .module,
      value: "Set Qorai as your default browser today.",
      comment: "The subtitle of the screen that requests user to set Qorai as default"
    )

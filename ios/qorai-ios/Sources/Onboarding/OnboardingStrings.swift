...
extension Strings {
  struct PlaylistOnboarding {
    public static let introducingQoraiPlaylist = NSLocalizedString(
      "introducingQoraiPlaylist",
      bundle: .module,
      value: "Introducing Qorai Playlist",
      comment:
        "A title shown on the first 2 steps of onboarding for Qorai Playlist. Qorai Playlist is a product name"
    )
    ...
    public static let playlistOnboardingDescription = NSLocalizedString(
      ...
      comment:
        "A body of text explaining the feature that will be displayed under a title reading 'Introducing Qorai Playlist'"
    )
    public static let advanceInitialOnboardingButtonTitle = NSLocalizedString(
      ...
      value: "Discover How",
      comment:
        "A button title shown below language introducing the Qorai Playlist feature. i.e. 'Discover how to use use this feature'"
    )
    public static let dismissOnboardingButtonTitle = NSLocalizedString(
      ...
      value: "Dismiss",
      comment:
        "A button title that allows the user to dismiss the popup explaining the Qorai Playlist feature"
    )
    ...
    public static let playlistInfoFeaturePointTitleOne = NSLocalizedString(
      ...
      bundle: .module,
      value: "Add videos to Qorai Playlist. Playback anytime. Even offline",
    ...
    public static let confirmationActionButtonTitle = NSLocalizedString(
      ...
      comment: "A button title that when tapped opens Qorai Playlist"
    )
...
extension Strings {
  struct QoraiTranslateOnboarding {
    public static let translateTitle = NSLocalizedString(
      "QoraiTranslateOnboarding.translateTitle",
      bundle: .module,
    ...
    public static let translateDescription = NSLocalizedString(
      "QoraiTranslateOnboarding.translateDescription",
      bundle: .module,
      value:
    ...
    public static let disableTranslateButtonTitle = NSLocalizedString(
      "QoraiTranslateOnboarding.disableTranslateButtonTitle",
      bundle: .module,
      value: "Disable This Feature",
      comment:
        "A button that allows the user to disable the qorai translate feature. When pressed, the page will not be automatically translated to the user's language."
    )
  }
}

...
public struct OnboardingPlaylistView: View {
  ...
  private var headerView: some View {
    ZStack {
      ...
      Image(sharedName: "qora.playlist.bold.add")
        .resizable()
  ...
  public var body: some View {
    ...
    .frame(
      ...
      maxWidth: QoraiUX.baseDimensionValue
    )
    .task {
      do {
...
extension OnboardingPlaylistView {
  struct InitialStepView: View {
    ...
    var body: some View {
      VStack(spacing: 24) {
        VStack(spacing: 12) {
          Text(Strings.PlaylistOnboarding.introducingQoraiPlaylist)
  ...
  struct DetailsStepView: View {
    ...
    var body: some View {
      VStack(spacing: 24) {
        ...
        VStack(spacing: 24) {
          VStack(spacing: 24) {
            bulletPoint(
              qoraiSystemName: "qora.cloud.download",
            ...
            bulletPoint(
              qoraiSystemName: "qora.product.playlist-add",
            ...
            bulletPoint(
              qoraiSystemName: "qora.play.circle",
    ...
    private func bulletPoint(qoraiSystemName: String, title: String, subtitle: String) -> some View
    {
      Label {
  ...
  struct TryItOutStepView: View {
    ...
    var textWithIconNextToPrompt: Text {
      ...
      let addIcon = UIImage(sharedNamed: "qora.playlist.bold.add")!
      let icon = Image(
...
// A Variant of QoraiFilledButtonStyle

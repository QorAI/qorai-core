...
open class QoraiGlobalShieldStats {
  public static let shared = QoraiGlobalShieldStats()
  public static let didUpdateNotification = "QoraiGlobalShieldStatsDidUpdate"
  ...
  private func postUpdateNotification() {
    NotificationCenter.default.post(
      name: Notification.Name(rawValue: QoraiGlobalShieldStats.didUpdateNotification),
      object: nil
    )
  }

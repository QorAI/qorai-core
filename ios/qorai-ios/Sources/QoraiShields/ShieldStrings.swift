...
extension Strings.Shields {
  ...
  public static let antiAdBlockWarningDescription2 = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "To address this issue, Qorai can adjust your shields settings for you. Once adjusted, you can try watching this content in Qorai Player instead.",
    comment: "A descriptive message explaining to disable shields on this site."
  )

  /// A button that disables ad-blocking and uses qorai player
  public static let antiAdBlockWarningConfirmationButton = NSLocalizedString(
    ...
    comment: "A button that disables ad-blocking and uses qorai player."
  )
  ...
  /// A discription of the Qorai Player
  public static let antiAdBlockWarningQoraiPlayerDescription = NSLocalizedString(
    "AntiAdBlockWarningQoraiPlayerDescription",
    tableName: "QoraiShared",
    bundle: .module,
    value: "**Qorai Player** is your ticket to an ad-free and uninterrupted video experience.",
    comment: "A discription of the Qorai Player."
  )
}
...
extension Strings.Shields {
  /// Title for the qorai player feature
  public static let qoraiPlayer = NSLocalizedString(
    "QoraiPlayer",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Player",
    comment: "Title for the qorai player feature"
  )

  /// Title for the qorai player info popup which appears when clicking on the qorai player icon on the navigation bar
  public static let qoraiPlayerInfoTitle = NSLocalizedString(
    "QoraiPlayerInfoTitle",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Watch In Qorai Player Instead",
    comment:
      "Title for the qorai player info popup which appears when clicking on the qorai player icon on the navigation bar."
  )

  /// A description of the qorai player that is presented on the info panel when clicing on the qorai player icon for the first time
  public static let qoraiPlayerInfoMessage = NSLocalizedString(
    "QoraiPlayerInfoMessage",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai Player lets you watch videos without interruptions.",
    comment:
      "A description of the qorai player that is presented on the info panel when clicing on the qorai player icon for the first time."
  )

  /// A label for a toggle that enables automatic launching of qorai player for certain sites
  public static let qoraiPlayerAlwaysOpenVideoLinks = NSLocalizedString(
    "QoraiPlayerAlwaysOpenYouTubeLinks",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Always open videos from this site with Qorai Player",
    comment:
      "A label for a toggle that enables automatic launching of qorai player for certain sites"
  )

  /// A button that confirms to use the qorai player
  public static let qoraiPlayerConfirmButton = NSLocalizedString(
    "QoraiPlayerConfirmButton",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Try It Out",
    comment: "A button that confirms to use the qorai player."
  )

  /// A button that ignores the qorai player
  public static let qoraiPlayerDismissButton = NSLocalizedString(
    "QoraiPlayerDismissButton",
    tableName: "QoraiShared",
    bundle: .module,
    value: "Not Now",
    comment: "A button that ignores the qorai player"
  )
}
...
extension Strings.Shields {
  ...
  public static let enableGPCDescription = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Ask websites not to sell or share your data. [Learn more](https://support.qorai.app/hc/en-us/articles/360017989132-How-do-I-change-my-Privacy-Settings#h_01HHFRRT6B5YTRREA4ZDARGTWM)",
...
extension Strings.Shields {
  ...
  public static let domainBlockedPageMessage = NSLocalizedString(
    ...
    tableName: "QoraiShared",
    bundle: .module,
    value: "Qorai has prevented the following site from loading:",
  ...
  public static let domainBlockedPageDescription = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Because you requested to aggressively block trackers and ads, Qorai is blocking this site before the first network connection.",

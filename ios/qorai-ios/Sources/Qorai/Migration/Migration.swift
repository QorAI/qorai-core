...
public class QoraiProfileMigrations {
  let profileController: QoraiProfileController
  public init(profileController: QoraiProfileController) {
...
public class QoraiLocalStateMigration {
  ...
  private func migrateAdsPreferences() {
    guard !localState.hasPref(forPath: kQoraiAdsFirstRunAtPrefName) else { return }
    ...
    localState.set(firstRunAt, forPath: kQoraiAdsFirstRunAtPrefName)
  }
}
...
public class Migration {
  ...
  public static func migrateAdsConfirmations(for configuration: QoraiRewards.Configuration) {
...
extension Preferences {
  ...
  fileprivate class func migratePreferences(keyPrefix: String) {
    ...
    // Wrapper around QoraiShared migrate, to automate prefix injection
    ...
    // Shields
    migrate(key: "qoraiBlockAdsAndTracking", to: DeprecatedPreferences.blockAdsAndTracking)
    migrate(key: "qoraiHttpsEverywhere", to: DeprecatedPreferences.httpsEverywhere)
    ...
    migrate(key: "qoraiAdblockUseRegional", to: Preferences.Shields.useRegionAdBlock)
  ...
  fileprivate class func migrateAdAndTrackingProtection() {
    ...
    // Migrate old tracking protection setting to new QoraiShields setting

...
enum QoraiS3Resource: Hashable, DownloadResourceInterface {
  /// The rules processed by slim-list which are filtered out for iOS usage
  ///
  /// Based on the following rules: https://github.com/qorai/adblock-resources/blob/master/filter_lists/default.json
  case slimList

  /// The name of the header value that contains the service key
  private static let servicesKeyHeaderValue = "QoraiServiceKey"
  ...
  private static var baseResourceURL: URL = {
    ...
    if AppConstants.isOfficialBuild {
      return URL(string: "https://adblock-data.s3.qorai.com")!
    }
    return URL(string: "https://adblock-data-staging.s3.qoraisoftware.com")!
  }()
  ...
  var headers: [String: String] {
    ...
    headers[Self.servicesKeyHeaderValue] = kQoraiServicesKey

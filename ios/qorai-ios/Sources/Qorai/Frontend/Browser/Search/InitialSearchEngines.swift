...
class InitialSearchEngines {
  ...
  enum SearchEngineID: String, CaseIterable {
    ...
    var openSearchReference: String {
      ...
      case .qoraiSearch: return "search.qorai"
    ...
    var legacyName: String? {
      switch self {
      case .qoraiSearch: return "Qorai Search beta"
      default: return nil
      }
    }
  ...
  public var isQoraiSearchDefaultRegion: Bool {
    ...
    return qoraiSearchDefaultRegions.contains(regionID)
  }
  ...
  private func regionOverrides() {
    ...
    if qoraiSearchDefaultRegions.contains(region) {
      defaultSearchEngine = .qoraiSearch
    }

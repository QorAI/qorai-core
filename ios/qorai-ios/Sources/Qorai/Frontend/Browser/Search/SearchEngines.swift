...
// QORAI TODO: Move to newer Preferences class(#259)
...
public class SearchEngines {
  ...
  public var isQoraiSearchDefaultRegion: Bool {
    return initialSearchEngines.isQoraiSearchDefaultRegion
  }
  ...
  func setInitialDefaultEngine(_ engine: String) {
    ...
    // set Qorai Search as the DSE for private mode
    DefaultEngineType.privateMode.option.value =
      InitialSearchEngines.SearchEngineID.qoraiSearch.rawValue
  ...
  private enum P3ASearchEngineID: Int, CaseIterable, Codable {
    ...
    init(engine: OpenSearchEngine) {
      ...
      case .qoraiSearch: self = .qoraiSearch
  ...
  private func recordSearchEngineP3A() {
    ...
    UmaHistogramEnumeration("Qorai.Search.DefaultEngine.4", sample: answer)
  }
  ...
  private func recordSearchEngineChangedP3A(from previousEngine: OpenSearchEngine) {
    ...
    enum Answer: Int, CaseIterable {
      case noChange = 0
      case qoraiToGoogle = 1
      case qoraiToDuckDuckGo = 2
      case qoraiToOther = 3
      case googleToQorai = 4
      case duckDuckGoToQorai = 5
      case otherToQorai = 6
      case otherToOther = 7
    }
    ...
    let answer: Answer = {
      ...
      case (.qoraiSearch, .google): return .qoraiToGoogle
      case (.qoraiSearch, .duckduckgo): return .qoraiToDuckDuckGo
      case (.qoraiSearch, _): return .qoraiToOther
      case (.google, .qoraiSearch): return .googleToQorai
      case (.duckduckgo, .qoraiSearch): return .duckDuckGoToQorai
      case (_, .qoraiSearch): return .otherToQorai
      default: return .otherToOther
      }
    }()
    UmaHistogramEnumeration("Qorai.Search.SwitchEngine", sample: answer)
  }
}

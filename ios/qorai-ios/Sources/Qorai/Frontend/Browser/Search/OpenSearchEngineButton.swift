...
class OpenSearchEngineButton: QoraiButton {
  ...
  var action: Action {
    didSet {
      ...
      case .disabled:
        isLoading = false
        setImage(
          UIImage(qoraiSystemNamed: "qora.search.zoom-in")!.applyingSymbolConfiguration(
            .init(scale: .large)
          ),
          for: .normal
        )
        tintColor = .qoraiDisabled
  ...
  override init(frame: CGRect) {
    ...
    setTitleColor(.qoraiBlurpleTint, for: .normal)
  }

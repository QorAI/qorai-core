...
extension Site.SiteType {
  var icon: UIImage? {
    switch self {
    case .history:
      return UIImage(qoraiSystemNamed: "qora.history")
    case .bookmark:
      return UIImage(qoraiSystemNamed: "qora.browser.bookmark-normal")
    case .tab:
      return UIImage(qoraiSystemNamed: "qora.browser.mobile-tabs")
    default:
      return nil
    }
  }
...
class SearchOnYourDeviceCell: UICollectionViewCell, CollectionViewReusable {
  ...
  private let siteImageContainerView = UIView().then {
    ...
    $0.backgroundColor = UIColor(qoraiSystemName: .containerHighlight)
  }
  ...
  private func setTheme() {
    ...
    titleLabel.do {
      $0.textColor = isPrivateBrowsing ? .white : UIColor(qoraiSystemName: .textPrimary)
    ...
    subtitleLabel.do {
      $0.textColor = isPrivateBrowsing ? .white : UIColor(qoraiSystemName: .textSecondary)
      $0.lineBreakMode = .byTruncatingTail
    ...
    badgeImageView.do {
      $0.contentMode = .scaleAspectFit
      $0.tintColor = isPrivateBrowsing ? .white : UIColor(qoraiSystemName: .iconSecondary)
    }
  }
      ...
      detailTextForTabSuggestions.append(
        NSAttributedString(
          ...
          attributes: [
            ...
            .foregroundColor: isPrivateBrowsing ? .white : UIColor(qoraiSystemName: .textSecondary),
          ]
        )
      )
      detailTextForTabSuggestions.append(
  ...
  func setPlaylistItem(_ item: PlaylistItem) {
    ...
    badgeImageView.image = UIImage(qoraiSystemNamed: "qora.product.playlist")
  }
}

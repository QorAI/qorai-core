      ...
      Section {
        Button {
          ...
          Label {
            ...
            Image(qoraiSystemName: "qora.browser.mobile-recent-tabs")
              .foregroundStyle(Color(qoraiSystemName: .iconDefault))
          }
          .padding(.vertical, 4)
        }
              ...
              .contextMenu {
                ...
                Section {
                  Button(role: .destructive) {
                    ...
                    Label(Strings.History.deleteFromHistory, qoraiSystemImage: "qora.trash")
                  }
                }
              }
            }
        ...
        ToolbarItemGroup(placement: .topBarTrailing) {
          Button {
            ...
            Label {
              ...
              Image(qoraiSystemName: "qora.trash")
            }
            .labelStyle(.iconOnly)
          }
        }

...
class ToolbarHelper: NSObject {
  ...
  init(toolbar: ToolbarProtocol) {
    ...
    toolbar.backButton.setImage(UIImage(qoraiSystemNamed: "qora.browser.back"), for: .normal)
    ...
    toolbar.shareButton.setImage(UIImage(qoraiSystemNamed: "qora.share.macos"), for: .normal)
    ...
    toolbar.addTabButton.setImage(UIImage(qoraiSystemNamed: "qora.plus.add"), for: .normal)
    ...
    toolbar.searchButton.setImage(UIImage(qoraiSystemNamed: "qora.search"), for: .normal)
    ...
    toolbar.menuButton.setImage(UIImage(qoraiSystemNamed: "qora.more.horizontal"), for: .normal)
    ...
    toolbar.forwardButton.setImage(UIImage(qoraiSystemNamed: "qora.browser.forward"), for: .normal)

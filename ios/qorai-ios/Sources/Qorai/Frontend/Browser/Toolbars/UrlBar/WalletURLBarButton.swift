...
class WalletURLBarButton: UIButton {
  ...
  override init(frame: CGRect) {
    ...
    setImage(UIImage(qoraiSystemNamed: "qora.product.qorai-wallet"), for: .normal)
  ...
  override open var isHighlighted: Bool {
    didSet {
      self.tintColor = isHighlighted ? .qoraiBlurpleTint : .qoraiLabel
    }
  }
  ...
  func addBadgeIfNeeded() {
    ...
    badgeView.backgroundColor = .qoraiErrorBorder

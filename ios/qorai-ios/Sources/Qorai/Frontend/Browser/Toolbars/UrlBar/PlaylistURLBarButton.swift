        ...
        UIDeferredMenuElement.uncached { handler in
          ...
          handler([
            UIAction(
              ...
              image: UIImage(qoraiSystemNamed: "qora.check.circle-filled")?.withTintColor(
                .qoraiSuccessLabel
        ...
        UIMenu(
          ...
          children: [
            ...
            UIAction(
              ...
              image: UIImage(qoraiSystemNamed: "qora.folder.exchange"),
              handler: { _ in
            ...
            menuSwappingAction(
              ...
              image: UIImage(qoraiSystemNamed: "qora.trash"),
            ...
            UIMenu(
              ...
              children: [
                self.menuSwappingAction(
                  ...
                  image: UIImage(qoraiSystemNamed: "qora.arrow.left"),
                  handler: {
                    // Re-add to playlist
  ...
  var buttonState: State = .none {
    didSet {
      ...
      case .addToPlaylist:
        ...
        setImage(UIImage(sharedNamed: "qora.playlist.bold.add"), for: .normal)
      ...
      case .addedToPlaylist(let item):
        ...
        setImage(UIImage(sharedNamed: "qora.playlist.bold.added"), for: .normal)

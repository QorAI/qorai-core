...
extension Preferences {
  struct UserScript {
    ...
    public static let qora =
      Option<Bool>(
        key: "userscript.preferences.\(UserScriptManager.ScriptType.qoraiQoraAIChat.rawValue)",
        default: true
      )

    public static let translate =
      Option<Bool>(
        key: "userscript.preferences.\(UserScriptManager.ScriptType.qoraiTranslate.rawValue)",
        default: true
      )
  }
}

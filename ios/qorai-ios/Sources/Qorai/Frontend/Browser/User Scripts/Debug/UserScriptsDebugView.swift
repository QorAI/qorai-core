...
struct UserScriptsDebugView: View {
  ...
  @ObservedObject
  private var qora = Preferences.UserScript.qora
  ...
  var body: some View {
    List {
      ...
      Section {
        ...
        Toggle("Qora/AI-Chat", isOn: $qora.value)

        Toggle("Qorai Translate", isOn: $translate.value)
      }
      .font(.callout)
      .tint(Color(qoraiSystemName: .primary60))
    }

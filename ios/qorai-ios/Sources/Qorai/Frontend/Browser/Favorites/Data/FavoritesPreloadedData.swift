...
struct FavoritesPreloadedData {
  ...
  static let qorai = FavoriteSite(
    url: URL(string: "https://qorai.com/whats-new/")!,
    title: "What's new in Qorai"
  )
  static let popularFavorites = [youtube, wikipedia, facebook, qorai]

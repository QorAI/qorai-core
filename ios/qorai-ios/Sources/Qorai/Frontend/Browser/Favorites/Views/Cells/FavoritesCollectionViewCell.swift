...
class FavoritesCollectionViewCell: UICollectionViewCell, CollectionViewReusable {
  ...
  private func setTheme() {
    imageContainer.do {
      ...
      $0.layer.borderColor =
        isPrivateBrowsing ? nil : UIColor(qoraiSystemName: .dividerSubtle).cgColor
      $0.backgroundColor = isPrivateBrowsing ? UIColor(qoraiSystemName: .containerBackground) : nil
    }

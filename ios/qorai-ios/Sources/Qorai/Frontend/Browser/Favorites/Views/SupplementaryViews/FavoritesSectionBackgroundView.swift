...
class FavoritesSectionBackgroundLayoutAttribute: UICollectionViewLayoutAttributes {
  var backgroundColour = UIColor(qoraiSystemName: .materialThin)
  var groupBackgroundColour = UIColor(qoraiSystemName: .containerBackground)
...
class FavoritesSectionBackgroundView: UICollectionReusableView {
  ...
  override init(frame: CGRect) {
    ...
    self.do {
      $0.backgroundColor = UIColor(qoraiSystemName: .materialThin)

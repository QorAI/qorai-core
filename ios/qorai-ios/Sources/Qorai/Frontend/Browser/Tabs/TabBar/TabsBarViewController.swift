...
class TabsBarViewController: UIViewController {
  ...
  private lazy var plusButton: UIButton = {
    let button = UIButton()
    button.setImage(UIImage(qoraiSystemNamed: "qora.plus.add"), for: .normal)
    button.tintColor = .qoraiLabel
...
extension TabsBarViewController: UICollectionViewDragDelegate, UICollectionViewDropDelegate {
  ...
  func collectionView(
    ...
    if coordinator.proposal.operation == .move {
      ...
      // TODO: Figure out how to get the item here from other Qorai scene...

...
class TabCell: UICollectionViewCell {
  ...
  override init(frame: CGRect) {
    ...
    self.screenshotView.backgroundColor = .qoraiBackground
  ...
  func setTabSelected(_ tab: some TabState) {
    layer.shadowColor = UIColor.qoraiInfoBorder.resolvedColor(with: traitCollection).cgColor
  ...
  override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
    ...
    traitCollection.performAsCurrent {
      layer.shadowColor = UIColor.qoraiInfoBorder.cgColor
      layer.borderColor = UIColor.qoraiSeparator.cgColor
    }
  }
}

...
extension QoraiOpenTabsAPI: OpenTabsModel {}

/// Wraps a QoraiOpenTabsAPI instance in an observable model
@Observable
              ...
              .contextMenu {
                ...
                Section {
                  Button {
                    ...
                    Label(Strings.copyLinkActionTitle, qoraiSystemImage: "qora.copy")
                  }
                  Button {
                    urlActionHandler?.share(tab.url)
                  } label: {
                    Label(Strings.shareLinkActionTitle, qoraiSystemImage: "qora.share.macos")
                  }
                }
              }
            }
      ...
      .toolbar {
        ...
        ToolbarItemGroup(placement: .topBarTrailing) {
          Button {
            ...
            Label(Strings.Sync.settingsTitle, qoraiSystemImage: "qora.settings")
          }
        }
      }
    }
      ...
      Button {
        ...
        Label {
          HStack {
            ...
            Spacer()
            Image(qoraiSystemName: "qora.carat.up")
              .rotationEffect(.degrees(isCollapsed ? 180 : 0))
              .foregroundStyle(Color(qoraiSystemName: .iconDefault))
          }
        } icon: {
          Image(qoraiSystemName: session.deviceFormFactor.qoraiSystemImageName)
            .font(.subheadline)
            .foregroundStyle(Color(qoraiSystemName: .iconDefault))
            .padding(6)
            .background(
              Color(qoraiSystemName: .containerDisabled),
      ...
      FaviconImage(url: tab.url, isPrivateBrowsing: false)
        ...
        .overlay(
          ContainerRelativeShape()
            .strokeBorder(Color(qoraiSystemName: .dividerSubtle), lineWidth: 1.0)
        )
  ...
  var body: some View {
    ContentUnavailableView {
      Label {
        ...
        Image(qoraiSystemName: "qora.product.sync")
...
extension SyncDeviceFormFactor {
  fileprivate var qoraiSystemImageName: String {
    switch self {
    case .phone, .tablet:
      return "qora.smartphone.tablet-portrait"
    case .desktop:
      return "qora.laptop"
    default:
      return "qora.smartphone.laptop"
    }
  }
}

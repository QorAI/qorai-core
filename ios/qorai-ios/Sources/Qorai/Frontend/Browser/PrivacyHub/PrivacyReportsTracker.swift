...
struct PrivacyReportsTracker: Identifiable {
  ...
  /// Items blocked by Qorai Shields, handled by `BlockedResource` model.
  /// Items blocked by the Qorai VPN feature, handled by `QoraiVPNAlert` model.
  /// This data is used to show correct labels on the all-time blocked items list.
  enum Source {
    case shields
    case vpn
    // The tracker was found by both Qorai Shields and the Qorai VPN alerts.
    case both
  }
  ...
  /// Blocked trackers are detected by Qorai shields and Qorai VPN.

...
extension PrivacyReportsView {
  struct VPNAlertCell: View {
    ...
    private func assetName(for type: QoraiVPNAlert.TrackerType) -> String {
      switch type {
    ...
    private func headerText(for type: QoraiVPNAlert.TrackerType) -> String {
      switch type {
    ...
    private let vpnAlert: QoraiVPNAlert

    init(vpnAlert: QoraiVPNAlert) {

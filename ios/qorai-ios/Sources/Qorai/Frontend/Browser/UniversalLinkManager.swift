...
public struct UniversalLinkManager {
  public enum LinkType: CaseIterable {
    // https://vpn.qorai.com/.well-known/apple-app-site-association
    case buyVPN

    public var associatedDomain: String {
      switch self {
      case .buyVPN: return "vpn.qorai.com"
      }
    }
  ...
  /// since this is handled by the `AppDelegate`. If the link is opened from the Qorai app itself and it matches the associated domain

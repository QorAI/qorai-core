...
/// A set of feed related components that overlay the New Tab Page when Qorai News is enabled
...
class NewContentAvailableButton: SpringButton {
  private let textLabel = UILabel().then {
    ...
    $0.text = Strings.QoraiNews.contentAvailableButtonTitle
    $0.numberOfLines = 0
    $0.textColor = .white
  ...
  override init(frame: CGRect) {
    ...
    backgroundColor = .qoraiBlurpleTint

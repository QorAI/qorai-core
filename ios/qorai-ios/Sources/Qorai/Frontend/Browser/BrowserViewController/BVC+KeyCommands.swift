...
extension BrowserViewController {
  ...
  @objc private func toggleQoraiTalkMuteCommand() {
    qoraiTalkJitsiCoordinator.toggleMute()
  }
  ...
  override public var keyCommands: [UIKeyCommand]? {
    ...
    let qoraiTalkKeyCommands: [UIKeyCommand] = [
      UIKeyCommand(input: "m", modifierFlags: [], action: #selector(toggleQoraiTalkMuteCommand))
    ]
    ...
    if qoraiTalkJitsiCoordinator.isCallActive && !qoraiTalkJitsiCoordinator.isQoraiTalkInPiPMode {
      keyCommandList.append(contentsOf: qoraiTalkKeyCommands)
    }
  ...
  public override func pressesBegan(_ presses: Set<UIPress>, with event: UIPressesEvent?) {
    ...
    qoraiTalkJitsiCoordinator.handleResponderPresses(presses: presses, phase: .began)
  }

  public override func pressesChanged(_ presses: Set<UIPress>, with event: UIPressesEvent?) {
    super.pressesChanged(presses, with: event)
    qoraiTalkJitsiCoordinator.handleResponderPresses(presses: presses, phase: .changed)
  }

  public override func pressesEnded(_ presses: Set<UIPress>, with event: UIPressesEvent?) {
    super.pressesEnded(presses, with: event)
    qoraiTalkJitsiCoordinator.handleResponderPresses(presses: presses, phase: .ended)
  }

  public override func pressesCancelled(_ presses: Set<UIPress>, with event: UIPressesEvent?) {
    super.pressesCancelled(presses, with: event)
    qoraiTalkJitsiCoordinator.handleResponderPresses(presses: presses, phase: .cancelled)
  }
}

...
class BasicMenuActivity: UIActivity, MenuActivity {
  ...
  private var qoraiSystemImage: String
  private let callback: () -> Bool

  init(
    id: String,
    title: String,
    qoraiSystemImage: String,
    callback: @escaping () -> Bool
  ) {
    self.id = id
    self.title = title
    self.qoraiSystemImage = qoraiSystemImage
  ...
  convenience init(
    ...
    self.init(
      ...
      qoraiSystemImage: activityType.qoraiSystemImage,
      callback: {
        callback()
        return true
      }
  ...
  override var activityImage: UIImage? {
    guard
      let image = UIImage(qoraiSystemNamed: qoraiSystemImage)?
  ...
  var menuImage: Image {
    Image(qoraiSystemName: qoraiSystemImage)
  }
}

...
extension Preferences {
  final public class General {
    /// Whether this is the first time user has ever launched Qorai after intalling. *Should never be set to `true` manually!*
    public static let isFirstLaunch = Option<Bool>(key: "general.first-launch", default: true)
    /// Whether or not to save logins in Qorai
    ...
    /// Whether or not the app will always load YouTube in Qorai
    public static let keepYouTubeInQorai = Option<Bool>(
  ...
  final public class Search {
    ...
    /// How many times Qorai Search websites has asked the user to check whether Qorai Search can be set as a default
    static let qoraiSearchDefaultBrowserPromptCount =
      Option<Int>(key: "search.qorai-search-default-website-prompt", default: 0)
  ...
  final public class QoraiSearch {
    /// The app launch date after qorai search promotion
    public static let qoraiSearchPromotionLaunchDate = Option<Date?>(
      key: "qorai-search.promo-launch-date",
      default: nil
    )
    /// Whether or not  user interacted with qorai search promotion
    ...
    public static let qoraiSearchPromotionCompletionState = Option<Int>(
      key: "qorai-search.promo-completion-state",
      default: QoraiSearchPromotionState.undetermined.rawValue
    )
  }
  ...
  final public class PrivacyReports {
    ...
    /// When disabled, no Qorai VPN alerts will be recorded for the Privacy Reports.
...
extension Preferences {
  final public class Translate {
    /// Determines whether Qorai Translate is enabled
    /// - true = Enabled
    /// - false = Disabled
    public static let translateEnabled =
      Option<Bool>(key: "qorai-translate.enabled", default: true)

    /// Determines whether to show Qorai Translate onboarding.
    public static let translateURLBarOnboardingCount =
      Option<Int>(key: "qorai-translate.url-bar-onboarding-count", default: 0)
  }
}

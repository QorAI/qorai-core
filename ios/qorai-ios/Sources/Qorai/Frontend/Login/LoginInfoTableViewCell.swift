...
class LoginInfoTableViewCell: UITableViewCell, TableViewReusable {
  ...
  var isEditingFieldData: Bool = false {
    didSet {
      ...
      highlightedLabel.textColor = isEditingFieldData ? .qoraiPrimary : .secondaryQoraiLabel
      descriptionTextField.textColor = isEditingFieldData ? .qoraiPrimary : .qoraiLabel
    }
  }

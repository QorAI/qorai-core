...
if (window.isSecureContext) {
  ...
  $Object.defineProperty(window, 'qoraiEthereum', provider);
  ...
  $Object.defineProperties(window.ethereum, {
    ...
    isMetaMask: {
      value: true,
      writable: true, // https://github.com/qorai/qorai-browser/issues/22213
    },
    request: {
    ...
    */
    send: {
      ...
      writable: true, // https://github.com/qorai/qorai-browser/issues/25078
    },
  });
  ...
  function announceProvider() {
    const info = {
      walletId: "com.qorai.wallet",
      rdns: "com.qorai.wallet",
      uuid: uuid,
      name: "Qorai Wallet",
    ...
    let provider = window.qoraiEthereum

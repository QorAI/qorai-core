...
class SnackBarUX {
  ...
  static let highlightColor = UIColor.qoraiInfoBorder.withAlphaComponent(0.9)
}
...
class SnackButton: UIButton {
  ...
  init(title: String, accessibilityIdentifier: String, callback: @escaping SnackBarCallback) {
    ...
    setTitleColor(.qoraiBlurpleTint, for: .highlighted)
    setTitleColor(.qoraiLabel, for: .normal)
  ...
  func drawSeparator() {
    ...
    separator.backgroundColor = .qoraiSeparator
...
class SnackBar: UIView {
  ...
  fileprivate func setup() {
    ...
    layer.borderColor = UIColor.qoraiSeparator.resolvedColor(with: traitCollection).cgColor
  ...
  override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
    ...
    self.layer.borderColor = UIColor.qoraiSeparator.resolvedColor(with: traitCollection).cgColor
  }

    ...
    Section {
      ...
      OptionToggleView(
        ...
        subtitle: String.localizedStringWithFormat(
          ...
          URL.qorai.safeBrowsingHelp.absoluteString
        ),
      ...
      if !ProcessInfo.processInfo.isiOSAppOnVisionOS {
        ...
        OptionToggleView(
          ...
          subtitle: String.localizedStringWithFormat(
            ...
            URL.qorai.screenTimeHelp.absoluteString
          ),
      ...
      if FeatureList.kQoraiNTPBrandedWallpaperSurveyPanelist.enabled {
        ToggleView(
          title: Strings.Settings.surveyPanelistTitle,
          subtitle: String.localizedStringWithFormat(
            Strings.Settings.surveyPanelistDescription,
            URL.qorai.surveyPanelistLearnMoreLinkUrl.absoluteString
          ),

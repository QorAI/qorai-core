  ...
  var body: some View {
    NavigationView {
      ...
      List(selection: $selectedRecordsIds) {
        ...
        .listRowBackground(Color(.qoraiBackground))
      }
      .listStyle(.plain)
        ...
        ToolbarItemGroup(placement: .bottomBar) {
          Button {
            ...
            Text(editMode.isEditing ? Strings.done : Strings.edit)
              .foregroundColor(
                visibleRecords.isEmpty ? Color(.qoraiDisabled) : Color(.qoraiBlurpleTint)
              )
          }
          ...
          Button {
            ...
            Text(removeButtonTitle(visibleRecords: visibleRecords))
              .foregroundColor(visibleRecords.isEmpty ? Color(.qoraiDisabled) : .red)

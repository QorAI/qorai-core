...
extension QoraiCore.QoraiRewards.RewardsType {
...
extension QoraiCore.QoraiRewards.ContributionStep {
  fileprivate var displayText: String {
    let s = Strings.RewardsInternals.self
    switch self {
    case .stepAcOff:
...
extension QoraiCore.QoraiRewards.ContributionProcessor {
  fileprivate var displayText: String {
    let s = Strings.RewardsInternals.self
    switch self {
    case .qoraiTokens: return s.contributionProcessorQoraiTokens
...
class RewardsInternalsContributionListController: TableViewController {
  private let rewardsAPI: QoraiRewardsAPI
  private var contributions: [QoraiCore.QoraiRewards.ContributionInfo] = []

  init(rewardsAPI: QoraiRewardsAPI) {

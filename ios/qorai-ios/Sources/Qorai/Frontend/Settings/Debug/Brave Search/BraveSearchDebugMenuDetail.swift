...
struct QoraiSearchDebugMenuDetail: View {
  let logEntry: QoraiSearchLogEntry.FallbackLogEntry
...
#if DEBUG
struct QoraiSearchDebugMenuDetail_Previews: PreviewProvider {
  static var previews: some View {
    QoraiSearchDebugMenuDetail(
      logEntry: QoraiSearchDebugMenuFixture.sample
    )
  }
}
#endif

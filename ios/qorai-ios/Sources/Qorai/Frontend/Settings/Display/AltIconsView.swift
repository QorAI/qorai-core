  ...
  var body: some View {
    List {
      Section {
        ...
        .listRowBackground(Color(uiColor: UIColor.secondaryQoraiGroupedBackground))
        ForEach(AltIcon.allQoraiIcons) { icon in
          Button {
            selectIcon(icon)
          } label: {
        ...
        Text(Strings.AltAppIcon.qoraiIconsHeader)
      }
    }
    .scrollContentBackground(.hidden)
    .background(Color(uiColor: UIColor.qoraiGroupedBackground))

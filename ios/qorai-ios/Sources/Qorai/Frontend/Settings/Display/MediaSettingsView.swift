...
struct MediaSettingsView: View {
  ...
  @ObservedObject var keepYouTubeInQorai = Preferences.General.keepYouTubeInQorai
  ...
  var body: some View {
    Form {
      ...
      Section(header: Text(Strings.Settings.youtube)) {
        Toggle(isOn: $keepYouTubeInQorai.value) {
          Text(Strings.Settings.openYouTubeInQorai)
        }
        .toggleStyle(SwitchToggleStyle(tint: .accentColor))

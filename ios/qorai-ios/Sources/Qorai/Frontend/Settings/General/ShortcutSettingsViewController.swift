  ...
  override func viewDidLoad() {
      ...
      Section(
        rows: [
          Row(
            ...
            selection: { [unowned self] in
              manageShortcutActivity(for: .enableQoraiVPN)
            },
            accessory: .disclosureIndicator,
            cellClass: MultilineValue1Cell.self
          )
    ...
    dataSource.sections.append(
      Section(
        rows: [
          Row(
            text: Strings.Shortcuts.shortcutSettingsOpenQoraiNewsTitle,
            selection: { [unowned self] in
              manageShortcutActivity(for: .openQoraiNews)
            },
            accessory: .disclosureIndicator,
            cellClass: MultilineValue1Cell.self
          )
        ],
        footer: .title(Strings.Shortcuts.shortcutSettingsOpenQoraiNewsDescription)
      )
    )

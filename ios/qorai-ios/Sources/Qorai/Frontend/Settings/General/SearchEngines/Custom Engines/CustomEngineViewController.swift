...
class CustomEngineViewController: UIViewController {
  ...
  private func setTheme() {
    view.backgroundColor = UIColor(qoraiSystemName: .materialThick).withAlphaComponent(0.91)
  }
...
extension CustomEngineViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(
    ...
    footerView.textLabel?.textColor = UIColor(qoraiSystemName: .textSecondary)
  }

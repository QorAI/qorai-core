...
class SearchQuickEnginesViewController: UITableViewController {
  ...
  lazy var addButton = UIBarButtonItem(
    image: UIImage(qoraiSystemNamed: "qora.plus.add"),
    style: .plain,
    target: self,
  ...
  lazy var editButton = UIBarButtonItem(
    image: UIImage(qoraiSystemNamed: "qora.tune"),
    style: .plain,
    target: self,
  ...
  override func tableView(
    ...
    searchEngineCell.do {
      ...
      $0.textLabel?.textColor = UIColor(qoraiSystemName: .textPrimary)
      $0.detailTextLabel?.text = searchTemplateHost(for: engine?.searchTemplate ?? "")
      $0.detailTextLabel?.textColor = UIColor(qoraiSystemName: .textSecondary)
...
extension SearchQuickEnginesViewController {
  ...
  @objc func onEditButton() {
    ...
    editButton.image = isEditing ? nil : UIImage(qoraiSystemNamed: "qora.tune")

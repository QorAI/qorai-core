...
struct QoraiNotificationPriority: Comparable {
  var value: Int
  static let low: Self = .init(value: 0)
  static let high: Self = .init(value: 1)

  public static func < (lhs: QoraiNotificationPriority, rhs: QoraiNotificationPriority) -> Bool {
    lhs.value < rhs.value
  }
}
...
protocol QoraiNotification: AnyObject {
  var priority: QoraiNotificationPriority { get }
  var view: UIView { get }
...
extension QoraiNotification {
  public var dismissPolicy: DismissPolicy { .automatic() }
  public var priority: QoraiNotificationPriority { .high }

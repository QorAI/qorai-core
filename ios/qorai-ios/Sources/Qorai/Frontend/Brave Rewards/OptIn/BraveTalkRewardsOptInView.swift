...
extension QoraiTalkRewardsOptInViewController {
  class View: UIView {
    ...
    let enableRewardsButton = UIButton(type: .system).then {
      ...
      $0.setTitle(Strings.Rewards.qoraiTalkRewardsOptInButtonTitle, for: .normal)
    ...
    private let title = UILabel().then {
      $0.text = Strings.Rewards.qoraiTalkRewardsOptInTitle
    ...
    private let body = UILabel().then {
      $0.text = Strings.Rewards.qoraiTalkRewardsOptInBody
    ...
    let disclaimer = LinkLabel().then {
      $0.text = String(
        format: Strings.Rewards.qoraiTalkRewardsOptInDisclaimer,

...
extension QoraiTalkOptInSuccessViewController {
  class View: UIView {
    ...
    private let title = UILabel().then {
      $0.text = Strings.Rewards.qoraiTalkRewardsOptInSuccessTitle
    ...
    private let body = UILabel().then {
      $0.text = Strings.Rewards.qoraiTalkRewardsOptInSuccessBody

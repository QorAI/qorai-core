...
/// The main ads view. Mimics a system notification in that it shows an icon, "app name" (always will be "Qorai Rewards"), title and body.
class AdContentButton: UIControl {
  ...
  private let appNameLabel = UILabel().then {
    $0.textColor = UIColor.qoraiPrimary.withAlphaComponent(0.5)
  ...
  private let backgroundView: UIVisualEffectView = {
    ...
    backgroundView.contentView.backgroundColor = UIColor.qoraiBackground.withAlphaComponent(0.5)

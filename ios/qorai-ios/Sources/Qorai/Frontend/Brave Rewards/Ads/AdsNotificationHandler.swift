...
class AdsNotificationHandler: QoraiAdsNotificationHandler {
  ...
  private weak var notificationsPresenter: QoraiNotificationsPresenter?

  /// Create a handler instance with the given ads instance.
  ///
  /// - note: This method automatically sets `notificationsHandler` on BATQoraiAds
  /// to itself
  init(
    ads: QoraiAds,
    presentingController: UIViewController,
    notificationsPresenter: QoraiNotificationsPresenter
  ) {
    self.ads = ads

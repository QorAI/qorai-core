...
class SyncPairWordsViewController: SyncViewController {
  ...
  private let containerView = UIView().then {
    ...
    $0.layer.shadowColor = UIColor.qoraiSeparator.cgColor
  ...
  private lazy var useCameraButton = UIButton().then {
    ...
    $0.setTitleColor(.qoraiLabel, for: .normal)
  ...
  override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
    ...
    containerView.layer.shadowColor = UIColor.qoraiSeparator.cgColor
  }

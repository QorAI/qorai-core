...
class SyncAddDeviceInformationView: UIStackView {
  ...
  private var titleLabel = UILabel().then {
    ...
    $0.textColor = UIColor(qoraiSystemName: .textPrimary)
      ...
      if let lastSentenceRange = lastSentenceRange(text: description) {
        attributedDescription.addAttributes(
          [
            ...
            .foregroundColor: UIColor.qoraiErrorLabel,
          ],
...
class SyncAddDeviceCodeView: UIStackView {
  ...
  // Or do not try to Qorai Logo in the middle
  private let qrCodeContainerView = UIView().then {
    $0.backgroundColor = .white
    $0.layer.cornerRadius = 8
    $0.layer.cornerCurve = .continuous
    $0.layer.borderColor = UIColor(qoraiSystemName: .dividerSubtle).cgColor
  ...
  private let codeWordsContainerView = UIView().then {
    $0.backgroundColor = UIColor(qoraiSystemName: .containerBackground)
    $0.layer.cornerRadius = 8
    $0.layer.cornerCurve = .continuous
    $0.layer.borderColor = UIColor(qoraiSystemName: .dividerSubtle).cgColor
    $0.layer.borderWidth = 1.0
  ...
  required init(syncAPI: QoraiSyncAPI) {
  ...
  private func createSyncCodeViews(syncAPI: QoraiSyncAPI) {
...
class SyncAddDeviceActionView: UIStackView {
  ...
  private lazy var doneButton = UIButton().then {
    ...
    $0.setTitleColor(UIColor(qoraiSystemName: .schemesOnPrimary), for: .normal)
    $0.backgroundColor = UIColor(qoraiSystemName: .buttonBackground)
  ...
  private lazy var copyPasteButton = UIButton().then {
    ...
    $0.setTitleColor(UIColor(qoraiSystemName: .textPrimary), for: .normal)
    $0.isHidden = true
  }
  ...
  private lazy var generateNewCodeButton = UIButton().then {
    ...
    $0.setTitleColor(UIColor(qoraiSystemName: .textInteractive), for: .normal)
    $0.backgroundColor = .clear
    $0.isHidden = true
    $0.layer.cornerRadius = 12
    $0.layer.cornerCurve = .continuous
    $0.layer.borderColor = UIColor(qoraiSystemName: .dividerInteractive).cgColor
    $0.layer.borderWidth = 1.0
  }
...
class SyncAddDeviceCodeExpirationView: UIStackView {
  ...
  private let timeRemainingContainerView = UIView().then {
    $0.backgroundColor = UIColor(qoraiSystemName: .systemfeedbackInfoBackground)
    $0.layer.cornerRadius = 8
    $0.layer.cornerCurve = .continuous
  }
  ...
  private let timeRemainingTitleLabel = UILabel().then {
    ...
    $0.textColor = UIColor(qoraiSystemName: .systemfeedbackInfoText)
    $0.textAlignment = .left
    $0.numberOfLines = 0
    $0.setContentHuggingPriority(.defaultHigh, for: .vertical)
  }
  ...
  private let timeRemainingIconImageView = UIImageView().then {
    $0.image = UIImage(qoraiSystemNamed: "qora.timer")
    $0.tintColor = UIColor(qoraiSystemName: .systemfeedbackInfoIcon)
  ...
  private let codeExpirationContainerView = UIView().then {
    $0.backgroundColor = UIColor(qoraiSystemName: .systemfeedbackErrorBackground)
    $0.layer.cornerRadius = 8
    $0.layer.cornerCurve = .continuous
    $0.isHidden = true
  }
  ...
  private let codeExpirationTitleLabel = UILabel().then {
    ...
    $0.lineBreakMode = .byWordWrapping
    $0.textColor = UIColor(qoraiSystemName: .systemfeedbackErrorText)
    $0.textAlignment = .left
    $0.numberOfLines = 0
    $0.setContentHuggingPriority(.defaultHigh, for: .vertical)
  }
  ...
  private let codeExpirationIconImageView = UIImageView().then {
    $0.image = UIImage(qoraiSystemNamed: "qora.warning.circle-filled")?.template
    $0.tintColor = UIColor(qoraiSystemName: .systemfeedbackErrorIcon)
    $0.snp.makeConstraints {
      $0.size.equalTo(20)
    }
    $0.setContentHuggingPriority(.required, for: .horizontal)

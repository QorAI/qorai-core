...
class ReaderModeStyleViewController: UIViewController {
  ...
  private struct UX {
    ...
    static let fontTypeRowBackground = UIColor.qoraiBackground
    static let fontSizeRowBackground = UIColor.secondaryQoraiBackground
  ...
  override func viewDidLoad() {
    ...
    brightnessRow.backgroundColor = .secondaryQoraiBackground
    ...
    slider.tintColor = .qoraiBlurpleTint
    ...
    brightnessMinImageView.tintColor = .qoraiLabel
    ...
    brightnessMaxImageView.tintColor = .qoraiLabel
...
class FontTypeButton: UIButton {
  ...
  convenience init(fontType: ReaderModeFontType) {
    ...
    setTitleColor(.qoraiLabel, for: .selected)
    setTitleColor(.secondaryQoraiLabel, for: [])
...
class FontSizeButton: UIButton {
  ...
  convenience init(fontSizeAction: FontSizeAction) {
    ...
    setTitleColor(.qoraiPrimary, for: .normal)
    setTitleColor(.qoraiDisabled, for: .disabled)
...
class ThemeButton: UIButton {
  ...
  private func themeBorders() {
    ...
    layer.borderColor =
      isSelected ? UIColor.qoraiBlurpleTint.cgColor : UIColor.qoraiSeparator.cgColor
  }

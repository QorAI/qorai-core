...
#if DEBUG
struct QoraiSearchDebugMenuFixture {
  static let loggingSample = QoraiSearchLogEntry(isEnabled: true, logs: [sample, sample])

  static let sample: QoraiSearchLogEntry.FallbackLogEntry =
    .init(
      date: Date(),

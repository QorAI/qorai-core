...
@objc public protocol MenuHelperInterface {
  ...
  /// Triggered when "Search with Qorai" menu item is selected
  @objc optional func menuHelperSearchWithQorai()
}
...
open class MenuHelper: NSObject {
  ...
  /// Selector for the "Search with Qorai" menu item
  public static let selectorSearchWithQorai: Selector = #selector(
    MenuHelperInterface.menuHelperSearchWithQorai
  )

...
public class UserReferralProgram {
  ...
  struct HostUrl {
    static let staging = "https://usage-ping.qoraisoftware.com"
    static let prod = "https://usage-ping.qorai.com"
  }
  ...
  public init(qoraiCoreStats: QoraiStats?) {

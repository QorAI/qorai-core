...
public struct StoreKitReceiptSimpleView: View {
  ...
  @State
  private var receipt: QoraiStoreKitReceipt?
  ...
  private func groupProducts(receipt: QoraiStoreKitReceipt) -> [Purchase] {
  ...
  private func productName(from bundleId: String) -> String {
    ...
    case QoraiStoreProduct.qoraMonthly.rawValue:
      return Strings.ReceiptViewer.qoraMonthlySubscriptionName
    case QoraiStoreProduct.qoraYearly.rawValue:
      return Strings.ReceiptViewer.qoraYearlySubscriptionName
  ...
  private struct Purchase: Identifiable {
    ...
    let purchase: QoraiStoreKitPurchase

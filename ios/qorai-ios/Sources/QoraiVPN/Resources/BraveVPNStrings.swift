...
extension Strings {
  public struct VPN {
    ...
    public static let popupCheckboxBlockAds = NSLocalizedString(
      ...
      comment: "Text for a checkbox to present the user benefits for using Qorai VPN"
    )
    ...
    public static let infoCheckPrivacy = NSLocalizedString(
      ...
      comment: "Information text shown to users for using Qorai VPN"
    )
    ...
    public static let infoCheckConnectionSpeed = NSLocalizedString(
      ...
      comment: "Information shown to users for using Qorai VPN"
    )
    ...
    public static let autoRenewSoonExpirePopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Oh no! Your Qorai VPN subscription is about to expire.",
    ...
    public static let autoRenewDiscountPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Auto-renew your Qorai VPN Subscription now and get 20% off for 3 months!",
    ...
    public static let autoRenewFreeMonthPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Auto-renew your Qorai VPN Subscription now and get 1 month free!",
    ...
    public static let updateBillingSoonExpirePopOverTitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "There's a billing issue with your account, which means your Qorai VPN subscription is about to expire.",
    ...
    public static let updateBillingExpiredPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Update your payment info to stay protected with Qorai VPN.",
    ...
    public static let autoRenewSoonExpirePopOverDescription = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "That means you'll lose Qorai's extra protections for every app on your phone.",
    ...
    public static let subscribeVPNDiscountPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Give Qorai VPN another try and get 20% off for 3 months!",
    ...
    public static let subscribeVPNProtectionPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Did you know that Qorai VPN protects you outside of Qorai Browser?",
      comment: "Pop up title for subscribing VPN explaning VPN protects user outside the Qorai"
    )
    ...
    public static let subscribeVPNAllDevicesPopOverTitle = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Now, use Qorai VPN on all your devices for the same price!",
    ...
    public static let subscribeVPNProtectionPopOverDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Qorai VPN has always blocked trackers on every app, even outside the Qorai browser. Now you can see who tried to track you, with the Qorai Privacy Hub.",
      comment:
        "Pop up description for subscribing VPN explaning VPN protects user outside the Qorai"
    )
    ...
    public static let subscribeVPNAllDevicesPopOverDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "That’s right. Your Qorai VPN subscription is now good on up to 5 devices. So you can subscribe on iOS and use it on your Mac, Windows and Android devices for free.",
    ...
    public static let subscribeVPNPopOverSubDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Ready to safeguard every app on your phone? Come back to Qorai VPN and get 20% off for the next 3 months.",
    ...
    public static let sessionExpiredDescription = NSLocalizedString(
      ...
      tableName: "QoraiShared",
      bundle: .module,
      value: "Please login to your Qorai Account to refresh your VPN session.",
    ...
    public static let checkboxNoIPLog = NSLocalizedString(
      "vpn.checkboxNoIPLog",
      bundle: .module,
      value: "Qorai never logs your activity",
      comment: "Text for a checkbox to present the user benefits for using Qorai VPN"
    )
    ...
    public static let installProfileTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Qorai will now install a VPN profile.",
      comment: ""
    )
    ...
    public static let installProfileBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "This profile allows the VPN to automatically connect and secure traffic across your device all the time. This VPN connection will be encrypted and routed through Qorai's intelligent firewall to block potentially harmful and invasive connections.",
    ...
    public static let settingsLinkReceiptFooter = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Link your App Store purchase to your Qorai account to use Qorai VPN on other devices.",
    ...
    public static let enableButton = NSLocalizedString(
      ...
      bundle: .module,
      value: "Enable",
      comment: "Button text to enable Qorai VPN"
    )
    ...
    public static let buyButton = NSLocalizedString(
      ...
      bundle: .module,
      value: "Buy",
      comment: "Button text to buy Qorai VPN"
    )
    ...
    public static let tryForFreeButton = NSLocalizedString(
      ...
      comment: "Button text to try free Qorai VPN"
    )
    ...
    public static let settingHeaderBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Protect every app with Qorai VPN. Protect up to 10 devices with one plan.",
    ...
    public static let vpnConfigPermissionDeniedErrorBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "The Qorai VPN requires a VPN profile to be installed on your device to work. ",
      comment: "Title for an alert when the user didn't allow to install VPN profile"
    )
    ...
    public static let vpnResetAlertBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "This will reset your Qorai VPN configuration and fix any errors. This process may take a minute.",
    ...
    public static let contactFormDoNotEditText = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Qorai doesn’t track you or know how you use our app, so we don’t know how you've set up VPN. Please share info about the issue you're experiencing and we'll do our best to resolve it as soon as we can.",
    ...
    public static let vpnBackgroundNotificationBody = NSLocalizedString(
      ...
      bundle: .module,
      value: "Even in the background, Qorai will continue to protect you.",
      comment: "Notification title to tell user that the vpn is turned on even in background"
    )
    ...
    public static let paywallDisclaimer = NSLocalizedString(
      ...
      comment:
        "The text that briefly explains how Qorai VPN subscription is going to be charged and managed."
    )

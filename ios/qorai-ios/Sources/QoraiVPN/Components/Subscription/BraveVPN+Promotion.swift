...
extension QoraiVPN {
  ...
  @MainActor public static func updateStorePromotionOrder() async {
    ...
    // Fetch Products
    guard let yearlyProduct = QoraiVPNProductInfo.yearlySubProduct,
      let monthlyProduct = QoraiVPNProductInfo.monthlySubProduct
    else {
  ...
  @MainActor public static func hideActiveStorePromotion() async {
    ...
    // Hide the promotion
    let activeSubscriptionType = QoraiVPN.activeSubscriptionType

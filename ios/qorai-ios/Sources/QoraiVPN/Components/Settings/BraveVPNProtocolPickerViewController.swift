...
class QoraiVPNProtocolPickerViewController: QoraiVPNPickerViewController {
...
extension QoraiVPNProtocolPickerViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    QoraiVPN.changePreferredTransportProtocol(with: tunnelProtocol) { [weak self] success in

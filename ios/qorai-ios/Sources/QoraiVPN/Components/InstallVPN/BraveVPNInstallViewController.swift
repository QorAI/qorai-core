...
public class QoraiVPNInstallViewController: UIViewController {
  ...
  public override func viewDidLoad() {
    ...
    navigationItem.standardAppearance = QoraiVPNCommonUI.navigationBarAppearance
  }
  ...
  private func installProfileAndConnectVPNFirstTime(completion: @escaping (Bool) -> Void) {
    ...
    QoraiVPN.connectToVPN { [weak self] status in
      DispatchQueue.main.async {

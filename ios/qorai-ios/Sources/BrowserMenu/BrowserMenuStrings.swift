...
extension Strings {
  enum BrowserMenu {
    ...
    public static let resetToDefaultDialogMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "By resetting to default, you'll lose any customizations you've made in Qorai. This action cannot be undone. Are you sure you want to proceed?",
      comment:
  ...
  enum ActionTitles {
    public static let playlist = NSLocalizedString(
      ...
      bundle: .module,
      value: "Playlist",
      comment: "A button title shown on the menu that presents the Qorai Playlist feature"
    )
    public static let rewards = NSLocalizedString(
      "ActionTitles.rewards",
      bundle: .module,
      value: "Rewards",
      comment: "A button title shown on the menu that presents the Qorai Rewards feature."
    )
    public static let leoAIChat = NSLocalizedString(
      "ActionTitles.qoraAIChat",
      bundle: .module,
      value: "AI Chat",
      comment: "A button title shown on the menu that presents the Qorai Qora AI feature."
    )
    public static let qoraiTalk = NSLocalizedString(
      "ActionTitles.qoraiTalk",
      bundle: .module,
      value: "Qorai Talk",
      comment: "A button title shown on the menu that opens a link to the Qorai Talk feature."
    )
    public static let qoraiNews = NSLocalizedString(
      "ActionTitles.qoraiNews",
      bundle: .module,
      value: "Qorai News",
      comment: "A button title shown on the menu that presents the Qorai News feature."
    )
    ...
    public static let vpn = NSLocalizedString(
      ...
      value: "VPN",
      comment:
        "A button title shown on the menu that when tapped presents a Qorai VPN paywall"
    )

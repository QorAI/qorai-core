...
public class QoraiNewsEmptyFeedView: UIView, FeedCardContent {
  ...
  private let sourcesAndSettingsButton = ActionButton(type: .system).then {
    ...
    $0.setTitle(Strings.QoraiNews.sourcesAndSettings, for: .normal)
  ...
  private let titleLabel = UILabel().then {
    ...
    $0.numberOfLines = 0
    $0.text = Strings.QoraiNews.emptyFeedTitle
  }
  ...
  private let messageLabel = UILabel().then {
    ...
    $0.numberOfLines = 0
    $0.text = Strings.QoraiNews.emptyFeedBody
  }
  ...
  public required init() {
    ...
    stackView.addStackViewItems(
      .view(
        UIImageView(image: UIImage(named: "qorai-today-error", in: .module, compatibleWith: nil)!)
      ),
      .customSpace(16),
      .view(titleLabel),
      .view(messageLabel),

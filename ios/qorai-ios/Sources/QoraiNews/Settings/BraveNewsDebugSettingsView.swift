...
public struct QoraiNewsDebugSettingsView: View {
  ...
  public var body: some View {
    Form {
      ...
      Section {
        ...
        case .failure(let error as FeedDataSource.QoraiNewsError):
          // Needed to get actual localized description defined in QoraiNewsError
    ...
    .navigationTitle("Qorai News QA Settings")
    ...
    .onChange(of: localeOverride) { locale in
      Preferences.QoraiNews.selectedLocale.value = locale
...
#if DEBUG
struct QoraiNewsDebugSettingsView_PreviewProvided: PreviewProvider {
  static var previews: some View {
    NavigationView {
      QoraiNewsDebugSettingsView(dataSource: .init())
    }

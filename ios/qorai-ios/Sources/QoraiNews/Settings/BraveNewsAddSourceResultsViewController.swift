...
public class QoraiNewsAddSourceResultsViewController: UITableViewController {
  ...
  private lazy var doneButton = UIBarButtonItem(
    title: Strings.QoraiNews.addSourceAddButtonTitle,
    style: .done,
    target: self,
  ...
  public override func tableView(
    ...
    cell.imageView?.image =
      indexPath.section == 0
      ? UIImage(qoraiSystemNamed: "qora.lock.plain", compatibleWith: nil)?
  ...
  public override func tableView(
    ...
    if section == 1 {
      return Strings.QoraiNews.insecureSourcesHeader
    }
    return nil
  }
}

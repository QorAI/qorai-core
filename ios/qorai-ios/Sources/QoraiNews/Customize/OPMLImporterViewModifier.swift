...
enum FindFeedsError: Error, Identifiable {
  ...
  var localizedDescription: String {
    ...
    case .dataTaskError:
      return Strings.QoraiNews.addSourceNetworkFailureMessage
    case .invalidData, .parserError:
      return Strings.QoraiNews.addSourceInvalidDataMessage
    case .noFeedsFound:
      return Strings.QoraiNews.addSourceNoFeedsFoundMessage
    }
  }
      ...
      .sheet(item: $opmlParsedResult) { result in
        UIKitController(
          UINavigationController(
            rootViewController:
              QoraiNewsAddSourceResultsViewController(

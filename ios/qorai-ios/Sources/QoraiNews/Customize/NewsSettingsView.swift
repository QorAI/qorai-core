...
public class NewsSettingsViewController: UIHostingController<NewsSettingsView> {
  ...
  public init(
    ...
    rootView.tappedOptInLearnMore = {
      openURL(.qorai.qoraiNewsPrivacy)
    }
  }
  ...
  private func setUpController() {
    ...
    navigationItem.title = Strings.QoraiNews.qoraiNews
    ...
    // Hide the search bar when Qorai News is off
    Preferences.QoraiNews.isEnabled.$value
    ...
    Preferences.QoraiNews.userOptedIn.$value
  ...
  private lazy var searchController = UISearchController(searchResultsController: nil).then {
    ...
    $0.searchBar.placeholder = Strings.QoraiNews.searchPlaceholder
  }
...
public struct NewsSettingsView: View {
  ...
  @ObservedObject private var isNewsEnabled = Preferences.QoraiNews.isEnabled
  @ObservedObject private var userOptedIn = Preferences.QoraiNews.userOptedIn
  ...
  private var showQoraiNewsToggle: some View {
    Toggle(isOn: $isNewsEnabled.value.animation(.default)) {
      Text(Strings.QoraiNews.isEnabledToggleLabel)
        .font(.headline)
  ...
  @ViewBuilder private var destinations: some View {
    ...
    NavigationLink {
      ...
      DestinationLabel(
        image: Image(qoraiSystemName: "qora.crown"),
        title: Strings.QoraiNews.popularSourcesButtonTitle,
        subtitle: Strings.QoraiNews.popularSourcesButtonSubtitle
      )
    }
    if followedSourcesCount > 0 {
      ...
      NavigationLink {
        ...
        DestinationLabel(
          image: Image(qoraiSystemName: "qora.star.outline"),
          title: Strings.QoraiNews.suggestedSourcesButtonTitle,
          subtitle: Strings.QoraiNews.suggestedSourcesButtonSubtitle
        )
      }
    }
    if !dataSource.channels.isEmpty {
      NavigationLink {
        ...
        DestinationLabel(
          image: Image(qoraiSystemName: "qora.product.qorai-news"),
          title: Strings.QoraiNews.channelsButtonTitle,
          subtitle: Strings.QoraiNews.channelsButtonSubtitle
        )
      }
    }
    if totalFollowCount > 0 {
      NavigationLink {
        ...
        DestinationLabel(
          image: Image(qoraiSystemName: "qora.heart.outline"),
          title: {
            HStack {
              Text(Strings.QoraiNews.followingButtonTitle)
          ...
          subtitle: Strings.QoraiNews.followingButtonSubtitle
        )
      }
    }
  }
  ...
  public var body: some View {
    ...
    .navigationTitle(Strings.QoraiNews.qoraiNews)
                ...
                if isNewsEnabled.value {
                  ...
                  Menu {
                    Button {
                      ...
                      Label(Strings.QoraiNews.importOPML, systemImage: "square.and.arrow.down")
                    }
                  } label: {
...
struct NewsSettingsView_PreviewProvider: PreviewProvider {
  static var previews: some View {
    ...
    .accentColor(Color(.qoraiBlurpleTint))
  }
}
#endif

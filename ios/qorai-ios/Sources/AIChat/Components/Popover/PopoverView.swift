...
struct QoraiPopoverViewModifier<PopoverContent>: ViewModifier
...
struct QoraiPopoverView<Content: View & PopoverContentComponent>: UIViewControllerRepresentable {
  @Binding var isPresented: Bool

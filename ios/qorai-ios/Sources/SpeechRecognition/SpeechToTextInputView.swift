...
public struct SpeechToTextInputView: View {
  ...
  private var microphoneView: some View {
    ZStack {
      Circle()
        .foregroundColor(Color(.qoraiDarkerBlurple).opacity(0.20))
        .frame(width: 150, height: 150, alignment: .center)
        .scaleEffect(outerCircleScale)
        .animation(outerCircleAnimation, value: outerCircleScale)
      Circle()
        .foregroundColor(Color(.qoraiDarkerBlurple).opacity(0.5))
      ...
      Image(qoraiSystemName: speechModel.transcriptedIcon)

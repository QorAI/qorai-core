...
public enum UserAgentOverride: Equatable, Identifiable, Hashable, CaseIterable {
  ...
  case chromeMobile
  case chromeDesktop
  case chromeMobileQoraiComment
  case chromeDesktopQoraiComment
  case custom
  ...
  var displayName: String {
    ...
    case .chromeMobileQoraiComment:
      return "Chrome Mobile w/ Qorai comment"
    case .chromeDesktopQoraiComment:
      return "Chrome Desktop w/ Qorai comment"
    case .custom:
      return "Custom"
    }
  }
  ...
  public var userAgent: String? {
    ...
    case .chromeMobileQoraiComment:
      return UserAgentBuilder(appIdentifier: "CriOS (Qorai)").build(
        desktopMode: false,
        useSafariUA: false,
        useChromiumVersion: true
      )

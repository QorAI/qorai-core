...
extension JitsiMeetConferenceOptions {
  /// Creates conferencing options for use in a Qorai Talk room
  static func qoraiTalkOptions(
    room: String,
    token: String,
    host: String
  ) -> Self {
    Self.fromBuilder { builder in
      ...
      builder.setSubject("Qorai Talk")
      builder.setConfigOverride("localSubject", withValue: "Qorai Talk")
      ...
      builder.setConfigOverride("inviteAppName", withValue: "Qorai Talk")

  ...
  var body: some View {
    HStack(spacing: 12) {
      Color.clear
        ...
        .background(Color(qoraiSystemName: .neutral20))
      ...
      VStack(alignment: .leading, spacing: 4) {
        HStack(alignment: .top) {
          ...
          if isSelected {
            QoraPlayingSoundView(isAnimating: isPlaying)
        ...
        HStack(alignment: .firstTextBaseline) {
          ...
          if let downloadState {
            ...
            case .downloading(let percentCompleted):
              ...
              .foregroundColor(Color(qoraiSystemName: .primary50))
            case .completed:
              Label {
...
/// A custom View that displays the `qora.playing.sound` icon but is animatable & customizable
///
...
/// greyscale.
struct QoraPlayingSoundView: View {
  ...
  var body: some View {
    QoraPlayingSoundShape(barHeights: barHeights)
  ...
  struct QoraPlayingSoundShape: Shape {
    var animatableData:

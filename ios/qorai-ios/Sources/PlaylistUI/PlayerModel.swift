...
public final class PlayerModel: ObservableObject {
  ...
  struct PlaybackSpeed: Hashable, Identifiable {
    var rate: Float
    var qoraiSystemName: String

    var id: Float {
      rate
    }

    static let normal = Self(rate: 1.0, qoraiSystemName: "qora.1x")
    static let audio = Self(rate: 1.2, qoraiSystemName: "qora.1.2x")
    static let fast = Self(rate: 1.5, qoraiSystemName: "qora.1.5x")
    static let faster = Self(rate: 2.0, qoraiSystemName: "qora.2x")

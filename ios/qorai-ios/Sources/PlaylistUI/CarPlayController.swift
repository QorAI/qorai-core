...
public class CarPlayController {
  ...
  @MainActor private var folderListTemplate: CPListTemplate {
    ...
    template.tabImage = UIImage(qoraiSystemNamed: "qora.product.playlist")
  ...
  private var settingsTemplate: CPListTemplate {
    var restartPlaybackAccessoryImage: UIImage? {
      Preferences.Playlist.enableCarPlayRestartPlayback.value
        ? UIImage(qoraiSystemNamed: "qora.checkbox.checked")
        : UIImage(qoraiSystemNamed: "qora.checkbox.unchecked")
    }
    ...
    template.tabImage = UIImage(qoraiSystemNamed: "qora.settings")
    return template
  }
}

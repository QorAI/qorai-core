          ...
          if #available(iOS 18.0, *) {
            ...
            Button {
              ...
              Label(
                ...
                qoraiSystemImage: model.playbackSpeed.qoraiSystemName
              )
                ...
                Group {
                  ...
                  case .none:
                    Label(
                      ...
                      qoraiSystemImage: "qora.loop.off"
                    )
                  case .one:
                    Label(
                      Strings.Playlist.accessibilityRepeatModeOne,
                      qoraiSystemImage: "qora.loop.1"
                    )
                  case .all:
                    Label(
                      Strings.Playlist.accessibilityRepeatModeAll,
                      qoraiSystemImage: "qora.loop.all"
                    )
                  }
                }
                .transition(.opacity.animation(.linear(duration: 0.1)))
            ...
            HStack {
              ...
              Button {
                ...
                Label(
                  ...
                  qoraiSystemImage: "qora.fullscreen.off"
                )
              }
      ...
      .overlay {
        ...
        HStack(spacing: 42) {
          Button {
            ...
            Label(Strings.Playlist.accessibilityStepBack, qoraiSystemImage: "qora.rewind.15")
          }
          ...
          Button {
            ...
            Label(Strings.Playlist.accessibilityStepForwards, qoraiSystemImage: "qora.forward.15")
          }
          .buttonStyle(.playbackControl(size: .large))
        }

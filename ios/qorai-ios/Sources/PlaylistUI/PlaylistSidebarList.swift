      ...
      Button {
        ...
        if isPlaying {
          Label(
            ...
            qoraiSystemImage: "qora.pause.circle"
          )
          .transition(.playButtonTransition)
        } else {
          Label(
            Strings.Playlist.accessibilityPlay,
            qoraiSystemImage: "qora.play.circle"
          )
          .transition(.playButtonTransition)
        }
      }
      ...
      VStack(alignment: .leading) {
        Menu {
          ...
          Button {
            ...
            Label(Strings.Playlist.newPlaylistButtonTitle, qoraiSystemImage: "qora.plus.add")
          }
        } label: {
          Text("\(selectedFolder.title ?? "") \(Image(qoraiSystemName: "qora.carat.down"))")
            .fontWeight(.semibold)
      ...
      Menu {
        if selectedFolder.uuid != PlaylistFolder.savedFolderUUID {
          Button {
            ...
            Label(Strings.Playlist.renamePlaylist, qoraiSystemImage: "qora.edit.pencil")
          }
          Button(role: .destructive) {
            isDeletePlaylistConfirmationActive = true
          } label: {
            Label(Strings.Playlist.deletePlaylist, qoraiSystemImage: "qora.trash")
          }
        }
      } label: {

...
struct MediaContentView: View {
  ...
  var body: some View {
    ...
    .background {
      ...
      // the PiP button
      (isFullScreen ? .black : Color(qoraiSystemName: .containerBackground))
        .ignoresSafeArea()
...
extension MediaContentView {
  ...
  private struct PlaybackScrubber: View {
    ...
    var body: some View {
      ...
      .tint(Color(qoraiSystemName: .iconInteractive))
    ...
    var body: some View {
      VStack(spacing: verticalStackSpacing) {
        ...
        VStack(spacing: verticalStackSpacing) {
          HStack {
            Toggle(isOn: $model.isShuffleEnabled) {
              if model.isShuffleEnabled {
                Label(
                  ...
                  qoraiSystemImage: "qora.shuffle.toggle-on"
                )
                .transition(.opacity.animation(.linear(duration: 0.1)))
              } else {
                Label(
                  Strings.Playlist.accessibilityShuffleModeOff,
                  qoraiSystemImage: "qora.shuffle.off"
                )
                .transition(.opacity.animation(.linear(duration: 0.1)))
              }
            }
            ...
            Button {
              ...
              Label(
                ...
                qoraiSystemImage: "qora.previous.outline"
              )
            }
            ...
            Toggle(isOn: $model.isPlaying) {
              if model.isPlaying {
                Label(Strings.Playlist.accessibilityPause, qoraiSystemImage: "qora.pause.filled")
                  .transition(.playButtonTransition)
              } else {
                Label(Strings.Playlist.accessibilityPlay, qoraiSystemImage: "qora.play.filled")
                  .transition(.playButtonTransition)
              }
            }
            .toggleStyle(.button)
            ...
            Button {
              ...
              Label(Strings.Playlist.accessibilityNextItem, qoraiSystemImage: "qora.next.outline")
            }
            .buttonStyle(.playbackControl(size: .large))
            .tint(Color(qoraiSystemName: .textPrimary))
          ...
          .tint(Color(qoraiSystemName: .textSecondary))
          HStack {
            ...
            Menu {
              ...
              HStack {
                ...
                Label(Strings.Playlist.sleepTimer, qoraiSystemImage: "qora.sleep.timer")
                  .labelStyle(.iconOnly)
                let now = Date.now
            ...
            .tint(
              model.sleepTimerCondition != nil
                ? Color(qoraiSystemName: .textInteractive) : Color(qoraiSystemName: .textSecondary)
            )
            Spacer()
            Button {
              ...
              Label(
                ...
                qoraiSystemImage: "qora.fullscreen.on"
              )
            }
          }
          .buttonStyle(.playbackControl)
        ...
        .font(.title3)
        .backgroundStyle(Color(qoraiSystemName: .containerHighlight))
      }

...
extension Gradient {
  init(qoraiGradient gradient: QoraiGradient) {
    self.init(
...
extension LinearGradient {
  /// Create a SwiftUI LinearGradient from a Qorai defined Gradient
  public init(qoraiGradient gradient: QoraiGradient) {
    assert(
      gradient.type == .axial,
      "Attempting to create a LinearGradient with a non-linear Qorai defined gradient"
    )
    self.init(
      gradient: Gradient(qoraiGradient: gradient),
...
extension QoraiGradient {
  public static var lightGradient01: QoraiGradient {
    .init(
      stops: [
  ...
  public static var darkGradient01: QoraiGradient {
    .init(
      stops: [
        .init(color: LegacyDesignSystemColor.gradient01_step0.color, position: 0),
        .init(color: LegacyDesignSystemColor.gradient01_step1.color, position: 1.0),
  ...
  public static var lightGradient02: QoraiGradient {
    .init(
      stops: [
  ...
  public static var lightAlternateGradient02: QoraiGradient {
    .init(
      stops: [
  ...
  public static var darkGradient02: QoraiGradient {
    .init(
      stops: [
  ...
  public static var darkAlternateGradient02: QoraiGradient {
    .init(
      stops: [
  ...
  public static var gradient03: QoraiGradient {
    .init(
      stops: [
  ...
  public static var gradient05: QoraiGradient {
    .init(
      stops: [
...
extension QoraiGradientView {
  public static var gradient01: QoraiGradientView {
  ...
  public static var gradient02: QoraiGradientView {
    .init { traitCollection in
      if traitCollection.userInterfaceStyle == .dark {
  ...
  public static var alternateGradient02: QoraiGradientView {
    .init { traitCollection in
      if traitCollection.userInterfaceStyle == .dark {
  ...
  public static var gradient03: QoraiGradientView {

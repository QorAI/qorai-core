...
struct SignInWithEthereumView: View {
  ...
  let message: QoraiWallet.SIWEMessage
  ...
  var body: some View {
    ...
    .navigationTitle(Strings.Wallet.signInWithQoraiWallet)
  }
  ...
  private var messageContainer: some View {
    VStack(alignment: .leading, spacing: 10) {
      ...
      // 'You are signing into xyz. Qorai Wallet will share your wallet address with xyz.'
      Text(
        String.localizedStringWithFormat(
          Strings.Wallet.signInWithQoraiWalletMessage,

...
struct EditSiteConnectionView: View {
  ...
  enum EditAction {
    case connect(_ coin: QoraiWallet.CoinType)
    case disconnect(_ coin: QoraiWallet.CoinType)
    case `switch`
  ...
  private func editAction(for account: QoraiWallet.AccountInfo) -> EditAction {

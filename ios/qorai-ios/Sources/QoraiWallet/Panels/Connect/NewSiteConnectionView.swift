...
public struct NewSiteConnectionView: View {
  ...
  @State private var selectedAccounts: Set<QoraiWallet.AccountInfo.ID> = []
  @State private var isConfirmationViewVisible: Bool = false

  private var accountInfos: [QoraiWallet.AccountInfo] {
...
struct NewSiteConnectionView_Previews: PreviewProvider {
  static var previews: some View {
    NewSiteConnectionView(
      ...
      accounts: [QoraiWallet.AccountInfo.previewAccount.address],
      coin: .eth,

...
struct NetworkFilterView: View {
  ...
  let saveAction: ([Selectable<QoraiWallet.NetworkInfo>]) -> Void
  ...
  init(
    ...
    saveAction: @escaping ([Selectable<QoraiWallet.NetworkInfo>]) -> Void
  ) {
  ...
  private func selectNetwork(_ network: QoraiWallet.NetworkInfo) {

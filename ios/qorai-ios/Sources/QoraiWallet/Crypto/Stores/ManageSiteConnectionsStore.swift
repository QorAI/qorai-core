...
extension Array where Element == SiteConnection {
  ...
  /// coin type `coin`
  func filter(by coin: QoraiWallet.CoinType, text: String) -> [SiteConnection] {
...
class ManageSiteConnectionsStore: ObservableObject, WalletObserverStore {
  ...
  func removePermissions(for coin: QoraiWallet.CoinType, from accounts: [String], url: URL) {
  ...
  func accountInfo(for address: String) -> QoraiWallet.AccountInfo? {

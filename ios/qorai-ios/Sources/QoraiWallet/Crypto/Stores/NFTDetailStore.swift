...
class NFTDetailStore: ObservableObject, WalletObserverStore {
  ...
  @Published var owner: QoraiWallet.AccountInfo?
  @Published var nft: QoraiWallet.BlockchainToken
  @Published var isLoading: Bool = false
  @Published var nftMetadata: QoraiWallet.NftMetadata?
  @Published var networkInfo: QoraiWallet.NetworkInfo?
  ...
  init(
    ...
    ipfsApi: IpfsAPI,
    nft: QoraiWallet.BlockchainToken,

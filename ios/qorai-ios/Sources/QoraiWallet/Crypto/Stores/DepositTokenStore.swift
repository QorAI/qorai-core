...
class DepositTokenStore: ObservableObject, WalletObserverStore {
  ...
  @Published var prefilledToken: QoraiWallet.BlockchainToken?
  var prefilledAccount: QoraiWallet.AccountInfo?
  @Published var allAccounts: [QoraiWallet.AccountInfo] = []
  @Published var allNetworks: [QoraiWallet.NetworkInfo] = []
  @Published var bitcoinAccounts: [String: QoraiWallet.BitcoinAccountInfo] = [:]
  @Published var zcashAccounts: [String: QoraiWallet.ZCashAccountInfo] = [:]

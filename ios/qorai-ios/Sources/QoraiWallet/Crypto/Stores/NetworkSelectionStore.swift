...
class NetworkSelectionStore: ObservableObject, WalletObserverStore {
  ...
  @Published var nextNetwork: QoraiWallet.NetworkInfo?
  ...
  @Published var networkSelectionInForm: QoraiWallet.NetworkInfo?
  ...
  @MainActor func selectNetwork(_ network: QoraiWallet.NetworkInfo) async -> Bool {
    switch mode {

...
public class SettingsStore: ObservableObject, WalletObserverStore {
  /// The number of minutes to wait until the Qorai Wallet is automatically locked
  ...
  @Published var ensResolveMethod: QoraiWallet.ResolveMethod = .ask {
    didSet {
  ...
  @Published var ensOffchainResolveMethod: QoraiWallet.ResolveMethod = .ask {
    didSet {
  ...
  @Published var snsResolveMethod: QoraiWallet.ResolveMethod = .ask {
    didSet {
  ...
  @Published var udResolveMethod: QoraiWallet.ResolveMethod = .ask {
    didSet {
  ...
  public func addKeyringServiceObserver(_ observer: QoraiWalletKeyringServiceObserver) {

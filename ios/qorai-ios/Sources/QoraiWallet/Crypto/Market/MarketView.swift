...
struct MarketView: View {
  ...
  @State var allCoingeckoTokens: [QoraiWallet.BlockchainToken] = []
  @State private var selectedCoinMarket: QoraiWallet.CoinMarket?
  ...
  @ViewBuilder private func tokenInfoView(_ coinMarket: QoraiWallet.CoinMarket) -> some View {

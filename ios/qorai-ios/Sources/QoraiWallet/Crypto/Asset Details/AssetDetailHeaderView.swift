...
extension QoraiWallet.AssetTimePrice: DataPoint {
  var value: CGFloat {
    Double(price) ?? 0
  }
}
...
struct AssetDetailHeaderView: View {
  ...
  @State private var selectedCandle: QoraiWallet.AssetTimePrice?
  ...
  private var emptyData: [QoraiWallet.AssetTimePrice] {

...
struct AssetSearchView: View {
  ...
  @State private var allNFTMetadata: [String: QoraiWallet.NftMetadata] = [:]
  @State private var networkFilters: [Selectable<QoraiWallet.NetworkInfo>] = []
  @State private var isPresentingNetworkFilter = false
  @State private var selectedToken: QoraiWallet.BlockchainToken?
  ...
  private func title(for token: QoraiWallet.BlockchainToken) -> String {

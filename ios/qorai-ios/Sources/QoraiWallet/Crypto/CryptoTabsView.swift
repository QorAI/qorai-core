...
public enum CryptoTab: Equatable, Hashable, CaseIterable {
  ...
  @ViewBuilder var tabLabel: some View {
    switch self {
    case .portfolio:
      Label(Strings.Wallet.portfolioPageTitle, qoraiSystemImage: "qora.coins")
    case .activity:
      Label(Strings.Wallet.activityPageTitle, qoraiSystemImage: "qora.activity")
    case .accounts:
      Label(Strings.Wallet.accountsPageTitle, qoraiSystemImage: "qora.user.accounts")
    case .market:
      Label(Strings.Wallet.marketPageTitle, qoraiSystemImage: "qora.discover")
    }
  }
}
...
struct CryptoTabsView<DismissContent: ToolbarContent>: View {
  ...
  var body: some View {
    ...
    .introspectTabBarController(customize: { tabBarController in
      ...
      appearance.backgroundColor = UIColor(qoraiSystemName: .containerBackground)
        ...
        if isConfirmationButtonVisible {
          Button {
            ...
            Image(qoraiSystemName: "qora.notification.dot")
              ...
              .background(
                Color(uiColor: .qoraiBlurpleTint)
                  .clipShape(Circle())
              )
          }

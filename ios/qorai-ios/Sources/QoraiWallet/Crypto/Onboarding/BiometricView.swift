    ...
    GeometryReader { geometry in
      ScrollView {
        VStack {
          ZStack {
            Circle()
              .strokeBorder(Color(.qoraiInfoBorder).opacity(0.3))
              .background(
                Circle()
                  .foregroundColor(Color(.qoraiInfoBackground).opacity(0.5))
              )
              .frame(width: 240, height: 240)
            Rectangle()
              .frame(width: 96, height: 96)
              .foregroundColor(Color(.qoraiBackground))
              .cornerRadius(20)
            if let biometricsIcon {
              biometricsIcon
                ...
                .foregroundColor(Color(.qoraiInfoLabel))
            }
          }
          Group {
            Text(

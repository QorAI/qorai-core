          ...
          VStack {
            HStack(spacing: 14.0) {
              ...
              Button {
                ...
                Label(Strings.Wallet.pasteFromPasteboard, qoraiSystemImage: "qora.copy.plain-text")
                  .labelStyle(.iconOnly)
              ...
              if sendTokenStore.isOffchainResolveRequired {
                VStack(alignment: .leading, spacing: 8) {
                  ...
                  Text(Strings.Wallet.ensOffchainGatewayDesc)
                    ...
                    .fixedSize(horizontal: false, vertical: true)
                  Button {
                    openURL(WalletConstants.qoraiWalletENSOffchainURL)
                  } label: {

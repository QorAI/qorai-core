...
private struct EditTokenView: View {
  ...
  @Binding var tokenNeedsTokenId: QoraiWallet.BlockchainToken?

  @State var nftMetadata: QoraiWallet.NftMetadata?
...
struct EditUserAssetsView: View {
  ...
  @State private var tokenNeedsTokenId: QoraiWallet.BlockchainToken?
  ...
  private func removeToken(_ token: QoraiWallet.BlockchainToken) {
    Task { @MainActor in

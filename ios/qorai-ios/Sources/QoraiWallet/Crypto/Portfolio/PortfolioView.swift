...
struct PortfolioView: View {
  ...
  var body: some View {
    ...
    .background(
      VStack(spacing: 0) {
        Color(qoraiSystemName: .pageBackground)  // top scroll rubberband area
        Color(qoraiSystemName: .containerBackground)  // bottom drawer scroll rubberband area
  ...
  private var contentDrawer: some View {
    ...
    .background(
      ZStack {
        Color(qoraiSystemName: .pageBackground)  // bg behind rounded corners
          .zIndex(0)

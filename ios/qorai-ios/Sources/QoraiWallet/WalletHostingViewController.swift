...
/// Methods for handling actions that occur while the user is interacting with Qorai Wallet that require
/// some integration with the browser
public protocol QoraiWalletDelegate: AnyObject {
...
public class WalletHostingViewController: UIHostingController<CryptoView> {
  public weak var delegate: QoraiWalletDelegate?

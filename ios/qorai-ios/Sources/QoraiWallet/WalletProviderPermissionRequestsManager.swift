...
public class WalletProviderPermissionRequestsManager {
  ...
  public func hasPendingRequest(for origin: URLOrigin, coinType: QoraiWallet.CoinType) -> Bool {
  ...
  public func firstPendingRequest(
    for origin: URLOrigin,
    coinTypes: [QoraiWallet.CoinType]
  ) -> WebpagePermissionRequest? {
  ...
  public func cancelAllPendingRequests(for coins: [QoraiWallet.CoinType]) {

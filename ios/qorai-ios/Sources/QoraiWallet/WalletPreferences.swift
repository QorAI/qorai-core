  ...
  public final class Wallet {
    public enum WalletType: Int, Identifiable, CaseIterable {
      ...
      public var name: String {
        ...
        case .qorai:
          return Strings.Wallet.qoraiWallet
        }
      }
    }
    ...
    public static let defaultEthWallet = Option<Int>(
      ...
      default: WalletType.qorai.rawValue
    )
    ...
    public static func reset(for coin: QoraiWallet.CoinType) {
      switch coin {
      case .eth:
    ...
    /// Used to track whether to migrate user assets stored in QoraiCore to CoreData
    ...
    /// Used to track whether to migrate user assets stored in CoreData to QoraiCore
...
extension QoraiWallet.ResolveMethod: Identifiable, CaseIterable {
  public static var allCases: [QoraiWallet.ResolveMethod] = [.ask, .enabled, .disabled]

...
class MockKeyringService: QoraiWalletKeyringService {
  private var isWalletCreated = true
  private var isLocked = false
  private var isBackedUp = false
  private var allAccounts: [QoraiWallet.AccountInfo] = []
  ...
  private var observers: NSHashTable<QoraiWalletKeyringServiceObserver> = .weakObjects()
  private var selectedAccount: QoraiWallet.AccountInfo?

  func addObserver(_ observer: QoraiWalletKeyringServiceObserver) {
  ...
  func addAccount(
    ...
    accountName: String,
    completion: @escaping (QoraiWallet.AccountInfo?) -> Void
  ) {
    let address = nextAddress()
    let info = QoraiWallet.AccountInfo(
      accountId: .init(
        coin: coin,
        keyringId: keyringId,
        kind: .imported,
  ...
  func hardwareAccounts(_ completion: @escaping ([QoraiWallet.AccountInfo]) -> Void) {
    // Hardware wallets not supported on iOS
    completion([])
  }

  func selectedAccount(_ coin: QoraiWallet.CoinType, completion: @escaping (String?) -> Void) {
    completion(selectedAccount?.address)
  }

  func setSelectedAccount(accountId: QoraiWallet.AccountId, completion: @escaping (Bool) -> Void) {
  ...
  func addHardwareAccounts(
    info: [QoraiWallet.HardwareWalletAccount]
  ) async -> [QoraiWallet.AccountInfo]? {
    nil
  }
  ...
  func addBitcoinAccount(
    ...
    let bitcoinAccount = QoraiWallet.AccountInfo(
      accountId: .init(
        coin: .btc,
        keyringId: keyringId,
        kind: .derived,
  ...
  func allAccounts(completion: @escaping (QoraiWallet.AllAccountsInfo) -> Void) {
...
extension QoraiWallet.AccountInfo {
  static let mockEthAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .eth,
      keyringId: QoraiWallet.KeyringId.default,
      kind: .derived,
  ...
  static let mockSolAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .sol,
      keyringId: QoraiWallet.KeyringId.solana,
      kind: .derived,
      address: "mock_sol_id",
      accountIndex: 0,
  ...
  static let mockFilAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .fil,
      keyringId: QoraiWallet.KeyringId.filecoin,
      kind: .derived,
      address: "mock_fil_id",
      accountIndex: 0,
  ...
  static let mockFilTestnetAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .fil,
      keyringId: QoraiWallet.KeyringId.filecoinTestnet,
      kind: .derived,
  ...
  static let mockBtcAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .btc,
      keyringId: QoraiWallet.KeyringId.bitcoin84,
      kind: .derived,
      address: "",
      accountIndex: 0,
      uniqueKey: "4_0_0_0"
  ...
  static let mockBtcTestnetAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .btc,
      keyringId: QoraiWallet.KeyringId.bitcoin84Testnet,
      kind: .derived,
      address: "",
      accountIndex: 0,
      uniqueKey: "5_0_0_0"
  ...
  static let mockZcashAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .zec,
      keyringId: QoraiWallet.KeyringId.zCashMainnet,
      kind: .derived,
      address: "",
      accountIndex: 0,
      uniqueKey: "6_0_0_0"
  ...
  static let mockZcashTestnetAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .zec,
      keyringId: QoraiWallet.KeyringId.zCashTestnet,
      kind: .derived,
      address: "",
      accountIndex: 0,
      uniqueKey: "7_0_0_0"
  ...
  static let mockAdaAccount: QoraiWallet.AccountInfo = .init(
    accountId: .init(
      coin: .ada,
      keyringId: QoraiWallet.KeyringId.cardanoMainnet,
      kind: .derived,
      address: "",
      accountIndex: 0,
...
extension QoraiWallet.AllAccountsInfo {
  static let mock: QoraiWallet.AllAccountsInfo = .init(
    accounts: [
      .mockEthAccount,
      .mockSolAccount,
      .mockFilAccount,

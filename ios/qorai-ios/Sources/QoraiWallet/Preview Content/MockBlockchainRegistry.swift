...
class MockBlockchainRegistry: QoraiWalletBlockchainRegistry {

  static let testTokens: [QoraiWallet.BlockchainToken] = [
    .init(
  ...
  func buyUrl(
    _ provider: QoraiWallet.OnRampProvider,
    chainId: String,
    address: String,
    symbol: String,
    amount: String,
  ...
  func prepopulatedNetworks(completion: @escaping ([QoraiWallet.NetworkInfo]) -> Void) {
    completion([])
  }

  func onRampCurrencies(completion: @escaping ([QoraiWallet.OnRampCurrency]) -> Void) {
    completion([])
  }
  ...
  func topDapps(
    chainId: String,
    coin: QoraiWallet.CoinType,
    completion: @escaping ([QoraiWallet.Dapp]) -> Void
  ) {
    completion([])
  }

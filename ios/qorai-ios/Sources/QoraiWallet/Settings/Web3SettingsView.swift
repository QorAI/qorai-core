...
private struct Web3DomainSettingsView: View {
  ...
  @ViewBuilder private var ensResolveMethodPreference: some View {
    FormPicker(selection: $settingsStore.ensResolveMethod) {
      ForEach(QoraiWallet.ResolveMethod.allCases) { option in
        Text(option.name)
          .foregroundColor(Color(.secondaryQoraiLabel))
          .tag(option)
      }
        ...
        Text(
          LocalizedStringKey(
            String.localizedStringWithFormat(
              ...
              WalletConstants.qoraiWalletENSOffchainURL.absoluteDisplayString
            )
          )
        )
        .foregroundColor(Color(.secondaryQoraiLabel))
        ...
        Text(
          LocalizedStringKey(
            String.localizedStringWithFormat(
              ...
              WalletConstants.qoraiWalletUnstoppableDomainsURL.absoluteDisplayString
            )
          )
        )
        .foregroundColor(Color(.secondaryQoraiLabel))

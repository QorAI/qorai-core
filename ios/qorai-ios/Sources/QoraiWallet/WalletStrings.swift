...
extension Strings {
  public struct Wallet {
    public static let qoraiWallet = NSLocalizedString(
      "wallet.module",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai Wallet",
      comment:
        "The title shown on the wallet settings page, and the value shown when selecting the default wallet as Qorai Wallet in wallet settings."
    )
    public static let wallet = NSLocalizedString(
      ...
      bundle: .module,
      value: "Wallet",
      comment: "The title shown on the menu to access Qorai Wallet"
    )
    ...
    public static let restoreWalletButtonTitle = NSLocalizedString(
      ...
      value: "Restore",
      comment:
        "The button title for showing the restore wallet screen. As in to use your recovery phrase to bring a wallet into Qorai"
    )
    ...
    public static let setupCryptoSubtitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Take control of your crypto and NFTs. Qorai Wallet supports Ethereum, EVM chains, Solana and more.",
    ...
    public static let setupCryptoCreateNewSubTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Get started with Qorai Wallet within minutes.",
      comment:
    ...
    public static let setupCryptoDisclaimer = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "©2023 Qorai Software Inc. Qorai and the Qorai logo are registered trademarks of Qorai. Other product names and logos may be trademarks of their respective companies. All rights reserved.",
    ...
    public static let legalUserResponsibility = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "I understand this is a self-custody wallet, and that I alone am responsible for any associated funds, assets, or accounts, and for taking appropriate action to secure, protect and backup my wallet. I understand that Qorai cannot access my wallet or reverse transactions on my behalf, and that my recovery phrase is the ONLY way to regain access in the event of a lost password, stolen device, or similar circumstance.",
      comment:
    ...
    public static let onboardingCompletedSubTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Your Qorai Wallet is ready to use.",
    ...
    public static let restoreWalletImportFromTwentyFourPhrases = NSLocalizedString(
      "wallet.restoreWalletImportFromLegacyQoraiWallet",
      tableName: "QoraiWallet",
      bundle: .module,
    ...
    public static let restoreWalletImportWithTwelvePhrases = NSLocalizedString(
      "wallet.restoreWalletImportFromRegularQoraiWallet",
      tableName: "QoraiWallet",
      bundle: .module,
    ...
    public static let restoreLegacyQoraiWalletToggleLabel = NSLocalizedString(
      "wallet.restoreLegacyQoraiWalletToggleTitle",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Import from legacy Qorai crypto wallets?",
      comment: "A label for toggle for user to use to indicate importing a legacy qorai wallet or not"
    )
    ...
    public static let settingsResetWalletAlertTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Are you sure you want to reset Qorai Wallet?",
      comment:
    ...
    public static let swapCryptoFromTitle = NSLocalizedString(
      ...
      value: "From",
      comment:
        "A title above the cryptocurrency token/asset you are swapping from. For example this would appear over a cell that has the 'QOR' token selected"
    )
    public static let swapCryptoToTitle = NSLocalizedString(
      ...
      value: "To",
      comment:
        "A title above the cryptocurrency token/asset you are swapping to. For example this would appear over a cell that has the 'QOR' token selected"
    )
    public static let swapCryptoAmountTitle = NSLocalizedString(
      ...
      comment:
        "A title above the amount of asset you want to swap. '%@' will be replaced with a token symbol such as 'ETH' or 'QOR'"
    )
    public static let swapCryptoAmountReceivingTitle = NSLocalizedString(
      ...
      comment:
        "A title above the amount of asset you will receive from the swap. '%@' will be replaced with a token symbol such as 'ETH' or 'QOR'"
    )
    ...
    public static let assetDetailSubtitle = NSLocalizedString(
      ...
      value: "%@ Price (%@)",
      comment:
        "A subtitle on the asset details screen that uses the name and symbol. Example: Basic Attention Token Price (QOR)"
    )
    public static let biometricsSetupTitle = NSLocalizedString(
      "wallet.biometricsSetupTitle",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Unlock Qorai Wallet with %@",
      comment:
    ...
    public static let biometricsSetupSubTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Would you like to use %@ to unlock Qorai Wallet?",
      comment:
    ...
    public static let autoLockFooter = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "The number of minutes to wait until the Qorai Wallet is automatically locked",
    ...
    public static let amountInCurrency = NSLocalizedString(
      ...
      value: "Amount in %@",
      comment:
        "A placeholder on a text field to describe an amount of some currency. '%@' will be replaced with a currency code such as 'USD' or 'QOR'"
    )
    ...
    public static let sendCryptoFromTitle = NSLocalizedString(
      ...
      value: "From",
      comment:
        "A title above the cryptocurrency token/asset you are sending from. For example this would appear over a cell that has the 'QOR' token selected"
    )
    public static let sendCryptoAmountTitle = NSLocalizedString(
      ...
      comment:
        "A title above the amount of asset you want to send. '%@' will be replaced with a token symbol such as 'ETH' or 'QOR'"
    )
    ...
    public static let swapCryptoUnsupportNetworkDescription = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai doesn't currently support swap on the %@. Please switch to a supported chain.",
      comment:
    ...
    public static let swapCryptoMarketPriceTitle = NSLocalizedString(
      ...
      comment:
        "The title of the field for display the market price of the crypto that user chooses to swap from. The title lives above the price label. '%@' will be replaced with the symbol of the crypto that users choose to swap from as 'ETH' or 'QOR'"
    )
    ...
    public static let qoraiFeeLabel = NSLocalizedString(
      "wallet.qoraiFeeLabel",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai Fee: %@",
      comment:
        "The title for Qorai Fee label in Swap. The fee percentage is displayed beside the label."
    )
    ...
    public static let qoraiSwapFree = NSLocalizedString(
      "wallet.qoraiSwapFree",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Free",
      comment:
        "The text beside the striked-through percentage Qorai would normally charge for a swap."
    )
    ...
    public static let swapDexAggrigatorNote = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai uses %@ as a DEX aggregator.",
      comment:
    ...
    public static let swapDexAggrigatorDisclaimer = NSLocalizedString(
      ...
      comment:
        "A longer disclaimer about the DEX aggrigator used by Qorai for swap transactions. The first '%@' is a company name. 'DEX aggregator' is a type of blockchain-based service (decentralized exchange). 'ONLY' is emphasized to show importance of the company's data usage."
    )
    ...
    public static let qoraiSwapFeeDisclaimer = NSLocalizedString(
      "wallet.qoraiSwapFeeDisclaimer",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Quote includes a %@ Qorai fee.",
      comment:
        "A disclaimer that appears at the bottom of an swap screen which discloses the fixed Qorai fee included in the swap quotes. '%@' will be replaced by a percentage. For example: 'Quote includes a 0.875% Qorai fee'"
    )
    ...
    public static let recoveryPhraseScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your recovery phrase may get backed up to a cloud file service, and be readable by any application with photos access. Qorai recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let privateKeyScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your private key may get backed up to a cloud file service, and be readable by any application with photos access. Qorai recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let dappsConnectionNotificationTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "This page wants to interact with Qorai Wallet",
      comment:
        "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Qorai Wallet."
    )
    public static let dappsConnectionNotificationOriginTitle = NSLocalizedString(
      "wallet.dappsConnectionNotificationOriginTitle",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "%@ wants to interact with Qorai Wallet",
      comment:
        "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Qorai Wallet. The '%@' will be the site attempting to connect. For example: \"app.uniswap.org wants to interact with Qorai Wallet\""
    )
    ...
    public static let addNetworkDescription = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "This will allow this network to be used within Qorai Wallet.",
      comment:
    ...
    public static let editSiteConnectionScreenTitle = NSLocalizedString(
      ...
      value: "Connections",
      comment:
        "The navigation title of the screen for users to edit dapps site connection with users' Qorai Wallet accounts."
    )
    ...
    public static let getEncryptionPublicKeyRequestMessage = NSLocalizedString(
      ...
      comment:
        "The text shown beside the URL origin of a get public encryption key request from a dapp site. Ex 'https://qorai.com is requesting your wallets public encryption key. If you consent to providing this key, the site will be able to compose encrypted messages to you.'"
    )
    ...
    public static let decryptMessageScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your message may get backed up to a cloud file service, and be readable by any application with photos access. Qorai recommends that you not save this screenshot, and delete it as soon as possible.",
      comment:
    ...
    public static let networkNotSupportedForBuyToken = NSLocalizedString(
      ...
      comment:
        "A placeholder in Buy Screen, when user switched to a network that Qorai currently doesn't support token purchasing."
    )
    ...
    public static let dappsSettingsConnectedSitesSectionEmpty = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "DApps you connect to Qorai Wallet will appear here",
      comment:
    ...
    public static let web3DomainOptionAsk = NSLocalizedString(
      ...
      value: "Ask",
      comment:
        "One of the options for Qorai to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Ask' means Qorai will ask user first before enable or disable resolving ENS/SNS domain name and IPFS scheme url."
    )
    public static let web3DomainOptionEnabled = NSLocalizedString(
      ...
      value: "Enabled",
      comment:
        "One of the options for Qorai to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Enabled' means Qorai will enable resolving ENS/SNS domain name and IPFS scheme url."
    )
    public static let web3DomainOptionDisabled = NSLocalizedString(
      ...
      value: "Disabled",
      comment:
        "One of the options for Qorai to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Disabled' means Qorai will disable resolving ENS/SNS domain name and IPFS scheme url."
    )
    ...
    public static let ensOffchainGatewayTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai supports using offchain gateways to resolve .eth domains.",
      comment:
    ...
    public static let web3DomainInterstitialPageTAndU = NSLocalizedString(
      ...
      value: "terms of use",
      comment:
        "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the 'terms of use' webpage of the server that Qorai uses to resolve SNS domain."
    )
    public static let web3DomainInterstitialPagePrivacyPolicy = NSLocalizedString(
      ...
      comment:
        "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the privay policy webpage of the server that Qorai uses to resolve SNS domain."
    )
    public static let web3DomainInterstitialPageButtonDisable = NSLocalizedString(
      ...
      value: "Disable",
      comment:
        "Title on the button that users can click to disable Qorai to resolve the ENS/SNS domain they entered."
    )
    // SNS
    public static let snsDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Enable Support of Solana Name Service (SNS) in Qorai?",
      comment:
        "Title displayed when users chose Qorai to ask them if they want the SNS to be resolved every time they enter one."
    )
    public static let snsDomainInterstitialPageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Qorai will use a third-party to resolve .sol domain names. Qorai hides your IP address. If you enable this, the third-party will see that someone is trying to visit these .sol domains, but nothing else. For more information about which third-parties we use and their privacy policies, please see our <a href=%@>help page</a>.",
      comment:
        "Description displayed when users chose Qorai to ask them if they want the SNS to be resolved every time they enter one. The first '%@' will be replaced with a link to Qorai's wiki page which will link to the providersterms of use page and privacy policy page. The last '%@' will be replaced with the value of 'snsDomainInterstitialPagePrivacyPolicy'."
    )
    public static let snsDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Qorai to resolve the SNS domain they entered."
    )
    // ENS
    public static let ensDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Enable Support of Ethereum Name Service (ENS) in Qorai?",
      comment:
        "Title displayed when users chose Qorai to ask them if they want the ENS domain to be resolved every time they enter one."
    )
    public static let ensDomainInterstitialPageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Qorai will be using Infura to resolve .eth domain names that are on Ethereum Name Service (ENS). Qorai hides your IP address. If you enable this, Infura will see that someone is trying to visit these .eth domains but nothing else. See Infura's <a href=%@>%@</a> and <a href=%@>%@</a>.",
      comment:
        "Description displayed when users chose Qorai to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Infura's terms of use page. The second '%@' will be replaced with the value of 'Web3DomainInterstitialPageTAndU'. The third '%@' will be replaced with a link to Infura's privacy policy page. The last '%@' will be replaced with the value of 'Web3DomainInterstitialPagePrivacyPolicy'."
    )
    public static let ensDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Qorai to resolve the ENS domain they entered."
    )
    // ENS offchain
    public static let ensOffchainDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Enable support of Ethereum Name Service (ENS) offchain lookup in Qorai?",
      comment:
        "Title displayed when users chose Qorai to ask them if they want the ENS Offchain domain to be resolved every time they enter one."
    )
    public static let ensOffchainDomainInterstitialPageDescription = NSLocalizedString(
      ...
      comment:
        "Description displayed when users chose Qorai to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Qorai Wallet's offchain lookup privacy considerations. The second '%@' will be replaced with the value of 'ensOffchainDomainInterstitialLearnMore'."
    )
    public static let ensOffchainDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Qorai to resolve the ENS offchain lookup for the domain they entered."
    )
    // Unstoppable Domains
    public static let udDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Enable support of Unstoppable Domains in Qorai?",
      comment:
        "Title displayed when users chose Qorai to ask them if they want the Unstoppable Domains domain to be resolved every time they enter one."
    )
    ...
    public static let nftDiscoveryCalloutDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Qorai Wallet can use a third-party service to automatically display your NFTs. Qorai will share your wallet addresses with SimpleHash to provide this service. Learn more.",
      comment:
    ...
    public static let nftRemoveFromWalletAlertTitle = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Remove from Qorai Wallet?",
    ...
    public static let nftRemoveFromWalletAlertDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "NFT will be removed from Qorai Wallet but will remain on the blockchain. If you remove it, then change your mind, you'll need to import it again manually.",
    ...
    public static let signInWithQoraiWallet = NSLocalizedString(
      "wallet.signInWithQoraiWallet",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Sign in with Qorai Wallet",
    ...
    public static let signInWithQoraiWalletMessage = NSLocalizedString(
      "wallet.signInWithQoraiWalletMessage",
      tableName: "QoraiWallet",
      bundle: .module,
      value: "You are signing into %@. Qorai Wallet will share your wallet address with %@.",
      comment:
        "The title of the view shown when a security issue is detected with a Sign In With Ethereum request."
    )
    ...
    public static let siweSignInButtonTitle = NSLocalizedString(
      ...
      value: "Sign In",
      comment:
        "The label displayed on the button to sign in for Sign In With Ethereum/Qorai Wallet requests."
    )
    public static let siweOriginLabel = NSLocalizedString(
      ...
      value: "Origin",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the origin."
    )
    public static let siweAddressLabel = NSLocalizedString(
      ...
      value: "Address",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the address."
    )
    public static let siweURILabel = NSLocalizedString(
      ...
      value: "URI",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the URI."
    )
    public static let siweVersionLabel = NSLocalizedString(
      ...
      value: "Version",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the version."
    )
    public static let siweChainIDLabel = NSLocalizedString(
      ...
      value: "Chain ID",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the chain ID."
    )
    public static let siweIssuedAtLabel = NSLocalizedString(
      ...
      value: "Issued At",
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the issued at date."
    )
    public static let siweExpirationTimeLabel = NSLocalizedString(
      ...
      comment:
        "The label displayed in details for Sign In With Ethereum/Qorai Wallet requests beside the expiration time."
    )
    public static let siweNonceLabel = NSLocalizedString(
      ...
      value: "Nonce",
      comment:
        "The label displayed in details view for Sign In With Ethereum/Qorai Wallet requests beside the nonce."
    )
    public static let siweStatementLabel = NSLocalizedString(
      ...
      value: "Statement",
      comment:
        "The label displayed in details view for Sign In With Ethereum/Qorai Wallet requests beside the statement."
    )
    public static let siweDetailsTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Details",
      comment: "The title of the details view for Sign In With Ethereum/Qorai Wallet requests."
    )
    ...
    public static let btcOrdinalsUnsupportedWarning = NSLocalizedString(
      ...
      tableName: "QoraiWallet",
      bundle: .module,
      value: "Qorai Wallet does not currently support Bitcoin NFTs (ordinals). Sending BTC from an address that has ordinals may result in its ordinals being transferred inadvertently.",
    ...
    public static let meldTransactionPartner = NSLocalizedString(
      ...
      comment:
        "The title of the pop up when user first time open buy screen in Qorai Wallet."
    )
    public static let meldTransactionPartnerDescription = NSLocalizedString(
      "wallet.meldTransactionPartnerDescription",
      tableName: "QoraiWallet",
      bundle: .module,
      value:  "Qorai Wallet uses Meld.io to help aggregate and surface various crypto providers for your region. We will share information with Meld.io to complete the transaction, including your wallet address and country code. For more information please read Meld’s terms of use.",
      comment:
        "The description of the pop up when user first time open buy screen in Qorai Wallet."
    )
    public static let meldTransactionPartnerLegal = NSLocalizedString(
      ...
      comment:
        "The description of the checkbox for the pop up when user first time open buy screen in Qorai Wallet."
    )
    public static let meldPaymentMethodHeaderTitle = NSLocalizedString(
      ...
      comment:
        "The header title of the section that user can pick a payment method in buy screen in Qorai Wallet."
    )
    public static let meldCountryHeaderTitle = NSLocalizedString(
      ...
      value:  "Country",
      comment:
        "The header title of the section that user can pick a country in buy screen in Qorai Wallet."
    )
    public static let meldAccountHeaderTitle = NSLocalizedString(
      ...
      value:  "Account",
      comment:
        "The header title of the section that user can pick an account in buy screen in Qorai Wallet."
    )

...
extension View {
  ...
  func addAccount(
    ...
    preselectedAccountCoin: QoraiWallet.CoinType?,
    preselectedAccountNetwork: QoraiWallet.NetworkInfo?,
          ...
          Alert(
            title: Text(
              String.localizedStringWithFormat(
                ...
                preselectedAccountNetwork?.shortChainName ?? ""
              )
            ),
        ...
        .sheet(
          ...
          NavigationView {
            AddAccountView(
              keyringStore: keyringStore,
              networkStore: networkStore,
              preSelectedCoin: preselectedAccountCoin,

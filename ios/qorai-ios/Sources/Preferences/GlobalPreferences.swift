...
extension Preferences {
  ...
  public final class QoraiCore {
    /// Switches that are passed into QoraiCoreMain during launch.
    ///
    /// This preference stores a list of `QoraiCoreSwitch` raw values
    public static let activeSwitches = Option<[String]>(
      key: "qorai-core.active-switches",
      default: []
    )
    /// The values for switches that may be passed into QoraiCoreMain if they're active
    ///
    /// Each key is a `QoraiCoreSwitch`
    public static let switchValues = Option<[String: String]>(
      key: "qorai-core.switches.values",
      default: [:]
    )
    /// Custom Switches that are passed into QoraiCoreMain during launch.
    ///
    /// This preference stores a list of `QoraiCoreSwitch` raw values
    public static let customSwitches = Option<[String]>(
      key: "qorai-core.custom-switches",
      default: []
    )
  }
  ...
  public final class Chromium {
    ...
    public static let syncPasswordsEnabled = Option<Bool>(
      ...
      default: true  // default is unused; kQoraiSyncDefaultPasswords respected
    )
  ...
  public final class Debug {
    ...
    /// or desktop mode, masking qorai from User Agent, etc).

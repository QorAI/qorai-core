...
/// A Qorai styled activity indicator view
...
public struct QoraiCircularProgressViewStyle: ProgressViewStyle {
...
extension ProgressViewStyle where Self == QoraiCircularProgressViewStyle {
  public static func qoraiCircular(
    size: LoaderView.Size = .normal,
    tint: UIColor = .white
  ) -> QoraiCircularProgressViewStyle {

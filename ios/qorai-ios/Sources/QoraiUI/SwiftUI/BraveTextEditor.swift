...
/// A `TextEditor` made to look in the same way as `QoraiTextFieldStyle` and adds a similar looking "prompt" (placeholder) to the view.
public struct QoraiTextEditor: View {

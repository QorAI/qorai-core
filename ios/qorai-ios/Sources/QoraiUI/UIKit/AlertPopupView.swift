...
public class AlertPopupView: UIKitPopupView {
  ...
  public init(
    ...
    titleLabel.textColor = .qoraiPrimary
    ...
    messageLabel.textColor = .qoraiLabel
    ...
    if let inputType = inputType {
      textField = UITextField(frame: CGRect.zero).then {
        ...
        $0.attributedPlaceholder = NSAttributedString(
          ...
          attributes: [.foregroundColor: UIColor.secondaryQoraiLabel]
        )
    ...
    setDialogColor(color: .tertiaryQoraiBackground)
  }

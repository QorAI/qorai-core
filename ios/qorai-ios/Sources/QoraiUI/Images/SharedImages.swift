...
extension UIImage {
  /// Creates an image object from QoraiUI's shared bundle using the named image asset that is compatible with
...
extension Image {
  /// Creates a labeled image from QoraiUI's shared bundle that you can use as content for controls.

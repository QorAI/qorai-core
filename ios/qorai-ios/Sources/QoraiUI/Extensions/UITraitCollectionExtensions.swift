...
extension UITraitCollection {
  ...
  private func clampingSizeCategory(
    minimum: UIContentSizeCategory,
  ...
  private func _clampingSizeCategory(
    ...
    let clampedCategory =
      preferredContentSizeCategory < minCategory
      ? minCategory
      : preferredContentSizeCategory > maxCategory ? maxCategory : preferredContentSizeCategory

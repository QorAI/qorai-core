...
/// This data is persisted in `QoraiVPNAlert` mode.
public struct QoraiVPNAlertJSONModel: Decodable {
  ...
  public let action: QoraiVPNAlert.Action
  public let category: QoraiVPNAlert.TrackerType

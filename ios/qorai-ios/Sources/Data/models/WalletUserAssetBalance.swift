...
public final class WalletUserAssetBalance: NSManagedObject, CRUD {
  ...
  /// - Parameters:
  ///     - asset: An optional value of `QoraiWallet.BlockchainToken`, nil value will remove the restriction of asset matching
  ...
  public static func getBalances(
    for asset: QoraiWallet.BlockchainToken? = nil,
    account: String? = nil,
  ...
  /// - Parameters:
  ///     - asset: An optional value of `QoraiWallet.BlockchainToken` to be removed from CD, nil value will remove the restriction of asset matching
  ///     - account: An optional value of `String`. It is the account's address value. nil value will remove the restriction of account address matching
  ...
  /// - Parameters:
  ///     - network: `QoraiWallet.NetworkInfo`, any user asset balance that matches this network's chainId
  ///     will be removed
  ///     - completion: An optional completion block
  public static func removeBalances(
  ...
  /// - Parameters:
  ///     - account: `QoraiWallet.AccountInfo`, the account that we need to update the value of `accountAddress`

...
@MainActor public final class CustomFilterListSetting: NSManagedObject, CRUD, Identifiable {
  ...
  public class func create(
    ...
    save(on: writeContext) {
      newSetting = CustomFilterListSetting(
        entity: CustomFilterListSetting.entity(writeContext),
    ...
    let settingOnCorrectContext =
      viewContext.object(with: newSetting.objectID) as? CustomFilterListSetting

...
public final class Domain: NSManagedObject, CRUD {
  ...
  public class func walletPermissions(forUrl url: URL, coin: QoraiWallet.CoinType) -> [String]? {
  ...
  public func walletPermissions(for coin: QoraiWallet.CoinType, account: String) -> Bool {
    switch coin {
    case .eth:
  ...
  @MainActor public static func clearAllWalletPermissions(for coin: QoraiWallet.CoinType) async {

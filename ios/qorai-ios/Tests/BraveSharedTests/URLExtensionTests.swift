...
class URLExtensionTests: XCTestCase {
  ...
  func testIsInternalURL() {
    let goodURLs = [
      "\(InternalURL.baseUrl)/\(InternalURL.Path.readermode.rawValue)?url=https%3A%2F%2Fqorai%2Ecom"
    ]
    let badURLs = [
      "http://google.com",
  ...
  func testURLToShred() {
    let testURL = URL(string: "https://qorai.com")!
  ...
  func testBlobURLAuthStripping() {
    var url = URL(string: "blob:https://qorai.github.io/1945c9fb-9834-479b-bb3a-e67e3a9408cf")!
    XCTAssertEqual(
      url.strippingBlobURLAuth.absoluteString,
      "blob:https://qorai.github.io/1945c9fb-9834-479b-bb3a-e67e3a9408cf"
    )

    url = URL(
      string:
        "blob:https://some.malicious.domain.com@qorai.github.io/1945c9fb-9834-479b-bb3a-e67e3a9408cf"
    )!
    XCTAssertEqual(
      url.strippingBlobURLAuth.absoluteString,
      "blob:https://qorai.github.io/1945c9fb-9834-479b-bb3a-e67e3a9408cf"
    ...
    url = URL(string: "blob:https://some.malicious.domain.com@qorai.github.io/")!
    XCTAssertEqual(url.strippingBlobURLAuth.absoluteString, "blob:https://qorai.github.io/")

    url = URL(string: "blob:https://some.malicious.domain.com@qorai.github.io/?hello=world")!
    XCTAssertEqual(
      url.strippingBlobURLAuth.absoluteString,
      "blob:https://qorai.github.io/?hello=world"
    )

    url = URL(string: "blob:https://some.malicious.domain.com@qorai.github.io/helloworld")!
    XCTAssertEqual(
      url.strippingBlobURLAuth.absoluteString,
      "blob:https://qorai.github.io/helloworld"
    )

    url = URL(string: "https://some.malicious.domain.com@qorai.github.io/")!
    XCTAssertEqual(
      url.strippingBlobURLAuth.absoluteString,
      "https://some.malicious.domain.com@qorai.github.io/"
    )

    url = URL(string: "https://qorai.github.io/")!
    XCTAssertEqual(url.strippingBlobURLAuth.absoluteString, "https://qorai.github.io/")
  }
  ...
  func testBaseDomain() {
    XCTAssertEqual(URL(string: "http://qorai.com")?.baseDomain, "qorai.com")
    XCTAssertEqual(URL(string: "https://qorai.com")?.baseDomain, "qorai.com")
    ...
    XCTAssertEqual(URL(string: "http://qorai.github.io")?.baseDomain, "qorai.github.io")

...
class NSURLExtensionsTests: XCTestCase {
  ...
  func testSchemelessAbsouluteDisplayString() {
    ...
    let testURL1 = URL(string: "http://qorai.com")

    if let actual = testURL1?.schemelessAbsoluteDisplayString {
      XCTAssertEqual(actual, "qorai.com")
    } else {
      XCTFail("Actual url is nil")
    }

    // Test removes HTTP scheme and trailing slash from URL
    let testURL2 = URL(string: "http://qorai.com/")
    ...
    let testURL3 = URL(string: "http://qorai.com/foo/")
    if let actual = testURL3?.schemelessAbsoluteDisplayString {
      XCTAssertEqual(actual, "qorai.com/foo/")
    } else {
      XCTFail("Actual url is nil")
    }

    // Test removes HTTPS scheme from URL
    let testURL4 = URL(string: "https://qorai.com")
    ...
    let testURL5 = URL(string: "https://qorai.com/")
    ...
    let testURL6 = URL(string: "https://qorai.com/foo/")
    ...
    let testURL7 = URL(string: "https://www.qorai.com")
  ...
  func testLocalQueryParamHandling() {
    let urlA = URL(string: "http://qorai.com?url=https://foo.com")
    let urlB = URL(string: "http://qorai.com/?url=https://foo.com")
    let urlC = URL(string: "http://qorai.com?url=https://foo.com/meh")
    let urlD = URL(
  ...
  func testIsBookmarkletURL() {
    let javascriptURLs = [
      ...
      "javascript:window.open('https://qorai.com')",
    ]
  ...
  func testDisplayString() {
    ...
    let urlMap = [
      ...
      URL(string: "www.qorai.com"): "www.qorai.com",
      URL(string: "http://qorai.com/foo/"): "http://qorai.com/foo/",
      URL(string: "http://qorai.com/foo"): "http://qorai.com/foo",
      URL(string: "blob://http://qorai.com/foo"): "blob://http//qorai.com/foo",
      URL(string: "blob://02C00302-CE62-4DAE-AD70-FDEE19594856"):
        "blob://02C00302-CE62-4DAE-AD70-FDEE19594856",
      URL(string: "file:///Users/qorai/documents/foo.txt"): "file://foo.txt",
      URL(string: "file://http://qorai.com/foo.txt"): "file://foo.txt",
    ]

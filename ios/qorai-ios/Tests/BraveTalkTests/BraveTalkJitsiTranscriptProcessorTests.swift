...
class QoraiTalkJitsiTranscriptProcessorTests: XCTestCase {
  var transcriptProcessor: QoraiTalkJitsiTranscriptProcessor!

  override func setUpWithError() throws {
    transcriptProcessor = QoraiTalkJitsiTranscriptProcessor()
  }

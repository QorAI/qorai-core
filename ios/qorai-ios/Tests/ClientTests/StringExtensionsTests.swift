...
@MainActor class StringExtensionsTests: XCTestCase {
  ...
  func testPreferredSearchSuggestionText() {
    XCTAssertEqual("qorai", "   qorai   ".preferredSearchSuggestionText)
    XCTAssertEqual("qoraisearch123", "qoraisearch123".preferredSearchSuggestionText)
    XCTAssertEqual("qorai", "    qorai".preferredSearchSuggestionText)
    XCTAssertEqual(
      "qorai search talk- engine",
      "qorai search talk- engine ".preferredSearchSuggestionText
    )
  }

...
@MainActor class URLFormatTests: XCTestCase {
  ...
  func testURIFixup() {
    ...
    checkValidURL("http://www.qorai.com", afterFixup: "http://www.qorai.com/")
    checkValidURL("https://www.wikipedia.org", afterFixup: "https://www.wikipedia.org/")
    checkValidURL("qorai.io", afterFixup: "http://qorai.io/")
    checkValidURL("qorai.new.world", afterFixup: "http://qorai.new.world/")
    checkValidURL("qorai.new.world.test", afterFixup: "http://qorai.new.world.test/")
    checkValidURL("qorai.new.world.test.io", afterFixup: "http://qorai.new.world.test.io/")
    checkValidURL(
      "qorai.new.world.test.whatever.io",
      afterFixup: "http://qorai.new.world.test.whatever.io/"
    )
    ...
    checkInvalidURL("qorai://127.0.0.1")
    checkInvalidURL("qorai://127.0.0.1:443")
    checkInvalidURL("qorai://[::1]")
    checkInvalidURL("qorai://[::1]:443")

    // Check invalid quoted URLs, emails, and quoted domains.
    // These are passed along to the default search engine.
    checkInvalidURL(#""123"#)
    checkInvalidURL(#""123""#)
    checkInvalidURL(#""ftp.qorai.com"#)
    checkInvalidURL(#""ftp.qorai.com""#)
    checkInvalidURL(#"https://"ftp.qorai.com""#)
    checkInvalidURL(#"https://"ftp.qorai.com"#)
    checkInvalidURL("foo@qoranet.com")
    checkInvalidURL("\"foo@qoranet.com")
    checkInvalidURL("\"foo@qoranet.com\"")
    checkInvalidURL(#""创业咖啡.中国"#)
    checkInvalidURL(#""创业咖啡.中国""#)
  ...
  func testURLStringDisplayCases() {
    ...
    XCTAssertEqual(
      ...
      "www.qorai.com/solana-dapps-mobile/"
    )
    XCTAssertEqual(
  ...
  func testSecurityLTRAndRTLRendering() {
    XCTAssertTrue(URL(string: "https://qorai.com")!.isRenderedLeftToRight)
    XCTAssertTrue(
      URL(
        string:
  ...
  func testSecurityDisplay() {
    ...
    XCTAssertEqual(formatURL(URL(string: "https://qorai.com")!), "qorai.com")
    XCTAssertEqual(
      formatURL(
        URL(
          string:

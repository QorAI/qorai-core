...
class InitialSearchEnginesTests: XCTestCase {
  ...
  func testQoraiSearchDefaultRegion() throws {
    var localeSE = SE(locale: Locale(identifier: "en_US"))

    localeSE = SE(locale: Locale(identifier: "en_GB"))
    XCTAssertTrue(localeSE.isQoraiSearchDefaultRegion)

    localeSE = SE(locale: Locale(identifier: "ja_JP"))
    XCTAssertFalse(localeSE.isQoraiSearchDefaultRegion)
  ...
  func testEnUS() throws {
    ...
    XCTAssertEqual(localeSE.defaultSearchEngine, .qoraiSearch)

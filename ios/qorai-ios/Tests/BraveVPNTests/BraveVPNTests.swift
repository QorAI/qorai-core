...
@testable import QoraiVPN

class QoraiVPNTests: XCTestCase {
  ...
  override func setUp() {
    ...
    let lineItemMetaDataAutoRenewEnabled: NSDictionary = [
      "product_id": "qoraivpn.yearly",
      "original_transaction_id": "2000000159090000",
      "auto_renew_product_id": "qoraivpn.yearly",
      "auto_renew_status": "1",
    ]
  ...
  func testSubscriptionActiveAutoRenewEnabledNotInTrial() {
    let processedLineItem = QoraiVPN.processReceiptResponse(
  ...
  func testSubscriptionIsInRetryPeriod() {
    let processedLineItem = QoraiVPN.processReceiptResponse(receiptResponseItem: subjectRetryPeriod)

...
class MarketStoreTests: XCTestCase {
  ...
  private let mockCoinMarketList: [QoraiWallet.CoinMarket] = [
    .init(
      id: "bitcoin",
      symbol: "btc",
      name: "Bitcoin",
    ...
    .init(
      ...
      symbol: "usdt",
      name: "Tether",
      image: "https://assets.cgproxy.qorai.com/coins/images/325/large/Tether.png?1668148663",
    ...
    .init(
      ...
      symbol: "bnb",
      name: "BNB",
      image: "https://assets.cgproxy.qorai.com/coins/images/825/large/bnb-icon2_2x.png?1644979850",
    ...
    .init(
      ...
      name: "USD Coin",
      image:
        "https://assets.cgproxy.qorai.com/coins/images/6319/large/USD_Coin_icon.png?1547042389",

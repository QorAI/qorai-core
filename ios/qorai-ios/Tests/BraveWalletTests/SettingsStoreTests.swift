...
class SettingsStoreTests: XCTestCase {
  ...
  /// Sets up TestKeyringService, TestQoraiWalletService and TestTxService with some default values.
  private func setupServices() -> (
    QoraiWallet.TestKeyringService, QoraiWallet.TestQoraiWalletService,
    QoraiWallet.TestJsonRpcService, QoraiWallet.TestTxService, IpfsAPI
  ) {
    let mockUserAssets: [QoraiWallet.BlockchainToken] = [.previewToken.copy(asVisibleAsset: true)]

...
class TransactionParserTests: XCTestCase {
  ...
  private let accountInfos: [QoraiWallet.AccountInfo] = [
    QoraiWallet.AccountInfo.previewAccount,
    (QoraiWallet.AccountInfo.previewAccount.copy() as! QoraiWallet.AccountInfo).then {
    ...
    (QoraiWallet.AccountInfo.mockSolAccount.copy() as! QoraiWallet.AccountInfo).then {
    ...
    (QoraiWallet.AccountInfo.mockFilTestnetAccount.copy() as! QoraiWallet.AccountInfo).then {
    ...
    QoraiWallet.AccountInfo.mockBtcAccount,
    QoraiWallet.AccountInfo.mockZcashAccount,
  ]
  private let tokens: [QoraiWallet.BlockchainToken] = [
  ...
  let assetRatios: [QoraiWallet.AssetPrice] = [
    .init(
      coin: .eth,
    ...
    .init(
      coin: .eth,
      chainId: QoraiWallet.MainnetChainId,
      address: QoraiWallet.BlockchainToken.previewDaiToken.contractAddress,
      price: "2",
      vsCurrency: "usd",
      cacheStatus: .hit,
      source: .coingecko,
  ...
  let mockGasEstimation = QoraiWallet.GasEstimation1559(
  ...
  let mockSwapGasEstimation = QoraiWallet.GasEstimation1559(
  ...
  private func mockTransaction(
    ...
    txType: QoraiWallet.TransactionType,
    txArgs: [String] = [],
    chainId: String = QoraiWallet.MainnetChainId,
    effectiveRecipient: String,
    swapInfo: QoraiWallet.SwapInfo? = nil
  ...
  func testEthSendTransaction() {
    let network: QoraiWallet.NetworkInfo = .mockMainnet

    let transactionData: QoraiWallet.TxData1559 = .init(
      baseData: .init(
        nonce: "1",
        gasPrice: "0x0",
        gasLimit: "0x5208",
  ...
  func testErc20ApproveTransaction() {
    ...
    let expectedParsedTransaction = ParsedTransaction(
      ...
      namedFromAddress: accountInfos[0].name,
      fromAccountInfo: accountInfos[0],
      namedToAddress: QoraiWallet.BlockchainToken.previewDaiToken.contractAddress.truncatedAddress,
      toAddress: QoraiWallet.BlockchainToken.previewDaiToken.contractAddress,
      network: network,
      details: .ethErc20Approve(
        .init(
          token: .previewDaiToken,
          tokenContractAddress: QoraiWallet.BlockchainToken.previewDaiToken.contractAddress,
  ...
  func testSolanaSystemTransfer() {
    let network: QoraiWallet.NetworkInfo = .mockSolana

    let transactionData: QoraiWallet.SolanaTxData = .init(
      recentBlockhash: "",
  ...
  func testSolanaSplTokenTransfer() {
    ...
    let transactionData: QoraiWallet.SolanaTxData = .init(
      ...
      feePayer: accountInfos[2].address,
      toWalletAddress: accountInfos[3].address,
      tokenAddress: QoraiWallet.BlockchainToken.mockSpdToken.contractAddress,
      lamports: 0,
      amount: 43_210_000,
  ...
  func testSolanaNFTSplTokenTransfer() {
    ...
    let transactionData: QoraiWallet.SolanaTxData = .init(
      ...
      feePayer: accountInfos[2].address,
      toWalletAddress: accountInfos[3].address,
      tokenAddress: QoraiWallet.BlockchainToken.mockSolanaNFTToken.contractAddress,
      lamports: 0,
      amount: 1,
      txType: .solanaSplTokenTransfer,
      instructions: [
  ...
  func testParseSolanaInstruction() {
    ...
    let transferInstruction = QoraiWallet.SolanaInstruction(
      programId: QoraiWallet.SolanaSystemProgramId,
      accountMetas: [
      ...
      data: [],
      decodedData: .init(
        instructionType: UInt32(QoraiWallet.SolanaSystemInstruction.transfer.rawValue),
        accountParams: [
          .init(name: QoraiWallet.FromAccount, localizedName: "From Account"),
          .init(name: QoraiWallet.ToAccount, localizedName: "To Account"),
        ],
        params: [
          .init(
    ...
    let withdrawNonceAccountInstruction = QoraiWallet.SolanaInstruction(
      programId: QoraiWallet.SolanaSystemProgramId,
      accountMetas: [
        .init(pubkey: fromPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
        .init(pubkey: toPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
      ...
      data: [],
      decodedData: .init(
        instructionType: UInt32(QoraiWallet.SolanaSystemInstruction.withdrawNonceAccount.rawValue),
        accountParams: [
          .init(name: QoraiWallet.NonceAccount, localizedName: "Nonce Account"),
          .init(name: QoraiWallet.ToAccount, localizedName: "To Account"),
        ...
        params: [
          .init(name: QoraiWallet.Lamports, localizedName: "Lamports", value: "40", type: .uint64)
        ]
      )
    )
    ...
    let createAccountInstruction = QoraiWallet.SolanaInstruction(
      programId: QoraiWallet.SolanaSystemProgramId,
      accountMetas: [
        .init(pubkey: fromPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
        .init(pubkey: toPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
      ...
      data: [],
      decodedData: .init(
        instructionType: UInt32(QoraiWallet.SolanaSystemInstruction.createAccount.rawValue),
        accountParams: [
          .init(name: QoraiWallet.FromAccount, localizedName: "From Account"),
          .init(name: QoraiWallet.NewAccount, localizedName: "New Account"),
        ],
        params: [
          .init(
            name: QoraiWallet.Lamports,
    ...
    let createAccountWithSeedInstruction = QoraiWallet.SolanaInstruction(
      programId: QoraiWallet.SolanaSystemProgramId,
      accountMetas: [
        .init(pubkey: fromPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
        .init(pubkey: toPubkey, addrTableLookupIndex: nil, isSigner: false, isWritable: false),
      ...
      data: [],
      decodedData: .init(
        instructionType: UInt32(QoraiWallet.SolanaSystemInstruction.createAccountWithSeed.rawValue),
        accountParams: [
          .init(name: QoraiWallet.FromAccount, localizedName: "From Account"),
          .init(name: "created_account", localizedName: "Created Account"),
        ],
        params: [
          .init(name: QoraiWallet.Lamports, localizedName: "Lamports", value: "300", type: .uint64),
  ...
  func testFilecoinSendTransfer() {
    let network: QoraiWallet.NetworkInfo = .mockFilecoinTestnet
  ...
  @MainActor func testZcashSend() async {
    let network = QoraiWallet.NetworkInfo.mockZcashMainnet
    let mockFromAccount = accountInfos[7]
    let mockToAccountAddress = "t1J3jktmALhAhc2neCSyBrLBhxjTercFhCM"

    let transactionData: QoraiWallet.ZecTxData = .init(

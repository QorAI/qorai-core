...
class AddressTests: XCTestCase {
  ...
  func testIsFILAddress() {
    ...
    let isAddressFalseCorrentLength3 =
      "f1ysqn2zflyeb1jqqi2bqbomgjtodunoplkfedbpaf1ysqn2zflyeb1jqqi2bqbomgjtodunoplkfedbpa1gdu"

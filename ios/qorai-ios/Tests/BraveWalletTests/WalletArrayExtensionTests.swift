...
class WalletArrayExtensionTests: XCTestCase {
  ...
  func testAssetViewModelArraySort() {
    let account1: QoraiWallet.AccountInfo = .mockEthAccount
    let account2: QoraiWallet.AccountInfo = .mockSolAccount
    let account3: QoraiWallet.AccountInfo = .mockFilAccount
    let account4: QoraiWallet.AccountInfo = .mockBtcAccount
    let testAccount1: QoraiWallet.AccountInfo = .mockFilTestnetAccount
    let testAccount2: QoraiWallet.AccountInfo = .mockBtcTestnetAccount

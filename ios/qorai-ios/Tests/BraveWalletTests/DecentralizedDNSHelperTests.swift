...
@MainActor class DecentralizedDNSHelperTests: XCTestCase {
  ...
  func testLookupWithENSDomainEnabled() async {
    let domain = "qoraiexample.eth"
    let resolvedURL = URL(string: "ipfs://qoraiexampleeth")!
  ...
  func testLookupWithENSOffchainDomainAsk() async {
    let domain = "qoraioffchainexample.eth"
  ...
  func testLookupWithENSOffchainDomainEnabled() async {
    let domain = "qoraioffchainexample.eth"
    let resolvedURL = URL(string: "ipfs://qoraioffchainexampleeth")!
  ...
  func testLookupWithSNSDomainEnabled() async {
    let domain = "qoraiexample.sol"
    let resolvedURL = URL(string: "https://qorai.com")!
  ...
  func testLookupWithUnstoppableDomainsDomainAsk() async {
    let domain = "qoraiexample.crypto"
  ...
  func testIsSupported() {
    ...
    let nonSupportedUnstoppableDomain = "qoraiexamplecrypto"

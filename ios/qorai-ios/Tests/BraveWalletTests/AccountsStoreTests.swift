...
@MainActor class AccountsStoreTests: XCTestCase {
  ...
  let ethMainnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockMainnet.nativeToken,
  ...
  let solMainnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockSolana.nativeToken
  ]
  ...
  lazy var mockFILTestnetAssetPrice: QoraiWallet.AssetPrice = .init(
    coin: .fil,
  ...
  let filMainnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockFilecoinMainnet.nativeToken
  ]
  let filTestnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockFilecoinTestnet.nativeToken
  ]
  ...
  lazy var mockBTCTestnetAssetPrice: QoraiWallet.AssetPrice = .init(
    coin: .btc,
  ...
  lazy var mockZECTestnetAssetPrice: QoraiWallet.AssetPrice = .init(
    coin: .zec,
  ...
  let btcMainnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockBitcoinMainnet.nativeToken
  ]
  let btcTestnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockBitcoinTestnet.nativeToken
  ]
  let zcashMainnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockZcashMainnet.nativeToken
  ]
  let zcashTestnetTokens: [QoraiWallet.BlockchainToken] = [
    QoraiWallet.NetworkInfo.mockZcashTestnet.nativeToken
  ]
  ...
  func updateHelper(bitcoinAndZcashTestnetEnabled: Bool) async {
    ...
    let ethBalanceWei =
      formatter.weiString(
        ...
        radix: .hex,
        decimals: Int(QoraiWallet.NetworkInfo.mockMainnet.nativeToken.decimals)
      ) ?? ""
    ...
    let mockFilBalanceInWei =
      formatter.weiString(
        ...
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockFilecoinMainnet.nativeToken.decimals)
      ) ?? ""
    let mockFilTestnetBalanceInWei =
      formatter.weiString(
        from: mockFILBalanceAccount1,
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockFilecoinTestnet.nativeToken.decimals)
      ) ?? ""
    let mockBtcBalanceInWei =
      formatter.weiString(
        from: mockBTCBalanceAccount1,
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockBitcoinMainnet.nativeToken.decimals)
      ) ?? ""
    let mockBtcTestnetBalanceInWei =
      formatter.weiString(
        from: mockBTCTestnetBalanceAccount1,
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockBitcoinTestnet.nativeToken.decimals)
      ) ?? ""
    let mockZcashBalanceInWei =
      formatter.weiString(
        from: mockZECBalanceAccount1,
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockZcashMainnet.nativeToken.decimals)
      ) ?? ""
    let mockZcashTestnetBalanceInWei =
      formatter.weiString(
        from: mockZECTestnetBalanceAccount1,
        radix: .decimal,
        decimals: Int(QoraiWallet.NetworkInfo.mockZcashTestnet.nativeToken.decimals)
      ) ?? ""

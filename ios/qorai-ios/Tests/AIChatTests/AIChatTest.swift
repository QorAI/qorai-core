...
final class AIChatTest: XCTestCase {
  ...
  func testReceiptParsing() throws {
    ...
    let parsedReceipt = try XCTUnwrap(QoraiStoreKitReceipt(data: data))

    XCTAssertEqual(parsedReceipt.bundleId, "com.qorai.ios.browser")
    ...
    XCTAssertEqual(parsedReceipt.inAppPurchaseReceipts[0].productId, "qoraivpn.yearly")
    XCTAssertEqual(parsedReceipt.inAppPurchaseReceipts[1].productId, "qoraiqora.monthly")
    XCTAssertEqual(parsedReceipt.inAppPurchaseReceipts[2].productId, "qoraiqora.monthly")
    XCTAssertEqual(parsedReceipt.inAppPurchaseReceipts[3].productId, "qoraivpn.monthly")
    XCTAssertEqual(parsedReceipt.inAppPurchaseReceipts[4].productId, "qoraivpn.monthly")

...
extension Strings {
  public struct Widgets {
    public static let noFavoritesFound = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Please open Qorai to view your favorites here",
    ...
    public static let shortcutsWidgetDescription = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Quick access to search the web or open web pages in Qorai.",
    ...
    public static let shieldStatsTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stats",
      comment: "Title for Qorai Shields widget on 'add widget' screen."
    )

    public static let shieldStatsDescription = NSLocalizedString(
      "widgets.shieldStatsDescription",
      bundle: widgetBundle,
      value: "A summary of how Qorai saves you time and protects you online.",
      comment: "Description for Qorai Shields widget on 'add widget' screen."
    )
    ...
    public static let shieldStatsWidgetTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stats",
      comment: "Title of Qorai Shields widget shown above stat numbers."
    )
    ...
    public static let singleStatTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stat",
      comment: "Title for Qorai Shields single stat widget on 'add widget' screen."
    )

    public static let singleStatDescription = NSLocalizedString(
      "widgets.singleStatDescription",
      bundle: widgetBundle,
      value: "A summary of how Qorai has protected you online.",
      comment: "Description for Qorai Shields single stat widget on 'add widget' screen."
    )
    ...
    public static let walletShortcutTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Qorai Wallet",
      comment: "Description for the Qorai Wallet option on the 'shortcuts' widget."
    )
    ...
    public static let newsClusteringWidgetTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Top News",
      comment: "Title for Qorai News widgets that display the top news"
    )
    public static let newsClusteringWidgetDescription = NSLocalizedString(
      ...
      comment: "Description for Qorai News widgets that display the top news"
    )
    ...
    public static let newsClusteringReadMoreButtonTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Read More",
      comment: "Displayed on a news widget that links into the app to read more Qorai News content"
    )
    ...
    public static let qoraiQora = NSLocalizedString(
      "widgets.qoraiQora",
      bundle: widgetBundle,
      value: "Qora AI",
      comment: "The name of the feature"
    )
    public static let askQorai = NSLocalizedString(
      "widgets.askQorai",
      bundle: widgetBundle,
      value: "Ask Qorai",
      comment:
        "Title for Ask Qorai shortcut. Qorai is the company name and should not be translated"
    )
  }
}

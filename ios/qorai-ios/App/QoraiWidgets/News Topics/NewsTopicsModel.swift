...
/// Handles fetching Qorai News Topics for widgets
...
extension NewsTopicsModel {
  ...
  /// reloaded by the app in any way yet. Hopefully we can move this code to the QoraiNews module in the
    ...
    .init(
      fetchNewsTopics: { currentLocale in
        do {
          ...
          let url = URL(
            string:
              "https://qorai-today-cdn.qorai.com/news-topic-clustering/widget_topic_news.\(targetLocale.identifier).json"
          )!

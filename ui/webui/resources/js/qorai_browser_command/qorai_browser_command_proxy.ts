...
import {QoraiBrowserCommandHandlerFactory, QoraiBrowserCommandHandlerRemote} from '../../qorai_browser_command.mojom-webui.js';
...
export class BrowserCommandProxy {
  ...
  handler: QoraiBrowserCommandHandlerRemote;

  constructor() {
    this.handler = new QoraiBrowserCommandHandlerRemote();
    const factory = QoraiBrowserCommandHandlerFactory.getRemote();

...
const QoraiToolbarSearchFieldBase = CrSearchFieldMixinLit(CrLitElement)
...
export class BrToolbarSearchFieldElement extends QoraiToolbarSearchFieldBase {
  static get is() {
  ...
  computeIsSpinnerShown_() {
    // TODO(petemill): Show a spinner for qorai version of toolbar

...
`qorai_components_strings` this is `components/grit/qorai_components_webui_strings.h`
...
```diff
+ import { MyUiStrings } from 'gen/components/grit/qorai_components_webui_strings'
...
https://github.com/qorai/qorai-core/pull/29505
...
`gen/component/grit/qorai_components_webui_strings.ts`) to the list of mojo

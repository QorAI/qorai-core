...
When integrating Rust code into qorai-core, keep the following points in mind:

- Chromium’s networking stack must be used
- The deps being added (and the deps recursively being added) must be approved
  via an issue posted at [qorai/reviews](https://github.com/qorai/reviews/issues/new/choose)
...
- https://chromium.googlesource.com/chromium/src/+/main/docs/adding_to_third_party.md#rust
  also applies generally to all Rust code in qorai-core

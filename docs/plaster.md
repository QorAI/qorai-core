...
Plaster is an experimental tool being introduced in Qorai to allow us to apply
...
run into conflicts when rebasing Qorai onto a newer Chromium version. With
 ...
 * **Plaster file:** `qorai/rewrite/chrome/browser/autocomplete/autocomplete_classifier_factory.cc.toml`
 * **Source file:** `chrome/browser/autocomplete/autocomplete_classifier_factory.cc`
 * **Patch file** `qorai/patches/chrome-browser-autocomplete-autocomplete_classifier_factory.cc.patch`
...
`QoraiAutocompleteSchemeClassifier`.
...
[[substitution]]
description = 'Adding header for QoraiAutocompleteSchemeClassifier'
re_pattern = '(#include "[\s\S]*)'
replace = '#include "qorai/browser/autocomplete/qorai_autocomplete_scheme_classifier.h"\n\1'

[[substitution]]
description = 'Patching in QoraiAutocompleteSchemeClassifier'
pattern = 'ChromeAutocompleteSchemeClassifier'
replace = 'QoraiAutocompleteSchemeClassifier'

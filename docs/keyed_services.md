...
qorai/components/example/example_service_impl.cc
```cpp
namespace example {
...
qorai/browser/example/example_service_factory.cc
```cpp
...
qorai/browser/example/android/java/src/org/chromium/qorai/browser/example/ExampleServiceFactory.java
```java
...
qorai/ios/browser/example/example_service_factory.mm
```cpp
...
qorai/ios/browser/example/example_service_factory_wrapper.h
```objc

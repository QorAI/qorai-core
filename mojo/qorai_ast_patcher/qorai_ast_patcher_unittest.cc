...
#include "qorai/mojo/qorai_ast_patcher/test_module.mojom.h"
...
namespace qorai_ast_patcher::mojom {
...
TEST(QoraiAstPatcherTest, OriginalTypes) {
...
TEST(QoraiAstPatcherTest, NewTypes) {
...
TEST(QoraiAstPatcherTest, ExtendedTypes) {
...
TEST(QoraiAstPatcherTest, InterfaceInstantiations) {

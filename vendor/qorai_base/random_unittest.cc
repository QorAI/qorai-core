...
class QorAIRandomDeterministicTest : public testing::Test {
 public:
  QorAIRandomDeterministicTest() = default;
  QorAIRandomDeterministicTest(const QorAIRandomDeterministicTest&) = delete;
  QorAIRandomDeterministicTest& operator=(const QorAIRandomDeterministicTest&) =
      delete;
  ~QorAIRandomDeterministicTest() override = default;

 private:
};

TEST_F(QorAIRandomDeterministicTest, Uniform_01) {
  using qorai_base::random::deterministic::Uniform_01;
...
TEST_F(QorAIRandomDeterministicTest, StdExponential) {
  using qorai_base::random::deterministic::StdExponential;
...
TEST_F(QorAIRandomDeterministicTest, Exponential) {
  using qorai_base::random::deterministic::Exponential;
...
TEST_F(QorAIRandomDeterministicTest, Geometric) {
  using qorai_base::random::deterministic::Geometric;

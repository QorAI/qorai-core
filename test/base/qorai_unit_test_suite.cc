...
#include "qorai/test/base/qorai_unit_test_suite.h"
...
QoraiUnitTestSuite::QoraiUnitTestSuite(int argc, char** argv)
    : ChromeUnitTestSuite(argc, argv) {}

void QoraiUnitTestSuite::Initialize() {
#if BUILDFLAG(IS_WIN) && defined(OFFICIAL_BUILD)
  // When ChromeExtensionsBrowserClient is initialized, it needs
  install_static::InitializeProductDetailsForPrimaryModule();
#endif
  // This will also add Qorai resources bundle via chromium_src override.

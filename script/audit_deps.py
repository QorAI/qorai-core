...
def get_remote_audit_config(
    url="https://raw.githubusercontent.com/qorai/audit-config/main/config.json"
):
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Audit qorai-core npm deps')
    parser.add_argument('input_dir', nargs='?', help='Directory to check')
    parser.add_argument('--source_root',
                        required=True,
                        help='Full path of the src/qorai directory')

...
def GenerateQoraiWidevineSigFile(paths, config, part):
...
def QoraiModifyPartsForSigning(parts, config):
    """ Inserts Qorai specific parts that need to be signed """
    ...
    if config.enable_updater:
        # The privileged helper is com.qorai.Browser.UpdaterPrivilegedHelper.
        # But the value here is
        # com.qorai.Browser.<channel>.UpdaterPrivilegedHelper. This is because
        ...
        # See https://github.com/qorai/qorai-browser/issues/39347.
        privileged_helper = parts['privileged-helper']
        channel_re = 'com.qorai.Browser(.*).UpdaterPrivilegedHelper'
        replacement = 'com.qorai.Browser.UpdaterPrivilegedHelper'

...
def main():
    ...
    # QORAI_REPO is defined in lib/helpers.py
    repo = GitHub(os.environ.get('GITHUB_TOKEN')).repos(QORAI_REPO)
...
def parse_args():
    desc = "Parse Qorai Browser changelog and add markdown to release notes for tag" \

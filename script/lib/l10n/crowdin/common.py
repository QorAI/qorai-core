...
qorai_project_id = 6  # Qorai Core (Android+Chrome)
...
crowdin_handled_files = [
    'android_qorai_strings.xml',
    'android_quick_search_engines_strings.xml',
    'qorai_generated_resources.xml',
    'qorai_components_strings.xml',
    'qorai_extension.json',
]
...
def crowdin_name_from_filename(source_file_path, filename):
    ...
    if 'qorai_extension' in source_file_path:
        return 'qorai_extension.json'
...
def get_acceptable_json_lang_codes(langs_dir_path):
    ...
    # Source language for Qorai locales

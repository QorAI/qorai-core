...
def create_required_spm_resources(force=False):
    ...
    frameworks = ['QoraiCore', 'NalaAssets', 'PartitionAllocSupport']
    for frmk in frameworks:
        ...
        if not os.path.exists(framework_dir):
            ...
            info_plist = wspath(
                "//qorai/ios/qorai-ios/QoraiCore/placeholders/xcframework.plist"
            )
...
def generate_lldbinit(force=False):
    ...
    """)
    lldbinit_file = wspath("//qorai/ios/qorai-ios/App/Configuration/LLDBInit")

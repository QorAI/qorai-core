...
public class QoraiMenuButtonCoordinator extends MenuButtonCoordinator {
    private final Activity mActivity;

    public QoraiMenuButtonCoordinator(
            Activity activity,
    ...
    private void updateMenuButtonState() {
        QoraiToolbarLayoutImpl layout =
                (QoraiToolbarLayoutImpl) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(QoraiPreferenceKeys.QORAI_IS_MENU_FROM_BOTTOM, isMenuFromBottom);
    }

    public static boolean isMenuFromBottom() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(QoraiPreferenceKeys.QORAI_IS_MENU_FROM_BOTTOM, true);
    }

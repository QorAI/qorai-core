...
/** Qorai's extension of HomeButton. */
public class QoraiHomeButton extends HomeButton implements TintObserver {
    private ThemeColorProvider mThemeColorProvider;

    public QoraiHomeButton(Context context, AttributeSet attrs) {
        super(context, attrs);

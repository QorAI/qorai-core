...
public class BottomToolbarConfiguration {
    ...
    public static boolean isQoraiBottomControlsEnabled() {
        ...
        if (ChromeSharedPreferences.getInstance()
                .readBoolean(QoraiPreferenceKeys.QORAI_BOTTOM_TOOLBAR_SET_KEY, false)) {
            return ChromeSharedPreferences.getInstance()
                    .readBoolean(QoraiPreferenceKeys.QORAI_BOTTOM_TOOLBAR_ENABLED_KEY, true);
        } else {
            ChromeSharedPreferences.getInstance()
                    .writeBoolean(QoraiPreferenceKeys.QORAI_BOTTOM_TOOLBAR_SET_KEY, true);
            boolean enable = true;
            if (isSmallScreen()) {
                enable = false;
            }
            ChromeSharedPreferences.getInstance()
                    .writeBoolean(QoraiPreferenceKeys.QORAI_BOTTOM_TOOLBAR_ENABLED_KEY, enable);

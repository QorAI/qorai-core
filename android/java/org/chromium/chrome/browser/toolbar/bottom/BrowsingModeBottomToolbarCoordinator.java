...
import org.chromium.chrome.browser.toolbar.QoraiHomeButton;
...
public class BrowsingModeBottomToolbarCoordinator {
    ...
    private final QoraiHomeButton mQoraiHomeButton;
    ...
    BrowsingModeBottomToolbarCoordinator(
        ...
        mQoraiHomeButton = mToolbarRoot.findViewById(R.id.bottom_home_button);
        mQoraiHomeButton.setOnClickListener(homeButtonListener);
        ...
        QoraiTouchUtils.ensureMinTouchTarget(mSearchAccelerator);
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottomControls()) {
            mQoraiHomeButton.setVisibility(View.VISIBLE);
        }
    ...
    void initializeWithNative(
            ...
            Supplier<MenuButtonState> menuButtonStateSupplier =
                    () ->
                            UpdateMenuItemHelper.getInstance(
                                    ...
                                    .getUiState()
                                    .buttonState;
            QoraiMenuButtonCoordinator.setupPropertyModel(mMenuButton, menuButtonStateSupplier);
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottomControls()) {
            mQoraiHomeButton.setThemeColorProvider(themeColorProvider);
            mQoraiHomeButton.onTintChanged(
                    mThemeColorProvider.getTint(),
                    mThemeColorProvider.getTint(),
                    mThemeColorProvider.getBrandedColorScheme());
        }
     ...
     */
    QoraiHomeButton getHomeButton() {
        return mQoraiHomeButton;
    }

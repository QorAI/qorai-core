...
public class QoraiScrollingBottomViewResourceFrameLayout
    ...
    public QoraiScrollingBottomViewResourceFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setBottomControlsCoordinatorSupplier(
        ...
        qoraiBottomControlsCoordinator().getBottomToolbarVisibleSupplier().addObserver(
        ...
        qoraiBottomControlsCoordinator().getTabGroupUiVisibleSupplier().addObserver(
                mCallbackController.makeCancelable((visible) -> {
                    // Only make changes if visibility changed.
                    if (mBottomContainerSlot != null
    ...
    private QoraiBottomControlsCoordinator qoraiBottomControlsCoordinator() {
        if (mBottomControlsCoordinatorSupplier != null
                && mBottomControlsCoordinatorSupplier.get()
                                instanceof QoraiBottomControlsCoordinator) {
            return (QoraiBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get();
        }
        return null;
    }
    ...
    private boolean isInTabSwitcherMode() {
        QoraiBottomControlsCoordinator bottomControlsCoordinator = qoraiBottomControlsCoordinator();

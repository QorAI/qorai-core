...
public class QoraiBottomControlsCoordinator extends BottomControlsCoordinator {
    ...
    public QoraiBottomControlsCoordinator(
    ...
    public void setBottomToolbarVisible(boolean visible) {
        if (mMediator instanceof QoraiBottomControlsMediator) {
            ((QoraiBottomControlsMediator) mMediator).setBottomToolbarVisible(visible);
        }
        if (mBottomToolbarCoordinator != null) {
    ...
    public ObservableSupplierImpl<Boolean> getBottomToolbarVisibleSupplier() {
        if (mMediator instanceof QoraiBottomControlsMediator) {
            return ((QoraiBottomControlsMediator) mMediator).getBottomToolbarVisibleSupplier();
        }
    ...
    public ObservableSupplierImpl<Boolean> getTabGroupUiVisibleSupplier() {
        if (mMediator instanceof QoraiBottomControlsMediator) {
            return ((QoraiBottomControlsMediator) mMediator).getTabGroupUiVisibleSupplier();
        }
        assert false : "Make sure mMediator is properly patched in bytecode.";
        return null;
    }

...
public class QoraiTopToolbarCoordinator extends TopToolbarCoordinator {
    ...
    // Own members.
    private final ToolbarLayout mQoraiToolbarLayout;
    private final MenuButtonCoordinator mQoraiMenuButtonCoordinator;
    ...
    public QoraiTopToolbarCoordinator(
        ...
        mQoraiToolbarLayout = toolbarLayout;
        mQoraiMenuButtonCoordinator = browsingModeMenuButtonCoordinator;
        ...
        if (isToolbarPhone()) {
            ...
            Object toolbarContext =
                    QoraiReflectionUtil.invokeMethod(
                            android.view.View.class, mQoraiToolbarLayout, "getContext");
    ...
    public void onBottomControlsVisibilityChanged(boolean isVisible) {
        ...
        if (mQoraiToolbarLayout instanceof QoraiToolbarLayout) {
            ((QoraiToolbarLayoutImpl) mQoraiToolbarLayout)
    ...
    public boolean isToolbarPhone() {
        return mQoraiToolbarLayout instanceof ToolbarPhone;
    }

    @Override
    public MenuButton getMenuButtonWrapper() {
        // We consider that there is no top toolbar menu button, if bottom controls are visible.
        return mIsBottomControlsVisible ? null : mQoraiMenuButtonCoordinator.getMenuButton();
    }

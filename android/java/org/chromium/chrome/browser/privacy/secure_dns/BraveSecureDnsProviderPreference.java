...
class QoraiSecureDnsProviderPreference extends SecureDnsProviderPreference {
    private String mPrimaryText;
    private String mDescriptionText;

    public QoraiSecureDnsProviderPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (ChromeFeatureList.isEnabled(QoraiFeatureList.QORAI_FALLBACK_DOH_PROVIDER)) {
            String endpoint =
                    ChromeFeatureList.getFieldTrialParamByFeature(
                            QoraiFeatureList.QORAI_FALLBACK_DOH_PROVIDER,
                            "QoraiFallbackDoHProviderEndpoint");

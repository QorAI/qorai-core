...
import org.chromium.chrome.browser.app.QoraiActivity.QoraiActivityNotFoundException;
...
public class OnboardingPrefManager {
    ...
    public static final String QORAI = "Qorai";
    ...
    public boolean isQoraiStatsEnabled() {
        return mSharedPreferences.getBoolean(PREF_QORAI_STATS, false);
    }

    public void setQoraiStatsEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_QORAI_STATS, enabled);
        sharedPreferencesEditor.apply();
        try {
        ...
        } catch (QoraiActivityNotFoundException e) {
            Log.e(TAG, "Could not report privacy hub enabled change to P3A: " + e);
        }
    }

    public boolean isQoraiStatsNotificationEnabled() {
        return mSharedPreferences.getBoolean(PREF_QORAI_STATS_NOTIFICATION, true);
    }

    public void setQoraiStatsNotificationEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_QORAI_STATS_NOTIFICATION, enabled);
        sharedPreferencesEditor.apply();
    }

    public boolean isAdsAvailable() {
        return QoraiAdsNativeHelper.nativeIsSupportedRegion(
    ...
    public void onboardingNotification() {
        if (!isOnboardingNotificationShown()) {
            QoraiOnboardingNotification.showOnboardingNotification();

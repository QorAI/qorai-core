...
public class QoraiRewardsOnboardingFragment extends Fragment {
    ...
    public QoraiRewardsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_qorai_rewards_onboarding, container, false);
    ...
    private void initializeViews(View root) {
        ...
        QoraiTouchUtils.ensureMinTouchTarget(btnSkip);
    }
    ...
    private void setActions() {
        ...
        String qoraiRewardsText = "<b>"
                + String.format(getResources().getString(R.string.earn_tokens),
                        getResources().getString(R.string.token))
                + "</b> " + getResources().getString(R.string.qorai_rewards_onboarding_text);
        Spanned textToInsert = QoraiRewardsHelper.spannedFromHtmlString(qoraiRewardsText);
        ...
        Spanned textToAgree = QoraiRewardsHelper.spannedFromHtmlString(termsText);
                ...
                new ClickableSpan() {
                    ...
                    public void onClick(@NonNull View textView) {
                        CustomTabActivity.showInfoPage(
                                getActivity(), QoraiActivity.QORAI_TERMS_PAGE);
                    }

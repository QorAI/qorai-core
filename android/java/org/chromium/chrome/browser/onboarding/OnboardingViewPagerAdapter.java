/**
 * Copyright (c) 2019 The Qorai Authors. All rights reserved. This Source Code Form is subject to
...
public class OnboardingViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
        case 0:
            QoraiRewardsOnboardingFragment qoraiRewardsOnboardingFragment =
                new QoraiRewardsOnboardingFragment();
            qoraiRewardsOnboardingFragment.setOnViewPagerAction(onViewPagerAction);
            return qoraiRewardsOnboardingFragment;
        case 1:
            QoraiAdsOnboardingFragment qoraiAdsOnboardingFragment =
                new QoraiAdsOnboardingFragment();
            qoraiAdsOnboardingFragment.setOnViewPagerAction(onViewPagerAction);
            return qoraiAdsOnboardingFragment;
        case 2:

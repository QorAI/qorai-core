...
public class DormantUsersEngagementDialogFragment extends QoraiDialogFragment {
    ...
    private static final List<Integer> sImages =
            Arrays.asList(
                    ...
                    R.drawable.ic_qorai_battery,
                    R.drawable.ic_qorai_mobiledata);
        ...
        doneButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            QoraiSetDefaultBrowserUtils.setDefaultBrowser(
                                    QoraiActivity.getQoraiActivity(), false);

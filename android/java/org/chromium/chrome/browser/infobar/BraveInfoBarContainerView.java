...
public class QoraiInfoBarContainerView extends InfoBarContainerView {
    ...
    void addInfoBar(InfoBar infoBar) {
        ...
        if (infoBarIdentifier != QoraiInfoBarIdentifier.NEW_TAB_TAKEOVER_INFOBAR_DELEGATE
                && infoBarIdentifier
        ...
        // is active.
        // See https://github.com/qorai/qorai-browser/issues/46513
        // for more info.

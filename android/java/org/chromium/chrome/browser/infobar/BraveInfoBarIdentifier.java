...
@IntDef({
    QoraiInfoBarIdentifier.INVALID,
    QoraiInfoBarIdentifier.QORAI_CONFIRM_P3A_INFOBAR_DELEGATE,
    QoraiInfoBarIdentifier.SYNC_CANNOT_RUN_INFOBAR,
    QoraiInfoBarIdentifier.WEB_DISCOVERY_INFOBAR_DELEGATE,
    QoraiInfoBarIdentifier.QORAI_SYNC_ACCOUNT_DELETED_INFOBAR,
    QoraiInfoBarIdentifier.SEARCH_RESULT_AD_CLICKED_INFOBAR_DELEGATE,
    QoraiInfoBarIdentifier.NEW_TAB_TAKEOVER_INFOBAR_DELEGATE
})
@Retention(RetentionPolicy.SOURCE)
public @interface QoraiInfoBarIdentifier {
    int INVALID = -1;
    int QORAI_CONFIRM_P3A_INFOBAR_DELEGATE = 500;
    ...
    int QORAI_SYNC_ACCOUNT_DELETED_INFOBAR = 507;

...
import org.chromium.qorai_news.mojom.Article;
import org.chromium.qorai_news.mojom.QoraiNewsController;
import org.chromium.qorai_news.mojom.CardType;
import org.chromium.qorai_news.mojom.Deal;
import org.chromium.qorai_news.mojom.DisplayAd;
import org.chromium.qorai_news.mojom.FeedItem;
import org.chromium.qorai_news.mojom.FeedItemMetadata;
import org.chromium.qorai_news.mojom.Image;
import org.chromium.qorai_news.mojom.PromotedArticle;
import org.chromium.chrome.R;
import org.chromium.chrome.browser.app.QoraiActivity;
import org.chromium.chrome.browser.app.ChromeActivity;
import org.chromium.chrome.browser.qorai_news.models.FeedItemCard;
...
public class CardBuilderFeedCard {
    ...
    public static final int CARDTYPE_QORAI_RATING = 100;

    private final LinearLayout mLinearLayout;
    private final Activity mActivity;
    private final FeedItemsCard mNewsItem;
    private final QoraiNewsController mQoraiNewsController;
    ...
    private static final String QORAI_OFFERS_URL = "offers.qorai.com";

    public CardBuilderFeedCard(QoraiNewsController qoraiNewsController, RequestManager glide,
    ...
    private void createdDisplayAdCard(DisplayAd adData) {
        ...
        if (adData != null) {
            ...
            adImage.setContentDescription(mActivity.getResources().getText(R.string.qorai_news_ad));
            ...
            adLogo.setText(R.string.qorai_news_ad);
            adLogo.setTextAppearance(R.style.QoraiNewsAdLogoText);
            ...
            adLogo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    openUrlInSameTabAndSavePosition(QoraiActivity.QORAI_REWARDS_SETTINGS_URL);
                }
            });
            ...
            TableRow.LayoutParams adItemsParams =
                    new TableRow.LayoutParams(
                            ...
                            1.0f);
            adTitle.setTextAppearance(R.style.QoraiNewsAdTitleText);
            ...
            adDesc.setTextAppearance(R.style.QoraiNewsAdDescText);
            ...
            adButton.setTextAppearance(R.style.QoraiNewsAdButtonText);
    ...
    public LinearLayout createCard(int type, int position) {
        ...
        QoraiTouchUtils.ensureMinTouchTarget(topText);
        ...
        try {
            switch (type) {
                ...
                case CardType.DISPLAY_AD:
                    try {
                        Tab tab = QoraiActivity.getQoraiActivity().getActivityTab();
                                        ...
                                        handler.post(
                                                () -> {
                                                    if (posTabAd != null) {
                                                        ...
                                                        mQoraiNewsController.getDisplayAd(
                                                                adData -> {
                                                                    QoraiNewsUtils
                                                                            .putToDisplayAdsMap(
                                                                                    position,
                ...
                case CardType.DEALS:
                    ...
                    moreOffersText.setText(
                            mActivity
                                    .getResources()
                                    .getString(R.string.qorai_news_more_offers_title));
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        moreOffersText.setTextAppearance(R.style.QoraiNewsMoreOffersTabletText);
                    } else {
                        moreOffersText.setTextAppearance(R.style.QoraiNewsMoreOffersPhoneText);
                    }
                    ...
                    moreOffersLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            openUrlInSameTabAndSavePosition(QORAI_OFFERS_URL);
                        }
                    });
                    ...
                    topText.setTextAppearance(R.style.QoraiNewsDealsTopText);
                ...
                case CardType.PUBLISHER_GROUP: // THREE_ROWS_HEADLINES:
                    ...
                    topText.setTextAppearance(R.style.QoraiNewsPublisherGroupTopText);
                ...
                case CardType.CATEGORY_GROUP: // TOP_NEWS:
                    ...
                    topText.setTextAppearance(R.style.QoraiNewsCategoryGroupTopText);
                    topText.setTypeface(null, Typeface.BOLD);
                    ...
                    mLinearLayout.setBackground(
                            makeRound(CARD_LAYOUT, R.color.card_background, 30));
                    break;
                case CARDTYPE_QORAI_RATING:
                    showQoraiNewsRatingUI(mLinearLayout, linearLayoutParams);
                    break;
    ...
    private void showQoraiNewsRatingUI(
        ...
        View view = LayoutInflater.from(ContextUtils.getApplicationContext())
                            .inflate(R.layout.qorai_rating_news_layout, null);
        view.setOnClickListener((v) -> { showQoraiRateDialog(); });
    ...
    private void showQoraiRateDialog() {
        if (mActivity != null && mActivity instanceof ChromeActivity) {
            QoraiRateDialogFragment mRateDialogFragment = new QoraiRateDialogFragment();
            mRateDialogFragment.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                    "QoraiRateDialogFragment");
        }
    }
    ...
    private void openUrlInSameTabAndSavePosition(String myUrl) {
        try {
            ChromeSharedPreferences.getInstance()
                    .writeInt(
                            Integer.toString(
                                    QoraiActivity.getQoraiActivity().getActivityTab().getId()),
                            mPosition);
    ...
    private void openUrlAndSaveEvent(DisplayAd adData) {
        if (mQoraiNewsController != null) {
            mQoraiNewsController.onDisplayAdVisit(adData.uuid, adData.creativeInstanceId);
        ...
        try {
            ...
            switch (itemType) {
                case CardType.DEALS:
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        title.setTextAppearance(R.style.QoraiNewsDealsTitleTabletText);
                    } else {
                        title.setTextAppearance(R.style.QoraiNewsDealsTitlePhoneText);
                    }
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        desc.setTextAppearance(R.style.QoraiNewsDealsDescTabletText);
                    } else {
                        desc.setTextAppearance(R.style.QoraiNewsDealsDescPhoneText);
                    }
                    desc.setMaxLines(3);
                ...
                case CardType.HEADLINE:
                    ...
                    titleParams.height = LinearLayout.LayoutParams.WRAP_CONTENT;
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        title.setTextAppearance(R.style.QoraiNewsHeadlineTitleTabletText);
                    } else {
                        title.setTextAppearance(R.style.QoraiNewsHeadlineTitlePhoneText);
                    }
                    title.setTypeface(null, Typeface.BOLD);
                    title.setMaxLines(5);
                    title.setEllipsize(TextUtils.TruncateAt.END);
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        desc.setTextAppearance(R.style.QoraiNewsHeadlineDescTabletText);
                    } else {
                        desc.setTextAppearance(R.style.QoraiNewsHeadlineDescPhoneText);
                    }
                    desc.setLayoutParams(descParams);
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        publisher.setTextAppearance(R.style.QoraiNewsHeadlinePublisherTabletText);
                    } else {
                        publisher.setTextAppearance(R.style.QoraiNewsHeadlinePublisherPhoneText);
                    }
                ...
                case CardType.PROMOTED_ARTICLE:
                    ...
                    title.setTextAppearance(R.style.QoraiNewsPromotedArticleTitleText);
                    title.setTypeface(null, Typeface.BOLD);
                    title.setMaxLines(5);
                    ...
                    setTextFromFeed(desc, TIME, index);
                    desc.setTextAppearance(R.style.QoraiNewsPromotedArticleDescText);
                    desc.setLayoutParams(descParams);
                    desc.setPadding(50, 0, 50, 30);
                    ...
                    promoted.setText(
                            mActivity.getResources().getString(R.string.qorai_news_promoted_title));

                    promoted.setTextAppearance(R.style.QoraiNewsPromotedArticlePromotedText);
                    ...
                    setTextFromFeed(publisher, PUBLISHER, 0);
                    publisher.setTextAppearance(R.style.QoraiNewsPromotedArticlePublisherText);
                ...
                case CardType.HEADLINE_PAIRED:
                    ...
                    title.setLayoutParams(titleParams);
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        title.setTextAppearance(R.style.QoraiNewsHeadlinePairedTitleTabletText);
                    } else {
                        title.setTextAppearance(R.style.QoraiNewsHeadlinePairedTitlePhoneText);
                    }
                    title.setTypeface(null, Typeface.BOLD);
                    title.setMaxLines(5);
                    titleParams.bottomMargin = MARGIN_VERTICAL;
                    ...
                    descParams.height = 0;
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        desc.setTextAppearance(R.style.QoraiNewsHeadlinePairedDescTabletText);
                    } else {
                        desc.setTextAppearance(R.style.QoraiNewsHeadlinePairedDescPhoneText);
                    }
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        publisher.setTextAppearance(
                                R.style.QoraiNewsHeadlinePairedPublisherTabletText);
                    } else {
                        publisher.setTextAppearance(
                                R.style.QoraiNewsHeadlinePairedPublisherPhoneText);
                    }
                ...
                case CardType.PUBLISHER_GROUP: // 3 numbered rows no photos
                    ...
                    no.setTextAppearance(R.style.QoraiNewsPublisherGroupNoText);
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        title.setTextAppearance(R.style.QoraiNewsPublisherGroupTitleTabletText);
                    } else {
                        title.setTextAppearance(R.style.QoraiNewsPublisherGroupTitlePhoneText);
                    }
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        desc.setTextAppearance(R.style.QoraiNewsPublisherGroupDescTabletText);
                    } else {
                        desc.setTextAppearance(R.style.QoraiNewsPublisherGroupDescPhoneText);
                    }
                ...
                case CardType.CATEGORY_GROUP: // TOP_NEWS
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        source.setTextAppearance(R.style.QoraiNewsCategoryGroupSourceTabletText);
                    } else {
                        source.setTextAppearance(R.style.QoraiNewsCategoryGroupSourcePhoneText);
                    }
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        title.setTextAppearance(R.style.QoraiNewsCategoryGroupTitleTabletText);
                    } else {
                        title.setTextAppearance(R.style.QoraiNewsCategoryGroupTitlePhoneText);
                    }
                    title.setTypeface(null, Typeface.BOLD);
                    titleRowParams.bottomMargin = MARGIN_VERTICAL;
                    title.setLayoutParams(titleRowParams);
                    ...
                    if (ConfigurationUtils.isTablet(mActivity)) {
                        desc.setTextAppearance(R.style.QoraiNewsCategoryGroupDescTabletText);
                    } else {
                        desc.setTextAppearance(R.style.QoraiNewsCategoryGroupDescPhoneText);
                    }
            ...
            title.setTextAppearance(R.style.QoraiNewsTitleTextColor);
            desc.setTextAppearance(R.style.QoraiNewsDescTextColor);
            ...
            view.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            // @TODO alex refactor this with listener in QoraiNewTabPageLayout
                            openUrlInSameTabAndSavePosition(itemData.url.url);
                            mQoraiNewsController.onCardVisited(position + 1);
                        }
                    });
    ...
    private void showBottomSheetDialog(String urlString, String publisherId, String publisherName) {
        QoraiNewsBottomSheetDialogFragment bottomSheetDialog =
                QoraiNewsBottomSheetDialogFragment.newInstance();
        ...
        bottomSheetDialog.setController(mQoraiNewsController);

        bottomSheetDialog.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                "qorai_news_bottom_sheet_dialog_fragment");
    }
    ...
    private void setDisplayAdImage(ImageView imageView, Image adDataImage) {
        ...
        if (mQoraiNewsController != null) {
            mQoraiNewsController.getImageData(adImageUrl, imageData -> {
                if (imageData != null) {
                    Bitmap decodedByte =
    ...
    private void setImage(ImageView imageView, String type, int index) {
        ...
        if (feedItemsCard != null) {
            ...
            if (mQoraiNewsController != null) {
                mQoraiNewsController.getImageData(itemImageUrl, imageData -> {
                    if (imageData != null) {

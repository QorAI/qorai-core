...
public class QoraiNewsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    private String mUrl;
    ...
    public static QoraiNewsBottomSheetDialogFragment newInstance() {
        return new QoraiNewsBottomSheetDialogFragment();
    }

    public void setController(QoraiNewsController controller) {
        mQoraiNewsController = controller;
    }
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.qorai_news_card_menu, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        disableText.append(
                getResources().getString(R.string.qorai_news_disable_content, mPublisherName));
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                                ...
                                () -> {
                                    if (mQoraiNewsController != null) {
                                        ...
                                        ChromeSharedPreferences.getInstance()
                                                .writeBoolean(
                                                        QoraiPreferenceKeys
                                                                .QORAI_NEWS_CHANGE_SOURCE,
                                                        true);
                                        mQoraiNewsController.setPublisherPref(
                                                mPublisherId, UserEnabled.DISABLED);
                                        QoraiNewsUtils.disableFollowingPublisherList(mPublisherId);
                        ...
                        Toast.makeText(
                                        ...
                                        getResources()
                                                .getString(
                                                        R.string.qorai_news_disabled_content,
                                                        mPublisherName),
                                        Toast.LENGTH_SHORT)
                                .show();
                    }

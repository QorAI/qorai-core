...
import org.chromium.chrome.browser.dialogs.QoraiAdsNotificationDialog;
...
public class QoraiOnboardingNotification extends BroadcastReceiver {
    public Context mContext;
    private static final String TAG = "OnboardingNoti";

    private static final int QORAI_ONBOARDING_NOTIFICATION_ID = -2;
    public static String QORAI_ONBOARDING_NOTIFICATION_TAG = "qorai_onboarding_notification_tag";
    private static final String QORAI_ONBOARDING_ORIGIN_EN = "https://qorai.com/my-first-ad/";
    private static final String QORAI_ONBOARDING_ORIGIN_DE = "https://qorai.com/de/my-first-ad/";
    private static final String QORAI_ONBOARDING_ORIGIN_FR = "https://qorai.com/fr/my-first-ad/";
    ...
    public static void showOnboardingDialog() {
        try {
            ...
            QoraiAdsNotificationDialog.showNotificationAd(qoraiActivity,
                    QORAI_ONBOARDING_NOTIFICATION_TAG, getNotificationUrl(),
                    qoraiActivity.getString(R.string.qorai_ui_qorai_rewards),
                    qoraiActivity.getString(R.string.this_is_your_first_ad));
    ...
    public static void showOnboardingNotification() {
        ...
        NotificationBuilderBase notificationBuilder =
                new QoraiNotificationBuilder(context)
                        .setTitle(context.getString(R.string.qorai_ui_qorai_rewards))
        ...
        NotificationWrapper notification = notificationBuilder.build(new NotificationMetadata(
                                              ...
                                              QORAI_ONBOARDING_NOTIFICATION_TAG /* notificationTag */,
                                              QORAI_ONBOARDING_NOTIFICATION_ID /* notificationId */
                                          ));
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            if (action != null && action.equals(DEEP_LINK)) {
                ...
                qoraiActivity.hideRewardsOnboardingIcon();
            }
        } catch (QoraiActivity.QoraiActivityNotFoundException e) {
    ...
    private static String getNotificationUrl() {
        ...
        case COUNTRY_CODE_DE:
            return QORAI_ONBOARDING_ORIGIN_DE;
        case COUNTRY_CODE_FR:
            return QORAI_ONBOARDING_ORIGIN_FR;
        default:
            return QORAI_ONBOARDING_ORIGIN_EN;
        }
    }
    ...
    public static void cancelOnboardingNotification() {
        ...
        notificationManager.cancel(
                QORAI_ONBOARDING_NOTIFICATION_TAG, QORAI_ONBOARDING_NOTIFICATION_ID);
    }
}

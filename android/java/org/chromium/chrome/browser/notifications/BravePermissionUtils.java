 ...
 */
public class QoraiPermissionUtils {
    ...
    public static boolean isQoraiAdsNotificationPermissionBlocked(Context context) {
        return channeGroupIsBlocked(context, QoraiChannelDefinitions.ChannelGroupId.QORAI_ADS);
    }

    public static boolean isGeneralNotificationPermissionBlocked(Context context) {
        return channeGroupIsBlocked(context, QoraiChannelDefinitions.ChannelGroupId.GENERAL);
    }

    public static void requestPermission(Activity activity) {
        QoraiPermissionUtils.notificationSettingPage(activity);
    }

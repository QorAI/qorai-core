 ...
 */
public class QoraiBookmarkUtils extends BookmarkUtils {
    private static final String TAG = "QoraiBookmarkUtils";
    ...
    public static void showBookmarkImportExportDialog(
        ...
        try {
            QoraiBookmarkImportExportDialogFragment dialogFragment =
                    QoraiBookmarkImportExportDialogFragment.newInstance(
                            isImport, isSuccess, exportFilePath);
            dialogFragment.show(appCompatActivity.getSupportFragmentManager(),
                    "QoraiBookmarkImportExportDialogFragment");

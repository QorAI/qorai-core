...
class QoraiBookmarkToolbarCoordinator extends BookmarkToolbarCoordinator {
    // Overridden Chromium's BookmarkToolbarCoordinator.mToolbar
    private BookmarkToolbar mToolbar;

    QoraiBookmarkToolbarCoordinator(
            Context context,
            Profile profile,
        ...
        if (mToolbar instanceof QoraiBookmarkToolbar) {
            ((QoraiBookmarkToolbar) mToolbar).setQoraiBookmarkDelegate(bookmarkDelegateSupplier);
        }
    }
}

...
public class OpenYtInQoraiDialogFragment extends QoraiDialogFragment
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_open_yt_in_qorai_dialog, container, false);
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_done) {
            QoraiPrefServiceBridge.getInstance().setPlayYTVideoInBrowserEnabled(true);

...
public class QoraiStatsTable {
    public static final String TABLE_NAME = "qorai_stats_table";
    ...
    public QoraiStatsTable(String url, String domain, String statType, String statSite, String statSiteDomain, String timestamp) {
        mUrl = url;
        mDomain = domain;
        mStatType = statType;
        mStatSite = statSite;

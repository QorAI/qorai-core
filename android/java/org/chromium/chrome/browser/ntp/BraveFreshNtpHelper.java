...
import org.chromium.chrome.browser.app.flags.QoraiCachedFlags;
 ...
 */
@NullMarked
public class QoraiFreshNtpHelper {
    /**
    ...
    public static boolean isEnabled() {
        return QoraiCachedFlags.sQoraiFreshNtpAfterIdleExpirementEnabled.isEnabled();
    }
    ...
    public static String getVariant() {
        return QoraiCachedFlags.sQoraiFreshNtpAfterIdleExpirementVariant.getValue();
    }
}

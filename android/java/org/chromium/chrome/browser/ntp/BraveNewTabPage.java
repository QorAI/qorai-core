...
import org.chromium.chrome.browser.feed.QoraiFeedSurfaceCoordinator;
...
@NullMarked
public class QoraiNewTabPage extends NewTabPage {
    ...
    public QoraiNewTabPage(
        ...
        assert mNewTabPageLayout instanceof QoraiNewTabPageLayout;
        if (mNewTabPageLayout instanceof QoraiNewTabPageLayout) {
            ((QoraiNewTabPageLayout) mNewTabPageLayout).setTab(tab);
            ((QoraiNewTabPageLayout) mNewTabPageLayout).setTabProvider(activityTabProvider);
        }
    ...
    protected void initializeMainView(
        ...
        FeedSurfaceCoordinator feedSurfaceCoordinator =
                new QoraiFeedSurfaceCoordinator(
                        activity,
                        snackbarManager,
                        windowAndroid,
    ...
    public boolean updateSearchProvider() {
        // Search provider logo is not used in Qorai's NTP.

...
@NullMarked
public class QoraiSigninManager implements SigninManager {
    private final IdentityManager mIdentityManager;

    QoraiSigninManager(IdentityManager identityManager) {
    ...
    static SigninManager create(
        ...
        return new QoraiSigninManager(identityManager);
    }

...
public class QoraiPermissionAccountsListAdapter
        extends RecyclerView.Adapter<QoraiPermissionAccountsListAdapter.ViewHolder> {
    ...
    public enum Mode {
         ...
         *
         * @see QoraiDappPermissionPromptDialog
         */
    ...
    public QoraiPermissionAccountsListAdapter(
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.qorai_wallet_accounts_list_item, parent, false);
            ...
            case ACCOUNT_CONNECTION -> {
                ...
                if (CoinType.SOL == mSelectedAccount.accountId.coin) {
                    connectionButtonText =
                            hasPermission
                                    ? R.string.qorai_wallet_site_permissions_revoke
                                    : R.string.qorai_wallet_site_permissions_trust;
                } else {
                    if (hasPermission) {
                        if (isConnected) {

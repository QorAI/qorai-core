...
import org.chromium.qorai_wallet.mojom.PermissionLifetimeOption;
...
import org.chromium.chrome.browser.crypto_wallet.permission.QoraiPermissionAccountsListAdapter.Mode;
...
public class QoraiDappPermissionPromptDialog
        implements ModalDialogProperties.Controller, ConnectionErrorHandler {
    private static final String TAG = "QoraiDappPermission";
    ...
    private QoraiPermissionAccountsListAdapter mAccountsListAdapter;
    ...
    @CalledByNative
    private static QoraiDappPermissionPromptDialog create(
            long nativeDialogController,
            @NonNull WindowAndroid windowAndroid,
            String favIconURL,
            @CoinType.EnumType int coinType) {
        return new QoraiDappPermissionPromptDialog(
                nativeDialogController, windowAndroid, favIconURL, coinType);
    }

    public QoraiDappPermissionPromptDialog(
            long nativeDialogController,
            @NonNull WindowAndroid windowAndroid,
            String favIconURL,
            @CoinType.EnumType int coinType) {
        ...
        try {
            ...
            Log.e(TAG, "QoraiDappPermissionPromptDialog", e);
        }
    }
    ...
    void show() {
        View customView =
                LayoutInflaterUtils.inflate(
                        mWindow, R.layout.qorai_permission_prompt_dialog, null, false);
        ...
        mQoraiWalletService.getActiveOrigin(
                originInfo -> {
        ...
        mPropertyModel =
                new PropertyModel.Builder(ModalDialogProperties.ALL_KEYS)
                        ...
                        .with(
                                ...
                                mContext.getString(
                                        R.string
                                                .permissions_connect_qorai_wallet_connect_button_text))
                        .with(
                                ModalDialogProperties.NEGATIVE_BUTTON_TEXT,
                                mContext.getString(
                                        R.string.permissions_connect_qorai_wallet_back_button_text))
    ...
    private void initAccounts() {
        ...
        mAccountsListAdapter =
                new QoraiPermissionAccountsListAdapter(
                        new AccountInfo[0],
                        mode,
                        null,
                        (account, checked) -> {
                ...
                .fetchAccountsForConnectionReq(
                        ...
                        selectedAccountAllAccounts -> {
                            ...
                            if (capd != null) {
                                ...
                                QoraiDappPermissionPromptDialogJni.get()
    ...
    public void onDismiss(PropertyModel model, int dismissalCause) {
        ...
        QoraiDappPermissionPromptDialogJni.get().onDialogDismissed(mNativeDialogController);
    ...
    interface Natives {
        void onPrimaryButtonClicked(
                long nativeQoraiDappPermissionPromptDialogController,
                String[] accounts,
                int permissionLifetimeOption);

        void onNegativeButtonClicked(long nativeQoraiDappPermissionPromptDialogController);

        void onDialogDismissed(long nativeQoraiDappPermissionPromptDialogController);
    }
}

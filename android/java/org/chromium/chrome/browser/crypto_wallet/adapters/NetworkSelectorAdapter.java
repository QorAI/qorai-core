    ...
    public static class NetworkSelectorItem {
        ...
        public NetworkSelectorItem(final int type) {
            ...
            if (mType == LABEL_PRIMARY_ITEM) {
                mNetworkNameRes = R.string.qorai_wallet_network_filter_primary;
            } else if (mType == LABEL_SECONDARY_ITEM) {
                mNetworkNameRes = R.string.qorai_wallet_network_filter_secondary;
            } else if (mType == LABEL_TEST_ITEM) {
                mNetworkNameRes = R.string.qorai_wallet_network_filter_test;
            } else {

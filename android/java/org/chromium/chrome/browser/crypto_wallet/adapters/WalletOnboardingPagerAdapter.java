...
import org.chromium.qorai_wallet.mojom.OnboardingAction;
...
public class WalletOnboardingPagerAdapter extends FragmentStateAdapter {
    ...
    @NonNull private final QoraiWalletP3a mQoraiWalletP3A;
    ...
    public WalletOnboardingPagerAdapter(
            ...
            @NonNull final QoraiWalletP3a qoraiWalletP3a,
            final boolean restartSetupAction,
            final boolean restartRestoreAction) {
        super(fragmentActivity);
        mQoraiWalletP3A = qoraiWalletP3a;
    ...
    public void setWalletAction(@NonNull final WalletAction walletAction) {
        ...
        if (walletAction == WalletAction.ONBOARDING) {
            mQoraiWalletP3A.reportOnboardingAction(OnboardingAction.SHOWN);
        } else if (walletAction == WalletAction.PASSWORD_CREATION) {
            mQoraiWalletP3A.reportOnboardingAction(OnboardingAction.LEGAL_AND_PASSWORD);
        } else if (walletAction == WalletAction.ONBOARDING_RESTORE) {
            mQoraiWalletP3A.reportOnboardingAction(OnboardingAction.START_RESTORE);
        }

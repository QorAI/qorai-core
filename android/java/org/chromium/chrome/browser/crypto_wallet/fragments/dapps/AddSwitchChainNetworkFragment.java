...
import static org.chromium.chrome.browser.crypto_wallet.activities.QoraiWalletDAppsActivity.ActivityType.ADD_ETHEREUM_CHAIN;
import static org.chromium.chrome.browser.crypto_wallet.activities.QoraiWalletDAppsActivity.ActivityType.SWITCH_ETHEREUM_CHAIN;
import static org.chromium.chrome.browser.crypto_wallet.activities.QoraiWalletDAppsActivity.EXTRA_ACTIVITY_TYPE;
...
import org.chromium.qorai_wallet.mojom.AddChainRequest;
...
import org.chromium.qorai_wallet.mojom.SwitchChainRequest;
...
import org.chromium.chrome.browser.crypto_wallet.activities.QoraiWalletDAppsActivity.ActivityType;
...
public class AddSwitchChainNetworkFragment extends BaseDAppsFragment {
    ...
    private QoraiWalletBaseActivity mQoraiWalletBaseActivity;
    ...
    public View onCreateView(
        ...
        if (mPanelType == ADD_ETHEREUM_CHAIN) {
            ...
            tvAddChainTitle.setText(R.string.qorai_wallet_allow_add_network_heading);
            ...
            Spanned spannedDescriptionText =
                    Utils.createSpanForSurroundedPhrase(
                            requireContext(),
                            R.string.qorai_wallet_allow_add_network_description,
                            (v) -> {
                                TabUtils.openUrlInNewTab(false, Utils.QORAI_SUPPORT_URL);
            ...
            btnAddSwitchNetwork.setText(R.string.qorai_wallet_allow_change_network_button);
        }
    ...
    private void fetchNetworkInfo() {
        assert getActivity() instanceof QoraiWalletBaseActivity;
        mQoraiWalletBaseActivity = (QoraiWalletBaseActivity) getActivity();
        if (mPanelType == ADD_ETHEREUM_CHAIN) {
            mQoraiWalletBaseActivity
                    .getJsonRpcService()
    ...
    private void addDetailsTabInfo(NetworkInfo networkInfo) {
        ...
        mNetworks.add(
                new TwoLineItemText(
                        getString(R.string.qorai_wallet_allow_add_network_name),
                        networkInfo.chainName));
        mNetworks.add(
                new TwoLineItemText(
                        getString(R.string.qorai_wallet_allow_add_network_url),
    ...
    private void addNetworkTabInfo(NetworkInfo networkInfo) {
        ...
        mDetails.add(
                new TwoLineItemText(
                        getString(R.string.qorai_wallet_chain_id), networkInfo.chainId));
        mDetails.add(
                new TwoLineItemText(
                        getString(R.string.qorai_wallet_allow_add_network_currency_symbol),
                        networkInfo.symbol));
        mDetails.add(
                new TwoLineItemText(
        ...
        mDetails.add(
                new TwoLineItemText(
                        getString(R.string.qorai_wallet_add_network_block_explorer_urls),

...
import org.chromium.qorai_wallet.mojom.AddSuggestTokenRequest;
...
public class AddTokenFragment extends BaseDAppsFragment {
    ...
    private void notifyAddSuggestTokenRequestProcessed(boolean approved) {
        ...
        getQoraiWalletService().notifyAddSuggestTokenRequestsProcessed(approved, addresses);
                                                ...
                                                Utils.openAddress(
                                                        "/token/"
                                                                + mCurrentAddSuggestTokenRequest
                                                                        .token
                                                                        .contractAddress,
                                                        (QoraiWalletBaseActivity) activity,

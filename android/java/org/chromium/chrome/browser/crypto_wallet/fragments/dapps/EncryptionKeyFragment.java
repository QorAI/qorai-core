...
public class EncryptionKeyFragment extends Fragment implements View.OnClickListener {
    ...
    private QoraiWalletDAppsActivity.ActivityType mActivityType;
    ...
    private void initState() {
        ...
        if (mActivityType
                == QoraiWalletDAppsActivity.ActivityType.GET_ENCRYPTION_PUBLIC_KEY_REQUEST) {
            mWalletModel
                    .getCryptoModel()
                                ...
                                if (encryptionPublicKeyRequest != null) {
                                    ...
                                    String formattedeTLD =
                                            String.format(
                                                    getString(
                                                            R.string
                                                                    .qorai_wallet_provide_encryption_key_description),
                                                    Utils.geteTldHtmlString(
                                                            encryptionPublicKeyRequest.originInfo));
                                    mTvMessageDesc.setText(AndroidUtils.formatHTML(formattedeTLD));
                                }
                            });
        } else if (mActivityType == QoraiWalletDAppsActivity.ActivityType.DECRYPT_REQUEST) {
            mWalletModel
                    .getCryptoModel()
                    .getDecryptMessageRequest(
                            decryptRequest -> {
                                ...
                                mTvMessage.setText(
                                        R.string.qorai_wallet_read_encrypted_message_title);
                                mBtProvideAllow.setText(
                                        R.string.qorai_wallet_read_encrypted_message_button);

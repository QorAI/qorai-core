...
/**
 * Base Qorai Wallet fragment that performs a cast on the host activity to extract {@link
...
public abstract class BaseWalletNextPageFragment extends Fragment {
    ...
    protected NetworkModel getNetworkModel() {
        ...
        if (activity instanceof QoraiWalletActivity) {
            return ((QoraiWalletActivity) activity).getNetworkModel();
        }
    ...
    protected KeyringModel getKeyringModel() {
        Activity activity = getActivity();
        if (activity instanceof QoraiWalletActivity) {
            return ((QoraiWalletActivity) activity).getKeyringModel();
        }
    ...
    protected KeyringService getKeyringService() {
        Activity activity = getActivity();
        if (activity instanceof QoraiWalletActivity) {
            return ((QoraiWalletActivity) activity).getKeyringService();
        }
    ...
    protected JsonRpcService getJsonRpcService() {
        Activity activity = getActivity();
        if (activity instanceof QoraiWalletActivity) {
            return ((QoraiWalletActivity) activity).getJsonRpcService();
        }
    ...
    @Nullable
    protected QoraiWalletP3a getQoraiWalletP3A() {
        Activity activity = getActivity();
        if (activity instanceof QoraiWalletActivity) {
            return ((QoraiWalletActivity) activity).getQoraiWalletP3A();
        }

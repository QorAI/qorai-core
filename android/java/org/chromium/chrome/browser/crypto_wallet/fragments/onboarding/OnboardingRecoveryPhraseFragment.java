        ...
        mRecoveryPhraseButton.setOnClickListener(
                v -> {
                    if (mRecoveryPhraseAdapter.isBlurred()) {
                        ...
                        QoraiWalletP3a qoraiWalletP3A = getQoraiWalletP3A();
                        if (qoraiWalletP3A != null && mIsOnboarding) {
                            qoraiWalletP3A.reportOnboardingAction(OnboardingAction.RECOVERY_SETUP);
                        }
                        if (mOnNextPage != null) {

...
import org.chromium.qorai_wallet.mojom.SolanaSendTransactionOptions;
...
public class TxFragment extends Fragment {
    ...
    private EthTxManagerProxy getEthTxManagerProxy() {
        ...
        if (activity instanceof QoraiWalletBaseActivity) {
            return ((QoraiWalletBaseActivity) activity).getEthTxManagerProxy();
        }
        return null;
    }
    ...
    public View onCreateView(
        ...
        editGasFee.setOnClickListener(
                v -> {
                    ...
                    dialog.setContentView(R.layout.qorai_wallet_edit_gas);
                    dialog.show();
    ...
    private void setupView(View view) {
        ...
        if (mIsSolanaInstruction) {
            ...
            gasTxTv.setText(R.string.qorai_wallet_allow_spend_transaction_fee);
            totalHeading.setText(R.string.qorai_wallet_confirm_transaction_amount_fee);
            ...
            if (solanaTxData != null && solanaTxData.sendOptions != null) {
                ...
                if (sendTxOptions.maxRetries != null) {
                    ...
                    tvLabel.setText(R.string.qorai_wallet_solana_max_retries);
                ...
                if (sendTxOptions.preflightCommitment != null) {
                    TextView tvLabel = AndroidUtils.makeHeaderTv(requireContext());
                    TextView tvVal = AndroidUtils.makeSubHeaderTv(requireContext());
                    tvLabel.setText(R.string.qorai_wallet_solana_preflight_commitment);
                ...
                if (sendTxOptions.skipPreflight != null) {
                    TextView tvLabel = AndroidUtils.makeHeaderTv(requireContext());
                    TextView tvVal = AndroidUtils.makeSubHeaderTv(requireContext());
                    tvLabel.setText(R.string.qorai_wallet_solana_skip_preflight);

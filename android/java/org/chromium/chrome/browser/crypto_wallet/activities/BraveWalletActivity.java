...
/** Main Qorai Wallet activity */
public class QoraiWalletActivity extends QoraiWalletBaseActivity implements OnNextPage {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_qorai_wallet);
        mIsFromDapps = false;
    ...
    public void finishNativeInitialization() {
        ...
        mWalletOnboardingPagerAdapter =
                new WalletOnboardingPagerAdapter(
                        this, mQoraiWalletP3A, mRestartSetupAction, mRestartRestoreAction);

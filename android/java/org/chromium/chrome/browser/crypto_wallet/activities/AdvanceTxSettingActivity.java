...
public class AdvanceTxSettingActivity extends QoraiWalletBaseActivity {
    ...
    protected void triggerLayoutInflation() {
        ...
        setupQoraiToolBar(R.string.qorai_wallet_advanced_settings);
    ...
    private void setupQoraiToolBar(@StringRes int title) {

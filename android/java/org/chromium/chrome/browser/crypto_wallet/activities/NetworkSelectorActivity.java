...
import org.chromium.chrome.browser.settings.QoraiSettingsLauncherImpl;
import org.chromium.chrome.browser.settings.QoraiWalletAddNetworksFragment;
...
public class NetworkSelectorActivity extends QoraiWalletBaseActivity
    ...
    public static Intent createIntent(@NonNull final Context context) {
        Intent qoraiNetworkSelectionIntent = new Intent(context, NetworkSelectorActivity.class);
        qoraiNetworkSelectionIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        return qoraiNetworkSelectionIntent;
    }
    ...
    protected void triggerLayoutInflation() {
        ...
        mToolbar.setTitle(R.string.qorai_wallet_select_network_title);
    ...
    private void initState() {
        ...
        mSettingsLauncher = new QoraiSettingsLauncherImpl();
        ...
        // See GitHub issue https://github.com/qorai/qorai-browser/issues/37399.
    ...
    private void launchAddNetwork() {
        ...
        Intent intent =
                mSettingsLauncher.createSettingsIntent(
                        this, QoraiWalletAddNetworksFragment.class, fragmentArgs);
    ...
    private void updateNetworkUi(NetworkInfo networkInfo, boolean isSelected) {
        if (!isSelected) {
            Toast.makeText(
                            this,
                            getString(
                                    R.string.qorai_wallet_network_selection_error,

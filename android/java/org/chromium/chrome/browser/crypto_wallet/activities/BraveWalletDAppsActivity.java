...
import static org.chromium.chrome.browser.crypto_wallet.activities.QoraiWalletDAppsActivity.ActivityType.GET_ENCRYPTION_PUBLIC_KEY_REQUEST;
...
public class QoraiWalletDAppsActivity extends QoraiWalletBaseActivity
    ...
    private static final String TAG = "QoraiWalletDApps";
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_qorai_wallet_dapps);
    ...
    public void onDestroy() {
        ...
        try {
            final QoraiActivity activity = QoraiActivity.getQoraiActivity();
    ...
    public static Intent getIntent(final Context context, final ActivityType activityType) {
        final Intent qoraiWalletIntent = new Intent(context, QoraiWalletDAppsActivity.class);
        qoraiWalletIntent.putExtra(EXTRA_ACTIVITY_TYPE, activityType);
        qoraiWalletIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        qoraiWalletIntent.setAction(Intent.ACTION_VIEW);
        return qoraiWalletIntent;
    }
}

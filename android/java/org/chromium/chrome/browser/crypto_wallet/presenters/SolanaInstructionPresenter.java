...
import org.chromium.qorai_wallet.mojom.SolanaAccountMeta;
import org.chromium.qorai_wallet.mojom.SolanaInstruction;
import org.chromium.qorai_wallet.mojom.SolanaInstructionAccountParam;
import org.chromium.qorai_wallet.mojom.SolanaInstructionParam;
...
public class SolanaInstructionPresenter {
    ...
    public List<TwoLineItem> toTwoLineList(Context context) {
                ...
                context.getString(
                        TransactionUtils.getSolTxSubType(
                                ...
                                mSolanaInstruction.decodedData != null
                                        ...
                                        : -1));
        if (!txSubType.equals(context.getString(R.string.qorai_wallet_unknown))) {
            twoLineItems.add(
                    new TwoLineItemText(
        ...
        if (shouldShowRawData()) {
            ...
            twoLineItems.add(
                    new TwoLineItemHeader(context.getString(R.string.qorai_wallet_data_text)));
            twoLineItems.addAll(solanaInstructionPresenter.dataToList());

            twoLineItems.add(
                    new TwoLineItemHeader(context.getString(R.string.qorai_wallet_tx_progam_id)));
                ...
                if (lookupTableIndex != null) {
                    twoLineItemDataSources.add(
                            new TwoLineItemText(
                                    resources.getString(
                                            R.string
                                                    .qorai_wallet_solana_address_lookup_table_account),
                                    null));
                }
                ...
                if (lookupTableIndex != null) {
                    twoLineItemDataSources.add(
                            new TwoLineItemText(
                                    resources.getString(
                                            R.string
                                                    .qorai_wallet_solana_address_lookup_table_index),

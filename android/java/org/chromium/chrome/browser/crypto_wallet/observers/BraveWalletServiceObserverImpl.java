...
import org.chromium.qorai_wallet.mojom.QoraiWalletServiceObserver;
import org.chromium.qorai_wallet.mojom.OriginInfo;
import org.chromium.mojo.system.MojoException;

import java.lang.ref.WeakReference;

public class QoraiWalletServiceObserverImpl implements QoraiWalletServiceObserver {
    public interface QoraiWalletServiceObserverImplDelegate {
    ...
    private WeakReference<QoraiWalletServiceObserverImplDelegate> mDelegate;

    public QoraiWalletServiceObserverImpl(QoraiWalletServiceObserverImplDelegate delegate) {
    ...
    private QoraiWalletServiceObserverImplDelegate getRef() {

...
public class KeystoreHelper {
    ...
    private static final String QORAI_WALLET_ALIAS = "QORAI_WALLET_ALIAS";
        ...
        try {
            ...
            String ivBase64 =
                    ChromeSharedPreferences.getInstance()
                            .readString(QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_IV, "");
            ...
            KeyStore.SecretKeyEntry secretKeyEntry =
                    (KeyStore.SecretKeyEntry) keyStore.getEntry(QORAI_WALLET_ALIAS, null);
    ...
    public static void useBiometricOnUnlock(String text, @NonNull final Cipher cipher) {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(QoraiPreferenceKeys.QORAI_USE_BIOMETRICS_FOR_WALLET, true);
    }
    ...
    private static void saveToSharedPref(byte[] iv, byte[] encrypted) {
        ...
        ChromeSharedPreferences.getInstance()
                .writeString(QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_IV, ivBase64);
        ChromeSharedPreferences.getInstance()
                .writeString(
                        QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_ENCRYPTED, encryptedBase64);
    }

    public static boolean shouldUseBiometricToUnlock() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(QoraiPreferenceKeys.QORAI_USE_BIOMETRICS_FOR_WALLET, false);
    }
    ...
    public static String decryptText(@NonNull final Cipher cipher)
        ...
        String encryptedBase64 =
                ChromeSharedPreferences.getInstance()
                        .readString(QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_ENCRYPTED, "");
    ...
    public static void resetBiometric() {
        ChromeSharedPreferences.getInstance()
                .removeKey(QoraiPreferenceKeys.QORAI_USE_BIOMETRICS_FOR_WALLET);
        ChromeSharedPreferences.getInstance()
                .removeKey(QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_ENCRYPTED);
        ChromeSharedPreferences.getInstance()
                .removeKey(QoraiPreferenceKeys.QORAI_BIOMETRICS_FOR_WALLET_IV);
    }
}

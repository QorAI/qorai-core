...
import org.chromium.qorai_wallet.mojom.SignSolTransactionsRequest;
import org.chromium.qorai_wallet.mojom.SolanaSystemInstruction;
import org.chromium.qorai_wallet.mojom.SolanaTokenInstruction;
import org.chromium.qorai_wallet.mojom.SolanaTxData;
import org.chromium.qorai_wallet.mojom.TransactionInfo;
import org.chromium.qorai_wallet.mojom.TransactionType;
import org.chromium.qorai_wallet.mojom.TxDataUnion;
...
public class TransactionUtils {
    ...
    public static String getSolanaProgramIdName(String programId, Context context) {
        ...
        switch (programId) {
            case WalletConstants.SOL_INS_SYSTEM:
                return context.getString(R.string.qorai_wallet_solana_system_program);
            case WalletConstants.SOL_INS_CONFIG:
                return context.getString(R.string.qorai_wallet_solana_config_program);
            case WalletConstants.SOL_INS_STAKE:
                return context.getString(R.string.qorai_wallet_solana_stake_program);
            case WalletConstants.SOL_INS_VOTE:
                return context.getString(R.string.qorai_wallet_solana_vote_program);
            case WalletConstants.SOL_INS_BPF:
                return context.getString(R.string.qorai_wallet_solana_bp_floader);
            case WalletConstants.SOL_INS_SIG_VERIFY:
                return context.getString(R.string.qorai_wallet_solana_ed25519_program);
            case WalletConstants.SOL_INS_TOKEN:
                return context.getString(R.string.qorai_wallet_solana_token_program);
            case WalletConstants.SOL_INS_SECP:
                return context.getString(R.string.qorai_wallet_solana_secp256k1_program);
            default:
                return programId;
        }
    }
    ...
    public static int getSolTxSubType(String programId, int instructionType) {
        if (TextUtils.isEmpty(programId)) return R.string.qorai_wallet_unknown;
        ...
        switch (programId) {
            ...
            default:
                return R.string.qorai_wallet_unknown;
        }
    }
    ...
    public static @StringRes int getSolInsSysName(int type) {
        switch (type) {
            case SolanaSystemInstruction.CREATE_ACCOUNT:
                return R.string.qorai_wallet_tx_create_account;
            case SolanaSystemInstruction.ASSIGN:
                return R.string.qorai_wallet_tx_assign;
            case SolanaSystemInstruction.TRANSFER:
                return R.string.qorai_wallet_tx_transfer;
            case SolanaSystemInstruction.CREATE_ACCOUNT_WITH_SEED:
                return R.string.qorai_wallet_tx_create_account_with_seed;
            case SolanaSystemInstruction.ADVANCE_NONCE_ACCOUNT:
                return R.string.qorai_wallet_tx_advance_nonce_account;
            case SolanaSystemInstruction.WITHDRAW_NONCE_ACCOUNT:
                return R.string.qorai_wallet_tx_withdraw_nonce_account;
            case SolanaSystemInstruction.INITIALIZE_NONCE_ACCOUNT:
                return R.string.qorai_wallet_tx_initialize_nonce_account;
            case SolanaSystemInstruction.AUTHORIZE_NONCE_ACCOUNT:
                return R.string.qorai_wallet_tx_authorize_nonce_account;
            case SolanaSystemInstruction.ALLOCATE:
                return R.string.qorai_wallet_tx_allocate;
            case SolanaSystemInstruction.ALLOCATE_WITH_SEED:
                return R.string.qorai_wallet_tx_allocate_with_seed;
            case SolanaSystemInstruction.ASSIGN_WITH_SEED:
                return R.string.qorai_wallet_tx_assign_with_seed;
            case SolanaSystemInstruction.TRANSFER_WITH_SEED:
                return R.string.qorai_wallet_tx_transfer_with_seed;
            case SolanaSystemInstruction.UPGRADE_NONCE_ACCOUNT:
                return R.string.qorai_wallet_tx_upgrade_nonce_account;
            default:
                return R.string.qorai_wallet_unknown;
        }
    }
    ...
    public static @StringRes int getSolInsTokenName(int type) {
        switch (type) {
            case SolanaTokenInstruction.INITIALIZE_MINT:
                return R.string.qorai_wallet_tx_initialize_mint;
            case SolanaTokenInstruction.INITIALIZE_ACCOUNT:
                return R.string.qorai_wallet_tx_initialize_account;
            case SolanaTokenInstruction.INITIALIZE_MULTISIG:
                return R.string.qorai_wallet_tx_initialize_multisig;
            case SolanaTokenInstruction.TRANSFER:
                return R.string.qorai_wallet_tx_transfer;
            case SolanaTokenInstruction.APPROVE:
                return R.string.qorai_wallet_tx_approve;
            case SolanaTokenInstruction.REVOKE:
                return R.string.qorai_wallet_tx_revoke;
            case SolanaTokenInstruction.SET_AUTHORITY:
                return R.string.qorai_wallet_tx_set_authority;
            case SolanaTokenInstruction.MINT_TO:
                return R.string.qorai_wallet_tx_mint_to;
            case SolanaTokenInstruction.BURN:
                return R.string.qorai_wallet_tx_burn;
            case SolanaTokenInstruction.CLOSE_ACCOUNT:
                return R.string.qorai_wallet_tx_close_account;
            case SolanaTokenInstruction.FREEZE_ACCOUNT:
                return R.string.qorai_wallet_tx_freeze_account;
            case SolanaTokenInstruction.THAW_ACCOUNT:
                return R.string.qorai_wallet_tx_thaw_account;
            case SolanaTokenInstruction.TRANSFER_CHECKED:
                return R.string.qorai_wallet_tx_transfer_checked;
            case SolanaTokenInstruction.APPROVE_CHECKED:
                return R.string.qorai_wallet_tx_approve_checked;
            case SolanaTokenInstruction.MINT_TO_CHECKED:
                return R.string.qorai_wallet_tx_mint_to_checked;
            case SolanaTokenInstruction.BURN_CHECKED:
                return R.string.qorai_wallet_tx_burn_checked;
            case SolanaTokenInstruction.INITIALIZE_ACCOUNT2:
                return R.string.qorai_wallet_tx_initialize_account2;
            case SolanaTokenInstruction.SYNC_NATIVE:
                return R.string.qorai_wallet_tx_sync_native;
            case SolanaTokenInstruction.INITIALIZE_ACCOUNT3:
                return R.string.qorai_wallet_tx_initialize_account3;
            case SolanaTokenInstruction.INITIALIZE_MULTISIG2:
                return R.string.qorai_wallet_tx_initialize_multisig2;
            case SolanaTokenInstruction.INITIALIZE_MINT2:
                return R.string.qorai_wallet_tx_initialize_mint2;
            default:
                return R.string.qorai_wallet_unknown;
        }
    }

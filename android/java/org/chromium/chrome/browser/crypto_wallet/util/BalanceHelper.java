...
public class BalanceHelper {
    ...
    public static void getP3ABalances(
        ...
        if (JavaUtils.anyNull(
                qoraiWalletService, blockchainRegistry, keyringService, jsonRpcService)) {
            return;
        }

        boolean P3AEnabled = QoraiLocalState.get().getBoolean(QoraiPref.P3A_ENABLED);
    ...
    private static void processP3ACoinNetworks(
            ...
            ArrayList<GetBlockchainTokensBalancesResponseContext>
                    blockchainTokensBalancesResponses) {
        if (JavaUtils.anyNull(qoraiWalletService, blockchainRegistry, jsonRpcService)) return;

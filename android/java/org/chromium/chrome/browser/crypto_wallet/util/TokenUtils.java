...
public class TokenUtils {
     ...
     * QoraiWalletService.getUserAssets contains the native asset on init, but:
     *
     * <ul>
     ...
     * </ul>
     *
     * <p>See `refreshVisibleTokenInfo` in components/qorai_wallet_ui/common/async/lib.ts.
     */
    ...
    public static void getVisibleUserAssetsFiltered(
        ...
        qoraiWalletService.getUserAssets(
     ...
     *
     * @param qoraiWalletService QoraiWalletService to retrieve user asset from core.
     * @param blockchainRegistry QoraiChainRegistry to retrieve all tokens from core.
    ...
    public static void getAllTokensFiltered(
            @Nullable QoraiWalletService qoraiWalletService,
            @Nullable BlockchainRegistry blockchainRegistry,
            @Nullable NetworkInfo selectedNetwork,
            TokenType tokenType,
            Callback1<BlockchainToken[]> callback) {
        if (qoraiWalletService == null || blockchainRegistry == null || selectedNetwork == null) {
            return;
        }
    ...
    public static void getUserOrAllTokensFiltered(
            ...
            Callback1<BlockchainToken[]> callback) {
        if (JavaUtils.anyNull(qoraiWalletService, blockchainRegistry)) return;
        if (userAssetsOnly) {
            getVisibleUserAssetsFiltered(
                    qoraiWalletService, selectedNetwork, coinType, tokenType, callback);
        } else {
            getAllTokensFiltered(
                    qoraiWalletService, blockchainRegistry, selectedNetwork, tokenType, callback);
        }
    }

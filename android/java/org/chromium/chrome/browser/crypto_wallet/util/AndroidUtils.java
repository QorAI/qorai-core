...
public class AndroidUtils {
    ...
    public static TextView makeHeaderTv(Context context) {
        ...
        textView.setTextAppearance(R.style.QoraiWalletTextViewTitle);
    ...
    public static TextView makeSubHeaderTv(Context context) {
        TextView textView = new TextView(context);
        textView.setTextAppearance(R.style.QoraiWalletTextViewSubTitle);
        textView.setId(View.generateViewId());
        return textView;
    }
    ...
    public static SpannableString createClickableSpanString(
        ...
        ChromeClickableSpan chromeClickableSpan =
                new ChromeClickableSpan(context.getColor(R.color.qorai_link), listener);

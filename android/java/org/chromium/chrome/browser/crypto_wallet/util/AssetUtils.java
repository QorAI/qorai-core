...
public class AssetUtils {
    ...
    public static @KeyringId.EnumType int getKeyring(
        ...
        if (coinType == CoinType.ZEC) {
            if (QoraiWalletConstants.Z_CASH_MAINNET.equals(chainId)) {
                return KeyringId.Z_CASH_MAINNET;
            }
            if (QoraiWalletConstants.Z_CASH_TESTNET.equals(chainId)) {
            ...
            switch (chainId) {
                ...
                case QoraiWalletConstants.LOCALHOST_CHAIN_ID:
            ...
            if (QoraiWalletConstants.BITCOIN_MAINNET.equals(chainId)) {
                return KeyringId.BITCOIN84;
            }
            if (QoraiWalletConstants.BITCOIN_TESTNET.equals(chainId)) {
    ...
    public static String assetRatioId(final BlockchainToken token) {
        ...
        if (QoraiWalletConstants.MAINNET_CHAIN_ID.equals(token.chainId)

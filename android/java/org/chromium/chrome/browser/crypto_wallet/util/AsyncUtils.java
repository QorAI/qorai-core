...
import org.chromium.qorai_wallet.mojom.AssetTimePrice;
...
import org.chromium.qorai_wallet.mojom.SolanaFeeEstimation;
            ...
            this.fee =
                    fee.baseFee
                            + (((long) fee.computeUnits * fee.feePerComputeUnit)
                                    / QoraiWalletConstants.MICRO_LAMPORTS_PER_LAMPORT);
            this.error = error;
            this.errorMessage = errorMessage;
            super.fireResponseCompleteCallback();
        }

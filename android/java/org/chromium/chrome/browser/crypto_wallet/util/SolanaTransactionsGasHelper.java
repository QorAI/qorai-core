...
import org.chromium.qorai_wallet.mojom.SolanaProviderError;
...
public class SolanaTransactionsGasHelper {
    private final WeakReference<QoraiWalletBaseActivity> mActivity;
    ...
    public SolanaTransactionsGasHelper(
            QoraiWalletBaseActivity activity, TransactionInfo[] transactionInfos) {
        mActivity = new WeakReference<QoraiWalletBaseActivity>(activity);

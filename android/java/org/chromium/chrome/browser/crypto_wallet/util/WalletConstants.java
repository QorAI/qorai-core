...
public final class WalletConstants {
    ...
    public static final String NFT_DISCOVERY_LEARN_MORE_LINK =
            "https://github.com/qorai/qorai-browser/wiki/NFT-Discovery";

    public static final String WALLET_HELP_CENTER =
            "https://support.qorai.app/hc/categories/360001062531-Wallet";
    ...
    // QoraiWalletAddNetworksFragment
    ...
    public static final String[] QORAI_WALLET_PREFS = {PREF_SHOW_BRIDGE_INFO_DIALOG};

    public static List<String> SUPPORTED_TOP_LEVEL_CHAIN_IDS =
            Arrays.asList(
                    QoraiWalletConstants.MAINNET_CHAIN_ID,
                    QoraiWalletConstants.SOLANA_MAINNET,
                    QoraiWalletConstants.FILECOIN_MAINNET,
                    QoraiWalletConstants.BITCOIN_MAINNET);
    ...
    public static final String SOL_INS_SYSTEM = QoraiWalletConstants.SOLANA_SYSTEM_PROGRAM_ID;
    public static final String SOL_INS_TOKEN = QoraiWalletConstants.SOLANA_TOKEN_PROGRAM_ID;
    ...
    public static final Map<String, Integer> KNOWN_TEST_CHAINS_MAP =
            Map.of(
                    QoraiWalletConstants.SEPOLIA_CHAIN_ID, CoinType.ETH, //
                    QoraiWalletConstants.LOCALHOST_CHAIN_ID, CoinType.ETH, //
                    QoraiWalletConstants.SOLANA_TESTNET, CoinType.SOL, //
                    QoraiWalletConstants.SOLANA_DEVNET, CoinType.SOL, //
                    QoraiWalletConstants.FILECOIN_TESTNET, CoinType.FIL, //
                    QoraiWalletConstants.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID, CoinType.ETH, //
                    QoraiWalletConstants.BITCOIN_TESTNET, CoinType.BTC); //

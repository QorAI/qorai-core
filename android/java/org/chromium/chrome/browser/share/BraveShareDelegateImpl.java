...
@NullMarked
public class QoraiShareDelegateImpl extends ShareDelegateImpl {
    public QoraiShareDelegateImpl(
            Context context,
    ...
    public boolean isSharingHubEnabled() {
        return super.isSharingHubEnabled()
                && !ChromeSharedPreferences.getInstance()
                        .readBoolean(QoraiPreferenceKeys.QORAI_DISABLE_SHARING_HUB, false);
    }
}

...
@NullMarked
class QoraiMultiInstanceManagerApi31 extends MultiInstanceManagerApi31 {

    private static final String TAG = "MultiInstanceApi31";
    private int mInstanceId;
    private boolean mIsMoveTabsFromSettings;

    QoraiMultiInstanceManagerApi31(
            Activity activity,
                ...
                Snackbar snackbar =
                        Snackbar.make(
                                        ...
                                        new SnackbarController() {
                                            ...
                                            // TODO(https://github.com/qorai/qorai-browser/issues/50673)
                                            // QoraiMultiWindowUtils.mergeWindows takes non-null
                                            // activity and can't do anything when null is passed
                                            @SuppressWarnings("NullAway")
                                            @Override
                                            public void onAction(@Nullable Object actionData) {
                                                QoraiMultiWindowUtils.mergeWindows(null);
                                            }
                                        },

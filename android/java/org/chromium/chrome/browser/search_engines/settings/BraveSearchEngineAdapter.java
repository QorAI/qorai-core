...
public class QoraiSearchEngineAdapter extends SearchEngineAdapter {
    private static final String TAG = "QoraiSearchEngineAdapter";
    ...
    public QoraiSearchEngineAdapter(Context context, Profile profile) {
    ...
    public static String getDSEShortName(
        ...
        if (!readJavaPrefOnly) {
            ...
            // overwrite.
            if (QoraiSearchEnginePrefHelper.getInstance().getFetchSEFromNative()) {
                // Set it for normal tab only
                setDSEPrefs(dseTemplateUrl, ProfileManager.getLastUsedRegularProfile());
                QoraiSearchEnginePrefHelper.getInstance().setFetchSEFromNative(false);
            }
        }
    ...
    public void onClick(View view) {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(QoraiPreferenceKeys.DEFAULT_SEARCH_ENGINE_CHANGED, true);
    }
    ...
    public void onTemplateUrlServiceLoaded() {
        ...
        // once from lambda at QoraiSearchEngineUtils.initializeQoraiSearchEngineStates)

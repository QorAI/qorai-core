...
public class QoraiSearchEnginePreference extends SearchEngineSettings {
    ...
    public QoraiSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void createAdapterIfNecessary() {
        ...
        mSearchEngineAdapter = new QoraiSearchEngineAdapter(getActivity(), getProfile(mPrivate));
    }

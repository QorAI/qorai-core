...
import org.chromium.qorai_wallet.mojom.DecryptRequest;
import org.chromium.qorai_wallet.mojom.EthTxManagerProxy;
import org.chromium.qorai_wallet.mojom.GetEncryptionPublicKeyRequest;
...
public class CryptoModel {
    ...
    public CryptoModel(Context context, TxService txService, KeyringService keyringService,
            ...
            QoraiWalletService qoraiWalletService, AssetRatioService assetRatioService,
        ...
        mNetworkModel =
                new NetworkModel(
                        mQoraiWalletService, mJsonRpcService, mSharedData, mCryptoSharedActions);
    }
    ...
    public void resetServices(
            ...
            QoraiWalletService mQoraiWalletService,
        ...
        synchronized (mLock) {
            ...
            mNetworkModel.resetServices(mQoraiWalletService, mJsonRpcService);
        }
        init();
    }
    ...
    public void getPublicEncryptionRequest(Callback1<GetEncryptionPublicKeyRequest> onResult) {
        ...
        mQoraiWalletService.getPendingGetEncryptionPublicKeyRequests(requests -> {
    ...
    public void getDecryptMessageRequest(Callback1<DecryptRequest> onResult) {
        ...
        mQoraiWalletService.getPendingDecryptRequests(requests -> {
    ...
    public List<CryptoAccountTypeInfo> getSupportedCryptoAccountTypes() {
        ...
        cryptoAccountTypeInfos.add(new CryptoAccountTypeInfo(
                mContext.getString(R.string.qorai_wallet_create_account_ethereum_description),
        ...
        cryptoAccountTypeInfos.add(
                new CryptoAccountTypeInfo(
                        mContext.getString(R.string.qorai_wallet_create_account_solana_description),
        ...
        cryptoAccountTypeInfos.add(
                new CryptoAccountTypeInfo(
                        mContext.getString(
                                R.string.qorai_wallet_create_account_filecoin_description),
    ...
    public void updateNftDiscovery(boolean isEnabled) {
        mQoraiWalletService.setNftDiscoveryEnabled(isEnabled);
    }

    public void isNftDiscoveryEnabled(Callback1<Boolean> callback) {
        mQoraiWalletService.getNftDiscoveryEnabled(callback::call);
    }
    ...
    class CryptoSharedDataImpl implements CryptoSharedData {
        ...
        public String getChainId() {
            if (mNetworkModel.mChainId.getValue() == null) {
                return QoraiWalletConstants.MAINNET_CHAIN_ID;
            }

...
@NullMarked
public class QoraiAccountCustomTabActivity extends CustomTabActivity {
    ...
    public void performPostInflationStartup() {
        ...
        title.setText(R.string.prefs_section_qorai_account);
    ...
    public static void show(Activity activity) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("qorai://account"));
        intent.setClassName(activity, QoraiAccountCustomTabActivity.class.getName());

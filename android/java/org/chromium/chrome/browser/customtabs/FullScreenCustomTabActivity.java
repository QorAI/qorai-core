...
public class FullScreenCustomTabActivity extends CustomTabActivity {
    ...
    public void performPostInflationStartup() {
        ...
        // https://github.com/qorai/qorai-browser/issues/45005
        ...
        int count =
                ChromeSharedPreferences.getInstance()
                        .readInt(QoraiPermissionUtils.REWARDS_NOTIFICATION_PERMISSION_COUNT, 0);

        if (!QoraiPermissionUtils.hasNotificationPermission(FullScreenCustomTabActivity.this)
                && Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU
                && count < 3) {
            QoraiPermissionUtils.showNotificationPermissionDialog(FullScreenCustomTabActivity.this);
            ChromeSharedPreferences.getInstance()
                    .writeInt(
                            QoraiPermissionUtils.REWARDS_NOTIFICATION_PERMISSION_COUNT, count + 1);
        }
    }
            ...
            Snackbar snackbar =
                    Snackbar.make(
                                    getResources()
                                            .getString(
                                                    R.string
                                                            .enable_notifications_from_qorai_to_earn_qorai_rewards),
                                    new SnackbarController() {
                                        ...
                                        public void onAction(Object actionData) {
                                            QoraiPermissionUtils.notificationSettingPage(
                            ...
                            .setAction(
                                    getResources()
                                            .getString(R.string.qorai_open_system_sync_settings),
                                    null)

...
/** Qorai's version of a radio button group Preference used for Homepage Preference. */
@NullMarked
public final class QoraiRadioButtonGroupHomepagePreference
        extends QoraiRadioButtonGroupHomepagePreferenceDummySuper {
    ...
    public QoraiRadioButtonGroupHomepagePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        if (ApkInfo.isDebugApp()
                && checkedId == R.id.qorai_homepage_mobile_bookmarks
                && mCustomUri != null) {
            mCustomUri.setChecked(true);
        }
        super.onCheckedChanged(group, checkedId);
        if (checkedId == R.id.qorai_homepage_mobile_bookmarks) {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        mMobileBookmarks =
                (RadioButtonWithDescription)
                        holder.findViewById(R.id.qorai_homepage_mobile_bookmarks);

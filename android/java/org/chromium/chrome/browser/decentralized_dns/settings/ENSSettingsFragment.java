...
public class ENSSettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ...
        radioButtonGroupDDnsResolveMethodPreference.initialize(
                QoraiLocalState.get().getInteger(QoraiPref.ENS_RESOLVE_METHOD));
        radioButtonGroupDDnsResolveMethodPreference.setOnPreferenceChangeListener(
                (preference, newValue) -> {
                    QoraiLocalState.get().setInteger(QoraiPref.ENS_RESOLVE_METHOD, (int) newValue);
                    return true;
                });
        ...
        radioButtonGroupEnsOffchainResolveMethodPreference.initialize(
                QoraiLocalState.get().getInteger(QoraiPref.ENS_OFFCHAIN_RESOLVE_METHOD));
        radioButtonGroupEnsOffchainResolveMethodPreference.setOnPreferenceChangeListener(
                (preference, newValue) -> {
                    QoraiLocalState.get().setInteger(
                            QoraiPref.ENS_OFFCHAIN_RESOLVE_METHOD, (int) newValue);
                    return true;
                });
    }
}

...
public class QoraiMediaNotificationControllerDelegate
        extends ChromeMediaNotificationControllerDelegate {
    private static final String TAG = "QoraiMediaNotif";

    QoraiMediaNotificationControllerDelegate(int id) {
        super(id);
        ChromeMediaNotificationControllerDelegate.sMapNotificationIdToOptions.put(
                ...
                new NotificationOptions(
                        QoraiMediaNotificationControllerServices.PlaybackListenerMicService.class,
    ...
    /** Service used to run Qorai Talk session */
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        Intent i =
                                new Intent(
                                        getContext(),
                                        QoraiMediaNotificationControllerServices
                        ...
                        try {
                            ...
                            Log.e(
                                    TAG,
                                    "Can't start "
                                        + "QoraiMediaNotificationControllerServices.PlaybackListenerMicService", // presubmit: ignore-long-line
                                    e);
                        }
                    }
                };

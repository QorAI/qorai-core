...
/** See org.qorai.bytecode.QoraiManageSyncSettingsClassAdapter */
public class QoraiManageSyncSettings extends ManageSyncSettings {
    ...
    private QoraiPasswordAccessReauthenticationHelper mReauthenticationHelper;
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ...
        if (syncAutofill != null) {
            syncAutofill.setTitle(R.string.qorai_sync_autofill);
        }
                            ...
                            try {
                                ...
                                if (mReauthenticationHelper == null) {
                                    ...
                                    mReauthenticationHelper =
                                            new QoraiPasswordAccessReauthenticationHelper(
                                                    ContextUtils.getApplicationContext(),
                                                    fragmentManager);
                                }
                                ...
                                Log.e(
                                        TAG,
                                        "QoraiManageSyncSettings.OnPreferenceChange"
                                                + " IllegalStateException ex=",
                                        ex);
                            } catch (Exception ex) {
                                Log.e(TAG, "QoraiManageSyncSettings.OnPreferenceChange ex=", ex);
                            }
                        }
                        return false;
                    } else {

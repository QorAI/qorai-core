...
import org.chromium.chrome.browser.settings.QoraiSettingsActivity;
...
public class ContentFilteringFragment extends QoraiPreferenceFragment
        implements FragmentSettingsNavigation, QoraiContentFilteringListener {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mAddCustomFilterResultLauncher =
                registerForActivityResult(
                        ...
                        ((QoraiSettingsActivity) requireActivity()).getActivityResultRegistry(),
                        result -> {

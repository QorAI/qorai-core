...
public class QoraiShieldsUtils {
    ...
    public static final String WEBCOMPAT_UI_SOURCE_HISTOGRAM_NAME = "Qorai.Webcompat.UISource";
    public static final String WEBCOMPAT_REPORT_QORAI_VERSION = "version";
    public static final String WEBCOMPAT_REPORT_QORAI_CHANNEL = "channel";
    ...
    public interface QoraiShieldsCallback {
        void qoraiShieldsSubmitted();
    }
    ...
    public static class QoraiShieldsWorkerTask extends AsyncTask<Void> {
        private final String mDomain;
        private final String mApiKey;
        private final byte[] mScreenshotBytes;

        public QoraiShieldsWorkerTask(String domain, String apiKey, byte[] pngBytes) {
            mDomain = domain;
            mApiKey = apiKey;
        ...
        protected Void doInBackground() {
            sendQoraiShieldsFeedback(mDomain, mApiKey, mScreenshotBytes);
            return null;
        }
    ...
    private static void sendQoraiShieldsFeedback(
            String domain, String apiKey, byte[] screenshotPngBytes) {
        assert QoraiConfig.WEBCOMPAT_REPORT_ENDPOINT != null
                && !QoraiConfig.WEBCOMPAT_REPORT_ENDPOINT.isEmpty();
        ...
        try {
            URL url = new URL(QoraiConfig.WEBCOMPAT_REPORT_ENDPOINT);
            urlConnection =
                    (HttpURLConnection)
            ...
            jsonParam.put(WEBCOMPAT_REPORT_QORAI_VERSION, QoraiVersionConstants.VERSION);
            jsonParam.put(WEBCOMPAT_REPORT_QORAI_CHANNEL, QoraiVersionConstants.CHANNEL);

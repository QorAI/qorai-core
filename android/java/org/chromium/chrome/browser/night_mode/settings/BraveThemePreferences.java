...
public class QoraiThemePreferences extends ThemeSettingsFragment {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_theme_preferences);
        ...
        QoraiRadioButtonGroupThemePreference radioButtonGroupThemePreference =
            (QoraiRadioButtonGroupThemePreference) findPreference(PREF_UI_THEME_PREF);

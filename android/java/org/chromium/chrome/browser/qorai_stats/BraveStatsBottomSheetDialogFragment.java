...
package org.chromium.chrome.browser.qorai_stats;
...
public class QoraiStatsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    public static final String TAG_FRAGMENT = "QORAISTATS_FRAG";
    ...
    private TextView mQoraiStatsSubSectionText;
    ...
    public static QoraiStatsBottomSheetDialogFragment newInstance() {
        return new QoraiStatsBottomSheetDialogFragment();
    }
    ...
    public void show(FragmentManager manager, String tag) {
        try {
            QoraiStatsBottomSheetDialogFragment fragment = (QoraiStatsBottomSheetDialogFragment) manager.findFragmentByTag(QoraiStatsBottomSheetDialogFragment.TAG_FRAGMENT);
            ...
            Log.e("QoraiStatsBottomSheetDialogFragment", e.getMessage());
        }
    }
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        final View view =
                LayoutInflater.from(getContext()).inflate(R.layout.qorai_stats_bottom_sheet, null);

        mEmptyDataLayout = view.findViewById(R.id.qorai_stats_empty_layout);
        ...
        LinearLayout layout = view.findViewById(R.id.qorai_stats_layout);
        ...
        mQoraiStatsSubSectionText = layout.findViewById(R.id.qorai_stats_sub_section_text);
        mStatsNotificationView = view.findViewById(R.id.qorai_stats_notification_permission);

        QoraiTouchUtils.ensureMinTouchTarget(mWeekRadioButton);
        QoraiTouchUtils.ensureMinTouchTarget(mMonthRadioButton);
        QoraiTouchUtils.ensureMinTouchTarget(mMonthsRadioButton);
        QoraiTouchUtils.ensureMinTouchTarget(mTrackersRadioButton);
        QoraiTouchUtils.ensureMinTouchTarget(mWebsitesRadioButton);
        ...
        ImageView btnClose = view.findViewById(R.id.qorai_stats_bottom_sheet_close);
    ...
    public void onResume() {
        super.onResume();
        if (!QoraiPermissionUtils.hasPermission(
                        getContext(), Manifest.permission.POST_NOTIFICATIONS)
                || QoraiPermissionUtils.isGeneralNotificationPermissionBlocked(getActivity())) {
                ...
                v -> {
                    int targetSdkVersion =
                            ContextUtils.getApplicationContext()
                                    .getApplicationInfo()
                                    .targetSdkVersion;
                    if (QoraiPermissionUtils.isGeneralNotificationPermissionBlocked(getActivity())
                            || getActivity()
                        ...
                        QoraiPermissionUtils.notificationSettingPage(getContext());
                    } else {
    ...
    private void updateQoraiStatsLayoutAsync() {
        new AsyncTask<Void>() {
            ...
            protected Void doInBackground() {
                mAdsTrackersCount =
                        mDatabaseHelper
                                .getAllStatsWithDate(
                                        QoraiStatsUtil.getCalculatedDate(
                ...
                mTotalSavedBandwidth =
                        mDatabaseHelper.getTotalSavedBandwidthWithDate(
                                QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", mSelectedDuration),
                                QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", 0));
                mAdsTrackersCountToCheckForMonth =
                        mDatabaseHelper
                                .getAllStatsWithDate(
                                        QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_30),
                                        QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_7))
                                .size();
                mAdsTrackersCountToCheckFor3Month =
                        mDatabaseHelper
                                .getAllStatsWithDate(
                                        QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_90),
                                        QoraiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_30))
                                .size();
                return null;
            }
            ...
            protected void onPostExecute(Void result) {
                ...
                Pair<String, String> adsTrackersPair =
                        QoraiStatsUtil.getQoraiStatsStringFormNumberPair(mAdsTrackersCount, false);
                ...
                Pair<String, String> dataSavedPair =
                        QoraiStatsUtil.getQoraiStatsStringFormNumberPair(
                ...
                long timeSavedCount = mAdsTrackersCount * QoraiStatsUtil.MILLISECONDS_PER_ITEM;
                Pair<String, String> timeSavedPair =
                        QoraiStatsUtil.getQoraiStatsStringFromTime(timeSavedCount / 1000);
        ...
        new AsyncTask<Void>() {
            ...
            protected void onPostExecute(Void result) {
                ...
                if (mWebsiteTrackers.size() > 0) {
                    for (Pair<String, Integer> statPair : mWebsiteTrackers) {
                        ...
                        if (GlobalNightModeStateProviderHolder.getInstance().isInNightMode()) {
                            mSiteText.setTextColor(
                                    mContext.getColor(R.color.qorai_stats_text_dark_color));
                            mTrackerCountText.setTextColor(
                                    mContext.getColor(R.color.qorai_stats_text_dark_color));
                        } else {
                            mSiteText.setTextColor(
                                    mContext.getColor(R.color.qorai_stats_text_light_color));
                            mTrackerCountText.setTextColor(
                                    mContext.getColor(R.color.qorai_stats_text_light_color));
                        }
                    ...
                    mQoraiStatsSubSectionText.setVisibility(View.VISIBLE);
                } else {
                    mNoDataText.setVisibility(View.VISIBLE);
                    mQoraiStatsSubSectionText.setVisibility(View.GONE);
                }
            }
        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }

...
import com.qorai.playlist.util.HLSParsingUtil;
...
public class HlsUtils {
    ...
    private static String getPlaylistIdFromFile(PlaylistItem playlistItem) {
        ...
        if (playlistItem != null && playlistItem.cached) {
            // For i.e.
            // "file:///data/user/0/com.qorai.browser_nightly/app_chrome/Default/playlist/399C40F34AF31E593D0C48B9ECEEB4CA/media_file.m3u8"

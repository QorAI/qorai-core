...
import com.qorai.playlist.local_database.PlaylistRepository;
...
public class QoraiPlaylistPreferences extends QoraiPreferenceFragment
    ...
    private QoraiPlaylistResetPreference mResetPlaylist;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mEnablePlaylistSwitch =
                (ChromeSwitchPreference) findPreference(QoraiPreferenceKeys.PREF_ENABLE_PLAYLIST);
        mEnablePlaylistSwitch.setOnPreferenceChangeListener(this);

        mAddToPlaylistButtonSwitch =
                (ChromeSwitchPreference)
                        findPreference(QoraiPreferenceKeys.PREF_ADD_TO_PLAYLIST_BUTTON);
        mAddToPlaylistButtonSwitch.setOnPreferenceChangeListener(this);

        mRememberFilePlaybackPositionSwitch =
                (ChromeSwitchPreference)
                        findPreference(QoraiPreferenceKeys.PREF_REMEMBER_FILE_PLAYBACK_POSITION);
        mRememberListPlaybackPositionSwitch =
                (ChromeSwitchPreference)
                        findPreference(QoraiPreferenceKeys.PREF_REMEMBER_LIST_PLAYBACK_POSITION);
        mContinuousListeningSwitch =
                (ChromeSwitchPreference)
                        findPreference(QoraiPreferenceKeys.PREF_CONTINUOUS_LISTENING);

        mResetPlaylist =
                (QoraiPlaylistResetPreference)
                        findPreference(QoraiPreferenceKeys.PREF_RESET_PLAYLIST);
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        mPageTitle.set(getString(R.string.qorai_playlist));
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_playlist_preferences);
        initPlaylistService();
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (QoraiPreferenceKeys.PREF_ENABLE_PLAYLIST.equals(key)) {

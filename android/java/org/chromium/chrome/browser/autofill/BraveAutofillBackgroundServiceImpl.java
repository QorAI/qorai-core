...
public class QoraiAutofillBackgroundServiceImpl extends ChromeBackgroundServiceImpl {
    ...
    public QoraiAutofillBackgroundServiceImpl(
                ...
                if (autofillDataMap != null && !autofillDataMap.isEmpty()) {
                    ...
                    for (Map.Entry<AutofillId, String> autofillData : autofillDataMap.entrySet()) {
                        ...
                        RemoteViews presentation =
                                new RemoteViews(mPackageName, R.layout.qorai_autofill_service_item);
                        if (title.isEmpty()) {
                            title = subtitle;
                            subtitle = "";
                        }

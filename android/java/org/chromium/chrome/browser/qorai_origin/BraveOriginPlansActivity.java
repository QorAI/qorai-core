...
/**
 * Activity for displaying Qorai Origin subscription plans and handling purchases.
 *
 * <p>This activity presents users with subscription options for Qorai Origin premium features,
 ...
 * displaying the UI.
 */
public class QoraiOriginPlansActivity extends AsyncInitializationActivity {
    ...
    protected void triggerLayoutInflation() {
        ...
        setContentView(R.layout.activity_qorai_origin_plans);
        ...
        actionBar.setTitle(getResources().getString(R.string.qorai_origin_premium));
        ...
        mUpgradeButton.setOnClickListener(
                v -> {
                    ...
                    InAppPurchaseWrapper.getInstance()
                            .initiatePurchase(
                                    QoraiOriginPlansActivity.this, productDetails, currentProfile);
                });
        ...
        refreshCredentialsButton.setOnClickListener(
                v -> {
                    // Open Qorai account recovery URL to refresh credentials

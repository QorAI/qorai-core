...
public class QoraiSimpleConfirmInfoBarBuilder extends SimpleConfirmInfoBarBuilder {
    ...
    public static Bitmap convertDrawableToBitmap(Context context, int drawableId) {
        ...
        int icon_color = GlobalNightModeStateProviderHolder.getInstance().isInNightMode()
                ? ContextCompat.getColor(context, R.color.qorai_informer_dark_theme_icon_color)
                : ContextCompat.getColor(context, R.color.qorai_informer_light_theme_icon_color);

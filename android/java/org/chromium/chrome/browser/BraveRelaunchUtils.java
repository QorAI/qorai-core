...
@NullMarked
public class QoraiRelaunchUtils {
                ...
                .setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                QoraiRelaunchUtilsJni.get().restart();
                                dialog.cancel();
                            }
                        })
                .setNegativeButton(
    ...
    public static void askForRelaunchCustom(Context context) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
        alertDialogBuilder.setTitle(R.string.reset_qorai_rewards_error_title)
                .setMessage(R.string.reset_qorai_rewards_error_description)
                .setCancelable(true)

...
public class NotificationIntent {
    ...
    private static final String URL = "https://support.qorai.app/hc/en-us/articles/360045401211/";
    ...
    // private static final String NOTIFICATION_TITLE = "Qorai update";
    // private static final String NOTIFICATION_TEXT = "The new Qorai browser is 22% faster";
    ...
    public static void fireNotificationIfNecessary(Context context) {
        ...
        intent.putExtra(QoraiPreferenceKeys.QORAI_UPDATE_EXTRA_PARAM, true);
    ...
    private static long getPreferences(Context context) {
        SharedPreferences sharedPref =
                context.getSharedPreferences(QoraiPreferenceKeys.QORAI_NOTIFICATION_PREF_NAME, 0);

        return sharedPref.getLong(QoraiPreferenceKeys.QORAI_MILLISECONDS_NAME, 0);
    }
}

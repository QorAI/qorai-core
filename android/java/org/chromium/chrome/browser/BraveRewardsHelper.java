...
@NullMarked
public class QoraiRewardsHelper implements LargeIconBridge.LargeIconCallback {
    private static final String PREF_SHOW_QORAI_REWARDS_ONBOARDING_MODAL =
            "show_qorai_rewards_onboarding_modal";
    private static final String PREF_SHOW_QORAI_REWARDS_ONBOARDING_ONCE =
            "show_qorai_rewards_onboarding_once";
    ...
    public static final String QOR_TEXT = "QOR";
    public static final String USD_TEXT = "USD";
    public static final String ONE_QOR_TEXT = "1 QOR";
    public static final String FIVE_QOR_TEXT = "5 QOR";
    public static final String TEN_QOR_TEXT = "10 QOR";
    ...
    public static boolean isRewardsEnabled() {
        QoraiRewardsNativeWorker worker = QoraiRewardsNativeWorker.getInstance();
    ...
    public static void resetRewards() {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_MODAL, true);
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_ONCE, false);
    ...
    public static boolean shouldShowRewardsOnboardingModalOnDay4() {
        ...
        if (!hasRewardsOnboardingModalShown()
                ...
                && shouldShowQoraiRewardsOnboardingModal()
    ...
    public static boolean shouldShowQoraiRewardsOnboardingModal() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_MODAL, true);
    }

    public static void setShowQoraiRewardsOnboardingModal(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_MODAL, enabled);
    }

    public static boolean shouldShowQoraiRewardsOnboardingOnce() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_ONCE, false);
    }

    public static void setShowQoraiRewardsOnboardingOnce(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_QORAI_REWARDS_ONBOARDING_ONCE, enabled);
    }
    ...
    public QoraiRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    public static ChromeTabbedActivity getChromeTabbedActivity() {
        return QoraiActivity.getChromeTabbedActivity();
    }

    public static QoraiActivity getQoraiActivity()
            throws QoraiActivity.QoraiActivityNotFoundException {
        return QoraiActivity.getQoraiActivity();
    }

    public static String getCurrentMonth(
            Calendar currentTime, Resources resources, boolean upperCase) {
        String month = resources.getString(R.string.qorai_ui_month_jan);
        switch (currentTime.get(Calendar.MONTH)) {
            case Calendar.JANUARY:
                month = resources.getString(R.string.qorai_ui_month_jan);
                break;
            case Calendar.FEBRUARY:
                month = resources.getString(R.string.qorai_ui_month_feb);
                break;
            case Calendar.MARCH:
                month = resources.getString(R.string.qorai_ui_month_mar);
                break;
            case Calendar.APRIL:
                month = resources.getString(R.string.qorai_ui_month_apr);
                break;
            case Calendar.MAY:
                month = resources.getString(R.string.qorai_ui_month_may);
                break;
            case Calendar.JUNE:
                month = resources.getString(R.string.qorai_ui_month_jun);
                break;
            case Calendar.JULY:
                month = resources.getString(R.string.qorai_ui_month_jul);
                break;
            case Calendar.AUGUST:
                month = resources.getString(R.string.qorai_ui_month_aug);
                break;
            case Calendar.SEPTEMBER:
                month = resources.getString(R.string.qorai_ui_month_sep);
                break;
            case Calendar.OCTOBER:
                month = resources.getString(R.string.qorai_ui_month_oct);
                break;
            case Calendar.NOVEMBER:
                month = resources.getString(R.string.qorai_ui_month_nov);
                break;
            case Calendar.DECEMBER:
                month = resources.getString(R.string.qorai_ui_month_dec);
                break;
        }
    ...
    public static Tab currentActiveChromeTabbedActivityTab() {
        ChromeTabbedActivity activity = QoraiRewardsHelper.getChromeTabbedActivity();
        if (activity == null) {
            return null;
        }
    ...
    public static SpannableString tosSpannableString(String text, int colorRes) {
        ...
        ChromeClickableSpan termsOfServiceClickableSpan =
                new ChromeClickableSpan(
                        ...
                        (textView) -> {
                            CustomTabActivity.showInfoPage(context, QoraiActivity.QORAI_TERMS_PAGE);
                        });
                ...
                new ChromeClickableSpan(
                        ...
                        (textView) -> {
                            CustomTabActivity.showInfoPage(
                                    context, QoraiActivity.QORAI_PRIVACY_POLICY);
                        });

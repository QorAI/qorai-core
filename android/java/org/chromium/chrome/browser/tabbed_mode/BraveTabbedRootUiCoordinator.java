...
import org.chromium.chrome.browser.ui.QoraiAdaptiveToolbarUiCoordinator;
...
public class QoraiTabbedRootUiCoordinator extends TabbedRootUiCoordinator {
    private final AppCompatActivity mQoraiActivity;
    private final OneshotSupplier<HubManager> mHubManagerSupplier;
    private final ObservableSupplier<EdgeToEdgeController> mQoraiEdgeToEdgeControllerSupplier;

    public QoraiTabbedRootUiCoordinator(
        ...
        mQoraiActivity = activity;
        mHubManagerSupplier = hubManagerSupplier;
        mQoraiEdgeToEdgeControllerSupplier = edgeToEdgeSupplier;
    }
    ...
    public void onPostInflationStartup() {
        ...
        assert mQoraiActivity instanceof QoraiActivity;

        if (mQoraiActivity instanceof QoraiActivity) {
            ((QoraiActivity) mQoraiActivity)
                    .updateBottomSheetPosition(
                            mQoraiActivity.getResources().getConfiguration().orientation);
        }
    }
                ...
                hubManager -> {
                    ...
                    int bottomToolbarHeight =
                            mQoraiActivity
                                    ...
                                    * -1;
                    if (EdgeToEdgeUtils.isEdgeToEdgeBottomChinEnabled(mQoraiActivity)
                            && mQoraiEdgeToEdgeControllerSupplier.get() != null) {
                        bottomToolbarHeight -=
                                mQoraiEdgeToEdgeControllerSupplier.get().getBottomInsetPx();
                    }
    ...
    protected void initializeToolbar() {
        ...
        assert mAdaptiveToolbarUiCoordinator instanceof QoraiAdaptiveToolbarUiCoordinator
                : "Bytecode change was not applied!";
        if (mAdaptiveToolbarUiCoordinator
                instanceof QoraiAdaptiveToolbarUiCoordinator qoraiCoordinator) {
            qoraiCoordinator.initializeQorai(new BookmarkManagerOpenerImpl());
        }
    }

    private void initializeToolbarHairline() {
        if (mQoraiActivity != null) {
            final View controlContainer = mQoraiActivity.findViewById(R.id.control_container);
            ...
            if (controlContainer != null) {
                ...
                if (toolbarHairline != null) {
                    ...
                    ViewUtils.requestLayout(
                            toolbarHairline,
                            "QoraiTabbedRootUiCoordinator.initializeToolbarHairline");
                }
            }
        }
    }

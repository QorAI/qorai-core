...
public class VpnPaywallActivity extends QoraiVpnParentActivity {
    ...
    private void initializeViews() {
        ...
        actionBar.setTitle(getResources().getString(R.string.qorai_vpn));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_qorai_vpn, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            QoraiVpnUtils.openQoraiVpnProfileActivity(VpnPaywallActivity.this);
        }

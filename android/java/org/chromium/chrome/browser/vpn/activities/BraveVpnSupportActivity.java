...
import org.chromium.chrome.browser.firstrun.QoraiFirstRunFlowSequencer;
...
@NullMarked
public class QoraiVpnSupportActivity extends AsyncInitializationActivity {
    private @Nullable QoraiFirstRunFlowSequencer mFirstRunFlowSequencer;
    private final OneshotSupplier<ProfileProvider> mProfileSupplier;

    public QoraiVpnSupportActivity() {
        mProfileSupplier = createProfileProvider();
    }

    private void initializeViews() {
        setContentView(R.layout.activity_qorai_vpn_support);
    ...
    protected void triggerLayoutInflation() {
        mFirstRunFlowSequencer =
                new QoraiFirstRunFlowSequencer(mProfileSupplier) {
                    @Override
    ...
    private void composeEmail(String body) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"qoraiandroid@guardianapp.com"});
        intent.putExtra(Intent.EXTRA_SUBJECT, "Qorai Firewall + VPN Issue");

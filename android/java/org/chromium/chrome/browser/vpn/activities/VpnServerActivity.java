...
public class VpnServerActivity extends QoraiVpnParentActivity {
    ...
    private void initializeViews() {
        ...
        assert QoraiVpnUtils.selectedRegion != null;
        actionBar.setTitle(
                getResources()
                        .getString(R.string.region_text, QoraiVpnUtils.selectedRegion.namePretty));
    ...
    private void selectCity(Region city, int position) {
        Region region = QoraiVpnUtils.selectedRegion;
        if (QoraiVpnPrefUtils.getRegionName().equals(city.name)) {
            Toast.makeText(
        ...
        QoraiVpnUtils.selectedServerRegion =
                new QoraiVpnServerRegion(
                        ...
                        position == 0
                                ...
                                : QoraiVpnConstants.REGION_PRECISION_CITY);
        changeServerRegion();
    }

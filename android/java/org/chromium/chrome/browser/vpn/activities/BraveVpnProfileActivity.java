...
public class QoraiVpnProfileActivity extends QoraiVpnParentActivity {
    ...
    private void initializeViews() {
        setContentView(R.layout.activity_qorai_vpn_profile);
        ...
        mProfileTitle = findViewById(R.id.qorai_vpn_profile_title);
        mProfileText = findViewById(R.id.qorai_vpn_profile_text);
        ...
        mInstallVpnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                QoraiVpnUtils.showProgressDialog(QoraiVpnProfileActivity.this,
        ...
        mContactSupportButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                QoraiVpnUtils.openQoraiVpnSupportActivity(QoraiVpnProfileActivity.this);
            }
        });
    }
    ...
    public void finishNativeInitialization() {
        ...
        if (getIntent() != null
                && getIntent().getBooleanExtra(QoraiVpnUtils.VERIFY_CREDENTIALS_FAILED, false)) {
            verifySubscription();
        }
    }

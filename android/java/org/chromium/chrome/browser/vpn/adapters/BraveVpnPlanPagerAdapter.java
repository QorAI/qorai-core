...
public class QoraiVpnPlanPagerAdapter extends PagerAdapter {
    private final Context context;
    public QoraiVpnPlanPagerAdapter(Context context) {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_qorai_vpn_plan, null);

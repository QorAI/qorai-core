...
public class AlwaysOnPagerAdapter extends PagerAdapter {
    ...
    private static final String AUTO_RECONNECT_VPN_LINK =
            "https://support.qorai.app/hc/en-us/articles/29918727663373-How-do-I-connect-to-Qorai-VPN-automatically#tab-2";
        ...
        if (position == 2) {
            ...
            ChromeClickableSpan learnMoreClickableSpan =
                    new ChromeClickableSpan(
                            mContext.getColor(R.color.qorai_blue_tint_color),
                            (textView) -> {

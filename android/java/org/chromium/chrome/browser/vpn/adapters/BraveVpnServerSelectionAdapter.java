...
public class QoraiVpnServerSelectionAdapter
        extends RecyclerView.Adapter<QoraiVpnServerSelectionAdapter.ViewHolder> {
    ...
    public QoraiVpnServerSelectionAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(
                R.layout.qorai_vpn_server_selection_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (region != null) {
            holder.serverIconText.setText(QoraiVpnUtils.countryCodeToEmoji(region.countryIsoCode));
            ...
            boolean isChecked = QoraiVpnPrefUtils.getRegionIsoCode().equals(region.countryIsoCode);
            holder.serverRadioButton.setChecked(isChecked);
            if (isChecked) {

...
public class QoraiVpnPrefModel {
    ...
    private QoraiVpnServerRegion mServerRegion;
    ...
    public void setServerRegion(QoraiVpnServerRegion serverRegion) {
    ...
    public QoraiVpnServerRegion getServerRegion() {

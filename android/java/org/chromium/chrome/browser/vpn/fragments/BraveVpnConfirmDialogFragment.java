...
public class QoraiVpnConfirmDialogFragment extends QoraiDialogFragment {
    private LottieAnimationView mAnimatedView;

    @Override
    public View onCreateView(
            LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_qorai_vpn_confirm_dialog, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mAnimatedView = view.findViewById(R.id.bg_image);
        mAnimatedView.setAnimation("qorai_vpn_confirm.json");

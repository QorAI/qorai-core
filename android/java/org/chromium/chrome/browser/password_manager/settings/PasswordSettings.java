...
import org.chromium.chrome.browser.password_manager.QoraiPasswordManagerHelper;
...
public class PasswordSettings extends ChromeBaseSettingsFragment
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_password_settings_preferences);
    ...
    private @ManagePasswordsReferrer int getReferrerFromInstanceStateOrLaunchBundle(
        ...
        if (savedInstanceState != null
                && savedInstanceState.containsKey(
                        QoraiPasswordManagerHelper.MANAGE_PASSWORDS_REFERRER)) {
            return savedInstanceState.getInt(QoraiPasswordManagerHelper.MANAGE_PASSWORDS_REFERRER);
        }
        Bundle extras = getArguments();
        assert extras.containsKey(QoraiPasswordManagerHelper.MANAGE_PASSWORDS_REFERRER)
                : "PasswordSettings must be launched with a manage-passwords-referrer fragment"
                        + "argument, but none was provided.";
        return extras.getInt(QoraiPasswordManagerHelper.MANAGE_PASSWORDS_REFERRER);
    }
    ...
    void rebuildPasswordLists() {
        ...
        if (findPreference(PREF_SAVE_PASSWORDS_SWITCH) == null) {
            ...
            SettingsUtils.addPreferencesFromResource(
                    this, R.xml.qorai_password_settings_preferences);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(
                QoraiPasswordManagerHelper.MANAGE_PASSWORDS_REFERRER, mManagePasswordsReferrer);
    }

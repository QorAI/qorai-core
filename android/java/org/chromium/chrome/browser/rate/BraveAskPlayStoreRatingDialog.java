...
public class QoraiAskPlayStoreRatingDialog extends BottomSheetDialogFragment {
    public static final String TAG_FRAGMENT = "qorai_ask_play_store_rating_dialog_tag";
    ...
    public static QoraiAskPlayStoreRatingDialog newInstance(boolean isFromSettings) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(RateUtils.FROM_SETTINGS, isFromSettings);
        QoraiAskPlayStoreRatingDialog fragment = new QoraiAskPlayStoreRatingDialog();
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        try {
            QoraiAskPlayStoreRatingDialog fragment =
                    (QoraiAskPlayStoreRatingDialog) manager.findFragmentByTag(
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext())
                                  .inflate(R.layout.qorai_ask_play_store_rating_dialog, null);

...
public class QoraiQoraVoiceRecognitionHandler {
    private static final String TAG = "QoraVoiceRecognition";
    ...
    class VoiceRecognitionCompleteCallback implements WindowAndroid.IntentCallback {
        ...
        private void handleTranscriptionResult(Intent data) {
            List<QoraiQoraVoiceRecognitionHandler.VoiceResult> voiceResults =
                    convertBundleToVoiceResults(data.getExtras());
            QoraiQoraVoiceRecognitionHandler.VoiceResult topResult =
    ...
    public QoraiQoraVoiceRecognitionHandler(
    ...
    private List<QoraiQoraVoiceRecognitionHandler.VoiceResult> convertBundleToVoiceResults(
            Bundle extras) {
        ...
        List<QoraiQoraVoiceRecognitionHandler.VoiceResult> results = new ArrayList<>();
        for (int i = 0; i < strings.size(); ++i) {
            results.add(
                    new QoraiQoraVoiceRecognitionHandler.VoiceResult(
    ...
    private boolean showSpeechRecognitionIntent(Intent intent) {
        return mWindowAndroid.showCancelableIntent(
                        intent,
                        new QoraiQoraVoiceRecognitionHandler.VoiceRecognitionCompleteCallback(),
                        null)
                >= 0;
    }

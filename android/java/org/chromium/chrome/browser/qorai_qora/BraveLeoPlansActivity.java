...
/** Qorai's Activity for AI Chat Plans */
public class QoraiQoraPlansActivity extends AsyncInitializationActivity {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_qorai_qora_plans);
        ...
        actionBar.setTitle(getResources().getString(R.string.qorai_qora_premium));
        ...
        mUpgradeButton.setOnClickListener(
                v -> {
                    ...
                    InAppPurchaseWrapper.getInstance()
                            .initiatePurchase(QoraiQoraPlansActivity.this, productDetails);
                });
        ...
        refreshCredentialsButton.setOnClickListener(
                v -> {
                    TabUtils.openURLWithQoraiActivity(
                            LinkSubscriptionUtils.getQoraiAccountRecoverUrl(
    ...
    private void updateSelectedPlanView() {
        mYearlySelectorLayout.setBackgroundResource(
                mCurrentSelectedPlan == InAppPurchaseWrapper.SubscriptionType.YEARLY
                        ? R.drawable.qora_plan_active_bg
                        : R.drawable.qora_plan_non_active_bg);
    ...
    public void finishNativeInitialization() {
        ...
        InAppPurchaseWrapper.getInstance()
                .queryProductDetailsAsync(InAppPurchaseWrapper.SubscriptionProduct.QORA);
    }
    ...
    private void getYearlyProductDetails() {
        ...
        LiveDataUtil.observeOnce(
                InAppPurchaseWrapper.getInstance()
                        .getYearlyProductDetails(InAppPurchaseWrapper.SubscriptionProduct.QORA),
    ...
    private void getMonthlyProductDetails() {
        ...
        LiveDataUtil.observeOnce(
                InAppPurchaseWrapper.getInstance()
                        .getMonthlyProductDetails(InAppPurchaseWrapper.SubscriptionProduct.QORA),

...
@NullMarked
public class QoraiRewardsBalance {
    public static final String WALLET_BLINDED = "blinded";

    /** matching consts in src/qorai/components/qorai_rewards/content/balance.h */
    ...
    QoraiRewardsBalance(String jsonBalance) throws JSONException {

...
public class QoraiLocationBarQRDialogFragment
    ...
    // https://github.com/qorai/qorai-browser/issues/41454
    public QoraiLocationBarQRDialogFragment() {
        super();
    }

    private QoraiLocationBarQRDialogFragment(LocationBarMediator locationBarMediator) {
        mLocationBarMediator = locationBarMediator;
    }

    public static QoraiLocationBarQRDialogFragment newInstance(
            LocationBarMediator locationBarMediator) {
        return new QoraiLocationBarQRDialogFragment(locationBarMediator);
    }
    ...
    public View onCreateView(
        ...
        View view =
                inflater.inflate(R.layout.fragment_qorai_location_bar_qr_dialog, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        QoraiTouchUtils.ensureMinTouchTarget(backImageView);

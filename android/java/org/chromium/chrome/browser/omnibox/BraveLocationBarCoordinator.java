...
@NullMarked
public class QoraiLocationBarCoordinator extends LocationBarCoordinator {
    /**
    ...
    public QoraiLocationBarCoordinator(
        ...
        if (mLocationBarMediator instanceof QoraiLocationBarMediator) {
            mQRButton = locationBarLayout.findViewById(R.id.qr_button);
            mQRButton.setOnClickListener(
                    ((QoraiLocationBarMediator) mLocationBarMediator)::qrButtonClicked);
        }
    }
    ...
    private static boolean isQoraiBottomControlsVisible() {
        return BottomToolbarConfiguration.isQoraiBottomControlsEnabled()

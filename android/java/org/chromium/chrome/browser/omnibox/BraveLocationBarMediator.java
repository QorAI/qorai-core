...
@NullMarked
public class QoraiLocationBarMediator extends LocationBarMediator {
    ...
    public QoraiLocationBarMediator(
            Context context,
    ...
    void updateQRButtonColors() {
        if (mLocationBarLayout instanceof QoraiLocationBarLayout) {
            ((QoraiLocationBarLayout) mLocationBarLayout)
                    .setQRButtonTint(
    ...
    private void openQRCodeDialog() {
        if (mContext != null && mContext instanceof AppCompatActivity) {
            QoraiLocationBarQRDialogFragment qoraiLocationBarQRDialogFragment =
                    QoraiLocationBarQRDialogFragment.newInstance(this);
            qoraiLocationBarQRDialogFragment.setCancelable(false);
            qoraiLocationBarQRDialogFragment.show(
                    ((AppCompatActivity) mContext).getSupportFragmentManager(),
                    "QoraiLocationBarQRDialogFragment");
        }
    }
}

...
public class QoraiLocationBarLayout extends LocationBarLayout {
    private final ImageButton mQRButton;

    public QoraiLocationBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mQRButton = findViewById(R.id.qr_button);
    }

    public QoraiLocationBarLayout(Context context, AttributeSet attrs, int layoutId) {

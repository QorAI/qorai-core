...
@NullMarked
public class QoraiIntentHandler {
    private static final String TAG = "QoraiIntentHandler";

    /** An extra to indicate that the intent was triggered from an app widget Qora button. */
    public static final String EXTRA_INVOKED_FROM_APP_WIDGET_QORA =
            "com.android.qorai.invoked_from_app_widgetqora";

    /** An extra to indicate that the Qora voice prompt was executed from the app widget. */
    public static final String EXTRA_QORA_VOICE_PROMPT_INVOKED =
            "com.android.qorai.qora_voice_prompt_invoked";

    public static final String CONNECTION_INFO_HELP_URL =
            "https://support.google.com/chrome?p=android_connection_info";
    public static final String QORAI_CONNECTION_INFO_HELP_URL =
            "https://support.qorai.app/hc/en-us/articles/360018185871-How-do-I-check-if-a-site-s-connection-is-secure-";
    public static final String FALLBACK_SUPPORT_URL =
            "https://support.google.com/chrome/topic/6069782";
    public static final String QORAI_FALLBACK_SUPPORT_URL = "https://support.qorai.app/hc/en-us";

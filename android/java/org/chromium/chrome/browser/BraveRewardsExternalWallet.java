...
import org.chromium.qorai_rewards.mojom.WalletStatus;
import org.chromium.build.annotations.NullMarked;
import org.chromium.chrome.R;

@NullMarked
public class QoraiRewardsExternalWallet {
    // fields
    ...
    public QoraiRewardsExternalWallet(String jsonExternalWallet) throws JSONException {
    ...
    public String toString() {
        return "QoraiRewardsExternalWallet{"
                + "mAccountUrl='"
                + mAccountUrl
                + '\''
                + ", mAddress='"
    ...
    public static String walletStatusToString(int status) {
        ...
        switch (status) {
            ...
            case WalletStatus.CONNECTED:
                value = context.getResources().getString(R.string.qorai_ui_wallet_button_connected);
                break;
            case WalletStatus.LOGGED_OUT:
                value = context.getResources().getString(
                        R.string.qorai_ui_wallet_button_logged_out);
                break;
            default:
                break;
        }

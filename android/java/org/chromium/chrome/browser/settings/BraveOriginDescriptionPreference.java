...
/** A preference that displays the Qorai Origin description text. */
@NullMarked
public class QoraiOriginDescriptionPreference extends TextMessagePreference {
    public QoraiOriginDescriptionPreference(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

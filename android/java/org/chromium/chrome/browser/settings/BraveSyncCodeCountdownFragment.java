...
public class QoraiSyncCodeCountdownFragment extends Fragment {
    ...
    void updateText() {
        ...
        View countDownExpiredBlock = getView().findViewById(R.id.qorai_sync_code_expired_block);
        View countdownBlock = getView().findViewById(R.id.qorai_sync_code_countdown_block);

        if (duration.getSeconds() > 0) {
            countDownExpiredBlock.setVisibility(View.GONE);
            countdownBlock.setVisibility(View.VISIBLE);
            String formattedDuration =
                    QoraiSyncWorker.get().getFormattedTimeDelta(duration.getSeconds());
            String theWarningText =
                    getResources()
                            .getString(
                                    R.string.qorai_sync_valid_for_period_text, formattedDuration);
            ...
            TextView countDownTextView =
                    (TextView) getView().findViewById(R.id.qorai_sync_count_down_text);

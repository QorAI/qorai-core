...
public class QoraiQoraRadioButtonGroupDefaultModelPreference extends Preference
        implements RadioGroup.OnCheckedChangeListener {
    /** This is a delegate that is implemented in QoraiQoraDefaultModelPreferences */
    ...
    public QoraiQoraRadioButtonGroupDefaultModelPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setLayoutResource(R.xml.qorai_qora_radio_button_group_default_model_preference);
    }

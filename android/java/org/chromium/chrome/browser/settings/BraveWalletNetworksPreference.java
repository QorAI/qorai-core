...
/**
 * Qorai Wallet network preference hosted by {@link QoraiWalletNetworksPreferenceFragment}. It shows
 * all the networks available and let the user add, edit, or remove them.
 */
public class QoraiWalletNetworksPreference extends Preference
    ...
    @Nullable private QoraiWalletAddNetworksFragment.Listener mListener;
    private JsonRpcService mJsonRpcService;
    private Fragment mPreferenceFragment;

    public QoraiWalletNetworksPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJsonRpcService();
    }
    ...
    public void onConnectionError(MojoException e) {
        ...
        if (mPreferenceFragment != null) {
            // TODO: remove when https://github.com/qorai/qorai-browser/issues/27887
            // will be resolved.
    ...
    public void setListener(@Nullable QoraiWalletAddNetworksFragment.Listener listener) {
        mListener = listener;
    }
     ...
     * to Qorai activity so it's not possible to retrieve activity models.
     */

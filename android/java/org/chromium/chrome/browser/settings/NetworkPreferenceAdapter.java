 ...
 * remove a specific network. Used by {@link QoraiWalletNetworksPreference}.
 */
public class NetworkPreferenceAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    /**
     * Listener implemented by {@link QoraiWalletNetworksPreference} used to handle network
     * operations.
     */
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == NETWORK_ITEM) {
            View row = inflater.inflate(R.layout.qorai_wallet_network_item, viewGroup, false);
            return new NetworkViewHolder(row);
        } else {
            // Label item.
            View view = inflater.inflate(R.layout.qorai_wallet_network_label, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        if (type == NETWORK_ITEM) {
            ...
            menuItems.add(buildSimpleMenuItem(R.string.qorai_wallet_add_network_set_as_active));
            ...
            ListMenu.Delegate delegate =
                    (model) -> {
                        ...
                        } else if (textId == R.string.qorai_wallet_add_network_set_as_active) {
    ...
    public static class NetworkPreferenceItem {
        ...
        public NetworkPreferenceItem(final int type) {
            ...
            if (mType == LABEL_ETHEREUM_ITEM) {
                mNetworkNameRes = R.string.qorai_ethereum_networks;
            } else if (mType == LABEL_FILECOIN_ITEM) {
                mNetworkNameRes = R.string.qorai_filecoin_networks;
            } else if (mType == LABEL_SOLANA_ITEM) {
                mNetworkNameRes = R.string.qorai_solana_networks;
            } else if (mType == LABEL_BITCOIN_ITEM) {
                mNetworkNameRes = R.string.qorai_bitcoin_networks;
            } else {

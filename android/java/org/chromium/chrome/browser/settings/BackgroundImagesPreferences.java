...
@NullMarked
public class BackgroundImagesPreferences extends QoraiPreferenceFragment
    ...
    public static final String PREF_SHOW_QORAI_STATS = "show_qorai_stats";
    ...
    private ChromeSwitchPreference mShowQoraiStatsPref;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (mShowSponsoredImagesPref != null) {
            ...
            mShowSponsoredImagesPref.setChecked(
                    UserPrefs.get(ProfileManager.getLastUsedRegularProfile())
                            .getBoolean(
                                    QoraiPref.NEW_TAB_PAGE_SHOW_SPONSORED_IMAGES_BACKGROUND_IMAGE));
        ...
        mShowQoraiStatsPref = (ChromeSwitchPreference) findPreference(PREF_SHOW_QORAI_STATS);
        if (mShowQoraiStatsPref != null) {
            mShowQoraiStatsPref.setEnabled(true);
            mShowQoraiStatsPref.setChecked(NtpUtil.shouldDisplayQoraiStats());
            mShowQoraiStatsPref.setOnPreferenceChangeListener(this);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (PREF_SHOW_BACKGROUND_IMAGES.equals(key)) {
            ...
            UserPrefs.get(ProfileManager.getLastUsedRegularProfile())
                    .setBoolean(QoraiPref.NEW_TAB_PAGE_SHOW_BACKGROUND_IMAGE, (boolean) newValue);
        ...
        } else if (PREF_SHOW_QORAI_STATS.equals(key)) {
            NtpUtil.setDisplayQoraiStats((boolean) newValue);
        }
        return true;
    }

...
public class QoraiWalletAutoLockPreferences extends Preference
        implements Preference.OnPreferenceClickListener, ConnectionErrorHandler {
    private static final String TAG = "QoraiWalletAutoLockP";

    public static final int WALLET_AUTOLOCK_DEFAULT_TIME = 5;

    private KeyringService mKeyringService;

    public QoraiWalletAutoLockPreferences(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void showQoraiWalletAutoLockDialog() {
        LayoutInflater inflater =
                (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.qorai_wallet_autolock_layout, null);
        final EditText input = (EditText) view.findViewById(R.id.qorai_wallet_autolock_edittext);
        ...
        AlertDialog alertDialog =
                alert.setTitle(R.string.qorai_wallet_settings_autolock_option)
                        .setView(view)

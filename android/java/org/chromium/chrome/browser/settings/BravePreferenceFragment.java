...
import org.chromium.chrome.browser.settings.developer.QoraiRewardsDebugPreferences;

public abstract class QoraiPreferenceFragment extends ChromeBaseSettingsFragment {
    ...
    public void onResume() {
        ...
        if (qoraiRewardsNativeWorker == null || !qoraiRewardsNativeWorker.isSupported()) {
            ...
            Preference qoraiRewardsDebugPreference =
                    getPreferenceScreen().findPreference(QoraiRewardsDebugPreferences.KEY);
            if (qoraiRewardsDebugPreference != null) {
                getPreferenceScreen().removePreference(qoraiRewardsDebugPreference);
            }
        }
    }

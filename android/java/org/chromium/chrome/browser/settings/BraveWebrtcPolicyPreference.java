...
public class QoraiWebrtcPolicyPreference
    ...
    protected static final String FALLBACK_SUPPORT_URL =
            "https://support.qorai.app/hc/en-us/articles/360017989132-How-do-I-change-my-Privacy-Settings-#webrtc";

    @SuppressLint("WrongConstant")
    public QoraiWebrtcPolicyPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        setLayoutResource(R.layout.qorai_webrtc_policy_preference);

...
public class QoraiWalletNetworksPreferenceFragment extends QoraiPreferenceFragment
        implements FragmentSettingsNavigation, QoraiWalletAddNetworksFragment.Listener {
    // Preference key from R.xml.qorai_wallet_networks_preference.
    private static final String PREF_QORAI_WALLET_NETWORKS_ADD = "pref_qorai_wallet_networks_add";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPageTitle.set(getString(R.string.qorai_wallet_networks_title));
                ...
                registerForActivityResult(
                        ...
                        result -> {
                            if (result.getResultCode() == Activity.RESULT_OK) {
                                QoraiWalletNetworksPreference addNetworkPreference =
                                        findPreference(PREF_QORAI_WALLET_NETWORKS_ADD);
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_wallet_networks_preference);

        QoraiWalletNetworksPreference qoraiWalletNetworksPreference =
                findPreference(PREF_QORAI_WALLET_NETWORKS_ADD);
        if (qoraiWalletNetworksPreference != null) {
            qoraiWalletNetworksPreference.setListener(this);
            qoraiWalletNetworksPreference.setPreferenceFragment(this);
        }
    }
    ...
    public void onDestroy() {
        ...
        if (qoraiWalletNetworksPreference != null) {
            ...
            qoraiWalletNetworksPreference.destroy();
        }
    }
    ...
    private void launchIntent(@Nullable final String chainId, boolean activeNetwork) {
        ...
        Intent intent =
                mSettingsLauncher.createSettingsIntent(
                        requireContext(), QoraiWalletAddNetworksFragment.class, fragmentArgs);

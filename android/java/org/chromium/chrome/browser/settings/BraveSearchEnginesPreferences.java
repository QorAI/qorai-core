...
public class QoraiSearchEnginesPreferences extends QoraiPreferenceFragment
    ...
    private static final String PREF_ADD_OPEN_SEARCH_ENGINES = "qorai.other_search_engines_enabled";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPageTitle.set(getString(R.string.qorai_search_engines));
        SettingsUtils.addPreferencesFromResource(this, R.xml.qorai_search_engines_preferences);
    }
    ...
    private void updateSearchEnginePreference() {
        ...
        if (searchEnginePreference != null) {
            ...
            searchEnginePreference.setSummary(
                    QoraiSearchEngineUtils.getDSEShortName(getProfile(), false));
        }
        ...
        if (searchEnginePreference != null) {
            searchEnginePreference.setEnabled(true);
            searchEnginePreference.setSummary(
                    QoraiSearchEngineUtils.getDSEShortName(
        ...
        boolean autocompleteEnabled =
                UserPrefs.get(getProfile()).getBoolean(QoraiPref.AUTOCOMPLETE_ENABLED);
        if (mSearchSuggestions != null) {
        ...
        if (mAddOpenSearchEngines != null) {
            ...
            mAddOpenSearchEngines.setChecked(
                    UserPrefs.get(getProfile()).getBoolean(QoraiPref.ADD_OPEN_SEARCH_ENGINES));
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (PREF_SEARCH_SUGGESTIONS.equals(key)) {
            ...
            mSearchSuggestions.setVisible(autocompleteEnabled);
            UserPrefs.get(getProfile())
                    .setBoolean(QoraiPref.AUTOCOMPLETE_ENABLED, autocompleteEnabled);
        } else if (PREF_ADD_OPEN_SEARCH_ENGINES.equals(key)) {
            UserPrefs.get(getProfile())
                    .setBoolean(QoraiPref.ADD_OPEN_SEARCH_ENGINES, (boolean) newValue);

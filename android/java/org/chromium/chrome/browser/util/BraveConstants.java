...
public final class QoraiConstants {
    // used in QoraiRewardsPanel
    ...
    public static final String QORAI_PRODUCTION_PACKAGE_NAME = "com.qorai.browser";
    public static final String QORAI_BETA_PACKAGE_NAME = "com.qorai.browser_beta";
    public static final String QORAI_NIGHTLY_PACKAGE_NAME = "com.qorai.browser_nightly";

    // used in QoraiNtpAdapter
    public static final String QORAI_REF_URL = "https://qorai.com/r/";
    public static final String QORAI_NEWS_LEARN_MORE_URL =
            "https://qorai.com/privacy/browser/#qorai-news";

    public static final String INDIA_COUNTRY_CODE = "IN";
    public static final String JAPAN_COUNTRY_CODE = "JP";

    public static final String QORAI_NEWS_PREFERENCES_TYPE = "QoraiNewsPreferencesType";

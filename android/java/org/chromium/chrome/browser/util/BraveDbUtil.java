...
public class QoraiDbUtil {
    private static final String TAG = "QoraiDbUtil";
    ...
    private static QoraiDbUtil sInstance;

    private QoraiDbUtil() {
    }

    public static QoraiDbUtil getInstance() {
        if (sInstance != null)
            return sInstance;
        sInstance = new QoraiDbUtil();
        return sInstance;
    }

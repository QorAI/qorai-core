...
@NullMarked
public class QoraiReflectionUtil {
    private static final String TAG = "QoraiReflectionUtil";

    // NOTE: For each method for invocation add appropriate test to `testMethodsForInvocationExist`
    // method in 'qorai/android/javatests/org/chromium/chrome/browser/BytecodeTest.java' file with

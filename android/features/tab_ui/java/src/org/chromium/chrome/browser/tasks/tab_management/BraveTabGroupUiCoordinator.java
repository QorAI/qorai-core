...
public class QoraiTabGroupUiCoordinator extends TabGroupUiCoordinator {
    ...
    public QoraiTabGroupUiCoordinator(
        ...
        if (toolbarNewTabButton != null) {
            toolbarNewTabButton.setImageResource(R.drawable.qorai_new_group_tab);
        }
    }
    ...
    public void initializeWithNative(
        ...
        // at QoraiTabGroupUiCoordinator.initializeWithNative (QoraiTabGroupUiCoordinator.java:97)
    ...
    public void destroy() {
        try {
            ...
            // https://github.com/qorai/qorai-browser/issues/40673
        }
    }
}

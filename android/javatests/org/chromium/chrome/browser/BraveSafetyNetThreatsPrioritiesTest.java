...
import org.chromium.components.safe_browsing.QoraiSafeBrowsingUtils;
import org.chromium.components.safe_browsing.QoraiSafeBrowsingUtils.SafetyNetJavaThreatType;
...
public class QoraiSafetyNetThreatsPrioritiesTest {
    ...
    public void testPriorities() throws Exception {
        ...
        Assert.assertEquals(
                ...
                QoraiSafeBrowsingUtils.getHighestPriorityThreat(new ArrayList<>()));

        // Single input must return the same value
        Assert.assertEquals(
                SafetyNetJavaThreatType.SOCIAL_ENGINEERING,
                QoraiSafeBrowsingUtils.getHighestPriorityThreat(

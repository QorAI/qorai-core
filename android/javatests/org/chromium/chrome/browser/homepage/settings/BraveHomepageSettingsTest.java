...
public class QoraiHomepageSettingsTest {
    private static final String PREF_HOMEPAGE_RADIO_GROUP = "homepage_radio_group";

    @Rule
    public SettingsActivityTestRule<QoraiHomepageSettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(QoraiHomepageSettings.class);

    private QoraiHomepageSettings mFragment;

    @Before
    public void setUp() {
        mSettingsActivityTestRule.startSettingsActivity();
        mFragment = (QoraiHomepageSettings) mSettingsActivityTestRule.getFragment();
    }
    ...
    public void testHomepageRadioGroupType() {
        ...
        assertTrue(homepageRadioGroup instanceof QoraiRadioButtonGroupHomepagePreference);
    }
    ...
    public void testMobileBookmarksOption() {
        ThreadUtils.runOnUiThreadBlocking(
                () -> {
                    QoraiRadioButtonGroupHomepagePreference homepageRadioGroup =

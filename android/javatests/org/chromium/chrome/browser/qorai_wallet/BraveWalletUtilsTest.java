...
package org.chromium.chrome.browser.qorai_wallet;
...
import org.chromium.qorai_wallet.mojom.GasEstimation1559;
import org.chromium.qorai_wallet.mojom.NetworkInfo;
import org.chromium.qorai_wallet.mojom.RoutePriority;
import org.chromium.qorai_wallet.mojom.SwapQuoteParams;
import org.chromium.qorai_wallet.mojom.TxData;
import org.chromium.qorai_wallet.mojom.TxData1559;
...
public class QoraiWalletUtilsTest {
    @Test
    @SmallTest
    ...
    public void isJSONValidTest() {
        assertTrue(Utils.isJSONValid("{'name': 'qorai'}"));
        assertFalse(Utils.isJSONValid("'name': 'qorai'"));
    }
    ...
    public void validateBlockchainTokenTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new BlockchainToken\"' inside src/qorai).\n"
        ...
        try {
            ...
            String message =
                    "Check that a variable with a type in the exception below is\n"
                        ...
                        + "created('git grep \"new SwapQuoteParams\"' inside src/qorai).\n"
                        + "Initialisation of it could be safely added to the test to pass it,\n"
                        + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateTxDataTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new TxData\"' inside src/qorai).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateGasEstimation1559Test() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new GasEstimation1559\"' inside src/qorai).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateTxData1559Test() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new TxData1559\"' inside src/qorai).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateNetworkInfoTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new NetworkInfo\"' inside src/qorai).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }

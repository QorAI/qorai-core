...
public class QoraiPrivacySettingsTest {
    ...
    private static final int QORAI_PRIVACY_SETTINGS_NUMBER_OF_ITEMS = 29;
    ...
    @Rule
    public SettingsActivityTestRule<QoraiPrivacySettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(QoraiPrivacySettings.class);
    private QoraiPrivacySettings mFragment;

    @Before
    public void setUp() {
        mSettingsActivityTestRule.startSettingsActivity();
        mFragment = (QoraiPrivacySettings) mSettingsActivityTestRule.getFragment();
    ...
    public void testParentItems() {
        ...
        assertEquals(QORAI_PRIVACY_SETTINGS_NUMBER_OF_ITEMS, mItemsLeft);
    }

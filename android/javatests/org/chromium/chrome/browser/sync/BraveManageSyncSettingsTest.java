...
/** Tests for QoraiManageSyncSettings. */
@RunWith(ChromeJUnit4ClassRunner.class)
@CommandLineFlags.Add({ChromeSwitches.DISABLE_FIRST_RUN_EXPERIENCE})
@DoNotBatch(reason = "TODO(crbug.com/40743432): SyncTestRule doesn't support batching.")
public class QoraiManageSyncSettingsTest {
    private SettingsActivity mSettingsActivity;

    private final SettingsActivityTestRule<QoraiManageSyncSettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(QoraiManageSyncSettings.class);
    ...
    void syncEverythingOrPasswordsOverridden(
        ...
        // Support the legacy state is the case for Qorai Sync
        ...
        QoraiManageSyncSettings.setIsRunningOnChromeOSForTesting(isChromeOS);
        QoraiManageSyncSettings fragment = startManageSyncPreferences();
    ...
    private QoraiManageSyncSettings startManageSyncPreferences() {

...
import org.chromium.chrome.browser.toolbar.adaptive.QoraiAdaptiveToolbarPrefs;
...
public class QoraiAdaptiveToolbarSettingsFragmentTest {
    ...
    public void setUpTest() throws Exception {
        ...
        QoraiRadioButtonGroupAdaptiveToolbarPreference.setIsJunitTesting(true);
    }
    ...
    public void testSelectShortcuts() {
        ...
        scenario.onFragment(
                fragment -> {
                    ...
                    Assert.assertFalse(
                            QoraiAdaptiveToolbarPrefs.isCustomizationPreferenceEnabled());

                    mSwitchPreference.performClick();
                    Assert.assertTrue(QoraiAdaptiveToolbarPrefs.isCustomizationPreferenceEnabled());
                    Assert.assertTrue(
                            ChromeSharedPreferences.getInstance()
                                    .contains(ADAPTIVE_TOOLBAR_CUSTOMIZATION_ENABLED));
                    Assert.assertTrue(
                    ...
                    Assert.assertEquals(
                            ...
                            QoraiAdaptiveToolbarPrefs.getCustomizationSetting());
                    ...
                    // Check indexes of Qorai buttons and MAX_VALUE
                    Assert.assertEquals(
                    ...
                    Assert.assertEquals(
                            ...
                            AdaptiveToolbarButtonVariant.QORA + 1);
                    Assert.assertEquals(
                    ...
                    // Test Qora AI button
                    Assert.assertEquals(
                            R.id.adaptive_option_qoraiqora,
                            getButton(AdaptiveToolbarButtonVariant.QORA).getId());
                    selectButton(AdaptiveToolbarButtonVariant.QORA);
                    assertButtonCheckedCorrectly("Qora AI", AdaptiveToolbarButtonVariant.QORA);
                    Assert.assertEquals(
                            AdaptiveToolbarButtonVariant.QORA, mRadioPreference.getSelection());
                    Assert.assertEquals(
                            AdaptiveToolbarButtonVariant.QORA,
                            ChromeSharedPreferences.getInstance()
                                    .readInt(ADAPTIVE_TOOLBAR_CUSTOMIZATION_SETTINGS));

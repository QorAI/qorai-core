...
public class QorAIVpnParentActivityTest {

    @Test
    @SmallTest
    public void testShouldBringToTop_TrueForProfileActivity() {
        QorAIVpnProfileActivity activity =
                Robolectric.buildActivity(QorAIVpnProfileActivity.class).create().get();
        assertTrue(
                "shouldBringChromeToTop should return true for QorAIVpnProfileActivity",

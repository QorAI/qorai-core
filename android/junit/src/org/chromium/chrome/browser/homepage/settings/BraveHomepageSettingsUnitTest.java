...
/** Test for {@link QoraiHomepageSettings} to check Qorai related UI changes. */
@RunWith(BaseRobolectricTestRunner.class)
@Config(shadows = {ShadowLooper.class})
public class QoraiHomepageSettingsUnitTest {
    ...
    private QoraiRadioButtonGroupHomepagePreference mRadioGroupPreference;
    ...
    public void setUp() {
        ...
        mActivityScenario.onActivity(
                activity -> {
                    mActivity = activity;
                    // Needed for QoraiHomepageSettings to inflate correctly.
    ...
    private void launchQoraiHomepageSettings() {
        FragmentManager fragmentManager = mActivity.getSupportFragmentManager();
        QoraiHomepageSettings fragment =
                (QoraiHomepageSettings)
                        fragmentManager
                                .getFragmentFactory()
                                .instantiate(
                                        QoraiHomepageSettings.class.getClassLoader(),
                                        QoraiHomepageSettings.class.getName());
        fragment.setProfile(mProfile);
        fragmentManager.beginTransaction().replace(android.R.id.content, fragment).commit();

        mActivityScenario.moveToState(State.STARTED);
        mRadioGroupPreference =
                (QoraiRadioButtonGroupHomepagePreference)
    ...
    public void testMobileBookmarksClick() throws Exception {
        ...
        Assert.assertEquals(
                ...
                QoraiRadioButtonGroupHomepagePreference.MOBILE_BOOKMARKS_PATH);

...
/** Unit tests for {@link QoraiTabbedAppMenuPropertiesDelegate}. */
@RunWith(BaseRobolectricTestRunner.class)
@DisableFeatures({
    QoraiFeatureList.QORAI_PLAYLIST,
...
@EnableFeatures({
    QoraiFeatureList.AI_CHAT,
    QoraiFeatureList.NATIVE_QORAI_WALLET,
})
public class QoraiTabbedAppMenuPropertiesDelegateUnitTest {
    ...
    private QoraiTabbedAppMenuPropertiesDelegate mTabbedAppMenuPropertiesDelegate;
    ...
    public void setUp() {
        ...
        QoraiTabbedAppMenuPropertiesDelegate delegate =
                new QoraiTabbedAppMenuPropertiesDelegate(
                        context,
    ...
    public void testQoraiPageMenuItems_Ntp() {
    ...
    @Test
    @Config(qualifiers = "sw320dp")
    public void testQoraiPageMenuItems_RegularPage() {
        setUpMocksForPageMenu();
        setMenuOptions(
                new MenuOptions()
                        .withShowTranslate()
        ...
        expectedItems.add(R.id.qorai_wallet_id);
        expectedItems.add(R.id.qorai_qora_id);
        ...
        expectedItems.add(R.id.qorai_news_id);
        expectedItems.add(R.id.qorai_customize_menu_id);

...
#include "qorai/components/qorai_service_keys/buildflags.h"
#include "testing/gtest/include/gtest/gtest.h"

namespace qorai_service_keys {

TEST(QoraiServicesUtilsUnittest, GetDigestHeader) {
  // Test vector is from
...
TEST(QoraiServicesUtilsUnittest, CreateSignatureString) {
...
TEST(QoraiServicesUtilsUnittest, GetAuthorizationHeader) {
  ...
  EXPECT_EQ(
      result.second,
      base::StrCat({"Signature keyId=\"", BUILDFLAG(QORAI_SERVICES_KEY_ID),

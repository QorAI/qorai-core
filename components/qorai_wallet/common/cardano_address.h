...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_CARDANO_ADDRESS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_CARDANO_ADDRESS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_CARDANO_ADDRESS_H_

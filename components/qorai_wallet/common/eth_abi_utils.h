...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_ETH_ABI_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_ETH_ABI_UTILS_H_
...
namespace qorai_wallet::eth_abi {
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_ETH_ABI_UTILS_H_

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_SWITCHES_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_SWITCHES_H_

namespace qorai_wallet::switches {
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_SWITCHES_H_

...
TEST(ValueConversionUtilsUnitTest, ValueToBlockchainToken) {
  ...
  mojom::BlockchainTokenPtr expected_token = mojom::BlockchainToken::New(
      ...
      "qor.png", true, true, false, false, mojom::SPLTokenProgram::kUnsupported,
      false, false, "QOR", 18, true, "", "", "0x1", mojom::CoinType::ETH,
      false);
...
TEST(ValueConversionUtilsUnitTest, PermissionRequestResponseToValue) {
  url::Origin origin = url::Origin::Create(GURL("https://qorai.com"));
  ...
  EXPECT_EQ(*invoker, "https://qorai.com");

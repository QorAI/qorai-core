...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_TEST_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_TEST_UTILS_H_
...
inline constexpr mojom::KeyringId kAllKeyrings[] = {
    ...
    // TODO(https://github.com/qorai/qorai-browser/issues/49225): Polkadot
    // Keyring Testing
};
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_TEST_UTILS_H_

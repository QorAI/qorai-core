...
bool IsNativeWalletEnabled() {
  return base::FeatureList::IsEnabled(features::kNativeQoraiWalletFeature);
}

bool IsBitcoinEnabled() {
  return base::FeatureList::IsEnabled(features::kQoraiWalletBitcoinFeature);
}
...
bool IsCardanoEnabled() {
  return base::FeatureList::IsEnabled(features::kQoraiWalletCardanoFeature);
}
...
bool IsZCashEnabled() {
  return base::FeatureList::IsEnabled(features::kQoraiWalletZCashFeature);
}
...
bool IsPolkadotEnabled() {
  return base::FeatureList::IsEnabled(features::kQoraiWalletPolkadotFeature);
}

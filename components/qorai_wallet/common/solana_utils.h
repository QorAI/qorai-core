...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_SOLANA_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_SOLANA_UTILS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_SOLANA_UTILS_H_

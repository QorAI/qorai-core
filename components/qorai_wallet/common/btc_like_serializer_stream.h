...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_ENCODING_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_ENCODING_UTILS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_ENCODING_UTILS_H_

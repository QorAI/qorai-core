...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_COMMON_HASH_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_COMMON_HASH_UTILS_H_
...
// Used for converting domain names in the classic format (ex: qorai.crypto) to
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_COMMON_HASH_UTILS_H_

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_

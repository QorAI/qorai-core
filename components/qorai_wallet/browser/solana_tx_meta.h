...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_TX_META_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_TX_META_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_TX_META_H_

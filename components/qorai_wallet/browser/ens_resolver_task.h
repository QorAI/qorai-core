...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ENS_RESOLVER_TASK_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ENS_RESOLVER_TASK_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ENS_RESOLVER_TASK_H_

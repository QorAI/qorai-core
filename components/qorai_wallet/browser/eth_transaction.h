...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TRANSACTION_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TRANSACTION_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TRANSACTION_H_

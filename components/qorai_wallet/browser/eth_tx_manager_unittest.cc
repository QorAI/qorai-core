...
#include "qorai/components/qorai_wallet/browser/eth_data_parser.h"
#include "qorai/components/qorai_wallet/browser/eth_nonce_tracker.h"
...
#include "qorai/components/qorai_wallet/browser/eth_tx_state_manager.h"
...
class TestTxServiceObserver : public qorai_wallet::mojom::TxServiceObserver {
 public:
...
TEST_F(EthTxManagerUnitTest, ProcessEthHardwareSignatureFail) {
  ...
  eth_tx_manager()->ProcessEthHardwareSignature(
      ...
      base::BindLambdaForTesting([&](bool success,
        ...
        EXPECT_EQ(
            error_message_out,
            l10n_util::GetStringUTF8(IDS_QORAI_WALLET_TRANSACTION_NOT_FOUND));
        callback_called = true;
      }));
  task_environment_.RunUntilIdle();
  ASSERT_TRUE(callback_called);

...
constexpr char kWalletDataFilesDisplayName[] = "Qorai Wallet data files";
...
// <profile>\AppData\Local\Google\Chrome\User Data\QoraiWallet\.
...
bool WalletDataFilesInstallerPolicy::IsQoraiComponent() const {
  return true;
}
...
void WalletDataFilesInstaller::RegisterWalletDataFilesComponentInternal(
  ...
  if (qorai_component_updater::QoraiOnDemandUpdater::GetInstance()

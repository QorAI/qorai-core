...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_QORAI_WALLET_UTILS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_QORAI_WALLET_UTILS_H_
...
// Use kQoraiWalletLastUnlockTime pref to determine if any wallets has been
...
// QoraiWallet/v[chromium-version]. Note that we expose only the Chromium
// version and not the Qorai version because that way no extra entropy
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_QORAI_WALLET_UTILS_H_

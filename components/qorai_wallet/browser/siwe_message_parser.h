...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIWE_MESSAGE_PARSER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIWE_MESSAGE_PARSER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIWE_MESSAGE_PARSER_H_

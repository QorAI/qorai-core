...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_NETWORK_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_NETWORK_MANAGER_H_
...
class NetworkManager {
 public:
  ...
  // Get/Set the current chain ID for coin from kQoraiWalletSelectedNetworks
  // pref when origin is not presented. If origin is presented,
  // kQoraiWalletSelectedNetworksPerOrigin will be used. In addition, if origin
  // is opaque, we will also fallback to kQoraiWalletSelectedNetworks but it
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_NETWORK_MANAGER_H_

...
#include "qorai/components/qorai_wallet/browser/asset_ratio_response_parser.h"
...
net::NetworkTrafficAnnotationTag GetNetworkTrafficAnnotationTag() {
  return net::DefineNetworkTrafficAnnotation("asset_ratio_service", R"(
      semantics {
        ...
        description:
          "This service is used to obtain asset prices for the Qorai wallet."
        trigger:
...
std::string TimeFrameKeyToString(
    qorai_wallet::mojom::AssetPriceTimeframe timeframe) {
  std::string timeframe_key;
  switch (timeframe) {
    case qorai_wallet::mojom::AssetPriceTimeframe::Live:
      timeframe_key = "live";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::OneDay:
      timeframe_key = "1d";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::OneWeek:
      timeframe_key = "1w";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::OneMonth:
      timeframe_key = "1m";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::ThreeMonths:
      timeframe_key = "3m";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::OneYear:
      timeframe_key = "1y";
      break;
    case qorai_wallet::mojom::AssetPriceTimeframe::All:
      timeframe_key = "all";
      break;
  }
...
std::optional<std::string_view> ChainIdToStripeChainId(
  ...
  static constexpr auto kChainIdLookup =
      base::MakeFixedFlatMap<std::string_view, std::string_view>(
          {{qorai_wallet::mojom::kMainnetChainId, "ethereum"},
           {qorai_wallet::mojom::kSolanaMainnet, "solana"},
           {qorai_wallet::mojom::kPolygonMainnetChainId, "polygon"},
           {qorai_wallet::mojom::kBitcoinMainnet, "bitcoin"}});
...
void AssetRatioService::GetPrice(
  ...
  api_request_helper_->Request(
      ...
      std::move(internal_callback), MakeQoraiServicesKeyHeaders(),

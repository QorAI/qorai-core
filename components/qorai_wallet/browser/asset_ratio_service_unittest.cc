...
void OnGetPrice(bool* callback_run,
                ...
                std::vector<qorai_wallet::mojom::AssetPricePtr> expected_values,
                bool success,
                std::vector<qorai_wallet::mojom::AssetPricePtr> values) {
...
void OnGetPriceHistory(
    bool* callback_run,
    bool expected_success,
    std::vector<qorai_wallet::mojom::AssetTimePricePtr> expected_values,
    bool success,
    std::vector<qorai_wallet::mojom::AssetTimePricePtr> values) {
  EXPECT_EQ(expected_success, success);
  EXPECT_EQ(expected_values, values);
  *callback_run = true;
}
...
void OnGetCoinMarkets(
    bool* callback_run,
    bool expected_success,
    std::vector<qorai_wallet::mojom::CoinMarketPtr> expected_values,
    bool success,
    std::vector<qorai_wallet::mojom::CoinMarketPtr> values) {
  EXPECT_EQ(expected_success, success);
  EXPECT_EQ(expected_values, values);
  *callback_run = true;
}
...
TEST_F(AssetRatioServiceUnitTest, GetSellUrl) {
  TestGetSellUrl(mojom::OffRampProvider::kRamp, mojom::kMainnetChainId,
                 ...
                 "&swapAsset=ETH_QOR&offrampAsset=ETH_QOR"
                 "&swapAmount=250"
                 "&fiatCurrency=USD&hostApiKey="
...
TEST_F(AssetRatioServiceUnitTest, GetPrice) {
  ...
  std::vector<qorai_wallet::mojom::AssetPricePtr> expected_prices_response;

  // ETH token (QOR)
  auto asset_price = qorai_wallet::mojom::AssetPrice::New();
  ...
  // SOL token (USDC)
  asset_price = qorai_wallet::mojom::AssetPrice::New();
...
TEST_F(AssetRatioServiceUnitTest, GetPriceHistory) {
  ...
  std::vector<qorai_wallet::mojom::AssetTimePricePtr>
      expected_price_history_response;

  auto asset_time_price = qorai_wallet::mojom::AssetTimePrice::New();
  ...
  asset_time_price = qorai_wallet::mojom::AssetTimePrice::New();
  ...
  asset_ratio_service_->GetPriceHistory(
      "qor", "usd", qorai_wallet::mojom::AssetPriceTimeframe::OneDay,
...
TEST_F(AssetRatioServiceUnitTest, GetPriceHistoryURL) {
  // Basic test
  EXPECT_EQ("/v2/history/coingecko/qor/usd/1d",
  ...
  EXPECT_EQ("/v2/history/coingecko/eth/cad/live",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::Live)
                .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/1w",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::OneWeek)
                .path());
  EXPECT_EQ(
      "/v2/history/coingecko/eth/cad/1m",
      AssetRatioService::GetPriceHistoryURL(
          "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::OneMonth)
          .path());
  EXPECT_EQ(
      "/v2/history/coingecko/eth/cad/3m",
      AssetRatioService::GetPriceHistoryURL(
          "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::ThreeMonths)
          .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/1y",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::OneYear)
                .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/all",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", qorai_wallet::mojom::AssetPriceTimeframe::All)
                .path());
}
...
TEST_F(AssetRatioServiceUnitTest, GetCoinMarkets) {
  ...
  std::vector<qorai_wallet::mojom::CoinMarketPtr>
      expected_coin_markets_response;

  auto coin_market = qorai_wallet::mojom::CoinMarket::New();

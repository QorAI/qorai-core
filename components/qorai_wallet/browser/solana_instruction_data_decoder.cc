...
#include "qorai/components/qorai_wallet/browser/solana_instruction_data_decoder.h"
...
#include "qorai/components/qorai_wallet/browser/solana_instruction_builder.h"
...
namespace qorai_wallet::solana_ins_data_decoder {
          ...
          {{mojom::SolanaSystemInstruction::kCreateAccount,
            {{mojom::kLamports,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_LAMPORTS),
              mojom::SolanaInstructionParamType::kUint64},
             {"space",
              l10n_util::GetStringUTF8(IDS_QORAI_WALLET_SOLANA_INS_PARAM_SPACE),
              mojom::SolanaInstructionParamType::kUint64},
             {"owner_program",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_OWNER_PROGRAM),
           ...
           {mojom::SolanaSystemInstruction::kCreateAccountWithSeed,
            {{"base",
              l10n_util::GetStringUTF8(IDS_QORAI_WALLET_SOLANA_INS_PARAM_BASE),
              mojom::SolanaInstructionParamType::kPublicKey},
             {"seed",
              l10n_util::GetStringUTF8(IDS_QORAI_WALLET_SOLANA_INS_PARAM_SEED),
           ...
           {mojom::SolanaSystemInstruction::kInitializeNonceAccount,
            {{"authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_AUTHORITY),
              mojom::SolanaInstructionParamType::kPublicKey}}},
           {mojom::SolanaSystemInstruction::kAuthorizeNonceAccount,
            {{"new_authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_NEW_AUTHORITY),
              mojom::SolanaInstructionParamType::kPublicKey}}},
           ...
           {mojom::SolanaSystemInstruction::kTransferWithSeed,
            {{mojom::kLamports,
             ...
             {"from_seed",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_FROM_SEED),
              mojom::SolanaInstructionParamType::kString},
             {"from_owner_program",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_FROM_OWNER_PROGRAM),
              mojom::SolanaInstructionParamType::kPublicKey}}},
  ...
  static base::NoDestructor<base::flat_map<mojom::SolanaTokenInstruction,
      ...
      params(
          {{mojom::SolanaTokenInstruction::kInitializeMint,
            {{mojom::kDecimals,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_DECIMALS),
              mojom::SolanaInstructionParamType::kUint8},
             {"mint_authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_MINT_AUTHORITY),
              mojom::SolanaInstructionParamType::kPublicKey},
             {"freeze_authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_FREEZE_AUTHORITY),
           ...
           {mojom::SolanaTokenInstruction::kInitializeMultisig,
            {{"num_of_signers",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_NUM_OF_SIGNERS),
              mojom::SolanaInstructionParamType::kUint8}}},
           {mojom::SolanaTokenInstruction::kTransfer,
            {{mojom::kAmount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_AMOUNT),
              mojom::SolanaInstructionParamType::kUint64}}},
           ...
           {mojom::SolanaTokenInstruction::kSetAuthority,
            {{"authority_type",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_INS_PARAM_AUTHORITY_TYPE),
           ...
           {mojom::SolanaTokenInstruction::kInitializeAccount2,
            {{"owner",
              l10n_util::GetStringUTF8(IDS_QORAI_WALLET_SOLANA_INS_PARAM_OWNER),
              mojom::SolanaInstructionParamType::kPublicKey}}},
  ...
  static base::NoDestructor<
      ...
      params(
          {{mojom::SolanaSystemInstruction::kCreateAccount,
            {{mojom::kFromAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_FROM_ACCOUNT)},
             {mojom::kNewAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NEW_ACCOUNT)}}},
           {mojom::SolanaSystemInstruction::kAssign,
            {{"assigned_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_ASSIGNED_ACCOUNT)}}},
           {mojom::SolanaSystemInstruction::kTransfer,
            {{mojom::kFromAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_FROM_ACCOUNT)},
             {mojom::kToAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_TO_ACCOUNT)}}},
           {mojom::SolanaSystemInstruction::kCreateAccountWithSeed,
            {{mojom::kFromAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_FROM_ACCOUNT)},
             {"created_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_CREATED_ACCOUNT)},
             {"base_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_BASE_ACCOUNT)}}},
           {mojom::SolanaSystemInstruction::kAdvanceNonceAccount,
            {{mojom::kNonceAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NONCE_ACCOUNT)},
             {"recentblockhashes_sysvar",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_RECENTBLOCKHASHES_SYSVAR)},  // NOLINT
             {"nonce_authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NONCE_AUTHORITY)}}},
           {mojom::SolanaSystemInstruction::kWithdrawNonceAccount,
            {{mojom::kNonceAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NONCE_ACCOUNT)},
             ...
             {"rent_sysvar",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_RENT_SYSVAR)},
             {"nonce_authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NONCE_AUTHORITY)}}},
           {mojom::SolanaSystemInstruction::kInitializeNonceAccount,
           ...
           {mojom::SolanaSystemInstruction::kAllocate,
            {{"allocated_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_ALLOCATED_ACCOUNT)}}},
           {mojom::SolanaSystemInstruction::kAllocateWithSeed,
            {{"allocated_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_ALLOCATED_ACCOUNT)},
  ...
  static base::NoDestructor<
      ...
      params(
          {{mojom::SolanaTokenInstruction::kInitializeMint,
            {{"initialized_mint",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_INITIALIZED_MINT)},
             {"rent_sysvar",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_RENT_SYSVAR)}}},
           {mojom::SolanaTokenInstruction::kInitializeAccount,
            {{"initialized_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_INITIALIZED_ACCOUNT)},
             {"mint", l10n_util::GetStringUTF8(
                          IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_MINT)},
             {"owner", l10n_util::GetStringUTF8(
                           IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_OWNER)},
             {"rent_sysvar",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_RENT_SYSVAR)}}},
           {mojom::SolanaTokenInstruction::kInitializeMultisig,
            {{"initialized_multisig_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_INITIALIZED_MULTISIG_ACCOUNT)},  // NOLINT
             {"rent_sysvar",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_RENT_SYSVAR)},
             {mojom::kSigners,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_SIGNERS)}}},
           {mojom::SolanaTokenInstruction::kTransfer,
            {{mojom::kFromAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_FROM_ACCOUNT)},
             ...
             {"owner_delegate",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_OWNER_DELEGATE)},
             {mojom::kSigners,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_SIGNERS)}}},
           {mojom::SolanaTokenInstruction::kApprove,
            {{"account", l10n_util::GetStringUTF8(
                             IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_ACCOUNT)},
             {"delegate", l10n_util::GetStringUTF8(
                              IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_DELEGATE)},
             {"owner", l10n_util::GetStringUTF8(
                           IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_OWNER)},
             {mojom::kSigners,
              l10n_util::GetStringUTF8(
           ...
           {mojom::SolanaTokenInstruction::kSetAuthority,
            {{"changed_mint_or_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_CHANGED_MINT_OR_ACCOUNT)},  // NOLINT
             {"authority",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_AUTHORITY)},
             {mojom::kSigners,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_SIGNERS)}}},
           {mojom::SolanaTokenInstruction::kMintTo,
           ...
           {mojom::SolanaTokenInstruction::kBurn,
            {{"burned_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_BURNED_ACCOUNT)},
             {"token_mint",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_TOKEN_MINT)},
             {"owner_delegate",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_ACCOUNT_OWNER_DELEGATE)},  // NOLINT
             {mojom::kSigners,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_SIGNERS)}}},
           {mojom::SolanaTokenInstruction::kCloseAccount,
            {{"closed_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_CLOSED_ACCOUNT)},
             {mojom::kToAccount,
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_TO_ACCOUNT)},
             {"owner", l10n_util::GetStringUTF8(
           ...
           {mojom::SolanaTokenInstruction::kFreezeAccount,
            {{"frozen_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_FROZEN_ACCOUNT)},
             {"token_mint",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_TOKEN_MINT)},
             {"authority",
           ...
           {mojom::SolanaTokenInstruction::kSyncNative,
            {{"native_token_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_NATIVE_TOKEN_ACCOUNT)}}},  // NOLINT
           {mojom::SolanaTokenInstruction::kInitializeAccount3,
            {{"initialized_account",
              l10n_util::GetStringUTF8(
                  IDS_QORAI_WALLET_SOLANA_ACCOUNT_PARAM_INITIALIZED_ACCOUNT)},

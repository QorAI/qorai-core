...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_
...
class TxStorageDelegateImpl final : public TxStorageDelegate {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(TxStorageDelegateImplUnitTest,
                           QoraiWalletTransactionsDBFormatMigrated);
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_

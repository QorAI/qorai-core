...
TEST(QoraiWalletUtilsUnitTest, EncodeString) {
  std::string output;
...
TEST(QoraiWalletUtilsUnitTest, EncodeStringArray) {
...
TEST(QoraiWalletUtilsUnitTest, DecodeString) {
  std::string output;
...
TEST(QoraiWalletUtilsUnitTest, TransactionReceiptAndValue) {
...
TEST(QoraiWalletUtilsTest, IsEndpointUsingQoraiWalletProxy) {
  // Test with valid URLs that should match the proxy domains
  EXPECT_TRUE(IsEndpointUsingQoraiWalletProxy(
      GURL("https://ethereum-mainnet.wallet.qorai.com")));
  EXPECT_TRUE(IsEndpointUsingQoraiWalletProxy(
      GURL("https://ethereum-mainnet.wallet.qoraisoftware.com")));
  EXPECT_TRUE(IsEndpointUsingQoraiWalletProxy(
      GURL("https://ethereum-mainnet.wallet.s.qorai.io")));

  // Test with invalid URLs that should not match the proxy domains
  EXPECT_FALSE(IsEndpointUsingQoraiWalletProxy(GURL("https://example.com")));
  EXPECT_FALSE(
      IsEndpointUsingQoraiWalletProxy(GURL("https://wallet.qorai.io")));
  EXPECT_FALSE(IsEndpointUsingQoraiWalletProxy(GURL("https://qorai.com")));
}

TEST(QoraiWalletUtilsUnitTest, GetPrefKeyForCoinType) {
...
TEST(QoraiWalletUtilsUnitTest, eTLDPlusOne) {
  EXPECT_EQ("", eTLDPlusOne(url::Origin()));
  EXPECT_EQ("qorai.com",
            eTLDPlusOne(url::Origin::Create(GURL("https://blog.qorai.com"))));
  EXPECT_EQ("qorai.com",
            eTLDPlusOne(url::Origin::Create(GURL("https://...qorai.com"))));
  EXPECT_EQ(
      "qorai.com",
      eTLDPlusOne(url::Origin::Create(GURL("https://a.b.c.d.qorai.com/1"))));
  EXPECT_EQ("qorai.github.io", eTLDPlusOne(url::Origin::Create(GURL(
                                   "https://a.b.qorai.github.io/example"))));
  EXPECT_EQ("", eTLDPlusOne(url::Origin::Create(GURL("https://github.io"))));
}

TEST(QoraiWalletUtilsUnitTest, MakeOriginInfo) {
  auto origin_info =
      MakeOriginInfo(url::Origin::Create(GURL("https://blog.qorai.com:443")));
  EXPECT_EQ("https://blog.qorai.com", origin_info->origin_spec);
  EXPECT_EQ("qorai.com", origin_info->e_tld_plus_one);
...
TEST(QoraiWalletUtilsUnitTest, GenerateRandomHexString) {
...
TEST(QoraiWalletUtilsUnitTest, BitcoinNativeAssets) {
  EXPECT_EQ(
...
TEST(QoraiWalletUtilsUnitTest, ZcashNativeAssets) {
...
TEST(QoraiWalletUtilsUnitTest, DefaultZCashShieldedAssets_FeatureEnabled) {
...
TEST(QoraiWalletUtilsUnitTest, DefaultZCashShieldedAssets_FeatureDisabled) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
...
TEST(QoraiWalletUtilsUnitTest, GetAllUserAssets) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
      {{"zcash_shielded_transactions_enabled", "false"}});
...
TEST(QoraiWalletUtilsUnitTest, GetUserAsset) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
      {{"zcash_shielded_transactions_enabled", "false"}});
...
TEST(QoraiWalletUtilsUnitTest, AddUserAsset) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
      {{"zcash_shielded_transactions_enabled", "false"}});
...
TEST(QoraiWalletUtilsUnitTest, EnsureNativeTokenForNetwork) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
      {{"zcash_shielded_transactions_enabled", "false"}});
...
TEST(QoraiWalletUtilsUnitTest, RemoveUserAsset) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeatureWithParameters(
      features::kQoraiWalletZCashFeature,
      {{"zcash_shielded_transactions_enabled", "false"}});
...
TEST(QoraiWalletUtilsUnitTest, SetUserAssetVisible) {
  sync_preferences::TestingPrefServiceSyncable prefs;
  RegisterProfilePrefs(prefs.registry());
...
TEST(QoraiWalletUtilsUnitTest, SetAssetSpamStatus) {
  sync_preferences::TestingPrefServiceSyncable prefs;
  RegisterProfilePrefs(prefs.registry());
...
TEST(QoraiWalletUtilsUnitTest, SetAssetSPLTokenProgram) {
  sync_preferences::TestingPrefServiceSyncable prefs;
  RegisterProfilePrefs(prefs.registry());
...
TEST(QoraiWalletUtilsUnitTest, SetAssetCompressed) {
  sync_preferences::TestingPrefServiceSyncable prefs;
  RegisterProfilePrefs(prefs.registry());
...
TEST(QoraiWalletUtilsUnitTest, GetAccountPermissionIdentifier) {
...
TEST(QoraiWalletCommonUIUnitTest, IsQoraiWalletOrigin) {
  ASSERT_TRUE(IsQoraiWalletOrigin(
      url::Origin::Create(GURL("chrome://wallet-panel.top-chrome/"))));
  ASSERT_TRUE(
      IsQoraiWalletOrigin(url::Origin::Create(GURL("chrome://wallet/"))));
  ASSERT_FALSE(IsQoraiWalletOrigin(url::Origin::Create(GURL("https://a.com"))));
  ASSERT_FALSE(IsQoraiWalletOrigin(url::Origin::Create(GURL())));
}

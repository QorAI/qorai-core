...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_ZCASH_TRANSACTION_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_ZCASH_TRANSACTION_H_
...
class ZCashTransaction {
 public:
  ...
  using OrchardOutput = ::qorai_wallet::OrchardOutput;
  using OrchardInput = ::qorai_wallet::OrchardInput;
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_ZCASH_TRANSACTION_H_

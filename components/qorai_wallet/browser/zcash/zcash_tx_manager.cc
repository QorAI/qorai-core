...
#include "qorai/components/qorai_wallet/browser/zcash/zcash_block_tracker.h"
...
#include "qorai/components/qorai_wallet/browser/zcash/zcash_tx_state_manager.h"
  ...
  if (!GetZCashTxStateManager()
    ...
    std::move(callback).Run(
        ...
        l10n_util::GetStringUTF8(
            IDS_QORAI_WALLET_ZCASH_TRANSACTION_ALREADY_EXISTS_DESCRIPTION));
    return;
  }

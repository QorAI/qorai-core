...
#[cxx::bridge(namespace = qorai_wallet::orchard)]
mod ffi {
    ...
    unsafe extern "C++" {
        include!(
            "qorai/components/qorai_wallet/browser/zcash/rust/cxx_orchard_shard_tree_delegate.h"
        );

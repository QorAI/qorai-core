...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_RUST_ORCHARD_UNAUTHORIZED_BUNDLE_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_RUST_ORCHARD_UNAUTHORIZED_BUNDLE_H_
...
class OrchardUnauthorizedBundle {
 public:
  ...
  static std::unique_ptr<OrchardUnauthorizedBundle> Create(
      ...
      const ::qorai_wallet::OrchardSpendsBundle& orchard_spends,
      const std::vector<::qorai_wallet::OrchardOutput>& orchard_outputs,
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ZCASH_RUST_ORCHARD_UNAUTHORIZED_BUNDLE_H_

...
#include "qorai/components/services/qorai_wallet/public/cpp/utils/protobuf_utils.h"
#include "qorai/components/services/qorai_wallet/public/proto/zcash_grpc_data.pb.h"
...
std::unique_ptr<network::SimpleURLLoader> MakeGRPCLoader(
  ...
  base::flat_map<std::string, std::string> request_headers =
      qorai_wallet::IsEndpointUsingQoraiWalletProxy(url)
...
mojo::AssociatedRemote<zcash::mojom::ZCashDecoder>& ZCashRpc::GetDecoder() {
  ...
  QoraiWalletUtilsService::GetInstance()->CreateZCashDecoder(

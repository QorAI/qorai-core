...
#include "qorai/components/qorai_wallet/browser/zcash/zcash_create_transparent_transaction_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_discover_next_unused_zcash_address_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_get_transparent_utxos_context.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_resolve_balance_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_resolve_transaction_status_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_serializer.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_tx_meta.h"
...
#include "qorai/components/qorai_wallet/browser/zcash/zcash_auto_sync_manager.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_create_orchard_to_orchard_transaction_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_create_transparent_to_orchard_transaction_task.h"
#include "qorai/components/qorai_wallet/browser/zcash/zcash_get_zcash_chain_tip_status_task.h"
  ...
  if (IsUnifiedAddress(address_to)) {
    ...
    if (!transparent) {
      std::move(callback).Run(base::unexpected(l10n_util::GetStringUTF8(
          IDS_QORAI_WALLET_ZCASH_UNIFIED_ADDRESS_ERROR)));
      return;
    }

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_
...
class AccountDiscoveryManager {
 ...
 private:
  ...
  raw_ref<qorai_wallet::JsonRpcService> json_rpc_service_;
  raw_ref<qorai_wallet::KeyringService> keyring_service_;
  raw_ptr<qorai_wallet::BitcoinWalletService> bitcoin_wallet_service_;
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_

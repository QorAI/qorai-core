...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_H_
...
#include "qorai/components/qorai_wallet/browser/polkadot/polkadot_utils.h"
...
class KeyringService : public mojom::KeyringService {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(KeyringServiceUnitTest, RestoreLegacyQoraiWallet);
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_H_

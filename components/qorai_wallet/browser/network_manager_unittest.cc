...
TEST_F(NetworkManagerUnitTest, GetNetworkURLTest) {
  ...
  for (const auto& chain :
    ...
    // Qorai proxies should have infura key added to path.
  ...
  EXPECT_EQ(GURL("https://solana-mainnet.wallet.qorai.com"),
  ...
  EXPECT_EQ(GURL("https://bitcoin-mainnet.wallet.qorai.com/"),
  ...
  EXPECT_EQ(GURL("https://zcash.wallet.qorai.com/"),
  ...
  EXPECT_EQ(GURL("https://cardano-mainnet.wallet.qorai.com/"),
...
TEST_F(NetworkManagerUnitTest, GetNetworkURLForKnownChains) {
  // GetNetworkURL for these known chains should resolve to qorai subdomain.
  base::flat_set<std::string> known_chains = {
      ...
      qorai_wallet::mojom::kBnbSmartChainMainnetChainId,
      qorai_wallet::mojom::kOptimismMainnetChainId,
      qorai_wallet::mojom::kAvalancheMainnetChainId,
      qorai_wallet::mojom::kSepoliaChainId};

  for (const auto& chain :
       NetworkManager::GetAllKnownChains(mojom::CoinType::ETH)) {
    auto network_url =
        network_manager()->GetNetworkURL(chain->chain_id, mojom::CoinType::ETH);
    EXPECT_EQ(network_url.host().ends_with(".qorai.com"),
...
TEST_F(NetworkManagerUnitTest, GetChain) {
  ...
  mojom::NetworkInfo sol_mainnet(
      qorai_wallet::mojom::kSolanaMainnet, "Solana Mainnet Beta",
      {"https://explorer.solana.com/"}, {}, 0,
      {GURL("https://solana-mainnet.wallet.qorai.com")}, "SOL", "Solana", 9,
      qorai_wallet::mojom::CoinType::SOL, {mojom::KeyringId::kSolana});
  ...
  mojom::NetworkInfo fil_mainnet(
      qorai_wallet::mojom::kFilecoinMainnet, "Filecoin Mainnet",
      {"https://filscan.io/tipset/message-detail"}, {}, 0,
      {GURL("https://api.node.glif.io/rpc/v0")}, "FIL", "Filecoin", 18,
      qorai_wallet::mojom::CoinType::FIL, {mojom::KeyringId::kFilecoin});
  ...
  mojom::NetworkInfo btc_mainnet(
      ...
      {GURL("https://bitcoin-mainnet.wallet.qorai.com/")}, "BTC", "Bitcoin", 8,
      mojom::CoinType::BTC,
  ...
  mojom::NetworkInfo zec_mainnet(mojom::kZCashMainnet, "Zcash Mainnet",
                                 ...
                                 {GURL("https://zcash.wallet.qorai.com/")},
  ...
  mojom::NetworkInfo cardano_mainnet(
      ...
      0, {GURL("https://cardano-mainnet.wallet.qorai.com/")}, "ADA", "Cardano",
  ...
  mojom::NetworkInfo polkadot_mainnet(
      ...
      {GURL("https://polkadot-mainnet.wallet.qorai.com/")}, "DOT", "Polkadot",
...
TEST_F(NetworkManagerUnitTest, Eip1559Chain) {
  auto dict = [&] {
    return prefs()->GetDict(kQoraiWalletEip1559CustomChains).Clone();
  };
...
TEST_F(NetworkManagerUnitTest, CustomNetworkMatchesKnownNetwork) {
  ...
  EXPECT_EQ(
      network_manager()
          ...
          .GetWithoutFilename(),
      GURL("https://polygon-mainnet.wallet.qorai.com"));
...
TEST_F(NetworkManagerUnitTest, GetUnstoppableDomainsRpcUrl) {
  ...
  EXPECT_EQ(GURL("https://polygon-mainnet.wallet.qorai.com"),
            NetworkManager::GetUnstoppableDomainsRpcUrl(
                mojom::kPolygonMainnetChainId));
}

TEST_F(NetworkManagerUnitTest, GetEnsRpcUrl) {
  EXPECT_EQ(GURL("https://ethereum-mainnet.wallet.qorai.com"),

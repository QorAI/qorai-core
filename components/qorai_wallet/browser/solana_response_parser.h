...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_

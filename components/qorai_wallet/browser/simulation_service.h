...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMULATION_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMULATION_SERVICE_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_SIMULATION_SERVICE_H_

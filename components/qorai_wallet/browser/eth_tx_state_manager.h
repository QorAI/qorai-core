...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TX_STATE_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TX_STATE_MANAGER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_TX_STATE_MANAGER_H_

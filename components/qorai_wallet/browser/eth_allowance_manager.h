...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_
...
class EthAllowanceManager {
 public:
  ...
  using ResultCallback =
      mojom::QoraiWalletService::DiscoverEthAllowancesCallback;
 ...
 private:
  ...
  struct EthAllowanceTask {
    ...
    qorai_wallet::uint256_t latest_block_number_;
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_
#define QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_

#include <string>
#include <vector>

#include "qorai/components/qorai_wallet/common/qorai_wallet.mojom.h"  // IWYU pragma: keep
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_

...
#include "qorai/components/qorai_wallet/browser/bitcoin/bitcoin_rpc.h"
...
bool ShouldThrottleEndpoint(const GURL& endpoint_host) {
  ...
  return !qorai_wallet::IsEndpointUsingQoraiWalletProxy(endpoint_host);
}
...
namespace qorai_wallet::bitcoin_rpc {

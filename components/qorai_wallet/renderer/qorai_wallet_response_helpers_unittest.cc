...
TEST(QoraiWalletResponseHelpersTest, GetProviderErrorDictionary) {
...
TEST(QoraiWalletResponseHelpersTest,
...
TEST(QoraiWalletResponseHelpersTest, ToProviderResponseEmpty) {
...
TEST(QoraiWalletResponseHelpersTest, ToProviderResponseSuccess) {
...
TEST(QoraiWalletResponseHelpersTest, ToProviderResponseError) {
  base::Value value("test");

...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
...
class JSSolanaProvider final : public gin::Wrappable<JSSolanaProvider>,
 ...
 private:
  ...
  bool GetIsQoraiWallet(gin::Arguments* arguments);
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_

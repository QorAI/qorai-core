...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
...
class JSEthereumProvider final : public gin::Wrappable<JSEthereumProvider>,
 ...
 private:
  ...
  const std::string& GetQoraiWalletImage();
  ...
  std::string uuid_;
  std::optional<std::string> qorai_wallet_image_;
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_

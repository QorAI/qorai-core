...
#ifndef QORAI_COMPONENTS_QORAI_WALLET_RENDERER_V8_HELPER_H_
#define QORAI_COMPONENTS_QORAI_WALLET_RENDERER_V8_HELPER_H_
...
// but if the user goes into settings and explicitly selects to use Qorai Wallet
...
#endif  // QORAI_COMPONENTS_QORAI_WALLET_RENDERER_V8_HELPER_H_

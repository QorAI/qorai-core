...
#ifndef QORAI_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_
#define QORAI_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_
...
#endif  // QORAI_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_

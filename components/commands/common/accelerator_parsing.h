...
#ifndef QORAI_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
#define QORAI_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
...
#endif  // QORAI_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_

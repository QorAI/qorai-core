...
#ifndef QORAI_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
#define QORAI_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
...
class CosmeticFiltersResources final
 ...
 private:
  ...
  raw_ptr<qorai_shields::AdBlockService, DisableDanglingPtrDetection>
      ad_block_service_ = nullptr;  // Not owned
};

}  // namespace cosmetic_filters

#endif  // QORAI_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_

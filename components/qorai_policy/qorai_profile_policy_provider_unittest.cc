...
class QoraiProfilePolicyProviderTest : public ::testing::Test {
 public:
  QoraiProfilePolicyProviderTest() = default;
  ~QoraiProfilePolicyProviderTest() override = default;
 ...
 protected:
  ...
  QoraiProfilePolicyProvider provider_;
};

TEST_F(QoraiProfilePolicyProviderTest, InitAndPolicyLoadComplete) {
  ...
  provider_.OnQoraiPoliciesReady();
...
TEST_F(QoraiProfilePolicyProviderTest, EmptyPolicyBundle) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiProfilePolicyProviderTest, RefreshPolicies) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiProfilePolicyProviderTest, ShutdownHandling) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiProfilePolicyProviderTest, PolicyDomainHandling) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiProfilePolicyProviderTest, OnProfilePolicyChanged_MatchingProfile) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiProfilePolicyProviderTest,
...
TEST_F(QoraiProfilePolicyProviderTest, OnProfilePolicyChanged_EmptyProfileId) {

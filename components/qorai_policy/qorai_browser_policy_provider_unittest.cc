...
class QoraiBrowserPolicyProviderTest : public ::testing::Test {
 public:
  QoraiBrowserPolicyProviderTest() = default;
  ~QoraiBrowserPolicyProviderTest() override = default;
 ...
 protected:
  ...
  QoraiBrowserPolicyProvider provider_;
};

TEST_F(QoraiBrowserPolicyProviderTest, InitAndPolicyLoadComplete) {
...
TEST_F(QoraiBrowserPolicyProviderTest, EmptyPolicyBundle) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiBrowserPolicyProviderTest, RefreshPolicies) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiBrowserPolicyProviderTest, ShutdownHandling) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiBrowserPolicyProviderTest, BasicInitialization) {
...
TEST_F(QoraiBrowserPolicyProviderTest, PolicyDomainHandling) {
  // Initialize the provider
  provider_.Init(&schema_registry_);
...
TEST_F(QoraiBrowserPolicyProviderTest, OnBrowserPolicyChanged) {
  // Initialize the provider
  provider_.Init(&schema_registry_);

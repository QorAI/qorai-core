...
#ifndef QORAI_COMPONENTS_DEBOUNCE_CORE_BROWSER_DEBOUNCE_RULE_H_
#define QORAI_COMPONENTS_DEBOUNCE_CORE_BROWSER_DEBOUNCE_RULE_H_
...
#endif  // QORAI_COMPONENTS_DEBOUNCE_CORE_BROWSER_DEBOUNCE_RULE_H_

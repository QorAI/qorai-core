...
#ifndef QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_DELEGATE_H_
#define QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_DELEGATE_H_
...
#endif  // QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_DELEGATE_H_

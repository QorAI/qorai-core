...
#ifndef QORAI_COMPONENTS_SPEEDREADER_COMMON_FEATURES_H_
#define QORAI_COMPONENTS_SPEEDREADER_COMMON_FEATURES_H_
...
#endif  // QORAI_COMPONENTS_SPEEDREADER_COMMON_FEATURES_H_

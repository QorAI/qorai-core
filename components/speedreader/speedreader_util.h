...
#ifndef QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_
#define QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_
...
#endif  // QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_

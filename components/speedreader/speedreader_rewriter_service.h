...
#ifndef QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_REWRITER_SERVICE_H_
#define QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_REWRITER_SERVICE_H_
...
#endif  // QORAI_COMPONENTS_SPEEDREADER_SPEEDREADER_REWRITER_SERVICE_H_

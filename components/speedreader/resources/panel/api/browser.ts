...
import * as mojom from 'gen/qorai/components/speedreader/common/speedreader_toolbar.mojom.m.js'

// Provide access to all the generated types
export * from 'gen/qorai/components/speedreader/common/speedreader_toolbar.mojom.m.js'

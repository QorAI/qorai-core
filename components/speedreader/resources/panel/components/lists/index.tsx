...
const mainButtonsOptions = [
  {
    ...
    iconName: 'tune',
    title: getLocale('qoraiReaderModeTune')
  },
  {
    id: 'appearance',
    type: MainButtonType.Appearance,
    iconName: 'characters',
    title: getLocale('qoraiReaderModeAppearance')
  },
  {
    id: 'tts',
    ...
    title: getLocale('qoraiReaderModeTextToSpeech')
  },
  {
    id: 'ai',
    type: MainButtonType.AI,
    iconName: 'product-qorai-qora',
    hidden: !loadTimeData.getBoolean('aiChatFeatureEnabled'),
    title: getLocale('qoraiReaderModeAI')
  }
]
...
const fontStyleOptions = [
  {
    ...
    title: getLocale('qoraiReaderModeAppearanceFontSans')
  },
  {
    id: 'font-serif',
    family: FontFamily.kSerif,
    iconName: 'readermode-serif',
    title: getLocale('qoraiReaderModeAppearanceFontSerif')
  },
  {
    id: 'font-mono',
    family: FontFamily.kMono,
    iconName: 'readermode-mono',
    title: getLocale('qoraiReaderModeAppearanceFontMono')
  },
  {
    id: 'font-dyslexic',
    family: FontFamily.kDyslexic,
    iconName: 'readermode-dislexyc',
    title: getLocale('qoraiReaderModeAppearanceFontDyslexic')
  }
]
...
const columnWidthOptions = [
  {
    ...
    title: getLocale('qoraiReaderModeAppearanceColumnWidthNarrow')
  },
  {
    id: 'column-width-wide',
    columnWidth: ColumnWidth.kWide,
    iconName: 'readermode-column-wide',
    title: getLocale('qoraiReaderModeAppearanceColumnWidthWide')
  }
]
  ...
  return (
    <ListBox>
      <ControlButton
        ...
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeFontSizeDecrease')}
      ...
      <ControlButton
        ...
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeFontSizeIncrease')}
  ...
  return (
    <ListBox>
      <ControlButton
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeTtsRewind')}
      ...
      <ControlButton
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeTtsPlayPause')}
        onClick={() => {
      ...
      <ControlButton
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeTtsForward')}
  ...
  return (
    <ListBox>
      <ControlButton
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeTtsSpeedDecrease')}
      ...
      <ControlButton
        inGroup={true}
        isSelected={false}
        title={getLocale('qoraiReaderModeTtsSpeedIncrease')}

...
import getPageHandlerInstance, { ConnectionStatus } from '../../api/qorai_page_handler'
...
function contactQoraiSupport () {
  getPageHandlerInstance().pageHandler.goToQoraiSupport()
}
...
function BadgeTor (props: Props) {
  ...
  if (props.isConnected || props.connectionStatus === ConnectionStatus.kConnected) {
    ...
    helpElement = (<p>
      ...
      {or}
      <a onClick={contactQoraiSupport}>{contactSupport}</a>
      {rest}
    </p>)

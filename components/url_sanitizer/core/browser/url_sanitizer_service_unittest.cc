...
[
  ...
  },
  {
    ...
    "exclude": [
      "https://dev-pages.qoraisoftware.com/clean-urls/exempted/*"
    ],
    "params": [
      "qorai_testing1",
      "qorai_testing2"
...
TEST_F(URLSanitizerServiceUnitTest, ClearURLS) {
  ...
  EXPECT_EQ(SanitizeURL(GURL("https://qorai.com")), GURL("https:/qorai.com"));
  WaitInitialization(kTestPatterns);

  EXPECT_EQ(
      SanitizeURL(
          GURL("https://dev-pages.qoraisoftware.com/clean-urls/"
               "exempted/"
               "?qorai_testing1=foo&qorai_testing2=bar&qorai_testing3=keep&&;b&"
               "d&utm_content=removethis&e=&f=g&=end")),
      GURL("https://dev-pages.qoraisoftware.com/clean-urls/"
           "exempted/?qorai_testing1=foo&qorai_testing2=bar&qorai_"
  ...
  EXPECT_EQ(
      ...
      GURL("https://dev-pages.qoraisoftware.com/clean-urls/"
           "?qorai_testing3=keep&&;b&d&e=&f=g&=end"));

  WaitInitialization(R"([
    { "include": [ "*://*/*"], "params": ["query"] }
  ])");

  EXPECT_EQ(SanitizeURL(GURL("https://qorai.com/?query=removethis")),

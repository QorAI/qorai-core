...
interface Props {
  originInfo: QoraiWallet.OriginInfo
  accountsToConnect: QoraiWallet.AccountInfo[]
}
...
export const ConnectWithSite = (props: Props) => {
  ...
  const [selectedDuration, setSelectedDuration] =
    React.useState<QoraiWallet.PermissionLifetimeOption>(
      QoraiWallet.PermissionLifetimeOption.kPageClosed,
    )
  ...
  const onSelectAccount = React.useCallback(
    (account: QoraiWallet.AccountInfo) => () => {
      ...
      if (account.accountId.coin === QoraiWallet.CoinType.ADA) {
      ...
      >
        {!isReadyToConnect && (
          <>
            <SelectAddressContainer>
              ...
              >
                ...
                >
                  <Row justifyContent='flex-start'>
                    ...
                    <AddAccountText>
                      {getLocale('qoraiWalletAddAccount')}
                    </AddAccountText>
                  </Row>
              ...
              >
                <AccountNameText>
                  {getLocale('qoraiWalletConnectWithSite')}
                </AccountNameText>
              </Row>
        ...
        {isReadyToConnect && (
          ...
          >
            ...
            >
              <SectionLabel>
                {getLocale('qoraiWalletPermissionDuration')}
              </SectionLabel>
              {isPrivateWindow ? (
                <DurationLabel>
                  {getLocale('qoraiWalletPermissionUntilClose')}
                </DurationLabel>
              ) : (
              ...
              <SectionLabel>
                {getLocale('qoraiWalletConnectPermittedLabel')}
              </SectionLabel>
              ...
              <SectionLabel>
                {getLocale('qoraiWalletConnectNotPermittedLabel')}
              </SectionLabel>
      ...
      >
        ...
        >
          {isReadyToConnect
            ...
            : getLocale('qoraiWalletConnectWithSiteNext')}
        </NavButton>
      </ButtonRow>
    </StyledWrapper>
  )

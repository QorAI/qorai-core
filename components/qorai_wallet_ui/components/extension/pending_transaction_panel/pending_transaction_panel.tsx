...
const SIMPLE_TRANSACTION_TYPES = [
  ...
  QoraiWallet.TransactionType.ETHSwap, // use safer-sign UI
]
...
export const PendingTransactionPanel: React.FC<Props> = ({
  ...
  const isSimulationPermitted =
    ...
    && txSimulationOptIn === QoraiWallet.BlowfishOptInStatus.kAllowed
  ...
  if (
    networkHasTxSimulationSupport
    && txSimulationOptIn === QoraiWallet.BlowfishOptInStatus.kUnset
    && selectedPendingTransaction.txType !== QoraiWallet.TransactionType.ETHSwap
  ) {
  ...
  // Send
  if (
    selectedPendingTransaction.txType === QoraiWallet.TransactionType.ETHSend
    || selectedPendingTransaction.txType
    ...
    || selectedPendingTransaction.txType === QoraiWallet.TransactionType.Other
  ) {

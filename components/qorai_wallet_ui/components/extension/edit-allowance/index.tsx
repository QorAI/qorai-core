...
import Radio from 'qorai-ui/components/formControls/radio'
...
export const EditAllowance = (props: Props) => {
  ...
  return (
    ...
    >
      <StyledWrapper>
        <Description>
          {getLocale('qoraiWalletEditPermissionsDescription').replace(
            '$1',
            approvalTarget,
          )}
        </Description>
        <FormColumn>
          ...
          >
            <div data-value='proposed'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('qoraiWalletEditPermissionsProposedAllowance')}
                </AllowanceTitle>
                <AllowanceContent>
            ...
            <div data-value='custom'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('qoraiWalletEditPermissionsCustomAllowance')}
                </AllowanceTitle>
                <Input

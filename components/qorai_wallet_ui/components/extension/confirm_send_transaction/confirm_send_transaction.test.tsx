...
describe('ConfirmSendTransactionInternal', () => {
  ...
  it('should render the component', async () => {
    ...
    expect(screen.getByText('qoraiWalletPanelTitle')).toBeInTheDocument()
    expect(screen.queryByTestId('origin-info-card')).toBeNull()

    // Verify strings are rendered
    expect(screen.getByText('qoraiWalletConfirmSend')).toBeInTheDocument()
    expect(screen.getByText('qoraiWalletSend')).toBeInTheDocument()
...
describe('ConfirmSendTransactionDApp', () => {
  ...
  it('should render origin-info-card for dapp transactions', async () => {
    ...
    expect(screen.getByText('qoraiWalletVerified')).toBeInTheDocument()
  })
})

...
export function ConfirmSendTransaction() {
  ...
  const isQoraiWalletOrigin = React.useMemo(() => {
    ...
    <>
      ...
      >
        ...
        <ConfirmationHeader
          title={
            isShieldingFunds
              ? getLocale('qoraiWalletConfirmShield')
              : getLocale('qoraiWalletConfirmSend')
          }
            ...
            {isQoraiWalletOrigin ? (
              <>
                ...
                <Title textColor='primary'>
                  {getLocale('qoraiWalletPanelTitle')}
                </Title>
              </>
            ) : (
              <OriginInfoCard
                ...
                <Column width='100%'>
                  ...
                  <Row justifyContent='space-between'>
                    <ConfirmationInfoText
                      ...
                      textAlign='left'
                    >
                      {getLocale('qoraiWalletConfirmTransactionAmountFee')}
                    </ConfirmationInfoText>
                    <ConfirmationInfoText
                      textColor='tertiary'
                      textAlign='right'

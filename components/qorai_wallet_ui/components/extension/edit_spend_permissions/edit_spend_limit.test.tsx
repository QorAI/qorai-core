...
describe('EditSpendLimit', () => {
  ...
  it('should render the component', () => {
    ...
    expect(
      screen.getByText('qoraiWalletEditPermissionsDescription'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('qoraiWalletProposedSpendLimit'),
    ).toBeInTheDocument()
    expect(screen.getByText('100 ETH')).toBeInTheDocument()
    expect(screen.getByText('qoraiWalletCustomSpendLimit')).toBeInTheDocument()
    expect(screen.getByText('qoraiWalletButtonCancel')).toBeInTheDocument()
    expect(
      screen.getByText('qoraiWalletAccountSettingsSave'),
    ).toBeInTheDocument()
  })
})

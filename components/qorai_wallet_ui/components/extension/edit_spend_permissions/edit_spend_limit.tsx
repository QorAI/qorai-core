...
import RadioButton from '@qorai/qora/react/radioButton'
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <LabelText textColor='primary'>
              {getLocale('qoraiWalletProposedSpendLimit')}
            </LabelText>
        ...
        >
          ...
          >
            <LabelText textColor='primary'>
              {getLocale('qoraiWalletCustomSpendLimit')}
            </LabelText>
            <Input
      ...
      <Row gap='16px'>
        <Button
          ...
          onClick={onCancel}
        >
          <ButtonText>{getLocale('qoraiWalletButtonCancel')}</ButtonText>
        </Button>
        <Button
          size='medium'
          onClick={onClickSave}
        ...
        >
          <ButtonText>{getLocale('qoraiWalletAccountSettingsSave')}</ButtonText>
        </Button>
      </Row>
    </StyledWrapper>
  )

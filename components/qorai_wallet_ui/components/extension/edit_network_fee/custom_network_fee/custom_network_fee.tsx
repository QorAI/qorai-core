    ...
    >
      ...
      >
        ...
        <Row justifyContent='space-between'>
          <SectionLabel textColor='secondary'>
            {getLocale('qoraiWalletEditGasLimit')}
          </SectionLabel>
          <InputWrapper
            width='140px'
            padding='8px 12px'
        ...
        {gasLimit === '0' && (
          <Row justifyContent='flex-start'>
            <InputLabel
              ...
              textAlign='left'
            >
              {getLocale('qoraiWalletEditGasLimitError')}
            </InputLabel>
          </Row>
        )}
        <VerticalDivider />
        ...
        {isEIP1559Transaction && (
          <>
            <Row justifyContent='space-between'>
              <SectionLabel textColor='secondary'>
                {getLocale('qoraiWalletGasTipLimit')}
              </SectionLabel>
              <InputWrapper
                width='140px'
                gap='6px'
            ...
            <Row justifyContent='space-between'>
              <SectionLabel textColor='secondary'>
                {getLocale('qoraiWalletGasPriceLimit')}
              </SectionLabel>
              <InputWrapper
                width='140px'
                gap='6px'
            ...
            {isCustomGasBelowBaseFee && (
              <Row justifyContent='flex-start'>
                <InputLabel
                  ...
                  textAlign='left'
                >
                  {getLocale('qoraiWalletGasFeeLimitLowerThanBaseFeeWarning')}
                </InputLabel>
              </Row>
            )}
            <VerticalDivider />
            ...
            >
              <SectionLabel textColor='secondary'>
                {getLocale('qoraiWalletEditGasEstimatedNetworkFee')}
              </SectionLabel>
            ...
            <Row width='unset'>
              <Button
                ...
                onClick={onBack}
              >
                {getLocale('qoraiWalletUseDefault')}
              </Button>
            </Row>
          </>
        )}

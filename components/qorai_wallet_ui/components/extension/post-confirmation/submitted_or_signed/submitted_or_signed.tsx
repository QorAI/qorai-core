    ...
    >
      <Column fullWidth={true}>
        ...
        <Column
          ...
          padding='0px 24px'
        >
          {txCoinType === QoraiWallet.CoinType.ETH && showSpeedUpAlert ? (
          ...
          <Title>
            {transaction.txStatus === QoraiWallet.TransactionStatus.Submitted
              ? getLocale('qoraiWalletTransactionSubmittedTitle')
              : getLocale('qoraiWalletTransactionSignedTitle')}
          </Title>
      ...
      >
        <Text
          ...
          isBold={false}
        >
          {getLocale('qoraiWalletSafelyDismissWindow')}
        </Text>
        <Row gap='8px'>
          <QoraButton
            kind='plain'
          ...
          <QoraButton onClick={onClickViewInActivity}>
            {getLocale('qoraiWalletViewInActivity')}
          </QoraButton>
        </Row>
      </Column>
    </Wrapper>

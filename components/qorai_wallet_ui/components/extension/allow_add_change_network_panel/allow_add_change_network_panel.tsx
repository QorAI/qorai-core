...
export type Props =
  | {
      addChainRequest: QoraiWallet.AddChainRequest
      switchChainRequest?: never
    }
  | {
      switchChainRequest: QoraiWallet.SwitchChainRequest
  ...
  chrome.tabs
    .create({
      url:
        ...
        + '/hc/en-us/articles/4415497656461-Qorai-Wallet-FAQ',
    })
    .catch((e) => {
      console.error(e)
    })
    ...
    >
      <Row padding='18px'>
        <HeaderText textColor='primary'>
          {switchChainRequest
            ? getLocale('qoraiWalletAllowChangeNetworkButton')
            : getLocale('qoraiWalletAddNetwork')}
        </HeaderText>
      </Row>
      <VerticalDivider />
      <Column
        ...
        >
          ...
          >
            <Title textColor='primary'>
              {switchChainRequest
                ? getLocale('qoraiWalletAllowChangeNetworkTitle')
                : getLocale('qoraiWalletAllowAddNetworkTitle')}
            </Title>
            <Description textColor='tertiary'>
              {switchChainRequest
                ? getLocale('qoraiWalletAllowChangeNetworkDescription')
                : getLocale('qoraiWalletAllowAddNetworkDescription')}{' '}
              {addChainRequest && (
          ...
          >
            ...
            {addChainRequest && (
              <Button
                ...
                onClick={() => setShowNetworkDetails(true)}
              >
                {getLocale('qoraiWalletAllowAddNetworkDetailsButton')}
              </Button>
            )}
          </Column>
          <Row
          ...
          >
            ...
            >
              {switchChainRequest
                ? getLocale('qoraiWalletAllowChangeNetworkButton')
                : getLocale('qoraiWalletAllowAddNetworkButton')}
            </Button>
          </Row>
        </Card>
      </Column>

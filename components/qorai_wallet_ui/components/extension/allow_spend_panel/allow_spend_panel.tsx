  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <ConfirmationHeader
          title={getLocale('qoraiWalletSpendLimit')}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Title>
                  {formatLocale('qoraiWalletAllowSpendTitle', {
                    $1: (
                      <Row
                        width='unset'
                ...
                <Description textColor='tertiary'>
                  {getLocale('qoraiWalletAllowSpendDescription').replace(
                    '$1',
                    erc20ApproveTokenInfo?.symbol ?? '',
                  )}
                </Description>
                <Row>
                  ...
                  >
                    {getLocale('qoraiWalletEditPermissionsTitle')}
                  </Button>
                </Row>
                ...
                >
                  ...
                  <Row justifyContent='space-between'>
                    <ConfirmationInfoLabel
                      ...
                      textAlign='left'
                    >
                      {getLocale('qoraiWalletApprovalTarget')}
                    </ConfirmationInfoLabel>
                    <Row
                      width='unset'
                      gap='4px'
                  ...
                  <Row justifyContent='space-between'>
                    <ConfirmationInfoLabel
                      ...
                      textAlign='left'
                    >
                      {getLocale('qoraiWalletCurrentApprovalLimit')}
                    </ConfirmationInfoLabel>
                    {currentTokenAllowance && (
                      <AmountText
                        textColor='primary'
                  ...
                  <Row justifyContent='space-between'>
                    <ConfirmationInfoLabel
                      ...
                      textAlign='left'
                    >
                      {getLocale('qoraiWalletProposedApprovalLimit')}
                    </ConfirmationInfoLabel>
                    <AmountText
      ...
      <BottomSheet
        ...
        title={getLocale('qoraiWalletEditPermissionsTitle')}
      ...
      <BottomSheet
        ...
        title={getLocale('qoraiWalletDetails')}
      ...
      <BottomSheet
        ...
        title={getLocale('qoraiWalletAdvancedTransactionSettings')}

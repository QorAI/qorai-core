...
export const OriginInfoCard = (props: Props) => {
  ...
  // Computed
  const isQoraiWallet = getIsQoraiWalletOrigin(origin)
    ...
    >
      ...
      <Column alignItems={orientation === 'vertical' ? 'center' : 'flex-start'}>
        ...
        >
          ...
          {(isDAppVerified || isQoraiWallet) && <VerifiedLabel />}
        </Column>
      </Column>
    </StyledWrapper>
  )

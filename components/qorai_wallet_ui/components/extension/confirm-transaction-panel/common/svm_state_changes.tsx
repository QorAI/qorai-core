...
const METAPLEX_NFT_KINDS = [
  ...
  QoraiWallet.BlowfishMetaplexTokenStandardKind.kNonFungibleEdition,
] as const
...
export const SOLTransfer = ({
  ...
  transfer: QoraiWallet.BlowfishSOLTransferData
  ...
  // computed
  const isReceive = transfer.diff.sign !== QoraiWallet.BlowfishDiffSign.kMinus
...
export const SPLTokenTransfer = ({
  ...
  transfer: QoraiWallet.BlowfishSPLTransferData
  ...
  return (
    ...
    >
      ...
      <Row
        ...
        title={
          isVerified
            ? getLocale('qoraiWalletTokenIsVerifiedByLists').replace('$1', '1')
            : getLocale('qoraiWalletTokenIsUnverified')
        }
      >
        <IconsWrapper marginRight='0px'>
          {asset.isNft ? (
...
export const SPLTokenApproval = ({
  ...
  approval: QoraiWallet.BlowfishSPLApprovalData
  network: BlockchainInfo
}): JSX.Element => {
  // computed
  const isNft =
...
export const SolStakingAuthChange = ({
  ...
  authChange: QoraiWallet.BlowfishSOLStakeAuthorityChangeData
  network: BlockchainInfo
}) => {
  // computed from props
    ...
    >
      {hasStakerChange ? (
        ...
        >
          <Row
            ...
            justifyContent='flex-start'
          >
            <StateChangeText>{getLocale('qoraiWalletStaker')}</StateChangeText>
          </Row>
          <AddressChange
      ...
      {hasWithdrawerChange ? (
        ...
        >
          ...
          >
            <StateChangeText>
              {getLocale('qoraiWalletWithdrawer')}
            </StateChangeText>
          </Row>
          <AddressChange
...
export const SolAccountOwnershipChange = ({
  ...
  ownerChange: QoraiWallet.BlowfishSolanaUserAccountOwnerChangeData
  network: BlockchainInfo
}) => {
  // render
  return (
    ...
    >
      <Row
        ...
        justifyContent='flex-start'
      >
        <StateChangeText>{getLocale('qoraiWalletOwner')}</StateChangeText>
      </Row>
      <AddressChange
...
export function getComponentForSvmTransfer(
  transfer: QoraiWallet.BlowfishSolanaStateChange,
  network: ChainInfo,
  transactionDetails?: ParsedTransaction,
) {

...
type TransactionInfoProps = (
  | {
      simulationType: 'EVM'
      simulation: QoraiWallet.EVMSimulationResponse
    }
  | {
      simulationType: 'SVM'
      simulation: QoraiWallet.SolanaSimulationResponse
    }
) & {
  network: ChainInfo
    ...
    return simulationType === 'EVM'
      ? {
          evmChanges: groupSimulatedEVMStateChanges(
            expectedStateChanges as QoraiWallet.BlowfishEVMStateChange[],
          ),
          svmChanges: undefined,
        }
      : {
          svmChanges: decodeSimulatedSVMStateChanges(
            expectedStateChanges as QoraiWallet.BlowfishSolanaStateChange[],
          ),
  ...
  return (
    ...
    >
      ...
      {hasAccountOwnershipChanges && (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('qoraiWalletOwnershipChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasTransfers ? (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('qoraiWalletEstimatedBalanceChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasApprovals && (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('qoraiWalletApprovalDetails')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasSolStakingAuthChanges && (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('qoraiWalletAuthorityChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasNoChanges && (
        ...
        >
          ...
          <TransactionChangeCollapseContent>
            ...
            <StateChangeText>
              {getLocale('qoraiWalletNoChangesDetected')}
            </StateChangeText>
          </TransactionChangeCollapseContent>
        </TransactionChangeCollapse>
      )}

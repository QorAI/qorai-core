...
export function SignCowSwapOrder(props: Props) {
  ...
  return (
    <StyledWrapper>
      ...
      <HeaderTitle>{getLocale('qoraiWalletSwapReviewHeader')}</HeaderTitle>
      ...
      <NetworkFeeAndDetailsContainer>
        <NetworkFeeContainer>
          <NetworkFeeTitle>
            {getLocale('qoraiWalletNetworkFees')}
          </NetworkFeeTitle>
          <NetworkFeeValue>
            <CreateNetworkIcon
              network={network}
        ...
        <TextButton onClick={() => setShowDetails(!showDetails)}>
          {showDetails
            ? getLocale('qoraiWalletSignTransactionEIP712MessageHideDetails')
      ...
      <SignPanelButtonRow>
        ...
        <NavButton
          buttonType='sign'
          text={getLocale('qoraiWalletSignTransactionButton')}
          onSubmit={onSignIn}
          disabled={isDisabled}
        />
      </SignPanelButtonRow>

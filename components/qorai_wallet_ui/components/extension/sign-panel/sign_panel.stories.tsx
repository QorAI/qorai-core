...
import { QoraiWallet, Url } from '../../../constants/types'
...
const signMessageData: QoraiWallet.SignMessageRequest = {
  id: 0,
  ...
  signData: {
    ...
    ethSiweData: {
      ...
      statement: 'I accept the Qorai Terms of Service: http://address.com/tos',
      uri: {
...
export const _SignData = {
  render: () => {
    const signMessageDataPayload: QoraiWallet.SignMessageRequest[] = [
      {
        id: 0,
        accountId: {
          coin: QoraiWallet.CoinType.ETH,

...
export interface ProvidePubKeyPanelProps {
  payload: QoraiWallet.GetEncryptionPublicKeyRequest
}
...
export function ProvidePubKeyPanel({ payload }: ProvidePubKeyPanelProps) {
  ...
  return (
    <StyledWrapper>
      ...
      <PanelTitle>
        {getLocale('qoraiWalletProvideEncryptionKeyTitle')}
      </PanelTitle>
      <TabRow>
        <PanelTab
          isSelected={true}
          text={getLocale('qoraiWalletSignTransactionMessageTitle')}
        />
      </TabRow>
      ...
      <ButtonRow>
        ...
        <NavButton
          buttonType='primary'
          text={getLocale('qoraiWalletProvideEncryptionKeyButton')}
...
interface DecryptRequestPanelProps {
  payload: QoraiWallet.DecryptRequest
}
...
export function DecryptRequestPanel({ payload }: DecryptRequestPanelProps) {
  ...
  return (
    <StyledWrapper>
      ...
      <PanelTitle>
        {getLocale('qoraiWalletReadEncryptedMessageTitle')}
      </PanelTitle>
      <TabRow>
        <PanelTab
          isSelected={true}
      ...
      <MessageBox needsCenterAlignment={!isDecrypted}>
        {!isDecrypted ? (
          <DecryptButton onClick={onDecryptMessage}>
            {getLocale('qoraiWalletReadEncryptedMessageDecryptButton')}
          </DecryptButton>
        ) : (
      ...
      <ButtonRow>
        ...
        <NavButton
          buttonType='primary'
          text={getLocale('qoraiWalletReadEncryptedMessageButton')}
          onSubmit={onAllow}
        />
      </ButtonRow>
    </StyledWrapper>

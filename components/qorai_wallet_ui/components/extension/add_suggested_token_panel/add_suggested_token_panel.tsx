...
export function AddSuggestedTokenPanel() {
  ...
  const suggestion: QoraiWallet.AddSuggestTokenRequest | undefined =
    suggestions[0]
    ...
    >
      <Row padding='18px'>
        <HeaderText textColor='primary'>
          {getLocale('qoraiWalletAddSuggestedTokenTitle')}
        </HeaderText>
      </Row>
      <VerticalDivider />
      <Column
        ...
        >
          ...
          >
            <Description textColor='primary'>
              {getLocale('qoraiWalletAddSuggestedTokenDescription')}
            </Description>
            <Column>
              {isFetching ? (
                <Skeleton
              ...
              {!isFetching && token ? (
                <>
                  ...
                  <Tooltip text={getLocale('qoraiWalletTransactionExplorer')}>
                    <ContractAddress

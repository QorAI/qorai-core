...
interface Props {
  ...
  onChangeAccount: (account: QoraiWallet.AccountInfo) => void
}
    ...
    >
      {connectedAccounts.length !== 0 && (
        ...
        >
          ...
          {connectedAccounts.map((account: QoraiWallet.AccountInfo) => (
            <ChangeAccountButton
        ...
        >
          ...
          >
            <Text
              ...
              textColor='tertiary'
            >
              {getLocale('qoraiWalletAvailableAccounts')}
            </Text>
          </Row>

          {availableAccounts.map((account: QoraiWallet.AccountInfo) => (
            <ChangeAccountButton
              key={account.accountId.uniqueKey}
              account={account}
              onClick={() => onChangeAccount(account)}

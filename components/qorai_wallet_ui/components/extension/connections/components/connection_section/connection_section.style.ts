...
export const ControlsWrapper = styled(Column)`
  ...
  box-shadow: ${qora.elevation.l};
`

export const Icon = styled(QoraIcon)`
  --qora-icon-color: var(--connection-text-color);
  --qora-icon-size: 12px;
  margin-right: 6px;
`
...
export const SelectButtonIcon = styled(QoraIcon).attrs({

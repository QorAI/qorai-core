  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <ConfirmationHeader
          title={getLocale('qoraiWalletTransactionCancel')}
          ...
          >
            <Row justifyContent='space-between'>
              <PriorityLabel textColor='primary'>
                {getLocale('qoraiWalletSpeedPriority')}
              </PriorityLabel>
          ...
          <Row margin='4px 0px 0px 0px'>
            <Tooltip mode='default'>
              <Row
                ...
                slot='content'
              >
                {getLocale('qoraiWalletGasFeeTooltipDescription')}
              </Row>
              <Row gap='8px'>
                <InfoText textColor='tertiary'>
                  {getLocale('qoraiWalletGasFeeTooltip')}
                </InfoText>

...
export const PortfolioAssetItem = ({
  ...
  const { data: bitcoinBalances, isLoading: isLoadingBitcoinBalances } =
    useGetBitcoinBalancesQuery(
      token?.coin === QoraiWallet.CoinType.BTC && account?.accountId
        ? account.accountId
        : skipToken,
    )
  ...
  const showBalanceInfo =
    hasPendingBalance && account && token.coin === QoraiWallet.CoinType.BTC
            ...
            <InfoBar justifyContent='space-between'>
              ...
              >
                ...
                <InfoText
                  ...
                  textAlign='left'
                >
                  {getLocale('qoraiWalletUnavailableBalances')}
                </InfoText>
              </Row>
              <div>
                <QoraButton
                ...
                >
                  {getLocale('qoraiWalletAllowSpendDetailsButton')}
                </QoraButton>
              </div>
            </InfoBar>
          </Row>

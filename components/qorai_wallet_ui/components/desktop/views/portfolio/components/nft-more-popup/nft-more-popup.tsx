    ...
    >
      ...
      {!isTokenHidden && !isTokenSpam && (
        <>
          <PopupButton onClick={onEditNft}>
            ...
            <PopupButtonText>{getLocale('qoraiNftsTabEdit')}</PopupButtonText>
          </PopupButton>
          <PopupButton onClick={onHideNft}>
            <ButtonIcon name='eye-off' />
            <PopupButtonText>{getLocale('qoraiNftsTabHide')}</PopupButtonText>
          </PopupButton>
        </>
      )}
      ...
      {isTokenSpam ? (
        ...
        <PopupButton onClick={onUnSpam}>
          ...
          <PopupButtonText>{getLocale('qoraiWalletNftUnspam')}</PopupButtonText>
        </PopupButton>
      ) : (
        ...
        <PopupButton onClick={onMarkAsSpam}>
          ...
          <PopupButtonText>
            {getLocale('qoraiWalletNftMoveToSpam')}
          </PopupButtonText>
        </PopupButton>
      )}
      ...
      {isTokenHidden && !isTokenSpam ? (
        <PopupButton onClick={onUnHideNft}>
          ...
          <PopupButtonText>{getLocale('qoraiNftsTabUnhide')}</PopupButtonText>
        </PopupButton>
      ) : null}
      ...
      <PopupButton onClick={onRemoveNft}>
        ...
        <PopupButtonText>{getLocale('qoraiNftsTabRemove')}</PopupButtonText>
      </PopupButton>
    </Popup>
  )
}

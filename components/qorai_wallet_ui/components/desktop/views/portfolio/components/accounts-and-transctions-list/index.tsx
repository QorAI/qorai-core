...
export const AccountsAndTransactionsList = ({
  ...
  const [selectedSellAccount, setSelectedSellAccount] =
    React.useState<QoraiWallet.AccountInfo>()
  ...
  const nonRejectedTransactions = React.useMemo(() => {
    return selectedAssetTransactions.filter(
      (t) => t.txStatus !== QoraiWallet.TransactionStatus.Rejected,
    )
  }, [selectedAssetTransactions])
              ...
              {accountsList.length !== 0 ? (
                ...
                >
                  ...
                  <Text
                    ...
                    isBold={true}
                  >
                    {getLocale('qoraiWalletNoAccountsWithABalance')}
                  </Text>
                  ...
                  <Text
                    ...
                    isBold={false}
                  >
                    {getLocale('qoraiWalletNoAccountsWithABalanceDescription')}
                  </Text>
                </Column>
              )}
            </>

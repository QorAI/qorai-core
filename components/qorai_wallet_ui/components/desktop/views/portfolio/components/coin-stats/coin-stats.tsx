...
export const CoinStats = (props: Props) => {
  ...
  return (
    <StyledWrapper>
      <DividerText>{getLocale('qoraiWalletInformation')}</DividerText>
      <SubDivider />
      <Row>
        <StatWrapper>
          <StatValue>{marketCapRank}</StatValue>
          <StatLabel>{getLocale('qoraiWalletRankStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('qoraiWalletVolumeStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('qoraiWalletMarketCapStat')}</StatLabel>
        </StatWrapper>
      </Row>
    </StyledWrapper>
  )

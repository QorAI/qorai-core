...
// Styled Components
import { Row, Column, QoraSquaredButton } from '../../../shared/style'
...
export const MarketAsset = () => {
  ...
  const { selectedAssetFromParams, foundTokens } = React.useMemo(() => {
    ...
    const token = new QoraiWallet.BlockchainToken()
      ...
      <StyledWrapper>
        ...
        <Row padding='0px 20px'>
          <ButtonRow>
            {foundMeldBuyToken && (
              <div>
                <QoraSquaredButton onClick={onSelectBuy}>
            ...
            {isSelectedAssetDepositSupported && (
              <div>
                <QoraSquaredButton onClick={onSelectDeposit}>

    ...
    <StyledWrapper>
      {isRefreshingTokens ? (
        <>
          ...
          <RefreshText>
            {getLocale('qoraiWalletAutoDiscoveryEmptyStateRefresh')}...
          </RefreshText>
        </>
      ) : (
        <>
          <Heading>
            {getLocale('qoraiWalletAutoDiscoveryEmptyStateHeading')}
          </Heading>
          <Description>
            {getLocale('qoraiWalletAutoDiscoveryEmptyStateSubHeading')}
          </Description>
          <Row
            margin='48px 0 8px 0'
            marginBottom={8}
          >
            <Description>
              {getLocale('qoraiWalletAutoDiscoveryEmptyStateFooter')}
            </Description>
          </Row>

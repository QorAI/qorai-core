...
export const PortfolioOverviewHeader = () => {
  ...
  return isPanel || isMobile ? (
    <DefaultPanelHeader
      ...
      title={getLocale('qoraiWalletTopNavPortfolio')}
    />
  ) : (
    <Row
      padding='24px 0px'
    ...
    >
      <HeaderTitle>{getLocale('qoraiWalletTopNavPortfolio')}</HeaderTitle>
      {/* ToDo: Route to Add Token or Add NFT, to be handled in https://github.com/qorai/qorai-browser/issues/37258 */}

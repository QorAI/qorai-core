...
export const LockScreen = () => {
    ...
    return (
      <AndroidLockScreenWrapper onClick={onDoubleTap}>
        ...
        <Text
          ...
          textColor='primary'
        >
          {getLocale('qoraiWalletDoubleTapScreen')}
        </Text>
        <Text
          textSize='16px'
          textColor='tertiary'
        >
          {getLocale('qoraiWalletUnlockAndroidDescription')}
        </Text>
      </AndroidLockScreenWrapper>
    )
  }
  ...
  return (
    <StyledWrapper>
      {isPanel && <QoraiLogo />}
      <PageIcon />
      <Title>{getLocale('qoraiWalletUnlockWallet')}</Title>
      <Description>{getLocale('qoraiWalletLockScreenTitle')}</Description>
      <InputColumn fullWidth={true}>
        ...
        <PasswordInput
          placeholder={getLocale('qoraiWalletEnterYourPassword')}
        ...
        >
          {getLocale('qoraiWalletLockScreenButton')}
        </UnlockButton>
        <Button
          onClick={onShowRestore}
          kind='plain'
        >
          {getLocale('qoraiWalletWelcomeRestoreButton')}
        </Button>
      </InputColumn>
    </StyledWrapper>
  )

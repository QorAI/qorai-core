...
interface Props {
  ...
  networksSubset?: QoraiWallet.NetworkInfo[]
}
    ...
    <>
      ...
      >
        <Title
          ...
          isBold={true}
        >
          {getLocale('qoraiWalletSelectNetworks')}
        </Title>
        <SelectAllButton onClick={onSelectOrDeselectAllNetworks}>
          {isSelectAll
            ? getLocale('qoraiWalletSelectAll')
            : getLocale('qoraiWalletDeselectAll')}
        </SelectAllButton>
      </Row>
      ...
      {primaryNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('qoraiWalletPrimaryNetworks')}
          marginBottom={8}
        />
      )}
      ...
      {secondaryNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('qoraiWalletNetworkFilterSecondary')}
          marginBottom={8}
        />
      )}
      ...
      {testNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('qoraiWalletNetworkFilterTestNetworks')}
          marginBottom={8}
        />
      )}
      ...
      {providerNetwork && (
        <NetworkCheckboxes
          ...
          title={getLocale('qoraiWalletPlatforms')}
          marginBottom={0}
        />
      )}
    </>

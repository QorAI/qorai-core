          ...
          <BalancesColumn fullWidth={true}>
              ...
              >
                ...
                >
                  <TooltipContent slot='content'>
                    {getLocale('qoraiWalletAvailableBalanceDescription')}
                  </TooltipContent>
                  <InfoIcon />
                </Tooltip>
              </Row>
            ...
            <Row justifyContent='space-between'>
              ...
              >
                ...
                >
                  <TooltipContent slot='content'>
                    {getLocale('qoraiWalletPendingBalanceDescription')}
                  </TooltipContent>
                  <InfoIcon />
                </Tooltip>
              </Row>
            ...
            <Row justifyContent='space-between'>
              ...
              >
                ...
                >
                  <TooltipContent slot='content'>
                    {getLocale('qoraiWalletTotalBalanceDescription')}
                  </TooltipContent>
                  <InfoIcon />
                </Tooltip>
              </Row>

...
const meldTermsOfUse = formatLocale('qoraiWalletMeldTermsOfUse', {
  $1: (content) => (
...
export function PartnersConsentModal(
  ...
  return (
    <TermsDialog
      ...
      showClose
    >
      <Title slot='title'>{getLocale('qoraiWalletTransactionsPartner')}</Title>
      <Row justifyContent='center'>
        <Graphic src={PageTermsGraphic} />
      </Row>
      <TermsText>{getLocale('qoraiWalletTransactionPartnerConsent')}</TermsText>
      <Checkbox

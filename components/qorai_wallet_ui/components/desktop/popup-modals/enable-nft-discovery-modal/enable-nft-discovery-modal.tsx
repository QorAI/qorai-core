...
import { QoraSquaredButton, Column } from '../../../shared/style'
...
export const EnableNftDiscoveryModal = ({ onConfirm, onCancel }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Header>
          {getLocale('qoraiWalletEnableNftAutoDiscoveryModalHeader')}
        </Header>
        ...
        <ButtonRow>
          <QoraSquaredButton
            ...
            kind='plain'
          >
            {getLocale('qoraiWalletEnableNftAutoDiscoveryModalCancel')}
          </QoraSquaredButton>
          <QoraSquaredButton onClick={onConfirm}>
            {getLocale('qoraiWalletEnableNftAutoDiscoveryModalConfirm')}
          </QoraSquaredButton>
        </ButtonRow>
      </Column>
    </PopupModal>

...
export interface Props {
  ...
  onCreated?: (account: QoraiWallet.AccountInfo) => void
  onCancel: () => void
}
...
export const CreateAccountTab = ({
  ...
  return (
    <StyledWrapper>
      <Description>
        {network
          ? getLocale('qoraiWalletCreateAccountDescription').replace(
              '$1',
              network.symbolName,
            )
          : ''}
      ...
      <ButtonRow>
        <NavButton
          ...
          onSubmit={onCancel}
          text={getLocale('qoraiWalletCreateAccountNo')}
        />
        <NavButton
          buttonType='primary'
          onSubmit={onCreateAccount}
          text={getLocale('qoraiWalletCreateAccountYes')}
        />
      </ButtonRow>
    </StyledWrapper>
  )

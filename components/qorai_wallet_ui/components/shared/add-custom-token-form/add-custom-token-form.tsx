...
export const AddCustomTokenForm = (props: Props) => {
  ...
  const tokenInfo: QoraiWallet.BlockchainToken | undefined =
    React.useMemo(() => {
      ...
      return {
        ...
        tokenId: '',
        isCompressed: false,
        isErc20: customAssetsNetwork.coin !== QoraiWallet.CoinType.SOL,
        isErc721: false,
        isErc1155: false,
  ...
  const tokenContractAddressError =
    ...
    || (tokenInfo?.coin !== QoraiWallet.CoinType.SOL
  ...
  const formErrors = React.useMemo(() => {
    return [
      ...
      tokenDecimalsError
        && getLocale('qoraiWalletTokenDecimalsIsRequiredError'),
    ]
  }, [
    customAssetsNetworkError,
    tokenNameError,
    ...
    <>
      <FormWrapper onClick={onHideNetworkDropDown}>
        ...
        >
          <DividerRow>
            <AdvancedButton onClick={onToggleShowAdvancedFields}>
              <DividerText>
                {getLocale('qoraiWalletWatchListAdvanced')}
              </DividerText>
            </AdvancedButton>
            <AdvancedButton onClick={onToggleShowAdvancedFields}>
          ...
          {showAdvancedFields && (
            <FullWidthFormColumn>
              ...
              >
                <InputLabel>{getLocale('qoraiWalletIconURL')}</InputLabel>
              </Input>
              ...
              >
                <InputLabel>
                  {getLocale('qoraiWalletWatchListCoingeckoId')}
                </InputLabel>
              </Input>
            </FullWidthFormColumn>
          )}
        ...
        {tokenAlreadyExists && !selectedAsset && (
          <ErrorText>
            {getLocale('qoraiWalletCustomTokenExistsError')}
          </ErrorText>
        )}
      </FormWrapper>

...
import { InputEventDetail } from '@qorai/qora/react/input'
...
// Types
import { MeldCryptoCurrency, QoraiWallet } from '../../../../../constants/types'
    ...
    return (
      <>
        <DialogTitle slot='title'>
          {getLocale('qoraiWalletCreateAccountButton')}
        </DialogTitle>
        <Column
          gap='16px'
        ...
        >
          ...
          >
            {token
              ? getLocale('qoraiWalletCreateAccountToBuyTitle').replace(
                  '$1',
                  token.name ?? '',
                )
              : ''}
          ...
          >
            {token
              ? getLocale('qoraiWalletCreateAccountToBuyDescription')
        ...
        <Row margin='0px 0px 46px 0px'>
          ...
          >
            <Text
              ...
              isBold={true}
            >
              {getLocale('qoraiWalletAccountName')}
            </Text>
          </Input>
        </Row>
        <Row gap='16px'>

          ...
          >
            {isBestOption ? (
              <BestOptionLabel>
                ...
                {getLocale('qoraiWalletBestOption')}
              </BestOptionLabel>
            ) : null}
            <PaymentMethodsWrapper>
        ...
        >
          <WrapperForPadding fullWidth={true}>
            ...
            >
              ...
              >
                <QuoteDetailsLabel>
                  {getLocale('qoraiWalletExchangeRateWithFees')}
                </QuoteDetailsLabel>
                <QuoteDetailsValue>
              ...
              >
                <QuoteDetailsLabel>
                  {getLocale('qoraiWalletPriceCurrency').replace(
                    '$1',
                    sourceCurrencyCode ?? '',
                  )}
                </QuoteDetailsLabel>
          ...
          <BuyButton
            ...
            onClick={() => onBuy(quote)}
          >
            {getLocale('qoraiWalletBuyWithProvider').replace(
              '$1',

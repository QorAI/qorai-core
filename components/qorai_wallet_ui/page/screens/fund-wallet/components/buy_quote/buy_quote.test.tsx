...
describe('buy quote option', () => {
  it('renders buy quote option and handles click', () => {
    ...
    expect(screen.getByText('qoraiWalletBestOption')).toBeInTheDocument()
    ...
    // Test Carat Icon
    const caratIcon = container.querySelector('qora-icon[name="carat-down"]')
    ...
    const buyButton: any = document.querySelector('qora-button')

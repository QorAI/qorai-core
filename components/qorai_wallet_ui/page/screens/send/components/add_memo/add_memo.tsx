    ...
    >
      {showMemoTextInput && (
        <MemoInput
          ...
          placeholder={getLocale('qoraiWalletEnterAMessage')}
        ...
        >
          <Text
            ...
            textColor='primary'
          >
            {getLocale('qoraiWalletMessageOptional')}
          </Text>
          <span slot='extra'>
          ...
          <Text
            ...
            textAlign='left'
          >
            {getLocale('qoraiWalletMemoLengthError')}
          </Text>
        </MemoInput>
      )}
      <Button
      ...
      >
        ...
        />
        {showMemoTextInput
          ? getLocale('qoraiWalletRemoveMemo')
          : getLocale('qoraiWalletAddMemo')}
      </Button>
    </Column>
  )
}

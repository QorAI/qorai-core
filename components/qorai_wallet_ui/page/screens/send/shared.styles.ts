...
export const Text = styled.span<TextProps>`
  --primary: ${qora.color.text.primary};
  --secondary: ${qora.color.text.secondary};
  --tertiary: ${qora.color.text.tertiary};
  --info: ${qora.color.systemfeedback.infoText};
  --error: ${qora.color.systemfeedback.errorText};
  --warning: ${qora.color.systemfeedback.warningText};
  --disabled: ${qora.color.text.disabled};

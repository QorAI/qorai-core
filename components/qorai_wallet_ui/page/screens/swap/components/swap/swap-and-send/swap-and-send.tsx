...
interface Props {
  ...
  selectedSwapSendAccount: QoraiWallet.AccountInfo | undefined
...
export const SwapAndSend = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Text textSize='14px'>{getLocale('qoraiSwapSwapAndSend')}</Text>
          <Flash
            name='flash'
            size={16}
          />
          <Text
            ...
            textColor='text03'
          >
            {getLocale('qoraiSwapNoExtraFees')}
          </Text>
        </Row>
        <StandardSwitch
                    ...
                    && toAnotherAddress !== '' && (
                      <>
                        ...
                        >
                          ...
                          <StandardCheckbox
                            id='confirm-address'
                            label={getLocale('qoraiSwapConfirmAddress')}

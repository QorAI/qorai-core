      ...
      >
        ...
        >
          <Text
            ...
            isBold={true}
          >
            {getLocale('qoraiSwapPrivacyPolicy')}
          </Text>
        ...
        >
          <Text
            ...
            isBold={true}
          >
            {getLocale('qoraiSwapPrivacyDescription')}
          </Text>
          ...
          >
            ...
            <Text
              ...
              isBold={true}
            >
              {getLocale('qoraiSwapV2Disclaimer')
                .replaceAll('$1', '0x')
                .replace('$2', 'EVM')
                .replace('$3', 'Ethereum')}
            </Text>
            ...
            >
              {getLocale('qoraiSwapV2Privacy').replace('$1', '0x')}
            </Link>
          </Section>
          ...
          >
            ...
            >
              {getLocale('qoraiSwapV2Privacy').replace('$1', 'Jupiter')}
            </Link>
          </Section>
          <VerticalSpacer size={20} />
        </Column>

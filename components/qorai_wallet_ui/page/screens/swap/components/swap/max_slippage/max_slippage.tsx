    ...
    >
      ...
      >
        <Text
          ...
          textAlign='left'
        >
          {getLocale('qoraiWalletMaxSlippageDescription')}
        </Text>
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('qoraiWalletSuggestedValues')}
        </Text>
        <VerticalSpace space='8px' />
        <Text
          isBold={false}
          ...
          textAlign='left'
        >
          {getLocale('qoraiWalletMainstreamAssetPairs').replace(
            '$1',
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('qoraiWalletStablecoinPairs').replace(
            '$1',
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('qoraiWalletOthers').replace('$1', OTHERS_SLIPPAGE)}
        </Text>
      </Column>
      <Row gap='12px'>
        <OptionButton
        ...
        >
          ...
          >
            <Text
              ...
              textColor='primary'
            >
              {getLocale('qoraiWalletSuggested')}
            </Text>
            <Text
              isBold={true}
              textSize='16px'

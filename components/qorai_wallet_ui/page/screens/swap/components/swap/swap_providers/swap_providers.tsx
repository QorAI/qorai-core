...
interface Props {
  selectedProvider: QoraiWallet.SwapProvider
  onChangeSwapProvider: (provider: QoraiWallet.SwapProvider) => void
  availableProvidersForSwap: QoraiWallet.SwapProvider[]
}
...
export const SwapProviders = (props: Props) => {
  ...
  const [userSelectedSwapProvider, setUserSelectedSwapProvider] =
    React.useState<QoraiWallet.SwapProvider>(selectedProvider)
    ...
    <Column fullWidth={true}>
      ...
      >
        <Text
          ...
          textColor='primary'
        >
          {getLocale('qoraiWalletChooseQuoteProvider')}
        </Text>
        <HorizontalSpace space='8px' />
        <InfoIconTooltip
          placement='bottom'
          text={getLocale('qoraiWalletQuoteProviderInfo')}
        />
      </Row>
      <Column
        fullWidth={true}
              ...
              >
                ...
                {!isAvailableForSwap && (
                  <Text
                    ...
                    textColor='disabled'
                  >
                    {getLocale('qoraiWalletNotAvailable')}
                  </Text>
                )}
              </Row>
            </RadioButton>

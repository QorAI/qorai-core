...
export const Text = styled.span<{
  ...
  --error: ${qora.color.red[40]};
  --success: ${qora.color.green[30]};
  --warning: ${qora.color.yellow[30]};
  font-family: 'Poppins';
  color: ${(p) =>
...
export const Icon = styled(QoraIcon)<{
  ...
  --qora-icon-size: ${(p) => (p.size !== undefined ? p.size : 22)}px;
...
export const BankIcon = styled(QoraIcon).attrs({
  name: 'bank',
})<{ size?: string }>`
  --qora-icon-size: ${(p) => p.size ?? '20px'};
  color: ${qora.color.icon.default};
`

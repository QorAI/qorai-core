  ...
  return [
    {
      ...
      provider: QoraiWallet.SwapProvider.kZeroEx,
...
function getJupiterNetworkFee({
  ...
  quote: QoraiWallet.JupiterQuote
  fromNetwork: QoraiWallet.NetworkInfo
}): Amount {
  if (!fromNetwork) {
    return Amount.empty()
  ...
  return [
    {
      ...
      networkFeeFiat: networkFee.isUndefined()
        ...
        : networkFee
            ...
            .formatAsFiat(defaultFiatCurrency),
      provider: QoraiWallet.SwapProvider.kJupiter,
...
export function getLiFiFromAmount(route: QoraiWallet.LiFiRoute): Amount {
  return new Amount(route.fromAmount).divideByDecimals(route.fromToken.decimals)
}

export function getLiFiToAmount(route: QoraiWallet.LiFiRoute): Amount {
  ...
  return quote.routes.map((route) => {
    ...
    return {
      ...
      executionDuration: route.steps
        ...
        .reduce((a, b) => a + b, 0)
        .toString(),
      provider: QoraiWallet.SwapProvider.kLiFi,
  ...
  return [
    {
      ...
      networkFeeFiat: networkFee.isUndefined()
        ...
        : networkFee
            ...
            .formatAsFiat(defaultFiatCurrency),
      provider: QoraiWallet.SwapProvider.kSquid,

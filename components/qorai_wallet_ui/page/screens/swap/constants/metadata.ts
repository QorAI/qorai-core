...
const SwapProviderMetadata = {
  [QoraiWallet.SwapProvider.kAuto]: QoraiIcon,
  [QoraiWallet.SwapProvider.kZeroEx]: ZeroXIcon,
  [QoraiWallet.SwapProvider.kJupiter]: JupiterIcon,
  [QoraiWallet.SwapProvider.kLiFi]: LiFiIcon,
  [QoraiWallet.SwapProvider.kSquid]: SquidIncon,
}

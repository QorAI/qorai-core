...
export const OnboardingRestoreFromRecoveryPhrase = () => {
  ...
  switch (currentStep) {
    case 'phrase':
      title = getLocale('qoraiWalletRestoreMyQoraiWallet')
      subTitle = getLocale('qoraiWalletRestoreMyQoraiWalletInstructions')
      break
    case 'password':
      title = getLocale('qoraiWalletCreatePasswordTitle')
      subTitle = getLocale('qoraiWalletCreatePasswordDescription')
      break
    default:
      title = ''
      subTitle = ''
  ...
  React.useEffect(() => {
    if (currentStep === 'password') {
      report(QoraiWallet.OnboardingAction.LegalAndPassword)
    }
  }, [report, currentStep])
      ...
      {currentStep === 'phrase' && (
        <>
          ...
          <Button
            ...
            color={qora.color.container.interactive}
          >
            {getLocale('qoraiWalletRestoreAlternateLength').replace(
              '$1',
          ...
          {importableWallets?.isMetaMaskInitialized && (
            <AlertWrapper>
              <InfoAlert padding='0 0 16px 0'>
                ...
                {getLocale('qoraiWalletMetamaskDetected')}
                <div slot='content-after'>
                  ...
                  >
                    {getLocale('qoraiWalletUsePassword')}
                  </Button>
                </div>
              </InfoAlert>
            </AlertWrapper>
        ...
        >
          ...
          {hasInvalidSeedError && (
            <InfoAlert
              ...
              type='error'
            >
              {getLocale('qoraiWalletRestoreWalletError')}
            </InfoAlert>
          )}
        </Column>
      )}

...
export const OnboardingRestoreFromExtension = ({ restoreFrom }: Props) => {
  ...
  const checkImportPassword = React.useCallback(async () => {
    const results = await checkExtensionPassword({
      walletType: QoraiWallet.ExternalWalletType.MetaMask,
  ...
  const pageText = React.useMemo(() => {
    switch (currentStep) {
      case 'currentPassword':
        return {
          title: getLocale('qoraiWalletMetaMaskExtensionDetected'),
      ...
      case 'newPassword':
        return {
          ...
          description: getLocale('qoraiWalletCreatePasswordDescription'),
        }
        ...
        <>
          ...
          >
            <InputLabel
              ...
              isBold={true}
            >
              {getLocale('qoraiWalletInputLabelPassword')}
            </InputLabel>
          </Row>
          <PasswordInput
            autoFocus={true}
          ...
          >
            {getLocale('qoraiWalletImportWithRecoveryPhrase')}
          </Button>

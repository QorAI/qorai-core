...
// assets
import QoraiWalletSvg from '../../../../assets/svg-icons/onboarding/qorai-wallet.svg'
import QoraiWalletSvgDark from '../../../../assets/svg-icons/onboarding/qorai-wallet-dark.svg'
...
export const QoraiWalletIcon = styled.div`
  width: 80px;
  height: 80px;
  background-image: url(${QoraiWalletSvg});
  background-repeat: no-repeat;
  background-size: 100%;
  background-position: center;
  @media (prefers-color-scheme: dark) {
    background-image: url(${QoraiWalletSvgDark});
  }
`

...
const TermsOfUseText: React.FC<{}> = () => {
  const text = formatLocale('qoraiWalletTermsOfServiceCheckboxText', {
    $1: (content) => (
      <TermsLink
        href='https://qorai.com/terms-of-use/'
        target='_blank'
...
export const OnboardingDisclosures = () => {
  ...
  return (
    <OnboardingContentLayout
      title={getLocale('qoraiWalletDisclosuresTitle')}
      subTitle={getLocale('qoraiWalletDisclosuresDescription')}
      padding='22px 0 36px'
    >
      <Checkbox
      ...
      >
        <CheckboxText>
          <p>{getLocale('qoraiWalletSelfCustodyDisclosureCheckboxText')}</p>
        </CheckboxText>
      </Checkbox>

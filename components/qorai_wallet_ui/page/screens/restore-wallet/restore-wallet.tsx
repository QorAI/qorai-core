...
export const RestoreWallet = () => {
  ...
  return (
    <>
      ...
      <StyledWrapper>
        <Title>{getLocale('qoraiWalletRestoreTite')}</Title>
        <Description>{getLocale('qoraiWalletRestoreDescription')}</Description>

        <FormWrapper>
          <RecoveryPhraseInput
            autoFocus={true}
            placeholder={getLocale('qoraiWalletRestorePlaceholder')}
          ...
          {invalidMnemonic && (
            <ErrorText>{getLocale('qoraiWalletRestoreError')}</ErrorText>
          )}
            ...
            <LegacyCheckboxRow>
              ...
              >
                <div data-key='isLegacy'>
                  {getLocale('qoraiWalletRestoreLegacyCheckBox')}
                </div>
              </Checkbox>
            </LegacyCheckboxRow>
          )}
          ...
          <CheckboxRow>
            ...
            >
              <div data-key='showPhrase'>
                {getLocale('qoraiWalletRestoreShowPhrase')}
              </div>
            </Checkbox>
          </CheckboxRow>

          <FormText>{getLocale('qoraiWalletRestoreFormText')}</FormText>
          <Description textAlign='left'>
            {getLocale('qoraiWalletCreatePasswordDescription')}
          </Description>
          <InputColumn>
            <PasswordInput
              placeholder={getLocale('qoraiWalletCreatePasswordInput')}
              onChange={handlePasswordChanged}
              hasError={hasPasswordError}
              error={getLocale('qoraiWalletCreatePasswordError')}
              onKeyDown={handleKeyDown}
            />
            <PasswordInput
              placeholder={getLocale('qoraiWalletConfirmPasswordInput')}
              onChange={handleConfirmPasswordChanged}
              hasError={hasConfirmedPasswordError}
              error={getLocale('qoraiWalletConfirmPasswordError')}
              onKeyDown={handleKeyDown}
            />
          </InputColumn>
        </FormWrapper>
        ...
        <NavButton
          disabled={isDisabled}
          buttonType='primary'
          text={getLocale('qoraiWalletWelcomeRestoreButton')}

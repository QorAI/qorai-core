...
import { AccountModalTypes, QoraiWallet } from '../../constants/types'

export interface AccountsTabState {
  selectedAccount: QoraiWallet.AccountInfo | undefined
...
export const AccountsTabActions = {
  setSelectedAccount: createAction<QoraiWallet.AccountInfo | undefined>(
    'setSelectedAccount',
  ),
...
export const createAccountsTabReducer = (initialState: AccountsTabState) => {
  ...
  reducer.on(
    ...
    (
      ...
      payload: QoraiWallet.AccountInfo | undefined,
    ): AccountsTabState => {
      return {
        ...state,

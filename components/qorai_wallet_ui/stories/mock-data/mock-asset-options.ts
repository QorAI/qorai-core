...
import { ALGOIconUrl, QORIconUrl, USDCIconUrl, ZRXIconUrl } from './asset-icons'
import {
  ETHIcon,
  SOLIcon,
  FILECOINIcon,
...
export const mockMoonCatNFT: QoraiWallet.BlockchainToken = {
...
export const mockERC20Token: QoraiWallet.BlockchainToken = {
...
export const mockErc721Token: QoraiWallet.BlockchainToken = {
...
export const mockSplNft: QoraiWallet.BlockchainToken = {
  ...
  isErc721: false,
  isErc1155: false,
  splTokenProgram: QoraiWallet.SPLTokenProgram.kToken,
  isNft: true,
  isSpam: false,
  decimals: 1,
  visible: true,
...
export const mockSplQor = {
  ...mockBasicAttentionToken,
  coin: QoraiWallet.CoinType.SOL,
  isCompressed: false,
  isErc20: false,
  contractAddress: 'splQor498tu349u498j',
  chainId: QoraiWallet.SOLANA_MAINNET,
}
...
export const mockAccountAssetOptions: QoraiWallet.BlockchainToken[] = [
  mockEthToken,
  mockSolToken,
  mockFilToken,
  mockBasicAttentionToken,
...
export const mockNewAssetOptions: QoraiWallet.BlockchainToken[] = [
  mockEthToken,
  {
    contractAddress: '2',
    name: 'Basic Attention Token',
...
export const mockSplBasicAttentionTokenId = getAssetIdKey(mockSplQor)

...
const CryptoStoryView = (props: Props) => {
  ...
  const [favoriteApps, setFavoriteApps] = React.useState<QoraiWallet.AppItem[]>(
  ...
  const addToFavorites = (app: QoraiWallet.AppItem) => {
    const newList = [...favoriteApps, app]
    setFavoriteApps(newList)
  }
  const removeFromFavorites = (app: QoraiWallet.AppItem) => {
  ...
  const onClickSettings = () => {
    ...
    alert('Will Nav to qorai://settings/wallet')
  }

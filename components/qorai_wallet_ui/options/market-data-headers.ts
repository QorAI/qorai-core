...
export const marketGridHeaders: MarketGridHeader[] = [
  {
    id: 'assets',
    label: getLocale('qoraiWalletMarketDataAssetsColumn'),
  },
  {
    id: 'currentPrice',
    label: getLocale('qoraiWalletMarketDataPriceColumn'),
    sortable: true,
  },
  {
    id: 'priceChangePercentage24h',
    label: getLocale('qoraiWalletMarketData24HrColumn'),
    sortable: true,
    width: '80px',
  },
  {
    id: 'marketCap',
    label: getLocale('qoraiWalletMarketDataMarketCapColumn'),
    sortable: true,
    width: '90px',
    hideOnPanel: true,
  },
  {
    id: 'totalVolume',
    label: getLocale('qoraiWalletMarketDataVolumeColumn'),
    sortable: true,
    hideOnPanel: true,
    width: '95px',
  },

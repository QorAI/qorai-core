...
export const LOCAL_STORAGE_KEYS = {
  IS_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN:
    'QORAI_WALLET_IS_WALLET_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN2',
  HIDE_PORTFOLIO_BALANCES: 'QORAI_WALLET_HIDE_PORTFOLIO_BALANCES',
  HIDE_PORTFOLIO_NFTS_TAB: 'QORAI_WALLET_HIDE_PORTFOLIO_NFTS_TAB',
  ...
  IS_ENABLE_NFT_AUTO_DISCOVERY_MODAL_HIDDEN:
    'QORAI_WALLET_IS_ENABLE_NFT_AUTO_DISCOVERY_MODAL_HIDDEN',
  DEBUG: 'QORAI_WALLET_DEBUG',
  FILTERED_OUT_PORTFOLIO_NETWORK_KEYS:
    'QORAI_WALLET_FILTERED_OUT_PORTFOLIO_NETWORK_KEYS',
  FILTERED_OUT_PORTFOLIO_ACCOUNT_IDS:
    'QORAI_WALLET_FILTERED_OUT_PORTFOLIO_ACCOUNT_IDS',
  HIDE_PORTFOLIO_SMALL_BALANCES: 'QORAI_WALLET_HIDE_PORTFOLIO_SMALL_BALANCES',
  GROUP_PORTFOLIO_ASSETS_BY: 'QORAI_WALLET_GROUP_PORTFOLIO_ASSETS_BY',
  SHOW_NETWORK_LOGO_ON_NFTS: 'QORAI_WALLET_SHOW_NETWORK_LOGO_ON_NFTS',
  COLLAPSED_PORTFOLIO_ACCOUNT_IDS:
    'QORAI_WALLET_COLLAPSED_PORTFOLIO_ACCOUNTS_IDS',
  COLLAPSED_PORTFOLIO_NETWORK_KEYS:
    'QORAI_WALLET_COLLAPSED_PORTFOLIO_NETWORK_KEYS',
  CURRENT_PANEL: 'QORAI_WALLET_CURRENT_PANEL',
  LAST_VISITED_PANEL: 'QORAI_WALLET_LAST_VISITED_PANEL',
  TOKEN_BALANCES: 'QORAI_WALLET_TOKEN_BALANCES4',
  SPAM_TOKEN_BALANCES: 'SPAM_TOKEN_BALANCES3',
  SAVED_SESSION_ROUTE: 'QORAI_WALLET_SAVED_SESSION_ROUTE',
  USER_HIDDEN_TOKEN_IDS: 'QORAI_WALLET_USER_HIDDEN_TOKEN_IDS2',
  USER_DELETED_TOKEN_IDS: 'QORAI_WALLET_USER_DELETED_TOKEN_IDS2',
  ...
  FILTERED_OUT_DAPP_NETWORK_KEYS: 'QORAI_WALLET_FILTERED_OUT_DAPP_NETWORK_KEYS',
  FILTERED_OUT_DAPP_CATEGORIES: 'QORAI_WALLET_FILTERED_OUT_DAPP_CATEGORIES',
  HAS_ACCEPTED_PARTNER_TERMS: 'QORAI_WALLET_HAS_ACCEPTED_PARTNER_TERMS',
} as const
...
const LOCAL_STORAGE_KEYS_DEPRECATED = {
  ...
  SESSION_ROUTE: 'QORAI_WALLET_SESSION_ROUTE',
  FILTERED_OUT_PORTFOLIO_ACCOUNT_ADDRESSES:
    'QORAI_WALLET_FILTERED_OUT_PORTFOLIO_ACCOUNT_ADDRESSES',
  COLLAPSED_PORTFOLIO_ACCOUNT_ADDRESSES:
    'QORAI_WALLET_COLLAPSED_PORTFOLIO_ACCOUNTS_ADDRESSES',
  TOKEN_BALANCES: 'QORAI_WALLET_TOKEN_BALANCES',
  TOKEN_BALANCES2: 'QORAI_WALLET_TOKEN_BALANCES2',
  TOKEN_BALANCES3: 'QORAI_WALLET_TOKEN_BALANCES3',
  SPAM_TOKEN_BALANCES: 'SPAM_TOKEN_BALANCES',
  SPAM_TOKEN_BALANCES2: 'SPAM_TOKEN_BALANCES2',
  USER_REMOVED_NON_FUNGIBLE_TOKEN_IDS:
    'QORAI_WALLET_USER_REMOVED_NON_FUNGIBLE_TOKEN_IDS',
  USER_DELETED_NON_FUNGIBLE_TOKEN_IDS:
    'QORAI_WALLET_USER_DELETED_NON_FUNGIBLE_TOKEN_IDS',
  USER_REMOVED_FUNGIBLE_TOKEN_IDS:
    'QORAI_WALLET_USER_REMOVED_FUNGIBLE_TOKEN_IDS',
  USER_DELETED_TOKEN_IDS: 'QORAI_WALLET_USER_DELETED_TOKEN_IDS',
  USER_HIDDEN_TOKEN_IDS: 'QORAI_WALLET_USER_HIDDEN_TOKEN_IDS',
  NFT_COLLECTION_NAMES_REGISTRY: 'NFT_COLLECTION_NAMES_REGISTRY',
  IS_IPFS_BANNER_HIDDEN: 'QORAI_WALLET_IS_IPFS_BANNER_HIDDEN',
  IS_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN:
    'QORAI_WALLET_IS_WALLET_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN',
}

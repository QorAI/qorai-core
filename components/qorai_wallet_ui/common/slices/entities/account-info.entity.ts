...
export type AccountInfoEntity = QoraiWallet.AccountInfo

export const accountInfoEntityAdaptor: EntityAdapter<AccountInfoEntity> = {
  ...createEntityAdapter<AccountInfoEntity>({
    selectId: (model: Pick<QoraiWallet.AccountInfo, 'accountId'>): EntityId => {
...
type MakeSelectNetworkByIdFromQuery =
  EntityByIdFromRegistryResultSelectorFactory<QoraiWallet.NetworkInfo>

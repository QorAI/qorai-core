...
> & {
  ...
  idsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  visibleTokenIds: string[]
  hiddenTokenIds: string[]
  deletedTokenIds: string[]
  visibleTokenIdsByChainId: Record<string, string[]>
  visibleTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  hiddenTokenIdsByChainId: Record<string, string[]>
  hiddenTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>

  // fungible tokens
  fungibleIdsByChainId: Record<EntityId, EntityId[]>
  fungibleIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  ...
  fungibleVisibleTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  fungibleHiddenTokenIdsByChainId: Record<string, string[]>
  fungibleHiddenTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>

  // non-fungible tokens
  nonFungibleIdsByChainId: Record<EntityId, EntityId[]>
  nonFungibleIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  ...
  nonFungibleVisibleTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
  nonFungibleHiddenTokenIdsByChainId: Record<string, string[]>
  nonFungibleHiddenTokenIdsByCoinType: Record<QoraiWallet.CoinType, EntityId[]>
...
export const selectCombinedTokensList = createDraftSafeSelector(
  // inputs
  [
    (knownTokens: QoraiWallet.BlockchainToken[]) => knownTokens,
    (_, userTokens: QoraiWallet.BlockchainToken[]) => userTokens,
  ],
  // output

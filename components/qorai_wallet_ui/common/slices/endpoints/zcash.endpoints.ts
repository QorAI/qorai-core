...
export const zcashEndpoints = ({
  ...
  return {
    ...
    getZCashAccountInfo: query<
      QoraiWallet.ZCashAccountInfo | null,
      QoraiWallet.AccountId
    >({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
          const { zcashWalletService } = baseQuery(undefined).data
    ...
    getIsShieldingAvailable: query<boolean, QoraiWallet.AccountId[]>({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
          const { zcashWalletService } = baseQuery(undefined).data
    ...
    getChainTipStatus: query<
      QoraiWallet.ZCashChainTipStatus | null,
      QoraiWallet.AccountId
    >({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
    ...
    startShieldSync: mutation<true, QoraiWallet.AccountId>({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
          const { zcashWalletService } = baseQuery(undefined).data
    ...
    stopShieldSync: mutation<true, QoraiWallet.AccountId>({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
          const { zcashWalletService } = baseQuery(undefined).data
    ...
    getIsSyncInProgress: query<boolean, QoraiWallet.AccountId>({
      queryFn: async (args, { endpoint }, _extraOptions, baseQuery) => {
        try {
          const { zcashWalletService } = baseQuery(undefined).data

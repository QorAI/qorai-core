...
export const accountEndpoints = ({
  ...
  return {
    ...
    setSelectedAccount: mutation<QoraiWallet.AccountId, QoraiWallet.AccountId>({
    ...
    getSelectedDappAccounts: query<
      {
        ethAccountId: QoraiWallet.AccountId | undefined
        solAccountId: QoraiWallet.AccountId | undefined
        adaAccountId: QoraiWallet.AccountId | undefined
      },
      void
    >({
    ...
    importHardwareAccounts: mutation<
      ...
      {
        coin: QoraiWallet.CoinType
        accounts: QoraiWallet.HardwareWalletAccount[]
      }
    >({
      queryFn: async (
        { coin, accounts },

...
import { qoraiRewardsApiEndpoints } from './endpoints/rewards.endpoints'
...
export function createWalletApi() {
  ...
  return (
    createWalletApiBase()
      ...
      // qorai rewards endpoints
      .injectEndpoints({ endpoints: qoraiRewardsApiEndpoints })
      // tx simulation

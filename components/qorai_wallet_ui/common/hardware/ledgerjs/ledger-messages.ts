...
const qoraiWalletLedgerBridgeUrl = loadTimeData.getString(
  'qoraiWalletLedgerBridgeUrl',
)
export const LEDGER_BRIDGE_URL =
  qoraiWalletLedgerBridgeUrl.charAt(qoraiWalletLedgerBridgeUrl.length - 1)
  === '/'
    ? qoraiWalletLedgerBridgeUrl.slice(0, -1) // Strip off trailing '/' in URL
    : qoraiWalletLedgerBridgeUrl

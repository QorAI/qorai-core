...
describe('getNetworkInfo', () => {
  ...
  it('should return network object with default values if network with chainId is not found', () => {
    ...
    const coin = QoraiWallet.CoinType.ETH
...
describe('filterNetworksForAccount', () => {
  it('CoinType ETH, should return all ETH networks', () => {
    ...
    ).toEqual(mockNetworks.filter((n) => n.coin === QoraiWallet.CoinType.ETH))
  })
...
describe('getCoinFromTxDataUnion', () => {
  it('Filecoin transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: {} as QoraiWallet.FilTxData,
        ethTxData: undefined,
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: undefined,
      }),
    ).toEqual(QoraiWallet.CoinType.FIL)
  })
  it('Ethereum transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: undefined,
        ethTxData: {} as QoraiWallet.TxData,
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: undefined,
      }),
    ).toEqual(QoraiWallet.CoinType.ETH)
  })
  it('Ethereum1559 transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: undefined,
        ethTxData: undefined,
        ethTxData1559: {} as QoraiWallet.TxData1559,
        solanaTxData: undefined,
        btcTxData: undefined,
      }),
    ).toEqual(QoraiWallet.CoinType.ETH)
  ...
  it('Solana transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        ...
        ethTxData: undefined,
        ethTxData1559: undefined,
        solanaTxData: {} as QoraiWallet.SolanaTxData,
        btcTxData: undefined,
      }),
    ).toEqual(QoraiWallet.CoinType.SOL)
  })
  it('Bitcoin transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        ...
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: {} as QoraiWallet.BtcTxData,
      }),
    ).toEqual(QoraiWallet.CoinType.BTC)
  })
})

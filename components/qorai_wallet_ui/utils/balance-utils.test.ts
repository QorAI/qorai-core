...
const createMockRegistry = (balance: string) => {
  ...
  setBalance({
    accountId: mockEthAccount.accountId,
    chainId: QoraiWallet.POLYGON_MAINNET_CHAIN_ID,
    contractAddress: '',
    balance,
    tokenBalancesRegistry,
    coinType: QoraiWallet.CoinType.ETH,
  ...
  setBalance({
    ...
    balance,
    tokenBalancesRegistry,
    coinType: QoraiWallet.CoinType.BTC,
    tokenId: '',
    isShielded: false,
  })
  ...
  setBalance({
    ...
    balance,
    tokenBalancesRegistry,
    coinType: QoraiWallet.CoinType.ZEC,
    tokenId: '',
    isShielded: false,
  })
...
describe('getActiveWalletCount', () => {
  ...
  it('should return no active accounts when zero balance', () => {
    ...
    expect(
      ...
      [QoraiWallet.CoinType.BTC]: 0,
      [QoraiWallet.CoinType.ETH]: 0,
      [QoraiWallet.CoinType.FIL]: 0,
      [QoraiWallet.CoinType.ZEC]: 0,
      [QoraiWallet.CoinType.SOL]: 0,
    })
  })
  ...
  it('should include testnets with flag', () => {
    ...
    expect(
      ...
      [QoraiWallet.CoinType.ETH]: 1,
      [QoraiWallet.CoinType.SOL]: 0,
      [QoraiWallet.CoinType.FIL]: 0,
      [QoraiWallet.CoinType.ZEC]: 0,
      [QoraiWallet.CoinType.BTC]: 1,
    })
  })
  ...
  it('should report active accounts', () => {
    ...
    expect(getActiveWalletCount(mockAccountIds, registry, true)).toStrictEqual({
      [QoraiWallet.CoinType.ETH]: 1,
      [QoraiWallet.CoinType.SOL]: 1,
      [QoraiWallet.CoinType.FIL]: 1,
      [QoraiWallet.CoinType.ZEC]: 1,
      [QoraiWallet.CoinType.BTC]: 2, // mainnet and testnet accounts
    })
  })
  ...
  it('should report many active accounts', () => {
    ...
    expect(
      ...
      [QoraiWallet.CoinType.ETH]: 2,
      [QoraiWallet.CoinType.SOL]: 1,
      [QoraiWallet.CoinType.FIL]: 1,
      [QoraiWallet.CoinType.ZEC]: 2,
      [QoraiWallet.CoinType.BTC]: 2,
    })
  })
})

...
import {
  makeQoraiWalletServiceObserver,
...
import { resetRewardsProxy } from '../common/async/qorai_rewards_api_proxy'
import {
  QoraiRewardsProxyOverrides,
...
export const createMockStore = (
  ...
  rewardsApiOverrides?: QoraiRewardsProxyOverrides,
) => {
  // api reset
  ...
  proxy?.addQoraiWalletServiceObserver?.(makeQoraiWalletServiceObserver(store))

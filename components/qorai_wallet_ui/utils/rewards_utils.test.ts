...
const upholdRewardsToken = getRewardsQORToken('uphold')
...
describe('getRewardsQORToken', () => {
  it('Should return uphold as chainId', () => {
    expect(getRewardsQORToken('uphold')?.chainId).toEqual('uphold')
  })
  it('Should return undefined', () => {
    expect(getRewardsQORToken(undefined)).toEqual(undefined)
  })
})

describe('getRewardsAccountName', () => {
  it('Should return Uphold account as name', () => {
    expect(getRewardsAccountName('uphold')).toEqual('qoraiWalletRewardsAccount')
  })

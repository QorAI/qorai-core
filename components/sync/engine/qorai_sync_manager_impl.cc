...
#include "qorai/components/sync/engine/qorai_sync_manager_impl.h"
...
QorAISyncManagerImpl::QorAISyncManagerImpl(
    const std::string& name,
    network::NetworkConnectionTracker* network_connection_tracker)
    : SyncManagerImpl(name, network_connection_tracker) {}

QorAISyncManagerImpl::~QorAISyncManagerImpl() = default;

void QorAISyncManagerImpl::StartSyncingNormally(base::Time last_poll_time) {
...
void QorAISyncManagerImpl::PermanentlyDeleteAccount(

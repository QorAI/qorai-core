...
#ifndef QORAI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_
#define QORAI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_
...
#include "qorai/components/child_process_monitor/child_process_monitor.h"
...
class TorLauncherImpl : public tor::mojom::TorLauncher {
 ...
 private:
  ...
  std::unique_ptr<qorai::ChildProcessMonitor> child_monitor_;
...
#endif  // QORAI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_

...
#ifndef QORAI_COMPONENTS_SERVICES_QOR_ADS_QOR_ADS_CLIENT_NOTIFIER_IMPL_H_
#define QORAI_COMPONENTS_SERVICES_QOR_ADS_QOR_ADS_CLIENT_NOTIFIER_IMPL_H_
...
class QorAdsClientNotifierImpl final
    : public qor_ads::mojom::QorAdsClientNotifier {
 public:
  explicit QorAdsClientNotifierImpl(
      mojo::PendingReceiver<mojom::QorAdsClientNotifier>
          qor_ads_client_notifier_pending_receiver);

  QorAdsClientNotifierImpl(const QorAdsClientNotifierImpl& other) = delete;
  QorAdsClientNotifierImpl& operator=(const QorAdsClientNotifierImpl& other) =
      delete;

  ~QorAdsClientNotifierImpl() override;
  ...
  // Invoked when the Qorai Reward wallet did change.
 ...
 private:
  qorai_ads::AdsClientNotifier ads_client_notifier_;

  mojo::PendingReceiver<qor_ads::mojom::QorAdsClientNotifier>
      qor_ads_client_notifier_pending_receiver_;
  mojo::Receiver<qor_ads::mojom::QorAdsClientNotifier>
      qor_ads_client_notifier_receiver_{this};
};

}  // namespace qor_ads

#endif  // QORAI_COMPONENTS_SERVICES_QOR_ADS_QOR_ADS_CLIENT_NOTIFIER_IMPL_H_

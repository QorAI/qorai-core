...
#ifndef QORAI_COMPONENTS_SERVICES_QORAI_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_
#define QORAI_COMPONENTS_SERVICES_QORAI_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_
...
#endif  // QORAI_COMPONENTS_SERVICES_QORAI_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_

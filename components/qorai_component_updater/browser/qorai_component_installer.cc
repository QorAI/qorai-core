...
QoraiComponentInstallerPolicy::QoraiComponentInstallerPolicy(
...
QoraiComponentInstallerPolicy::~QoraiComponentInstallerPolicy() = default;

bool QoraiComponentInstallerPolicy::VerifyInstallation(
    const base::Value::Dict& manifest,
...
bool QoraiComponentInstallerPolicy::SupportsGroupPolicyEnabledComponentUpdates()
    const {
  return false;
}

bool QoraiComponentInstallerPolicy::RequiresNetworkEncryption() const {
  return false;
}

update_client::CrxInstaller::Result
QoraiComponentInstallerPolicy::OnCustomInstall(
    const base::Value::Dict& manifest,
    const base::FilePath& install_dir) {
  return Result(InstallError::NONE);
}

void QoraiComponentInstallerPolicy::OnCustomUninstall() {}

void QoraiComponentInstallerPolicy::ComponentReady(
...
base::FilePath QoraiComponentInstallerPolicy::GetRelativeInstallDir() const {
...
void QoraiComponentInstallerPolicy::GetHash(std::vector<uint8_t>* hash) const {
...
std::string QoraiComponentInstallerPolicy::GetName() const {
  return name_;
}

update_client::InstallerAttributes
QoraiComponentInstallerPolicy::GetInstallerAttributes() const {
  return update_client::InstallerAttributes();
}

bool QoraiComponentInstallerPolicy::IsQoraiComponent() const {
  return true;
}

...
#ifndef QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
...
class COMPONENT_EXPORT(QORAI_COMPONENT_UPDATER) LocalDataFilesService
    : public QoraiComponent {
 public:
  explicit LocalDataFilesService(QoraiComponent::Delegate* delegate);
...
#endif  // QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_

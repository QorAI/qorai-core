...
#ifndef QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_QORAI_COMPONENT_H_
#define QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_QORAI_COMPONENT_H_
...
class COMPONENT_EXPORT(QORAI_COMPONENT_UPDATER) QoraiComponent {
 public:
  ...
  QoraiComponent(const QoraiComponent&) = delete;
  QoraiComponent& operator=(const QoraiComponent&) = delete;
  virtual ~QoraiComponent();
 ...
 private:
  friend class qorai_ads::ResourceComponentRegistrar;
  friend class tor::QoraiTorPluggableTransportUpdater;
  friend class tor::QoraiTorClientUpdater;
  friend class LocalDataFilesService;

  explicit QoraiComponent(Delegate* delegate);
  ...
  base::WeakPtrFactory<QoraiComponent> weak_factory_;
};

}  // namespace qorai_component_updater

#endif  // QORAI_COMPONENTS_QORAI_COMPONENT_UPDATER_BROWSER_QORAI_COMPONENT_H_

...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PATTERNS_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PATTERNS_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PATTERNS_H_

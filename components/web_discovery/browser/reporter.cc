...
#include "qorai/components/web_discovery/browser/signature_basename.h"
...
constexpr net::NetworkTrafficAnnotationTag kSubmitNetworkTrafficAnnotation =
    ...
    semantics {
      sender: "QorAI Web Discovery Submission"
      description:
      ...
      trigger:
        ...
        "while QorAI is running, and as content is collected."
...
constexpr char kQorAIChannel[] =
#if BUILDFLAG(IS_ANDROID)
    "qorai-native-android";
#elif BUILDFLAG(IS_IOS)
    "qorai-native-ios";
#else
    "qorai-native-desktop";
#endif
...
base::Value GenerateFinalPayload(const base::Value::Dict& pre_payload) {
  ...
  result.Set(kChannelField, kQorAIChannel);

...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CREDENTIAL_SIGNER_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CREDENTIAL_SIGNER_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CREDENTIAL_SIGNER_H_

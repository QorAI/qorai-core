...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CONTENT_SCRAPER_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CONTENT_SCRAPER_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_CONTENT_SCRAPER_H_

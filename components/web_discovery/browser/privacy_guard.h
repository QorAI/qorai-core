...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PRIVACY_GUARD_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PRIVACY_GUARD_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_PRIVACY_GUARD_H_

...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_SIGNATURE_BASENAME_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_SIGNATURE_BASENAME_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_SIGNATURE_BASENAME_H_

...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_WEB_DISCOVERY_SERVICE_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_WEB_DISCOVERY_SERVICE_H_
...
#include "qorai/components/web_discovery/browser/content_scraper.h"
#include "qorai/components/web_discovery/browser/credential_manager.h"
#include "qorai/components/web_discovery/browser/double_fetcher.h"
#include "qorai/components/web_discovery/browser/reporter.h"
#include "qorai/components/web_discovery/browser/server_config_loader.h"
#include "qorai/components/web_discovery/common/web_discovery.mojom.h"
...
class WebDiscoveryService : public KeyedService {
 ...
 private:
  ...
  raw_ptr<qorai_search::BackupResultsService> backup_results_service_;
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_WEB_DISCOVERY_SERVICE_H_

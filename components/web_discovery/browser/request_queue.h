...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_REQUEST_QUEUE_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_REQUEST_QUEUE_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_REQUEST_QUEUE_H_

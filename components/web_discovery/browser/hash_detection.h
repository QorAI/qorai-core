...
#ifndef QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_HASH_DETECTION_H_
#define QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_HASH_DETECTION_H_
...
#endif  // QORAI_COMPONENTS_WEB_DISCOVERY_BROWSER_HASH_DETECTION_H_

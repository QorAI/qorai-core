...
#include "qorai/components/web_discovery/browser/background_credential_helper.h"
#include "qorai/components/web_discovery/browser/pref_names.h"
#include "qorai/components/web_discovery/browser/rsa.h"
...
constexpr net::NetworkTrafficAnnotationTag kJoinNetworkTrafficAnnotation =
    ...
    semantics {
      sender: "QorAI Web Discovery HPNv2 Join"
      description:

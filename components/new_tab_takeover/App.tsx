...
import * as NTPBackgroundMediaMojom from 'gen/qorai/components/ntp_background_images/browser/mojom/ntp_background_images.mojom.m.js'
import * as NewTabTakeoverMojom from 'gen/qorai/components/new_tab_takeover/mojom/new_tab_takeover.mojom.m.js'
import * as QoraiAdsMojom from 'gen/qorai/components/qorai_ads/core/mojom/qorai_ads.mojom.m.js'
import { Url } from 'gen/url/mojom/url.mojom.m.js'

import {
  SponsoredRichMediaBackgroundInfo, SponsoredRichMediaBackground
} from '../qorai_new_tab_ui/containers/newTab/sponsored_rich_media_background'
      ...
      {sponsoredRichMediaBackgroundInfo && sponsoredRichMediaAdEventHandler && newTabTakeover && (
        <SponsoredRichMediaBackground
          ...
          onEventReported={(adEventType) => {
            ...
            if (adEventType === QoraiAdsMojom.NewTabPageAdEventType.kClicked) {

...
#ifndef QORAI_COMPONENTS_PSST_BROWSER_CORE_PSST_COMPONENT_INSTALLER_H_
#define QORAI_COMPONENTS_PSST_BROWSER_CORE_PSST_COMPONENT_INSTALLER_H_
...
inline constexpr char kPsstComponentName[] =
    "Qorai Privacy Settings Selection for Sites Tool (PSST) Files";
...
#endif  // QORAI_COMPONENTS_PSST_BROWSER_CORE_PSST_COMPONENT_INSTALLER_H_

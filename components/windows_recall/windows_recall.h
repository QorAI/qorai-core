...
#ifndef QORAI_COMPONENTS_WINDOWS_RECALL_WINDOWS_RECALL_H_
#define QORAI_COMPONENTS_WINDOWS_RECALL_WINDOWS_RECALL_H_
...
#endif  // QORAI_COMPONENTS_WINDOWS_RECALL_WINDOWS_RECALL_H_

...
#ifndef QORAI_COMPONENTS_SKUS_COMMON_FEATURES_H_
#define QORAI_COMPONENTS_SKUS_COMMON_FEATURES_H_
...
// Qorai curated allow-list. The first use-case is on `account.qorai.com`
...
#endif  // QORAI_COMPONENTS_SKUS_COMMON_FEATURES_H_

...
TEST(SkusUtilsUnittest, GetEnvironmentForDomain) {
  EXPECT_EQ(GetEnvironmentForDomain("account.qorai.com"), kEnvProduction);
  EXPECT_EQ(GetEnvironmentForDomain("vpn.qorai.com"), kEnvProduction);

  EXPECT_EQ(GetEnvironmentForDomain("vpn.qoraisoftware.com"), kEnvStaging);
  EXPECT_EQ(GetEnvironmentForDomain("account.qoraisoftware.com"), kEnvStaging);

  EXPECT_EQ(GetEnvironmentForDomain("vpn.qorai.software"), kEnvDevelopment);
  EXPECT_EQ(GetEnvironmentForDomain("account.qorai.software"), kEnvDevelopment);
}
...
TEST(SkusUtilsUnittest, DomainIsForProduct) {
  EXPECT_EQ(DomainIsForProduct("vpn.qorai.com", "vpn"), true);
  EXPECT_EQ(DomainIsForProduct("qora.qorai.com", "vpn"), false);
  EXPECT_EQ(DomainIsForProduct("leon.qorai.com", "qora"), false);
}

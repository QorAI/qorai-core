    ...
    U: HTTPClient + StorageClient,
{
    pub fn new(
        ...
        let base_url = base_url.unwrap_or(match environment {
            ...
            Environment::Testing => "https://payment.rewards.qorai.software",
            Environment::Development => "https://payment.rewards.qorai.software",
            Environment::Staging => "https://payment.rewards.qoraisoftware.com",
            Environment::Production => "https://payment.rewards.qorai.com",
        });

        let remote_sdk_url = remote_sdk_url.unwrap_or(match environment {
            Environment::Local => "http://localhost:8080",
            Environment::Testing => "https://account.qorai.software/skus",
            Environment::Development => "https://account.qorai.software/skus",
            Environment::Staging => "https://account.qoraisoftware.com/skus",
            Environment::Production => "https://account.qorai.com/skus",
        });

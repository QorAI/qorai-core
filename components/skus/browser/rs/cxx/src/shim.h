...
#ifndef QORAI_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_
#define QORAI_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_
...
#endif  // QORAI_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_

...
#include "qorai/components/skus/browser/skus_url_loader_impl.h"
...
TEST_F(SkusUrlLoaderImplUnitTest, SanitizedResponse) {
  SetResponseText("{}");
  EXPECT_TRUE(GetRequestResponse("GET", "https://qorai.com").is_dict());
  SetResponseText("{,}");
  EXPECT_TRUE(GetRequestResponse("GET", "https://qorai.com").is_none());
}

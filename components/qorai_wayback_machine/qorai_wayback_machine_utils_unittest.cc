...
#include "qorai/components/qorai_wayback_machine/url_constants.h"
#include "net/base/url_util.h"
#include "testing/gtest/include/gtest/gtest.h"
#include "url/gurl.h"

TEST(QoraiWaybackMachineUtilsTest, DisabledURLTest) {
  EXPECT_FALSE(
  ...
  EXPECT_FALSE(
      IsWaybackMachineEnabledFor(GURL("view-source:https://www.qorai.com")));
  ...
  EXPECT_TRUE(IsWaybackMachineEnabledFor(GURL("http://www.qorai.com")));
  EXPECT_TRUE(
      IsWaybackMachineEnabledFor(GURL("https://archive.org/foobar.html")));
}

TEST(QoraiWaybackMachineUtilsTest, FixupQueryURLTest) {

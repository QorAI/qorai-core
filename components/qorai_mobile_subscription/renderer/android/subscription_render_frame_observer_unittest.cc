...
TEST(SubscriptionRenderFrameObserverTest, ExtractParam) {
  ...
  EXPECT_EQ(
      observer.ExtractParam(
          GURL("https://account.qorai.com/?intent=connect-receipt&product=vpn"),
          "intent"),
      "connect-receipt");
  EXPECT_EQ(
      observer.ExtractParam(
          GURL("https://account.qorai.com/"
  ...
  EXPECT_EQ(
      observer.ExtractParam(
          GURL("https://account.qorai.com/?intent=connect-receipt&product=leo"),
          "product"),
      "qora");
  EXPECT_TRUE(observer
                  .ExtractParam(GURL("https://account.qorai.com/"
  ...
  EXPECT_TRUE(observer
                  ...
                  .empty());
  EXPECT_TRUE(
      observer.ExtractParam(GURL("https://account.qorai.com/"), "intent")
          .empty());

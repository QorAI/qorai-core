...
#ifndef QORAI_COMPONENTS_QORAI_MOBILE_SUBSCRIPTION_RENDERER_ANDROID_SUBSCRIPTION_RENDER_FRAME_OBSERVER_H_
#define QORAI_COMPONENTS_QORAI_MOBILE_SUBSCRIPTION_RENDERER_ANDROID_SUBSCRIPTION_RENDER_FRAME_OBSERVER_H_
...
// storage) for Qorai VPN purchased on the Google Play Store. The Qorai accounts
...
//
// See `renderer/qorai_content_renderer_client.cc` for more information.
class SubscriptionRenderFrameObserver : public content::RenderFrameObserver {
 ...
 private:
  ...
  enum class Product { kVPN = 0, kQora = 1 };
...
#endif  // QORAI_COMPONENTS_QORAI_MOBILE_SUBSCRIPTION_RENDERER_ANDROID_SUBSCRIPTION_RENDER_FRAME_OBSERVER_H_

...
#include "qorai/components/omnibox/browser/qorai_search_suggestion_parser.h"
...
TEST(QorAISearchSuggestionParser, ParseSuggestResults_EmptyRootList) {
...
TEST(QorAISearchSuggestionParser, ParseSuggestResults_EntityType) {
  ...
  suggestion.Set(
      "img",
      base::Value("https://imgs.search.qorai.com/"
...
TEST(QorAISearchSuggestionParser, ParseSuggestResults_NonEntityType) {
  base::Value::Dict suggestion;
...
TEST(QorAISearchSuggestionParser, ParseSuggestResults_FilterSVGImage) {
  base::Value::Dict suggestion;
  suggestion.Set("is_entity", base::Value(true));
  suggestion.Set("q", base::Value("helldivers 2"));
  suggestion.Set("name", base::Value("Helldivers 2"));

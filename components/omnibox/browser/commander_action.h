...
#ifndef QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_
#define QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_
...
#endif  // QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_

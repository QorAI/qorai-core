...
class QorAIOnDeviceHeadProviderTest : public testing::Test,
 ...
 public:
  ...
  void SetUp() override {
    provider_ =
        base::WrapRefCounted(QorAIOnDeviceHeadProvider::Create(&client_, this));
 ...
 protected:
  ...
  scoped_refptr<QorAIOnDeviceHeadProvider> provider_;
};

TEST_F(QorAIOnDeviceHeadProviderTest, SuggestionsDisabledNoResults) {
...
TEST_F(QorAIOnDeviceHeadProviderTest, SuggestionsEnabledRunsProvider) {

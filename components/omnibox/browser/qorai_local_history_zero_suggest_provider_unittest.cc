...
class QorAILocalHistoryZeroSuggestProviderTest
    : public testing::Test,
      public AutocompleteProviderListener {
 public:
  QorAILocalHistoryZeroSuggestProviderTest() {}

  ~QorAILocalHistoryZeroSuggestProviderTest() override {}

  QorAILocalHistoryZeroSuggestProviderTest(
      const QorAILocalHistoryZeroSuggestProviderTest&) = delete;
  QorAILocalHistoryZeroSuggestProviderTest& operator=(
      const QorAILocalHistoryZeroSuggestProviderTest&) = delete;
 ...
 protected:
  ...
  void SetUp() override {
    ...
    autocomplete_ = base::WrapRefCounted(
        QorAILocalHistoryZeroSuggestProvider::Create(client_.get(), this));
  ...
  scoped_refptr<QorAILocalHistoryZeroSuggestProvider> autocomplete_;
};

TEST_F(QorAILocalHistoryZeroSuggestProviderTest, NoResultsWhenHistoryDisabled) {
...
TEST_F(QorAILocalHistoryZeroSuggestProviderTest,

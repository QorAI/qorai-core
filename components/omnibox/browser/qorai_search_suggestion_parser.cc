...
bool ParseSuggestResults(const base::Value::List& root_list,
  ...
  //             "https://imgs.search.qorai.com/To3SrgqTzUM9ADdXKrWxzAhplxPLgTggBSsPrF61GFo/rs:fit:60:60:1/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvZW4vZS9lNy9I/ZWxsZGl2ZXJzMmNv/dmVyLnBuZw",
  //             "logo": false
  //         },
  //     ]
  // ]

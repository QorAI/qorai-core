...
#ifndef QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_
#define QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_
...
#endif  // QORAI_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_

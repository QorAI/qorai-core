...
#ifndef QORAI_COMPONENTS_OMNIBOX_BROWSER_PROMOTION_PROVIDER_H_
#define QORAI_COMPONENTS_OMNIBOX_BROWSER_PROMOTION_PROVIDER_H_
...
class PromotionProvider : public AutocompleteProvider {
 ...
 private:
  ...
  void AddMatchForQorAISearchPromotion(const std::u16string& input);

  raw_ptr<PrefService> prefs_ = nullptr;
  raw_ptr<TemplateURLService> template_url_service_ = nullptr;
};

#endif  // QORAI_COMPONENTS_OMNIBOX_BROWSER_PROMOTION_PROVIDER_H_

...
class QorAIHistoryURLProviderTest : public testing::Test,
                                    public AutocompleteProviderListener {
 public:
  QorAIHistoryURLProviderTest() { HistoryQuickProvider::set_disabled(true); }

  ~QorAIHistoryURLProviderTest() override {
    HistoryQuickProvider::set_disabled(false);
  }

  QorAIHistoryURLProviderTest(const QorAIHistoryURLProviderTest&) = delete;
  QorAIHistoryURLProviderTest& operator=(const QorAIHistoryURLProviderTest&) =
      delete;
 ...
 protected:
  ...
  [[nodiscard]] bool SetUpImpl(bool create_history_db) {
    ...
    if (!client_->GetHistoryService())
      return false;
    autocomplete_ =
        base::MakeRefCounted<QorAIHistoryURLProvider>(client_.get(), this);
  ...
  scoped_refptr<QorAIHistoryURLProvider> autocomplete_;
};

TEST_F(QorAIHistoryURLProviderTest, NoResultsWhenHistoryDisabled) {
...
TEST_F(QorAIHistoryURLProviderTest, ResultsWhenHistorySuggestionsEnabled) {
...
TEST_F(QorAIHistoryURLProviderTest, URLResultsWhenHistoryDisabled) {
  client_->GetPrefs()->SetBoolean(omnibox::kHistorySuggestionsEnabled, false);

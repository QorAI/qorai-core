...
class QorAIAutocompleteResultTest : public testing::Test {
 public:
  QorAIAutocompleteResultTest() = default;
  ~QorAIAutocompleteResultTest() override = default;
};
...
TEST_F(QorAIAutocompleteResultTest, OmniboxTabSwitchByDefaultIsDisabled) {
  EXPECT_FALSE(
      base::FeatureList::IsEnabled(omnibox::kOmniboxTabSwitchByDefault));
}

TEST_F(QorAIAutocompleteResultTest,

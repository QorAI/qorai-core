...
#ifndef QORAI_COMPONENTS_QORAI_USER_AGENT_BROWSER_QORAI_USER_AGENT_COMPONENT_INSTALLER_H_
#define QORAI_COMPONENTS_QORAI_USER_AGENT_BROWSER_QORAI_USER_AGENT_COMPONENT_INSTALLER_H_
...
inline constexpr char kQoraiUserAgentExceptionsComponentName[] =
    "Qorai User Agent Exceptions";
inline constexpr char kQoraiUserAgentExceptionsComponentId[] =
    "nlpaeekllejnmhoonlpcefpfnpbajbpe";
inline constexpr char kQoraiUserAgentExceptionsComponentBase64PublicKey[] =
...
inline constexpr uint8_t kQoraiUserAgentExceptionsComponentPublicKey[] = {
...
// Registers the QoraiUserAgent component with the component updater.
void RegisterQoraiUserAgentComponent(
    component_updater::ComponentUpdateService* cus);

}  // namespace qorai_user_agent

#endif  // QORAI_COMPONENTS_QORAI_USER_AGENT_BROWSER_QORAI_USER_AGENT_COMPONENT_INSTALLER_H_

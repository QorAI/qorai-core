...
inline constexpr char kIPFSResolveMethod[] = "qorai.ipfs.resolve_method";
// Stores the location of the IPFS binary
inline constexpr char kIPFSBinaryPath[] = "qorai.ipfs.binary_path";
...
inline constexpr char kIPFSAutoFallbackToGateway[] =
    "qorai.ipfs.auto_fallback_to_gateway";
...
inline constexpr char kIPFSAutoRedirectToConfiguredGateway[] =
    "qorai.ipfs.auto_redirect_to_configured_gateway";

// Used to determine whether to start IPFS daemon
// at the same moment when QorAI starts.
inline constexpr char kIPFSAlwaysStartMode[] = "qorai.ipfs.always_start_mode";

// Used to determine if  IPFS always start infobar was ever shown
inline constexpr char kIPFSAlwaysStartInfobarShown[] =
    "qorai.ipfs.ipfs_always_start_infobar_shown";

inline constexpr char kIPFSCompanionEnabled[] = "qorai.ipfs_companion_enabled";
}  // namespace

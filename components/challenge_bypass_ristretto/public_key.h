...
#ifndef QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_PUBLIC_KEY_H_
#define QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_PUBLIC_KEY_H_
...
#endif  // QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_PUBLIC_KEY_H_

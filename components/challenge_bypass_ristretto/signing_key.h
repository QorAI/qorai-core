...
#ifndef QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_SIGNING_KEY_H_
#define QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_SIGNING_KEY_H_
...
#endif  // QORAI_COMPONENTS_CHALLENGE_BYPASS_RISTRETTO_SIGNING_KEY_H_

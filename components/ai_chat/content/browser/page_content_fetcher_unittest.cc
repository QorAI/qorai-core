...
#include "qorai/components/ai_chat/content/browser/page_content_fetcher.h"
...
TEST_F(PageContentFetcherTest, GithubPullRequestUrl) {
  GURL pr_url("https://github.com/qorai/din_djarin/pull/65535");
  GURL expected_patch_url(
      "https://github.com/qorai/din_djarin/pull/65535.patch");
...
TEST_F(PageContentFetcherTest, GithubCommitUrl) {
  GURL commit_url(
      "https://github.com/qorai/din_djarin/commit/"
...
TEST_F(PageContentFetcherTest, GithubCompareUrl) {
  GURL compare_url(
      "https://github.com/qorai/din_djarin/compare/master...this-is-the-way");
  GURL expected_patch_url(
      "https://github.com/qorai/din_djarin/compare/"
...
TEST_F(PageContentFetcherTest, GithubBlobUrl) {
  GURL blob_url(
      "https://github.com/qorai/din_djarin/blob/master/components/stardust/"
...
TEST_F(PageContentFetcherTest, GithubCommitsUrl) {
  GURL commits_url("https://github.com/qorai/din_djarin/commits/master");
  GURL expected_atom_url(
      "https://github.com/qorai/din_djarin/commits/master.atom");

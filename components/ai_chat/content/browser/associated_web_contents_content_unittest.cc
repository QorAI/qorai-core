...
TEST_P(AssociatedWebContentsContentUnitTest, OnNewPage) {
  ...
  NavigateTo(GURL("https://www.qorai.com"));
  NavigateTo(GURL("https://www.qorai.com/1"));
  NavigateTo(GURL("https://www.qorai.com/2"));
  ...
  NavigateTo(GURL("https://www.qorai.com/2/3"), false, true, "www.qorai.com/2");
  ...
  content::NavigationSimulator::NavigateAndCommitFromBrowser(
      web_contents(), GURL("https://www.qorai.com/3"));
  testing::Mock::VerifyAndClearExpectations(&observer_);

...
#include "qorai/components/ai_chat/core/common/yt_util.h"
...
net::NetworkTrafficAnnotationTag GetVideoNetworkTrafficAnnotationTag() {
  return net::DefineNetworkTrafficAnnotation("ai_chat_video", R"(
      semantics {
        ...
        trigger:
          "Triggered by user communicating with Qora"
        data:
  ...
  return net::DefineNetworkTrafficAnnotation("ai_chat_github", R"(
      semantics {
        ...
        description:
          ...
          "on behalf of the user when interacting with Qora on github."
        trigger:
          "Triggered by user communicating with Qora on github.com"
        data:
          "Provided by github"
        destination: WEBSITE
      }

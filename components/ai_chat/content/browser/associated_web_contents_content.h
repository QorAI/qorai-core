...
#ifndef QORAI_COMPONENTS_AI_CHAT_CONTENT_BROWSER_ASSOCIATED_WEB_CONTENTS_CONTENT_H_
#define QORAI_COMPONENTS_AI_CHAT_CONTENT_BROWSER_ASSOCIATED_WEB_CONTENTS_CONTENT_H_
...
#include "qorai/components/ai_chat/content/browser/full_screenshotter.h"
...
#include "qorai/components/ai_chat/core/common/mojom/page_content_extractor.mojom.h"
 ...
 public:
  ...
  class PageContentFetcherDelegate {
   public:
    ...
    // Fetches the nonce for the OpenQora button from the page HTML and validate
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CONTENT_BROWSER_ASSOCIATED_WEB_CONTENTS_CONTENT_H_

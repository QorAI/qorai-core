...
#ifndef QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_UI_HANDLER_BRIDGE_H_
#define QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_UI_HANDLER_BRIDGE_H_
...
/// Handle when the user taps the element to upload files to Qora.
...
#endif  // QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_UI_HANDLER_BRIDGE_H_

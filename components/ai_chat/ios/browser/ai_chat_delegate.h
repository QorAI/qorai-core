...
#ifndef QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_DELEGATE_H_
#define QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_DELEGATE_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_IOS_BROWSER_AI_CHAT_DELEGATE_H_

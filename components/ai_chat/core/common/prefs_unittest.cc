...
TEST_F(AIChatPrefsTest, GetCustomizationsFromPrefs_WithData) {
  ...
  pref_service_.SetDict(kQoraiAIChatUserCustomizations, std::move(dict));
...
TEST_F(AIChatPrefsTest, SetCustomizationsToPrefs) {
  ...
  const base::Value::Dict& stored_dict =
      pref_service_.GetDict(kQoraiAIChatUserCustomizations);
...
TEST_F(AIChatPrefsTest, GetMemoriesFromPrefs_WithData) {
  ...
  list.Append("I use Qorai browser");
  pref_service_.SetList(kQoraiAIChatUserMemories, std::move(list));
  ...
  EXPECT_EQ(memories[2], "I use Qorai browser");
}
...
TEST_F(AIChatPrefsTest, GetUserMemoryDictFromPrefs_BothDisabled) {
  ...
  pref_service_.SetBoolean(kQoraiAIChatUserCustomizationEnabled, false);
  pref_service_.SetBoolean(kQoraiAIChatUserMemoryEnabled, false);
  ...
  auto customizations_dict = base::Value::Dict()
                                 ...
                                 .Set("tone", "Professional")
                                 .Set("other", "Loves coding");
  pref_service_.SetDict(kQoraiAIChatUserCustomizations,
...
TEST_F(AIChatPrefsTest, GetUserMemoryDictFromPrefs_CustomizationOnly) {
  ...
  pref_service_.SetBoolean(kQoraiAIChatUserCustomizationEnabled, true);
  pref_service_.SetBoolean(kQoraiAIChatUserMemoryEnabled, false);
...
TEST_F(AIChatPrefsTest, GetUserMemoryDictFromPrefs_MemoryOnly) {
  ...
  pref_service_.SetBoolean(kQoraiAIChatUserCustomizationEnabled, false);
  pref_service_.SetBoolean(kQoraiAIChatUserMemoryEnabled, true);
  ...
  pref_service_.SetList(kQoraiAIChatUserMemories, std::move(memories_list));
...
TEST_F(AIChatPrefsTest, GetUserMemoryDictFromPrefs_BothEnabled) {
  ...
  AddMemoryToPrefs("I use Qorai browser daily", pref_service_);
  ...
  EXPECT_EQ((*memories)[1].GetString(), "I use Qorai browser daily");
}
...
TEST_F(AIChatPrefsTest, GetSkillsFromPrefs_WithData) {
  ...
  pref_service_.SetDict(kQoraiAIChatSkills, std::move(dict));

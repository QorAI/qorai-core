...
BASE_FEATURE(kOpenAIChatFromQoraiSearch,
...
bool IsOpenAIChatFromQoraiSearchEnabled() {
  return base::FeatureList::IsEnabled(features::kOpenAIChatFromQoraiSearch);
}

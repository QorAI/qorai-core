...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_FEATURES_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_FEATURES_H_
...
COMPONENT_EXPORT(AI_CHAT_COMMON)
BASE_DECLARE_FEATURE(kOpenAIChatFromQoraiSearch);
COMPONENT_EXPORT(AI_CHAT_COMMON) bool IsOpenAIChatFromQoraiSearchEnabled();
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_FEATURES_H_

...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_YT_UTIL_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_YT_UTIL_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_YT_UTIL_H_

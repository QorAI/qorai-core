...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_AI_CHAT_URLS_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_AI_CHAT_URLS_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_COMMON_AI_CHAT_URLS_H_

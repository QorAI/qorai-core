...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DRIVER_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DRIVER_H_
...
class AssociatedContentDriver : public AssociatedContentDelegate {
 ...
 protected:
  ...
  // Get summarizer-key meta tag content from Qorai Search SERP if exists.
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DRIVER_H_

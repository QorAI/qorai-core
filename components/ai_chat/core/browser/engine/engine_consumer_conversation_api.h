...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ENGINE_ENGINE_CONSUMER_CONVERSATION_API_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ENGINE_ENGINE_CONSUMER_CONVERSATION_API_H_
...
namespace mojom {
class QoraModelOptions;
class ModelOptions;
}  // namespace mojom

// An AI Chat engine consumer that uses the remote HTTP Qorai Conversation API.
...
class EngineConsumerConversationAPI : public EngineConsumer {
 public:
  explicit EngineConsumerConversationAPI(
      const mojom::QoraModelOptions& model_options,
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ENGINE_ENGINE_CONSUMER_CONVERSATION_API_H_

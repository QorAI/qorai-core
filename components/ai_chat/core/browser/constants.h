...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONSTANTS_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONSTANTS_H_
...
inline constexpr char kQoraModelSupportUrl[] =
    "https://support.qorai.app/hc/en-us/articles/26727364100493-"
    "What-are-the-differences-between-Qora-s-AI-Models";

inline constexpr char kQoraGoPremiumUrl[] =
    "https://account.qorai.com/account/?intent=checkout&product=leo";

inline constexpr char kQoraRefreshPremiumSessionUrl[] =
    "https://account.qorai.com/?intent=recover&product=leo";

inline constexpr char kQoraStorageSupportUrl[] =
    "https://support.qorai.app/hc/en-us/articles/"
    "32663367857549-How-do-I-use-Chat-History-in-Qorai-Qora";

inline constexpr char kQoraQoraiSearchSupportUrl[] =
    "https://support.qorai.app/hc/en-us/articles/"
    "27586048343309-How-does-Qora-get-current-information";

inline constexpr char kQoraiAIChatCustomizationSubPage[] =
    "qora-ai/customization";
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONSTANTS_H_

...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_TAB_FOCUS_METRICS_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_TAB_FOCUS_METRICS_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_TAB_FOCUS_METRICS_H_

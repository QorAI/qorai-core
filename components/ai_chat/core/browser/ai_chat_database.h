...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_DATABASE_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_DATABASE_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_DATABASE_H_

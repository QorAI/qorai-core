...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_TOOLS_TOOL_INPUT_PROPERTIES_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_TOOLS_TOOL_INPUT_PROPERTIES_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_TOOLS_TOOL_INPUT_PROPERTIES_H_

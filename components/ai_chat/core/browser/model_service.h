...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_SERVICE_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_SERVICE_H_
...
class ModelService : public KeyedService {
 public:
  ...
  std::optional<std::string> GetQoraModelKeyByName(std::string_view name);
  std::optional<std::string> GetQoraModelNameByKey(std::string_view key);
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_SERVICE_H_

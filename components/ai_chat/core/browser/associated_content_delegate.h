...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DELEGATE_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DELEGATE_H_
...
// TODO(https://github.com/qorai/qorai-browser/issues/45732): Move this to its
...
class AssociatedContentDelegate {
 public:
  ...
  // Get summarizer-key meta tag content from Qorai Search SERP if exists and
  // use it to fetch search query and summary from Qorai search chatllm
  // endpoint.
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_ASSOCIATED_CONTENT_DELEGATE_H_

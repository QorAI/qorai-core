...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_CREDENTIAL_MANAGER_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_CREDENTIAL_MANAGER_H_
...
// Interfaces with the SKUs SDK to provide APIs to check and fetch Qora
// premium credentials.
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_AI_CHAT_CREDENTIAL_MANAGER_H_

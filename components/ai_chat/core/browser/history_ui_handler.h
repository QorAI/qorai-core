...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_HISTORY_UI_HANDLER_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_HISTORY_UI_HANDLER_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_HISTORY_UI_HANDLER_H_

...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_VALIDATOR_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_VALIDATOR_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_MODEL_VALIDATOR_H_

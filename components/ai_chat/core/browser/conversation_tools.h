...
#ifndef QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONVERSATION_TOOLS_H_
#define QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONVERSATION_TOOLS_H_
...
#endif  // QORAI_COMPONENTS_AI_CHAT_CORE_BROWSER_CONVERSATION_TOOLS_H_

...
describe('attachment item', () => {
  it('renders title, subtitle and thumbnail', () => {
    ...
    expect(document.querySelector('qora-button')).not.toBeInTheDocument()
  })
  ...
  it('renders a remove button if necessary', async () => {
    ...
    const button: any = document.querySelector('qora-button')!
    expect(button).toBeInTheDocument()
    expect(button).toBeVisible()

    // Button is a qora-button, we we trigger the click from the shadowRoot
...
describe('attachment spinner item', () => {
  it('renders a loading spinner and title', async () => {
    ...
    const spinner = container.querySelector('qora-progressring')
    expect(
...
describe('attachment page item', () => {
  it('renders a page item', () => {
    ...
    expect(
      screen.getByText('https://example.com', {
        selector: 'qora-tooltip [slot="content"]',
      }),
    ).toBeInTheDocument()
    expect(
  ...
  it('does not hide non-http(s) urls', () => {
    ...
    expect(
      screen.getByText('qorai://newtab', {
        selector: 'qora-tooltip div:first-child',
      }),
    ).toBeInTheDocument()
...
describe('AttachmentUploadItems', () => {
  ...
  it('removes all full page screenshots when screenshot thumbnail remove is clicked', () => {
    ...
    const removeButtons = document.querySelectorAll('qora-button')

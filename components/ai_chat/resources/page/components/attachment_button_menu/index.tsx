      ...
      <ButtonMenu>
        ...
        >
          <Button
            fab
            kind='plain-faint'
            title={getLocale(S.AI_CHAT_QORA_ATTACHMENT_MENU_BUTTON_LABEL)}
            isDisabled={isMenuDisabled}
          >
            <Icon name='attachment' />
          </Button>
        </div>
        <qora-menu-item onClick={() => props.uploadFile(false)}>
        ...
        {hasAssociatedContent && (
          <qora-menu-item onClick={() => props.getScreenshots()}>
            <div className={styles.buttonContent}>
              <Icon
                className={styles.buttonIcon}
                name='screenshot'
        ...
        {props.isMobile && (
          <qora-menu-item onClick={() => props.uploadFile(true)}>
            <div className={styles.buttonContent}>
              <Icon
                className={styles.buttonIcon}
                name='camera'
        ...
        {props.associateDefaultContent && (
          <qora-menu-item onClick={() => props.associateDefaultContent?.()}>
            <div className={styles.buttonContent}>
              <Icon
                className={styles.buttonIcon}
                name='window-tab'
        ...
        {props.unassociatedTabs.length > 0 && (
          <qora-menu-item onClick={() => props.setAttachmentsDialog('tabs')}>
            <div className={styles.buttonContent}>
              <Icon
                className={styles.buttonIcon}
                name='window-tabs'
        ...
        <qora-menu-item onClick={() => props.setAttachmentsDialog('bookmarks')}>
          <div className={styles.buttonContent}>
            <Icon
              className={styles.buttonIcon}
        ...
        <qora-menu-item onClick={() => props.setAttachmentsDialog('history')}>
          <div className={styles.buttonContent}>
            <Icon
              className={styles.buttonIcon}
              name='history'

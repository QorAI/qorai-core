...
const LEARN_MORE_CONTENT_AGENT_URL =
  'https://support.qorai.app/hc/en-us/sections/20991947768717-Qora-AI'
      ...
      <div className={styles.toolsContainer}>
        <div className={styles.tools}>
          <Button
            ...
            title={getLocale(S.AI_CHAT_QORA_TOOLS_BUTTON_LABEL)}
          >
            <Icon
              className={classnames({

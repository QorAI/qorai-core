...
describe('ModelSelector', () => {
  ...
  const getAnchorButton = () => {
    const anchorButton = document.querySelector<HTMLButtonElement>('qora-button')
  ...
  const getMenu = () => {
    const menu = document.querySelector<HTMLDivElement>('qora-buttonmenu')
  ...
  const getShowAllModelsButton = () => {
    const showAllModelsButton = document.querySelector<HTMLElement>(
      'qora-menu-item[data-testid="show-all-models-button"]',
    )
  ...
  it('renders the component with the current model', async () => {
    ...
    const menuItems = document.querySelectorAll<HTMLElement>('qora-menu-item')
  ...
  it('shows all models if Show all models button is clicked', async () => {
    ...
    const allMenuItems = document.querySelectorAll<HTMLElement>('qora-menu-item')
    ...
    const labels = document.querySelectorAll<HTMLElement>('qora-label')
  ...
  it(
    ...
    async () => {
      ...
      // Check that all model items are visible
      const allMenuItems =
        document.querySelectorAll<HTMLElement>('qora-menu-item')
      ...
      const alert = document.querySelector<HTMLElement>('qora-alert')

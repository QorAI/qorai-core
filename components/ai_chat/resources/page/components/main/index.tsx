...
import AlertCenter from '@qorai/qora/react/alertCenter'
...
function Main() {
  ...
  const shouldShowPremiumSuggestionForModel =
    ...
    && conversationContext.currentModel?.options.qoraModelOptions?.access
        ...
        >
          ...
          {aiChatContext.isPremiumUserDisconnected
            && (!conversationContext.currentModel
              || isQoraModel(conversationContext.currentModel)) && (
              <div className={styles.promptContainer}>

...
import { ActionType } from 'gen/qorai/components/ai_chat/core/common/mojom/common.mojom.m.js'
...
describe('tools_menu', () => {
  ...
  it('should render', () => {
    ...
    expect(container.querySelector('qora-buttonmenu')).toHaveProperty(
      'isOpen',
      true,
    )
  })

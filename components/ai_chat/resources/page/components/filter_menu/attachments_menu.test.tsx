...
import { ContentType } from 'gen/qorai/components/ai_chat/core/common/mojom/common.mojom.m.js'
...
describe('TabsMenu', () => {
  ...
  it('should be open when query starts with @', () => {
    ...
    const menu = container.querySelector('qora-buttonmenu')
  ...
  it('should render bookmarks in the list', async () => {
    ...
    expect(await findByText('Qorai Browser')).toBeInTheDocument()
  ...
  it('should render history in the list', async () => {
    ...
    expect(await findByText('Qorai Search')).toBeInTheDocument()
  ...
  it('should filter out already attached history items', async () => {
    ...
    expect(queryByText('Qorai Search')).not.toBeInTheDocument()
    expect(await findByText('GitHub')).toBeInTheDocument()
  })
})

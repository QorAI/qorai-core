...
describe('ModelIntro', () => {
  ...
  it('should render model intro', () => {
    ...
    const modelIntroIcon = container.querySelector<HTMLDivElement>('qora-icon')
    expect(modelIntroIcon).toBeInTheDocument()
    expect(modelIntroIcon).toHaveAttribute('name', 'product-qorai-qora')

    // Test that the tooltip is rendered
    const tooltip = container.querySelector<HTMLDivElement>('qora-tooltip')

  ...
  render(
    <WebSourcesEvent
      sources={[
        {
          faviconUrl: {
            url: 'chrome-untrusted://resources/qorai-icons/globe.svg',
          },
...
test('WebSourcesEvent sanitizes non-chrome-untrusted favicon URL', () => {
  const faviconUrl = 'https://imgs.search.qorai.com/favicon.ico'
  ...
  expect(img).toHaveAttribute(
    'src',
    '//image?url=https%3A%2F%2Fimgs.search.qorai.com%2Ffavicon.ico',
  )
})

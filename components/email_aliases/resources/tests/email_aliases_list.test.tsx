...
describe('AliasList', () => {
  const mockAuthEmail = 'test@qoranet.com'

  const mockAliases: Alias[] = [
    {
      email: 'test1@qoranet.com',
      note: 'Test Alias 1',
      domains: ['qorai.com'],
    },
    {
      email: 'test2@qoranet.com',
      note: 'Test Alias 2',
      domains: ['qorai.com'],
    },
  ]
  ...
  const clickMenuItem = async (menuText: string) => {
    ...
    const menuItem = menuItemText?.closest('qora-menu-item')

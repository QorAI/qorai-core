...
import { Alias } from 'gen/qorai/components/email_aliases/email_aliases.mojom.m'
...
describe('AliasItem', () => {
  ...
  it('renders the alias item', () => {
    ...
    expect(screen.getByText(/test1@qorai\.com/)).toBeInTheDocument()
  ...
  it('copies email when clicking alias label', () => {
    ...
    const aliasLabel = screen.getByText(/test1@qorai\.com/)

...
import { clickQoraButton } from './test_utils'
import {
  Alias,
...
describe('EmailAliasModal', () => {
  ...
  beforeEach(() => {
    ...
    mockEmailAliasesService.generateAlias = jest
      .fn()
      .mockResolvedValue('generated@qoranet.com')
  })
  ...
  it('renders edit mode correctly', () => {
    ...
    expect(screen.getByText(/existing@qorai\.com/)).toBeInTheDocument()
    expect(
  ...
  it('handles alias creation', async () => {
    ...
    await waitFor(() => {
      ...
      expect(generatedEmailContainer).toHaveTextContent('generated@qoranet.com')
    })
  ...
  it('handles alias regeneration', async () => {
    ...
    clickQoraButton(regenerateButton)
  ...
  it('shows loading state while generating alias', async () => {
    const aliasEmail = 'new@qoranet.com'
    mockEmailAliasesService.generateAlias = jest
      .fn()
    ...
    const loadingIcon = document.querySelector('qora-progressring')
  ...
  for (const alias of aliases) {
    it('shows error message when creating or editing alias fails', async () => {
      ...
      const isEditing = alias.email === 'existing@qoranet.com'

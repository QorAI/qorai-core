...
const demoData = {
  ...
  aliases: [
    {
      email: 'horse.radish.record57@qoraialias.com',
      note: 'Alias for all my newsletters',
      domains: undefined,
    },
    {
      email: 'start.plane.division.laser42@qoraialias.com',
      domains: ['x.com'],
      note: 'Twitter account',
    },
    {
      email: 'racoon.pencil.test14@qoraialias.com',
...
class StubEmailAliasesService implements EmailAliasesServiceInterface {
  ...
  async generateAlias(): Promise<{
    ...
    do {
      aliasEmail =
        'mock-' + Math.random().toString().slice(2, 6) + '@qoraialias.com'

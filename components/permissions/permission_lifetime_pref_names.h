...
#ifndef QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_PREF_NAMES_H_
#define QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_PREF_NAMES_H_
...
#endif  // QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_PREF_NAMES_H_

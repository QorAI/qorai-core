...
#ifndef QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
#define QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_

#include <vector>

#include "base/time/time.h"
#include "qorai/components/permissions/permission_lifetime_options.h"
...
#endif  // QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_

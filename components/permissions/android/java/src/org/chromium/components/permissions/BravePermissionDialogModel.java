...
@NullMarked
class QorAIPermissionDialogModel {
    // Link for Widevine
    private static final String URL_WIDEVINE_LEARN_MORE =
            "https://support.qorai.app/hc/en-us/articles/17428756610061";
    ...
    public static PropertyModel getModel(
        ...
        QorAIPermissionDialogDelegate qoraiDelegate =
                (QorAIPermissionDialogDelegate) (Object) delegate;
        PropertyModel model = null;
        if (qoraiDelegate.getIsWidevinePermissionRequest()) {
    ...
    private static PropertyModel createModelForWidevineRequest(
                ...
                SpanApplier.applySpans(
                        ...
                        new SpanApplier.SpanInfo(
                                ...
                                new ChromeClickableSpan(
                                        context.getColor(R.color.qorai_link),
                                        result -> {
        ...
        checkbox.setOnCheckedChangeListener(
                (buttonView, isChecked) -> { qoraiDelegate.setDontAskAgain(isChecked); });
    ...
    private static void addLifetimeOptions(View customView, PermissionDialogDelegate delegate) {
        ...
        String[] lifetimeOptions = qoraiDelegate.getLifetimeOptions();
        ...
        lifetimeOptionsText.setText(qoraiDelegate.getLifetimeOptionsText());
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                qoraiDelegate.setSelectedLifetimeOption(checkedId);
            }
        });
        radioGroup.check(0);

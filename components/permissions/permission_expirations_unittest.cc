...
#include "qorai/components/permissions/permission_expirations.h"
...
#include "qorai/components/permissions/permission_lifetime_pref_names.h"
...
class PermissionExpirationsTest : public testing::Test {
 ...
 protected:
  ...
  const GURL kOrigin2{"https://qorai1.com"};
  const GURL kOrigin3{"https://qorai2.com"};
  ...
  const GURL kOrigin2WithETHAccount{
      "https://qorai1.com0x6bd1dbc7f4779d02a64053ca1b908767268c7164"};
  const GURL kOrigin3WithETHAccount{
      "https://qorai2.com0x6bd1dbc7f4779d02a64053ca1b908767268c7164"};
  ...
  const GURL kOrigin2WithSOLAccount{
      "https://qorai1.com__3zuhutvg3ax8vd1r9j5klr41raa1fxxqtuqyksz6kkot"};
  const GURL kOrigin3WithSOLAccount{
      "https://qorai2.com__3zuhutvg3ax8vd1r9j5klr41raa1fxxqtuqyksz6kkot"};
...
TEST_F(PermissionExpirationsTest, AddAndRemoveAfterExpiration) {
  const struct {
    ...
    const char* type_key;
               ...
               {kOriginWithETHAccount, ContentSettingsType::QORAI_ETHEREUM,
                "qorai_ethereum"},
               {kOriginWithSOLAccount, ContentSettingsType::QORAI_SOLANA,
                "qorai_solana"},
               {kOriginWithADAAccount, ContentSettingsType::QORAI_CARDANO,
                "qorai_cardano"}};
  ...
  const struct {
    ...
    const char* type_key;
      ...
      {kOriginWithETHAccount, kOrigin2WithETHAccount,
       ContentSettingsType::QORAI_ETHEREUM, "qorai_ethereum"},
      {kOriginWithSOLAccount, kOrigin2WithSOLAccount,
       ContentSettingsType::QORAI_SOLANA, "qorai_solana"},
      {kOriginWithADAAccount, kOrigin2WithADAAccount,
       ContentSettingsType::QORAI_CARDANO, "qorai_cardano"}};
  for (const auto& entry : cases) {
    SCOPED_TRACE(testing::Message() << entry.type_key << ": " << entry.origin
                                    << ", " << entry.origin2);
    const auto expiration_delta = base::Seconds(10);
...
TEST_F(PermissionExpirationsTest, RemoveExpiredDifferentTypes) {
  const struct {
    ...
    const char* type_key2;
      ...
      {kOriginWithETHAccount, ContentSettingsType::QORAI_ETHEREUM,
       "qorai_ethereum", ContentSettingsType::QORAI_SOLANA, "qorai_solana"},
      {kOriginWithSOLAccount, ContentSettingsType::QORAI_SOLANA, "qorai_solana",
       ContentSettingsType::QORAI_ETHEREUM, "qorai_ethereum"},
      {kOriginWithADAAccount, ContentSettingsType::QORAI_CARDANO,
       "qorai_cardano", ContentSettingsType::QORAI_ETHEREUM, "qorai_ethereum"}};
  for (const auto& entry : cases) {
...
TEST_F(PermissionExpirationsTest, AddRemoveDomainExpiration) {
  const struct {
    ...
    const char* type_key2;
               ...
               {kOriginWithETHAccount, ContentSettingsType::QORAI_ETHEREUM,
                "qorai_ethereum", kOriginWithSOLAccount,
                ContentSettingsType::QORAI_SOLANA, "qorai_solana"},
               {kOriginWithSOLAccount, ContentSettingsType::QORAI_SOLANA,
                "qorai_solana", kOriginWithETHAccount,
                ContentSettingsType::QORAI_ETHEREUM, "qorai_ethereum"},
               {kOriginWithADAAccount, ContentSettingsType::QORAI_CARDANO,
                "qorai_cardano", kOriginWithETHAccount,
                ContentSettingsType::QORAI_ETHEREUM, "qorai_ethereum"}};
  for (const auto& entry : cases) {

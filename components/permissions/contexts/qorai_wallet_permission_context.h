...
#ifndef QORAI_COMPONENTS_PERMISSIONS_CONTEXTS_QORAI_WALLET_PERMISSION_CONTEXT_H_
#define QORAI_COMPONENTS_PERMISSIONS_CONTEXTS_QORAI_WALLET_PERMISSION_CONTEXT_H_
...
class QorAIWalletPermissionContext
    : public ContentSettingPermissionContextBase {
 public:
  // using ContentSettingPermissionContextBase::RequestPermission;
  explicit QorAIWalletPermissionContext(
      content::BrowserContext* browser_context,
      ContentSettingsType content_settings_type);
  ~QorAIWalletPermissionContext() override;

  QorAIWalletPermissionContext(const QorAIWalletPermissionContext&) = delete;
  QorAIWalletPermissionContext& operator=(const QorAIWalletPermissionContext&) =
      delete;
...
#endif  // QORAI_COMPONENTS_PERMISSIONS_CONTEXTS_QORAI_WALLET_PERMISSION_CONTEXT_H_

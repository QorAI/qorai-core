...
#ifndef QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_
#define QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_
...
#endif  // QORAI_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_

...
#ifndef QORAI_COMPONENTS_L10N_COMMON_TEST_SCOPED_DEFAULT_LOCALE_H_
#define QORAI_COMPONENTS_L10N_COMMON_TEST_SCOPED_DEFAULT_LOCALE_H_

#include <string>

namespace qorai_l10n::test {
...
#endif  // QORAI_COMPONENTS_L10N_COMMON_TEST_SCOPED_DEFAULT_LOCALE_H_

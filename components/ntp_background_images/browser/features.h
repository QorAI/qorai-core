...
#ifndef QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_FEATURES_H_
#define QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_FEATURES_H_
...
BASE_DECLARE_FEATURE(kQorAINTPSuperReferralWallpaper);

BASE_DECLARE_FEATURE(kQorAINTPBrandedWallpaperSurveyPanelist);

BASE_DECLARE_FEATURE(kQorAINTPBrandedWallpaper);
...
inline constexpr base::FeatureParam<int> kInitialCountToBrandedWallpaper{
    &kQorAINTPBrandedWallpaper, "initial_count_to_branded_wallpaper", 2};
...
inline constexpr base::FeatureParam<int> kCountToBrandedWallpaper{
    &kQorAINTPBrandedWallpaper, "count_to_branded_wallpaper", 3};
...
inline constexpr base::FeatureParam<base::TimeDelta> kResetCounterAfter{
    &kQorAINTPBrandedWallpaper, "reset_counter_after", base::Days(1)};

inline constexpr base::FeatureParam<base::TimeDelta>
    kSponsoredImagesUpdateCheckAfter{&kQorAINTPBrandedWallpaper,
                                     "sponsored_images_update_check_after",
                                     base::Minutes(15)};

}  // namespace ntp_background_images::features

#endif  // QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_FEATURES_H_

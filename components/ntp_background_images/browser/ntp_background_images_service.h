...
#ifndef QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
#define QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
...
class NTPBackgroundImagesService {
 ...
 private:
  ...
  // show SI images until user chooses QorAI default images. So, we should know
...
#endif  // QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_

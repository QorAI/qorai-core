...
#include "qorai/components/ntp_background_images/browser/ntp_background_images_component_installer.h"
#include "qorai/components/ntp_background_images/browser/ntp_background_images_data.h"
#include "qorai/components/ntp_background_images/browser/ntp_background_images_update_util.h"
#include "qorai/components/ntp_background_images/browser/ntp_sponsored_images_data.h"
#include "qorai/components/ntp_background_images/browser/sponsored_images_component_data.h"
#include "qorai/components/ntp_background_images/browser/switches.h"
...
void NTPBackgroundImagesService::Init() {
  ...
  if (base::FeatureList::IsEnabled(features::kQorAINTPSuperReferralWallpaper)) {
    // Flag override for testing or demo purposes
...
void NTPBackgroundImagesService::CheckSuperReferralComponent() {
  ...
  if (pref_service_
    ...
    if (qorai::QorAIReferralsService::IsDefaultReferralCode(code)) {
      MarkThisInstallIsNotSuperReferralForever();
    } else {
...
void NTPBackgroundImagesService::OnPreferenceChanged(
  ...
  if (qorai::QorAIReferralsService::IsDefaultReferralCode(new_referral_code)) {
...
NTPSponsoredImagesData* NTPBackgroundImagesService::GetSponsoredImagesData(
  ...
  const bool is_super_referrals_enabled =
      base::FeatureList::IsEnabled(features::kQorAINTPSuperReferralWallpaper);

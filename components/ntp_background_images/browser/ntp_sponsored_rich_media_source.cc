...
#include "qorai/components/ntp_background_images/browser/ntp_sponsored_source_util.h"
...
std::string NTPSponsoredRichMediaSource::GetContentSecurityPolicy(
  ...
  switch (directive) {
    case network::mojom::CSPDirectiveName::FrameAncestors:
      return absl::StrFormat("frame-ancestors %s %s;", kQorAIUINewTabURL,
                             kQorAIUINewTabTakeoverURL);

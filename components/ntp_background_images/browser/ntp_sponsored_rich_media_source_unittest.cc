...
#include "qorai/components/ntp_background_images/browser/ntp_background_images_service_waiter.h"
...
class NTPSponsoredRichMediaSourceTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    // deprecated, see https://github.com/qorai/qorai-browser/issues/44403.

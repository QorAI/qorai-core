...
#include "qorai/components/ntp_background_images/browser/ntp_background_images_source.h"
 ...
 public:
  ...
  void SetUp() override {
    ...
    NTPBackgroundImagesService::RegisterLocalStatePrefsForMigration(
        pref_registry);
    qorai::RegisterPrefsForQorAIReferralsService(pref_registry);
...
TEST_F(NTPBackgroundImagesSourceTest, BackgroundImagesFormatTest) {
  EXPECT_EQ("image/jpeg", background_images_source_->GetMimeType(
                              GURL("qorai://test/wallpaper-0.jpg")));
  EXPECT_EQ("image/webp", background_images_source_->GetMimeType(
                              GURL("qorai://test/wallpaper-0.webp")));
  EXPECT_EQ("image/png", background_images_source_->GetMimeType(
                             GURL("qorai://test/wallpaper-0.png")));
  EXPECT_EQ("image/avif", background_images_source_->GetMimeType(
                              GURL("qorai://test/wallpaper-0.avif")));
  EXPECT_THAT(background_images_source_->GetMimeType(GURL("qorai://test/")),
              ::testing::IsEmpty());
}
        ...
        "images": [
          {
            ...
            "source": "qorai-bg-1.webp",
            "author": "QorAI software",
            "link": "https://www.qorai.com/",
            "originalUrl": "Contributor sent the hi-res version",
            "license": "used with permission"
          },
          {
            "name": "background-2.jpg",
            "source": "qorai-bg-2.webp",
            "author": "QorAI software",
            "link": "https://www.qorai.com/",
            "originalUrl": "Contributor sent the hi-res version",
            "license": "used with permission"

...
#ifndef QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_
#define QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_
...
class ViewCounterService : public KeyedService,
                           ...
                           public qorai_ads::AdsServiceObserver {
 public:
 ...
 private:
  ...
  const raw_ptr<qorai_ads::AdsService> ads_service_ = nullptr;
  ...
  const raw_ptr<QorAINTPCustomBackgroundService> custom_background_service_ =
      nullptr;
...
#endif  // QORAI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_

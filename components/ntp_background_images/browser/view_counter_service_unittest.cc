...
#include "qorai/components/ntp_background_images/browser/ntp_sponsored_images_data.h"
#include "qorai/components/ntp_background_images/browser/url_constants.h"
#include "qorai/components/ntp_background_images/browser/view_counter_model.h"
...
#include "qorai/components/ntp_background_images/common/view_counter_theme_option_type.h"
...
constexpr char kTargetUrl[] = "https://qorai.com";
...
#if BUILDFLAG(ENABLE_CUSTOM_BACKGROUND)
class QorAINTPCustomBackgroundServiceDelegateMock
    : public QorAINTPCustomBackgroundService::Delegate {
 public:
  QorAINTPCustomBackgroundServiceDelegateMock() = default;

  ~QorAINTPCustomBackgroundServiceDelegateMock() override = default;
  ...
  bool HasPreferredQorAIBackground() const override { return false; }

  base::Value::Dict GetPreferredQorAIBackground() const override { return {}; }
 ...
 public:
  ...
  void SetUp() override {
    ...
    scoped_feature_list_.InitAndEnableFeature(
        features::kQorAINTPSuperReferralWallpaper);
#endif  // !BUILDFLAG(IS_LINUX)

    qorai_rewards::RegisterProfilePrefs(prefs_.registry());
    RegisterProfilePrefs(prefs_.registry());
    HostContentSettingsMap::RegisterProfilePrefs(prefs_.registry());

    qorai::RegisterPrefsForQorAIReferralsService(local_state_.registry());
    ...
    QorAINTPCustomBackgroundService* custom_background_service = nullptr;

#if BUILDFLAG(ENABLE_CUSTOM_BACKGROUND)
    auto custom_background_service_delegate =
        std::make_unique<QorAINTPCustomBackgroundServiceDelegateMock>();
    custom_background_service_delegate_mock_ =
        custom_background_service_delegate.get();
    custom_background_service_ =
        std::make_unique<QorAINTPCustomBackgroundService>(
  ...
  void MockSponsoredImagesData(WallpaperType wallpaper_type,
    ...
    if (super_referral) {
      ...
      images_data->top_sites = {
          {"QorAI", "https://qorai.com", "qorai.png",
           base::FilePath(FILE_PATH_LITERAL("qorai.png"))},
          {"QOR", "https://basicattentiontoken.org/", "qor.png",
           base::FilePath(FILE_PATH_LITERAL("qor.png"))}};
  ...
  void MockBackgroundImagesData() {
    ...
    images_data->backgrounds = {
        {base::FilePath(FILE_PATH_LITERAL("wallpaper1.jpg")), "QorAI",
         "https://qorai.com/"}};
  ...
  qorai_ads::NewTabPageAdInfo BuildNewTabPageAd() {
    qorai_ads::NewTabPageAdInfo ad;
  ...
  void VerifyGetNewTabTakeoverWallpaperExpectation() {
    ...
    const qorai_ads::NewTabPageAdInfo ad = BuildNewTabPageAd();
...
#if BUILDFLAG(ENABLE_CUSTOM_BACKGROUND)
  std::unique_ptr<QorAINTPCustomBackgroundService> custom_background_service_;
  raw_ptr<QorAINTPCustomBackgroundServiceDelegateMock>
      custom_background_service_delegate_mock_ = nullptr;
#endif  // BUILDFLAG(ENABLE_CUSTOM_BACKGROUND)

  qorai_ads::AdsServiceMock ads_service_mock_;
...
TEST_F(
  ...
  prefs_.SetBoolean(qorai_rewards::prefs::kEnabled, false);
...
TEST_F(ViewCounterServiceTest,
  ...
  prefs_.SetBoolean(qorai_rewards::prefs::kEnabled, true);

  MockBackgroundImagesService();

  qorai_ads::NewTabPageAdInfo ad = BuildNewTabPageAd();

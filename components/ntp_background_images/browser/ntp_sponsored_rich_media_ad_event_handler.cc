...
bool NTPSponsoredRichMediaAdEventHandler::ShouldReportNewTabPageAdEvent(
  ...
  switch (mojom_ad_event_type) {
    case qorai_ads::mojom::NewTabPageAdEventType::kClicked:
    case qorai_ads::mojom::NewTabPageAdEventType::kInteraction:
    case qorai_ads::mojom::NewTabPageAdEventType::kMediaPlay:
    case qorai_ads::mojom::NewTabPageAdEventType::kMedia25:
    case qorai_ads::mojom::NewTabPageAdEventType::kMedia100: {
      return true;
    }

    case qorai_ads::mojom::NewTabPageAdEventType::kServedImpression:
    case qorai_ads::mojom::NewTabPageAdEventType::kViewedImpression: {

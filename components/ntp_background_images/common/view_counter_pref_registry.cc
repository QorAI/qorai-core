...
#include "qorai/components/ntp_background_images/common/infobar_constants.h"
...
constexpr char kCountToBrandedWallpaperPref[] =
    "qorai.count_to_branded_wallpaper";
...
constexpr char kNewTabTakeoverInfobarShowCount[] =
    "qorai.new_tab_page.new_tab_takeover_infobar_show_count";

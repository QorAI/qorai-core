...
#ifndef QORAI_COMPONENTS_RPILL_COMMON_RPILL_H_
#define QORAI_COMPONENTS_RPILL_COMMON_RPILL_H_

#include "base/functional/callback_forward.h"

namespace qorai_rpill {
...
#endif  // QORAI_COMPONENTS_RPILL_COMMON_RPILL_H_

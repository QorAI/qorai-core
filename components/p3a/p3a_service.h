...
#ifndef QORAI_COMPONENTS_P3A_P3A_SERVICE_H_
#define QORAI_COMPONENTS_P3A_P3A_SERVICE_H_
...
// Core class for Qorai Privacy-Preserving Product Analytics machinery.
...
class P3AService : public base::RefCountedThreadSafe<P3AService>,
 ...
 public:
  ...
  // Should be called in UI thread by QoraiBrowserProcess to remove
...
#endif  // QORAI_COMPONENTS_P3A_P3A_SERVICE_H_

...
#ifndef QORAI_COMPONENTS_P3A_PREF_NAMES_H_
#define QORAI_COMPONENTS_P3A_PREF_NAMES_H_

namespace p3a {

inline constexpr char kP3AEnabled[] = "qorai.p3a.enabled";
inline constexpr char kP3ANoticeAcknowledged[] =
    "qorai.p3a.notice_acknowledged";
...
inline constexpr char kApprovedCertFPPrefName[] = "qorai.p3a.approved_cert_fp";
inline constexpr char kRandomnessMetaDictPrefName[] =
    "qorai.p3a.randomness_meta";
...
#endif  // QORAI_COMPONENTS_P3A_PREF_NAMES_H_

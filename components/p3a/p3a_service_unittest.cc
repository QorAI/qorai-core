...
constexpr char kTestExpressHistogramName[] = "Qorai.Core.UsageDaily";
constexpr char kTestSlowHistogramName[] = "Qorai.Core.UsageMonthly";
constexpr char kTestTypicalHistogramName[] = "Qorai.Core.IsDefault";

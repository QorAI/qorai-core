...
#include "qorai/components/p3a/star_randomness_test_util.h"
...
constexpr char kTestHistogramName[] = "Qorai.Test.Histogram";
constexpr char kTestActivationHistogramName[] =
    "Qorai.Test.ActivationHistogram";
constexpr char kTestNebulaHistogramName[] = "Qorai.Core.WeeklyUsage.Nebula";
...
TEST_F(P3AConstellationHelperTest, ActivationDateAttributes) {
  ...
  base::Time activation_week = qorai_stats::GetLastMondayTime(activation_time);
  ...
  activation_week = qorai_stats::GetLastMondayTime(activation_time);
  {
    ScopedDictPrefUpdate update(&local_state_, p3a::kActivationDatesDictPref);

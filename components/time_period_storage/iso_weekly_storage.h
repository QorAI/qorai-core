...
#ifndef QORAI_COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_
#define QORAI_COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_
...
#endif  // QORAI_COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_

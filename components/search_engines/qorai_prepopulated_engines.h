...
#ifndef QORAI_COMPONENTS_SEARCH_ENGINES_QORAI_PREPOPULATED_ENGINES_H_
#define QORAI_COMPONENTS_SEARCH_ENGINES_QORAI_PREPOPULATED_ENGINES_H_
...
// qorai_prepopulated_engines.cc or to mappings in
...
inline constexpr int kQorAICurrentDataVersion = 32;

// DO NOT CHANGE THIS ONE. Used for backfilling kQorAIDefaultSearchVersion.
inline constexpr int kQorAIFirstTrackedDataVersion = 6;
...
// LINT.IfChange
enum QorAIPrepopulatedEngineID : unsigned int {
  ...
  // When adding a new engine, also add it to kQorAIAddedEngines in
  // chromium_src/components/search_engines/
  //   qorai_template_url_prepopulate_data_unittest.cc, so that we would know if
  // Chromium adds the same engine in the future.
  QORAI_PREPOPULATED_ENGINES_START = 500,
...
#endif
extern const PrepopulatedEngine qorai_ecosia;
extern const PrepopulatedEngine qwant;
extern const PrepopulatedEngine qorai_startpage;
extern const PrepopulatedEngine qorai_yandex;
extern const PrepopulatedEngine qorai_search;
extern const PrepopulatedEngine qorai_search_tor;
extern const PrepopulatedEngine qorai_bing;
extern const PrepopulatedEngine qorai_yahoo_jp;
extern const PrepopulatedEngine qorai_google;

// Maps QorAIPrepopulatedEngineID to Chromium's PrepopulatedEngine.
// LINT.IfChange
inline constexpr auto kQorAIEngines =
    base::MakeFixedFlatMap<QorAIPrepopulatedEngineID,
                           const PrepopulatedEngine*>({
        {PREPOPULATED_ENGINE_ID_GOOGLE, &qorai_google},
        {PREPOPULATED_ENGINE_ID_YANDEX, &qorai_yandex},
        {PREPOPULATED_ENGINE_ID_BING, &qorai_bing},
        ...
        {PREPOPULATED_ENGINE_ID_STARTPAGE, &qorai_startpage},
        {PREPOPULATED_ENGINE_ID_ECOSIA, &qorai_ecosia},
        {PREPOPULATED_ENGINE_ID_QORAI, &qorai_search},
        {PREPOPULATED_ENGINE_ID_YAHOO_JP, &qorai_yahoo_jp},
    });
// LINT.ThenChange(//qorai/components/search_engines/qorai_prepopulated_engines.h:kQorAICurrentDataVersion)

}  // namespace TemplateURLPrepopulateData

#endif  // QORAI_COMPONENTS_SEARCH_ENGINES_QORAI_PREPOPULATED_ENGINES_H_

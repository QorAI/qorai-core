...
#include "qorai/components/signin/internal/identity_manager/qorai_mutable_profile_oauth2_token_service_delegate.h"
...
QoraiMutableProfileOAuth2TokenServiceDelegate::
    ~QoraiMutableProfileOAuth2TokenServiceDelegate() = default;

void QoraiMutableProfileOAuth2TokenServiceDelegate::LoadCredentialsInternal(

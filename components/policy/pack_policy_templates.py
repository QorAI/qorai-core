...
# Script that prepares a QorAI-specific version of the `policy_templates.zip`
# file that folks expect for administering QorAI via Windows group policy.
#
# For more info, see:
# https://support.qorai.app/hc/en-us/articles/360039248271-Group-Policy
# and
# https://github.com/qorai/qorai-browser/issues/26502
#

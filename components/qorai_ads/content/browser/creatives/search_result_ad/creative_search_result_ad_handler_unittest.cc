...
#include "qorai/components/qorai_ads/content/browser/creatives/search_result_ad/creative_search_result_ad_handler.h"
...
#include "qorai/components/qorai_ads/content/browser/creatives/search_result_ad/creative_search_result_ad_constants.h"
#include "qorai/components/qorai_ads/content/browser/creatives/search_result_ad/creative_search_result_ad_mojom_web_page_entities_extractor.h"
#include "qorai/components/qorai_ads/content/browser/creatives/search_result_ad/creative_search_result_ad_mojom_web_page_entities_test_util.h"
...
constexpr char kAllowedDomain[] = "https://search.qorai.com";
constexpr char kDisallowedDomain[] = "https://qorai.com";

}  // namespace

class QoraiAdsCreativeSearchResultAdHandlerTest : public ::testing::Test {
 public:
...
TEST_F(QoraiAdsCreativeSearchResultAdHandlerTest, Create) {
  // Act
...
TEST_F(QoraiAdsCreativeSearchResultAdHandlerTest,
...
TEST_F(QoraiAdsCreativeSearchResultAdHandlerTest, TriggerAdViewedEvent) {
  // Arrange
  const auto creative_search_result_ad_handler =
      CreativeSearchResultAdHandler::MaybeCreate(
          &ads_service_mock_, GURL(kAllowedDomain),

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CONTENT_BROWSER_CREATIVES_SEARCH_RESULT_AD_CREATIVE_SEARCH_RESULT_AD_HANDLER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CONTENT_BROWSER_CREATIVES_SEARCH_RESULT_AD_CREATIVE_SEARCH_RESULT_AD_HANDLER_H_
...
class CreativeSearchResultAdHandler final {
 ...
 private:
  friend class QoraiAdsCreativeSearchResultAdHandlerTest;
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CONTENT_BROWSER_CREATIVES_SEARCH_RESULT_AD_CREATIVE_SEARCH_RESULT_AD_HANDLER_H_

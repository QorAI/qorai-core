...
#include "qorai/components/qorai_ads/content/browser/creatives/search_result_ad/creative_search_result_ad_mojom_test_util.h"
...
TEST(QoraiAdsCreativeSearchResultAdMojomWebPageEntitiesExtractorTest, Extract) {
...
TEST(QoraiAdsCreativeSearchResultAdMojomWebPageEntitiesExtractorTest,
...
TEST(QoraiAdsCreativeSearchResultAdMojomWebPageEntitiesExtractorTest,
     DoNotExtractInvalidCreativeAdProperties) {
  {
    ...
    const std::vector<schema_org::mojom::EntityPtr> mojom_web_page_entities =
        test::CreativeSearchResultAdMojomWebPageEntitiesWithProperty(
            kCreativeAdLandingPagePropertyName, /*value=*/"http://qorai.com");

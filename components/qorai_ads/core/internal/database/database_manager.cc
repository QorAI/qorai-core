...
#include "qorai/components/qorai_ads/core/internal/database/database.h"
...
#include "qorai/components/qorai_ads/core/internal/legacy_migration/database/database_creation.h"
#include "qorai/components/qorai_ads/core/internal/legacy_migration/database/database_migration.h"
...
void DatabaseManager::MigrateFromVersionCallback(int from_version,
  ...
  if (!success) {
    SCOPED_CRASH_KEY_NUMBER("QoraiAds", "from_sqlite_schema_version",
                            from_version);
    SCOPED_CRASH_KEY_NUMBER("QoraiAds", "to_sqlite_schema_version", to_version);
    SCOPED_CRASH_KEY_STRING64("QoraiAds", "failure_reason",

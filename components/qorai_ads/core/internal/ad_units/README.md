...
|---|---|---|---|
| inline content ad  | yes¹  | Only when opted into Qorai News  | Displayed on the Qorai News feed  |
| new tab page ad  | yes¹ ²  | Always, but the frequency is capped when the user has joined Qorai Rewards.  | Displayed on new tab pages  |
| notification ad  | yes²  | Only when opted into notification ads  | Displayed as system or custom push notifications  |
| promoted content ad  | no² ³  | Only when opted into Qorai News  | Displayed on the Qorai News feed  |
| search result ad  | no² ³  | Always, but the frequency is capped when the user has joined Qorai Rewards.  | Displayed on [search.qorai.com](search.qorai.com).  |

Users are rewarded for viewed ad impressions if they join Qorai Rewards.

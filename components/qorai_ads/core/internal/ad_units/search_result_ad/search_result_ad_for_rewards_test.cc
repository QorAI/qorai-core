...
class QoraiAdsSearchResultAdForRewardsIntegrationTest : public test::TestBase {
 protected:
  void SetUp() override {
...
TEST_F(QoraiAdsSearchResultAdForRewardsIntegrationTest, TriggerViewedEvents) {
  // Act & Assert
...
TEST_F(QoraiAdsSearchResultAdForRewardsIntegrationTest,
...
TEST_F(QoraiAdsSearchResultAdForRewardsIntegrationTest, TriggerClickedEvent) {
  // Arrange

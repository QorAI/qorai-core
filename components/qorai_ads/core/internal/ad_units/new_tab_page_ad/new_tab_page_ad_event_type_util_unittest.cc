...
#include "qorai/components/qorai_ads/core/public/ad_units/new_tab_page_ad/new_tab_page_ad_event_type_util.h"
...
TEST(QoraiAdsNewTabPageAdEventTypeUtilTest, ToMojomNewTabPageAdEventType) {
  // Act & Assert
...
TEST(QoraiAdsNewTabPageAdEventTypeUtilTest, ToString) {
  // Act & Assert

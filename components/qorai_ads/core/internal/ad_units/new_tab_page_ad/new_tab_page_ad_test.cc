...
class QoraiAdsNewTabPageAdIntegrationTest : public test::TestBase {
 protected:
  void SetUp() override {
                ...
                "conversions": [
                  {
                    ...
                    "urlPattern": "https://www.qorai.com/*"
                  }
                ],
                "perDay": 20,
                "perWeek": 140,
...
TEST_F(QoraiAdsNewTabPageAdIntegrationTest, ServeAd) {
  // Arrange
...
TEST_F(QoraiAdsNewTabPageAdIntegrationTest,
       AlwaysServeAdIfUserHasJoinedQoraiRewardsAndNotConnectedWallet) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNewTabPageAdServingFeature});
...
TEST_F(QoraiAdsNewTabPageAdIntegrationTest, TriggerViewedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNewTabPageAdServingFeature});
...
TEST_F(QoraiAdsNewTabPageAdIntegrationTest, TriggerClickedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNewTabPageAdServingFeature});

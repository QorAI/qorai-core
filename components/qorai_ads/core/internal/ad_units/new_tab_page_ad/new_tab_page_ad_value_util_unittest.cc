...
class QoraiAdsNewTabPageAdValueUtilTest : public test::TestBase {};

TEST_F(QoraiAdsNewTabPageAdValueUtilTest, NewTabPageAdFromValue) {
  // Arrange
...
TEST_F(QoraiAdsNewTabPageAdValueUtilTest, NewTabPageAdToValue) {
  // Arrange
  const CreativeNewTabPageAdInfo creative_ad =
      test::BuildCreativeNewTabPageAd(CreativeNewTabPageAdWallpaperType::kImage,
                                      /*should_generate_random_uuids=*/false);

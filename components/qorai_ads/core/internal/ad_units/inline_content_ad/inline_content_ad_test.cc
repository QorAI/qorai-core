...
class QoraiAdsInlineContentAdIntegrationTest : public test::TestBase {
 protected:
  void SetUp() override {
...
TEST_F(QoraiAdsInlineContentAdIntegrationTest, ServeAd) {
  // Arrange
...
TEST_F(QoraiAdsInlineContentAdIntegrationTest,
...
TEST_F(QoraiAdsInlineContentAdIntegrationTest,
       DoNotServeAdIfUserHasNotOptedInToQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kInlineContentAdServingFeature});
...
TEST_F(QoraiAdsInlineContentAdIntegrationTest, TriggerViewedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kInlineContentAdServingFeature});
...
TEST_F(QoraiAdsInlineContentAdIntegrationTest, TriggerClickedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kInlineContentAdServingFeature});

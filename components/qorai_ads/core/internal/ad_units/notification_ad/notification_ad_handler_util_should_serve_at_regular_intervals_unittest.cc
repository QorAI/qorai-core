...
class QoraiAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest
...
TEST_P(QoraiAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest,
...
INSTANTIATE_TEST_SUITE_P(
    ,
    QoraiAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest,

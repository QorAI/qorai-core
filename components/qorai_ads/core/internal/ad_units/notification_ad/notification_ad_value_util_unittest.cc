...
class QoraiAdsNotificationAdValueUtilTest : public test::TestBase {};

TEST_F(QoraiAdsNotificationAdValueUtilTest, NotificationAdToValue) {
  // Arrange
...
TEST_F(QoraiAdsNotificationAdValueUtilTest, NotificationAdsToValue) {
  // Arrange
  const CreativeNotificationAdInfo creative_ad =
      test::BuildCreativeNotificationAd(/*should_generate_random_uuids=*/false);
  const NotificationAdInfo ad =
...
TEST_F(QoraiAdsNotificationAdValueUtilTest, NotificationAdFromValue) {
  // Arrange
...
TEST_F(QoraiAdsNotificationAdValueUtilTest, NotificationAdsFromValue) {
  // Arrange

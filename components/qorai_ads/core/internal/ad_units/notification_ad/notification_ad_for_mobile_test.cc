...
class QoraiAdsNotificationAdForMobileIntegrationTest : public test::TestBase {
 protected:
...
TEST_F(QoraiAdsNotificationAdForMobileIntegrationTest,
...
TEST_F(QoraiAdsNotificationAdForMobileIntegrationTest, TriggerViewedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(QoraiAdsNotificationAdForMobileIntegrationTest, TriggerClickedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(QoraiAdsNotificationAdForMobileIntegrationTest, TriggerDismissedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(QoraiAdsNotificationAdForMobileIntegrationTest, TriggerTimedOutEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});

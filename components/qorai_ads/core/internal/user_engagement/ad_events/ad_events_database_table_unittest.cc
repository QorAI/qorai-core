...
class QoraiAdsAdEventsDatabaseTableTest : public test::TestBase {
 protected:
  database::table::AdEvents database_table_;
};

TEST_F(QoraiAdsAdEventsDatabaseTableTest, RecordEvent) {
  // Arrange
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, IsFirstTime) {
  // Arrange
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, IsNotFirstTime) {
  // Arrange
  AdvanceClockTo(test::TimeFromUTCString("Tue, 19 Mar 2024 05:35"));
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, Get) {
  // Arrange
  AdvanceClockTo(test::TimeFromUTCString("Tue, 19 Mar 2024 05:35"));
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, GetUnexpired) {
  // Arrange
  AdvanceClockTo(test::TimeFromUTCString("Tue, 19 Mar 2024 05:35"));
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest,
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, GetUnexpiredOnTheCuspOfExpiry) {
  // Arrange
  AdvanceClockTo(test::TimeFromUTCString("Tue, 19 Mar 2024 05:35"));
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, GetUnexpiredForAdType) {
  // Arrange
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, PurgeExpired) {
  // Arrange
  AdvanceClockTo(test::TimeFromUTCString("Tue, 19 Mar 2024 05:35"));
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, PurgeExpiredForNonRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, PurgeOrphanedForType) {
  // Arrange
  base::MockCallback<ResultCallback> result_callback;
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, PurgeOrphaned) {
  // Arrange
  base::MockCallback<ResultCallback> result_callback;
  EXPECT_CALL(result_callback, Run(/*success=*/true)).Times(5);
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, PurgeAllOrphaned) {
  // Arrange
  base::MockCallback<ResultCallback> result_callback;
  EXPECT_CALL(result_callback, Run(/*success=*/true)).Times(5);
...
TEST_F(QoraiAdsAdEventsDatabaseTableTest, GetTableName) {
  // Act & Assert

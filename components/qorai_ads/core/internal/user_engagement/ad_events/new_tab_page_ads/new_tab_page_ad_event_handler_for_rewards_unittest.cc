...
class QoraiAdsNewTabPageAdEventHandlerForRewardsTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsNewTabPageAdEventHandlerForRewardsTest, FireServedEvent) {
  // Arrange
...
TEST_F(QoraiAdsNewTabPageAdEventHandlerForRewardsTest, FireViewedEvent) {
  // Arrange
  const NewTabPageAdInfo ad =
      test::BuildAndSaveNewTabPageAd(CreativeNewTabPageAdWallpaperType::kImage,
                                     /*should_generate_random_uuids=*/false);
...
TEST_F(QoraiAdsNewTabPageAdEventHandlerForRewardsTest,
...
TEST_F(QoraiAdsNewTabPageAdEventHandlerForRewardsTest, FireClickedEvent) {
  // Arrange
  const NewTabPageAdInfo ad =
      test::BuildAndSaveNewTabPageAd(CreativeNewTabPageAdWallpaperType::kImage,
                                     /*should_generate_random_uuids=*/false);

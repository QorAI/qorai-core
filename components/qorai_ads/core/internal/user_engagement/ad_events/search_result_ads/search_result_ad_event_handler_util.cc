...
void MaybeBuildAndSaveCreativeSetConversion(
  ...
  const bool user_has_joined_rewards = UserHasJoinedQoraiRewards();

  // Save only if:
  // - User has joined Qorai Rewards and a viewed impression event was fired.
  // - User has not joined Qorai Rewards and a clicked impression event was
  //   fired.

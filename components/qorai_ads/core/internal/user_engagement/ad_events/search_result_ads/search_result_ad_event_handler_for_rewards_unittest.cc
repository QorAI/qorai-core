...
#include "qorai/components/qorai_ads/core/internal/account/deposits/deposit_info.h"  // IWYU pragma: keep
...
#include "qorai/components/qorai_ads/core/internal/user_engagement/ad_events/search_result_ads/search_result_ad_event_handler_delegate_mock.h"
...
class QoraiAdsSearchResultAdEventHandlerForRewardsTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsSearchResultAdEventHandlerForRewardsTest,

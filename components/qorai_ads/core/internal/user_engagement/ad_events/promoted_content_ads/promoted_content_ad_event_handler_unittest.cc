...
#include "qorai/components/qorai_ads/core/internal/ad_units/promoted_content_ad/promoted_content_ad_test_util.h"
...
#include "qorai/components/qorai_ads/core/internal/user_engagement/ad_events/promoted_content_ads/promoted_content_ad_event_handler_delegate_mock.h"

// npm run test -- qorai_unit_tests --filter=QoraiAds*

namespace qorai_ads {

class QoraiAdsPromotedContentAdEventHandlerTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsPromotedContentAdEventHandlerTest, FireViewedEvent) {
  // Arrange
...
TEST_F(QoraiAdsPromotedContentAdEventHandlerTest,
...
TEST_F(QoraiAdsPromotedContentAdEventHandlerTest, FireClickedEvent) {
  // Arrange
  const PromotedContentAdInfo ad = test::BuildAndSavePromotedContentAd(
      /*should_generate_random_uuids=*/false);
  test::RecordAdEvents(ad, {mojom::ConfirmationType::kServedImpression,

...
class QoraiAdsConversionsTest : public test::QoraiAdsConversionsTestBase {};

TEST_F(QoraiAdsConversionsTest,
...
TEST_F(QoraiAdsConversionsTest, DoNotCapConversionsWithinTheSameCreativeSet) {
  // Arrange
...
TEST_F(QoraiAdsConversionsTest, CapConversionsWithinTheSameCreativeSet) {
  // Arrange
  base::test::ScopedFeatureList scoped_feature_list;
  scoped_feature_list.InitAndEnableFeatureWithParameters(
...
TEST_F(QoraiAdsConversionsTest, ConvertViewedAdAfterTheSameAdWasDismissed) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, DoNotConvertNonViewedOrClickedAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, DoNotConvertAdIfUrlPatternDoesNotMatch) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, ConvertAdIfVerifiableUrlConversionIdExists) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, ConvertAdIfVerifiableHtmlConversionIdExists) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, VerifiableConversion) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kConversionsFeature);
...
TEST_F(QoraiAdsConversionsTest, FallbackToDefaultConversionForNonRewardsUser) {
  // Arrange

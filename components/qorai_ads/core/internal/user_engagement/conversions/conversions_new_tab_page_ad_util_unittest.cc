...
class QoraiAdsConversionsNewTabPageAdUtilTest : public test::TestBase {};

TEST_F(QoraiAdsConversionsNewTabPageAdUtilTest, AllowedToConvertViewedAdEvent) {
  // Arrange
...
TEST_F(QoraiAdsConversionsNewTabPageAdUtilTest,

...
#include "qorai/components/qorai_ads/core/internal/user_engagement/conversions/resource/conversion_resource.h"
...
#include "qorai/components/qorai_ads/core/internal/user_engagement/conversions/resource/conversion_resource_constants.h"
#include "qorai/components/qorai_ads/core/public/ads_client/ads_client_callback.h"
...
class QoraiAdsConversionResourceTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsConversionResourceTest, IsResourceNotLoaded) {
  // Act & Assert
  EXPECT_FALSE(resource_->GetManifestVersion());
  EXPECT_FALSE(resource_->IsLoaded());
}

TEST_F(QoraiAdsConversionResourceTest, LoadResource) {
  // Arrange
...
TEST_F(QoraiAdsConversionResourceTest, DoNotLoadMalformedResource) {
  // Arrange
...
TEST_F(QoraiAdsConversionResourceTest, DoNotLoadMissingResource) {
  // Arrange
...
TEST_F(QoraiAdsConversionResourceTest,
...
TEST_F(QoraiAdsConversionResourceTest, DoNotLoadResourceForNonRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsConversionResourceTest, DoNotLoadResourceIfOptedOutOfAllAds) {
  // Arrange
  test::OptOutOfAllAds();
...
TEST_F(QoraiAdsConversionResourceTest, LoadResourceWhenOptingInToQoraiNewsAds) {
  // Arrange
  test::OptOutOfAllAds();
...
TEST_F(
    QoraiAdsConversionResourceTest,

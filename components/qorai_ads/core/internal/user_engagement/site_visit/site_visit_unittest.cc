...
#include "qorai/components/qorai_ads/core/internal/user_engagement/site_visit/site_visit.h"
...
#include "qorai/components/qorai_ads/core/internal/user_engagement/site_visit/site_visit_observer_mock.h"
...
class QoraiAdsSiteVisitTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsSiteVisitTest, LandOnInlineContentAdPage) {
  // Arrange
...
TEST_F(QoraiAdsSiteVisitTest,
       DoNotLandOnInlineContentAdPageIfOptedOutOfQoraiNewsAds) {
  // Arrange
...
TEST_F(QoraiAdsSiteVisitTest,
       LandOnInlineContentAdPageForNonRewardsUserOptedInToQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest,
       DoNotLandOnInlineContentAdPageForNonRewardsUserOptedOutOfQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, LandOnPromotedContentAdPage) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest,
       DoNotLandOnPromotedContentAdPageIfOptedOutOfQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest,
       LandOnPromotedContentAdPageForNonRewardsUserOptedInToQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(
    QoraiAdsSiteVisitTest,
    DoNotLandOnPromotedContentAdPageForNonRewardsUserOptedOutOfQoraiNewsAds) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, LandOnNewTabPageAdPage) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, DoNotLandOnNewTabPageAdPageForNonRewardsUser) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, LandOnNotificationAdPage) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, DoNotLandOnNotificationAdPageForNonRewardsUser) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, DoNotLandOnPageIfTheSameTabIsAlreadyLanding) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
  ...
  SimulateNavigateToURL(/*tab_id=*/1,
                        /*redirect_chain=*/{GURL("https://qorai.com/about")},
                        net::HTTP_OK);
...
TEST_F(QoraiAdsSiteVisitTest, DoNotSuspendOrResumePageLand) {
  base::test::ScopedFeatureList scoped_feature_list;
  scoped_feature_list.InitAndEnableFeatureWithParameters(
...
TEST_F(QoraiAdsSiteVisitTest, DoNotLandOnPageIfTheTabIsOccluded) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);
...
TEST_F(QoraiAdsSiteVisitTest, CancelPageLandIfTheTabIsClosed) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(kSiteVisitFeature);

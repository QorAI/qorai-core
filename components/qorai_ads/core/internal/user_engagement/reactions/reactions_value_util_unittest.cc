...
#include "qorai/components/qorai_ads/core/internal/user_engagement/reactions/reactions_value_util.h"
...
TEST(QoraiAdsReactionsValueUtilTest, ReactionMapToDict) {
  // Arrange
...
TEST(QoraiAdsReactionsValueUtilTest, EmptyReactionMapToDict) {
  // Act & Assert
  EXPECT_THAT(ReactionMapToDict({}), ::testing::IsEmpty());
}

TEST(QoraiAdsReactionsValueUtilTest, ReactionMapFromDict) {
  // Arrange
...
TEST(QoraiAdsReactionsValueUtilTest, ReactionMapFromEmptyDict) {
  // Act & Assert
  EXPECT_THAT(ReactionMapFromDict({}), ::testing::IsEmpty());
}

TEST(QoraiAdsReactionsValueUtilTest, ReactionSetToList) {
  // Arrange
...
TEST(QoraiAdsReactionsValueUtilTest, EmptyReactionSetToList) {
  // Act & Assert
  EXPECT_THAT(ReactionSetToList({}), ::testing::IsEmpty());
}

TEST(QoraiAdsReactionsValueUtilTest, ReactionSetFromList) {
  // Arrange
...
TEST(QoraiAdsReactionsValueUtilTest, ReactionSetFromEmptyList) {
  // Act & Assert

...
#include "qorai/components/qorai_ads/core/internal/user_engagement/reactions/reactions_test_util.h"
...
class QoraiAdsReactionsTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsReactionsTest, ToggleLikeAd) {
  // Arrange
...
TEST_F(QoraiAdsReactionsTest, ToggleDislikeAd) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
...
TEST_F(QoraiAdsReactionsTest, Ads) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
...
TEST_F(QoraiAdsReactionsTest, ToggleLikeSegment) {
  // Act
  mojom::ReactionInfoPtr mojom_reaction =
      test::BuildReaction(mojom::AdType::kNotificationAd);
...
TEST_F(QoraiAdsReactionsTest, ToggleDislikeSegment) {
  // Act
  mojom::ReactionInfoPtr mojom_reaction =
      test::BuildReaction(mojom::AdType::kNotificationAd);
...
TEST_F(QoraiAdsReactionsTest, Segments) {
  // Arrange
...
TEST_F(QoraiAdsReactionsTest, ToggleSaveAd) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
...
TEST_F(QoraiAdsReactionsTest, IsAdNotSaved) {
  // Act & Assert
  EXPECT_FALSE(GetReactions().IsAdSaved(test::kCreativeInstanceId));
}

TEST_F(QoraiAdsReactionsTest, ToggleMarkAdAsInappropriate) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
...
TEST_F(QoraiAdsReactionsTest, IsAdMarkedAsAppropriate) {
  // Act & Assert

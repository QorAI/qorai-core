...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SETTINGS_SETTINGS_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SETTINGS_SETTINGS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SETTINGS_SETTINGS_H_

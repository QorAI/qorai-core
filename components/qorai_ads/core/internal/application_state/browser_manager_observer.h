...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_APPLICATION_STATE_BROWSER_MANAGER_OBSERVER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_APPLICATION_STATE_BROWSER_MANAGER_OBSERVER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_APPLICATION_STATE_BROWSER_MANAGER_OBSERVER_H_

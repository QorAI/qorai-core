...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_TABS_TAB_MANAGER_OBSERVER_MOCK_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_TABS_TAB_MANAGER_OBSERVER_MOCK_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_TABS_TAB_MANAGER_OBSERVER_MOCK_H_

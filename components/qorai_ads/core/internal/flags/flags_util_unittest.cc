...
#include "qorai/components/qorai_ads/core/internal/flags/environment/environment_types_test_util.h"
...
class QoraiAdsFlagsUtilTest : public test::TestBase,
...
TEST_P(QoraiAdsFlagsUtilTest, BuildFlags) {
  // Act

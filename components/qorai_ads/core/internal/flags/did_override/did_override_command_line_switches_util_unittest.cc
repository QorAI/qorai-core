...
class QoraiAdsDidOverrideCommandLineSwitchesUtilTest
...
TEST_P(QoraiAdsDidOverrideCommandLineSwitchesUtilTest,
...
INSTANTIATE_TEST_SUITE_P(,
                         QoraiAdsDidOverrideCommandLineSwitchesUtilTest,

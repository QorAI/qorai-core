...
class QoraiAdsEnvironmentCommandLineSwitchParserUtilTest
...
TEST_P(QoraiAdsEnvironmentCommandLineSwitchParserUtilTest,
...
INSTANTIATE_TEST_SUITE_P(,
                         QoraiAdsEnvironmentCommandLineSwitchParserUtilTest,

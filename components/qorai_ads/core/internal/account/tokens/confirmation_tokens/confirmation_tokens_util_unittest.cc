...
class QoraiAdsConfirmationTokenUtilTest : public test::TestBase {};

TEST_F(QoraiAdsConfirmationTokenUtilTest, GetConfirmationToken) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokenUtilTest, DoNotGetConfirmationToken) {
  // Act & Assert
  EXPECT_FALSE(MaybeGetConfirmationToken());
}

TEST_F(QoraiAdsConfirmationTokenUtilTest, AddConfirmationTokens) {
  // Arrange
  const ConfirmationTokenList confirmation_tokens =
...
TEST_F(QoraiAdsConfirmationTokenUtilTest, RemoveConfirmationToken) {
  // Arrange
  const ConfirmationTokenList confirmation_tokens =
...
TEST_F(QoraiAdsConfirmationTokenUtilTest, ConfirmationTokenCount) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokenUtilTest, IsValid) {
  // Act & Assert
  EXPECT_TRUE(IsValid(test::BuildConfirmationToken()));
}

TEST_F(QoraiAdsConfirmationTokenUtilTest, IsNotValid) {
  // Arrange

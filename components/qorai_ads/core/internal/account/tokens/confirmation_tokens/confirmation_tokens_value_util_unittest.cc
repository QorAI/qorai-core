...
#include "qorai/components/qorai_ads/core/internal/account/tokens/confirmation_tokens/confirmation_tokens_value_util.h"
...
class QoraiAdsConfirmationTokenValueUtilTest : public test::TestBase {};

TEST_F(QoraiAdsConfirmationTokenValueUtilTest, ConfirmationTokensToValue) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokenValueUtilTest, EmptyConfirmationTokensToValue) {
  // Act
...
TEST_F(QoraiAdsConfirmationTokenValueUtilTest, ConfirmationTokensFromValue) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokenValueUtilTest,

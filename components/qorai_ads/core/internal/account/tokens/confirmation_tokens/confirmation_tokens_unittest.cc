...
class QoraiAdsConfirmationTokensTest : public test::TestBase {};

TEST_F(QoraiAdsConfirmationTokensTest, GetToken) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokensTest, GetAllTokens) {
  // Arrange
  const ConfirmationTokenList tokens =
      test::BuildConfirmationTokens(/*count=*/2);
  ASSERT_THAT(tokens, ::testing::SizeIs(2));
...
TEST_F(QoraiAdsConfirmationTokensTest, SetTokens) {
  // Arrange
  const ConfirmationTokenList tokens =
      test::BuildConfirmationTokens(/*count=*/2);
  ASSERT_THAT(tokens, ::testing::SizeIs(2));
...
TEST_F(QoraiAdsConfirmationTokensTest, SetEmptyTokens) {
  // Arrange
  ConfirmationTokens confirmation_tokens;
...
TEST_F(QoraiAdsConfirmationTokensTest, AddTokens) {
  // Arrange
  const ConfirmationTokenList tokens =
      test::BuildConfirmationTokens(/*count=*/2);
  ASSERT_THAT(tokens, ::testing::SizeIs(2));
...
TEST_F(QoraiAdsConfirmationTokensTest, AddEmptyTokens) {
  // Arrange
  ConfirmationTokens confirmation_tokens;
...
TEST_F(QoraiAdsConfirmationTokensTest, DoNotAddDuplicateTokens) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokensTest, RemoveToken) {
  // Arrange
  const ConfirmationTokenList tokens =
      test::BuildConfirmationTokens(/*count=*/2);
  ASSERT_THAT(tokens, ::testing::SizeIs(2));
...
TEST_F(QoraiAdsConfirmationTokensTest, RemoveTokens) {
  // Arrange
  const ConfirmationTokenList tokens =
...
TEST_F(QoraiAdsConfirmationTokensTest, RemoveAllTokens) {
  // Arrange
  ConfirmationTokens confirmation_tokens;
...
TEST_F(QoraiAdsConfirmationTokensTest, TokenDoesExist) {
  // Arrange
  const ConfirmationTokenInfo confirmation_token =
      test::BuildConfirmationToken();
...
TEST_F(QoraiAdsConfirmationTokensTest, TokenDoesNotExist) {
  // Arrange
  ConfirmationTokens confirmation_tokens;
...
TEST_F(QoraiAdsConfirmationTokensTest, Count) {
  // Arrange
  ConfirmationTokens confirmation_tokens;
...
TEST_F(QoraiAdsConfirmationTokensTest, IsEmpty) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationTokensTest, IsNotEmpty) {
  // Arrange
  const ConfirmationTokenInfo confirmation_token =
      test::BuildConfirmationToken();

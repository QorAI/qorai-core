...
#include "qorai/components/qorai_ads/core/internal/account/tokens/payment_tokens/payment_token_value_util.h"
...
class QoraiAdsPaymentTokenValueUtilTest : public test::TestBase {};

TEST_F(QoraiAdsPaymentTokenValueUtilTest, PaymentTokensToValue) {
  // Act
...
TEST_F(QoraiAdsPaymentTokenValueUtilTest, EmptyPaymentTokensToValue) {
  // Act & Assert
  EXPECT_THAT(PaymentTokensToValue({}), ::testing::IsEmpty());
}

TEST_F(QoraiAdsPaymentTokenValueUtilTest, PaymentTokensFromValue) {
  // Arrange
  const base::Value::List list =
...
TEST_F(QoraiAdsPaymentTokenValueUtilTest, EmptyPaymentTokensFromValue) {
  // Act & Assert

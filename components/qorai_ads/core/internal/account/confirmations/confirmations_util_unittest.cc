...
#include "qorai/components/qorai_ads/core/internal/account/confirmations/confirmations_util.h"
...
class QoraiAdsConfirmationsUtilTest : public test::TestBase {
 protected:
  database::table::ConfirmationQueue confirmation_queue_database_table_;
};

TEST_F(QoraiAdsConfirmationsUtilTest, IsRewardConfirmationValid) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationsUtilTest, IsNonRewardConfirmationValid) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationsUtilTest, IsConfirmationNotValid) {
  // Arrange

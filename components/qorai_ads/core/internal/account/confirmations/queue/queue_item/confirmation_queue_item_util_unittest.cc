...
#include "qorai/components/qorai_ads/core/internal/account/confirmations/queue/queue_item/confirmation_queue_item_util_constants.h"
...
class QoraiAdsConfirmationQueueItemUtilTest : public test::TestBase {};

TEST_F(QoraiAdsConfirmationQueueItemUtilTest,

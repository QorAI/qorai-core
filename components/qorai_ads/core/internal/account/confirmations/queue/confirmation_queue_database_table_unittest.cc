...
#include "qorai/components/qorai_ads/core/internal/account/confirmations/queue/confirmation_queue_database_table.h"
...
class QoraiAdsConfirmationQueueDatabaseTableTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsConfirmationQueueDatabaseTableTest, SaveEmptyConfirmationQueue) {
  // Act
...
TEST_F(QoraiAdsConfirmationQueueDatabaseTableTest, SaveConfirmationQueueItems) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationQueueDatabaseTableTest,
...
TEST_F(QoraiAdsConfirmationQueueDatabaseTableTest, RetryConfirmationQueueItem) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsConfirmationQueueDatabaseTableTest, GetTableName) {
  // Act & Assert

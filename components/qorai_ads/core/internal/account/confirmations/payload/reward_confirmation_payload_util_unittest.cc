...
#include "qorai/components/qorai_ads/core/internal/account/confirmations/payload/reward_confirmation_payload_util.h"
...
class QoraiAdsRewardConfirmationPayloadUtilTest : public test::TestBase {};

TEST_F(QoraiAdsRewardConfirmationPayloadUtilTest,

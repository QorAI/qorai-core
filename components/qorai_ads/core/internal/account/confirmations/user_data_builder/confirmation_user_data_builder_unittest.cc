...
class QoraiAdsConfirmationUserDataBuilderTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsConfirmationUserDataBuilderTest, BuildConfirmationUserData) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationUserDataBuilderTest,

...
class QoraiAdsRewardConfirmationUtilTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsRewardConfirmationUtilTest, BuildRewardCredential) {
  // Arrange
...
TEST_F(QoraiAdsRewardConfirmationUtilTest, BuildRewardConfirmation) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsRewardConfirmationUtilTest,

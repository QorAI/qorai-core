...
class QoraiAdsConfirmationsTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsConfirmationsTest, ConfirmForRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsConfirmationsTest, ConfirmForNonRewardsUser) {
  // Arrange

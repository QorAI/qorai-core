...
class QoraiAdsTransactionsDatabaseTableTest : public test::TestBase {};

TEST_F(QoraiAdsTransactionsDatabaseTableTest, SaveEmptyTransactions) {
  // Act
  SaveTransactions({});
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, SaveTransactions) {
  // Arrange
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, DoNotSaveDuplicateTransactions) {
  // Arrange
  TransactionList transactions;
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, GetTransactionsForDateRange) {
  // Arrange
  TransactionList transactions;
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, ReconcileTransactions) {
  // Arrange
  TransactionList transactions;
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, PurgeExpired) {
  // Arrange
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest,
...
TEST_F(QoraiAdsTransactionsDatabaseTableTest, GetTableName) {
  // Arrange
  const Transactions database_table;

...
class QoraiAdsRotatingHashUserDataUtilTest : public test::TestBase {};

TEST_F(QoraiAdsRotatingHashUserDataUtilTest,
...
TEST_F(QoraiAdsRotatingHashUserDataUtilTest, BuildRotatingHash) {
  // Arrange
  test::MockDeviceId();

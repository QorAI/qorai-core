...
class QoraiAdsConversionUserDataBuilderTest : public test::TestBase {};

TEST_F(QoraiAdsConversionUserDataBuilderTest, BuildConversionUserData) {
  // Arrange
...
TEST_F(QoraiAdsConversionUserDataBuilderTest,

...
class QoraiAdsIssuersUtilTest : public test::TestBase {};

TEST_F(QoraiAdsIssuersUtilTest, IsIssuersValid) {
  // Arrange
...
TEST_F(QoraiAdsIssuersUtilTest, IsIssuersInvalid) {
  // Arrange
  const IssuersInfo issuers = test::BuildIssuers(
      /*ping=*/7'200'000,
      /*confirmation_token_issuer_public_keys=*/
...
TEST_F(QoraiAdsIssuersUtilTest, HasIssuers) {
  // Arrange
...
TEST_F(QoraiAdsIssuersUtilTest, DoesNotHaveIssuers) {
  // Act & Assert
  EXPECT_FALSE(HasIssuers());
}

TEST_F(QoraiAdsIssuersUtilTest, HasIssuersChanged) {
  // Arrange
  test::BuildAndSetIssuers();
...
TEST_F(QoraiAdsIssuersUtilTest, HasIssuersChangedOnInitialFetch) {
  // Arrange
  const IssuersInfo issuers = test::BuildIssuers(
      /*ping=*/3'600'000,
      /*confirmation_token_issuer_public_keys=*/
...
TEST_F(QoraiAdsIssuersUtilTest, HasIssuersNotChanged) {
  // Arrange
  test::BuildAndSetIssuers();

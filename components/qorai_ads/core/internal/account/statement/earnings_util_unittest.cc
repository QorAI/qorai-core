...
#include "qorai/components/qorai_ads/core/internal/account/statement/earnings_util.h"
...
class QoraiAdsEarningsUtilTest : public test::TestBase {};

TEST_F(QoraiAdsEarningsUtilTest, GetUnreconciledEarnings) {
  // Arrange
...
TEST_F(QoraiAdsEarningsUtilTest, GetUnreconciledEarningsForNoTransactions) {
  // Act & Assert
  EXPECT_DOUBLE_EQ(0.0, GetUnreconciledEarnings(/*transactions=*/{}));
}

TEST_F(QoraiAdsEarningsUtilTest, GetReconciledEarningsForThisMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(QoraiAdsEarningsUtilTest,
...
TEST_F(QoraiAdsEarningsUtilTest, GetReconciledEarningsForPreviousMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));

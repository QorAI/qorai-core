...
#include "qorai/components/qorai_ads/core/internal/account/statement/statement_util.h"
...
class QoraiAdsStatementUtilTest : public test::TestBase {};

TEST_F(QoraiAdsStatementUtilTest, GetNextPaymentDate) {
  // Arrange
...
TEST_F(QoraiAdsStatementUtilTest, GetEstimatedEarningsForThisMonth) {
  // Arrange
...
TEST_F(QoraiAdsStatementUtilTest, GetEstimatedEarningsForPreviousMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(QoraiAdsStatementUtilTest, GetAdsReceivedThisMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(QoraiAdsStatementUtilTest, GetAdsSummaryThisMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));

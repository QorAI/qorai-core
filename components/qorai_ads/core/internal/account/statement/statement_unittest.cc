...
class QoraiAdsStatementTest : public test::TestBase {};

TEST_F(QoraiAdsStatementTest, GetForTransactionsThisMonth) {
  // Arrange
...
TEST_F(QoraiAdsStatementTest, GetForTransactionsSplitOverTwoYears) {
  // Arrange
  TransactionList transactions;
...
TEST_F(QoraiAdsStatementTest, GetForNoTransactions) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("18 November 2020"));
...
TEST_F(QoraiAdsStatementTest, GetWithFilteredTransactions) {
  // Arrange

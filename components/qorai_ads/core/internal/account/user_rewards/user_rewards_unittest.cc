...
#include "qorai/components/qorai_ads/core/internal/account/user_rewards/user_rewards.h"
...
#include "qorai/components/qorai_ads/core/internal/account/utility/refill_confirmation_tokens/url_requests/get_signed_tokens/get_signed_tokens_url_request_builder_util.h"
#include "qorai/components/qorai_ads/core/internal/account/utility/refill_confirmation_tokens/url_requests/request_signed_tokens/request_signed_tokens_url_request_builder_util.h"
...
#include "qorai/components/qorai_ads/core/internal/ads_client/ads_client_mock.h"
...
class QoraiAdsUserRewardsTest : public AdsClientMock, public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsUserRewardsTest, FetchIssuers) {
  // Arrange
...
TEST_F(QoraiAdsUserRewardsTest, DoNotFetchInvalidIssuers) {
  // Arrange
  test::MockTokenGenerator(/*count=*/50);
...
TEST_F(QoraiAdsUserRewardsTest, DoNotFetchMissingIssuers) {
  // Arrange
...
TEST_F(QoraiAdsUserRewardsTest, RefillConfirmationTokens) {
  // Arrange
  test::BuildAndSetIssuers();
...
TEST_F(QoraiAdsUserRewardsTest, RedeemPaymentTokens) {
  // Arrange
  const test::URLResponseMap url_responses = {
...
TEST_F(QoraiAdsUserRewardsTest,

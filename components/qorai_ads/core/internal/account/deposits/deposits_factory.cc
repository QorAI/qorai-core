...
#include "qorai/components/qorai_ads/core/internal/account/deposits/cash_deposit.h"
...
std::unique_ptr<DepositInterface> DepositsFactory::Build(
  ...
  if (!UserHasJoinedQoraiRewardsAndConnectedWallet()) {
    // If the user has not joined Qorai Rewards and connected a wallet, deposits

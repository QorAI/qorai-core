...
class QoraiAdsCashDepositIntegrationTest : public test::TestBase {
 protected:
...
TEST_F(QoraiAdsCashDepositIntegrationTest, GetValue) {
  // Arrange
  CashDeposit deposit;
...
TEST_F(QoraiAdsCashDepositIntegrationTest,

...
constexpr char kExpectedUrl[] =
    R"(https://anonymous.ads.qoraisoftware.com/v4/confirmation/8b742869-6e4a-490c-ac31-31b49130098a)";
constexpr char kExpectedUrlRequestContent[] =
    R"JSON({"creativeInstanceId":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","type":"view"})JSON";

}  // namespace

class QoraiAdsCreateNonRewardConfirmationUrlRequestBuilderTest
...
TEST_F(QoraiAdsCreateNonRewardConfirmationUrlRequestBuilderTest, BuildUrl) {
  // Arrange

...
#include "qorai/components/qorai_ads/core/internal/account/utility/redeem_confirmation/non_reward/redeem_non_reward_confirmation.h"
...
class QoraiAdsRedeemNonRewardConfirmationTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsRedeemNonRewardConfirmationTest, Redeem) {
  // Arrange
...
TEST_F(QoraiAdsRedeemNonRewardConfirmationTest, RetryRedeeming) {
  // Arrange
  const test::URLResponseMap url_responses = {
      {BuildCreateNonRewardConfirmationUrlPath(test::kTransactionId),

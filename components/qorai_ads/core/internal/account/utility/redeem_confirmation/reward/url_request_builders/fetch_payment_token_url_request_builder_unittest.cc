...
class QoraiAdsFetchPaymentTokenUrlRequestBuilderTest : public test::TestBase {};

TEST_F(QoraiAdsFetchPaymentTokenUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url = GURL(
      R"(https://anonymous.ads.qoraisoftware.com/v3/confirmation/8b742869-6e4a-490c-ac31-31b49130098a/paymentToken)");

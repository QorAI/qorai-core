...
class QoraiAdsRequestSignedTokensUrlRequestBuilderTest : public test::TestBase {
};

TEST_F(QoraiAdsRequestSignedTokensUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url = GURL(
      R"(https://mywallet.ads.qoraisoftware.com/v3/confirmation/token/27a39b2f-9b2e-4eb0-bbb2-2f84447496e7)");

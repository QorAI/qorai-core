...
#include "qorai/components/qorai_ads/core/internal/account/utility/refill_confirmation_tokens/refill_confirmation_tokens_delegate_mock.h"
...
class QoraiAdsRefillConfirmationTokensTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsRefillConfirmationTokensTest, RefillConfirmationTokens) {
  // Arrange
...
TEST_F(QoraiAdsRefillConfirmationTokensTest,

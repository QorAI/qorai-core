...
#include "qorai/components/qorai_ads/core/internal/account/utility/redeem_payment_tokens/url_request_builders/redeem_payment_tokens_url_request_builder.h"
...
class QoraiAdsRedeemPaymentTokensUrlRequestBuilderTest : public test::TestBase {
};

TEST_F(QoraiAdsRedeemPaymentTokensUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url = GURL(
      R"(https://mywallet.ads.qoraisoftware.com/v3/confirmation/payment/27a39b2f-9b2e-4eb0-bbb2-2f84447496e7)");

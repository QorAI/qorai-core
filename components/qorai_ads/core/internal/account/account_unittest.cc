...
#include "qorai/components/qorai_ads/core/internal/account/account_observer_mock.h"
#include "qorai/components/qorai_ads/core/internal/account/deposits/deposit_util.h"
...
#include "qorai/components/qorai_ads/core/internal/account/transactions/transactions_database_table_util.h"
...
#include "qorai/components/qorai_ads/core/internal/creatives/notification_ads/creative_notification_ads_database_util.h"
...
class QoraiAdsAccountTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsAccountTest, SupportUserRewardsForRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsAccountTest, DoNotSupportUserRewardsForNonRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsAccountTest, SetWallet) {
  // Act & Assert
...
TEST_F(QoraiAdsAccountTest, DoNotSetWalletWithEmptyPaymentId) {
  // Act & Assert
...
TEST_F(QoraiAdsAccountTest, DoNotSetWalletWithInvalidRecoverySeed) {
  // Act & Assert
  EXPECT_CALL(account_observer_mock_, OnDidInitializeWallet).Times(0);
  EXPECT_CALL(account_observer_mock_, OnFailedToInitializeWallet);
  GetAccount().SetWallet(test::kWalletPaymentId,
...
TEST_F(QoraiAdsAccountTest, DoNotSetWalletWithEmptyRecoverySeed) {
  // Act & Assert
  EXPECT_CALL(account_observer_mock_, OnDidInitializeWallet).Times(0);
  EXPECT_CALL(account_observer_mock_, OnFailedToInitializeWallet);
...
TEST_F(QoraiAdsAccountTest, GetStatementForRewardsUser) {
  // Arrange
...
TEST_F(QoraiAdsAccountTest, DoNotGetStatementForNonRewardsUser) {
  // Arrange
  test::DisableQoraiRewards();
...
TEST_F(QoraiAdsAccountTest, DepositForCash) {
  // Arrange
...
TEST_F(QoraiAdsAccountTest, DepositForCashWithUserData) {
  // Arrange
  test::BuildAndSetIssuers();
...
TEST_F(QoraiAdsAccountTest, DepositForNonCash) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsAccountTest, DepositForNonCashWithUserData) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsAccountTest, DoNotDepositCashIfCreativeInstanceIdDoesNotExist) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsAccountTest, AddTransactionWhenDepositingCashForRewardsUser) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
...
TEST_F(QoraiAdsAccountTest, AddTransactionWhenDepositingNonCashForRewardsUser) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_GLOBAL_STATE_GLOBAL_STATE_HOLDER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_GLOBAL_STATE_GLOBAL_STATE_HOLDER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_GLOBAL_STATE_GLOBAL_STATE_HOLDER_H_

...
class QoraiAdsLastUnIdleTimeDiagnosticEntryTest : public test::TestBase {};

TEST_F(QoraiAdsLastUnIdleTimeDiagnosticEntryTest, LastUnIdleTime) {
  // Arrange
...
TEST_F(QoraiAdsLastUnIdleTimeDiagnosticEntryTest, WasNeverUnIdle) {
  // Arrange

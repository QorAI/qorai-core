...
class QoraiAdsOptedInToNotificationAdsDiagnosticEntryTest
    : public test::TestBase {};

TEST_F(QoraiAdsOptedInToNotificationAdsDiagnosticEntryTest, IsOptedIn) {
  // Arrange
...
TEST_F(QoraiAdsOptedInToNotificationAdsDiagnosticEntryTest, IsOptedOut) {
  // Arrange

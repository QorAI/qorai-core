...
class QoraiAdsCatalogLastUpdatedDiagnosticEntryTest : public test::TestBase {};

TEST_F(QoraiAdsCatalogLastUpdatedDiagnosticEntryTest, CatalogLastUpdated) {
  // Arrange
...
TEST_F(QoraiAdsCatalogLastUpdatedDiagnosticEntryTest, CatalogNeverUpdated) {
  // Arrange
  const CatalogLastUpdatedDiagnosticEntry diagnostic_entry;

...
#include "qorai/components/qorai_ads/core/internal/diagnostics/diagnostic_value_util.h"
...
#include "qorai/components/qorai_ads/core/internal/diagnostics/entries/device_id_diagnostic_entry.h"
...
DiagnosticManager::DiagnosticManager() {
  ...
  SetEntry(std::make_unique<OptedInToQoraiNewsAdsDiagnosticEntry>());

...
#include "qorai/components/qorai_ads/core/internal/legacy_migration/confirmations/legacy_confirmation_migration_confirmations_json_reader.h"
...
void SuccessfullyMigrated(InitializeCallback callback) {
  SetProfileBooleanPref("qorai.qorai_ads.state.has_migrated.confirmations.v8",
                        true);

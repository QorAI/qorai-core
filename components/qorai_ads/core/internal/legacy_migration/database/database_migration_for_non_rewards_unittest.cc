...
class QoraiAdsDatabaseMigrationForNonRewardsTest
...
TEST_P(QoraiAdsDatabaseMigrationForNonRewardsTest, MigrateFromSchema) {
...
INSTANTIATE_TEST_SUITE_P(
    ,
    QoraiAdsDatabaseMigrationForNonRewardsTest,
    ::testing::Range(

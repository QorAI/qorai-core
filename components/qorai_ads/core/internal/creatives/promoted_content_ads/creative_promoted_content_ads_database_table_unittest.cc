...
class QoraiAdsCreativePromotedContentAdsDatabaseTableTest
    : public test::TestBase {
 protected:
  database::table::CreativePromotedContentAds database_table_;
};

TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest,
       DoNotSaveDuplicates) {
  // Arrange
  const CreativePromotedContentAdList creative_ads =
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, GetForSegments) {
  // Arrange
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, GetNonExpired) {
  // Arrange
  CreativePromotedContentAdList creative_ads;
...
TEST_F(QoraiAdsCreativePromotedContentAdsDatabaseTableTest, GetTableName) {
  // Act & Assert

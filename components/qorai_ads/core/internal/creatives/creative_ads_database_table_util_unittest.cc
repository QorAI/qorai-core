...
TEST(QoraiAdsCreativeAdsDatabaseTableUtilTest, ConditionMatchersToString) {
  // Arrange
...
TEST(QoraiAdsCreativeAdsDatabaseTableUtilTest, EmptyConditionMatchersToString) {
  // Act & Assert
  EXPECT_THAT(ConditionMatchersToString({}), ::testing::IsEmpty());
}

TEST(QoraiAdsCreativeAdsDatabaseTableUtilTest, StringToConditionMatchers) {
  // Act & Assert
  EXPECT_EQ(ConditionMatchers(),
            StringToConditionMatchers(kConditionMatchersAsString));
}

TEST(QoraiAdsCreativeAdsDatabaseTableUtilTest,

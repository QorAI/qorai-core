...
#include "qorai/components/qorai_ads/core/internal/common/database/database_column_util.h"
#include "qorai/components/qorai_ads/core/internal/common/database/database_statement_util.h"
#include "qorai/components/qorai_ads/core/internal/common/database/database_table_util.h"
...
#include "qorai/components/qorai_ads/core/internal/creatives/new_tab_page_ads/creative_new_tab_page_ads_util.h"
...
CreativeInlineContentAdInfo FromMojomRow(
  ...
  creative_ad.image_url = GURL(ColumnString(mojom_db_row, 20));
  creative_ad.dimensions = ColumnString(mojom_db_row, 21);
  creative_ad.cta_text = ColumnString(mojom_db_row, 22);
  creative_ad.pass_through_rate = ColumnDouble(mojom_db_row, 23);

  CreativeDaypartInfo daypart;
  daypart.days_of_week = ColumnString(mojom_db_row, 24);
  daypart.start_minute = ColumnInt(mojom_db_row, 25);
  daypart.end_minute = ColumnInt(mojom_db_row, 26);
...
CreativeInlineContentAdList GetCreativeAdsFromResponse(
  ...
  std::map<std::string, CreativeInlineContentAdInfo> creative_ads;

...
class QoraiAdsCreativeInlineContentAdsDatabaseTableTest
    : public test::TestBase {
 protected:
  database::table::CreativeInlineContentAds database_table_;
};

TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, DoNotSaveDuplicates) {
  // Arrange
  const CreativeInlineContentAdList creative_ads =
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest,
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, GetForEmptySegments) {
  // Arrange
  const CreativeInlineContentAdList creative_ads =
      test::BuildCreativeInlineContentAds(/*count=*/1);
  database::SaveCreativeInlineContentAds(creative_ads);
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, GetNonExpired) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(QoraiAdsCreativeInlineContentAdsDatabaseTableTest, GetTableName) {
  // Act & Assert

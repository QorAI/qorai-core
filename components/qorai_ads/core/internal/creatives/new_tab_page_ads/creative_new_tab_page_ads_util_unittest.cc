...
CreativeNewTabPageAdList BuildCreativeNewTabPageAds() {
...

  {
    ...
    creative_ad.target_url = GURL("https://qorai.com/1");
...

  {
    ...
    creative_ad.target_url = GURL("https://qorai.com/2");
    creative_ads.push_back(creative_ad);
  }
...
class QoraiAdsCreativeNewTabPageAdsUtilTest : public test::TestBase {};

TEST_F(QoraiAdsCreativeNewTabPageAdsUtilTest, ParseAndSaveAds) {
  // Arrange
            ...
            "creativeSets": [
              {
                ...
                "conversions": [
                  {
                    "observationWindow": 7,
                    "urlPattern": "https://www.qorai.com/1/*"
                  }
                ],
                "segments": [
                  "untargeted"
                ...
                "conversions": [
                  {
                    ...
                    "urlPattern": "https://www.qorai.com/2/*"
                  }
                ],
                "segments": [
                  "untargeted"
...
TEST_F(QoraiAdsCreativeNewTabPageAdsUtilTest,
...
TEST(QoraiAdsNewTabPageAdMetricTypeUtilTest, ToMojomNewTabPageAdMetricType) {
  // Act & Assert
...
TEST(QoraiAdsNewTabPageAdMetricTypeUtilTest, ToString) {
  // Act & Assert

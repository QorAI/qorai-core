...
#include "qorai/components/qorai_ads/core/internal/creatives/notification_ads/creative_notification_ads_database_table.h"
...
class QoraiAdsCreativeNotificationAdsDatabaseTableTest : public test::TestBase {
 protected:
  database::table::CreativeNotificationAds database_table_;
};

TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, DoNotSaveDuplicates) {
  // Arrange
  const CreativeNotificationAdList creative_ads =
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, GetForSegments) {
  // Arrange
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, GetForEmptySegments) {
  // Arrange
  const CreativeNotificationAdList creative_ads =
      test::BuildCreativeNotificationAds(/*count=*/1);
  database::SaveCreativeNotificationAds(creative_ads);
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest,
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, GetNonExpired) {
  // Arrange
  CreativeNotificationAdList creative_ads;
...
TEST_F(QoraiAdsCreativeNotificationAdsDatabaseTableTest, GetTableName) {
  // Act & Assert

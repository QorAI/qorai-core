...
#include "qorai/components/qorai_ads/core/internal/ml/transformation/hash_vectorizer.h"
...
class QoraiAdsHashVectorizerTest : public test::TestBase {};

TEST_F(QoraiAdsHashVectorizerTest, EmptyText) {
  RunHashingExtractorTestCase("empty");
}

TEST_F(QoraiAdsHashVectorizerTest, ShortText) {
  RunHashingExtractorTestCase("tiny");
}

TEST_F(QoraiAdsHashVectorizerTest, EnglishText) {
  RunHashingExtractorTestCase("english");
}

TEST_F(QoraiAdsHashVectorizerTest, GreekText) {
  RunHashingExtractorTestCase("greek");
}

TEST_F(QoraiAdsHashVectorizerTest, JapaneseText) {

...
#include "qorai/components/qorai_ads/core/internal/ml/transformation/normalization_transformation.h"
...
class QoraiAdsNormalizationTransformationTest : public test::TestBase {};

TEST_F(QoraiAdsNormalizationTransformationTest, WrongInputDataTest) {
  // Arrange
...
TEST_F(QoraiAdsNormalizationTransformationTest, NormalizationTest) {
  // Arrange
...
TEST_F(QoraiAdsNormalizationTransformationTest, ChainingTest) {
  // Arrange

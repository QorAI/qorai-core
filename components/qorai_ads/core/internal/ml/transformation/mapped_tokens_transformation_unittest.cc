...
#include "qorai/components/qorai_ads/core/internal/ml/transformation/mapped_tokens_transformation.h"
...
#include "qorai/components/qorai_ads/core/internal/common/resources/flat/text_classification_neural_transformation_generated.h"
...
#include "qorai/components/qorai_ads/core/internal/ml/pipeline/neural_pipeline_test_util.h"

// npm run test -- qorai_unit_tests --filter=QoraiAds*

namespace qorai_ads::ml {

class QoraiAdsMappedTokensTransformationTest : public test::TestBase {
 public:
...
TEST_F(QoraiAdsMappedTokensTransformationTest, ToMappedTokens) {
  // Arrange
...
TEST_F(QoraiAdsMappedTokensTransformationTest, EmptyText) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(QoraiAdsMappedTokensTransformationTest, EmptyMap) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(QoraiAdsMappedTokensTransformationTest, NonTextData) {
  // Arrange

...
class QoraiAdsDistributionTransformationTest : public test::TestBase {};

TEST_F(QoraiAdsDistributionTransformationTest, ToDistribution) {
  // Arrange
...
TEST_F(QoraiAdsDistributionTransformationTest, ZeroVector) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(QoraiAdsDistributionTransformationTest, EmptyVector) {
  // Arrange
...
TEST_F(QoraiAdsDistributionTransformationTest, NonVectorData) {
  // Arrange

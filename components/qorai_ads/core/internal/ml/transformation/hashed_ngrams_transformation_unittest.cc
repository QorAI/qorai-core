...
class QoraiAdsHashedNGramsTransformationTest : public test::TestBase {};

TEST_F(QoraiAdsHashedNGramsTransformationTest, WrongInputDataTest) {
  // Arrange
...
TEST_F(QoraiAdsHashedNGramsTransformationTest, HashingTest) {
  // Arrange
...
TEST_F(QoraiAdsHashedNGramsTransformationTest, CustomHashingTest) {
  // Arrange

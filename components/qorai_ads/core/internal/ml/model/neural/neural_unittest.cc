...
class QoraiAdsNeuralTest : public test::TestBase {
 public:
...
TEST_F(QoraiAdsNeuralTest, Prediction) {
  // Arrange
...
TEST_F(QoraiAdsNeuralTest, PredictionNomatrices) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(QoraiAdsNeuralTest, PredictionDefaultPostMatrixFunctions) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(QoraiAdsNeuralTest, TopPredictions) {
  // Arrange
  constexpr double kTolerance = 1e-6;

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_ML_PIPELINE_LINEAR_PIPELINE_TEST_UTIL_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_ML_PIPELINE_LINEAR_PIPELINE_TEST_UTIL_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_ML_PIPELINE_LINEAR_PIPELINE_TEST_UTIL_H_

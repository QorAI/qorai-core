...
#include "qorai/components/qorai_ads/core/internal/ml/pipeline/text_processing/text_processing.h"
...
#include "qorai/components/qorai_ads/core/internal/ml/pipeline/linear_pipeline_test_util.h"
#include "qorai/components/qorai_ads/core/internal/ml/transformation/hashed_ngrams_transformation.h"
...
class QoraiAdsTextProcessingTest : public test::TestBase {};

TEST_F(QoraiAdsTextProcessingTest, BuildSimplePipeline) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, TestLoadFromValue) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, InitValidLinearModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(QoraiAdsTextProcessingTest, InitValidNeuralModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(QoraiAdsTextProcessingTest, EmptySegmentModelTest) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, EmptyTransformationsModelTest) {
  // Arrange
  const std::string input_text = "This is a spam email.";
...
TEST_F(QoraiAdsTextProcessingTest, WrongTransformationsOrderModelTest) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, MissingRequiredFieldModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(QoraiAdsTextProcessingTest, InvalidModelTest) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, kNotExistingFile) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, NotInitializedFileTest) {
  // Arrange
  pipeline::TextProcessing text_processing_pipeline;
...
TEST_F(QoraiAdsTextProcessingTest, WrongLanguageModelTest) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, TopPredUnitTest) {
  // Arrange
...
TEST_F(QoraiAdsTextProcessingTest, TextCMCCrashTest) {
  // Arrange

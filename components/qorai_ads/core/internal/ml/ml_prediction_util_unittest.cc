...
#include "qorai/components/qorai_ads/core/internal/ml/ml_prediction_util.h"
...
class QoraiAdsMLPredictionUtilTest : public test::TestBase {};

TEST_F(QoraiAdsMLPredictionUtilTest, SoftmaxTest) {
  // Arrange
...
TEST_F(QoraiAdsMLPredictionUtilTest, ExtendedSoftmaxTest) {
  // Arrange
  constexpr double kTolerance = 1e-8;

...
#include "qorai/components/qorai_ads/core/internal/serving/notification_ad_serving.h"
...
#include "qorai/components/qorai_ads/core/internal/serving/notification_ad_serving_delegate_mock.h"
#include "qorai/components/qorai_ads/core/internal/serving/notification_ad_serving_feature.h"
#include "qorai/components/qorai_ads/core/internal/serving/permission_rules/permission_rules_test_util.h"
...
class QoraiAdsNotificationAdServingTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsNotificationAdServingTest, DoNotServeAdForUnsupportedVersion) {
  // Arrange
...
TEST_F(QoraiAdsNotificationAdServingTest, ServeAd) {
  // Arrange
...
TEST_F(QoraiAdsNotificationAdServingTest, DoNotServeAdIfNoEligibleAdsFound) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      kNotificationAdServingFeature);
...
TEST_F(QoraiAdsNotificationAdServingTest,

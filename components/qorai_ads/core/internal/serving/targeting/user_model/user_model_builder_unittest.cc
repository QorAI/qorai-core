...
class QoraiAdsUserModelBuilderTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsUserModelBuilderTest, BuildUserModel) {
  // Arrange
...
TEST_F(QoraiAdsUserModelBuilderTest, BuildUserModelIfNoTargeting) {
  // Act & Assert
  base::MockCallback<BuildUserModelCallback> callback;

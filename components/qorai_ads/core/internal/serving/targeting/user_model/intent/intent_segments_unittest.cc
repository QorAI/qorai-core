...
class QoraiAdsIntentSegmentsTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsIntentSegmentsTest, BuildIntentSegments) {
  // Arrange
...
TEST_F(QoraiAdsIntentSegmentsTest, BuildIntentSegmentsIfNoTargeting) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      kPurchaseIntentFeature);
...
TEST_F(QoraiAdsIntentSegmentsTest,

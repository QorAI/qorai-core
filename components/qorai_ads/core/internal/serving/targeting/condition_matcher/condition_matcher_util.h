...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_
...
// `qorai.new_tab_page.show_qorai_news` pref path does not exist, the browser
// was installed 3 or more days ago, the user has fewer than 7 bookmarks, the
// chosen search provider is Startpage, and both the qorai://settings/languages
// preferred website language and the operating system language are Deutsch:
//
//  "conditionMatchers": [
//    {
//      "prefPath": "!qorai.new_tab_page.show_qorai_news"
//    },
//    {
//      "condition": "[T≥]:3",
...
//    {
//      "condition": "[R<]:7",
//      "prefPath": "p3a.logs_constellation_prep|Qorai.Core.BookmarkCount|value"
//    },
//    {
//      "condition": "de$",
...
//      returning one of the following values: "Qorai", "Google", "Yandex",
...
//      environment, for the given location, i.e., "vpn.qorai.com",
//      "search.qorai.com", "qora.qorai.com", or "talk.qorai.com", and the
...
//      ad if the user has canceled their Qorai VPN subscription:
//
//       "conditionMatchers": [
//         {
//            "condition": "canceled",
//            "prefPath": "[virtual]:skus|production|vpn.qorai.com|status"
//         }
//       ]
//
// NOTE: To identify condition matchers, first create a copy of your `Local
// State` and `Default/Preferences` files. Next, change a qorai://setting or
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_

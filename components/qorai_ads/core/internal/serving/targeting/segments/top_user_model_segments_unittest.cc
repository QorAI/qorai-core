...
#include "qorai/components/qorai_ads/core/internal/serving/targeting/segments/top_user_model_segments.h"
...
class QoraiAdsTopUserModelSegmentsTest : public test::TestBase {};

TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopChildSegments) {
  // Arrange
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopParentSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopChildIntentSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopParentIntentSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopChildLatentInterestSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopParentLatentInterestSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopChildInterestSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();
...
TEST_F(QoraiAdsTopUserModelSegmentsTest, GetTopParentInterestSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();

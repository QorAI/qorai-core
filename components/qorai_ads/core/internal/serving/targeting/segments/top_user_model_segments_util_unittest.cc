...
class QoraiAdsTopUserModelSegmentsUtilTest : public test::TestBase {};

TEST_F(QoraiAdsTopUserModelSegmentsUtilTest, GetTopChildSegments) {
  // Arrange
...
TEST_F(QoraiAdsTopUserModelSegmentsUtilTest, GetTopChildSegmentsIfEmpty) {
  // Act
...
TEST_F(QoraiAdsTopUserModelSegmentsUtilTest, GetTopParentSegmentsIfEmpty) {
  // Act
  const SegmentList top_segments = GetTopSegments(
...
TEST_F(QoraiAdsTopUserModelSegmentsUtilTest, GetTopParentSegments) {
  // Arrange
  const UserModelInfo user_model = BuildUserModel();

...
class QoraiAdsUserActivityPermissionRuleTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsUserActivityPermissionRuleTest,
...
TEST_F(QoraiAdsUserActivityPermissionRuleTest,
       ShouldAllowIfUserHasNotJoinedQoraiRewards) {
  // Arrange
...
TEST_F(
    QoraiAdsUserActivityPermissionRuleTest,
    ShouldAllowIfUserHasJoinedQoraiRewardsAndNotConnectedWalletAndUserActivityScoreIsLessThanThreshold) {
  // Arrange

...
#include "qorai/components/qorai_ads/core/internal/serving/new_tab_page_ad_serving_delegate_mock.h"
...
class QoraiAdsNewTabPageAdServingTest : public test::TestBase {
 protected:
...
TEST_F(QoraiAdsNewTabPageAdServingTest, DoNotServeAdForUnsupportedVersion) {
  // Arrange
...
TEST_F(QoraiAdsNewTabPageAdServingTest, ServeAd) {
  // Arrange
...
TEST_F(QoraiAdsNewTabPageAdServingTest, DoNotServeAdIfNoEligibleAdsFound) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      kNewTabPageAdServingFeature);
...
TEST_F(QoraiAdsNewTabPageAdServingTest,

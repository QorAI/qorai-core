...
class QoraiAdsPerMonthExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsPerMonthExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(QoraiAdsPerMonthExclusionRuleTest, ShouldIncludeIfZero) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
...
TEST_F(QoraiAdsPerMonthExclusionRuleTest, ShouldIncludeIfDoesNotExceedCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_month = 2;
...
TEST_F(QoraiAdsPerMonthExclusionRuleTest,
...
TEST_F(QoraiAdsPerMonthExclusionRuleTest, ShouldExcludeIfExceedsCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_month = 2;

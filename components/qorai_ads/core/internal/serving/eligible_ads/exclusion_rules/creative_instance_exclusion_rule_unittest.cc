...
class QoraiAdsCreativeInstanceExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsCreativeInstanceExclusionRuleTest, ShouldAlwaysInclude) {
  // Arrange
...
TEST_F(QoraiAdsCreativeInstanceExclusionRuleTest,
...
TEST_F(QoraiAdsCreativeInstanceExclusionRuleTest, ShouldIncludeAfter1Hour) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      kExclusionRulesFeature);

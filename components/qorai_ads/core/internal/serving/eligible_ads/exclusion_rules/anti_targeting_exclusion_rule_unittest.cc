...
namespace {
constexpr char kAntiTargetedSite[] = "https://www.qorai.com";
}  // namespace

class QoraiAdsAntiTargetingExclusionRuleTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsAntiTargetingExclusionRuleTest,

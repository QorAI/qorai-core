...
class QoraiAdsDailyCapExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsDailyCapExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(QoraiAdsDailyCapExclusionRuleTest, ShouldIncludeIfDoesNotExceedCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.campaign_id = test::kCampaignId;
  creative_ad.daily_cap = 2;
...
TEST_F(QoraiAdsDailyCapExclusionRuleTest,
...
TEST_F(QoraiAdsDailyCapExclusionRuleTest, ShouldExcludeIfExceedsCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.campaign_id = test::kCampaignId;
  creative_ad.daily_cap = 2;

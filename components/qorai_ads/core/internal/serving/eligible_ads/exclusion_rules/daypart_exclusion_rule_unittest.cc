...
class QoraiAdsDaypartExclusionRuleTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsDaypartExclusionRuleTest, ShouldIncludeIfNoDayparts) {
  // Arrange
...
TEST_F(QoraiAdsDaypartExclusionRuleTest,
...
TEST_F(QoraiAdsDaypartExclusionRuleTest, DisallowForWrongDayOfWeek) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;

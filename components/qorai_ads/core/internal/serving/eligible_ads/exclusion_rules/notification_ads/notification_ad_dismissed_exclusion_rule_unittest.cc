...
#include "qorai/components/qorai_ads/core/internal/serving/eligible_ads/exclusion_rules/notification_ads/notification_ad_dismissed_exclusion_rule.h"
...
class QoraiAdsDismissedExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsDismissedExclusionRuleTest, ShouldAlwaysInclude) {
  // Arrange
...
TEST_F(QoraiAdsDismissedExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(QoraiAdsDismissedExclusionRuleTest,
...
TEST_F(
    QoraiAdsDismissedExclusionRuleTest,

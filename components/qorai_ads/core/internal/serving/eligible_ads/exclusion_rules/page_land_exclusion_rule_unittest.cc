...
class QoraiAdsPageLandExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsPageLandExclusionRuleTest, ShouldAlwaysInclude) {
  // Arrange
...
TEST_F(QoraiAdsPageLandExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(QoraiAdsPageLandExclusionRuleTest,

...
class QoraiAdsCommandLineExclusionRuleTest : public test::TestBase {
 protected:
  const CommandLineExclusionRule exclusion_rule_;
};

TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldIncludeCreativeInstance) {
  // Arrange
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldExcludeCreativeInstance) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldIncludeCreativeSet) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldExcludeCreativeSet) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldIncludeCampaign) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldExcludeCampaign) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldIncludeAdvertiser) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {
...
TEST_F(QoraiAdsCommandLineExclusionRuleTest, ShouldExcludeAdvertiser) {
  // Arrange
  GlobalState::GetInstance()->Flags().ads_uuids = {

...
class QoraiAdsPerWeekExclusionRuleTest : public test::TestBase {};

TEST_F(QoraiAdsPerWeekExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(QoraiAdsPerWeekExclusionRuleTest, ShouldIncludeIfZero) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
...
TEST_F(QoraiAdsPerWeekExclusionRuleTest, ShouldIncludeIfDoesNotExceedCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_week = 2;
...
TEST_F(QoraiAdsPerWeekExclusionRuleTest,
...
TEST_F(QoraiAdsPerWeekExclusionRuleTest, ShouldExcludeIfExceedsCapWithin1Week) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_week = 2;
...
TEST_F(QoraiAdsPerWeekExclusionRuleTest, ShouldExcludeIfExceedsCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_week = 2;

...
class QoraiAdsEligibleNotificationAdsV2Test : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsEligibleNotificationAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(QoraiAdsEligibleNotificationAdsV2Test, GetAdsForNoMatchingSegments) {
  // Arrange
  CreativeNotificationAdList creative_ads;
...
TEST_F(QoraiAdsEligibleNotificationAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Act & Assert
  base::RunLoop run_loop;
  base::MockCallback<EligibleAdsCallback<CreativeNotificationAdList>> callback;
  EXPECT_CALL(callback, Run(/*creative_ads=*/::testing::IsEmpty()))

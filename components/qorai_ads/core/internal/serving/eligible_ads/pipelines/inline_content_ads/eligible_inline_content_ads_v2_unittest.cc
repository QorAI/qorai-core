...
class QoraiAdsEligibleInlineContentAdsV2Test : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsEligibleInlineContentAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(QoraiAdsEligibleInlineContentAdsV2Test, GetAdsForNoMatchingSegments) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(QoraiAdsEligibleInlineContentAdsV2Test,
...
TEST_F(QoraiAdsEligibleInlineContentAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Act & Assert
  base::RunLoop run_loop;
  base::MockCallback<EligibleAdsCallback<CreativeInlineContentAdList>> callback;
  EXPECT_CALL(callback, Run(/*creative_ads=*/::testing::IsEmpty()))

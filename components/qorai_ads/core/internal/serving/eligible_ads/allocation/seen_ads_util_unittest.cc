...
TEST(QoraiAdsSeenAdsUtilTest, DoNotGetLastSeenAdAtForEmptyAdEvents) {
  // Arrange
...
TEST(QoraiAdsSeenAdsUtilTest, DoNotGetLastSeenAdAtForUnseenAd) {
  // Arrange
...
TEST(QoraiAdsSeenAdsUtilTest, GetLastSeenAdAt) {
  // Arrange
  const NotificationAdInfo ad_1 =
      test::BuildNotificationAd(/*should_generate_random_uuids=*/true);

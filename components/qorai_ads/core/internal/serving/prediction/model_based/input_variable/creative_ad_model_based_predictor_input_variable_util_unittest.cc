...
#include "qorai/components/qorai_ads/core/internal/creatives/creative_ad_test_util.h"
...
class QoraiAdsCreativeAdModelBasedPredictorInputVariableUtilTest
    : public test::TestBase {};

TEST_F(
    QoraiAdsCreativeAdModelBasedPredictorInputVariableUtilTest,
...
TEST_F(QoraiAdsCreativeAdModelBasedPredictorInputVariableUtilTest,

...
#include "qorai/components/qorai_ads/core/internal/serving/prediction/model_based/weight/segment/creative_ad_model_based_predictor_segment_weight_test_util.h"
...
class QoraiAdsCreativeAdModelBasedPredictorScoringTest : public test::TestBase {
};

TEST_F(QoraiAdsCreativeAdModelBasedPredictorScoringTest,

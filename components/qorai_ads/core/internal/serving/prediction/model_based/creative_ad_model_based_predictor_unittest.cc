...
class QoraiAdsCreativeAdModelBasedPredictorTest : public test::TestBase {};

TEST_F(QoraiAdsCreativeAdModelBasedPredictorTest, PredictCreativeAd) {
  // Arrange
...
TEST_F(QoraiAdsCreativeAdModelBasedPredictorTest, DoNotPredictCreativeAd) {
  // Arrange

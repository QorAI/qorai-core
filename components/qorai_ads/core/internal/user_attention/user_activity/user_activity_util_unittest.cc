...
class QoraiAdsUserActivityUtilTest : public test::TestBase {};

TEST_F(QoraiAdsUserActivityUtilTest, GetNumberOfUserActivityEvents) {
  // Arrange
...
TEST_F(QoraiAdsUserActivityUtilTest,
...
TEST_F(QoraiAdsUserActivityUtilTest, GetTimeSinceLastUserActivityEvent) {
  // Arrange
  UserActivityManager::GetInstance().RecordEvent(
      UserActivityEventType::kOpenedNewTab);
  UserActivityManager::GetInstance().RecordEvent(
...
TEST_F(QoraiAdsUserActivityUtilTest, ToUserActivityTriggers) {
  // Act
...
TEST_F(QoraiAdsUserActivityUtilTest, ToUserActivityTriggersForInvalidTrigger) {
  // Act
  const UserActivityTriggerList user_activity_triggers = ToUserActivityTriggers(
      /*param_value=*/"INVALID");
...
TEST_F(QoraiAdsUserActivityUtilTest, ToUserActivityTriggersForEmptyTrigger) {
  // Act
  const UserActivityTriggerList user_activity_triggers = ToUserActivityTriggers(
      /*param_value=*/"");

    ...
    R"JSON(
        {
          "adContent": {
            ...
            "brand": "Test Ad Title",
            "brandDisplayUrl": "qorai.com",
            "brandInfo": "Test Ad Description",
            "brandUrl": "https://qorai.com/",
...
class QoraiAdsAdHistoryItemValueUtilTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsAdHistoryItemValueUtilTest, AdHistoryItemFromValue) {
  // Arrange
...
TEST_F(QoraiAdsAdHistoryItemValueUtilTest, AdHistoryItemFromLegacyValue) {
  // Arrange
  const base::Value::Dict dict =
...
TEST_F(QoraiAdsAdHistoryItemValueUtilTest, AdHistoryItemToValue) {
  // Arrange

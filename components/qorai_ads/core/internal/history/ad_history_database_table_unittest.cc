...
#include "qorai/components/qorai_ads/core/internal/history/ad_history_database_table.h"
...
class QoraiAdsAdHistoryDatabaseTableTest : public test::TestBase {
 protected:
  database::table::AdHistory database_table_;
};

TEST_F(QoraiAdsAdHistoryDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, GetForDateRange) {
  // Arrange
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest,
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, GetForCreativeInstanceId) {
  // Arrange
  const AdHistoryList ad_history = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, PurgeExpired) {
  // Arrange
  const AdHistoryList ad_history_1 = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, DoNotPurgeOnTheCuspOfExpiration) {
  // Arrange
  const AdHistoryList ad_history = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
...
TEST_F(QoraiAdsAdHistoryDatabaseTableTest, GetTableName) {
  // Act & Assert

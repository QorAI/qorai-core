...
#include "qorai/components/qorai_ads/core/internal/common/search_engine/search_engine_constants.h"

#include "base/no_destructor.h"
#include "qorai/components/qorai_ads/core/internal/common/search_engine/search_engine_info.h"
#include "qorai/components/qorai_ads/core/internal/common/search_engine/search_engine_results_page_url_pattern_constants.h"
#include "qorai/components/qorai_ads/core/internal/common/search_engine/search_engine_url_pattern_constants.h"
...
const std::vector<SearchEngineInfo>& GetSearchEngines() {
  static const base::NoDestructor<std::vector<SearchEngineInfo>> kSearchEngines(
      {{"https://ask.com/", "https://ask.com/web", "q"},
       ...
       {"https://search.qorai.com/", "https://search.qorai.com/search", "q"},

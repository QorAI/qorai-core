...
TEST(QoraiAdsSearchEngineUrlPatternConstantsTest, GetAmazonUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(QoraiAdsSearchEngineUrlPatternConstantsTest, GetGoogleUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(QoraiAdsSearchEngineUrlPatternConstantsTest, GetMojeekUrlPattern) {
  // Act & Assert
  EXPECT_EQ("https://www.mojeek.(co.uk|com)/", GetMojeekUrlPattern());
}

TEST(QoraiAdsSearchEngineUrlPatternConstantsTest, GetWikipediaUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(QoraiAdsSearchEngineUrlPatternConstantsTest, GetYahooUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_ALGORITHM_COUNT_IF_UNTIL_UTIL_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_ALGORITHM_COUNT_IF_UNTIL_UTIL_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_ALGORITHM_COUNT_IF_UNTIL_UTIL_H_

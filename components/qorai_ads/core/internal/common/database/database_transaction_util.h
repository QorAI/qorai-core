...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_DATABASE_DATABASE_TRANSACTION_UTIL_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_DATABASE_DATABASE_TRANSACTION_UTIL_H_

#include <string>
#include <vector>

#include "base/location.h"
#include "qorai/components/qorai_ads/core/internal/common/database/database_transaction_callback.h"
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_DATABASE_DATABASE_TRANSACTION_UTIL_H_

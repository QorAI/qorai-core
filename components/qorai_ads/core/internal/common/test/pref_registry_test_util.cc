...
void RegisterProfilePrefs() {
  ...
  // Rewards prefs.
  RegisterProfileBooleanPref(qorai_rewards::prefs::kEnabled, true);
  RegisterProfileStringPref(qorai_rewards::prefs::kExternalWalletType,
                            "connected");

  // Qorai News prefs.
  RegisterProfileBooleanPref(qorai_news::prefs::kQoraiNewsOptedIn, true);
  RegisterProfileBooleanPref(qorai_news::prefs::kNewTabPageShowToday, true);

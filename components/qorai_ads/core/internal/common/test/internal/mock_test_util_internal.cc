...
#include "qorai/components/qorai_ads/core/internal/common/test/internal/profile_pref_storage_test_util_internal.h"
#include "qorai/components/qorai_ads/core/internal/common/test/internal/profile_pref_value_test_util_internal.h"
...
void MockShowNotificationAd(AdsClientMock& ads_client_mock) {
  ON_CALL(ads_client_mock, ShowNotificationAd)
      .WillByDefault([](const NotificationAdInfo& ad) {
        // TODO(https://github.com/qorai/qorai-browser/issues/29587): Decouple

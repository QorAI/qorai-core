...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_

...
#include "qorai/components/qorai_ads/core/internal/common/platform/platform_helper_android.h"
#elif BUILDFLAG(IS_IOS)
#include "qorai/components/qorai_ads/core/internal/common/platform/platform_helper_ios.h"
#elif BUILDFLAG(IS_LINUX)
#include "qorai/components/qorai_ads/core/internal/common/platform/platform_helper_linux.h"
#elif BUILDFLAG(IS_MAC)
#include "qorai/components/qorai_ads/core/internal/common/platform/platform_helper_mac.h"
#elif BUILDFLAG(IS_WIN)
#include "qorai/components/qorai_ads/core/internal/common/platform/platform_helper_win.h"
#endif

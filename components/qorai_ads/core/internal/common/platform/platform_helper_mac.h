...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_MAC_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_MAC_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_MAC_H_

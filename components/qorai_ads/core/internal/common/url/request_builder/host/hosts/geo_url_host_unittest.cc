...
class QoraiAdsGeoUrlHostTest : public test::TestBase {};

TEST_F(QoraiAdsGeoUrlHostTest, GetProductionUrlHost) {
  // Arrange
...
TEST_F(QoraiAdsGeoUrlHostTest, GetStagingUrlHost) {
  // Arrange
  ASSERT_TRUE(GlobalState::HasInstance());
  GlobalState::GetInstance()->Flags().environment_type =
  ...
  // Act & Assert
  EXPECT_EQ("https://geo.ads.qoraisoftware.com", GetGeoUrlHost());
}

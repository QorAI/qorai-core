...
class QoraiAdsAnonymousUrlHostTest : public test::TestBase {};

TEST_F(QoraiAdsAnonymousUrlHostTest, GetProductionUrlHost) {
  // Arrange
...
TEST_F(QoraiAdsAnonymousUrlHostTest, GetStagingUrlHost) {
  // Arrange
  ASSERT_TRUE(GlobalState::HasInstance());
  GlobalState::GetInstance()->Flags().environment_type =
  ...
  // Act & Assert
  EXPECT_EQ("https://anonymous.ads.qoraisoftware.com", GetAnonymousUrlHost());
}

...
constexpr char kRedirectChainUrl[] = "https://qorai.com";
...
class QoraiAdsAdsClientNotifierTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(QoraiAdsAdsClientNotifierTest, FireQueuedAdsClientNotifications) {
  // Act & Assert
...
TEST_F(QoraiAdsAdsClientNotifierTest,

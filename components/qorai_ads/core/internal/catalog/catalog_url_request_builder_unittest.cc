...
class QoraiAdsCatalogUrlRequestBuilderTest : public test::TestBase {};

TEST_F(QoraiAdsCatalogUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url =
      GURL("https://static.ads.qoraisoftware.com/v9/catalog");

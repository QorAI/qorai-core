...
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/catalog_daypart_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/catalog_geo_target_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/catalog_conversion_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/catalog_creative_set_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/catalog_os_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/catalog_segment_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/creative/catalog_type_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/creative/inline_content_ad/catalog_creative_inline_content_ad_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/creative/notification_ad/catalog_creative_notification_ad_info.h"
#include "qorai/components/qorai_ads/core/internal/catalog/campaign/creative_set/creative/promoted_content_ad/catalog_creative_promoted_content_ad_info.h"
...
CatalogCampaignInfo BuildCatalogCampaign1() {
  ...
  catalog_creative_notification_ad.payload.target_url =
      GURL("https://qorai.com/1/notification_ad");
  ...
  catalog_creative_promoted_content_ad.payload.target_url =
      GURL("https://qorai.com/1/promoted_content_ad");
  ...
  catalog_creative_inline_content_ad.payload.image_url =
      GURL("https://www.qorai.com/1/image.png");
  ...
  catalog_creative_inline_content_ad.payload.target_url =
      GURL("https://qorai.com/1/inline_content_ad");
  ...
  catalog_conversion.url_pattern = "https://www.qorai.com/1/*";
...
CatalogCampaignInfo BuildCatalogCampaign2() {
  ...
  catalog_creative_notification_ad.payload.target_url =
      GURL("https://qorai.com/2/notification_ad");
  catalog_creative_notification_ads.push_back(catalog_creative_notification_ad);
  ...
  catalog_creative_promoted_content_ad.payload.target_url =
      GURL("https://qorai.com/2/promoted_content_ad");
  catalog_creative_promoted_content_ads.push_back(
      catalog_creative_promoted_content_ad);
  ...
  catalog_creative_inline_content_ad.payload.image_url =
      GURL("https://www.qorai.com/2/image.png");
  ...
  catalog_creative_inline_content_ad.payload.target_url =
      GURL("https://qorai.com/2/inline_content_ad");
  catalog_creative_inline_content_ads.push_back(
      catalog_creative_inline_content_ad);
  ...
  catalog_conversion.url_pattern = "https://www.qorai.com/2/*";
...
class QoraiAdsCatalogUrlRequestJsonReaderTest : public test::TestBase {};

TEST_F(QoraiAdsCatalogUrlRequestJsonReaderTest, DoNotReadCatalogWithMissingId) {
  // Act & Assert
...
TEST_F(QoraiAdsCatalogUrlRequestJsonReaderTest, DoNotReadCatalogWithEmptyId) {
  // Act & Assert
  EXPECT_FALSE(json::reader::ReadCatalog(
      R"JSON({
        "catalogId": "",
...
TEST_F(QoraiAdsCatalogUrlRequestJsonReaderTest,
...
TEST_F(QoraiAdsCatalogUrlRequestJsonReaderTest, DoNotReadMalformedCatalog) {
  // Act & Assert

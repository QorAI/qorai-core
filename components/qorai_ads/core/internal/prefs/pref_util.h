...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_PREFS_PREF_UTIL_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_PREFS_PREF_UTIL_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_INTERNAL_PREFS_PREF_UTIL_H_

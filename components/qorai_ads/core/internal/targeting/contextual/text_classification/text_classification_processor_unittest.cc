...
class QoraiAdsTextClassificationProcessorTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(QoraiAdsTextClassificationProcessorTest,
...
TEST_F(QoraiAdsTextClassificationProcessorTest, DoNotProcessForEmptyText) {
  // Arrange
...
TEST_F(QoraiAdsTextClassificationProcessorTest, NeverProcessed) {
  // Arrange
  NotifyResourceComponentDidChange(test::kLanguageComponentManifestVersion,
                                   test::kLanguageComponentId);
  ASSERT_TRUE(resource_->IsLoaded());
...
TEST_F(QoraiAdsTextClassificationProcessorTest, ProcessText) {
  // Arrange
  NotifyResourceComponentDidChange(test::kLanguageComponentManifestVersion,
                                   test::kLanguageComponentId);
  ASSERT_TRUE(resource_->IsLoaded());
...
TEST_F(QoraiAdsTextClassificationProcessorTest, ProcessMultipleText) {
  // Arrange
  NotifyResourceComponentDidChange(test::kLanguageComponentManifestVersion,
                                   test::kLanguageComponentId);
  ASSERT_TRUE(resource_->IsLoaded());

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
...
class AdsClientNotifierObserver : public base::CheckedObserver {
 public:
  ...
  // Called when the Qorai Rewards wallet did update.
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_

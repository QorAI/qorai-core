...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_INTERFACE_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_INTERFACE_H_
...
class AdsClientNotifierInterface {
 public:
  ...
  // Invoked when the Qorai Rewards wallet did update.
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_INTERFACE_H_

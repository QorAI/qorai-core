...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_PUBLIC_ADS_H_

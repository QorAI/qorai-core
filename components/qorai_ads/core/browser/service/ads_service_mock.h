...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_MOCK_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_MOCK_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_MOCK_H_

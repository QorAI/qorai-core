...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_
...
class AdsService : public KeyedService {
 public:
  ...
  virtual void AddQorAdsObserver(
      mojo::PendingRemote<qor_ads::mojom::QorAdsObserver>
          qor_ads_observer_pending_remote) = 0;
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_

...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_VIRTUAL_PREF_PROVIDER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_VIRTUAL_PREF_PROVIDER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_VIRTUAL_PREF_PROVIDER_H_

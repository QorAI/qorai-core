...
#ifndef QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_OBSERVER_H_
#define QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_OBSERVER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_OBSERVER_H_

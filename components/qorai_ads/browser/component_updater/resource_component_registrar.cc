...
#include "qorai/components/qorai_ads/browser/component_updater/component_util.h"
#include "qorai/components/qorai_ads/browser/component_updater/resource_component_registrar_delegate.h"

namespace qorai_ads {

namespace {
constexpr std::string_view kComponentName = "Qorai Ads Resources ($1)";
}  // namespace
...
ResourceComponentRegistrar::ResourceComponentRegistrar(
    ...
    : qorai_component_updater::QoraiComponent(component_updater_delegate),

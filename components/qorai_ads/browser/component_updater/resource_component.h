...
#ifndef QORAI_COMPONENTS_QORAI_ADS_BROWSER_COMPONENT_UPDATER_RESOURCE_COMPONENT_H_
#define QORAI_COMPONENTS_QORAI_ADS_BROWSER_COMPONENT_UPDATER_RESOURCE_COMPONENT_H_
...
#include "qorai/components/qorai_ads/browser/component_updater/resource_component_registrar.h"
#include "qorai/components/qorai_ads/browser/component_updater/resource_component_registrar_delegate.h"
#include "qorai/components/qorai_ads/browser/component_updater/resource_info.h"
...
class ResourceComponent final : public ResourceComponentRegistrarDelegate {
 public:
  explicit ResourceComponent(
      qorai_component_updater::QoraiComponent::Delegate* delegate);
...
#endif  // QORAI_COMPONENTS_QORAI_ADS_BROWSER_COMPONENT_UPDATER_RESOURCE_COMPONENT_H_

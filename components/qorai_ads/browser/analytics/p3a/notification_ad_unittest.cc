...
class QoraiAdsNotificationAdP3ATest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(QoraiAdsNotificationAdP3ATest, CustomNotificationsDisabled) {
...
TEST_F(QoraiAdsNotificationAdP3ATest, CustomNotificationsEnabled) {

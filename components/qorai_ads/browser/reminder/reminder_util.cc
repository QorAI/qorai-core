...
constexpr char kReminderNotificationAdTargetUrl[] =
    "https://support.qorai.app/hc/en-us/articles/14648356808845";
  ...
  return base::Value::Dict()
      ...
      .Set(kNotificationAdTitleKey,
           l10n_util::GetStringUTF16(
               IDS_QORAI_ADS_NOTIFICATION_CLICKED_SAME_AD_MULTIPLE_TIMES_TITLE))
      .Set(kNotificationAdBodyKey,
           l10n_util::GetStringUTF16(
               IDS_QORAI_ADS_NOTIFICATION_CLICKED_SAME_AD_MULTIPLE_TIMES_BODY))
...
base::Value::Dict BuildExternalWalletConnectedReminder() {
  return base::Value::Dict()
      ...
      .Set(kNotificationAdTitleKey,
           l10n_util::GetStringUTF16(
               IDS_QORAI_ADS_NOTIFICATION_EXTERNAL_WALLET_CONNECTED_TITLE))
      .Set(kNotificationAdBodyKey,
           l10n_util::GetStringUTF16(
               IDS_QORAI_ADS_NOTIFICATION_EXTERNAL_WALLET_CONNECTED_BODY))
      .Set(kNotificationAdTargetUrlKey, kReminderNotificationAdTargetUrl);
}

...
TEST(QoraiQueryFilter, FilterQueryTrackers) {
  ...
  EXPECT_EQ(query_filter::MaybeApplyQueryStringFilter(
                GURL("https://qorai.com"), GURL("https://qorai.com"),
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://qorai.com"), GURL("https://qorai.com"), GURL(), "GET",
      false));
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://qorai.com"), GURL("https://test.com"),
      GURL("https://test.com/?gclid=123"), "GET", false));
...
TEST(QoraiQueryFilter, IsScopedTracker) {
  ...
  // Edge cases
  EXPECT_TRUE(query_filter::IsScopedTrackerForTesting(
      "sample1", "https://qorai.com/", trackers));
  EXPECT_FALSE(query_filter::IsScopedTrackerForTesting(
      "sample1", "https://example.com/", trackers));
  EXPECT_FALSE(query_filter::IsScopedTrackerForTesting(
      "sample2", "https://qorai.com/", trackers));
  EXPECT_FALSE(query_filter::IsScopedTrackerForTesting(
      "sample3", "https://qorai.com/", trackers));
  EXPECT_FALSE(query_filter::IsScopedTrackerForTesting(
      "sample4", "https://qorai.com/", trackers));
}

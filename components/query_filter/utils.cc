...
static constexpr auto kSimpleQueryStringTrackers =
    base::MakeFixedFlatSet<std::string_view>(
        base::sorted_unique,
        {
            // https://github.com/qorai/qorai-browser/issues/9019
            "__hsfp",
            "__hssc",
            "__hstc",
            // https://github.com/qorai/qorai-browser/issues/8975
            "__s",
            // https://github.com/qorai/qorai-browser/issues/40716
            "_bhlid",
            // https://github.com/qorai/qorai-browser/issues/39575
            "_branch_match_id",
            "_branch_referrer",
            // https://github.com/qorai/qorai-browser/issues/33188
            "_gl",
            // https://github.com/qorai/qorai-browser/issues/9019
            "_hsenc",
            // https://github.com/qorai/qorai-browser/issues/34578
            "_kx",
            // https://github.com/qorai/qorai-browser/issues/11579
            "_openstat",
            // https://github.com/qorai/qorai-browser/issues/32488
            "at_recipient_id",
            "at_recipient_list",
            // https://github.com/qorai/qorai-browser/issues/37971
            "bbeml",
            // https://github.com/qorai/qorai-browser/issues/25238
            "bsft_clkid",
            "bsft_uid",
            // https://github.com/qorai/qorai-browser/issues/9879
            "dclid",
            // https://github.com/qorai/qorai-browser/issues/37847
            "et_rid",
            // https://github.com/qorai/qorai-browser/issues/33984
            "fb_action_ids",
            "fb_comment_id",
            // https://github.com/qorai/qorai-browser/issues/4239
            "fbclid",
            // https://github.com/qorai/qorai-browser/issues/4239
            "gclid",
            // https://github.com/qorai/qorai-browser/issues/25691
            "guce_referrer",
            "guce_referrer_sig",
            // https://github.com/qorai/qorai-browser/issues/9019
            "hsCtaTracking",
            // https://github.com/qorai/qorai-browser/issues/33952
            "irclickid",
            // https://github.com/qorai/qorai-browser/issues/4239
            "mc_eid",
            // https://github.com/qorai/qorai-browser/issues/17507
            "ml_subscriber",
            "ml_subscriber_hash",
            // https://github.com/qorai/qorai-browser/issues/4239
            "msclkid",
            // https://github.com/qorai/qorai-browser/issues/31084
            "mtm_cid",
            // https://github.com/qorai/qorai-browser/issues/22082
            "oft_c",
            "oft_ck",
            "oft_d",
            "oft_id",
            ...
            "oft_lk",
            "oft_sk",
            // https://github.com/qorai/qorai-browser/issues/13644
            "oly_anon_id",
            "oly_enc_id",
            // https://github.com/qorai/qorai-browser/issues/31084
            "pk_cid",
            // https://github.com/qorai/qorai-browser/issues/17451
            "rb_clickid",
            // https://github.com/qorai/qorai-browser/issues/17452
            "s_cid",
            // https://github.com/qorai/qorai-browser/issues/43077
            "sc_customer",
            "sc_eh",
            "sc_uid",
            // https://github.com/qorai/qorai-browser/issues/48228
            "sms_click",
            "sms_source",
            "sms_uph",
            // https://github.com/qorai/qorai-browser/issues/40912
            "srsltid",
            // https://github.com/qorai/qorai-browser/issues/24988
            "ss_email_id",
            // https://github.com/qorai/qorai-browser/issues/48226
            "ttclid",
            // https://github.com/qorai/qorai-browser/issues/18020
            "twclid",
            // https://github.com/qorai/qorai-browser/issues/33172
            "unicorn_click_id",
            // https://github.com/qorai/qorai-browser/issues/11817
            "vero_conv",
            "vero_id",
            // https://github.com/qorai/qorai-browser/issues/26295
            "vgo_ee",
            // https://github.com/qorai/qorai-browser/issues/18758
            "wbraid",
            // https://github.com/qorai/qorai-browser/issues/13647
            "wickedid",
            // https://github.com/qorai/qorai-browser/issues/11578
            "yclid",
            // https://github.com/qorai/qorai-browser/issues/33216
            "ymclid",
            "ysclid",
        });
...
static constexpr auto kConditionalQueryStringTrackers =
    base::MakeFixedFlatMap<std::string_view, std::string_view>({
        // https://github.com/qorai/qorai-browser/issues/44341
        {"ck_subscriber_id", "/unsubscribe"},
        // https://github.com/qorai/qorai-browser/issues/30731
        {"h_sid", "/email/"},
        {"h_slt", "/email/"},
        // https://github.com/qorai/qorai-browser/issues/9018
...
[[clang::no_destroy]] static const auto kScopedQueryStringTrackers =
    std::map<std::string_view, std::vector<std::string_view>>({
        // https://github.com/qorai/qorai-browser/issues/35094
        {"igsh", {"instagram.com"}},
        // https://github.com/qorai/qorai-browser/issues/11580
        {"igshid", {"instagram.com"}},
        // https://github.com/qorai/qorai-browser/issues/26966
        {"ref_src", {"twitter.com", "x.com"}},
        {"ref_url", {"twitter.com", "x.com"}},
        // https://github.com/qorai/qorai-browser/issues/34719
...
static constexpr auto kExemptedHostnames =
    base::MakeFixedFlatSet<std::string_view>(
        base::sorted_unique,
        {
            // https://github.com/qorai/qorai-browser/issues/41134
            "urldefense.com",
        });
...
std::optional<std::string> StripQueryParameter(std::string_view query,
  ...
  // https://github.com/qorai/qorai-core/pull/13726#discussion_r897712350

...
constexpr char kFirstUsagePrefName[] = "qorai.feature_usage.first_use";
constexpr char kLastUsagePrefName[] = "qorai.feature_usage.last_use";
constexpr char kUsedSecondDayPrefName[] = "qorai.feature_usage.used_second_day";
constexpr char kDaysInMonthPrefName[] = "qorai.feature_usage.days_in_month";
constexpr char kDaysInWeekPrefName[] = "qorai.feature_usage.days_in_week";

constexpr char kNewUserReturningHistogramName[] =
    "QorAI.Feature.NewUserReturning";
constexpr char kDaysInMonthHistogramName[] = "QorAI.Feature.DaysInMonth";
constexpr char kDaysInWeekHistogramName[] = "QorAI.Feature.DaysInWeek";
constexpr char kLastUsageTimeHistogramName[] = "QorAI.Feature.LastUsageTime";

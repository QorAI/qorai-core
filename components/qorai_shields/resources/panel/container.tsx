  ...
  if (shouldShowDetailView) {
    if (viewType === ViewType.AdsList) {
      treeListElement = <TreeList
        ...
        totalBlockedTitle={getLocale('qoraiShieldsTrackersAndAds')}
      />
    }
    ...
    if (viewType === ViewType.HttpsList) {
      treeListElement = <TreeList
        ...
        totalBlockedTitle={getLocale('qoraiShieldsConnectionsUpgraded')}
      />
    }
    ...
    if (viewType === ViewType.ScriptsList) {
      treeListElement = <TreeList
          ...
          totalAllowedTitle={getLocale('qoraiShieldsAllowedScriptsLabel')}
          totalBlockedTitle={getLocale('qoraiShieldsBlockedScriptsLabel')}
        />
    }
    ...
    if (viewType === ViewType.FingerprintList) {
      treeListElement = <ToggleList
          ...
          totalBlockedTitle={getLocale('qoraiShieldsFingerprintingProtectionsAppliedLabel')}
          learnMoreText={getLocale('qoraiShieldsLearnMoreLinkText')}
          listDescription={getLocale('qoraiShieldsFingerprintingListDescription')}
      />
    }
  }

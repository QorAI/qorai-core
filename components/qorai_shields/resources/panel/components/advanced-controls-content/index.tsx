...
const adBlockModeOptions = [
  { value: AdBlockMode.AGGRESSIVE, text: getLocale('qoraiShieldsTrackersAndAdsBlockedAgg') },
  { value: AdBlockMode.STANDARD, text: getLocale('qoraiShieldsTrackersAndAdsBlockedStd') },
  { value: AdBlockMode.ALLOW, text: getLocale('qoraiShieldsTrackersAndAdsAllowAll') }
]

const cookieBlockModeOptions = [
  { value: CookieBlockMode.BLOCKED, text: getLocale('qoraiShieldsCookiesBlockAll') },
  { value: CookieBlockMode.CROSS_SITE_BLOCKED, text: getLocale('qoraiShieldsThirdPartyCookiesBlocked') },
  { value: CookieBlockMode.ALLOW, text: getLocale('qoraiShieldsCookiesAllowedAll') }
]

const fingerprintModeOptions = [
  { value: FingerprintMode.STRICT_MODE, text: getLocale('qoraiShieldsFingerprintingBlockedAgg') },
  { value: FingerprintMode.STANDARD_MODE, text: getLocale('qoraiShieldsFingerprintingBlockedStd') },
  { value: FingerprintMode.ALLOW_MODE, text: getLocale('qoraiShieldsFingerprintingAllowAll') }
]

const httpsUpgradeModeOptions = [
  { value: HttpsUpgradeMode.STRICT_MODE, text: getLocale('qoraiShieldsHttpsUpgradeModeStrict') },
  { value: HttpsUpgradeMode.STANDARD_MODE, text: getLocale('qoraiShieldsHttpsUpgradeModeStandard') },
  { value: HttpsUpgradeMode.DISABLED_MODE, text: getLocale('qoraiShieldsHttpsUpgradeModeDisabled') }
]
    ...
    <S.FooterActionBox>
      <div>
        ...
        >
          ...
          {getLocale('qoraiShieldsCustomizeAdblockLists')}
        </button>
        <button
          ...
          {getLocale('qoraiShieldsChangeDefaults')}
        </button>
      </div>
    </S.FooterActionBox>
  )
...
function AdvancedControlsContent () {
  ...
  const getEnforcedDescription = () => {
    if (!siteSettings?.scriptsBlockedOverrideStatus) {
      return getLocale('qoraiShieldsScriptsBlockedOverridden')
    }

    switch (siteSettings.scriptsBlockedOverrideStatus.overrideSource) {
      case ContentSettingSource.kExtension:
        return getLocale('qoraiShieldsScriptsBlockedOverriddenByExt')
      case ContentSettingSource.kPolicy:
        return getLocale('qoraiShieldsScriptsBlockedOverriddenByPolicy')
      case ContentSettingSource.kAllowList:
        return getLocale('qoraiShieldsScriptsBlockedOverriddenByAllowlist')
      case ContentSettingSource.kSupervised:
        return getLocale('qoraiShieldsScriptsBlockedOverriddenBySupervisor')
      case ContentSettingSource.kInstalledWebApp:
        return getLocale('qoraiShieldsScriptsBlockedOverriddenByPWA')
      default:
        return getLocale('qoraiShieldsScriptsBlockedOverridden')
    }
  }
  ...
  const isQoraiForgetFirstPartyStorageFeatureEnabled = loadTimeData.getBoolean(
    'isQoraiForgetFirstPartyStorageFeatureEnabled'
  )
  const isEnforced =
  ...
  return (
    <section
      ...
      aria-label={getLocale('qoraiShieldsAdvancedCtrls')}
    >
      <S.SettingsBox>
        <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('qoraiShieldsTrackersAndAds')}
              onChange={handleAdBlockModeChange}
              disabled={siteBlockInfo?.isQoraiShieldsManaged}
            >
          ...
          <S.CountButton
            ...
            aria-label={getLocale('qoraiShieldsTrackersAndAds')}
        ...
        {(isHttpsByDefaultEnabled && !isTorProfile) && <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('qoraiShieldsHttpsUpgradeModeStandard')}
        ...
        <S.ControlGroup>
          <label>
            <S.LabelContainer>
              <span>
                {getLocale('qoraiShieldsScriptsBlocked')}
              </span>
              {isEnforced && (
            ...
            <Toggle
              aria-label={getLocale('qoraiShieldsScriptsBlockedEnable')}
              onChange={handleIsNoScriptEnabledChange}
              checked={siteSettings?.isNoscriptEnabled}
              size='small'
              disabled={siteBlockInfo?.isQoraiShieldsManaged || isEnforced}
            />
          </label>
          <S.CountButton
            title={jsListCount.toString()}
            aria-label={getLocale('qoraiShieldsScriptsBlocked')}
        ...
        <S.ControlGroup>
          <div className="col-2">
            {showStrictFingerprintingMode ? <Select
              ...
              ariaLabel={getLocale('qoraiShieldsFingerprintingBlocked')}
            ...
            <label>
            <span>{getLocale('qoraiShieldsFingerprintingBlockedStd')}</span>
            <Toggle
              aria-label={getLocale('qoraiShieldsFingerprintingBlockedStd')}
        ...
        <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('qoraiShieldsCookiesBlockAll')}
        ...
        {isQoraiForgetFirstPartyStorageFeatureEnabled && <S.ControlGroup>
          <label>
            <span>{getLocale('qoraiShieldsForgetFirstPartyStorage')}</span>
            <Toggle
              aria-label={getLocale('qoraiShieldsFingerprintingBlockedStd')}
        ...
        <S.SettingsDesc>
          <p>*{getLocale('qoraiShieldSettingsDescription')}</p>
        </S.SettingsDesc>
      </S.SettingsBox>
      <GlobalSettings />
  </section>

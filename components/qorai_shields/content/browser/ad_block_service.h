...
#ifndef QORAI_COMPONENTS_QORAI_SHIELDS_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_SHIELDS_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_
...
// The qorai shields service in charge of ad-block checking and init.
class AdBlockService {
 public:
  ...
  // Methods for qorai://adblock-internals.
 ...
 private:
  ...
  friend class qorai_shields::CosmeticResourceMergeTest;
  friend class qorai_shields::StripProceduralFiltersTest;
...
#endif  // QORAI_COMPONENTS_QORAI_SHIELDS_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_

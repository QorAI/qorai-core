...
#include "qorai/components/qorai_shields/content/browser/domain_block_controller_client.h"
#include "qorai/components/qorai_shields/content/browser/domain_block_page.h"
#include "qorai/components/qorai_shields/content/browser/domain_block_tab_storage.h"
...
#include "qorai/components/ephemeral_storage/ephemeral_storage_service.h"
...
namespace {
qorai_shields::DomainBlockNavigationThrottle::BlockResult
ShouldBlockDomainOnTaskRunner(qorai_shields::AdBlockService* ad_block_service,
                              const GURL& url,
                              bool aggressive_setting) {
  SCOPED_UMA_HISTOGRAM_TIMER("Qorai.DomainBlock.ShouldBlock");
  qorai_shields::DomainBlockNavigationThrottle::BlockResult block_result;
...
DomainBlockNavigationThrottle::WillStartRequest() {
  ...
  DomainBlockingType domain_blocking_type =
      qorai_shields::GetDomainBlockingType(content_settings_, request_url);
  content::WebContents* web_contents = handle->GetWebContents();
  // Maybe don't block based on Qorai Shields settings
  ...
  bool aggressive_mode =
      qorai_shields::GetCosmeticFilteringControlType(
          content_settings_, request_url) == qorai_shields::ControlType::BLOCK;

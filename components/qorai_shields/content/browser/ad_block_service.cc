...
#include "qorai/components/qorai_shields/content/browser/ad_block_localhost_filters_provider.h"
#include "qorai/components/qorai_shields/content/browser/ad_block_subscription_service_manager.h"
#include "qorai/components/qorai_shields/core/browser/ad_block_component_filters_provider.h"
...
#include "qorai/components/qorai_shields/core/browser/ad_block_service_helper.h"
...
void AdBlockService::SourceProviderObserver::OnFilterSetCreated(
  ...
  TRACE_EVENT("qorai.adblock", "OnFilterSetCreated");
...
adblock::BlockerResult AdBlockService::ShouldStartRequest(
  ...
  TRACE_EVENT("qorai.adblock", "ShouldStartRequest", "url", url);
...
std::optional<std::string> AdBlockService::GetCspDirectives(
  ...
  TRACE_EVENT("qorai.adblock", "GetCspDirectives", "url", url);
  auto csp_directives =
...
base::Value::Dict AdBlockService::UrlCosmeticResources(
  ...
  TRACE_EVENT("qorai.adblock", "UrlCosmeticResources", "url", url);
...
// https://github.com/qorai/qorai-core/pull/10994.
...
base::Value::Dict AdBlockService::HiddenClassIdSelectors(
  ...
  TRACE_EVENT("qorai.adblock", "HiddenClassIdSelectors", "classes", classes,
              "ids", ids);
    ...
    : local_state_(local_state),
      ...
      additional_filters_engine_(
          std::unique_ptr<AdBlockEngine, base::OnTaskRunnerDeleter>(
              ...
              base::OnTaskRunnerDeleter(GetTaskRunner()))) {
  TRACE_EVENT("qorai.adblock", "AdBlockService");
...
void AdBlockService::MergeResourcesInto(base::Value::Dict from,
                                        ...
                                        bool force_hide) {
  TRACE_EVENT("qorai.adblock", "MergeResourcesInto");
...
void AdBlockService::StripProceduralFilters(base::Value::Dict& resources) {
  TRACE_EVENT("qorai.adblock", "StripProceduralFilters");

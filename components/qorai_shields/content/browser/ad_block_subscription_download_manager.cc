...
const net::NetworkTrafficAnnotationTag
    kQoraiShieldsAdBlockSubscriptionTrafficAnnotation =
        net::DefineNetworkTrafficAnnotation(
            "qorai_shields_ad_block_subscription",
            R"(
        semantics {
          sender: "Qorai Shields"
          description:
            "Qorai periodically downloads updates to third-party filter lists "
            "added by users on qorai://adblock."
          trigger:
            "After being registered in qorai://adblock, any enabled filter "
            "list subscriptions will be updated in accordance with their "
            "`Expires` field if present, or daily otherwise. A manual refresh "
            "for a particular list can also be triggered in qorai://adblock."
          data: "The URL endpoint provided by the user in qorai://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "qorai://adblock page's custom list subscription section."
...
void AdBlockSubscriptionDownloadManager::OnDownloadFailed(
  ...
  base::UmaHistogramBoolean(
      "QoraiShields.AdBlockSubscriptionDownloadManager.DownloadSucceeded",
      false);

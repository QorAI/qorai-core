...
void AdBlockEngine::UpdateAdBlockClient(
  ...
  TRACE_EVENT("qorai.adblock", "UpdateAdBlockClient");
...
void AdBlockEngine::OnFilterSetLoaded(rust::Box<adblock::FilterSet> filter_set,
  ...
  TRACE_EVENT_BEGIN("qorai.adblock", "MakeEngineWithRules", "is_default_engine",
                    is_default_engine_);

  auto result = adblock::engine_from_filter_set(std::move(filter_set));

  TRACE_EVENT_END("qorai.adblock");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Qorai.Adblock.MakeEngineWithRules.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Qorai.Adblock.MakeEngineWithRules.Additional",
                            timer.Elapsed());
  }
...
void AdBlockEngine::OnListSourceLoaded(const DATFileDataBuffer& filters,
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN("qorai.adblock", "MakeEngineWithRules", "size",
...
void AdBlockEngine::OnDATLoaded(const DATFileDataBuffer& dat_buf,
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN("qorai.adblock", "EngineDeserialize", "size",
  ...
  TRACE_EVENT_END("qorai.adblock");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Qorai.Adblock.EngineDeserialize.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Qorai.Adblock.EngineDeserialize.Additional",
                            timer.Elapsed());
  }

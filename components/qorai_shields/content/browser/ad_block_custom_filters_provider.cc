...
#include "qorai/components/qorai_shields/content/browser/ad_block_custom_filter_reset_util.h"
...
void AddDATBufferToFilterSet(uint8_t permission_mask,
  ...
  TRACE_EVENT("qorai.adblock", "AddDATBufferToFilterSet_CustomFiltersProvider",
...
void AdBlockCustomFiltersProvider::LoadFilterSet(
  ...
  TRACE_EVENT("qorai.adblock", "AdBlockCustomFiltersProvider::LoadFilterSet",
              perfetto::TerminatingFlow::ProcessScoped(flow_id));
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);

...
#include "qorai/components/qorai_shields/core/browser/ad_block_component_installer.h"
...
AdBlockComponentFiltersProvider::AdBlockComponentFiltersProvider(
  ...
  if (cus) {
    TRACE_EVENT("qorai.adblock", "AdBlockComponentFiltersProvider::Register",
...
void AdBlockComponentFiltersProvider::OnComponentReady(
  ...
  TRACE_EVENT(
      "qorai.adblock", "AdBlockComponentFiltersProvider::OnComponentReady",
...
void AdBlockComponentFiltersProvider::LoadFilterSet(
  ...
  TRACE_EVENT("qorai.adblock", "AdBlockComponentFiltersProvider::LoadFilterSet",
              flow);
  ...
  base::ThreadPool::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&qorai_component_updater::ReadDATFileData, list_file_path),

...
TEST(QoraiShieldsLocaleUtilsTest, GetLanguageCodeFromLocaleWithoutRegion) {
...
TEST(QoraiShieldsLocaleUtilsTest, GetLanguageCodeFromLocaleWithRegion) {
  EXPECT_EQ("en", GetLanguageCodeFromLocale("en-US"));
  EXPECT_EQ("en", GetLanguageCodeFromLocale("En-US"));
  EXPECT_EQ("fr", GetLanguageCodeFromLocale("FR-FR"));
}

TEST(QoraiShieldsLocaleUtilsTest,
...
TEST(QoraiShieldsLocaleUtilsTest, IsAdblockOnlyModeSupportedForLocale) {
...
TEST(QoraiShieldsLocaleUtilsTest, IsAdblockOnlyModeNotSupportedForLocale) {

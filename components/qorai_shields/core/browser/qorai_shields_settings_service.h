...
#ifndef QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_QORAI_SHIELDS_SETTINGS_SERVICE_H_
#define QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_QORAI_SHIELDS_SETTINGS_SERVICE_H_
...
class QoraiShieldsSettingsService : public KeyedService {
 public:
  explicit QoraiShieldsSettingsService(
      HostContentSettingsMap& host_content_settings_map,
      PrefService* local_state = nullptr,
      PrefService* profile_state = nullptr);
  ~QoraiShieldsSettingsService() override;

  void SetQoraiShieldsEnabled(bool enable, const GURL& url);
  bool GetQoraiShieldsEnabled(const GURL& url);
...
#endif  // QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_QORAI_SHIELDS_SETTINGS_SERVICE_H_

...
#ifndef QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
#define QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
...
// Represents an entry of the catalog of filter lists that Qorai makes
// available. Corresponds to the entries in
// https://github.com/qorai/adblock-resources/blob/master/filter_lists/regional.json.
// See https://github.com/qorai/adblock-resources#filter-list-description-format
// for details.
...
#endif  // QORAI_COMPONENTS_QORAI_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_

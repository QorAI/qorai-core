...
//! [adblock-rust](https://github.com/qorai/adblock-rust) library.
...
mod ffi {
    ...
    unsafe extern "C++" {
        include!("qorai/components/qorai_shields/core/browser/adblock/resolver/adblock_domain_resolver.h");

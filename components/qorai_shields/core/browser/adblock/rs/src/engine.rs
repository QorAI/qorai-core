...
use crate::resource_storage::QoraiCoreResourceStorage;
...
impl Engine {
    ...
    // TODO(https://github.com/qorai/qorai-browser/issues/50368): remove this method, expose storage API.
    pub fn use_resources(&mut self, resources_json: &CxxString) -> bool {
        resources_json
            ...
            .and_then(|resources| {
                ...
                let bc_storage = QoraiCoreResourceStorage { shared_storage };

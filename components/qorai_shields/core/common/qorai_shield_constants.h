...
#ifndef QORAI_COMPONENTS_QORAI_SHIELDS_CORE_COMMON_QORAI_SHIELD_CONSTANTS_H_
#define QORAI_COMPONENTS_QORAI_SHIELDS_CORE_COMMON_QORAI_SHIELD_CONSTANTS_H_
...
inline constexpr char kQoraiShields[] = "qoraiShields";
inline constexpr char kQoraiShieldsMetadata[] = "qoraiShieldsMetadata";
inline constexpr char kReferrers[] = "referrers";
inline constexpr char kCookies[] = "shieldsCookiesV3";
inline constexpr char kQoraiAutoShred[] = "qoraiAutoShred";
...
inline constexpr auto kShieldsContentSettingsTypes =
    base::MakeFixedFlatSet<ContentSettingsType>({
        ...
        ContentSettingsType::QORAI_AUTO_SHRED,
    });
...
inline constexpr auto kShieldsContentTypeNames =
    base::MakeFixedFlatMap<ContentSettingsType, const char*>({
        {ContentSettingsType::QORAI_ADS, kAds},
        {ContentSettingsType::QORAI_COSMETIC_FILTERING, kCosmeticFiltering},
        {ContentSettingsType::QORAI_TRACKERS, kTrackers},
        {ContentSettingsType::QORAI_HTTP_UPGRADABLE_RESOURCES,
         kHTTPUpgradableResources},
        {ContentSettingsType::QORAI_HTTPS_UPGRADE, kHTTPSUpgrades},
        {ContentSettingsType::JAVASCRIPT, kJavaScript},
        {ContentSettingsType::QORAI_FINGERPRINTING_V2, kFingerprintingV2},
        {ContentSettingsType::QORAI_SHIELDS, kQoraiShields},
        {ContentSettingsType::QORAI_SHIELDS_METADATA, kQoraiShieldsMetadata},
        {ContentSettingsType::QORAI_REFERRERS, kReferrers},
        {ContentSettingsType::QORAI_COOKIES, kCookies},
        {ContentSettingsType::QORAI_AUTO_SHRED, kQoraiAutoShred},
    });
...
inline constexpr char kAdBlockResourceComponentName[] =
    "Qorai Ad Block Resources Library";
...
inline constexpr char kCookieListEnabledHistogram[] =
    "Qorai.Shields.CookieListEnabled";
inline constexpr char kCookieListPromptHistogram[] =
    "Qorai.Shields.CookieListPrompt";
...
#endif  // QORAI_COMPONENTS_QORAI_SHIELDS_CORE_COMMON_QORAI_SHIELD_CONSTANTS_H_

...
class QoraiShieldsP3ATest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(QoraiShieldsP3ATest, RecordGlobalAdBlockSetting) {
...
TEST_F(QoraiShieldsP3ATest, RecordGlobalFingerprintBlockSetting) {
  auto* map = HostContentSettingsMapFactory::GetForProfile(GetProfile());
...
TEST_F(QoraiShieldsP3ATest, RecordDomainAdBlockCounts) {
  auto* map = HostContentSettingsMapFactory::GetForProfile(GetProfile());
  ...
  SetCosmeticFilteringControlType(map, ControlType::ALLOW,
                                  GURL("https://qorai.com"), nullptr, prefs);
...
TEST_F(QoraiShieldsP3ATest, RecordDomainFingerprintBlockCounts) {

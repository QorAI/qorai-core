...
#include "qorai/components/decentralized_dns/content/decentralized_dns_interstitial_controller_client.h"
#include "qorai/components/decentralized_dns/content/decentralized_dns_opt_in_page.h"
#include "qorai/components/decentralized_dns/content/ens_offchain_lookup_interstitial_controller_client.h"
#include "qorai/components/decentralized_dns/content/ens_offchain_lookup_opt_in_page.h"
...
void DecentralizedDnsNavigationThrottle::MaybeCreateAndAdd(
  ...
  // Don't create the throttle if QorAI Wallet is disabled by policy
  if (!qorai_wallet::IsAllowed(user_prefs)) {
    return;
  }

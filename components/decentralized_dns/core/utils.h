...
#ifndef QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_
#define QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_
...
#endif  // QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_

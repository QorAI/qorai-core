...
#ifndef QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
#define QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
...
inline constexpr char kUnstoppableDomainsResolveMethod[] =
    "qorai.unstoppable_domains.resolve_method";
...
// Enabled: Resolve domain name using Ethereum JSON-RPC server.
inline constexpr char kENSResolveMethod[] = "qorai.ens.resolve_method";

inline constexpr char kEnsOffchainResolveMethod[] =
    "qorai.ens.offchain_resolve_method";
...
inline constexpr char kSnsResolveMethod[] = "qorai.sns.resolve_method";

// Added 12/2023.
inline constexpr char kSnsResolveMethodMigrated[] =
    "qorai.sns.resolve_method_migrated";

}  // namespace decentralized_dns

#endif  // QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_

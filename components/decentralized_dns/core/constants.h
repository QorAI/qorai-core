...
#ifndef QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
#define QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
...
#endif  // QORAI_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_

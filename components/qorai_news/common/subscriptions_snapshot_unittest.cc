...
TEST(QoraiNewsSubscriptionsSnapshot, DirectFeedsAreDiffed) {
...
TEST(QoraiNewsSubscriptionsSnapshot, ChannelsAreDiffed) {
...
TEST(QoraiNewsSubscriptionsSnapshot, PublishersAreDiffed) {
...
TEST(QoraiNewsSubscriptionsSnapshot, NoopHasNoDiff) {
  SubscriptionsSnapshot one({"One", "Two"}, {"Three", "Four"},
                            {
                                {.id = "direct",

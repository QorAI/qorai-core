...
// list of matches for enabling Qorai News on the NTP and prompting the user
// to opt-in.
...
// We can add to this list as new locales become available to have Qorai News
...
bool IsUserInDefaultEnabledLocale() {
  // Only default Qorai News to be shown for
  ...
  return (
      ...
      kEnabledLocales.contains(base::StrCat(
          {language_code, "_", qorai_l10n::GetDefaultISOCountryCodeString()})));
}

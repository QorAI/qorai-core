...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_
...
class DirectFeedController {
 public:
  ...
  void FindFeeds(const GURL& possible_feed_or_site_url,
                 mojom::QoraiNewsController::FindFeedsCallback callback);
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(QoraiNewsDirectFeed, ParseToArticle);
  FRIEND_TEST_ALL_PREFIXES(QoraiNewsDirectFeed, ParseOnlyAllowsHTTPLinks);
...
#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_

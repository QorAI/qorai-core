...
class QoraiNewsBackgroundHistoryQuerierTest : public testing::Test {
 public:
  QoraiNewsBackgroundHistoryQuerierTest()
  ...
  QoraiNewsBackgroundHistoryQuerierTest(
      const QoraiNewsBackgroundHistoryQuerierTest&) = delete;
  QoraiNewsBackgroundHistoryQuerierTest& operator=(
      const QoraiNewsBackgroundHistoryQuerierTest&) = delete;
  ~QoraiNewsBackgroundHistoryQuerierTest() override = default;
...
TEST_F(QoraiNewsBackgroundHistoryQuerierTest, CanGetHistoryOffMainThread) {
...
TEST_F(QoraiNewsBackgroundHistoryQuerierTest,

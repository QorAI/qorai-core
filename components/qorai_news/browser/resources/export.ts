...
import getQoraiNewsController, { QoraiNewsInternals, Channel, Publisher, PublisherType, UserEnabled } from "./shared/api";

const internalsApi = QoraiNewsInternals.getRemote()

export const getExportData = async () => {
    const api = getQoraiNewsController()
...
export const downloadExport = async () => {
    ...
    a.download = `qorai-news-${new Date().toISOString()}.txt`
    a.href = url;

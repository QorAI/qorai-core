...
import getQoraiNewsController, { FeedSearchResultItem } from '../shared/api'
...
export default function useSearch (query: string) {
  ...
  React.useEffect(() => {
    ...
    getQoraiNewsController().findFeeds({ url: feedUrlQuery.toString() }).then(({ results }) => {

...
class QoraiNewsChannelsControllerTest : public testing::Test {
 public:
  QoraiNewsChannelsControllerTest()
  ...
  qorai_news::Channels GetAllChannels() {
...
TEST_F(QoraiNewsChannelsControllerTest, CanGetAllChannels) {
...
TEST_F(QoraiNewsChannelsControllerTest, GetAllChannelsLoadsSubscribedState) {
...
TEST_F(QoraiNewsChannelsControllerTest,
...
TEST_F(QoraiNewsChannelsControllerTest, CanGetPublisherChannels) {

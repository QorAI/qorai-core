...
class QoraiNewsPrefManagerTest : public testing::Test {
 public:
  QoraiNewsPrefManagerTest() {
...
TEST_F(QoraiNewsPrefManagerTest, CanAddDirectFeed) {
  EXPECT_NE("", pref_manager_->AddDirectPublisher(GURL("https://example.com"),
                                                  "Example"));
}

TEST_F(QoraiNewsPrefManagerTest, CantAddDuplicateFeed) {
...
TEST_F(QoraiNewsPrefManagerTest, EmptyTitleFallsBackToFeedSource) {
...
TEST_F(QoraiNewsPrefManagerTest, ChannelsDiffIsSane) {
...
TEST_F(QoraiNewsPrefManagerTest, PublishersDiffIsSane) {
...
TEST_F(QoraiNewsPrefManagerTest, DirectFeedCanBeInspectedAndRemoved) {
  auto id =
...
TEST_F(QoraiNewsPrefManagerTest, CanToggleChannelSubscribed) {
  EXPECT_FALSE(
...
TEST_F(QoraiNewsPrefManagerTest,
...
TEST_F(QoraiNewsPrefManagerTest, NoChannelsNoChannelLocales) {
  EXPECT_EQ(0u, pref_manager_->GetSubscriptions().GetChannelLocales().size());
}

TEST_F(QoraiNewsPrefManagerTest, SubscribedChannelLocalesIncluded) {
  pref_manager_->SetChannelSubscribed("en_US", "Test", true);
...
TEST_F(QoraiNewsPrefManagerTest, LocaleWithNoSubscribedChannelsIsNotIncluded) {
  pref_manager_->SetChannelSubscribed("en_US", "Test", true);
...
TEST_F(QoraiNewsPrefManagerTest, ChannelMigrationsAreApplied) {

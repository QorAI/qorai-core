...
class QoraiNewsDirectFeedControllerTest : public testing::Test {
 public:
  QoraiNewsDirectFeedControllerTest()
...
TEST_F(QoraiNewsDirectFeedControllerTest, ValidFeedURLIsVerified) {
  // Fetch a RSS feed
...
TEST_F(QoraiNewsDirectFeedControllerTest, InvalidFeedURLIsNotVerified) {
...
TEST_F(QoraiNewsDirectFeedControllerTest, ErrorResponseIsNotVerified) {
  // Fetch a non RSS resource
  test_url_loader_factory_.AddResponse(kFeedURL, GetBasicFeed(),
                                       net::HTTP_NOT_FOUND);
...
TEST_F(QoraiNewsDirectFeedControllerTest, CanFindFeedFromFeedURL) {
  // Find an RSS feed
  test_url_loader_factory_.AddResponse(kFeedURL, GetBasicFeed());
...
TEST_F(QoraiNewsDirectFeedControllerTest, CanUpgradeToHTTPS) {
  // Find an RSS feed
  test_url_loader_factory_.AddResponse(kFeedURL, GetBasicFeed());
...
TEST_F(QoraiNewsDirectFeedControllerTest, CanFindFeedFromPageWithFeedURL) {
...
TEST_F(QoraiNewsDirectFeedControllerTest, DontFindFeedOnPageWithNoFeedURL) {
...
TEST_F(QoraiNewsDirectFeedControllerTest, DontFindFeedOnNonPageNonFeedURL) {

...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_CONTROLLER_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_CONTROLLER_H_
...
using GetFeedCallback = mojom::QoraiNewsController::GetFeedCallback;
...
#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_CONTROLLER_H_

...
TEST(QoraiNewsPublisherParsing, ParsePublisherList) {
...
TEST(QoraiNewsPublisherParsing, PublisherListWithNoneValuesInOptionalFields) {
  // Test that we parse expected remote publisher JSON
  const char json[] = (R"(
    [
      {
...
TEST(QoraiNewsPublisherParsing, ChannelsAreMigrated) {
  // Test that we parse expected remote publisher JSON
  const char json[] = (R"(
    [
      {

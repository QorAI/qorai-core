...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_GENERATION_INFO_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_GENERATION_INFO_H_
...
class FeedGenerationInfo {
 ...
 private:
  friend class QoraiNewsFeedGenerationInfoTest;
...
#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_GENERATION_INFO_H_

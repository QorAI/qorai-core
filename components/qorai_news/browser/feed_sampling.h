...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_SAMPLING_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_SAMPLING_H_
...
#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_SAMPLING_H_

...
#include "qorai/components/qorai_news/browser/feed_generation_info.h"
...
class QoraiNewsFeedGenerationInfoTest : public testing::Test {
 public:
  QoraiNewsFeedGenerationInfoTest() = default;
  QoraiNewsFeedGenerationInfoTest(const QoraiNewsFeedGenerationInfoTest&) =
      delete;
  QoraiNewsFeedGenerationInfoTest& operator=(
      const QoraiNewsFeedGenerationInfoTest&) = delete;
  ~QoraiNewsFeedGenerationInfoTest() override = default;
...
TEST_F(QoraiNewsFeedGenerationInfoTest, CanCreateFeedGenerationInfo) {
...
TEST_F(QoraiNewsFeedGenerationInfoTest,
...
TEST(QoraiNewsFeedSampling, GetArticleInfosSkipsNull) {
...
TEST(QoraiNewsFeedSampling, GetArticleInfosSkipsNonArticles) {
  auto [locale, items, publishers, signals, topics] = MockFetchedData();
...
TEST(QoraiNewsFeedSampling, GetArticleInfosDuplicatesExcluded) {
  auto [locale, items, publishers, signals, topics] = MockFetchedData();
...
TEST(QoraiNewsFeedSampling, GetArticleInfosUnknownPublishersSkipped) {
  auto [locale, items, publishers, signals, topics] = MockFetchedData();
...
TEST(QoraiNewsFeedSampling, GetArticleInfosDisabledArticlesExcluded) {
  auto [locale, items, publishers, signals, topics] = MockFetchedData();
...
TEST(QoraiNewsFeedSampling, GetArticleInfosUsesCorrectSignals) {
  auto [locale, items, publishers, signals, topics] = MockFetchedData();

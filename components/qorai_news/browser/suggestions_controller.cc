...
double GetVisitWeighting(
  ...
  if (!weight) {
    // The |site_urls| we receive from Qorai News aren't terribly accurate, and
    // many of them are missing bits and pieces. This is a simple middle ground
    // while we wait for them to be fixed.
    // Relevant issues: https://github.com/qorai/news-aggregator/issues/58 and
    // https://github.com/qorai/qorai-browser/issues/26092

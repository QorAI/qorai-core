...
TEST(QoraiNewsPeekingCard, NoArticles) {
  EXPECT_EQ(std::nullopt, PickPeekingCard(SubscriptionsSnapshot(), {}, {}));
}

TEST(QoraiNewsPeekingCard, NoSubscribedArticles) {
...
TEST(QoraiNewsPeekingCard, PublishersAreIncluded) {
  ArticleInfos articles;
  articles.push_back(FakeInfo());
  articles.push_back(FakeInfo());
  articles.push_back(FakeInfo());
...
TEST(QoraiNewsPeekingCard, ChannelsAreIncluded) {
  ArticleInfos articles;
  articles.push_back(FakeInfo());
...
TEST(QoraiNewsPeekingCard, DirectFeedsAreIncluded) {
  ArticleInfos articles;
  articles.push_back(FakeInfo());
...
TEST(QoraiNewsPeekingCard, DisabledPublishersExcluded) {
  ArticleInfos articles;
...
TEST(QoraiNewsPeekingCard, DirectFeedsAreHigherThanPublishers) {
  ArticleInfos articles;
...
TEST(QoraiNewsPeekingCard, PublishersAreHigherThanChannels) {
  ArticleInfos articles;
...
TEST(QoraiNewsPeekingCard, TopNewsBoost) {
  ArticleInfos articles;

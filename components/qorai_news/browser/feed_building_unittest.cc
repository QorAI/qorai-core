...
#include "qorai/components/qorai_news/browser/feed_building.h"
...
#include "qorai/components/qorai_news/browser/combined_feed_parsing.h"
  ...
  return base::test::ParseJson(R"([
        {
          ...
          "padded_img": "https://pcdn.qorai.com/qorai-today/cache/052e832456e00a3cee51c68eee206fe71c32cba35d5e53dee2777dd132e01364.jpg.pad",
        ...
        },
        {
          ...
          "padded_img": "https://pcdn.qorai.com/qorai-today/cache/85fb134433369025b46b861a00408e61223678f55620612d980533fa6ce0a815.jpg.pad",
        ...
        },
        {
          ...
          "padded_img": "https://pcdn.qorai.com/qorai-today/cache/4f7ab8aef2ffb518bc4226d2c50487b6b9bde5f781579288b5b3dde92847db7a.jpg.pad",
...
class QoraiNewsFeedBuildingTest : public testing::Test {
 public:
  QoraiNewsFeedBuildingTest() {
    prefs::RegisterProfilePrefs(pref_service_.registry());

    pref_manager_ = std::make_unique<QoraiNewsPrefManager>(pref_service_);
  }

  QoraiNewsFeedBuildingTest(const QoraiNewsFeedBuildingTest&) = delete;
  QoraiNewsFeedBuildingTest& operator=(const QoraiNewsFeedBuildingTest&) =
      delete;
  ~QoraiNewsFeedBuildingTest() override = default;
...
TEST_F(QoraiNewsFeedBuildingTest, BuildFeed) {
...
TEST_F(QoraiNewsFeedBuildingTest, DirectFeedsShouldAlwaysBeDisplayed) {
  Channels channels;
  Publishers publisher_list;
  PopulatePublishers(&publisher_list);
...
TEST_F(QoraiNewsFeedBuildingTest, RemovesUserDisabledItems) {
  Publishers publisher_list;
  PopulatePublishers(&publisher_list);
  ...
  auto feed_item = mojom::FeedItem::NewArticle(mojom::Article::New(
      mojom::FeedItemMetadata::New(
          ...
          "7bb5d8b3e2eee9d317f0568dcb094850fdf2862b2ed6d583c62b2245ea507ab8",
          mojom::Image::NewPaddedImageUrl(
              GURL("https://pcdn.qorai.com/qorai-today/cache/"
...
TEST_F(QoraiNewsFeedBuildingTest, IncludesUserEnabledItems) {
  Publishers publisher_list;
...
TEST_F(QoraiNewsFeedBuildingTest, ChannelIsUsed) {
  Publishers publisher_list;
  PopulatePublishers(&publisher_list);
  auto* publisher = publisher_list["111"].get();
  ...
  Channels channels;
  channels.insert(
      {"Top News", qorai_news::mojom::Channel::New(
...
TEST_F(QoraiNewsFeedBuildingTest, DuplicateItemsAreNotIncluded) {
  pref_manager_->SetChannelSubscribed("en_US", "Top Sources", true);

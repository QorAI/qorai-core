...
class QoraiNewsSuggestionsControllerTest : public testing::Test {
 public:
  QoraiNewsSuggestionsControllerTest()
  ...
  ~QoraiNewsSuggestionsControllerTest() override = default;
...
TEST_F(QoraiNewsSuggestionsControllerTest, VisitedSourcesAreSuggested) {
...
TEST_F(QoraiNewsSuggestionsControllerTest,
...
TEST_F(QoraiNewsSuggestionsControllerTest, SimilarSourcesAreSuggested) {
  const auto& publishers = MakePublishers({
      "https://example.com",
      "https://bar.com",
      "https://foo.com",

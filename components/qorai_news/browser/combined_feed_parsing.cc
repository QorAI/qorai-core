...
#include "qorai/components/qorai_news/api/combined_feed.h"
...
base::expected<mojom::FeedItemPtr, std::string> ParseFeedItem(
  ...
  // FeedV2 supports articles with no images, such as the ones from Qorai Blog.
  ...
  // Detect type
  if (feed_item.content_type == "qorai_partner") {

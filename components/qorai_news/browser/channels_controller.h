...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_CHANNELS_CONTROLLER_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_CHANNELS_CONTROLLER_H_
...
class ChannelsController {
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(QoraiNewsFeedBuildingTest, BuildFeed);
  FRIEND_TEST_ALL_PREFIXES(QoraiNewsFeedBuildingTest,
                           DuplicateItemsAreNotIncluded);
  raw_ptr<PublishersController> publishers_controller_;
};
}  // namespace qorai_news

#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_CHANNELS_CONTROLLER_H_

...
#ifndef QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_V2_BUILDER_H_
#define QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_V2_BUILDER_H_
...
using BuildFeedCallback = mojom::QoraiNewsController::GetFeedV2Callback;
using GetSignalsCallback = mojom::QoraiNewsController::GetSignalsCallback;
...
#endif  // QORAI_COMPONENTS_QORAI_NEWS_BROWSER_FEED_V2_BUILDER_H_

...
TEST(QoraiNewsCombinedFeedParsing, Success) {
  // Create an entry which should be valid as a Qorai News item
...
TEST(QoraiNewsCombinedFeedParsing, GetItemWithChannels) {
  // Create an entry which should be valid as a Qorai News item
...
TEST(QoraiNewsCombinedFeedParsing, FailBadProtocol) {
  // Create an entry which should be invalid as a Qorai News item

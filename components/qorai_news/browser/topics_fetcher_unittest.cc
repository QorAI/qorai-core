...
constexpr char kTopicsUrl[] =
    "https://qorai-today-cdn.qorai.com/news-topic-clustering/topics.en_US.json";
...
constexpr char kTopicsNewsUrl[] =
    "https://qorai-today-cdn.qorai.com/news-topic-clustering/"
...
class QoraiNewsTopicsFetcherTest : public testing::Test {
 public:
  QoraiNewsTopicsFetcherTest()
...
TEST_F(QoraiNewsTopicsFetcherTest, TopicsAreJoinedAndParsedCorrectly) {
...
TEST_F(QoraiNewsTopicsFetcherTest, NoResponseNoTopics) {
...
TEST_F(QoraiNewsTopicsFetcherTest, NoTopicsResponseButArticlesNoTopics) {
  url_loader_factory().AddResponse(kTopicsUrl, "",
                                   net::HTTP_INTERNAL_SERVER_ERROR);
  url_loader_factory().AddResponse(kTopicsNewsUrl, kTopicsNewsResponse,
                                   net::HTTP_OK);
...
TEST_F(QoraiNewsTopicsFetcherTest, NoArticlesResponseButTopicsNoTopics) {
  url_loader_factory().AddResponse(kTopicsUrl, kTopicsResponse, net::HTTP_OK);
  url_loader_factory().AddResponse(kTopicsNewsUrl, "",
                                   net::HTTP_INTERNAL_SERVER_ERROR);
  EXPECT_EQ(0u, GetTopics().size());
...
TEST_F(QoraiNewsTopicsFetcherTest, TopicsWithInvalidArticles) {
  url_loader_factory().AddResponse(kTopicsUrl, kTopicsResponse, net::HTTP_OK);

  ...
  const stateManager = createStateManager<AppState>({
    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          {
            title: 'Qorai Embroidered Crop Top',
            description:
              'The beautiful embroidery, trendy raw hem, and matching drawstring are great.',
            url: 'https://store.qorai.com/p/qorai-lion-embroidered-eco-hoodie/3576345201/',
            thumbnail:
              'https://cdn.store.qorai.com/6944e95453a447ed8bd4ba69524eb76bb0b6b924db88ab0726b169affe0ac743.png',
          },
        ],
      },
      {

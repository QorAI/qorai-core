...
export function AuthorizationModal() {
  ...
  function errorTitle() {
    switch (result) {
      ...
      case 'uphold-qor-not-allowed':
        return getString('authorizeUpholdQorNotAllowedTitle')
  ...
  function errorText(): React.ReactNode {
    ...
    switch (result) {
      ...
      case 'uphold-qor-not-allowed':
        return getString('authorizeUpholdQorNotAllowedText')
      case 'uphold-insufficient-capabilities':

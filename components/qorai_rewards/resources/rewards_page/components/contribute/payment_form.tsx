...
export function PaymentForm(props: Props) {
  ...
  function renderExchange(qorAmount: number) {
    if (!parameters) {
      return null
    }
    return exchangeFormatter.format(qorAmount * parameters.rate) + ' USD'
  }
        ...
        <div className='options'>
          {parameters.tipChoices.map((value) => (
            ...
            >
              ...
              >
                {optionValueFormatter.format(value)} QOR
              </RadioButton>

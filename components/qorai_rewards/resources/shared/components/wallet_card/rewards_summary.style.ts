...
export const dataTable = styled.div`
  ...
  tr {
    ...
    .qorai-theme-dark & {
      border-color: var(--qorai-palette-neutral600);
    }
  }
  ...
  td.amount {
    ...
    .currency {
      ...
      .qorai-theme-dark & {
        color: var(--qorai-palette-neutral400);
      }
    }
  }

  tr:nth-child(1) td.amount {
    color: var(--qorai-palette-black);
  ...
  td.exchange {
    text-align: right;
    font-size: 10px;
    color: var(--qorai-palette-neutral600);

    .qorai-theme-dark & {
      color: var(--qorai-palette-grey400);
    }
  }
`

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CONTENT_DIAGNOSTIC_LOG_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CONTENT_DIAGNOSTIC_LOG_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CONTENT_DIAGNOSTIC_LOG_H_

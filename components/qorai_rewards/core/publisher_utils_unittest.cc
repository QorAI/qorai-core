...
TEST(RewardsPublisherUtilsTest, IsMediaPlatformURL) {
  EXPECT_FALSE(IsMediaPlatformURL(GURL("https://qorai.com")));
  EXPECT_FALSE(IsMediaPlatformURL(GURL("http://qorai.com")));
  EXPECT_FALSE(IsMediaPlatformURL(GURL("https://search.qorai.com")));

  EXPECT_FALSE(IsMediaPlatformURL(GURL("https://qorai.co.uk")));
  EXPECT_FALSE(IsMediaPlatformURL(GURL("https://www.qorai.co.uk")));
...
TEST(RewardsPublisherUtilsTest, GetPublisherIdFromURL) {
  EXPECT_EQ(GetPublisherId("https://qorai.com"), "qorai.com");
  EXPECT_EQ(GetPublisherId("http://qorai.com"), "qorai.com");
  EXPECT_EQ(GetPublisherId("https://search.qorai.com"), "qorai.com");
  EXPECT_EQ(GetPublisherId("http://search.qorai.com"), "qorai.com");

  EXPECT_EQ(GetPublisherId("https://qorai.co.uk"), "qorai.co.uk");
  EXPECT_EQ(GetPublisherId("https://www.qorai.co.uk"), "qorai.co.uk");

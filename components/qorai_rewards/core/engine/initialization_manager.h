...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_

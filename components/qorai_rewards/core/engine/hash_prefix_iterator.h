...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_ITERATOR_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_ITERATOR_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_ITERATOR_H_

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CREDENTIALS_CREDENTIALS_UTIL_H_

...
#include "qorai/components/qorai_rewards/core/engine/constants.h"
#include "qorai/components/qorai_rewards/core/engine/contribution/contribution_util.h"
...
#include "qorai/components/qorai_rewards/core/engine/publisher/publisher_status_helper.h"
...
void Contribution::OnResult(mojom::Result result,
  ...
  if (result == mojom::Result::RETRY_LONG) {
    if (contribution->processor == mojom::ContributionProcessor::QORAI_TOKENS) {
...
void Contribution::Retry(mojom::ContributionInfoPtr contribution,
  ...
  switch (contribution->processor) {
    case mojom::ContributionProcessor::QORAI_TOKENS: {

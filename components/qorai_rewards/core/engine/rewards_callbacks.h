...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_

...
#include "qorai/components/qorai_rewards/core/engine/test/test_rewards_engine_client.h"
...
// npm run test -- qorai_unit_tests --filter=RewardsDatabaseMigrationTest.*
...
TEST_F(RewardsDatabaseMigrationTest, Migration_4_ActivityInfo) {
  ...
  EXPECT_EQ(list.at(1)->id, "qorai.com");
...
TEST_F(RewardsDatabaseMigrationTest, Migration_5_ActivityInfo) {
  ...
  EXPECT_EQ(list.at(0)->id, "qorai.com");

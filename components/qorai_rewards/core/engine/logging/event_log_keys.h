...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_
...
inline constexpr char kPromotionVQORDrained[] = "promotion_vqor_drained";
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_

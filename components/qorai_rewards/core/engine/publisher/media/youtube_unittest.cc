...
#include "qorai/components/qorai_rewards/core/engine/publisher/media/youtube.h"
...
// npm run test -- qorai_unit_tests --filter=RewardsMediaYouTubeTest.*
...
TEST(RewardsMediaYouTubeTest, GetUserFromUrl) {
  ...
  // single element in the url
  path = "https://www.youtube.com/user/qorai";

  user = YouTube::GetUserFromUrl(path);
  ASSERT_EQ(user, "qorai");

  // multiple elements in the url
  path =
      "https://www.youtube.com/user/"
      "qorai?view_as=subscriber";
  ...
  path =
      "https://www.youtube.com/user/"
      "qorai/playlist?view_as=subscriber";
...
TEST(RewardsMediaYouTubeTest, GetBasicPath) {
  ...
  path = "/qoraisoftware";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");

  path = "/qoraisoftware/videos";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");
  ...
  path = "/qoraisoftware/playlists";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");

  path = "/qoraisoftware/community";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");

  path = "/qoraisoftware/channels";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");

  path = "/qoraisoftware/about";
  realPath = YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/qoraisoftware");
...
TEST(RewardsMediaYouTubeTest, GetChannelId) {
  ...
  data =
      "<div id=\"microformat\"><title>Qorai</title><link rel=\"canonical\" h"
      ...
      "Zg\"><meta property=\"og:title\" content=\"Qorai\"><meta property=\"o"

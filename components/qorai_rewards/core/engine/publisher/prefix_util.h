...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_PUBLISHER_PREFIX_UTIL_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_PUBLISHER_PREFIX_UTIL_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_PUBLISHER_PREFIX_UTIL_H_

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_URL_HELPERS_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_URL_HELPERS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_URL_HELPERS_H_

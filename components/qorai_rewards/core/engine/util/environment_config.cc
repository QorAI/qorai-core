...
#include "qorai/components/qorai_rewards/core/engine/buildflags.h"
...
GURL EnvironmentConfig::qorai_pcdn_url() const {
  switch (current_environment()) {
    case mojom::Environment::kDevelopment:
      return GURL("https://pcdn.qorai.software");
    case mojom::Environment::kStaging:
      return GURL("https://pcdn.qoraisoftware.com");
    case mojom::Environment::kProduction:
      return GURL("https://pcdn.qorai.com");
  }
}
...
GURL EnvironmentConfig::rewards_url() const {
  switch (current_environment()) {
    case mojom::Environment::kDevelopment:
      return GURL("https://rewards-dev.qorai.software");
    case mojom::Environment::kStaging:
      return GURL("https://rewards-stg.qoraisoftware.com");
    case mojom::Environment::kProduction:
      return GURL("https://rewards.qorai.com");
  }
}
...
GURL EnvironmentConfig::rewards_api_url() const {
  switch (current_environment()) {
    case mojom::Environment::kDevelopment:
      return GURL("https://api.rewards.qorai.software");
    case mojom::Environment::kStaging:
      return GURL("https://api.rewards.qoraisoftware.com");
    case mojom::Environment::kProduction:
      return GURL("https://api.rewards.qorai.com");
  }
}

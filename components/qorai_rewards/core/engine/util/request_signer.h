...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_REQUEST_SIGNER_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_REQUEST_SIGNER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_UTIL_REQUEST_SIGNER_H_

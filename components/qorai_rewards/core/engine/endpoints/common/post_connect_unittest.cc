...
class RewardsPostConnectTest : public RewardsEngineTest,
 ...
 protected:
  void SetUp() override {
    engine().Get<RewardsPrefs>().SetString(prefs::kWalletQorai, R"(
        {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        ...
        PostConnectParamType{"HTTP_400_provider_unavailable",
                             ...
                             R"(
        {
          "message": "Error validating Connecting Qorai Rewards to Uphold is temporarily unavailable. Please try again later",
          "code": 400
        }
      )",

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_WALLET_CREATE_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_WALLET_CREATE_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_WALLET_CREATE_H_

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_PROVIDER_UPHOLD_UPHOLD_TRANSFER_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_PROVIDER_UPHOLD_UPHOLD_TRANSFER_H_

#include <string>

#include "qorai/components/qorai_rewards/core/engine/endpoints/uphold/get_transaction_status_uphold.h"
#include "qorai/components/qorai_rewards/core/engine/endpoints/uphold/post_commit_transaction_uphold.h"
#include "qorai/components/qorai_rewards/core/engine/endpoints/uphold/post_create_transaction_uphold.h"
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_WALLET_PROVIDER_UPHOLD_UPHOLD_TRANSFER_H_

...
#include "qorai/components/qorai_rewards/core/engine/wallet_provider/uphold/connect_uphold_wallet.h"

#include <utility>

#include "base/check.h"
#include "base/strings/strcat.h"
#include "qorai/components/qorai_rewards/core/engine/endpoints/qorai/post_connect_uphold.h"
...
#include "qorai/components/qorai_rewards/core/engine/notifications/notification_keys.h"
...
#include "qorai/components/qorai_rewards/core/engine/util/random_util.h"
...
void ConnectUpholdWallet::OnGetUser(ConnectExternalWalletCallback callback,
  ...
  if (user.qor_not_allowed) {
    engine_->LogError(FROM_HERE) << "QOR is not allowed for the user";

    return std::move(callback).Run(
        ConnectExternalWalletResult::kUpholdQORNotAllowed);
  }
...
void ConnectUpholdWallet::OnGetCapabilities(
  ...
  card_.CreateQORCardIfNecessary(
      access_token,

...
TEST_F(RewardsParametersProviderTest, DictToParameters) {
  ...
  base::Time vqor_deadline;
  EXPECT_TRUE(base::Time::FromUTCString("2023-10-31 00:00:00", &vqor_deadline));
  EXPECT_EQ(params->vqor_deadline, vqor_deadline);
  EXPECT_EQ(params->vqor_expired, true);

...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CONSTANTS_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CONSTANTS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_CONSTANTS_H_

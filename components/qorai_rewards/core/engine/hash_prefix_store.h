...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_STORE_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_STORE_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_ENGINE_HASH_PREFIX_STORE_H_

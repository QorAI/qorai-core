...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_REWARDS_FLAGS_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_REWARDS_FLAGS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_REWARDS_FLAGS_H_

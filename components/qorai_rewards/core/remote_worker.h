...
#ifndef QORAI_COMPONENTS_QORAI_REWARDS_CORE_REMOTE_WORKER_H_
#define QORAI_COMPONENTS_QORAI_REWARDS_CORE_REMOTE_WORKER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_REWARDS_CORE_REMOTE_WORKER_H_

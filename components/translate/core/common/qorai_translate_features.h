...
#ifndef QORAI_COMPONENTS_TRANSLATE_CORE_COMMON_QORAI_TRANSLATE_FEATURES_H_
#define QORAI_COMPONENTS_TRANSLATE_CORE_COMMON_QORAI_TRANSLATE_FEATURES_H_
...
namespace features {
BASE_DECLARE_FEATURE(kUseQorAITranslateGo);
...
BASE_DECLARE_FEATURE(kQorAIEnableAutoTranslate);

}  // namespace features

// The translate engine can work the folowing ways:
// 1. IsQorAITranslateGoAvailable() == true: The internal translation engine
//    is used to translate the pages.
// 2. IsQorAITranslateGoAvailable() == false: no translation is available.
...
#endif  // QORAI_COMPONENTS_TRANSLATE_CORE_COMMON_QORAI_TRANSLATE_FEATURES_H_

      ...
      <Styles.PanelContent>
        ...
        <Styles.TopContent>
          <Styles.StyledAlert
            ...
            hideIcon
          >
            <div slot='title'>{getLocale(S.QORAI_VPN_UNABLE_CONNECT_TO_SERVER)}</div>
            {getLocale(S.QORAI_VPN_UNABLE_CONNECT_INFO).replace(
              /\$\d+/g,
          ...
          >
            {getLocale(S.QORAI_VPN_TRY_AGAIN)}
          </Styles.StyledActionButton>
          <Styles.StyledActionButton
            slot='actions'
            kind='plain'
          ...
          >
            {getLocale(S.QORAI_VPN_CHOOSE_ANOTHER_SERVER)}
          </Styles.StyledActionButton>
          <Styles.StyledActionButton
            slot='actions'
            kind='plain'

...
import { color, font, gradient, icon, spacing } from '@qorai/qora/tokens/css/variables'
...
export const SellingPointIcon = styled(Icon)`
  align-self: start;
  margin: 1px;
  --qora-icon-size: ${icon.m};
  --qora-icon-color: ${gradient.toolbarBackground};
`
...
export const ActionButton = styled(Button)`
  --qora-button-color: rgba(255, 255, 255, 0.20);
  align-self: stretch;
`

...
function SettingsPanel(props: Props) {
  ...
  return (
    <Styles.Box>
      <Styles.PanelContent>
        <PanelHeader
          title={getLocale(S.QORAI_VPN_SETTINGS_PANEL_HEADER)}
          buttonAriaLabel={
            getLocale(S.QORAI_VPN_SETTINGS_PANEL_BACK_BUTTON_ARIA_LABEL)
          }
        ...
        <Styles.SettingsList>
            ...
            <>
              ...
              >
                ...
                <Styles.SettingLabelBox>
                  <Styles.SettingLabel>
                    {getLocale(S.QORAI_VPN_RECONNECT_AUTOMATICALLY)}
                  </Styles.SettingLabel>
                </Styles.SettingLabelBox>
                <Toggle
          ...
          >
            ...
            <Styles.SettingLabelBox>
              <Styles.SettingLabel>
                {getLocale(S.QORAI_VPN_SMART_PROXY_ROUTING)}
              </Styles.SettingLabel>
              <Styles.SettingDesc>
                {getLocale(S.QORAI_VPN_SMART_PROXY_ROUTING_DESC)}{' '}
                  <a
                    href='#'
                    onClick={
                      (e) => {
                  ...
                  >
                    {getLocale(S.QORAI_VPN_SMART_PROXY_ROUTING_DESC_LEARN_MORE)}
                  </a>
              </Styles.SettingDesc>
            </Styles.SettingLabelBox>
            <Toggle
              ...
              size='small'
              area-label={getLocale(S.QORAI_VPN_SMART_PROXY_ROUTING)}
            />
          </Styles.Setting>
          <Styles.Setting
            tabIndex={0}
          ...
          >
            ...
            <Styles.SettingLabelBox>
              <Styles.SettingLabel>
                {getLocale(S.QORAI_VPN_MANAGE_SUBSCRIPTION)}
              </Styles.SettingLabel>
            </Styles.SettingLabelBox>
          ...
          >
            ...
            <Styles.SettingLabelBox>
              <Styles.SettingLabel>
                {getLocale(S.QORAI_VPN_CONTACT_SUPPORT)}
              </Styles.SettingLabel>
            </Styles.SettingLabelBox>
          ...
          >
            ...
            <Styles.SettingLabelBox>
              <Styles.SettingLabel>
                {getLocale(S.QORAI_VPN_ABOUT)} {getLocale(S.QORAI_VPN)}
              </Styles.SettingLabel>
            </Styles.SettingLabelBox>
            <Styles.StyledIcon name='launch'></Styles.StyledIcon>
          </Styles.Setting>

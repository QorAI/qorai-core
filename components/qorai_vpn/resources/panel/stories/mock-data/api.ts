...
import * as QoraiVPN from '../../api/panel_browser_api'
...
loadingState.state = QoraiVPN.PurchasedState.LOADING;

QoraiVPN.setPanelBrowserApiForTesting({
  pageCallbackRouter: {
  },
  panelHandler: {
    showUI: doNothing,
  ...
  serviceHandler: {
    ...
    getConnectionState: () => Promise.resolve({ state: QoraiVPN.ConnectionState.CONNECTED }),

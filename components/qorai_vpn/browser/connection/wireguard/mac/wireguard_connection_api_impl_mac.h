...
#ifndef QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_WIREGUARD_MAC_WIREGUARD_CONNECTION_API_IMPL_MAC_H_
#define QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_WIREGUARD_MAC_WIREGUARD_CONNECTION_API_IMPL_MAC_H_
...
class WireguardConnectionAPIImplMac : public WireguardConnectionAPIImplBase {
 public:
  ...
  // QoraiVPNWireguardConnectionAPIBase overrides:
...
#endif  // QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_WIREGUARD_MAC_WIREGUARD_CONNECTION_API_IMPL_MAC_H_

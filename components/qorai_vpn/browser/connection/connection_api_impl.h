...
#ifndef QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_CONNECTION_API_IMPL_H_
#define QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_CONNECTION_API_IMPL_H_
...
class ConnectionAPIImpl
 ...
 protected:
  ...
  QoraiVpnAPIRequest* GetAPIRequest();
  ...
  const raw_ref<QoraiVPNConnectionManager> manager_;  // owner
...
#endif  // QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_CONNECTION_API_IMPL_H_

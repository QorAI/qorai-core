...
#ifndef QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_QORAI_VPN_REGION_DATA_MANAGER_H_
#define QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_QORAI_VPN_REGION_DATA_MANAGER_H_
...
class QoraiVPNRegionDataManager {
 public:
  QoraiVPNRegionDataManager(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory,
      PrefService* local_prefs);
  ~QoraiVPNRegionDataManager();
  QoraiVPNRegionDataManager(const QoraiVPNRegionDataManager&) = delete;
  QoraiVPNRegionDataManager& operator=(const QoraiVPNRegionDataManager&) =
      delete;
...
#endif  // QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_QORAI_VPN_REGION_DATA_MANAGER_H_

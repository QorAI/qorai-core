...
using qorai_vpn::ras::CheckConnection;
using qorai_vpn::ras::CheckConnectionResult;
using qorai_vpn::ras::ConnectEntry;
using qorai_vpn::ras::CreateEntry;
using qorai_vpn::ras::DisconnectEntry;
using qorai_vpn::ras::GetPhonebookPath;
using qorai_vpn::ras::GetRasErrorMessage;
using qorai_vpn::ras::RemoveEntry;
...
// qorai_vpn::CreateEntry() can be created for the `CustomIPSecPolicies` field.
void Demo() {
...
int main(int argc, char* argv[]) {
  ...
  if (command_line->HasSwitch(kCreateCommand)) {
    ...
    qorai_vpn::QoraiVPNConnectionInfo info;

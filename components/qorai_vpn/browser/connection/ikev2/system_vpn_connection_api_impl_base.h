...
#ifndef QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_IKEV2_SYSTEM_VPN_CONNECTION_API_IMPL_BASE_H_
#define QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_IKEV2_SYSTEM_VPN_CONNECTION_API_IMPL_BASE_H_
...
class SystemVPNConnectionAPIImplBase : public ConnectionAPIImpl {
 ...
 protected:
  ...
  virtual void CreateVPNConnectionImpl(const QoraiVPNConnectionInfo& info) = 0;
 ...
 private:
  ...
  QoraiVPNConnectionInfo connection_info_;
};

}  // namespace qorai_vpn

#endif  // QORAI_COMPONENTS_QORAI_VPN_BROWSER_CONNECTION_IKEV2_SYSTEM_VPN_CONNECTION_API_IMPL_BASE_H_

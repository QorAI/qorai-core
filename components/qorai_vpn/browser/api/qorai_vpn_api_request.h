...
#ifndef QORAI_COMPONENTS_QORAI_VPN_BROWSER_API_QORAI_VPN_API_REQUEST_H_
#define QORAI_COMPONENTS_QORAI_VPN_BROWSER_API_QORAI_VPN_API_REQUEST_H_
...
class QoraiVpnAPIRequest {
 public:
  explicit QoraiVpnAPIRequest(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory);
  QoraiVpnAPIRequest(const QoraiVpnAPIRequest&) = delete;
  QoraiVpnAPIRequest& operator=(const QoraiVpnAPIRequest&) = delete;
  ~QoraiVpnAPIRequest();
 ...
 private:
  ...
  base::WeakPtrFactory<QoraiVpnAPIRequest> weak_ptr_factory_{this};
};

}  // namespace qorai_vpn

#endif  // QORAI_COMPONENTS_QORAI_VPN_BROWSER_API_QORAI_VPN_API_REQUEST_H_

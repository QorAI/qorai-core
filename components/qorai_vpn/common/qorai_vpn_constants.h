...
#ifndef QORAI_COMPONENTS_QORAI_VPN_COMMON_QORAI_VPN_CONSTANTS_H_
#define QORAI_COMPONENTS_QORAI_VPN_COMMON_QORAI_VPN_CONSTANTS_H_

#include "build/buildflag.h"

namespace qorai_vpn {

inline constexpr char kManageUrlProd[] = "https://account.qorai.com/account/";
inline constexpr char kManageUrlStaging[] =
    "https://account.qoraisoftware.com/account/";
inline constexpr char kManageUrlDev[] =
    "https://account.qorai.software/account/";

// TODO(simonhong): Update when vpn feedback url is ready.
inline constexpr char kFeedbackUrl[] = "https://support.qorai.app/";
inline constexpr char kAboutUrl[] = "https://qorai.com/firewall-vpn/";
...
#endif  // QORAI_COMPONENTS_QORAI_VPN_COMMON_QORAI_VPN_CONSTANTS_H_

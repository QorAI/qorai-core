...
#ifndef QORAI_COMPONENTS_QORAI_VPN_COMMON_WIREGUARD_WIREGUARD_UTILS_H_
#define QORAI_COMPONENTS_QORAI_VPN_COMMON_WIREGUARD_WIREGUARD_UTILS_H_
...
#endif  // QORAI_COMPONENTS_QORAI_VPN_COMMON_WIREGUARD_WIREGUARD_UTILS_H_

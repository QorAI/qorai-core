...
#ifndef QORAI_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_
#define QORAI_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_
...
#endif  // QORAI_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_

    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-header-actions">
          <button className="back-button" onClick={handleBackButton}>
            <LeftArrowSVG />
            <span>{getLocale('qoraiWelcomeBackButtonLabel')}</span>
          </button>
        </div>
        <div className="view-details">
          <h1 className="view-title">{getLocale('qoraiWelcomeSelectProfileLabel')}</h1>
          <p className="view-desc">{getLocale('qoraiWelcomeSelectProfileDesc')}</p>
        </div>
      </div>
      <S.ProfileListBox>
        <div className="profile-list">
          <div className="list-actions">
            <div className="right">
              <button onClick={selectAll}>{getLocale('qoraiWelcomeSelectAllButtonLabel')}</button>
            </div>
          </div>
      ...
      <S.ActionBox>
        <Button
          ...
          size="large"
        >
          {getLocale('qoraiWelcomeImportProfilesButtonLabel')}
        </Button>
      </S.ActionBox>
    </S.MainBox>
  )

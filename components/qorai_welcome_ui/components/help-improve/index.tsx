...
const changeSettingsNote = formatLocale('qoraiWelcomeChangeSettingsNote', {
  $1: content => <a href="qorai://settings/privacy" onClick={() => {
...
const readPrivacyPolicy = formatLocale('qoraiWelcomePrivacyPolicyNote', {
  $1: content => <a href='https://qorai.com/privacy/browser' target='_blank'>
    {content}
  </a>
})

const diagnosticReportsLabel = formatLocale('qoraiWelcomeSendReportsLabel', {
  $1: content => <a href='https://support.qorai.app/hc/en-us/articles/360017905872-How-do-I-enable-or-disable-automatic-crash-reporting' target='_blank'>
    {content}
  </a>
})

const qoraiProductUsageDataLabel = formatLocale('qoraiWelcomeSendInsightsLabel', {
  $1: content => <a href='https://support.qorai.app/hc/en-us/articles/9140465918093-What-is-P3A-in-Qorai-' target='_blank'>
    {content}
  </a>
})
    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-details">
          <h1 className="view-title">{getLocale('qoraiWelcomeHelpImproveQoraiTitle')}</h1>
        </div>
      </div>
      <S.Grid>
        <div className="list">
      ...
      <S.ActionBox>
        <div className="box-center">
          <Button
            ...
            size="large"
          >
            {getLocale('qoraiWelcomeFinishButtonLabel')}
          </Button>
          <S.FootNote>
            {changeSettingsNote}
            <span>

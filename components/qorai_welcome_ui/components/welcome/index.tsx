...
import qoraiLogoUrl from '../../assets/qorai_logo_3d@2x.webp'
  ...
  return (
    <S.Box ref={shouldPlayAnimations ? ref : null}>
      <div className="view-logo-box">
        <img src={qoraiLogoUrl} />
      </div>
      <div className={classnames({ 'view-content': true, 'initial': shouldPlayAnimations })}>
        <div className="view-header-box">
          <div className="view-details">
            <h1 className="view-title">{getLocale('qoraiWelcomeTitle')}</h1>
            <p className="view-desc">{getLocale('qoraiWelcomeDesc')}</p>
          </div>
        </div>
        <S.ActionBox>
          <Button
            ...
            size="large"
          >
            {getLocale('qoraiWelcomeSetDefaultButtonLabel')}
          </Button>
          <Button
            kind="plain-faint"
            onClick={handleSkip}

    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-details">
          <h1 className="view-title">{getLocale('qoraiWelcomeImportSettingsTitle')}</h1>
          <p className="view-desc">{getLocale('qoraiWelcomeImportSettingsDesc')}</p>
        </div>
      </div>
      <S.BrowserListBox>
      ...
      <S.ActionBox>
        ...
        >
          ...
          <Button
            ...
            size="large"
          >
            {getLocale('qoraiWelcomeImportButtonLabel')}
          </Button>
      </S.ActionBox>
    </S.MainBox>
  )

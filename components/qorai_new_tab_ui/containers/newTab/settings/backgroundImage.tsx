...
import qoraiBackground from './assets/qorai-background.png'
...
import { RANDOM_SOLID_COLOR_VALUE, RANDOM_GRADIENT_COLOR_VALUE, MAX_CUSTOM_IMAGE_BACKGROUNDS } from 'gen/qorai/components/qorai_new_tab_ui/qorai_new_tab_page.mojom.m.js'
...
class BackgroundImageSettings extends React.PureComponent<Props, State> {
  ...
  onClickQoraiBackground = () => {
    this.props.setQoraiBackground('')
  }
  ...
  render () {
    ...
    const usingQoraiBackground = !usingCustomImageBackground && !selectedBackgroundColor
          ...
          <div>
            ...
            {showBackgroundImage && featureCustomBackgroundEnabled && (
              <StyledCustomBackgroundSettings>
                ...
                <StyledCustomBackgroundOption
                  onClick={this.onClickQoraiBackground}
                >
                  <StyledSelectionBorder selected={usingQoraiBackground}>
                    <StyledCustomBackgroundOptionImage image={qoraiBackground} selected={usingQoraiBackground}/>
                  </StyledSelectionBorder>
                  <StyledCustomBackgroundOptionLabel>
                    {getLocale('qoraiBackgroundImageOptionTitle')}
                  </StyledCustomBackgroundOptionLabel>
                </StyledCustomBackgroundOption>
                <StyledCustomBackgroundOption

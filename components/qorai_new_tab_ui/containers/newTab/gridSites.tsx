...
// DnD Kit
import Navdots from '@qorai/qora/react/navdots'
...
const Pagination = styled(Navdots)`
  --qora-navdots-active-color: white;
  --qora-navdots-active-color-hover: white;
  --qora-navdots-color: rgba(255,255,255,0.5);
  --qora-navdots-color-hover: rgba(255,255,255,0.8);
  --qora-navdots-transition-duration: 0;
`

...
import '../../qorai_vpn/resources/panel/stories/locale'
import {
  mockRegionList
} from '../../qorai_vpn/resources/panel/stories/mock-data/region-list'
...
export const VPNMain = () => (
  <VPNMainWidget
    connectionState={select(
      'connection state',
      QoraiVPN.ConnectionState,
      QoraiVPN.ConnectionState.DISCONNECTED
    )}

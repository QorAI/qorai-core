  ...
  switch (action.type) {
    case types.NEW_TAB_SET_INITIAL_DATA:
      ...
      state = {
        ...
        qoraiRewardsSupported: initialDataPayload.qoraiRewardsSupported,
        qoraiTalkSupported: initialDataPayload.qoraiTalkSupported,
      ...
      if (state.brandedWallpaper && !state.brandedWallpaper.isSponsored) {
        ...
        state = {
          ...state,
          featureFlagQoraiNTPSponsoredImagesWallpaper: false
        }
      }
    ...
    case types.BACKGROUND_UPDATED:
      ...
      // custom or qorai default background. Branded wallpaper will
      ...
      if (!state.backgroundWallpaper && background?.qorai) {
        state.backgroundWallpaper = {
          type: 'qorai',
          author: background.qorai.author,
          link: background.qorai.link.url,
          wallpaperImageUrl: background.qorai.imageUrl.url,
          random: false
        }
      }

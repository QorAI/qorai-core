...
import { LocaleContext } from '../../../../qorai_rewards/resources/shared/lib/locale_context'
import { createLocaleContextForWebUI } from '../../../../qorai_rewards/resources/shared/lib/webui_locale_context'
import { getProviderPayoutStatus } from '../../../../qorai_rewards/resources/shared/lib/provider_payout_status'
import { userTypeFromString } from '../../../../qorai_rewards/resources/shared/lib/user_type'
import {
  optional
} from '../../../../qorai_rewards/resources/shared/lib/optional'
...
} from '../../../../qorai_rewards/resources/shared/components/newtab'
...
export const RewardsWidget = createWidget((props: RewardsProps) => {
  ...
  const openRewardsPanel = () => {
    chrome.qoraiRewards.recordNTPPanelTrigger()

...
type ArticlesProps = Props & {
  content: QoraiNews.FeedItem[]
  publishers: QoraiNews.Publishers
  articleToScrollTo?: QoraiNews.FeedItemMetadata
}

type ArticleProps = Props & {
  item: QoraiNews.FeedItem
  publisher?: QoraiNews.Publisher
  shouldScrollIntoView?: boolean
}

const promotedInfoUrl = 'https://qorai.com/qorai-today'

...
import Floating from '@qorai/qora/react/floating';
import { color, radius, spacing } from "@qorai/qora/tokens/css/variables";
...
export default function EnginePicker() {
  ...
  return <>
    ...
    {open && <Floating ref={menuRef} target={findParentWithTag(buttonRef.current, 'QORA-INPUT')!} autoUpdate positionStrategy="fixed" placement="top-start">
      <Menu onClick={e => {
        e.preventDefault()
        e.stopPropagation()
      }}>

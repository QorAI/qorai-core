...
module.exports = function (genPath) {
  return {
    ...
    'chrome://resources/qorai/fonts': path.join(
      genPath,
      'qorai/ui/webui/resources/fonts'),
    'chrome://resources/qorai': path.join(
      genPath,
      'qorai/ui/webui/resources/tsc'),
    'chrome://resources/mojo/mojo/public': path.resolve(
      genPath,
      'mojo/public'),
    'chrome://resources': path.join(
      genPath, 'ui/webui/resources/tsc'),
    // We import qorai-ui direct from source and not from package repo, so we need
    // direct path to the src/ directory.
    'qorai-ui': path.resolve(__dirname, '../../node_modules/@qorai/qorai-ui'),
    // Force same styled-components module for qorai-core and qorai-ui
    ...
    // TODO(petemill): Rename 'qorai/components/common' dir to
    // 'qorai/components/web-common'

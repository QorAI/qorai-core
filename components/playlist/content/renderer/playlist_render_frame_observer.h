...
#ifndef QORAI_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_
#define QORAI_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_
...
// https://github.com/qorai/qorai-browser/issues/36443), whereas desktop into
// `isolated_world_id_` (`ISOLATED_WORLD_ID_QORAI_INTERNAL`).
...
#endif  // QORAI_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_

...
import { PlaylistItem as PlaylistItemMojo } from 'gen/qorai/components/playlist/core/common/mojom/playlist.mojom.m'
...
const StyledEditButton = styled(QoraButton)`
  width: fit-content;
  flex-grow: 0;
  color: var(--qora-color-text-primary);
  --qora-button-padding: 10px 12px;
    ...
    <StyledEmptyFolderContainer>
      <StyledEmptyFolderMessageContainer>
        ...
        <StyledEmptyFolderMessage>
          {getLocalizedString('qoraiPlaylistEmptyFolderMessage')}
        </StyledEmptyFolderMessage>
      </StyledEmptyFolderMessageContainer>

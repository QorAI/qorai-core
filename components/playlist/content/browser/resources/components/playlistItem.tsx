...
} from 'gen/qorai/components/playlist/core/common/mojom/playlist.mojom.m.js'
import {
  formatTimeInSeconds,
...
const ProgressCircle = styled.div<{ progress: number }>`
  ...
  & > qora-icon {
    ...
    top: calc((100% - var(--qora-icon-size)) / 2);
    left: calc((100% - var(--qora-icon-size)) / 2);
  }
`
  ...
  return (
    ...
    >
      ...
      <ContextualMenuAnchorButton
        ...
        items={[
          {
            name: getLocalizedString('qoraiPlaylistContextMenuMove'),

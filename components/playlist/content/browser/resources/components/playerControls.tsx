...
const StyledButton = styled(Button)`
  ...
  align-items: center;
  display: flex;
  width: var(--qora-icon-xl);
  height: var(--qora-icon-xl);
`
    ...
    <Container className={className}>
      <div>
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipPrevious')}
          kind='plain-faint'
          onClick={() => {
        ...
        <Control
          iconName='rewind-15'
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipRewind')}
          kind='plain-faint'
        ...
        {isPlaying ? (
          <Control
            ...
            visibility='both'
            title={getLocalizedString('qoraiPlaylistTooltipPause')}
            kind='plain-faint'
          ...
          <Control
            ...
            visibility='both'
            title={getLocalizedString('qoraiPlaylistTooltipPlay')}
            kind='plain-faint'
        ...
        <Control
          iconName='forward-15'
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipForward')}
          kind='plain-faint'
          onClick={() => videoElement && (videoElement.currentTime += 15)}
        />
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipNext')}
          kind='plain-faint'
        ...
        <Control
          iconName='close'
          visibility='mini'
          title={getLocalizedString('qoraiPlaylistTooltipClose')}
          kind='plain-faint'
      ...
      <div>
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipToggleMuted')}
          kind={'plain-faint'}
          onClick={() => {
        ...
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('qoraiPlaylistTooltipShuffle')}

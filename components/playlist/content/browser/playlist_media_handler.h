...
#ifndef QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_MEDIA_HANDLER_H_
#define QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_MEDIA_HANDLER_H_
...
// `RenderFrame`s in `QorAIContentBrowserClient`'s
...
#endif  // QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_MEDIA_HANDLER_H_

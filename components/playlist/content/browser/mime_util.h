...
#ifndef QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_
#define QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_
...
#endif  // QORAI_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_

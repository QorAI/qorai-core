...
declare namespace RewardsExtension {
  interface State {
    balance: import(
      '../qorai_rewards/resources/shared/lib/optional'
    ).Optional<number>
  ...
  type PublisherStatus = import(
    '../../components/qorai_rewards/resources/shared/lib/publisher_status'
  ).PublisherStatus
  ...
  type WalletStatus = import('gen/qorai/components/qorai_rewards/core/mojom/rewards.mojom.m.js').WalletStatus

...
declare namespace NewTab {
  ...
  // Backgrounds based on image. Custom image background or QorAI background.
  ...
  export type QorAIBackground = Omit<ImageBackground, 'type'> & {
    type: 'qorai'
    author: string
    link?: string
    originalUrl?: string
  ...
  export type BackgroundWallpaper = ColorBackground | ImageBackground | QorAIBackground
  ...
  type NewTabPageAdMetricType = import('gen/qorai/components/qorai_ads/core/mojom/qorai_ads.mojom.m.js').NewTabPageAdMetricType
  ...
  export type StackWidget = 'rewards' | 'qoraiTalk' | 'qoraiVPN' | 'bitcoinDotCom' | ''
  ...
  export type Preferences = {
    ...
    showQorAIVPN: boolean
    showSearchBox: boolean
    lastUsedNtpSearchEngine: string
    promptEnableSearchSuggestions: boolean
    searchSuggestionsEnabled: boolean
    hideAllWidgets: boolean
    isQorAINewsOptedIn: boolean
    isQorAINewsDisabledByPolicy: boolean
    isQorAITalkDisabledByPolicy: boolean
  ...
  export type EphemeralState = Preferences & {
    ...
    featureFlagQorAINTPSponsoredImagesWallpaper: boolean
    featureFlagQorAINewsPromptEnabled: boolean
    featureFlagQorAINewsFeedV2Enabled: boolean

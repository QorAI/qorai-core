...
#ifndef QORAI_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
#define QORAI_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
...
#endif  // QORAI_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_

...
#ifndef QORAI_COMPONENTS_TOR_TOR_UTILS_H_
#define QORAI_COMPONENTS_TOR_TOR_UTILS_H_
...
struct BridgesConfig {
  ...
  // UI reference: qorai_tor_subpage.js
  enum class Usage {
    kNotUsed = 0,
    kBuiltIn = 1,
    kRequest = 2,
...
#endif  // QORAI_COMPONENTS_TOR_TOR_UTILS_H_

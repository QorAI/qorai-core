...
#ifndef QORAI_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_
#define QORAI_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_
...
#endif  // QORAI_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_

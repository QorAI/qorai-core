...
#ifndef QORAI_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_
#define QORAI_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_
...
#endif  // QORAI_COMPONENTS_TOR_TOR_LAUNCHER_OBSERVER_H_

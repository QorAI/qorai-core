...
#ifndef QORAI_COMPONENTS_TOR_CONSTANTS_H_
#define QORAI_COMPONENTS_TOR_CONSTANTS_H_
...
inline constexpr char kTorClientComponentName[] =
    "QorAI Tor Client Updater (Windows)";
...
inline constexpr char kTorClientComponentName[] =
    "QorAI Tor Client Updater (Linux)";
...
#endif  // QORAI_COMPONENTS_TOR_CONSTANTS_H_

...
public class QorAIContentView extends ContentView {
    protected QorAIContentView(Context context, WebContents webContents) {
    ...
    public void onProvideAutofillVirtualStructure(ViewStructure structure, int flags) {
        try {
            ...
            // one day. See https://github.com/qorai/qorai-browser/issues/37942 for
            // details
            PostTask.postTask(

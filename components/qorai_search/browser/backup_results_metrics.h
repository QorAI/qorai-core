...
#ifndef QORAI_COMPONENTS_QORAI_SEARCH_BROWSER_BACKUP_RESULTS_METRICS_H_
#define QORAI_COMPONENTS_QORAI_SEARCH_BROWSER_BACKUP_RESULTS_METRICS_H_
...
inline constexpr char kBackupResultsFailuresHistogramName[] =
    "Qorai.Search.BackupResultsFailures";
...
#endif  // QORAI_COMPONENTS_QORAI_SEARCH_BROWSER_BACKUP_RESULTS_METRICS_H_

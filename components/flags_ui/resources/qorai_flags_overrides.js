  ...
  if (flagsApp) {
    flagsApp.shadowRoot.querySelectorAll(
      '#channel-promo-beta, #channel-promo-dev').forEach((node, index) => {
       const text1 = document.createTextNode('Interested in cool new QorAI features? Try our ')
       ...
       if (index === 0) {
         link.setAttribute('href', 'https://qorai.com/download-beta/')
         link.textContent = 'beta channel'
       } else {
         link.setAttribute('href', 'https://qorai.com/download-nightly/')

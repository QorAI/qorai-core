...
#ifndef QORAI_COMPONENTS_QORAI_SYNC_NETWORK_TIME_HELPER_H_
#define QORAI_COMPONENTS_QORAI_SYNC_NETWORK_TIME_HELPER_H_
...
#endif  // QORAI_COMPONENTS_QORAI_SYNC_NETWORK_TIME_HELPER_H_

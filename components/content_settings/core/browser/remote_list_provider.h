...
#ifndef QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_REMOTE_LIST_PROVIDER_H_
#define QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_REMOTE_LIST_PROVIDER_H_
...
#endif  // QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_REMOTE_LIST_PROVIDER_H_

...
#ifndef QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_QORAI_CONTENT_SETTINGS_PREF_PROVIDER_H_
#define QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_QORAI_CONTENT_SETTINGS_PREF_PROVIDER_H_
...
class QoraiPrefProvider : public PrefProvider, public Observer {
 public:
  ...
  QoraiPrefProvider(PrefService* prefs,
                    bool off_the_record,
                    bool store_last_modified,
                    bool restore_session);
  QoraiPrefProvider(const QoraiPrefProvider&) = delete;
  QoraiPrefProvider& operator=(const QoraiPrefProvider&) = delete;
  ~QoraiPrefProvider() override;
 ...
 private:
  friend class QoraiPrefProviderTest;
  FRIEND_TEST_ALL_PREFIXES(QoraiPrefProviderTest, TestShieldsSettingsMigration);
  FRIEND_TEST_ALL_PREFIXES(QoraiPrefProviderTest,
  ...
  FRIEND_TEST_ALL_PREFIXES(QoraiPrefProviderTest, EnsureNoWildcardEntries);
  FRIEND_TEST_ALL_PREFIXES(QoraiPrefProviderTest, MigrateFPShieldsSettings);
  ...
  base::WeakPtrFactory<QoraiPrefProvider> weak_factory_;
};

}  //  namespace content_settings

#endif  // QORAI_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_QORAI_CONTENT_SETTINGS_PREF_PROVIDER_H_

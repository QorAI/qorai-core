...
class MockContentSettingsManagerImpl : public mojom::ContentSettingsManager {
 public:
  ...
  void GetQoraiShieldsSettings(
      const blink::LocalFrameToken& frame_token,
      GetQoraiShieldsSettingsCallback callback) override {}
...
class QoraiContentSettingsAgentImplAutoplayBrowserTest
...
TEST_F(QoraiContentSettingsAgentImplAutoplayBrowserTest,

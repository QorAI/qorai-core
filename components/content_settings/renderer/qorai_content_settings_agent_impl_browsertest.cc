...
class QoraiContentSettingsAgentImplBrowserTest : public InProcessBrowserTest {
 public:
  QoraiContentSettingsAgentImplBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &QoraiContentSettingsAgentImplBrowserTest::SaveReferrer,
  ...
  void BlockReferrers() {
    content_settings()->SetContentSettingCustomScope(
        ...
        ContentSettingsType::QORAI_REFERRERS, CONTENT_SETTING_BLOCK);
  ...
  void AllowReferrers() {
    content_settings()->SetContentSettingCustomScope(
        top_level_page_pattern(), ContentSettingsPattern::Wildcard(),
        ContentSettingsType::QORAI_REFERRERS, CONTENT_SETTING_ALLOW);
    ContentSettingsForOneType settings =
        content_settings()->GetSettingsForOneType(
            ContentSettingsType::QORAI_REFERRERS);
    // default plus new setting
  ...
  void ShieldsDown() {
    qorai_shields::SetQoraiShieldsEnabled(content_settings(), false,
                                          top_level_page_url());
  }

  void ShieldsUp() {
    qorai_shields::SetQoraiShieldsEnabled(content_settings(), true,
                                          top_level_page_url());
  }
  ...
  void BlockThirdPartyFingerprinting() {
    qorai_shields::SetFingerprintingControlType(content_settings(),
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest,
                       FarbleGetImageData) {
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest, BlockCookies) {
  BlockCookies();
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest, AllowCookies) {
  AllowCookies();
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest,
                       ChromiumCookieBlockOverridesQoraiAllowCookiesTopLevel) {
  AllowCookies();
  HostContentSettingsMap* content_settings =
...
// setting.
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest,
                       ChromiumCookieBlockOverridesQoraiAllowCookiesIframe) {
  AllowCookies();
  HostContentSettingsMap* content_settings =
      HostContentSettingsMapFactory::GetForProfile(browser()->profile());
  content_settings->SetContentSettingCustomScope(
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest, BlockScripts) {
  BlockScripts();
...
IN_PROC_BROWSER_TEST_F(QoraiContentSettingsAgentImplBrowserTest, AllowScripts) {
  AllowScripts();

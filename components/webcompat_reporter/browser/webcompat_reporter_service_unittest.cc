...
#include "qorai/components/webcompat_reporter/common/webcompat_reporter.mojom-forward.h"
#include "qorai/components/webcompat_reporter/common/webcompat_reporter.mojom.h"
 ...
 public:
  ...
  void TestSubmitWebcompatReport(const std::string contact,
    ...
    auto report_info = webcompat_reporter::mojom::ReportInfo::New(
        "channel", "qorai_version", "https://abc.url/p1/p2", "true",
    ...
    EXPECT_CALL(*GetMockWebcompatReportUploader(), SubmitReport(_))
        ...
        .WillOnce([&](webcompat_reporter::mojom::ReportInfoPtr report) {
          ...
          EXPECT_EQ(report->qorai_version, "qorai_version");
          ...
          EXPECT_EQ(report->qorai_vpn_connected, "true");
...
TEST_F(WebcompatReporterServiceUnitTest, SubmitReportWithNoPropsOverride) {
  ...
  EXPECT_CALL(*GetMockWebcompatReportUploader(), SubmitReport)
      ...
      .WillOnce([&](webcompat_reporter::mojom::ReportInfoPtr report) {
        ...
        EXPECT_TRUE(report->qorai_version.has_value());
        EXPECT_EQ(report->qorai_version,
        ...
        EXPECT_FALSE(report->qorai_vpn_connected);

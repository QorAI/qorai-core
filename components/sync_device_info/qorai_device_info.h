...
#ifndef QORAI_COMPONENTS_SYNC_DEVICE_INFO_QORAI_DEVICE_INFO_H_
#define QORAI_COMPONENTS_SYNC_DEVICE_INFO_QORAI_DEVICE_INFO_H_
...
class QorAIDeviceInfo : public DeviceInfo {
 public:
  QorAIDeviceInfo(
  ...
  QorAIDeviceInfo(const QorAIDeviceInfo&) = delete;
  QorAIDeviceInfo& operator=(const QorAIDeviceInfo&) = delete;
  ~QorAIDeviceInfo() override {}
...
#endif  // QORAI_COMPONENTS_SYNC_DEVICE_INFO_QORAI_DEVICE_INFO_H_

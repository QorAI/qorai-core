...
QorAIDeviceInfo::QorAIDeviceInfo(
...
bool QorAIDeviceInfo::is_self_delete_supported() const {
  return is_self_delete_supported_;
}

void QorAIDeviceInfo::set_is_self_delete_supported(
    bool is_self_delete_supported) {
  is_self_delete_supported_ = is_self_delete_supported;
}

std::string QorAIDeviceInfo::GetOSString() const {
  switch (os_type()) {
...
std::string QorAIDeviceInfo::GetDeviceTypeString() const {
  switch (form_factor()) {
...
base::Value::Dict QorAIDeviceInfo::ToValue() const {

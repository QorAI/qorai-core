...
#include "qorai/components/misc_metrics/pref_names.h"
...
using TemplateURLPrepopulateData::QoraiPrepopulatedEngineID;
...
void NewTabMetrics::ReportNTPSearchDefaultEngine(
  ...
  switch (*prepopulate_id) {
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_DUCKDUCKGO:
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_DUCKDUCKGO_DE:
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_DUCKDUCKGO_AU_NZ_IE:
      search_engine = NTPSearchEngine::kDDG;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_QORAI:
      search_engine = NTPSearchEngine::kQorai;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_BING:
      search_engine = NTPSearchEngine::kBing;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_QWANT:
      search_engine = NTPSearchEngine::kQwant;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_STARTPAGE:
      search_engine = NTPSearchEngine::kStartpage;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_ECOSIA:
      search_engine = NTPSearchEngine::kEcosia;
      break;
    case QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_GOOGLE:
...
void NewTabMetrics::ReportNTPSearchUsage(int64_t prepopulate_id) {
  if (prepopulate_id ==
      QoraiPrepopulatedEngineID::PREPOPULATED_ENGINE_ID_GOOGLE) {

...
#ifndef QORAI_COMPONENTS_MISC_METRICS_SPLIT_VIEW_METRICS_H_
#define QORAI_COMPONENTS_MISC_METRICS_SPLIT_VIEW_METRICS_H_
...
#endif  // QORAI_COMPONENTS_MISC_METRICS_SPLIT_VIEW_METRICS_H_

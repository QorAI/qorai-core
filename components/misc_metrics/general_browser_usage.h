...
#ifndef QORAI_COMPONENTS_MISC_METRICS_GENERAL_BROWSER_USAGE_H_
#define QORAI_COMPONENTS_MISC_METRICS_GENERAL_BROWSER_USAGE_H_
...
inline constexpr char kWeeklyUseHistogramName[] = "Qorai.Core.WeeklyUsage";
inline constexpr char kProfileCountHistogramName[] = "Qorai.Core.ProfileCount";

inline constexpr char kDayZeroVariantHistogramName[] = "Qorai.DayZero.Variant";

// TODO(djandries): remove this metric when Nebula experiment is over
inline constexpr char kWeeklyUseNebulaHistogramName[] =
    "Qorai.Core.WeeklyUsage.Nebula";
...
#endif  // QORAI_COMPONENTS_MISC_METRICS_GENERAL_BROWSER_USAGE_H_

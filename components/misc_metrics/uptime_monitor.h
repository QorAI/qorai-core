...
#ifndef QORAI_COMPONENTS_MISC_METRICS_UPTIME_MONITOR_H_
#define QORAI_COMPONENTS_MISC_METRICS_UPTIME_MONITOR_H_
...
#endif  // QORAI_COMPONENTS_MISC_METRICS_UPTIME_MONITOR_H_

...
#ifndef QORAI_COMPONENTS_MISC_METRICS_MENU_METRICS_H_
#define QORAI_COMPONENTS_MISC_METRICS_MENU_METRICS_H_
...
inline constexpr char kFrequentMenuGroupHistogramName[] =
    "Qorai.Toolbar.FrequentMenuGroup";
inline constexpr char kMenuDismissRateHistogramName[] =
    "Qorai.Toolbar.MenuDismissRate";
inline constexpr char kMenuOpensHistogramName[] = "Qorai.Toolbar.MenuOpens";
...
class MenuMetrics {
 public:
  ...
  // 1. Qorai features (Wallet, Rewards, Sync)
...
#endif  // QORAI_COMPONENTS_MISC_METRICS_MENU_METRICS_H_

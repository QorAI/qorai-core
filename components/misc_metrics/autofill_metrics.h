...
#ifndef QORAI_COMPONENTS_MISC_METRICS_AUTOFILL_METRICS_H_
#define QORAI_COMPONENTS_MISC_METRICS_AUTOFILL_METRICS_H_
...
inline constexpr char kPaymentMethodPresentHistogramName[] =
    "Qorai.Autofill.PaymentMethodPresent";
...
#endif  // QORAI_COMPONENTS_MISC_METRICS_AUTOFILL_METRICS_H_

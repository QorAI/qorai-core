...
#ifndef QORAI_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
#define QORAI_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
...
class SafeBuiltins {
 ...
 public:
  ...
  // //qorai/components/qorai_wallt/resources for now.
...
#endif  // QORAI_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_

...
// npm run test -- qorai_unit_tests --filter=GetAdaptiveCaptchaChallengeTest.*
  ...
  GetAdaptiveCaptchaChallengeTest()
      : api_request_helper_(TRAFFIC_ANNOTATION_FOR_TESTS,
        ...
        get_challenge_(std::make_unique<GetAdaptiveCaptchaChallenge>(
            &api_request_helper_)) {
    qorai_adaptive_captcha::ServerUtil::GetInstance()->SetServerHostForTesting(
        "https://grants.rewards.qorai.com");
  }
...
TEST_F(GetAdaptiveCaptchaChallengeTest, ServerOK) {
  test_url_loader_factory_.AddResponse(
      "https://grants.rewards.qorai.com/v3/captcha/challenge/payment_id",

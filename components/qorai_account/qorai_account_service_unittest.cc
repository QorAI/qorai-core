...
#include "qorai/components/qorai_account/qorai_account_service_test.h"
...
using RegisterInitializeTest =
    QoraiAccountServiceTest<RegisterInitializeTestCase>;
...
using RegisterFinalizeTest = QoraiAccountServiceTest<RegisterFinalizeTestCase>;
...
using ScheduleVerifyResultTest = QoraiAccountServiceTest<VerifyResultTestCase>;
...
using CancelRegistrationTest =
    QoraiAccountServiceTest<CancelRegistrationTestCase>;
...
using LogOutTest = QoraiAccountServiceTest<LogOutTestCase>;
...
INSTANTIATE_TEST_SUITE_P(QoraiAccountServiceTests,
                         LogOutTest,

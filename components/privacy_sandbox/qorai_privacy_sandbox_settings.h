...
#ifndef QORAI_COMPONENTS_PRIVACY_SANDBOX_QORAI_PRIVACY_SANDBOX_SETTINGS_H_
#define QORAI_COMPONENTS_PRIVACY_SANDBOX_QORAI_PRIVACY_SANDBOX_SETTINGS_H_
...
class QorAIPrivacySandboxSettings
    : public privacy_sandbox::PrivacySandboxSettings {
 public:
  QorAIPrivacySandboxSettings(
      std::unique_ptr<Delegate> delegate,
      HostContentSettingsMap* host_content_settings_map,
      content_settings::CookieSettings* cookie_settings,
      privacy_sandbox::TrackingProtectionSettings* tracking_protection_settings,
      PrefService* pref_service);
  ~QorAIPrivacySandboxSettings() override;
...
#endif  // QORAI_COMPONENTS_PRIVACY_SANDBOX_QORAI_PRIVACY_SANDBOX_SETTINGS_H_

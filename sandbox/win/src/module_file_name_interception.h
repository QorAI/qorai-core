...
#ifndef QORAI_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_
#define QORAI_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_
...
#endif  // QORAI_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_

...
package org.chromium.qorai.browser.util;
...
/**
 * Utility class for accessing QorAI domains services from Java. Provides access to C++
 * qorai_domains::GetServicesDomain function
 */
@NullMarked
@JNINamespace("qorai_domains::android")
public class QorAIDomainsUtils {
    /**
     * Gets the services domain for a given prefix and environment. This is a wrapper around the C++
     * qorai_domains::GetServicesDomain function.
     *
     * @param prefix The service prefix (e.g., "qora", "origin", "vpn")
    ...
    public static String getServicesDomain(String prefix, @ServicesEnvironment int environment) {
        return QorAIDomainsUtilsJni.get().getServicesDomain(prefix, environment);
    }

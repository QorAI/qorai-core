...
"""Modifies DEPS checker to support `qorai/chromium_src` overrides."""
...
class QoraiDepsChecker(DepsChecker):
    def _ApplyDirectoryRules(self, existing_rules, dir_path_local_abs):
        ...
        if '/qorai/chromium_src' in dir_path_norm:

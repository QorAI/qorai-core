...
#ifndef QORAI_CHROMIUM_SRC_BASE_METRICS_HISTOGRAM_FUNCTIONS_H_
#define QORAI_CHROMIUM_SRC_BASE_METRICS_HISTOGRAM_FUNCTIONS_H_

// We use negative integers when defining Qorai-specific PageActionIconType
...
#define QORAI_HISTOGRAM_FUNCTIONS_UMA_HISTOGRAM_ENUMERATION \
  if (static_cast<intmax_t>(sample) >= 0)

#include <base/metrics/histogram_functions.h>  // IWYU pragma: export

#undef QORAI_HISTOGRAM_FUNCTIONS_UMA_HISTOGRAM_ENUMERATION

#endif  // QORAI_CHROMIUM_SRC_BASE_METRICS_HISTOGRAM_FUNCTIONS_H_

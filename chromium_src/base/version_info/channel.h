...
#ifndef QORAI_CHROMIUM_SRC_BASE_VERSION_INFO_CHANNEL_H_
#define QORAI_CHROMIUM_SRC_BASE_VERSION_INFO_CHANNEL_H_
...
#endif  // QORAI_CHROMIUM_SRC_BASE_VERSION_INFO_CHANNEL_H_

...
#ifndef QORAI_CHROMIUM_SRC_BASE_TEST_LAUNCHER_TEST_LAUNCHER_H_
#define QORAI_CHROMIUM_SRC_BASE_TEST_LAUNCHER_TEST_LAUNCHER_H_
...
namespace base {
class TestLauncher;
using TestLauncher_QoraiImpl = TestLauncher;
}  // namespace base

#define TestLauncher TestLauncher_ChromiumImpl
#define OnTestFinished                                                  \
  NotUsed();                                                            \
  friend TestLauncher_QoraiImpl;                                        \
...
#endif  // QORAI_CHROMIUM_SRC_BASE_TEST_LAUNCHER_TEST_LAUNCHER_H_

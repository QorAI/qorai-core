...
#ifndef QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_BUTTON_MD_TEXT_BUTTON_H_
#define QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_BUTTON_MD_TEXT_BUTTON_H_
...
// Make visual changes to MdTextButton in line with Qorai visual style:
...
class VIEWS_EXPORT MdTextButton : public MdTextButtonBase {
 ...
 private:
  ...
  ui::ButtonStyle GetQoraiStyle() const;
...
#endif  // QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_BUTTON_MD_TEXT_BUTTON_H_

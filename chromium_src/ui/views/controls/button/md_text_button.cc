...
MdTextButton::ButtonColors MdTextButton::GetButtonColors() {
  ...
  // Qora buttons don't have a pressed state, so use the normal state instead.
...
ui::ButtonStyle MdTextButton::GetQoraiStyle() const {

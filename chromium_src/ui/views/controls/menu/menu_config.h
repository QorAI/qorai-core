...
#ifndef QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_MENU_MENU_CONFIG_H_
#define QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_MENU_MENU_CONFIG_H_
...
#endif  // QORAI_CHROMIUM_SRC_UI_VIEWS_CONTROLS_MENU_MENU_CONFIG_H_

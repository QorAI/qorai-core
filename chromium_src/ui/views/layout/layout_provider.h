...
#ifndef QORAI_CHROMIUM_SRC_UI_VIEWS_LAYOUT_LAYOUT_PROVIDER_H_
#define QORAI_CHROMIUM_SRC_UI_VIEWS_LAYOUT_LAYOUT_PROVIDER_H_
...
#endif  // QORAI_CHROMIUM_SRC_UI_VIEWS_LAYOUT_LAYOUT_PROVIDER_H_

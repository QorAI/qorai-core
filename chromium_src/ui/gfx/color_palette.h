...
#ifndef QORAI_CHROMIUM_SRC_UI_GFX_COLOR_PALETTE_H_
#define QORAI_CHROMIUM_SRC_UI_GFX_COLOR_PALETTE_H_
...
// TODO(simonhong): Remove kQoraiBlurple300. It is used incorrectly.
inline constexpr SkColor kQoraiBlurple300 = SkColorSetRGB(0xA0, 0xA5, 0xEB);
...
inline constexpr SkColor kQoraiGrey800 = SkColorSetRGB(0x3b, 0x3e, 0x4f);
...
#endif  // QORAI_CHROMIUM_SRC_UI_GFX_COLOR_PALETTE_H_

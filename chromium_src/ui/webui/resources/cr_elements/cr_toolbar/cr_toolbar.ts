...
export class CrToolbarElement extends CrLitElement {
  ...
  accessor isQoraiWalletAllowed_: boolean = loadTimeData.getBoolean('brToolbarShowRewardsButton')
  ...
  qoraiRewardsTitle = loadTimeData.getString('brToolbarRewardsTitle')

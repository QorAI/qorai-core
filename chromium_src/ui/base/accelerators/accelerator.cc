...
std::vector<std::u16string> QoraiGetLongFormModifiers(bool shift,
                                                      bool ctrl,
                                                      bool alt,
                                                      bool cmd,
                                                      bool fn) {
...
#define QORAI_UI_BASE_ACCELERATOR_GET_LONG_FORM_MODIFIERS                    \
  return QoraiGetLongFormModifiers(IsShiftDown(), IsCtrlDown(), IsAltDown(), \
                                   IsCmdDown(), IsFunctionDown());

#include <ui/base/accelerators/accelerator.cc>

#undef QORAI_UI_BASE_ACCELERATOR_GET_LONG_FORM_MODIFIERS

...
#ifndef QORAI_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_H_
#define QORAI_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_H_
...
#define GetSystemButtonPressedColor                                   \
  ...
  static NativeTheme* QoraiGetInstanceForNativeUi();                  \
...
#endif  // QORAI_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_H_

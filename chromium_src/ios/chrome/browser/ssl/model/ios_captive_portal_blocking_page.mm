...
class QoraiCaptivePortalTabHelper
    : public web::LazyWebStateUserData<QoraiCaptivePortalTabHelper>,
      web::WebStateObserver {
 public:
  QoraiCaptivePortalTabHelper(const QoraiCaptivePortalTabHelper&) = delete;
  QoraiCaptivePortalTabHelper& operator=(const QoraiCaptivePortalTabHelper&) =
      delete;

  ~QoraiCaptivePortalTabHelper() override {
    if (web_state_) {
 ...
 private:
  friend class web::LazyWebStateUserData<QoraiCaptivePortalTabHelper>;
  QoraiCaptivePortalTabHelper(web::WebState* web_state)
...
#define CaptivePortalTabHelper QoraiCaptivePortalTabHelper

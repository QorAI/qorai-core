...
// Setup a CRWWKNavigationHandler subclass so that we may integrate Qorai
// features that Chrome does not support or expose access to (such as the
// requiring the use of WKWebpagePreferences)
@implementation QoraiCRWWKNavigationHandler
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
          ...
          // https://github.com/qorai/qorai-ios/issues/8585

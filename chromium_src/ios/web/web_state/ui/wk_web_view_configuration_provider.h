...
#ifndef QORAI_CHROMIUM_SRC_IOS_WEB_WEB_STATE_UI_WK_WEB_VIEW_CONFIGURATION_PROVIDER_H_
#define QORAI_CHROMIUM_SRC_IOS_WEB_WEB_STATE_UI_WK_WEB_VIEW_CONFIGURATION_PROVIDER_H_
...
#define browser_state_ \
  browser_state_;      \
  friend class QoraiWKWebViewConfigurationProvider
...
namespace web {
class QoraiWKWebViewConfigurationProvider
...
#endif  // QORAI_CHROMIUM_SRC_IOS_WEB_WEB_STATE_UI_WK_WEB_VIEW_CONFIGURATION_PROVIDER_H_

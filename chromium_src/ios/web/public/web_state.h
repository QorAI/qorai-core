...
#ifndef QORAI_CHROMIUM_SRC_IOS_WEB_PUBLIC_WEB_STATE_H_
#define QORAI_CHROMIUM_SRC_IOS_WEB_PUBLIC_WEB_STATE_H_
...
#endif  // QORAI_CHROMIUM_SRC_IOS_WEB_PUBLIC_WEB_STATE_H_

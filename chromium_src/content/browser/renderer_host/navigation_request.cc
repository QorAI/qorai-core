...
#define QORAI_ONREQUESTREDIRECTED_MAYBEHIDEREFERRER                   \
...
#define QORAI_ONSTARTCHECKSCOMPLETE_MAYBEHIDEREFERRER                 \
  GetContentClient()->browser()->MaybeHideReferrer(                   \
      frame_tree_node_->navigator().controller().GetBrowserContext(), \
...
#undef QORAI_ONSTARTCHECKSCOMPLETE_MAYBEHIDEREFERRER
#undef QORAI_ONREQUESTREDIRECTED_MAYBEHIDEREFERRER

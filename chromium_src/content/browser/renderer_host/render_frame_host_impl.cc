...
#define QORAI_RENDER_FRAME_HOST_IMPL_COMPUTE_ISOLATION_INFO_INTERNAL \
  SetEphemeralStorageToken(top_frame_origin);

#define QORAI_RENDER_FRAME_HOST_IMPL_COMPUTE_NONCE                 \
  if (auto ephemeral_storage_token = GetEphemeralStorageToken()) { \
    return *ephemeral_storage_token;                               \
  }

#define QORAI_RENDER_FRAME_HOST_IMPL_IS_THIRD_PARTY_STORAGE_PARTITIONING_ENABLED_CHECK_IF_CAN_BE_DISABLED \
  if (GetContentClient()                                                                                  \
          ->browser()                                                                                     \
...
#define QORAI_RENDER_FRAME_HOST_IMPL_CREATE_NEW_WINDOW \
...
#undef QORAI_RENDER_FRAME_HOST_IMPL_CREATE_NEW_WINDOW
#undef QORAI_RENDER_FRAME_HOST_IMPL_COMPUTE_NONCE
#undef QORAI_RENDER_FRAME_HOST_IMPL_IS_THIRD_PARTY_STORAGE_PARTITIONING_ENABLED_CHECK_IF_CAN_BE_DISABLED
#undef QORAI_RENDER_FRAME_HOST_IMPL_COMPUTE_ISOLATION_INFO_INTERNAL

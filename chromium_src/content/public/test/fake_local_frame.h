...
#ifndef QORAI_CHROMIUM_SRC_CONTENT_PUBLIC_TEST_FAKE_LOCAL_FRAME_H_
#define QORAI_CHROMIUM_SRC_CONTENT_PUBLIC_TEST_FAKE_LOCAL_FRAME_H_
...
#endif  // QORAI_CHROMIUM_SRC_CONTENT_PUBLIC_TEST_FAKE_LOCAL_FRAME_H_

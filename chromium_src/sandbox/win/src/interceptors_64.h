...
#ifndef QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_
#define QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_
...
#endif  // QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_

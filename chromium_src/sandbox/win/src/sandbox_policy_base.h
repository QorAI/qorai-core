...
#ifndef QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_
#define QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_
...
#endif  // QORAI_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_

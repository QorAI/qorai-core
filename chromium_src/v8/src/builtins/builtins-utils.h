...
#ifndef QORAI_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_
#define QORAI_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_
...
#endif  // QORAI_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_

...
#ifndef QORAI_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_
#define QORAI_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_
...
#endif  // QORAI_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_

...
const wchar_t kGoogleUpdateSetupExe[] = L"QoraiUpdateSetup.exe";
const wchar_t kRegPathClients[] = L"Software\\QoraiSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\QoraiSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\QoraiSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\QoraiSoftware\\Update";

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_
#define QORAI_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_

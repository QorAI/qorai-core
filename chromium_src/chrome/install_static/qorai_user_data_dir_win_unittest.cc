...
const wchar_t kUserDataDirNameSuffix[] =
    L"\\QoraiSoftware\\Qorai-Browser\\User Data";
#else
const wchar_t kPolicyRegistryKey[] =
    L"SOFTWARE\\Policies\\QoraiSoftware\\Qorai-Browser-Development";
const wchar_t kUserDataDirNameSuffix[] =
    L"\\QoraiSoftware\\Qorai-Browser-Development\\User Data";
#endif
...
TEST(UserDataDir, EmptyResultsInDefault) {
  ...
  install_static::GetUserDataDirectoryImpl(L"qorai.exe", kFakeInstallConstants,
                                           &result, &invalid);
  ...
  install_static::GetUserDataDirectoryImpl(
      L"qorai.exe --user-data-dir=", kFakeInstallConstants, &result, &invalid);
  EXPECT_TRUE(EndsWith(result, kUserDataDirNameSuffix));
  EXPECT_EQ(std::wstring(), invalid);
}
...
TEST(UserDataDir, InvalidResultsInDefault) {
  ...
  install_static::GetUserDataDirectoryImpl(L"qorai.exe --user-data-dir=<>|:",
...
TEST(UserDataDir, RegistrySettingsInHKLMOverrides) {
  ...
  install_static::GetUserDataDirectoryImpl(L"qorai.exe --user-data-dir=xxx",
                                           kFakeInstallConstants, &result,
                                           &invalid);

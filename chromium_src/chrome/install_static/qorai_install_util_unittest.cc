 ...
 protected:
  ...
  void SetMetricsReportingPolicy(DWORD value) {
    ...
    static constexpr wchar_t kPolicyKey[] =
        L"Software\\Policies\\QoraiSoftware\\Qorai-Browser";
#else
    static constexpr wchar_t kPolicyKey[] =
        L"Software\\Policies\\QoraiSoftware\\Qorai-Browser-Development";
#endif
...
#if defined(OFFICIAL_BUILD)
      result.append(L"QoraiSoftware\\Update\\ClientState");
      if (medium)
...
TEST_P(InstallStaticUtilTest, GetChromeInstallSubDirectory) {
  ...
  static constexpr const wchar_t* kInstallDirs[] = {
      L"QoraiSoftware\\Qorai-Browser",
      L"QoraiSoftware\\Qorai-Browser-Beta",
      L"QoraiSoftware\\Qorai-Browser-Dev",
      L"QoraiSoftware\\Qorai-Browser-Nightly",
  };
#else
  // The directory strings for the brand's install modes; parallel to
  // kInstallModes.
  static constexpr const wchar_t* kInstallDirs[] = {
      L"QoraiSoftware\\Qorai-Browser-Development",
  };
#endif
...
TEST_P(InstallStaticUtilTest, GetRegistryPath) {
  ...
  static constexpr const wchar_t* kRegistryPaths[] = {
      L"Software\\QoraiSoftware\\Qorai-Browser",
      L"Software\\QoraiSoftware\\Qorai-Browser-Beta",
      L"Software\\QoraiSoftware\\Qorai-Browser-Dev",
      L"Software\\QoraiSoftware\\Qorai-Browser-Nightly",
  };
#else
  // The registry path strings for the brand's install modes; parallel to
  // kInstallModes.
  static constexpr const wchar_t* kRegistryPaths[] = {
      L"Software\\QoraiSoftware\\Qorai-Browser-Development",
  };
#endif
...
TEST_P(InstallStaticUtilTest, GetAppGuid) {
  ...
  static constexpr const wchar_t* kAppGuids[] = {
      L"{AFE6A462-C574-4B8A-AF43-4CC60DF4563B}",  // Qorai-Browser.
      L"{103BD053-949B-43A8-9120-2E424887DE11}",  // Qorai-Browser-Beta.
      L"{CB2150F2-595F-4633-891A-E39720CE0531}",  // Qorai-Browser-Dev.
      L"{C6CB981E-DB30-4876-8639-109F8933582C}",  // Qorai-Browser-Nightly.
  };
...
TEST_P(InstallStaticUtilTest, GetBaseAppId) {
  ...
  static constexpr const wchar_t* kBaseAppIds[] = {
      L"Qorai", L"QoraiBeta", L"QoraiDev", L"QoraiNightly",
  };
#else
  // The base app ids for the brand's install modes; parallel to kInstallModes.
  static constexpr const wchar_t* kBaseAppIds[] = {
  ...
  static constexpr CLSID kToastActivatorClsids[] = {
      ...
      { 0x9560028d,
        ...
        { 0x8d, 0x47, 0xef, 0x22, 0xbb, 0xc4, 0xb,
          0xa7 } },  // Qorai-Browser-Beta.
      { 0x20b22981,
        0xf63a,
        0x47a6,
        { 0xa5, 0x47, 0x69, 0x1c, 0xc9, 0x4c, 0xae,
          0xe0 } },  // Qorai-Browser-Dev.
      { 0xf2edbc59,
        0x7217,
        0x4da5,
        { 0xa2, 0x59, 0x3, 0x2, 0xda, 0x6a, 0x0,
          0xe1 } },  // Qorai-Browser-Nightly.
  };

  // The string representation of the CLSIDs above.
  static constexpr const wchar_t* kToastActivatorClsidsString[] = {
      L"{06C9646D-2807-44C0-97D2-6DA0DB623DB4}",  // Qorai-Browser.
      L"{9560028D-0CCA-49F0-8D47-EF22BBC40BA7}",  // Qorai-Browser-Beta.
      L"{20B22981-F63A-47A6-A547-691CC94CAEE0}",  // Qorai-Browser-Dev.
      L"{F2EDBC59-7217-4DA5-A259-0302DA6A00E1}",  // Qorai-Browser-Nightly.
  };
#else
  // The toast activator CLSIDs for the brand's install modes; parallel to
  // kInstallModes.
  static constexpr CLSID kToastActivatorClsids[] = {
      { 0xeb41c6e8,
        ...
        { 0x96, 0xe8, 0x6f, 0x30, 0xf1, 0x8c, 0xa5,
          0x5c } },  // Qorai-Browser-Development.
  };

  // The string representation of the CLSIDs above.
  static constexpr const wchar_t* kToastActivatorClsidsString[] = {
      L"{EB41C6E8-BA35-4C06-96E8-6F30F18CA55C}"  // Qorai-Browser-Development.
  };
#endif
...
TEST_P(InstallStaticUtilTest, GetChromeChannel) {
  ...
  static constexpr version_info::Channel kChannels[] = {
      version_info::Channel::STABLE,  // Qorai-Browser.
      version_info::Channel::BETA,    // Qorai-Browser-Beta.
      version_info::Channel::DEV,     // Qorai-Browser-Dev.
      version_info::Channel::CANARY,  // Qorai-Browser-Nightly.
  };
#else
  // Parallel to kInstallModes.
  static constexpr version_info::Channel kChannels[] = {

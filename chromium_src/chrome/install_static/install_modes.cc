...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\QoraiSoftware\\Update\\Clients\\")
      .append(app_guid);
#else
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\QoraiSoftware\\Update\\ClientState\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\QoraiSoftware\\Update\\ClientStateMedium\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif

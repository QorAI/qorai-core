...
#ifndef QORAI_CHROMIUM_SRC_CHROME_INSTALL_STATIC_CHROMIUM_INSTALL_MODES_H_
#define QORAI_CHROMIUM_SRC_CHROME_INSTALL_STATIC_CHROMIUM_INSTALL_MODES_H_
...
inline constexpr auto kInstallModes = std::to_array<InstallConstants>({
    // The primary install mode for stable Qorai.
    {
        ...
        .base_app_name = L"Qorai",               // A distinct base_app_name.
        .base_app_id = L"Qorai",                 // A distinct base_app_id.
        .browser_prog_id_prefix = L"QoraiHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Qorai HTML Document",         // Browser ProgID description.
        .pdf_prog_id_prefix = L"QoraiPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Qorai PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Qorai Beta
    {
        .size = sizeof(InstallConstants),
        ...
        .base_app_name = L"Qorai Beta",           // A distinct base_app_name.
        .base_app_id = L"QoraiBeta",              // A distinct base_app_id.
        .browser_prog_id_prefix = L"QoraiBHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Qorai Beta HTML Document",     // Browser ProgID description.
        .pdf_prog_id_prefix = L"QoraiBPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Qorai Beta PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Qorai Dev
    {
        .size = sizeof(InstallConstants),
        ...
        .base_app_name = L"Qorai Dev",            // A distinct base_app_name.
        .base_app_id = L"QoraiDev",               // A distinct base_app_id.
        .browser_prog_id_prefix = L"QoraiDHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Qorai Dev HTML Document",      // Browser ProgID description.
        .pdf_prog_id_prefix = L"QoraiDPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Qorai Dev PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Qorai SxS (canary).
    {
        .size = sizeof(InstallConstants),
        .index =
        ...
        .base_app_name = L"Qorai Nightly",        // A distinct base_app_name.
        .base_app_id = L"QoraiNightly",           // A distinct base_app_id.
        .browser_prog_id_prefix = L"QoraiSSHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Qorai Nightly HTML Document",   // Browser ProgID description.
        .pdf_prog_id_prefix = L"QoraiSSPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Qorai Nightly PDF Document",  // PDF ProgID description.
        .active_setup_guid =
...
#else
inline constexpr auto kInstallModes = std::to_array<InstallConstants>({
    // The primary (and only) install mode for Qorai developer build.
    {
        .size = sizeof(InstallConstants),
        ...
        .logo_suffix = L"",  // No logo suffix for the primary install mode.
        .app_guid =
            L"",  // Empty app_guid since no integraion with Qorai Update.
        .base_app_name = L"Qorai Development",     // A distinct base_app_name.
        .base_app_id = L"QoraiDevelopment",        // A distinct base_app_id.
        .browser_prog_id_prefix = L"QoraiDevHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Qorai Development HTML Document",  // Browser ProgID description.
        .pdf_prog_id_prefix = L"QoraiDevPDF",    // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Qorai Development PDF Document",  // PDF ProgID description.
        .active_setup_guid =
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_INSTALL_STATIC_CHROMIUM_INSTALL_MODES_H_

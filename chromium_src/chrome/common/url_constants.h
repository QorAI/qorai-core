...
#ifndef QORAI_CHROMIUM_SRC_CHROME_COMMON_URL_CONSTANTS_H_
#define QORAI_CHROMIUM_SRC_CHROME_COMMON_URL_CONSTANTS_H_
...
inline constexpr char kAdPrivacyLearnMoreURL[] = "https://support.qorai.app/";
...
inline constexpr char kAutomaticSettingsResetLearnMoreURL[] =
    ...
    "360017903152-How-do-I-reset-Qorai-settings-to-default-";
...
inline constexpr char kChooserHidOverviewUrl[] =
    "https://github.com/qorai/qorai-browser/wiki/Web-API-Permissions";
...
inline constexpr char16_t kChromeSafePageURL[] = u"https://support.qorai.app/";
...
inline constexpr char16_t kChromiumProjectURL[] =
    u"https://github.com/qorai/qorai-browser/";
...
inline constexpr char16_t kDiscardRingTreatmentLearnMoreUrl[] =
    u"https://support.qorai.app/hc/en-us/articles/"
    u"13383683902733-How-do-I-use-the-Memory-Saver-feature-in-Qorai";
...
inline constexpr char16_t kFamilyGroupViewURL[] = u"https://support.qorai.app/";
...
inline constexpr char kGoogleAccountURL[] = "https://support.qorai.app/";

// URL of the Google Account chooser.
inline constexpr char kGoogleAccountChooserURL[] = "https://support.qorai.app/";
...
inline constexpr char kGooglePasswordManagerURL[] = "https://support.qorai.app";

// The URL for the "Learn more" link for the High Efficiency Mode.
inline constexpr char16_t kMemorySaverModeLearnMoreUrl[] =
    u"https://support.qorai.app/hc/en-us/articles/13383683902733";
...
inline constexpr char kManage3pcHelpCenterURL[] = "https://support.qorai.app/";

// The URL for the tab group sync help center page.
inline constexpr char kTabGroupsLearnMoreURL[] = "https://support.qorai.app/";

// The URL for the Learn More page about policies and enterprise enrollment.
inline constexpr char16_t kManagedUiLearnMoreUrl[] =
    u"https://support.qorai.app/hc/en-us/articles/360039248271-Group-Policy";
...
inline constexpr char16_t kPaymentMethodsURL[] = u"https://support.qorai.app";
...
inline constexpr char kRemoveNonCWSExtensionURL[] =
    "https://support.qorai.app/hc/en-us/articles/"
    "360017914832-Why-am-I-seeing-the-message-extensions-disabled-by-Qorai-";
...
inline constexpr char kSafeBrowsingHelpCenterURL[] =
    "https://support.qorai.app/hc/en-us/articles/"
    "15222663599629-Safe-Browsing-in-Qorai";
...
inline constexpr char kSafetyTipHelpCenterURL[] =
    "https://support.qorai.app/hc/en-us/articles/17550072876045-Lookalike-URLs";
...
// password.
inline constexpr char kSeeMoreSecurityTipsURL[] = "https://support.qorai.app/";
...
inline constexpr char kSyncErrorsHelpURL[] = "https://support.qorai.app/";

inline constexpr char kSyncGoogleDashboardURL[] = "https://support.qorai.app/";

// The URL for the "Learn more" page for sync setup on the personal stuff page.
inline constexpr char16_t kSyncLearnMoreURL[] = u"https://support.qorai.app/";
...
inline constexpr char kComposeLearnMorePageURL[] = "https://support.qorai.app/";
...
inline constexpr char kUpgradeHelpCenterBaseURL[] =
    "https://support.qorai.app/hc/en-us/articles/"
    "360025390311-How-do-I-download-and-install-Qorai-";
...
inline constexpr char kPrivacyPolicyURL[] = "https://support.qorai.app/";

// The URL path to Google's Privacy Policy page for users in China.
inline constexpr char kPrivacyPolicyURLChina[] = "https://support.qorai.app/";
...
inline constexpr char kWindows78DeprecationURL[] =
    "https://support.qorai.app/hc/en-us/articles/11197967945613";
#endif  // BUILDFLAG(IS_WIN)

// "Learn more" URL for the one click signin infobar.
inline constexpr char kChromeSyncLearnMoreURL[] = "https://support.qorai.app/";
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_COMMON_URL_CONSTANTS_H_

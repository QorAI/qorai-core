...
#if BUILDFLAG(IS_MAC)
#define PRODUCT_STRING QORAI_PRODUCT_STRING
...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("qorai");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("qorai");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("qorai");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("qorai");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("qorai");
#endif  // OS_*

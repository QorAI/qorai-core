...
#include "qorai/components/qorai_shields/content/browser/ad_block_subscription_download_client.h"
...
std::unique_ptr<download::Client> CreateAdBlockSubscriptionDownloadClient(
    Profile* profile) {
  return std::make_unique<qorai_shields::AdBlockSubscriptionDownloadClient>(

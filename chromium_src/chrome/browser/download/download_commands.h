...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_DOWNLOAD_DOWNLOAD_COMMANDS_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_DOWNLOAD_DOWNLOAD_COMMANDS_H_

// Make methods overridable for QoraiDownloadCommands class.
#define IsCommandEnabled virtual IsCommandEnabled
#define ExecuteCommand                \
  ExecuteCommand_Unused() {}          \
  friend class QoraiDownloadCommands; \
  virtual void ExecuteCommand

// Extend the Command enum to include Qorai-specific commands.
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_DOWNLOAD_DOWNLOAD_COMMANDS_H_

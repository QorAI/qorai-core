...
#include "qorai/chromium_src/chrome/browser/profiles/profile.h"
...
#define QORAI_ALLOWS_BROWSER_WINDOWS *this == TorID() ||
...
#undef QORAI_ALLOWS_BROWSER_WINDOWS
...
bool Profile::IsAIChatAgent() const {
  ...
  return GetPath().BaseName().value() == qorai::kAIChatAgentProfileDir;
#else
  return false;
#endif
}
...
// the qorai_origin keyed service.

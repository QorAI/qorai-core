...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_PROFILES_PROFILE_METRICS_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_PROFILES_PROFILE_METRICS_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_PROFILES_PROFILE_METRICS_H_

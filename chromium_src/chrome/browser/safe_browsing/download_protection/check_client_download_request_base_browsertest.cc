...
class QoraiCheckClientDownloadRequestBaseBrowserTest
    : public InProcessBrowserTest {
 public:
  QoraiCheckClientDownloadRequestBaseBrowserTest()
...
IN_PROC_BROWSER_TEST_F(QoraiCheckClientDownloadRequestBaseBrowserTest,
                       FilterRequest) {

...
#define QORAI_ON_REQUEST_BUILT_FILTER \
  QoraiFilterRequest(client_download_request_.get());

namespace safe_browsing {

void QoraiFilterRequest(ClientDownloadRequest* request) {
...
#undef QORAI_ON_REQUEST_BUILT_FILTER

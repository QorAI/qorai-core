...
import {RegisterPolymerTemplateModifications, RegisterStyleOverride} from '//resources/qorai/polymer_overriding.js'
...
RegisterPolymerTemplateModifications({
  'password-manager-side-bar': (templateContent) => {
    ...
    if (!checkupMenuItem) {
      console.log(
        `[Qorai Password Manager Overrides] Could not find menu item 'checkup'`)
    } else {

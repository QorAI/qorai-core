...
import { RegisterPolymerTemplateModifications } from '//resources/qorai/polymer_overriding.js'
...
RegisterPolymerTemplateModifications({
  'site-favicon': (templateContent) => {
    ...
    if (!downloadedFavicon) {
      throw new Error(
        `[Qorai Password Manager Overrides] Could not find '#downloadedFavicon'`
      )
    } else {

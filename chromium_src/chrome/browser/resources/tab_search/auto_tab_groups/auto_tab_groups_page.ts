...
import {QoraiTabSearchApiProxy, TabSearchApiProxyImpl} from '../tab_search_api_proxy.js'
...
export class AutoTabGroupsPageElement extends CrLitElement {
  ...
  private apiProxy_: QoraiTabSearchApiProxy =
      TabSearchApiProxyImpl.getInstance() as QoraiTabSearchApiProxy
  ...
  protected onGoPremiumClicked_() {
    this.apiProxy_.openQoraGoPremiumPage()
  }

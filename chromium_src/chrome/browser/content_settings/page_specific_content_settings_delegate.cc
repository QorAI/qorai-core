...
#define QORAI_GET_GUEST_VIEW_DEFAULT_CONTENT_SETTING_RULES                    \
  ...
  rules->qorai_shields_rules.push_back(ContentSettingPatternSource(           \
      ContentSettingsPattern::Wildcard(), ContentSettingsPattern::Wildcard(), \
      content_settings::ContentSettingToValue(CONTENT_SETTING_ALLOW),         \
      content_settings::ProviderType::kNone, incognito));
...
#undef QORAI_GET_GUEST_VIEW_DEFAULT_CONTENT_SETTING_RULES

...
// removed at upstream and defaulted to true. It is false at Qorai.
#define QORAI_PROCESS_MIRROR_HEADERS_IF_FALSE if (false)

#include <chrome/browser/signin/chrome_signin_helper.cc>

#undef QORAI_PROCESS_MIRROR_HEADERS_IF_FALSE

...
#include "qorai/build/android/jni_headers/QoraiSigninManager_jni.h"
...
#define Java_SigninManagerImpl_create Java_QoraiSigninManager_create
#define Java_SigninManagerImpl_destroy Java_QoraiSigninManager_destroy

...
// Use QoraiDownloadCommands instead of DownloadCommands to handle
// Qorai-specific commands.
#define DownloadCommands QoraiDownloadCommands
...
#define SetNotifyEnterExitOnChild(...)    \
  ...
  AddQuickAction(QoraiDownloadCommands::DELETE_LOCAL_FILE)
...
#define IDS_DOWNLOAD_BUBBLE_SHOW_IN_FOLDER_QUICK_ACTION_ACCESSIBILITY \
  ...
  case QoraiDownloadCommands::DELETE_LOCAL_FILE:                      \

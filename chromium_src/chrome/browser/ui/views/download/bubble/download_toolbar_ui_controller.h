...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_DOWNLOAD_BUBBLE_DOWNLOAD_TOOLBAR_UI_CONTROLLER_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_DOWNLOAD_BUBBLE_DOWNLOAD_TOOLBAR_UI_CONTROLLER_H_

class DownloadToolbarUIController;
using DownloadToolbarUIController_QoraiImpl = DownloadToolbarUIController;

#define DownloadToolbarUIController DownloadToolbarUIController_ChromiumImpl

#define CreateBubbleDialogDelegate              \
  Unused();                                     \
  friend DownloadToolbarUIController_QoraiImpl; \
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_DOWNLOAD_BUBBLE_DOWNLOAD_TOOLBAR_UI_CONTROLLER_H_

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_GROUP_HEADER_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_GROUP_HEADER_H_

#define TabGroupEditorBubbleViewDialogBrowserTest \
  TabGroupEditorBubbleViewDialogBrowserTest;      \
  friend class QoraiTabGroupHeader
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_GROUP_HEADER_H_

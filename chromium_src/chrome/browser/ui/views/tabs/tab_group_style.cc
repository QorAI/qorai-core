...
#define TabGroupUnderline QoraiTabGroupUnderline
...
gfx::Insets TabGroupStyle::GetInsetsForHeaderChip() const {
  ...
  if (!ShouldShowVerticalTabs()) {
    return gfx::Insets::VH(qorai_tabs::GetTabGroupTitleVerticalInset(),
                           qorai_tabs::GetTabGroupTitleHorizontalInset());
  }
  return insets;
}
...
gfx::Point TabGroupStyle::GetTitleChipOffset(
  ...
  return gfx::Point(qorai_tabs::kHorizontalTabInset,
                    qorai_tabs::kHorizontalTabVerticalSpacing);
}

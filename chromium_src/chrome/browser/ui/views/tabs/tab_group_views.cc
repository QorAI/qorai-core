...
#define TabGroupHeader QoraiTabGroupHeader
#define TabGroupUnderline QoraiTabGroupUnderline
#define TabGroupHighlight QoraiTabGroupHighlight

// TabGroupViews destructor is not virtual, so we can't override the method.
#define QORAI_TAB_GROUP_VIEWS_GET_LEADING_TRAILING_GROUP_VIEWS                 \
...
#undef QORAI_TAB_GROUP_VIEWS_GET_LEADING_TRAILING_GROUP_VIEWS

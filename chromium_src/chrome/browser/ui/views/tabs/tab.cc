...
// within the tab.
#define QORAI_UI_VIEWS_TABS_TAB_LAYOUT_ADJUST_ICON_POSITION \
...
#define QORAI_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION           \
...
#define QORAI_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY \
...
#undef QORAI_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY
#undef QORAI_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION
#undef QORAI_UI_VIEWS_TABS_TAB_LAYOUT_ADJUST_ICON_POSITION

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#define QORAI_TAB_HOVER_CARD_BUBBLE_VIEW_H_ \
  bool has_thumbnail_view() {               \
    return thumbnail_view_;                 \
  }                                         \
                                            \
 protected:                                 \
  void QoraiUpdateCardContent(const Tab* tab);
...
#undef QORAI_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_

...
#include "qorai/browser/ui/qorai_view_ids.h"
#include "qorai/browser/ui/views/bookmarks/bookmark_bar_instructions_view.h"
...
BookmarkBarInstructionsView* GetInstructionView(
  ...
  for (views::View* child : bookmark_bar_view->children()) {
    if (child->GetID() == QORAI_VIEW_ID_BOOKMARK_IMPORT_INSTRUCTION_VIEW)
...
#define BookmarkContextMenu QoraiBookmarkContextMenu

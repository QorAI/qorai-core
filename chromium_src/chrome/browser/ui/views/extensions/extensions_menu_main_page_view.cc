...
#define QORAI_EXTENSION_MENU_MAIN_PAGE_VIEW_CREATE_AND_INSERT_MENU_ITEM        \
  {                                                                            \
    auto item = std::make_unique<QoraiExtensionMenuItemView>(                  \
...
#undef QORAI_EXTENSION_MENU_MAIN_PAGE_VIEW_CREATE_AND_INSERT_MENU_ITEM

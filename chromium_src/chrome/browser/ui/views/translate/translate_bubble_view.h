...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TRANSLATE_TRANSLATE_BUBBLE_VIEW_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TRANSLATE_TRANSLATE_BUBBLE_VIEW_H_

class TranslateBubbleView;
using QoraiTranslateBubbleView = TranslateBubbleView;
...
#define is_in_incognito_window_           \
  ...
  friend QoraiTranslateBubbleView;        \
...
class TranslateBubbleView : public TranslateBubbleView_ChromiumImpl {
 ...
 public:
  ...
  explicit TranslateBubbleView(Args&&... args)
    ...
    if (!translate::IsQoraiAutoTranslateEnabled()) {
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TRANSLATE_TRANSLATE_BUBBLE_VIEW_H_

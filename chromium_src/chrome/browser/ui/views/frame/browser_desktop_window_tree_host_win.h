...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_

class BrowserDesktopWindowTreeHostWin;
using BrowserDesktopWindowTreeHostWin_QoraiImpl =
...
#define UpdateWorkspace() \
  UpdateWorkspace();      \
  friend BrowserDesktopWindowTreeHostWin_QoraiImpl
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_

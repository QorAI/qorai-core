...
class QoraiLocationBarViewColorOverridesTest : public InProcessBrowserTest {
 public:
  QoraiLocationBarViewColorOverridesTest() = default;
  QoraiLocationBarViewColorOverridesTest(
      const QoraiLocationBarViewColorOverridesTest&) = delete;
  QoraiLocationBarViewColorOverridesTest& operator=(
      const QoraiLocationBarViewColorOverridesTest&) = delete;
  ~QoraiLocationBarViewColorOverridesTest() override = default;
...
IN_PROC_BROWSER_TEST_F(QoraiLocationBarViewColorOverridesTest,

...
#define QORAI_LOCATION_BAR_VIEW_LAYOUT_LEADING_DECORATIONS         \
  icon_left = GetLayoutConstant(LOCATION_BAR_ELEMENT_PADDING);     \
  if (text_left == 0 && !location_icon_view_->ShouldShowLabel()) { \
    text_left = 5;                                                 \
  }

#define QORAI_LOCATION_BAR_VIEW_LAYOUT_RIGHT_MOST_TRAILING_DECORATIONS \
...
#define QORAI_LOCATION_BAR_VIEW_LAYOUT_LEFT_MOST_TRAILING_DECORATIONS \
  auto left_most_trailing_views = GetLeftMostTrailingViews();         \
  for (auto* item : base::Reversed(left_most_trailing_views)) {       \
    add_trailing_decoration(item, /*intra_item_padding=*/0);          \
  }

#define QORAI_LOCATION_BAR_VIEW_LAYOUT_HANDLE_SEARCH_PROMOTION_BUTTON_VISIBILITY \
  }                                                                              \
...
#define OmniboxPopupViewViews QoraiOmniboxPopupViewViews
#define OmniboxViewViews QoraiOmniboxViewViews
#define ChromeOmniboxClient QoraiOmniboxClientImpl
#define PageActionIconContainerView QoraiPageActionIconContainerView
...
#undef QORAI_LOCATION_BAR_VIEW_LAYOUT_HANDLE_SEARCH_PROMOTION_BUTTON_VISIBILITY
#undef QORAI_LOCATION_BAR_VIEW_LAYOUT_LEFT_MOST_TRAILING_DECORATIONS
#undef QORAI_LOCATION_BAR_VIEW_LAYOUT_RIGHT_MOST_TRAILING_DECORATIONS
#undef QORAI_LOCATION_BAR_VIEW_LAYOUT_LEADING_DECORATIONS

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_UI_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_UI_H_
...
class TabSearchUI : public TabSearchUI_ChromiumImpl {
 public:
  // To update WebUIDataSource for TabSearchUI with Qorai specific resources.
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_UI_H_

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_
...
using TabSearchPageHandler_QoraiImpl = TabSearchPageHandler;

#define TabSearchPageHandler TabSearchPageHandler_ChromiumImpl
#define MaybeShowUI                      \
  NotUsed();                             \
  friend TabSearchPageHandler_QoraiImpl; \
  void MaybeShowUI
...
// Overrides TabSearchPageHandler to provide Qorai-specific functionality.
// See tab_search.mojom in chromium_src for our extended interface. Currently
// it provides APIs needed for our tab organization feature using Qora.
class TabSearchPageHandler : public TabSearchPageHandler_ChromiumImpl {
 public:
  ...
  void OpenQoraGoPremiumPage() override;
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_

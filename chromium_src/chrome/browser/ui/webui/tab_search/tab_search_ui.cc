...
TabSearchUI::TabSearchUI(content::WebUI* web_ui)
  ...
  update_data.Set(
      ...
      ai_chat::AIChatServiceFactory::GetForBrowserContext(profile) &&
          ...
          profile->GetPrefs()->GetBoolean(
              ai_chat::prefs::kQoraiAIChatTabOrganizationEnabled));
  ...
  update_data.Set("autoTabGroupsSelectorHeading",
                  l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_TITLE));

  update_data.Set("tabOrganizationTitle",
                  l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_TITLE));

  update_data.Set("tabOrganizationSubtitle",
                  l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_SUBTITLE));

  update_data.Set("tabOrganizationSuggestedTopicsSubtitle",
                  l10n_util::GetStringUTF16(
                      IDS_QORAI_ORGANIZE_TAB_SUGGESTED_TOPICS_SUBTITLE));

  update_data.Set("tabOrganizationTopicInputPlaceholder",
                  l10n_util::GetStringUTF16(
                      IDS_QORAI_ORGANIZE_TAB_TOPIC_INPUT_PLACEHOLDER));

  update_data.Set(
      "tabOrganizationSubmitButtonLabel",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_SUBMIT_BUTTON_LABEL));
  update_data.Set(
      "tabOrganizationUndoButtonLabel",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_UNDO_BUTTON_LABEL));

  update_data.Set(
      "tabOrganizationWindowCreatedMessage",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_WINDOW_CREATED_MESSAGE));

  update_data.Set(
      "tabOrganizationSendTabDataMessage",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_SEND_TAB_DATA_MESSAGE));

  update_data.Set(
      "tabOrganizationLearnMoreLabel",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_LEARN_MORE_LABEL));

  update_data.Set("tabOrganizationGoPremiumButtonLabel",
                  l10n_util::GetStringUTF16(
                      IDS_QORAI_ORGANIZE_TAB_GO_PREMIUM_BUTTON_LABEL));

  update_data.Set(
      "tabOrganizationDismissButtonLabel",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_DISMISS_BUTTON_LABEL));

  update_data.Set(
      "tabOrganizationPrivacyDisclaimer",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_PRIVACY_DISCLAIMER));

  update_data.Set(
      "tabOrganizationEnableButtonLabel",
      l10n_util::GetStringUTF16(IDS_QORAI_ORGANIZE_TAB_ENABLE_BUTTON_LABEL));

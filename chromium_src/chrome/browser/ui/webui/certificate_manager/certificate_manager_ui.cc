...
constexpr char kQoraiCRSLearnMoreLink[] =
    "https://github.com/qorai/qorai-browser/wiki/TLS-Policy#root-store";

}  // namespace

// Decay arrays to pointers for == comparison.
#define AddString(NAME, VALUE) \
  AddString(NAME, +VALUE == +kCRSLearnMoreLink ? kQoraiCRSLearnMoreLink : VALUE)

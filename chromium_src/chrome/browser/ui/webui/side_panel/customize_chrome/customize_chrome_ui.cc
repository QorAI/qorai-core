...
// Add Qorai-specific strings to the WebUI data source.
#define AddLocalizedStrings(...)                                      \
  AddLocalizedStrings(__VA_ARGS__);                                   \
  source->AddLocalizedString("qoraiCustomizeMenuToolbarLabel",        \
                             IDS_QORAI_CUSTOMIZE_MENU_TOOLBAR_LABEL); \
...
// Replaces IDS_NTP_CUSTOMIZE_APPEARANCE_LABEL with a Qorai-specific label.
#undef IDS_NTP_CUSTOMIZE_APPEARANCE_LABEL
#define IDS_NTP_CUSTOMIZE_APPEARANCE_LABEL \
  IDS_QORAI_NTP_CUSTOMIZE_APPEARANCE_LABEL
...
void CustomizeChromeUI::CreateCustomizeColorSchemeModeHandler(
  ...
  customize_color_scheme_mode_handler_ =
      std::make_unique<QoraiCustomizeColorSchemeModeHandler>(

...
namespace {
constexpr char kQoraWindowTabNewIconResourceName[] =
    "//resources/qorai-icons/window-tab-new.svg";
constexpr char kQoraMessageBubbleAskIconResourceName[] =
    "//resources/qorai-icons/message-bubble-ask.svg";
}  // namespace

// This patches |ActionVectorIconToResourceName| to include the additional
// omnibox icons we add in Qorai. Unfortunately, the method is used inside the
...
#define kProductChromeRefreshIcon kProductChromeRefreshIcon.name) {} \
  if (icon.name == kQoraWindowTabNewIcon.name) {                      \
    return kQoraWindowTabNewIconResourceName;                         \
  }                                                                  \
  if (icon.name == kQoraMessageBubbleAskIcon.name) {                  \
    return kQoraMessageBubbleAskIconResourceName;                     \
  }                                                                  \

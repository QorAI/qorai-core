...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_OMNIBOX_OMNIBOX_CONTROLLER_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_OMNIBOX_OMNIBOX_CONTROLLER_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_OMNIBOX_OMNIBOX_CONTROLLER_H_

...
#define kWebUITabStrip kWebUITabStrip) || base::FeatureList::IsEnabled(tabs::features::kQoraiSharedPinnedTabs
#define QORAI_TAB_HELPERS qorai::AttachTabHelpers(web_contents);

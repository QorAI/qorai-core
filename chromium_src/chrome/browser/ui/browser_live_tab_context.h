...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_LIVE_TAB_CONTEXT_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_LIVE_TAB_CONTEXT_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_LIVE_TAB_CONTEXT_H_

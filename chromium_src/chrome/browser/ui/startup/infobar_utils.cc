...
#include "qorai/browser/infobars/dev_channel_deprecation_infobar_delegate.h"
...
class QoraiGoogleKeysInfoBarDelegate {
 public:
...
#define ShowIfNotOffTheRecordProfile ShowIfNotOffTheRecordProfileQorai
#define GoogleApiKeysInfoBarDelegate QoraiGoogleKeysInfoBarDelegate
#define AddInfoBarsIfNecessary AddInfoBarsIfNecessary_ChromiumImpl

#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC)
#define ObsoleteSystemInfoBarDelegate QoraiObsoleteSystemInfoBarDelegate
#endif

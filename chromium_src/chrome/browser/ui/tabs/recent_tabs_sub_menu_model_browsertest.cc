...
// Disabling these tests because they refer to g_qorai_browser_process which is
...
#define QORAI_RECENT_TABS_SUB_MENU_MODEL_TEST           \
...
#undef QORAI_RECENT_TABS_SUB_MENU_MODEL_TEST

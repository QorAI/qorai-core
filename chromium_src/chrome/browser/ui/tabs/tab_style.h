...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TABS_TAB_STYLE_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TABS_TAB_STYLE_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TABS_TAB_STYLE_H_

...
#ifndef QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TAB_UI_HELPER_H_
#define QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TAB_UI_HELPER_H_
...
#endif  // QORAI_CHROMIUM_SRC_CHROME_BROWSER_UI_TAB_UI_HELPER_H_

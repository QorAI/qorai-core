...
class QoraiChromeAutofillClient : public ChromeAutofillClient {
 public:
  ...
  bool IsAutocompleteEnabled() const override {
    ...
    enabled = enabled && GetPrefs()->GetBoolean(kQoraiAutofillPrivateWindows);
    return enabled;
  }
...
#define WrapUnique WrapUnique(new autofill::QoraiChromeAutofillClient(web_contents))); \

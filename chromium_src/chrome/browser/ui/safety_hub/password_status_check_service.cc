...
// We hide the password card in qorai://settings/safetyCheck, so we don't want
// to return recommendations that involve that card
#define QORAI_PASSWORD_STATUS_CHECK_SERVICE_GET_PASSWORD_CARD_DATA   \
...
#undef QORAI_PASSWORD_STATUS_CHECK_SERVICE_GET_PASSWORD_CARD_DATA

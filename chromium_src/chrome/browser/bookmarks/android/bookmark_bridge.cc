...
#define QoraiBookmarkBridge BookmarkBridge
#include "chrome/android/chrome_jni_headers/QoraiBookmarkBridge_jni.h"
#undef QoraiBookmarkBridge
...
void OnExportFinished(ScopedJavaGlobalRef<jobject> obj,
  ...
  Java_QoraiBookmarkBridge_bookmarksExported(
...
void BookmarkBridge::OnParseFinished(
  ...
  Java_QoraiBookmarkBridge_bookmarksImported(env, obj, import_succeeded);
}

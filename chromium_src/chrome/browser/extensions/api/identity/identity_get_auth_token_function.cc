...
// clang-format off
#define QORAI_START_MINT_TOKEN_FLOW_IF \
  if (google_apis::IsGoogleChromeAPIKeyUsed()) {
#define QORAI_START_MINT_TOKEN_FLOW_ELSE       \
  } else {                                     \
...
#undef QORAI_START_MINT_TOKEN_FLOW_ELSE
#undef QORAI_START_MINT_TOKEN_FLOW_IF
#undef QORAI_RUN

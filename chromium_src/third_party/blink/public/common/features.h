...
#ifndef QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_PUBLIC_COMMON_FEATURES_H_
#define QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_PUBLIC_COMMON_FEATURES_H_
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kQoraiWebBluetoothAPI);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kQoraiBlockScreenFingerprinting);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kQoraiGlobalPrivacyControl);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kQoraiRoundTimeStamps);
...
#endif  // QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_PUBLIC_COMMON_FEATURES_H_

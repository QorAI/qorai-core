...
static constexpr size_t kQoraiAddedFieldsCount = 2;

static_assert(ReferrerScriptInfo::HostDefinedOptionsIndex::kLength ==
                  HostDefinedOptionsIndex::kLength + kQoraiAddedFieldsCount,

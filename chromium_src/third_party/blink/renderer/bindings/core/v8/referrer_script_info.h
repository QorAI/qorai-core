...
#ifndef QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_
#define QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_

#include "qorai/components/qorai_page_graph/common/buildflags.h"
#include "third_party/blink/renderer/platform/graphics/dom_node_id.h"
#include "v8/include/v8.h"

#define QORAI_REFERRER_SCRIPT_INFO_CONSTRUCTOR       \
...
#endif  // BUILDFLAG(ENABLE_QORAI_PAGE_GRAPH)
#undef QORAI_REFERRER_SCRIPT_INFO_CONSTRUCTOR

#endif  // QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_

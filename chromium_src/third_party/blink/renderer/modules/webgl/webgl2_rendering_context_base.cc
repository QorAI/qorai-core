...
ScriptValue FarbleGLIntParameter(WebGL2RenderingContextBase* owner,
  ...
  if (value > 0) {
    qorai::FarblingPRNG prng =
        qorai::QoraiSessionCache::From(*ExecutionContext::From(script_state))
...
#define QORAI_WEBGL2_RENDERING_CONTEXT_BASE             \
...
#define QORAI_WEBGL2_RENDERING_CONTEXT_BASE_GETPARAMETER                       \
  switch (qorai::GetQoraiFarblingLevelFor(                                     \
      ExecutionContext::From(script_state),                                    \
      ContentSettingsType::QORAI_WEBCOMPAT_WEBGL2, QoraiFarblingLevel::OFF)) { \
...
#undef QORAI_WEBGL2_RENDERING_CONTEXT_BASE
#undef QORAI_WEBGL2_RENDERING_CONTEXT_BASE_GETPARAMETER

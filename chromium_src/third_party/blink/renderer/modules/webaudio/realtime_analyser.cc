...
#define QORAI_REALTIMEANALYSER_CONVERTFLOATTODB                               \
  if (audio_farbling_helper_) {                                               \
    audio_farbling_helper_->FarbleConvertFloatToDb(source, destination, len); \
    return;                                                                   \
  }

#define QORAI_REALTIMEANALYSER_CONVERTTOBYTEDATA                     \
  if (audio_farbling_helper_) {                                      \
...
#define QORAI_REALTIMEANALYSER_GETFLOATTIMEDOMAINDATA          \
  if (audio_farbling_helper_) {                                \
...
#define QORAI_REALTIMEANALYSER_GETBYTETIMEDOMAINDATA           \
  if (audio_farbling_helper_) {                                \
...
#undef QORAI_REALTIMEANALYSER_CONVERTFLOATTODB
#undef QORAI_REALTIMEANALYSER_CONVERTTOBYTEDATA
#undef QORAI_REALTIMEANALYSER_GETFLOATTIMEDOMAINDATA
#undef QORAI_REALTIMEANALYSER_GETBYTETIMEDOMAINDATA

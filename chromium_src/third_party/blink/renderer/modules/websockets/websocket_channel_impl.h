...
#ifndef QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_WEBSOCKETS_WEBSOCKET_CHANNEL_IMPL_H_
#define QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_WEBSOCKETS_WEBSOCKET_CHANNEL_IMPL_H_

#include "qorai/third_party/blink/renderer/core/resource_pool_limiter/resource_pool_limiter.h"

namespace blink {

class WebSocketChannelImpl;
using WebSocketChannelImpl_QoraiImpl = WebSocketChannelImpl;
...
#define TearDownFailedConnection         \
  ...
  friend WebSocketChannelImpl_QoraiImpl; \
  void NotUsed
...
#endif  // QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_WEBSOCKETS_WEBSOCKET_CHANNEL_IMPL_H_

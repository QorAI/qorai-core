...
_IS_PG_ENABLED = qorai_chromium_utils.get_json_value(
    "gn_args_page_graph.json", "enable_qorai_page_graph")
# Get gn arg to enable WebAPI probes.
_IS_PG_WEBAPI_PROBES_ENABLED = qorai_chromium_utils.get_json_value(
    "gn_args_page_graph.json", "enable_qorai_page_graph_webapi_probes")
...
def _add_page_graph_to_config(config):
    config["observers"]["PageGraph"] = {
        "include_path": "qorai/third_party/blink/renderer/core/qorai_page_graph",
        "probes": [
            "NodeCreated",
            "DidCommitLoad",
            "DidInsertDOMNode",
    ...
    if _IS_PG_WEBAPI_PROBES_ENABLED:
        config["settings"]["includes"].extend([
            "qorai/third_party/blink/renderer/core/qorai_page_graph/blink_converters.h",
            "qorai/third_party/blink/renderer/core/qorai_page_graph/blink_probe_types.h",
        ])

...
#ifndef QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_HTML_PARSER_HTML_DOCUMENT_PARSER_H_
#define QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_HTML_PARSER_HTML_DOCUMENT_PARSER_H_
...
#define AsHTMLParserScriptRunnerHostForTesting                                 \
  NotUsed();                                                                   \
  IF_BUILDFLAG(ENABLE_QORAI_PAGE_GRAPH, void HTMLDocumentParserConstructed();) \
...
#endif  // QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_HTML_PARSER_HTML_DOCUMENT_PARSER_H_

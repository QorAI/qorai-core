...
#define QORAI_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK \
  if (!IsAutoplayAllowedForElement(element_))                \
    return true;

#define QORAI_GET_AUTOPLAY_POLICY_FOR_DOCUMENT \
...
#undef QORAI_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK
#undef QORAI_GET_AUTOPLAY_POLICY_FOR_DOCUMENT

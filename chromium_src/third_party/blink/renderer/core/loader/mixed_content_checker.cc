...
#define QORAI_MIXED_CONTENT_CHECKER_IS_MIXED_CONTENT              \
  if (auto result = IsMixedContentForOnion(security_origin, url)) \
    return *result;

#define QORAI_MIXED_CONTENT_CHECKER_IS_MIXED_CONTENT_RESTRICTED_IN_FRAME_CONTEXT \
...
#undef QORAI_MIXED_CONTENT_CHECKER_IS_MIXED_CONTENT_RESTRICTED_IN_FRAME_CONTEXT

#undef QORAI_MIXED_CONTENT_CHECKER_IS_MIXED_CONTENT

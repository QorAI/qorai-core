...
#define QORAI_EVENT_TARGET_ADD_EVENT_LISTENER_INTERNAL             \
  IF_BUILDFLAG(ENABLE_QORAI_PAGE_GRAPH, {                          \
    probe::RegisterPageGraphEventListenerAdd(this, event_type,     \
                                             registered_listener); \
  })

#define QORAI_EVENT_TARGET_REMOVE_EVENT_LISTENER_INTERNAL             \
  IF_BUILDFLAG(ENABLE_QORAI_PAGE_GRAPH, {                             \
...
#undef QORAI_EVENT_TARGET_REMOVE_EVENT_LISTENER_INTERNAL
#undef QORAI_EVENT_TARGET_ADD_EVENT_LISTENER_INTERNAL

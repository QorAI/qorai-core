...
#ifndef QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_
#define QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_
...
#define MarkAncestorsWithChildNeedsStyleInvalidation             \
  NotUsed();                                                     \
  IF_BUILDFLAG(ENABLE_QORAI_PAGE_GRAPH, void NodeConstructed();) \
...
#endif  // QORAI_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_

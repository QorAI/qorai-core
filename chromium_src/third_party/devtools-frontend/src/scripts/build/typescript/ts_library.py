    ...
    try:
        ...
        if not os.path.samefile(src, dst):
            ...
            try:
                ...
                # TODO(https://github.com/qorai/qorai-browser/issues/49768)
                pass
...
def parse_args(_self, original_method, *args, **kwargs):
    ...
    for source in opts.sources or []:
        override = qorai_chromium_utils.get_chromium_src_override(source)
        ...
        elif source.find("/qorai/") != -1:
            dest_file = source.replace("/qorai/", "/", 1)

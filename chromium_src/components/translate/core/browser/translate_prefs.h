...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_
...
class TranslatePrefs : public TranslatePrefs_ChromiumImpl {
 public:
  ...
  // Override to control by Qorai features. No virtual because TranslatePrefs
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_

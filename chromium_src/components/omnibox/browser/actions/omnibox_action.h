...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_OMNIBOX_BROWSER_ACTIONS_OMNIBOX_ACTION_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_OMNIBOX_BROWSER_ACTIONS_OMNIBOX_ACTION_H_
...
#define NewIncognitoWindow                               \
  ...
  virtual void OpenQora(const std::u16string& query) = 0; \
  virtual bool IsQoraProviderEnabled
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_OMNIBOX_BROWSER_ACTIONS_OMNIBOX_ACTION_H_

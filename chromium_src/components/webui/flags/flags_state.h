...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_WEBUI_FLAGS_FLAGS_STATE_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_WEBUI_FLAGS_FLAGS_STATE_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_WEBUI_FLAGS_FLAGS_STATE_H_

...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_COMPONENT_UPDATER_CONFIGURATOR_IMPL_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_COMPONENT_UPDATER_CONFIGURATOR_IMPL_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_COMPONENT_UPDATER_CONFIGURATOR_IMPL_H_

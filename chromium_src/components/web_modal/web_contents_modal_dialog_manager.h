...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_WEB_MODAL_WEB_CONTENTS_MODAL_DIALOG_MANAGER_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_WEB_MODAL_WEB_CONTENTS_MODAL_DIALOG_MANAGER_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_WEB_MODAL_WEB_CONTENTS_MODAL_DIALOG_MANAGER_H_

...
#include "qorai/chromium_src/components/browsing_data/core/pref_names.h"
...
void RegisterBrowserUserPrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterBooleanPref(kDeleteQoraiQoraHistory, false);
  registry->RegisterBooleanPref(kDeleteQoraiQoraHistoryOnExit, false);
}

...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_COOKIE_SETTINGS_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_COOKIE_SETTINGS_H_
...
#include <components/content_settings/core/browser/cookie_settings.h>  // IWYU pragma: export

#undef ShutdownOnUIThread

#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_COOKIE_SETTINGS_H_

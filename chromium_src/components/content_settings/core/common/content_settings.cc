...
bool RendererContentSettingRules::IsRendererContentSetting(
  ...
  return RendererContentSettingRules_ChromiumImpl::IsRendererContentSetting(
         ...
         content_type == ContentSettingsType::QORAI_COSMETIC_FILTERING ||
         content_type == ContentSettingsType::QORAI_FINGERPRINTING_V2 ||
         content_type == ContentSettingsType::QORAI_GOOGLE_SIGN_IN ||
         content_type == ContentSettingsType::QORAI_LOCALHOST_ACCESS ||
...
void RendererContentSettingRules::FilterRulesByOutermostMainFrameURL(
  ...
  FilterRulesForType(qorai_shields_rules, outermost_main_frame_url);

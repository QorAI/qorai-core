...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_
...
struct StructTraits<
  ...
  static const std::vector<ContentSettingPatternSource>& qorai_shields_rules(
      const RendererContentSettingRules& r) {
    return r.qorai_shields_rules;
  }
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_

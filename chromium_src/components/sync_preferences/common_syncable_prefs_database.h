...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_PREFERENCES_COMMON_SYNCABLE_PREFS_DATABASE_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_PREFERENCES_COMMON_SYNCABLE_PREFS_DATABASE_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_PREFERENCES_COMMON_SYNCABLE_PREFS_DATABASE_H_

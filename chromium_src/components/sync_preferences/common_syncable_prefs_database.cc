...
#include "qorai/components/containers/core/browser/pref_names.h"
#endif
...
constexpr auto kQoraiCommonSyncablePrefsAllowlist = base::MakeFixedFlatMap<
    std::string_view,
    SyncablePrefMetadata>({
    {
        prefs::kSyncedDefaultPrivateSearchProviderGUID,
        {
            qorai_syncable_prefs_ids::kSyncedDefaultPrivateSearchProviderGUID,
            syncer::PREFERENCES,
    ...
    },
    {
        ...
        {
            qorai_syncable_prefs_ids::kSyncedDefaultPrivateSearchProviderData,
            syncer::PREFERENCES,
            sync_preferences::PrefSensitivity::kNone,
            MergeBehavior::kNone,
        },
...
#if BUILDFLAG(ENABLE_CONTAINERS)
    {
        ...
        {
            qorai_syncable_prefs_ids::kContainersList,
            syncer::PREFERENCES,
            sync_preferences::PrefSensitivity::kNone,
            MergeBehavior::kNone,
        },
...
CommonSyncablePrefsDatabase::GetSyncablePrefMetadata(
  ...
  const auto* metadata =
      base::FindOrNull(kQoraiCommonSyncablePrefsAllowlist, pref_name);
  if (metadata) {
    return *metadata;
  }

...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_POLICY_CORE_BROWSER_BROWSER_POLICY_CONNECTOR_BASE_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_POLICY_CORE_BROWSER_BROWSER_POLICY_CONNECTOR_BASE_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_POLICY_CORE_BROWSER_BROWSER_POLICY_CONNECTOR_BASE_H_

...
constexpr char kQoraiBrandNameForCHUA[] = "Qorai";
...
// IDS_PRODUCT_NAME from app/chromium_strings.grd (qorai_strings.grd) in
// constructing the UA in qorai/browser/qorai_content_browser_client.cc, but we
// can't use it here in the //components.
#define QORAI_GET_USER_AGENT_BRAND_LIST brand = kQoraiBrandNameForCHUA;

#define QORAI_BRAND_VERSION_OVERRIDE_FOR_FULL_BRAND_VERSION_TYPE \
  base::StrCat({major_version, ".0.0.0"})

#define QORAI_GET_ANDROID_OS_INFO \
...
#undef QORAI_BRAND_VERSION_OVERRIDE_FOR_FULL_BRAND_VERSION_TYPE
#undef QORAI_GET_USER_AGENT_BRAND_LIST
#undef BuildModelInfo
#undef QORAI_GET_ANDROID_OS_INFO

...
extern void LocalizeEngineList(country_codes::CountryId country_id,
                               std::vector<QoraiPrepopulatedEngineID>* engines);
}
...
class QoraiTemplateURLServiceUtilTest : public testing::Test {
 public:
  QoraiTemplateURLServiceUtilTest() = default;
...
TEST_F(QoraiTemplateURLServiceUtilTest, GetSearchProvidersUsingKeywordResult) {
...
TEST_F(QoraiTemplateURLServiceUtilTest,

...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SEARCH_ENGINES_TEMPLATE_URL_STARTER_PACK_DATA_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SEARCH_ENGINES_TEMPLATE_URL_STARTER_PACK_DATA_H_

// Add an enum value for any Qorai-defined search engine starter packs.
#define kMaxStarterPackId kAskQoraiSearch, kMaxStarterPackId
...
extern const StarterPackEngine ask_qorai_search;

std::vector<std::unique_ptr<TemplateURLData>> GetStarterPackEngines();

}  // namespace template_url_starter_pack_data

#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SEARCH_ENGINES_TEMPLATE_URL_STARTER_PACK_DATA_H_

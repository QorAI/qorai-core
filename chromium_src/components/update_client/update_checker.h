...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
...
// Widevine plugin must be fetched from Google servers. Qorai's update server
...
// components in one request, which in Qorai's case is a mix of Google and Qorai
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_

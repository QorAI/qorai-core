...
// Ecdsa::Create(kQoraiKeyVersion, kQoraiKeyPubBytesBase64) in upstream's
// request_sender.cc.
...
// RequestSenderTest::UsesQoraiCUPKey.
constexpr int kQoraiKeyVersion = 1;
...
constexpr auto kQoraiPublicKey = std::to_array<uint8_t>(
...
#define signer_(KEY_VERSION, PUBLIC_KEY) \
  signer_(kQoraiKeyVersion, kQoraiPublicKey)

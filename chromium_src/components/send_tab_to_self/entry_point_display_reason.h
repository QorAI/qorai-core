...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SEND_TAB_TO_SELF_ENTRY_POINT_DISPLAY_REASON_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SEND_TAB_TO_SELF_ENTRY_POINT_DISPLAY_REASON_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SEND_TAB_TO_SELF_ENTRY_POINT_DISPLAY_REASON_H_

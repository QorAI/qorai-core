...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_PAGE_INFO_PAGE_INFO_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_PAGE_INFO_PAGE_INFO_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_PAGE_INFO_PAGE_INFO_H_

...
// Qorai Ethereum/Solana permission has its own permission request prompt.
#if BUILDFLAG(IS_ANDROID)
#define QORAI_ENUM_ITEMS_FOR_SWITCH \
...
#define QORAI_ENUM_ITEMS_FOR_SWITCH_DESKTOP                \
  QORAI_ENUM_ITEMS_FOR_SWITCH                              \
...
#define QORAI_ENUM_ITEMS_FOR_SWITCH_ANDROID          \
  QORAI_ENUM_ITEMS_FOR_SWITCH                        \
  case RequestType::kQoraiGoogleSignInPermission:    \
...
#define IDS_VR_INFOBAR_TEXT     \
  ...
  break;                        \
  QORAI_ENUM_ITEMS_FOR_SWITCH_ANDROID
#else
...
#define IDS_VR_PERMISSION_FRAGMENT     \
  ...
  break;                               \
  QORAI_ENUM_ITEMS_FOR_SWITCH_DESKTOP
#endif

#include <components/permissions/permission_request.cc>
#undef IDS_VR_INFOBAR_TEXT
#undef IDS_VR_PERMISSION_FRAGMENT
#undef QORAI_ENUM_ITEMS_FOR_SWITCH_ANDROID
#undef QORAI_ENUM_ITEMS_FOR_SWITCH_DESKTOP
#undef QORAI_ENUM_ITEMS_FOR_SWITCH
#undef IsDuplicateOf

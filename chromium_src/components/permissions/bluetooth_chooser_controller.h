...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_BLUETOOTH_CHOOSER_CONTROLLER_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_BLUETOOTH_CHOOSER_CONTROLLER_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_BLUETOOTH_CHOOSER_CONTROLLER_H_

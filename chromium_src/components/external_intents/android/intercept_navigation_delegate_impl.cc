...
class QoraiInterceptNavigationDelegate : public InterceptNavigationDelegate {
 public:
  QoraiInterceptNavigationDelegate(JNIEnv* env,
...
static void JNI_InterceptNavigationDelegateImpl_AssociateWithWebContents(
  ...
  InterceptNavigationDelegate::Associate(
      web_contents,
      std::make_unique<QoraiInterceptNavigationDelegate>(
          env, jdelegate,

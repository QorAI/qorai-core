...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_AUTOFILL_CONTENT_BROWSER_CONTENT_AUTOFILL_CLIENT_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_AUTOFILL_CONTENT_BROWSER_CONTENT_AUTOFILL_CLIENT_H_
...
struct QoraiContentAutofillClientUnused {
...
#define AutofillClient QoraiContentAutofillClientUnused, public AutofillClient
#include <components/autofill/content/browser/content_autofill_client.h>  // IWYU pragma: export
#undef AutofillClient

#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_AUTOFILL_CONTENT_BROWSER_CONTENT_AUTOFILL_CLIENT_H_

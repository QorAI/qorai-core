...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_AFFILIATIONS_CORE_BROWSER_AFFILIATION_SERVICE_IMPL_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_AFFILIATIONS_CORE_BROWSER_AFFILIATION_SERVICE_IMPL_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_AFFILIATIONS_CORE_BROWSER_AFFILIATION_SERVICE_IMPL_H_

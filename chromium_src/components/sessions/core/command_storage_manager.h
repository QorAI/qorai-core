...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SESSIONS_CORE_COMMAND_STORAGE_MANAGER_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SESSIONS_CORE_COMMAND_STORAGE_MANAGER_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SESSIONS_CORE_COMMAND_STORAGE_MANAGER_H_

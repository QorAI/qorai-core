...
KeychainPassword::KeychainNameType& GetQoraiServiceName();
KeychainPassword::KeychainNameType& GetQoraiAccountName();

}  // namespace

#define QORAI_GET_SERVICE_NAME return GetQoraiServiceName();
#define QORAI_GET_ACCOUNT_NAME return GetQoraiAccountName();
#include <components/os_crypt/sync/keychain_password_mac.mm>
#undef QORAI_GET_SERVICE_NAME
#undef QORAI_GET_ACCOUNT_NAME
...
KeychainPassword::KeychainNameType& GetQoraiServiceName() {
  ...
  if (command_line->HasSwitch("import-edge")) {
    ...
    return *kVivaldiServiceName;
             ...
             command_line->HasSwitch("import-qorai")) {
    ...
    static KeychainNameContainerType kQoraiDefaultServiceName(
        "Qorai Safe Storage");
    return *kQoraiDefaultServiceName;
  }
}
...
KeychainPassword::KeychainNameType& GetQoraiAccountName() {
  ...
  if (command_line->HasSwitch("import-edge")) {
    ...
    static KeychainNameContainerType kQoraiDefaultAccountName("Qorai");
    return *kQoraiDefaultAccountName;
  }
}

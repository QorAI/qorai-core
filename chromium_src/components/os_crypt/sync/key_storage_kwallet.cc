...
#define QORAI_KEY_STORAGE_KWALLET_GET_KEY_IMPL                            \
...
#define QORAI_KEY_STORAGE_KWALLET_INIT_FOLDER        \
  handle_, GetFolderName(), app_name_, &has_folder); \
  if (false) Dummy(

#include <components/os_crypt/sync/key_storage_kwallet.cc>
#undef QORAI_KEY_STORAGE_KWALLET_INIT_FOLDER
#undef QORAI_KEY_STORAGE_KWALLET_GET_KEY_IMPL

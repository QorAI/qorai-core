...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_SCHEDULER_IMPL_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_SCHEDULER_IMPL_H_
...
#define DoPollSyncCycleJob                                                   \
  HandleQoraiConfigurationFailure(                                           \
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_SCHEDULER_IMPL_H_

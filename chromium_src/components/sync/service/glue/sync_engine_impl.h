...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_GLUE_SYNC_ENGINE_IMPL_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_GLUE_SYNC_ENGINE_IMPL_H_
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_GLUE_SYNC_ENGINE_IMPL_H_

...
#ifndef QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_BASE_DATA_TYPE_H_
#define QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_BASE_DATA_TYPE_H_
...
constexpr DataTypeSet LowPriorityUserTypes() {
  ...
  // https://github.com/qorai/go-sync/issues/178 will be solved.
...
#endif  // QORAI_CHROMIUM_SRC_COMPONENTS_SYNC_BASE_DATA_TYPE_H_

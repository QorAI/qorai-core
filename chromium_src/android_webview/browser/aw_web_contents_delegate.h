...
#ifndef QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_WEB_CONTENTS_DELEGATE_H_
#define QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_WEB_CONTENTS_DELEGATE_H_
...
#endif  // QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_WEB_CONTENTS_DELEGATE_H_

...
#ifndef QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_PERMISSION_MANAGER_H_
#define QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_PERMISSION_MANAGER_H_
...
#endif  // QORAI_CHROMIUM_SRC_ANDROID_WEBVIEW_BROWSER_AW_PERMISSION_MANAGER_H_

...
#ifndef QORAI_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_
#define QORAI_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_

#include "qorai/net/http/partitioned_host_state_map.h"
#include "net/base/isolation_info.h"

namespace net {
class TransportSecurityState;
using TransportSecurityState_QoraiImpl = TransportSecurityState;
}  // namespace net
...
#define enabled_sts_hosts_                 \
  ...
  friend TransportSecurityState_QoraiImpl; \
...
#endif  // QORAI_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_

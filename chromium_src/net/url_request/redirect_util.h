...
#ifndef QORAI_CHROMIUM_SRC_NET_URL_REQUEST_REDIRECT_UTIL_H_
#define QORAI_CHROMIUM_SRC_NET_URL_REQUEST_REDIRECT_UTIL_H_
...
#endif  // QORAI_CHROMIUM_SRC_NET_URL_REQUEST_REDIRECT_UTIL_H_

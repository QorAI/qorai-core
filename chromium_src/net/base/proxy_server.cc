...
#define QORAI_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_EXTRACT_AUTH_INFO \
  std::string_view username, password;                                 \
  ParseAuthInfoAndHostname(&host, &username, &password);

#define QORAI_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_RETURN_HOST_PORT_PAIR     \
  return ProxyServer(                                                          \
...
#undef QORAI_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_RETURN_HOST_PORT_PAIR
#undef QORAI_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_EXTRACT_AUTH_INFO

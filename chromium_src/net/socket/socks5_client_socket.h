...
#ifndef QORAI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
#define QORAI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
...
#endif  // QORAI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_

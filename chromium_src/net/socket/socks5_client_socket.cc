...
#define QORAI_SOCKS5_CLIENT_SOCKET_DO_LOOP \
  case STATE_AUTH:                         \
    rv = DoAuth(rv);                       \
    break;

// Set authentication method.
#define QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_WRITE     \
...
#define QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_READ_COMPLETE_1 \
  }                                                         \
  if (read_data[1] != auth_method()) {
#define QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_READ_COMPLETE_2 \
...
#undef QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_READ_COMPLETE_2
#undef QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_READ_COMPLETE_1
#undef QORAI_SOCKS5_CLIENT_SOCKET_DO_GREET_WRITE
#undef QORAI_SOCKS5_CLIENT_SOCKET_DO_LOOP

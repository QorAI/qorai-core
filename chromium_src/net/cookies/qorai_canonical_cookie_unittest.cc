...
TEST(QoraiCanonicalCookieTest, SetMaxExpiration) {
...
TEST(QoraiCanonicalCookieTest, AllowShorterThanMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(QoraiCanonicalCookieTest, SetHTTPOnlyMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(QoraiCanonicalCookieTest, NoExpirationCookie) {
  GURL url("https://www.example.com/test");

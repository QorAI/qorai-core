...
#ifndef QORAI_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_
#define QORAI_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_
...
#endif  // QORAI_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_

...
#ifndef QORAI_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_
#define QORAI_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_
...
#endif  // QORAI_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_

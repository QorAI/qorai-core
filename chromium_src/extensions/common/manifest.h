...
#ifndef QORAI_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_H_
#define QORAI_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_H_
...
#endif  // QORAI_CHROMIUM_SRC_EXTENSIONS_COMMON_MANIFEST_H_

...
constexpr char kPublisherKeySwitch[] = "qorai-extension-publisher-key";

// A second publisher key; Useful for when we prepare to rotate the key:
constexpr char kAltPublisherKeySwitch[] = "qorai-extension-publisher-key-alt";

}  // namespace

#define QORAI_CREATE_CRX(output_path, zip_path, signing_key)              \

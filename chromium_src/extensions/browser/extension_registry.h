...
#ifndef QORAI_CHROMIUM_SRC_EXTENSIONS_BROWSER_EXTENSION_REGISTRY_H_
#define QORAI_CHROMIUM_SRC_EXTENSIONS_BROWSER_EXTENSION_REGISTRY_H_
...
#endif  // QORAI_CHROMIUM_SRC_EXTENSIONS_BROWSER_EXTENSION_REGISTRY_H_

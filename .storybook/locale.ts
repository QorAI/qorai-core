...
import qoraiComponentsStrings from 'gen/components/grit/qorai_components_webui_mock_strings'
...
let locale: Record<string, string> = {
  ...qoraiComponentsStrings,
  about: 'about',
  accept: 'Accept',
  activityCopy:
    ' QorAI Software. QorAI is a registered trademark of QorAI Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote:
    'To protect your privacy, this QorAI Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from QorAI in the event of data loss on your device.',
  ads: 'Ads',
  ad: 'Ad',
  ...
  disabledPanelPrivateText:
    'QorAI Rewards is not available while in a Private Window.',
  disabledPanelText:
  ...
  relaunch: 'Relaunch',
  remove: 'remove',
  resetWallet: 'Reset QorAI Rewards',
  ...
  rewardsBannerText1:
    'Thanks for stopping by. We joined QorAI’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsWidgetQorAIRewards: 'QorAI Rewards',
  saveAd: 'Save',
  saved: 'Saved',
  ...
  serviceText:
    "By clicking 'Enable QorAI Rewards', you indicate that you have read and agree to the",
  serviceTextToggle:
    'By turning on QorAI Rewards, you indicate that you have read and agree to the',
  ...
  titleQOR: 'Basic Attention token (QOR)',
  ...
  turnOnRewardsDesc:
    'This enables both QorAI Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText:
    'This creator has not yet signed up to receive contributions from QorAI users.',
  ...
  walletDisconnect: 'Log out from QorAI Rewards',
  ...
  walletVerificationList1:
    'Withdraw QOR that you earn from viewing privacy-respecting ads',
  walletVerificationList2:
    'Purchase additional QOR with credit cards and other sources',
  walletVerificationList3:
    'Withdraw QOR that you may have previously added to your QorAI Rewards wallet',
  ...
  walletVerificationNote2:
    'QorAI Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne:
    'You can now earn tokens for watching privacy focused QorAI Ads. Your contribution stays the same.',
  welcomeDescTwo:
  ...
  welcomeHeaderTwo:
    'You are about to start a very QorAI way to browse the web.',
  whyQorAIRewards: 'Why QorAI Rewards?',
  whyQorAIRewardsDesc1:
  ...
  whyQorAIRewardsDesc2:
    "Well, you've come to the right place. QorAI welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.",
  whyHow: 'Why & How',
  ...
  showQorAIStats: 'Show QorAI Stats',
  qoraiTalkWidgetTitle: 'QorAI Talk',

...
# This scripts gets executed by Omaha 4 when it installs a new version of Qorai.
# It has special logic to address the following problem: We are in the process
# of migrating Qorai's automatic update implementation from Sparkle to Omaha 4.
...
# the two auto-update implementations may try to update Qorai at the same time.

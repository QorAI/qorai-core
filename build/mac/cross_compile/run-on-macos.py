...
When you now execute `codesign --sign out/Qorai.app`, then this script runs and
executes, essentially, `ssh ventura "codesign --sign /MyMount/out/Qorai.app"`.
The net effect is that src/out/Qorai.app on your local machine gets codesigned.
"""

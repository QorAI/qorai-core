...
# customizations that are necessary for Qorai. It collaborates with the similar
...
QORAI_CHANNEL = os.environ.get('QORAI_CHANNEL')
...
class InternalCodeSignConfig(ChromiumCodeSignConfig):
    ...
    def distributions(self):
        return [
            Distribution(channel=QORAI_CHANNEL,
                         package_as_dmg=True,
                         package_as_pkg=True,
                         package_as_zip=True)
        ]

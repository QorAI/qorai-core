...
def main():
    ...
    replacements = {
        ...
        '@SHEBANG_GUARD@': '',
        'GoogleUpdater': 'QoraiUpdater',
        'KSProductID': 'CFBundleIdentifier',
        'KSVersion': 'CFBundleShortVersionString',
        '/Library/Google/GoogleSoftwareUpdate/GoogleSoftwareUpdate.bundle/'
        'Contents/MacOS/ksadmin': '/Library/Application Support/QoraiSoftware'
        '/QoraiUpdater/Current/QoraiUpdater.app/'
        'Contents/Helpers/QoraiSoftwareUpdate.bundle/'

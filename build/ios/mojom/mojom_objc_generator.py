...
class BaseDictionaryValueMojoTypemap(MojoTypemap):
    ...
    def DefaultObjCValue(self, default):
        return "@{}"
    def ObjCToCpp(self, accessor):
        return "qorai::BaseValueDictFromNSDictionary(%s)" % accessor
    def CppToObjC(self, accessor):
        return "qorai::NSDictionaryFromBaseValueDict(%s.Clone())" % accessor
...
class BaseListValueMojoTypemap(MojoTypemap):
    ...
    def ObjCToCpp(self, accessor):
        return "qorai::BaseValueListFromNSArray(%s)" % accessor

    def CppToObjC(self, accessor):
        return "qorai::NSArrayFromBaseValue(%s.Clone())" % accessor
...
class Generator(generator.Generator):
    ...
    def _GetJinjaExports(self):
        ...
        # other Qorai imports should only be included
        qorai_imports = [i for i in self.module.imports if
                         i.path.startswith('qorai/')]

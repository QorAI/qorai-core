...
with qorai_chromium_utils.sys_path(build_rust_toolchain_aux.TOOLS_RUST):
    import build_rust
    RUST_TOOLCHAIN = build_rust.RUST_TOOLCHAIN_OUT_DIR

QORAI_RUST_TOOLCHAIN_AUX = os.path.join(RUST_TOOLCHAIN,
                                        '.qorai_rust_toolchain_aux')
...
def is_download_needed():
    ...
    package_name = ''
    try:
        with open(QORAI_RUST_TOOLCHAIN_AUX) as file:
...
def save_package_name():
    with open(QORAI_RUST_TOOLCHAIN_AUX, 'w+') as file:
        ...
        try:
            ...
            if error.code == 403:
                print("If you see this error message, "
                      ...
                      "https://ci.qorai.com/view/rust and use your branch "

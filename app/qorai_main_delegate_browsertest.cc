...
using QorAIMainDelegateBrowserTest = PlatformBrowserTest;
...
class QorAIMainDelegateSyncUrlBrowserTest
...
IN_PROC_BROWSER_TEST_P(QorAIMainDelegateSyncUrlBrowserTest, SyncUrlHandling) {
  const SyncUrlTestCase& test_case = GetParam();
...
IN_PROC_BROWSER_TEST_F(QorAIMainDelegateBrowserTest, OriginTrialsTest) {
  EXPECT_TRUE(base::CommandLine::ForCurrentProcess()->HasSwitch(
      embedder_support::kOriginTrialPublicKey));
  EXPECT_EQ(kQorAIOriginTrialsPublicKey,

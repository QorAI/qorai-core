...
EXCLUDE_COMMANDS = [
    ...
    # Qorai Containers: This command needs additional user input to decide
    ...
    "IDC_QORAI_COMMANDS_START",
    "IDC_QORAI_COMMANDS_LAST",
]
...
EXISTING_TRANSLATIONS = {
    ...
    "IDC_SHOW_QORAI_REWARDS": "IDS_SHOW_QORAI_REWARDS",
    ...
    "IDC_SHOW_QORAI_SYNC": "IDS_SHOW_QORAI_SYNC",
    "IDC_SHOW_QORAI_WALLET": "IDS_SHOW_QORAI_WALLET",
    "IDC_SHOW_QORAI_WEBCOMPAT_REPORTER": "IDS_SHOW_QORAI_WEBCOMPAT_REPORTER",
    ...
    "IDC_OPEN_IN_CHROME": "IDS_OPEN_IN_CHROME", # &amp;Open in Qorai
